...
/********************************************************************20**
        ...
        Sid:      kw_err.h@@/main/2 - Fri Nov 13 14:14:12 2009
...
#if (ERRCLASS & ERRCLS_INT_PAR)
#define KW_GET_AND_VALIDATE_CKWSAP(_ckwSap, _errCode, _fn) \
{ \
   S16 _ret; \
   _ret = RFAILED; \
...
#define PJ_GET_AND_VALIDATE_CPJSAP(_cpjSap, _errCode, _fn, _ret) \
{ \
   _ret = RFAILED; \
...
/********************************************************************30**
         ...
         End of file:     kw_err.h@@/main/2 - Fri Nov 13 14:14:12 2009
