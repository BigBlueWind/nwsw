...
/********************************************************************20**
     ...
     Sid:      gen.h@@/main/140 - Thu Oct 20 11:18:36 2011
...
#define DBGP(_tskInit, _layerName, _msgClass, _arg) \
        { \
           ...
           { \
              ...
              sprintf((_tskInit)->prntBuf, "[%s] [%s 0x%x:%x] %s:%d ", \
                    _buf,_layerName, (_tskInit)->ent, (_tskInit)->inst, \
                    __FILE__, __LINE__); \
...
/********************************************************************30**
         ...
         End of file:     gen.h@@/main/140 - Thu Oct 20 11:18:36 2011
