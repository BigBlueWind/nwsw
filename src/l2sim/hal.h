...
#define NUM_MAP_DEV                     10
//#define NUM_DSP_DEV                     10
...
#define SRIO_0_BASEADDR        	        (RAD_BASEADDR + 0xF00000)
#define SRIO_1_BASEADDR        	        (RAD_BASEADDR + 0xE00000)

/*
 * Flash Devices (BSP)
 */

#define NOR8_BASEADDR                   0xA8000000
#define NOR16_BASEADDR                  0xA0000000
#define NAND_BASEADDR                   0xA9000000
...
#define DDR1_BASEADDR                   0x40000000
...
#define SPACC_BASEADDR                  0xFBD40000
...
/*
 * Multiprocessors synchronization semaphores
 */
#define SEMAPHORES_BASE                 0xFBF00000 /**< Internal Hardware semaphores base address */
#define SEMACTRLREG(semaid)             (SEMAPHORES_BASE+semaid*4) /**< Macro to get address based on semaphore ID */
#define SEMANUM                         32
/*
 * CRAM
 */
...
#define GEMAC0_BASEADDR                 (APB_BASEADDR + 0x0D0000) /**< Gigbait Ethernet MAC #0 base address */
#define XP_APB_BASEADDR                 (APB_BASEADDR + 0x100000) /**< Expansion APB bus base address */
#define GEMAC1_BASEADDR                 (APB_BASEADDR + 0x170000) /**< Gigbait Ethernet MAC #1 base address */
#define GEMSRDS_BASEADDR                (APB_BASEADDR + 0x1A0000) /**< Gigabit Ethernet MAC SERDES */
#define SYS_APB_BASEADDR                (APB_BASEADDR + 0x400000) /**< System APB base address */
#define RAD_APB_BASEADDR                (APB_BASEADDR + 0x800000) /**< Radio  APB base address */

/*
 * APB Radio APB Address Assignments
 */
#define RAD_APB_CLKRST_BASEADDR         (RAD_APB_BASEADDR + 0x000000)
#define RAD_APB_FSYNC_TIMER_BASEADDR    (RAD_APB_BASEADDR + 0x0000C0)
#define RAD_APB_CONFIG_BASEADDR         (RAD_APB_BASEADDR + 0x010000)
#define RAD_APB_SRIO0_BASEADDR          (RAD_APB_BASEADDR + 0x020000)
//#define RAD_APB_SRIO1_BASEADDR          (RAD_APB_BASEADDR + 0x060000)//TODO!!!!!!!!!!!!!!!30000)
...
#define RAD_CFG_EP_MSI_SET              (RAD_APB_CONFIG_BASEADDR + 0x100)
#define RAD_CFG_EP_MSI_MSG_SENT         (RAD_APB_CONFIG_BASEADDR + 0x104)
#define RAD_CFG_RC_MSI_CATCHER          (RAD_APB_CONFIG_BASEADDR + 0x108)

// SRDS0 Registers
#define RAD_SRDS0_PCS_MISC_CFG          (RAD_APB_SERDES0_4CH_BASEADDR + 0x8004)

// SRDS0 Registers
#define SRDS0_NUM_LANES                 4
...
#define SRDSMODE_CPRO       0xB
#define SRDSMODE_PRBS       0xC
*/

// SRIO and PCIe 1 rate
//#define SRDSRATE_2500       1
// PCIe 2 rate
//#define SRDSRATE_5000       2
...
#define SRIO_AXI_CLK_CNTRL              (TOPCLKRST_BASEADDR + 4*0x9)
 ...
 */
#define GEMNTG_FREQ_SET_INT             (XP_GEMNTG_BASE + 0x00)      /**< FE0C0200 */ 
#define GEMNTG_FREQ_SET_FRA             (XP_GEMNTG_BASE + 0x04)      /**< FE0C0204 */
#define GEMNTG_PHASE_ADJ_FREQ_INT       (XP_GEMNTG_BASE + 0x10)      /**< FE0C0210 */
#define GEMNTG_PHASE_ADJ_FREQ_FRA       (XP_GEMNTG_BASE + 0x14)      /**< FE0C0214 */
#define GEMNTG_PHASE_ADJ_DUR            (XP_GEMNTG_BASE + 0x18)      /**< FE0C0218 */
#define GEMNTG_PHASE_ADJ_START          (XP_GEMNTG_BASE + 0x1C)      /**< FE0C021C */
#define GEMNTG_MODE                     (XP_GEMNTG_BASE + 0x20)      /**< FE0C0220 */
#define GEMNTG_PULSE_WIDTH              (XP_GEMNTG_BASE + 0x30)      /**< FE0C0230 */
#define GEMNTG_FRAME_LENGTH             (XP_GEMNTG_BASE + 0x34)      /**< FE0C0234 */
#define GEMNTG_PHASE_FRAME              (XP_GEMNTG_BASE + 0x38)      /**< FE0C0238 */
#define GEMNTG_FRAME_COUNT              (XP_GEMNTG_BASE + 0x3C)      /**< FE0C023C */
...
#define XP_TDM_NTG_CNTRL                (XPCLKRST_BASEADDR + 4*0x09)
#define XP_GEM_NTG_CNTRL                (XPCLKRST_BASEADDR + 4*0x0A)
#define XP_SRDS_CNTRL                   (XPCLKRST_BASEADDR + 4*0x0B)
#define XP_EXTPHY_CLK_CNTRL             (XPCLKRST_BASEADDR + 4*0x0C)
#define XP_TDM_NTG_BASE                 (XPCLKRST_BASEADDR + 4*0x40)
#define XP_GEM_NTG_BASE                 (XPCLKRST_BASEADDR + 4*0x80)
...
#define GPIO_RESERVED_18                (GPIO_APB_BASEADDR + 0x18)
#define SYSCONF_STAT_REG                (GPIO_APB_BASEADDR + 0x1C)
#define GPIO_RESERVED_20                (GPIO_APB_BASEADDR + 0x20)
...
#define GPIO_THERMAL_CTRL_REG           (GPIO_APB_BASEADDR + 0x6C)
#define GPIO_THERMAL_STAT_REG           (GPIO_APB_BASEADDR + 0x70)
#define GPIO_RGMII_0_DLL_TXD_REG        (GPIO_APB_BASEADDR + 0x74)
#define GPIO_RGMII_0_DLL_TX_CLK_REG     (GPIO_APB_BASEADDR + 0x78)
#define GPIO_RGMII_1_DLL_TXD_REG        (GPIO_APB_BASEADDR + 0x7C)
#define GPIO_RGMII_1_DLL_TX_CLK_REG     (GPIO_APB_BASEADDR + 0x80)
#define GPIO_RESERVED_84                (GPIO_APB_BASEADDR + 0x84)
#define GPIO_RESERVED_88                (GPIO_APB_BASEADDR + 0x88)
#define GPIO_RESERVED_8C                (GPIO_APB_BASEADDR + 0x8C)
#define GPIO_LEVEL_INT_STAT_CLR_REG     (GPIO_APB_BASEADDR + 0x90)
#define GPIO_POS_LEVEL_REG              (GPIO_APB_BASEADDR + 0x94)
...
#define TIMER_IRQ_MASK				(TIMER_APB_BASEADDR + 0x40)
#define TIMER_IRQ_STATUS			(TIMER_APB_BASEADDR + 0x50)
/*
...
#define HAL_IRQ_LOCAL_TIMER_WD  30
...
#define HAL_IRQ_DDR0_CTRL       SPI_ID(16)
#define HAL_IRQ_DDR1_CTRL       SPI_ID(17)
...
#define HAL_IRQ_PCIE_4          SPI_ID(74)
#define HAL_IRQ_PCIE_MSI        HAL_IRQ_PCIE_4
...
//#define HAL_NUM_SPU              NUM_DSP_DEV

#define REG32(x)		(*(volatile unsigned int *)(x))
#define REG16(x)		(*(volatile unsigned short*)(x))
#define REG8(x)			(*(volatile unsigned char*)(x))

#define Get24MHzTick()          *(volatile UINT32 *)TIMER0_CURR_COUNT
#define GetTIMETICK()	     *(volatile UINT32 *)TIMER0_CURR_COUNT
#define TICKS_TO_MS(ms)     (150*1000*ms)
#define MS_TO_TICKS(ms)     (150*1000*ms)
#define TICKS_TO_US(us)     (150*us)
#define US_TO_TICKS(us)     (150*us)
#define IS_IN_RANGE(x, a, b)  (((UINT32)(x)>=(UINT32)(a)) && ((UINT32)(x) < (UINT32)(b)))

#ifdef __GNUC__
static
#endif
__inline UINT32 GetExecBusTicks(UINT32 start_tick)
{
	return Get24MHzTick() - start_tick;
   // return 10*(end_tick - start_tick)/24;
}
...
#define DMAIRQ_FCTRL_T2K            (1 << 1)


typedef struct tDMA_CHAN_CTRL_T2K
{
    VUINT32     Control;
    VUINT32     HeadFDesc;
    VUINT32     BurstLength;
    ...
    VUINT32     SoftReset;
    VUINT32		DiagRegs[55];
} DMA_CHAN_CTRL_T2K, *PDMA_CHAN_CTRL_T2K;

/*
typedef struct tDMA_CHAN_CTRL_T2K_EX
{
    VUINT32     MEM2DMA_Thrhld;
    VUINT32     DMA2MEM_Thrhld;
    VUINT32     AXIRdAlld;
    VUINT32     Reserved;
    VUINT32     AXIrqEnb;
    VUINT32     Reserved1;
    ...
    VUINT32     Reserved3;
    VUINT32		DiagRegs[55];
} DMA_CHAN_CTRL_T2K_EX, *PDMA_CHAN_CTRL_T2K_EX;
