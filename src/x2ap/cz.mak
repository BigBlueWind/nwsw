...
# SB files directory
#SB_DIR= /u/prd/rls/1000191/1.3/crnt
...
CZTLCFLG=-DCZ -DRS -DLCRSLICZT -DLWLCRSLICZT -DLCCZUICZT -DLCCZT
...
CZOPTS=-DCZ -DRS -DLCRSLICZT -DLWLCRSLICZT -DLCCZUICZT -DLCCZT -DLTE_HO_SUPPORT
...
CZACCOPTS3=-DCZAC_SCTP -DRS -DCMXTA_MASTER -DSM -DLCSMMILCZ -DLWLCSMMILCZ  $(CZTLCFLG) $(CZTLWLCFLG) $(LCZLCFLG) $(SMLCFLG) $(CZOPTS1) $(CHIOPTS) $(CSBOPTS) $(HITLCFLG) $(LHILCFLG) $(SCTLCFLG) -DDM  -DNO_ERRCLS
...
GENACCOSOPTS=-DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 -DSS_MULTIPLE_PROCS -DLONG_MSG -DCM_INET2 -DSS_DRVR_SUPPORT
...
CZALL_INC=$(LCZ_INC) $(CZ_INC) $(CZT_INC) $(SB_DIR)
...
$(SY_DIR)/czac_cztutl.$(OBJ): $(CZACC_DIR)/czac_cztutl.c $(SYS_INC) $(CZACCALL_INC)
...
$(SY_DIR)/smhiexms.$(OBJ): $(HI_DIR)/smhiexms.c $(SYS_INC) $(LCZ_INC)
	$(CC) -c $(CPRDOPTS) $(CHIOPTS) $(CSMOPTS) $(HI_DIR)/smhiexms.c -o $(SY_DIR)/smhiexms.$(OBJ)

$(SY_DIR)/smhiptmi.$(OBJ): $(HI_DIR)/smhiptmi.c $(SYS_INC) $(LCZ_INC)
	$(CC) -c $(CPRDOPTS) $(CHIOPTS) $(CSMOPTS) $(HI_DIR)/smhiptmi.c -o $(SY_DIR)/smhiptmi.$(OBJ)
...
$(SY_DIR)/smsbexms.$(OBJ): $(SB_DIR)/smsbexms.c $(SYS_INC) $(LCZ_INC)
	$(CC) -c $(CPRDOPTS) $(CSBOPTS) $(CSMOPTS) $(SB_DIR)/smsbexms.c -o $(SY_DIR)/smsbexms.$(OBJ)

$(SY_DIR)/smsbptmi.$(OBJ): $(SB_DIR)/smsbptmi.c $(SYS_INC) $(LCZ_INC)
	$(CC) -c $(CPRDOPTS)  $(CSMOPTS) $(SB_DIR)/smsbptmi.c -o $(SY_DIR)/smsbptmi.$(OBJ)
...
$(SY_DIR)/hit.$(OBJ): $(HI_DIR)/hit.c $(SYS_INC) $(HIT_INC)
	$(CC) -c $(CHIOPTS) $(CPRDOPTS) $(HI_DIR)/hit.c -o $(SY_DIR)/hit.$(OBJ)
...
$(SY_DIR)/lhi.$(OBJ): $(HI_DIR)/lhi.c $(SYS_INC) $(CZALL_INC)
	$(CC) -c $(CHIOPTS) $(CPRDOPTS) $(HI_DIR)/lhi.c -o $(SY_DIR)/lhi.$(OBJ)

$(SY_DIR)/lsb.$(OBJ): $(SB_DIR)/lsb.c $(SYS_INC) $(CZALL_INC)
	$(CC) -c $(CSBOPTS) $(CPRDOPTS) $(SB_DIR)/lsb.c -o $(SY_DIR)/lsb.$(OBJ)
