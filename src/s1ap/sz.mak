...
#               
#
#       Sid:      sz.mak.00@@/main/2 - Mon Jan 10 22:16:19 2011
#
#       Prg:    sn
#
#********************************************************************21*/
...
# commented for RTR
#PRDOPTS=-DSZ -DSZ_ENB -DUZ -DLCSZT -DLCSCT 

# for loose coupling
#PRDOPTS=-DSZ -DSZ_ENB -DLSZV1\
	-DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -DCM_PASN_DBG    \
        -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT \
	-DLWLCSZT -DLCDMUISCT -DLCSBUISCT
PRDOPTS=-DSZ -DUZ -DLCUZLISZT -DLWLCUZLISZT -DLCSZUISZT -DLCSZT -DPTSZUISZT -US1AP_REL8A0 -DCM_PASN_CRIT_HANDL -DLSZV1 -DSZTV1 -DSZTV3\
		  -DLCLSZ -DLCSCT -DSM -DSZ -DLCSMSZMILSZ  -DLCSZMILSZ -DLCLSZ -DSM -DSZ -DLCSMSZMILSZ  -DLCSZMILSZ -DSZ_ENB \
		  -DSZ_DYNAMIC_PEER -USZ_USTA -DLCSZMILSZ -DUSE_PURE -DS1AP_REL9A6 
# for ksctp 
#PRDOPTS=-DSZ -DSZ_ENB \
#	-DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -DCM_PASN_DBG    \
#        -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT \
...
PT_INC_PATH="-I$(CM_CM_DIR) -I$(CM_LIB_DIR) -I$(CM_HASH_DIR) -I$(CM_TMR_DIR) \
   ...
   -I$(CM_MEM_DIR) -I$(CM_LLIST_DIR) -I$(CM_LSZ_DIR)"
...
ACC_INC_PATH="-I$(SZ_DIR) -I$(CM_CM_DIR) -I$(CM_LIB_DIR) -I$(CM_HASH_DIR) \
   ...
   -I$(SZACC_DIR) -I$(CM_SM_DIR) -I$(SZSM_DIR) -I$(OS_DIR) \
   -I$(CM_SS7_DIR) -I$(CM_LLIST_DIR) -I$(CM_MEM_DIR) -I$(CM_LSZ_DIR) \
...
# ---------------- For non-ANSI Compilation
#GNUENV="-DSUNOS"
#For non-ANSI PT build
#GNUENV="-DSUNOS -DDONT_USE_SYS_LIB"
...
$(SY_DIR)/ss_log.$(OBJ): $(SS_DIR)/ss_log.c $(SYS_INC) $(SS_INC)
	$(CC) -c $(COSOPTS) $(SS_DIR)/ss_log.c -o $(SY_DIR)/ss_log.$(OBJ)
...
#********************************************************************30**
#  
#        End of file:     sz.mak.00@@/main/2 - Mon Jan 10 22:16:19 2011
#    
#********************************************************************31*/
#
#********************************************************************40**
...
#----------- -------- ---- -----------------------------------------------
#/main/2      ---      pkaX  1. Updated for S1AP release 3.1
#********************************************************************91*/
