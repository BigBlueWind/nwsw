...
#----------------- RRC product options --------------------------
# 
#PRDOPTS=-DNH -DCMFILE_REORG_1 -DCMFILE_REORG_2 -DDEBUGP -DCM_PASN_DBG -DCM_INET2 -DCCPU_OPT -DRRC_PHY_CFG_SUPP -UNH_ASN_COND_VALIDATE -DNHU_MULT_SAP_SUPPRT -DLTERRC_REL9 -DNHU_VER2 -DCTF_VER2
PRDOPTS=-DNH -DSM -DLCLNH -DLCSMMILNH -DLCSMNHMILNH -DLCNHMILNH -DLCNHU -DWR -DNX -DLCWRLINHU -DLCNHUINHU \
...
MTOSOPTS=-DSS_MT -DCMFILE_REORG_1 -DSS_SINGLE_THREADED -D_REENTRANT -DDEBUGNOEXIT -DSS_DRVR_SUPPORT
...
#PURIFY
PURCC="purify --cache-dir=/tmp gcc -m32 -DUSE_PURE"
...
$(SY_DIR)/nhac_kwuutl.$(OBJ): $(NHACC_DIR)/nhac_kwuutl.c $(SYS_INC) $(NHACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(NHACC_DIR)/nhac_kwuutl.c -I./cmxta/ -I./header/ -o $(SY_DIR)/nhac_kwuutl.$(OBJ)
...
$(SY_DIR)/nhac_pjuutl.$(OBJ): $(NHACC_DIR)/nhac_pjuutl.c $(SYS_INC) $(NHACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(NHACC_DIR)/nhac_pjuutl.c -I./cmxta/ -I./header/ -o $(SY_DIR)/nhac_pjuutl.$(OBJ)
