...
#endif /* ANSI */
{
   ...
   switch(pst->srcEnt)
   {
     ...
     case ENT_PRM:
     {
       ...
       {
              case EVT_HELLO:
              sendRrcHelloAckToPrm(mBuf);
              SPutMsg(mBuf);
              break;

              case EVT_START_QUERY:
              sendRrcStartIndToPrm();
         ...
         switch(pst->event)
         {
            ...
            default:
               ...
               NH_DBG_FATAL((NH_PRNT_BUF, 
                  "nhActvTsk: Invalid event(%d) from SM\n", pst->event));
               break;
      ...
      case ENTNX :
      {
         switch(pst->event) /* RRC User events */ 
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               NH_DBG_FATAL((NH_PRNT_BUF, 
                 "nhActvTsk: Invalid event(%d) from RRC user\n", pst->event));
               break;
         }/* end of switch on pst->event */
         break;
      }/*end of case ENTNX */
      ...
      case ENTPJ : /* PDCP Layer events */ 
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               NH_DBG_FATAL((NH_PRNT_BUF, 
                     "nhActvTsk: Invalid event(%d) from PDCP\n", pst->event));
               break;
         }/* end of switch on pst->event */
         break;
      }/*end of case ENTPJ */   
      ...
      case ENTKW : /* RLC Layer events */ 
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               NH_DBG_FATAL((NH_PRNT_BUF, 
                     "nhActvTsk: Invalid event(%d) from RLC\n", pst->event));
               break;
         }/* end of switch on pst->event */
         break;
      }/*end of case ENTKW */   
      ...
      case ENTRG : /* MAC Layer events */ 
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               NH_DBG_FATAL((NH_PRNT_BUF, 
                     "nhActvTsk: Invalid event(%d) from MAC\n", pst->event));
               break;
         }/* end of switch on pst->event */
         break;
      }/*end of case ENTRG */   
      ...
      case ENTTF : /* PHY Layer events */ 
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               NH_DBG_FATAL((NH_PRNT_BUF, 
                     "nhActvTsk: Invalid event(%d) from PHY\n", pst->event));
               break;
         }/* end of switch on pst->event */
         break;
      }/*end of case ENTTF */   
      ...
      default:
         SPutMsg(mBuf);
         NH_DBG_FATAL((NH_PRNT_BUF, 
              "nhActvTsk: Event from Unknown entity(%d)\n", pst->srcEnt));
         break;
   } /* end of switch */
