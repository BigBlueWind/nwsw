...
*********************************************************************21*/
/* ve003.102: Added defalut values for PAL */
...
extern "C" {
#endif /* __cplusplus */
CONSTANT CtfBandwidth veDfltCellDlBW = CTF_BW_RB_100;                  /* 50 */ 
CONSTANT CtfBandwidth veDfltCellUlBW = CTF_BW_RB_100;                  /* 50 */ 
...
#else
CONSTANT U16 veDfltPrachCfgIdx = 3;                /* 14 Preamble Format 0 Sfn Any Subframe 1*/
#endif
...
/* PDSCH Cfg */
CONSTANT U16 veDfltRefSignalPower = 18;  
...
CONSTANT U16 veDfltULPwrCtrlAlpha = 0x07; /* TODO 0x05 */
CONSTANT S16 veDfltP0NominalPUCCH = -110; /* -96 */
CONSTANT S16 veDfltP0NominalPUSCH = -110; /* -85 */
...
CONSTANT S16 veDfltUlDeltaPreambleMsg3 = 0x01; /* TODO 0x04*/
...
CONSTANT U8 veDfltAccumulationEnabled = TRUE;               /* en0 */
CONSTANT S16 veDfltP0UEPUCCH = 0;               /* 0 */
CONSTANT U16 veDfltpSRSOffset = 3;               /* 3(-6dB) */
CONSTANT U16 veDfltFilterCoef = 4;               /* fc4 */
/* PUSCH ConfigDedicated */
CONSTANT U16 veDfltBetaOffACKIdx = 9;               /* 9 */
CONSTANT U16 veDfltBetaOffRIIdx =  6;               /* 6 */
CONSTANT U16 veDfltBetaOffCQIIdx = 6;               /* 6 */
/* CQI Reporting Related Information */
CONSTANT U16 veDfltCqiRprtModeAperiodic = 1;               /* rm20 */
CONSTANT U16 veDfltCqiNomPDSCHRSEPREoff = 6;               /* 0 */
...
CONSTANT U16 veDfltTransMode = 0;               /* tm1 */
...
#else
CONSTANT U16 veDfltDrbTPollRetx = 25;               /* ms80 */
#endif
...
CONSTANT CtfUeTxAntMode veDfltAntInfoTxMode = CTF_UE_TX_ANT_MODE_TM1; /* CTF_UE_TX_ANT_MODE_TM1 */
...
CONSTANT U8 veDfltMaxUePerUlSf = 10;
CONSTANT U8 veDfltMaxUePerDlSf = 10;
...
*/
CONSTANT U8 veDfltMaxUlBwPerUe = 100;/*(100/VE_MAX_UE);*/
CONSTANT U16 veDfltMaxDlBwPerUe = 100;
CONSTANT U8 veDfltMaxDlRetxBw = 50;
CONSTANT U8 veDfltMaxDlUeNwTxPerTti = 10;
CONSTANT U8 veDfltMaxUlUeNwTxPerTti = 5;
...
CONSTANT U16 veDfltStartRnti = 104; /* Start RNTI for the range managed by MAC */
CONSTANT U16 veDfltMacRntisize = 100;   /* Indicates contiguous range of RNTI */
...
CONSTANT U8 veDfltThresholdCqi = FALSE;
/*!< Total Dowlink Bandwidth */
CONSTANT U8 veDfltDLTotalBw = 100;
/*!< Total Uplink Bandwidth  */
CONSTANT U8 veDfltULTotalBw = 100;
/*!< Ng value for PHICH */
...
------------ -------- ---- ----------------------------------------------
/main/1      ve003.102 rk        1. Added defalut values for PAL
*********************************************************************91*/
