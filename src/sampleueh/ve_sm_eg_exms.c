...
/**********************************************************************
     ...
     File:     ve_sm_eg_exms.c

     Sid:      ve_sm_eg_exms.c@@/main/2 - Wed Dec  1 08:44:31 2010
...
#endif
{
   ...
   switch(pst->event)
   {
      ...
      default:
         ...
         ret = RFAILED;
#ifdef DEBUGP
       VEDBGP(DBGMASK_SM, (smCb.init.prntBuf, "smEgActvTsk : Received\
         invalid event\n"));
#endif
...
/********************************************************************30**
         ...
         End of file:     ve_sm_eg_exms.c@@/main/2 - Wed Dec  1 08:44:31 2010
