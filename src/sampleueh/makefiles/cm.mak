...
CCcmFLAGS=-DSS_MT_TMR -DSS_FLOAT -ULTE_TDD -URGR_V1 -DLSZV1 #<---Insert cm specific defines here
else
CCcmFLAGS=-DSS_MT_TMR -DSS_FLOAT -ULTE_TDD -DRGR_V1 -DLSZV1 #<---Insert cm specific defines here
endif

ifeq (${BLDENV}, lnx_e2e_ms)
CCsmFLAGS=-DHI -DSB -DEG -DVE -DKW -DKW_PDCP -DPJ -DSZ -DYS -DRG -DNH -UVE_SM_LOG_TO_FILE -URGR_SI_SCH -UTA_NEW -USI_NEW
else
CCsmFLAGS=-DHI -DSB -DEG -DVE -DKW -DKW_PDCP -DPJ -DSZ -DYS -DRG -DNH -UVE_SM_LOG_TO_FILE -DRGR_SI_SCH -DTA_NEW -DSI_NEW
endif
#-------------------------------------------------------------#
#File/Obj macros             
#-------------------------------------------------------------#
