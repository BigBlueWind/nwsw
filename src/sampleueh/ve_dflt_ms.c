...
/********************************************************************20**
     ...
     Sid:      ve_dflt_ms.c@@/main/2 - Wed Dec  1 08:44:23 2010
...
/* AHGOSH:: changed CONSTANT CtfPhichDuration veDfltPhichDur = CTF_PHICH_DUR_NORMAL; */                /* normal */
/*RNT:Changed the phich config to normal, it should be NORMAL ONLY */
CONSTANT CtfPhichDuration veDfltPhichDur = CTF_PHICH_DUR_NORMAL/*CTF_PHICH_DUR_EXTENDED*/;                 /* normal */
CONSTANT CtfPhichResource veDfltPhichRes = CTF_PHICH_RSRC_ONESIXTH;                 /* one*/
/*
 * SystemInfo Blocks
 */
CONSTANT U16 veDfltCellRsrvdForOperUse = 1;  /* Not reserved */
...
CONSTANT S16 veDfltPriSignalPower = 65;
CONSTANT S16 veDfltSecSignalPower =65;
...
/* MS_FIX */
#ifdef LTEMAC_MIMO
CONSTANT CtfAntennaPortsCount veDfltCtfAntPort = CTF_AP_CNT_2;
#else
CONSTANT CtfAntennaPortsCount veDfltCtfAntPort = CTF_AP_CNT_1;
#endif
#ifdef LTEMAC_MIMO
CONSTANT U32 veDfltAntCmnInfoPorts = NhuAntennaInfoCmnantennaPortsCountan1Enum;
#endif
...
#ifdef MSPD_HARQ_ENABLE
CONSTANT U16 veDfltMacCfgMaxHARQTx = 3;               /* 2 */
#else
CONSTANT U16 veDfltMacCfgMaxHARQTx = 0;               /* 2 */
#endif
...
CONSTANT U16 veDfltBetaOffACKIdx = 10;
CONSTANT U16 veDfltBetaOffRIIdx =  12;
CONSTANT U16 veDfltBetaOffCQIIdx = 15;
...
#else
CONSTANT U16 veDfltDrbTPollRetx = 15;               /* ms80 */
#endif
...
/* Ctf Cfg Info */
CONSTANT CmLteUeCategory veDfltUECategory = CM_LTE_UE_CAT_5;
...
CONSTANT U16 veDfltFormatInd = 0;   /* 0 - wideband cqi, over ctf */
...
/* MS_FIX */
#ifdef LTEMAC_MIMO
CONSTANT RgrTxMode veDfltTxModeEnum = RGR_UE_TM_3;               /* TM3 */
#else
CONSTANT RgrTxMode veDfltTxModeEnum = RGR_UE_TM_1;               /* TM1 */
#endif
#ifdef LTEMAC_MIMO
...
#else
/* Periodic CQI reporting mode */
CONSTANT U16 veDfltPrdModeEnum =  0; /* MODE 1-0 */
/* Periodicity values for CQI */
CONSTANT U16 veDfltPrdicityEnum = 2;
#endif
/* Subframe offset */
...
#ifdef LTEMAC_MIMO
CONSTANT U16 veDfltCqiPmiCfgIdx = 38;
#else
CONSTANT U16 veDfltCqiPmiCfgIdx = 38;
#endif
...
CONSTANT U8 veDfltMaxUePerUlSf = 1;
CONSTANT U8 veDfltMaxUePerDlSf = 1;
CONSTANT U8 veDfltMaxUlBwPerUe = 50;
CONSTANT U16 veDfltMaxDlBwPerUe = 50;
CONSTANT U8 veDfltMaxDlRetxBw = 50;
CONSTANT U8 veDfltMaxDlUeNwTxPerTti = 1;
CONSTANT U8 veDfltMaxUlUeNwTxPerTti = 1;
...
CONSTANT U8 veDfltDlCmnCodRateCcchCqi = 15;
/* Sub-band start */
...
CONSTANT U32 veDfltMeasObjIdOne = 1;
CONSTANT U32 veDfltMeasObjIdTwo = 2;
CONSTANT U32 veDfltMeasRprtCfgId = 1;
CONSTANT U32 veDfltMeasIdOne = 1;
CONSTANT U32 veDfltMeasIdTwo = 2;
CONSTANT S32 veDfltMeasA3Offset = 2;
CONSTANT U32 veDfltMeasHysteresis = 0;
CONSTANT U32 veDfltMeasTTT = 0;
CONSTANT U32 veDfltMeasL3FilterCoeff = 0;
CONSTANT U8  veDfltMeasEvntA3 = 2;
CONSTANT U32 veDfltMeaseutraFreqOffset = 0;
CONSTANT U32 veDfltMeasTrgrQnty = 1;
CONSTANT U32 veDfltMeasRprtQnty = 0;
CONSTANT U32 veDfltMeasMaxRprtCells = VE_MAX_TARGET_PREP;
CONSTANT U32 veDfltMeasIntrvl = 0;
CONSTANT U32 veDfltMeasRprtAmnt = 0;
CONSTANT U32 veDfltMeasGapOffset = 0;
CONSTANT U32 veDfltMeasServCellDlFreq = 0;
CONSTANT U16 veDfltMeasServCellDlBwdth = 0;
CONSTANT U32 veDfltMeasNghCellDlFreq = 0;
CONSTANT U16 veDfltMeasNghCellDlBwdth = 0;
/* 1 => 100ms */
CONSTANT U16 veDfltTmrsAndConstsT304 = 0x06;
CONSTANT U16 veDfltPrachMskIdx = 0x00;
...
/********************************************************************30**
         ...
         End of file:     ve_dflt_ms.c@@/main/2 - Wed Dec  1 08:44:23 2010
