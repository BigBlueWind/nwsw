...
/**********************************************************************
     ...
     File:     ve_sm_ys_exms.c

     Sid:      ve_sm_ys_exms.c@@/main/2 - Wed Dec  1 08:44:40 2010
...
#endif
{
   ...
   switch(pst->event)
   {
      ...
      default:
         ...
         ret = RFAILED;
#ifdef DEBUGP
       VEDBGP(DBGMASK_SM, (smCb.init.prntBuf, "smYsActvTsk : Received\
         invalid event\n"));
#endif
         break;
   }
...
/********************************************************************30**
         ...
         End of file:     ve_sm_ys_exms.c@@/main/2 - Wed Dec  1 08:44:40 2010
