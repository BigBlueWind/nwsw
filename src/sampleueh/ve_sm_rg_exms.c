...
/**********************************************************************
     ...
     Sid:      ve_sm_rg_exms.c@@/main/2 - Wed Dec  1 08:44:37 2010
...
#endif
{
   ...
   switch(pst->event)
   {
      ...
      default:
         ...
         ret = RFAILED;
#ifdef DEBUGP
       VEDBGP(DBGMASK_SM, (smCb.init.prntBuf, "smRgActvTsk : Received\
         invalid event\n"));
#endif
         break;
   }
...
/********************************************************************30**
         ...
         End of file:     ve_sm_rg_exms.c@@/main/2 - Wed Dec  1 08:44:37 2010
