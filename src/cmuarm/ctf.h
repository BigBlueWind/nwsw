...
#ifdef PWAV_TS
/** Set Time Stamp Request event */
#define EVTCTFUEHSETTSREQ 9 
/** Set Time Stamp Resonse event */
#define EVTCTFUEHSETTSRSP 10
/** Set Time Stamp Confirm event */
#define EVTCTFUEHSETTSCFM 11
#endif
