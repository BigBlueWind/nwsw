...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(cfg, EVTLCZCFGREQ,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(cfm, EVTLCZCFGCFM, mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(sts, EVTLCZSTSREQ,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(cfm, EVTLCZSTSCFM,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(sta, EVTLCZSTAREQ,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(cfm, EVTLCZSTACFM,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /*ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(usta, EVTLCZSTAIND,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(cntrl, EVTLCZCNTRLREQ, mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(cfm, EVTLCZCNTRLCFM,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#endif /* ANSI */
{
   ...
   if (pst->selector == LCZ_SEL_LC) {
      if (cmPkCzMngmt(trac, EVTLCZTRCIND,mBuf) != ROK) {
#if (ERRCLASS & ERRCLS_ADD_RES)
         SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId,
            (S8*)__FILE__, __LINE__, (ErrCls)ERRCLS_ADD_RES,
...
#else /* ANSI */
PUBLIC S16 cmPkCzPeerLstCfg(param, mBuf)
CzPeerLstCfg *param;
Buffer *mBuf;
#endif /* ANSI */
{
   ...
   if (param->nmbPeers)
   {
    ...
    (Void)SPutSBuf(0,0,(Data*)param->peerCfg,
...
#else /* ANSI */
PUBLIC S16 cmPkCzCfg(param, elmnt, mBuf)
CzCfg *param;
Elmnt elmnt;
Buffer *mBuf;
#endif /* ANSI */
{
  ...
  switch(elmnt) 
  {
   ...
   switch(elmnt) {
      case STCZPEER:
         CMCHKPK(cmPkCzPeerLstCfg, &param->u.peerLst, mBuf);
         break;
      case STCZSCTSAP:
...
#else /* ANSI */
PUBLIC S16 cmPkCzMngmt(param,eventType, mBuf)
CzMngmt *param;
S16 eventType;
Buffer *mBuf;
#endif /* ANSI */
   ...
   TRC3(cmPkCzMngmt)
      ...
      switch(eventType) 
      {
         ...
         case  EVTLCZCNTRLREQ :
            ...
            break;
         case  EVTLCZCFGREQ :
            ret1=cmPkCzCfg(&param->t.cfg, param->hdr.elmId.elmnt,mBuf);
            break;
         default :
            break;
      }
