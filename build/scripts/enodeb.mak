...
CMFLAGS=-DSS_MT_TMR -DSS_FLOAT -ULTE_TDD -DMSPD -ULTEMAC_MIMO -DMSPD_MEMCPY#<---Insert cm specific defines here
...
YSFLAGS=-DTF -DYS -DYS_LTE_PAL -DLTE_PAL_ENB -UYS_PERF_MEAS -DLCCTF -DYS_MSPD\
	...
	-DYS_MS_PHY  -UYS_JMP_PHY_RUN_STE -DYS_MIB_WARND -DYS_PHY_STOP_AUTO -UYS_SIMUL_PUSCH_RECP -DYS_ALLOC_ON_NEED -UYS_RRC_CONN_SIMUL -UGEN_DUMMY_SR -UADI_BAND_AUTOMATE \
	-DYS_MS_NO_TA
KWFLAGS= -DKW_PDCP -UNH -USM -DPTPJLIB -DLTE_HENB -DKW_BG_UL_PROC -DKW_BG_DL_PROC
...
C4GMXENBE2EOPTS= -DMX_ARM_ENABLED -DLOWERARM -DSCHEDULER -DUL_CEVA -DUSECEVA\
		  ...
		  -DCMFIlE_REORG_2 -DSSINT2 -DCMKV2 -DSS_PERF -D SS_WL_REGION=1\
	          ...
	          -UYS_ALL_PERF -DPWAV_HC -DPWAV -UPWAV_LARM_LOGS -DPWAV_TS
