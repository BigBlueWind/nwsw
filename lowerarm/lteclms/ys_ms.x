...
EXTERN S16 ysMsPrcUciInd ARGS((
PRXSDUIND       rxSduInd,
YsCellCb        *cellCb
));

EXTERN S16 ysMsPrcPucchPwrInd ARGS((
PRXSDUIND       rxSduInd,
YsCellCb        *cellCb
));

EXTERN S16 ysMsUlmPrcPucch ARGS((
PRXSDUIND       rxSduInd,
YsCellCb        *cellCb
));

#ifdef DLHQ_RTT_OPT  
EXTERN S16 ysMsUlmPrcUlCntrl ARGS((
...
EXTERN Void ysMsGetRntiFrmChanId ARGS((YsCellCb * cellCb, CmLteRnti *rnti, \
         U8 subframe, U16 channelId));
EXTERN S16 ysMsSndMissedCrcInd ARGS((YsCellCb * cellCb));
...
EXTERN S16 ysMsDlmSndVectSDU ARGS ((
YsCellCb        *cellCb
));

EXTERN Void ysSendCrcToMac ARGS((
YsCellCb          *cellCb,
TfuCrcIndInfo     *crcIndInfo
));

EXTERN S16 ysMsUtlInitPhyList ARGS ((
YsPhyLstCp        *lstCp
));

EXTERN S16 ysMsCfgModTxPwrCfg ARGS ((
CtfCellRecfgInfo  *cellRecfg
));
#ifdef PWAV
