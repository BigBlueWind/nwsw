...
extern MXRC YsLiMsgHandler (Void * ysCtx, Void * msg);
...
PUBLIC MXRC YsLiMsgHandler (Void * ysCtx, Void * msg)
{
...
#ifdef MSPD_MLOG_NEW
   MLogTask(PID_CL_PHY_MSG, RESOURCE_LARM, t, MacGetTick());
#endif
...
#endif
{
   ...
   cellCb.timingInfo.subframe = (U8) -1; 
