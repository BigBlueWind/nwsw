...
#ifdef DEBUGP
#define _ysp                       ysCb.ysInit.prntBuf
#else
#define _ysp                       NULLP
#endif
...
{ \
   ...
   { \
      ...
      sprintf (ysCb.ysInit.prntBuf, "%s", _arg1); \
...
#else
#define YS_DBG_ERR(_arg) 
#define YS_DBG_PARAM(_arg)
#define YS_DBG_INFO(_arg)
#define YS_DBG_FATAL(_arg)
#endif
/* display result dump */
...
#define YS_LOGERROR(errCls, errCode, errVal, errDesc)                      \
        SLogError(ysCb.ysInit.ent, ysCb.ysInit.inst, ysCb.ysInit.procId,   \
                  ...
                  (CONSTANT Txt *)&(__FILE__), __LINE__, errCls, errCode, (ErrVal)errVal,     \
...
{                                                                                                \
   if(ysCb.ysInit.logMask & SS_DIAG_LVL0)                                                         \
   {                                                                                             \
 ...
 *  
*/
#define YS_DIAG_LVL1(_tknId, _splArgEnum, _splArg, _string, _arg1, _arg2, _arg3, _arg4)            \
{                                                                 \
   if(ysCb.ysInit.logMask & SS_DIAG_LVL1)                             \
   {                                                              \
 ...
 *  
*/
#define YS_DIAG_LVL2(_tknId, _splArgEnum, _splArg, _string, _arg1, _arg2, _arg3, _arg4)       \
{                                                              \
   if(ysCb.ysInit.logMask & SS_DIAG_LVL2)                            \
   {                                                              \
 ...
 *  
*/
#define YS_DIAG_LVL3(_tknId, _splArgEnum, _splArg, _string, _arg1, _arg2, _arg3, _arg4)        \
{                                                              \
   if(ysCb.ysInit.logMask & SS_DIAG_LVL3)                            \
   {                                                              \
 ...
 *  
*/
#define YS_DIAG_LVL4(_tknId, _splArgEnum, _splArg, _string, _arg1, _arg2, _arg3, _arg4)        \
{                                                              \
   if(ysCb.ysInit.logMask & SS_DIAG_LVL4)                            \
   {                                                              \
...
/main/2      ys005.102     psb             1. Fixed warnings for g++ compilation on Linux
                           psb             1. Fix for TIC_ID:ccpu00119532: Changed the
                                              way of debug print.
*********************************************************************91*/
