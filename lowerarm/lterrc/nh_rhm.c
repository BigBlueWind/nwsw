...
#endif /* ANSI */
{
   ...
   if(RFAILED == ret)
   {  
      NH_DBG_ERROR((NH_PRNT_BUF, "cmHashListInit failure.\n"));
      /* Raise Alarm */                
...
#endif /* ANSI */
{
   ...
   {
      /* Log Error */
      NH_DBG_ERROR((NH_PRNT_BUF, "cmHashListInsert failure.\n"));
      /* Raise Alarm */
      dgn.type = LNH_USTA_DGNVAL_NONE;
      nhSendLmAlarm(LCM_CATEGORY_RESOURCE,LNH_EVENT_OPERATION_FAIL,
                    LCM_CAUSE_HASH_FAIL,&dgn);
...
#endif /* ANSI */
{
   ...
   {
       /* Log Error */
      NH_DBG_ERROR((NH_PRNT_BUF, "cmHashListDelete Failed.\n"));
      /* Raise Alarm */
      dgn.type = LNH_USTA_DGNVAL_NONE;
      nhSendLmAlarm(LCM_CATEGORY_RESOURCE, LNH_EVENT_OPERATION_FAIL,
                    LCM_CAUSE_HASH_FAIL, &dgn);
...
#endif /* ANSI */
{
   ...
   {
      /* Log Error */
      NH_DBG_ERROR((NH_PRNT_BUF, "cmHashListDeinit failure.\n"));
      /* Raise Alarm */
      dgn.type = LNH_USTA_DGNVAL_NONE;
      nhSendLmAlarm(LCM_CATEGORY_RESOURCE,LNH_EVENT_OPERATION_FAIL,
                    LCM_CAUSE_HASH_FAIL,&dgn);
