...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,
         "NhUiNhuBndCfm(pst, suId(%d), status(%d))\n", suId, status));
...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,
         "NhUiNhuCellCfgCfm(pst, suId(%d) ", spId));
...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,
         "NhUiNhuPdcpSduStaCfm(pst, spId(%d)\n", suId));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuBndCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuDatInd() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuErrInd() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuStaInd() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuDatCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuCfgCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuCellCfgCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuDecodeCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuCountCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuPdcpSduStaCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtUiNhuEncodeCfm() called"));
