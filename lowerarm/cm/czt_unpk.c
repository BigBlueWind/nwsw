...
/**********************************************************************
     ...
     Sid:      czt_unpk.c@@/main/2 - Thu Aug 25 18:46:50 2011
                ...
                switch( param->choice.val ) 
                {
                        ...
                        case CAUSE_TRANSPORT :
                                ...
                                CMCHKUNPK(cmUnpkTknU32, &param->val.transport,
                                          mBuf); 
                                break;
/* czt_unpk_c_001.main_2 :  Fix for the build warnings, all changes are guarded
...
/**********************************************************************
        End of file:     czt_unpk.c@@/main/2 - Thu Aug 25 18:46:50 2011
**********************************************************************/
...
/main/2               czt_unpk_c_001.main_2 akaranth 1.Fix for the build warnings, all changes are guarded
                                                       under CZTV1 flag, for backward compatability.
*********************************************************************91*/
