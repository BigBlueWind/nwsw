...
/* tfu_h_001.main_4 - Changes for MIMO feature addition */
#ifndef LTEMAC_MIMO
#define TFU_MAX_TB                1    /*!< Maximum number of Transport blocks. */
#else
...
#ifdef LTEMAC_SPS
#define TFU_DCIFMT1A_PDCCHORDER   0
#define TFU_DCIFMT1A_PDSCHINFO    1
#define TFU_DCIFMT1A_REL          2
#endif /* LTEMAC_SPS*/
/* Tunable parameter */
