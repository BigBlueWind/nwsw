...
/* rgu_x_001.main_3 - ADD - L2M Support */
#ifdef LTE_L2_MEAS
   Bool         snMapPres;           /*!< Sequence number mapping info pres or
                                          not? */
   RguSnMapInfo *rguSnInfo;          /*!< Sequence Number mapping info from RLC
                                       for packet delay calculation purpose in
                                       L2 Measurements */
#endif /* LTE_L2_MEAS */
}RguDatReqTb;
...
#ifdef LTE_L2_MEAS
#ifdef LTEMAC_R9
   RgL2MeasUlThrpTimInfo timeInfo; /*!< T2 and T1 Info */
#endif
#endif
}RguLchDatInd;
...
EXTERN S16 cmPkRguL2MUlThInfo ARGS((
 RgL2MeasUlThrpTimInfo* param,
 Buffer *mBuf
));

EXTERN S16 cmUnpkRguL2MUlThInfo ARGS ((
 RgL2MeasUlThrpTimInfo * param,
 Buffer *mBuf
 ));
#endif
