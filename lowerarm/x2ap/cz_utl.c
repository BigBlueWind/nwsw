...
#endif /* endif ANSI */
{
   ...
   S16 numComp = 1;
   /*x2ap build warning fix---variable tmpUeInfo is never used*/
   /*CztUeInfo   tmpUeInfo;*/
   S16 cnt;
   Mem sMem;
   ...
   /*CZ_SET_ZERO(&tmpUeInfo, sizeof(CztUeInfo));*/
   ...
   CZ_FILL_TKN(contHocnl->member[cnt].value.u.cztUE_X2AP_ID_Old /* Fix for ccpu00117267 */,
                                                      ueInfo->oldUEX2APId);
   ...
   if(CZ_UNKNOWN_UE_X2AP_ID != ueInfo->newUEX2APId)
   {
      ...
      CZ_FILL_TKN(contHocnl->member[cnt].value.u.cztUE_X2AP_ID_New /* Fix for ccpu00117267 */,
                                                         ueInfo->newUEX2APId);
      cnt++;
   }
...
#endif /* endif ANSI */
{
   ...
   CZ_FILL_TKN(failIe->protocolIEs.member[czCnt].criticality,
                                                   CztCriticalityrejectEnum);
   CZ_FILL_TKN(failIe->protocolIEs.member[czCnt].value.u.cztMeasurement_ID,
                                                      rsrcInfo->eNb1measId);
...
#endif /* endif ANSI */
{
   ...
   CZ_FILL_TKN(failIe->protocolIEs.member[czCnt].value.u.czteNB1ECGI.pres,
                                               PRSNT_NODEF);

   CZ_FILL_TKN_STR_OSXL(
        (failIe->protocolIEs.member[czCnt].value.u.czteNB1ECGI.pLMN_Identity),
  ...
  &(failIe->protocolIEs.member[czCnt].value.u.czteNB1ECGI.eUTRANcellIdentifier),
   ...
   CZ_FILL_TKN(failIe->protocolIEs.member[czCnt].value.u.czteNB2ECGI.pres,
                                                             PRSNT_NODEF);

   CZ_FILL_TKN_STR_OSXL(
        (failIe->protocolIEs.member[czCnt].value.u.czteNB2ECGI.pLMN_Identity),
...
#endif /* endif ANSI */
{
   ...
   if (CZ_UNKNOWN_UE_X2AP_ID != czTmpUeInfo.oldUEX2APId)
   {
      ...
      CZ_FILL_TKN(errIe->protocolIEs.member[cnt].criticality,
                                                    CztCriticalityignoreEnum);
      CZ_FILL_TKN(errIe->protocolIEs.member[cnt].value.u.cztUE_X2AP_ID_Old /* Fix for ccpu00117267 */,
   ...
   if (CZ_UNKNOWN_UE_X2AP_ID != czTmpUeInfo.newUEX2APId)
   {
      ...
      CZ_FILL_TKN(errIe->protocolIEs.member[cnt].criticality,
                                                 CztCriticalityignoreEnum);
      CZ_FILL_TKN(errIe->protocolIEs.member[cnt].value.u.cztUE_X2AP_ID_New /* Fix for ccpu00117267 */,
