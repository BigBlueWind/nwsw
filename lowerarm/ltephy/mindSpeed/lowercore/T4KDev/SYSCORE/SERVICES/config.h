...
#define CRAMVAR	            __attribute__((section(".CRAMSECT.")))
...
#ifndef NO_USE_DDR1
    #define SVSR_API_LOGGER_BUF_SIZE   (50 * 1024 * 1024)  // set to 0 to remove DDR1 cacheable heap
#else
...
#define SVSR_API_LOGGER_DEF_MASK_ENA    ((1<<1)|(1<<3)|(1<<4)|(1<<7)|(1<<10)|(1<<11)|(1<<12)|(1<<14)|(1<<17)|(1<<19)|(1<<22)|(1<<23)|(1<<24)|(1<<25))
...
#ifdef CACHED_ICPU_LARM
#define I_CPU_RX_CACHED
#define I_CPU_TX_CACHED
#endif /* CACHED_ICPU_LARM */
