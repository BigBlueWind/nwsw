//-------------------------------------------------------------------------------------------
/** @file DOX_INTERNAL Ad361lte10_b1.h
 *
 * @brief
...
const ADRADPROFILE Ad261Lte10Mhz_2_1GHZ[] = {
//************************************************************
...
{SPIWR,0x242,0x0E},// Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
{SPIWR,0x238,0x20},// Set VCO Cal Offset[3:0]
...
{SPIWR,0x23B,0x1B},// Set Rx Synth Loop filter Icp
//************************************************************
// Setup Synthesizer
//************************************************************
...
{SPIWR,0x27B,0x16},// Set Tx Synth Loop filter Icp
...
{SPIWR,0x231,0xC3},// Write Rx Synth Integer Freq Word[7:0]
...
{SPIWR,0x271,0xD6},// Write Tx Synth Integer Freq Word[7:0] (starts VCO cal)
{SPIWR,0x005,0x11},// Set LO divider setting
...
{SPIWR,0x0FC,0x23},// Incr Step Size, ADC Overrange Size
