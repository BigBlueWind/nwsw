...
#define MSGS_NMMAPP             0x000A

#define MSGS_LAST               0x000A      // DO NOT FORGET TO REDEFINE!
...
#define MSGS_DI                 0x002B      // di/adi
#define MSGS_NMM                0x0031
...
#define PHY_LTE_SHUTDOWN                0x401E
#define MAC_RXBUFDRAIN_IND          0x401F

#define MAC_TEST_TXVECTOR_CFG        0x4020
#define MAC_TEST_RXVECTOR_CFG        0x4021

#define MAC_PHY_STOP_IND                0x7001

//MAC-NMM parameters
#define MAC_NMM_IND                 0x4050
...
#define PHY_LTE_NMM_MSG         0x5150
#define PHY_TEST_INVALID_DATA	0x5152
...
#define DIAG_TEST_GEN_API           0xF80D
...
#define PAR_PHYCFGBITS              0x0045
#define PAR_P_B                     0x0046
#define PAR_PHICH_RESOURCE          0x0047
#define PAR_PHICH_DURATION          0x0048
...
// Power parameters
#define PAR_RS_EPRE                 0x00A9
#define PAR_PSS_RA                  0x00AA
#define PAR_SSS_RA                  0x00AB

#define PAR_NMM_MODE            0x00B0
...
#define PAR_HOPPING_MODE           0x00BE
#define PAR_PUSCH_HOPPING_OFFSET   0x00BF
#define PAR_GR_HOPPING_ENA         0x00C0
#define PAR_GR_ASSIG_PUSCH         0x00C3
#define PAR_SEQ_HOPPING_ENA        0x00C4
#define PAR_nSB                    0x00C5
...
#define PAR_PUSCH_DED_RIIDX         0xF5
#define PAR_PUSCH_DED_CQIIDX        0xF6
#define PAR_PUSCH_DED_N_nRI         0xF8
#define PAR_PUSCH_DED_N_nr1CQI      0xF9
#define PAR_PUSCH_DED_N_nrg1CQI     0xFA

#define PAR_HARQ_SUPPORT            0xFB
#define PAR_CQI_SUPPORT             0xFC


///PARAMS FOR INVALID DATA TESTING
#define PAR_INVALID_DELAY           0xFB
#define PAR_INVALID_API_CORRUPTION  0xFC
...
// make struct-names and fields identical as with 4gmx
#if defined(USE_LINUX) || defined(WIN32)
typedef struct _API_HEADER_
{
    U32      Control;        // See: ApiCtrlFlags
    U32      Length;         // The message length
    U16      Type;           // The type of API command see:ApiTypesID
    U16      SrcInstID;      // The source instance ID
    U16      DstInstID;      // The destination instance ID
...
{
    U16  ParamID;
    U16  ParamLength;    // The payload length + length of this header in bytes
