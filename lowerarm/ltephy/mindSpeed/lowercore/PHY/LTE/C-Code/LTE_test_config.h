...
typedef struct tagFLAGPASSFAIL
{
    S8 Flag_PDSCH_IQ;
    S8 Flag_UL_RXBITS;
    S8 Flag_PUSCH;
    S8 Flag_PUSCH_Stat;
    S8 Flag_PUSCH_TIMING_ADV;
    S8 Flag_PUSCH_RSSI;
    S8 Flag_PUSCH_FREQ_OFFSET;
    S8 Flag_PUSCH_SINR;
    S8 Flag_MUX_PUSCH;
    S8 Flag_PUCCH;
    S8 Flag_PUCCH_Stat;
    S8 Flag_PUCCH_TIMING_ADV;
    S8 Flag_PUCCH_FREQ_OFFSET;
    S8 Flag_PUCCH_SINR;
    S8 Flag_PUCCH_RSSI;
    S8 Flag_PRACH;
    S8 Flag_SRS;
    ...
    S8 Flag_RIP;
    S8 Flag_THERM_NOISE;
} FLAG_PASS_FAIL, *PFLAG_PASS_FAIL;
