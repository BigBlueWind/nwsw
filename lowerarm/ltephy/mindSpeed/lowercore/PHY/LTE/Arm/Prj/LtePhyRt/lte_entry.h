...
{
    UINT32 nInstanceID;
    UINT32 nNMMInstanceID;
    UINT32 n3GNWLInstanceID;
    UINT32 nMsgHandlerID; // LTE Msg handler
    UINT32 nMacInstanceId;
    UINT32 nUpperNMMInstanceId;
    UINT32 nDummy;
...
INLINE void SetUNmmInstanceId(UINT32 MacId)
{
    pLteCtx->nUpperNMMInstanceId = MacId;
}

INLINE UINT32 GetUNmmInstanceId(void)
{
    return pLteCtx->nUpperNMMInstanceId;
}
