...
/***********************************************************************
   ...
   Func  : egMakes5STOPPAGINGINDGmEntry
...
#ifdef ANSI
PRIVATE void egMakes5STOPPAGINGINDGmEntry
(
LegMsgEntry               *gmSTOPPAGINGINDCb                         /* GM Control Block */
)
#else
PRIVATE void egMakes5STOPPAGINGINDGmEntry(gmSTOPPAGINGINDCb)
LegMsgEntry               *gmSTOPPAGINGINDCb;
#endif
{
   U8 ieCnt = 0;
   TRC2(egMakes5STOPPAGINGINDGmEntry);

   /* Populate the STOPPAGINGIND GM Entry */
   gmSTOPPAGINGINDCb->msgType = EG_S5_STOPPAGINGIND_CMD_CODE;
   gmSTOPPAGINGINDCb->nmbIeProp = EG_S5_STOPPAGINGIND_NMB_IES;
...
} /* End of egMakes5STOPPAGINGINDGmEntry */


/***********************************************************************

   Func  : egMakes5TRCSESACTGmEntry
...
#ifdef ANSI
PRIVATE void egMakes5TRCSESACTGmEntry
(
LegMsgEntry               *gmTRCSESACTCb                         /* GM Control Block */
)
#else
PRIVATE void egMakes5TRCSESACTGmEntry(gmTRCSESACTCb)
LegMsgEntry               *gmTRCSESACTCb;
#endif
{
   U8 ieCnt = 0;
   TRC2(egMakes5TRCSESACTGmEntry);

   /* Populate the TRCSESACT GM Entry */
   gmTRCSESACTCb->msgType = EG_S5_TRCSESACT_CMD_CODE;
   gmTRCSESACTCb->nmbIeProp = EG_S5_TRCSESACT_NMB_IES;
...
} /* End of egMakes5TRCSESACTGmEntry */


/***********************************************************************

   Func  : egMakes5TRCSESDEACTGmEntry
...
#ifdef ANSI
PRIVATE void egMakes5TRCSESDEACTGmEntry
(
LegMsgEntry               *gmTRCSESDEACTCb                         /* GM Control Block */
)
#else
PRIVATE void egMakes5TRCSESDEACTGmEntry(gmTRCSESDEACTCb)
LegMsgEntry               *gmTRCSESDEACTCb;
#endif
{
   U8 ieCnt = 0;
   TRC2(egMakes5TRCSESDEACTGmEntry);

   /* Populate the TRCSESDEACT GM Entry */
   gmTRCSESDEACTCb->msgType = EG_S5_TRCSESDEACT_CMD_CODE;
   gmTRCSESDEACTCb->nmbIeProp = EG_S5_TRCSESDEACT_NMB_IES;
...
} /* End of egMakes5TRCSESDEACTGmEntry */
...
#endif
{
   ...
   egMakes5STOPPAGINGINDGmEntry(&gmEntry[gmMsgCount]);
   gmMsgCount++;

   /* Populating TRCSESACT GM Entry */
   egMakes5TRCSESACTGmEntry(&gmEntry[gmMsgCount]);
   gmMsgCount++;

   /* Populating TRCSESDEACT GM Entry */
   egMakes5TRCSESDEACTGmEntry(&gmEntry[gmMsgCount]);
   gmMsgCount++;
