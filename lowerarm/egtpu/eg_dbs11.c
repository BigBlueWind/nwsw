...
#endif
{
   ...
   if( ret == ROK && (gmCRTBREREQCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     {
       egMakeAppChildIeEntry((gmCRTBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTBREREQ_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmCRTBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_TFT_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0);

       egMakeAppChildIeEntry((gmCRTBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0);

       egMakeAppChildIeEntry((gmCRTBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,1,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_QOS_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_FLAGS_IETYPE,
           EG_IE_OPTIONAL,0,FALSE, 0 );
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmCRTBRERSPCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmCRTBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTBRERSP_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmCRTBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );
...
#endif
{
   ...
   egMakeAppIeProp(&gmCRTFWDTUNREQCb->ieProperties[ieCnt],
                    EG_S103_PDN_FW_INFO_IETYPE,EG_IE_MANDATORY,0,FALSE);
...
#endif
{
   ...
   egMakeAppIeProp(&gmCRTFWDTUNRSPCb->ieProperties[ieCnt],
                    EG_S1U_DATA_FW_IETYPE,EG_IE_CONDITIONAL,0,FALSE);
...
#endif
{
   ...
   if( ret == ROK && (gmCRTINDDATFWDTUNREQCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTINDDATFWDTUNREQ_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );
       ...
       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,2,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,3,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,4,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,5,FALSE, 0 );
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmCRTINDDATFWDTUNRSPCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTINDDATFWDTUNRSP_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTINDDATFWDTUNRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );
...
#endif
{
   ...
   if( ret == ROK && (gmCRTSESREQCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       ...
       egMakeAppChildIeEntry((gmCRTSESREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTSESREQ_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmCRTSESREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_TFT_IETYPE,
           EG_IE_OPTIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,3,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_QOS_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );
     }
   }
   ieCnt++;
   ...
   if(ret == ROK && gmCRTSESREQCb->ieProperties[ieCnt].groupedIe != NULLP)
   {
     ...
     {
       egMakeAppChildIeEntry((gmCRTSESREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTSESREQ_BEARER_CNTX1_GRP_NMB_IES);
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTSESRSP_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_TFT_IETYPE,
           EG_IE_OPTIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,2,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_QOS_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_FLAGS_IETYPE,
           EG_IE_OPTIONAL,0,FALSE, 0 );
     }
   }
   ieCnt++;
   ...
   if( ret == ROK && (gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     {
       egMakeAppChildIeEntry((gmCRTSESRSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_CRTSESRSP_BEARER_CNTX1_GRP_NMB_IES);
...
#endif
{
   ...
   if( ret == ROK && (gmDELBRECMDCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmDELBRECMDCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_DELBRECMD_BEARER_CNTX0_GRP_NMB_IES);
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmDELBREFLRINDCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmDELBREFLRINDCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_DELBREFLRIND_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmDELBREFLRINDCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );
     }
   }
   ieCnt++;
...
#endif
{
   ...
   /* Populate BEARER_CNTX IE Properties */
   egMakeAppIeProp(&gmDELBREREQCb->ieProperties[ieCnt],
                    EG_BEARER_CNTX_IETYPE,EG_IE_OPTIONAL,0,FALSE);
   ...
   if( ret == ROK && (gmDELBREREQCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmDELBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_DELBREREQ_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmDELBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmDELBRERSPCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmDELBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_DELBRERSP_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmDELBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmMODBRECMDCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       ...
       egMakeAppChildIeEntry((gmMODBRECMDCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_MODBRECMD_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmMODBRECMDCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_QOS_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmMODBREREQCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmMODBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_MODBREREQ_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmMODBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmMODBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_FLAGS_IETYPE,
           EG_IE_OPTIONAL,0,FALSE, 0 );
     }
   }
   ieCnt++;
   ...
   if( ret == ROK && (gmMODBREREQCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     {
       egMakeAppChildIeEntry((gmMODBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_MODBREREQ_BEARER_CNTX1_GRP_NMB_IES);
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmMODBRERSPCb->ieProperties[ieCnt].groupedIe)  != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmMODBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_MODBRERSP_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmMODBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmMODBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );
     }
   }
   ieCnt++;
   ...
   if( ret == ROK && (gmMODBRERSPCb->ieProperties[ieCnt].groupedIe)  != NULLP)
   {
     ...
     {
       egMakeAppChildIeEntry((gmMODBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_MODBRERSP_BEARER_CNTX1_GRP_NMB_IES);
...
#endif
{
   ...
   if( ret == ROK && (gmUPDBREREQCb->ieProperties[ieCnt].groupedIe)  != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       egMakeAppChildIeEntry((gmUPDBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_UPDBREREQ_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmUPDBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_TFT_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmUPDBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_QOS_IETYPE,
           EG_IE_CONDITIONAL,0,FALSE, 0 );

       egMakeAppChildIeEntry((gmUPDBREREQCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_FLAGS_IETYPE,
           EG_IE_OPTIONAL,0,FALSE, 0 );
     }
   }
   ieCnt++;
...
#endif
{
   ...
   if( ret == ROK && (gmUPDBRERSPCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       ...
       egMakeAppChildIeEntry((gmUPDBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_EBI_IETYPE,
           EG_IE_MANDATORY,0,FALSE, EG_UPDBRERSP_BEARER_CNTX0_GRP_NMB_IES);

       egMakeAppChildIeEntry((gmUPDBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_CAUSE_IETYPE,
           EG_IE_MANDATORY,0,FALSE, 0 );
     }
   }
   ieCnt++;
