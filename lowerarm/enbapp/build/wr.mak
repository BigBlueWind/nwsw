...
ifeq (${BLD},seum)
CCwrFLAGS=-DWR_RELAY -DEU_DAT_APP -DEGTP_U -DNX -DPX -DUZ -DEU -DKW_PDCP -UPTNXLIPJU -UPTWRLIRGR -DDEBUGP -UTFU_TDD -DTFU_WRR_2 -DLCEGUIEGT -DLCWRLICTF -DLCWRLINHU -DxLCPJUIPJU -DLCWRLIRGR -ULTE_TDD -UTA_NEW -USI_NEW -URGR_SI_SCH -DSS_MT_TMR
else
ifeq (${BLD},picoseum)
CCwrFLAGS=-DWR_RELAY -DEU_DAT_APP -DEGTP_U -DNX -DPX -DUZ -DEU -DKW_PDCP -UPTNXLIPJU -UPTWRLIRGR -DDEBUGP -UTFU_TDD -DTFU_WRR_2 -DLCEGUIEGT -DLCWRLICTF -DLCWRLINHU -DxLCPJUIPJU -DLCWRLIRGR -ULTE_TDD -UWR_PICO -UWR_WITHOUT_CNE -DWIRESHARK_LOG -UYS_PICO -DSI_NEW -DYS_PICO -DWR_PICO  -DSS_MT_TMR
else
ifeq (${BLDENV},lnx_e2e_ms)
CCwrFLAGS=-DWR_RELAY -DEU_DAT_APP -DEGTP_U -DNX -DPX -DUZ -DEU -DKW_PDCP -DPTNXLIPJU -DPTWRLIRGR -DDEBUGP -UTFU_TDD -DTFU_WRR_2 -DLCEGUIEGT -DLCWRLICTF -DLCWRLINHU -DxLCPJUIPJU -DLCWRLIRGR -ULTE_TDD -DLCSMNHMILNH -DDG -UWR_DG_OAM -DVALIDATION_CHK -DWR_TEST_CODE -DWR_TEST_CLI -DENB_OVRLOAD -UMME_LDBAL -DSS_MT_TMR
else
...
CCwrFLAGS=-DWR_RELAY -DEU_DAT_APP -DEGTP_U -DNX -DPX -DUZ -DEU -DKW_PDCP -DKW -UPTNXLIPJU -UPTWRLIRGR -DDEBUGP -UTFU_TDD -DTFU_WRR_2 -DLCEGUIEGT -DLCWRLICTF -DLCWRLINHU -DxLCPJUIPJU -DLCWRLIRGR -ULTE_TDD -DTA_NEW -DSI_NEW -DRGR_SI_SCH -UWR_SM_LOG_TO_FILE  -DDG -UWR_DG_OAM -DVALIDATION_CHK -DWR_OAM_TEST -DWR_TEST_CODE -DWR_TEST_CLI -DENB_OVRLOAD -UMME_LDBAL -DSS_MT_TMR
endif
endif
endif
endif
...
$(OUT_DIR)/wr_umm_meas.$(OBJ): $(IN_DIR)/wr_umm_meas.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_meas.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
        $(IN_DIR)/wr_umm_meas.$(SRC)
$(OUT_DIR)/wr_umm_anrmeas.$(OBJ): $(IN_DIR)/wr_umm_anrmeas.$(SRC) $(ALL_INC)
	$(CC) -c -o$(OUT_DIR)/wr_umm_anrmeas.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
        $(IN_DIR)/wr_umm_anrmeas.$(SRC)
		  
$(OUT_DIR)/wr_lmm.$(OBJ): $(IN_DIR)/wr_lmm.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_lmm.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
        $(IN_DIR)/wr_lmm.$(SRC)

$(OUT_DIR)/wr_emm_neighenb.$(OBJ): $(IN_DIR)/wr_emm_neighenb.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_neighenb.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
        $(IN_DIR)/wr_emm_neighenb.$(SRC)

$(OUT_DIR)/wr_emm_cfg.$(OBJ): $(IN_DIR)/wr_emm_cfg.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_cfg.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
        $(IN_DIR)/wr_emm_cfg.$(SRC)

$(OUT_DIR)/wr_smm_smallcell.$(OBJ): $(IN_DIR)/wr_smm_smallcell.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_smm_smallcell.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
        $(IN_DIR)/wr_smm_smallcell.$(SRC)

$(OUT_DIR)/wr_umm_ulnas.$(OBJ): $(IN_DIR)/wr_umm_ulnas.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_ulnas.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_ulnas.$(SRC)

$(OUT_DIR)/wr_umm_s1ap_msg.$(OBJ): $(IN_DIR)/wr_umm_s1ap_msg.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_s1ap_msg.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_s1ap_msg.$(SRC)

$(OUT_DIR)/wr_umm_dlnas.$(OBJ): $(IN_DIR)/wr_umm_dlnas.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_dlnas.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_dlnas.$(SRC)

$(OUT_DIR)/wr_umm_rabsetup.$(OBJ): $(IN_DIR)/wr_umm_rabsetup.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_rabsetup.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_rabsetup.$(SRC)

$(OUT_DIR)/wr_umm_lclctxtrel.$(OBJ): $(IN_DIR)/wr_umm_lclctxtrel.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_lclctxtrel.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_lclctxtrel.$(SRC)

$(OUT_DIR)/wr_umm_ctxtrel.$(OBJ): $(IN_DIR)/wr_umm_ctxtrel.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_ctxtrel.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_ctxtrel.$(SRC)

$(OUT_DIR)/wr_umm_rabrel.$(OBJ): $(IN_DIR)/wr_umm_rabrel.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_rabrel.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_rabrel.$(SRC)

$(OUT_DIR)/wr_umm_rabmod.$(OBJ): $(IN_DIR)/wr_umm_rabmod.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_rabmod.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_rabmod.$(SRC)



$(OUT_DIR)/wr_umm_lcrabrel.$(OBJ): $(IN_DIR)/wr_umm_lcrabrel.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_lcrabrel.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_lcrabrel.$(SRC)



$(OUT_DIR)/wr_umm_rrccon.$(OBJ): $(IN_DIR)/wr_umm_rrccon.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_rrccon.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_rrccon.$(SRC)

$(OUT_DIR)/wr_emm_cell.$(OBJ): $(IN_DIR)/wr_emm_cell.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_cell.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_emm_cell.$(SRC)

$(OUT_DIR)/wr_emm_pbm.$(OBJ): $(IN_DIR)/wr_emm_pbm.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_pbm.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_emm_pbm.$(SRC)

$(OUT_DIR)/wr_emm_pws.$(OBJ): $(IN_DIR)/wr_emm_pws.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_pws.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_emm_pws.$(SRC)

$(OUT_DIR)/wr_emm_mme.$(OBJ): $(IN_DIR)/wr_emm_mme.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_mme.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_emm_mme.$(SRC)
$(OUT_DIR)/wr_utils.$(OBJ): $(IN_DIR)/wr_utils.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_utils.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_utils.$(SRC)
$(OUT_DIR)/wr_emm_mme_s1ap.$(OBJ): $(IN_DIR)/wr_emm_mme_s1ap.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_mme_s1ap.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_emm_mme_s1ap.$(SRC) 
$(OUT_DIR)/wr_umm_rrc_msg.$(OBJ): $(IN_DIR)/wr_umm_rrc_msg.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_rrc_msg.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_rrc_msg.$(SRC)
$(OUT_DIR)/wr_umm_l1_msg.$(OBJ): $(IN_DIR)/wr_umm_l1_msg.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_l1_msg.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_l1_msg.$(SRC)
$(OUT_DIR)/wr_umm_sch_msg.$(OBJ): $(IN_DIR)/wr_umm_sch_msg.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_sch_msg.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_sch_msg.$(SRC)

$(OUT_DIR)/wr_emm_plmn.$(OBJ): $(IN_DIR)/wr_emm_plmn.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_plmn.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_emm_plmn.$(SRC)

$(OUT_DIR)/wr_emm_pbm_sib.$(OBJ): $(IN_DIR)/wr_emm_pbm_sib.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_pbm_sib.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_emm_pbm_sib.$(SRC)

$(OUT_DIR)/wr_umm.$(OBJ): $(IN_DIR)/wr_umm.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm.$(SRC)

$(OUT_DIR)/wr_dam.$(OBJ): $(IN_DIR)/wr_dam.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_dam.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_dam.$(SRC)
$(OUT_DIR)/wr_ifm_dam.$(OBJ): $(IN_DIR)/wr_ifm_dam.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ifm_dam.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_dam.$(SRC)

$(OUT_DIR)/wr_smm_init.$(OBJ): $(IN_DIR)/wr_smm_init.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_smm_init.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_smm_init.$(SRC)

$(OUT_DIR)/wr_smm_init_merged.$(OBJ): $(IN_DIR)/wr_smm_init_merged.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_smm_init_merged.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_smm_init_merged.$(SRC)

$(OUT_DIR)/wr_smm_rrc.$(OBJ): $(IN_DIR)/wr_smm_rrc.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMNHMILNH -DLCLNH $(IN_DIR)/wr_smm_rrc.$(SRC) -o \
	$(OUT_DIR)/wr_smm_rrc.$(OBJ)

$(OUT_DIR)/wr_smm_rlc.$(OBJ): $(IN_DIR)/wr_smm_rlc.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCKWMILKW -DLCPJMILPJ -DLCLKW $(IN_DIR)/wr_smm_rlc.$(SRC) -o \
	$(OUT_DIR)/wr_smm_rlc.$(OBJ)

$(OUT_DIR)/wr_smm_mac.$(OBJ): $(IN_DIR)/wr_smm_mac.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCRGMILRG  -DLCLRG -DLCSMMILRG $(IN_DIR)/wr_smm_mac.$(SRC) -o $(OUT_DIR)/wr_smm_mac.$(OBJ)

$(OUT_DIR)/wr_smm_s1ap.$(OBJ): $(IN_DIR)/wr_smm_s1ap.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMMILSZ -DLCLSZ -DSZ_ENB $(IN_DIR)/wr_smm_s1ap.$(SRC) -o \
	$(OUT_DIR)/wr_smm_s1ap.$(OBJ)

$(OUT_DIR)/wr_smm_x2ap.$(OBJ): $(IN_DIR)/wr_smm_x2ap.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMMILCZ -DLCLCZ -DCZ_ENB $(IN_DIR)/wr_smm_x2ap.$(SRC) -o \
	$(OUT_DIR)/wr_smm_x2ap.$(OBJ)

$(OUT_DIR)/wr_smm_sctp.$(OBJ): $(IN_DIR)/wr_smm_sctp.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMSBMILSB -DLCLSB -DLSB4 -DLSB8 $(IN_DIR)/wr_smm_sctp.$(SRC) -o \
	$(OUT_DIR)/wr_smm_sctp.$(OBJ)

$(OUT_DIR)/wr_smm_tucl.$(OBJ): $(IN_DIR)/wr_smm_tucl.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMHIMILHI $(IN_DIR)/wr_smm_tucl.$(SRC) -o \
	$(OUT_DIR)/wr_smm_tucl.$(OBJ)

$(OUT_DIR)/wr_smm_egtp.$(OBJ): $(IN_DIR)/wr_smm_egtp.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMMILEG -DLCLEG $(IN_DIR)/wr_smm_egtp.$(SRC) -o \
	$(OUT_DIR)/wr_smm_egtp.$(OBJ)

$(OUT_DIR)/wr_smm_enbapp_rsys.$(OBJ): $(IN_DIR)/wr_smm_enbapp_rsys.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLWLCSMMILWR  -DLWLCSWR -DLWLCWRMILWR -DSM -DPTSMMILWR $(IN_DIR)/wr_smm_enbapp_rsys.$(SRC) -o\
	$(OUT_DIR)/wr_smm_enbapp_rsys.$(OBJ)

$(OUT_DIR)/wr_smm_enbapp_utils.$(OBJ): $(IN_DIR)/wr_smm_enbapp_utils.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLWLCSMMILWR  -DLWLCSWR -DLWLCWRMILWR -DSM $(IN_DIR)/wr_smm_enbapp_utils.$(SRC) -o \
	$(OUT_DIR)/wr_smm_enbapp_utils.$(OBJ)

$(OUT_DIR)/wr_smm_enbapp_cmnplatutils.$(OBJ): $(IN_DIR)/wr_smm_enbapp_cmnplatutils.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLWLCSMMILWR  -DLWLCSWR -DLWLCWRMILWR -DSM $(IN_DIR)/wr_smm_enbapp_cmnplatutils.$(SRC) -o \
	$(OUT_DIR)/wr_smm_enbapp_cmnplatutils.$(OBJ)

$(OUT_DIR)/wr_smm_pdcp.$(OBJ): $(IN_DIR)/wr_smm_pdcp.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR)  $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMMILPJ -DLCPJMILPJ -DLCLPJ $(IN_DIR)/wr_smm_pdcp.$(SRC) -o \
	$(OUT_DIR)/wr_smm_pdcp.$(OBJ)


$(OUT_DIR)/wr_smm_cl.$(OBJ): $(IN_DIR)/wr_smm_cl.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR)  $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMYSMILYS -DLCYSMILYS -DLCLYS $(IN_DIR)/wr_smm_cl.$(SRC) -o \
	$(OUT_DIR)/wr_smm_cl.$(OBJ)

$(OUT_DIR)/wr_emm.$(OBJ): $(IN_DIR)/wr_emm.$(SRC) $(ALL_INC)
	$(CC)  -I$(SS_DIR)  $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCSMYSMILYS -DLCYSMILYS -DLCLYS $(IN_DIR)/wr_emm.$(SRC) -o \
	$(OUT_DIR)/wr_emm.$(OBJ)

$(OUT_DIR)/wr_ifm_x2ap.$(OBJ): $(IN_DIR)/wr_ifm_x2ap.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ifm_x2ap.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_x2ap.$(SRC)

$(OUT_DIR)/wr_ifm_egtp.$(OBJ): $(IN_DIR)/wr_ifm_egtp.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ifm_egtp.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_egtp.$(SRC)

$(OUT_DIR)/wr_ifm_rrc.$(OBJ): $(IN_DIR)/wr_ifm_rrc.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ifm_rrc.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_rrc.$(SRC)

$(OUT_DIR)/wr_ifm_pdcp.$(OBJ): $(IN_DIR)/wr_ifm_pdcp.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ifm_pdcp.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_pdcp.$(SRC)

$(OUT_DIR)/wr_ifm_schd.$(OBJ): $(IN_DIR)/wr_ifm_schd.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ifm_schd.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_schd.$(SRC)

$(OUT_DIR)/wr_ifm_rrm.$(OBJ): $(IN_DIR)/wr_ifm_rrm.$(SRC) $(ALL_INC)
	$(CC) -c -o$(OUT_DIR)/wr_ifm_rrm.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_rrm.$(SRC)

$(OUT_DIR)/wr_ifm_s1ap.$(OBJ): $(IN_DIR)/wr_ifm_s1ap.$(SRC) $(ALL_INC)
	$(CC) -c -o$(OUT_DIR)/wr_ifm_s1ap.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_s1ap.$(SRC)

$(OUT_DIR)/wr_ifm_l1.$(OBJ): $(IN_DIR)/wr_ifm_l1.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ifm_l1.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_ifm_l1.$(SRC)

$(OUT_DIR)/wr_umm_egtp_hdl.$(OBJ): $(IN_DIR)/wr_umm_egtp_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_egtp_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_egtp_hdl.$(SRC)

$(OUT_DIR)/wr_umm_l1_hdl.$(OBJ): $(IN_DIR)/wr_umm_l1_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_l1_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_l1_hdl.$(SRC)

$(OUT_DIR)/wr_umm_pdcp_hdl.$(OBJ): $(IN_DIR)/wr_umm_pdcp_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_pdcp_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_pdcp_hdl.$(SRC)

$(OUT_DIR)/wr_umm_rrc_hdl.$(OBJ): $(IN_DIR)/wr_umm_rrc_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_rrc_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_rrc_hdl.$(SRC)

$(OUT_DIR)/wr_umm_s1ap_hdl.$(OBJ): $(IN_DIR)/wr_umm_s1ap_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_s1ap_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_s1ap_hdl.$(SRC)

$(OUT_DIR)/wr_umm_sch_hdl.$(OBJ): $(IN_DIR)/wr_umm_sch_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_sch_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_sch_hdl.$(SRC)

$(OUT_DIR)/wr_umm_x2ap_hdl.$(OBJ): $(IN_DIR)/wr_umm_x2ap_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_x2ap_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_x2ap_hdl.$(SRC)

$(OUT_DIR)/wr_umm_x2ap_msg.$(OBJ): $(IN_DIR)/wr_umm_x2ap_msg.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_x2ap_msg.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_x2ap_msg.$(SRC)

$(OUT_DIR)/wr_tmr.$(OBJ): $(IN_DIR)/wr_tmr.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_tmr.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_tmr.$(SRC)

#$(OUT_DIR)/wr_mi.$(OBJ): $(IN_DIR)/wr_mi.$(SRC) $(ALL_INC)
#	$(CC)  -o$(OUT_DIR)/wr_mi.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
#	$(IN_DIR)/wr_mi.$(SRC)

$(OUT_DIR)/wr_ptmi.$(OBJ): $(IN_DIR)/wr_ptmi.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ptmi.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLCWRMILWR -DLWLCWRMILWR -DLWLCWR -DSM -DLCLWR \
	$(IN_DIR)/wr_ptmi.$(SRC)

$(OUT_DIR)/wr_ex_ms.$(OBJ): $(IN_DIR)/wr_ex_ms.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_ex_ms.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -ULCWR  -DLWLCWR  -DLWLCLWR   -DLCLWR -DSM   \
	$(IN_DIR)/wr_ex_ms.$(SRC)

$(OUT_DIR)/wr_lwr.$(OBJ): $(IN_DIR)/wr_lwr.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_lwr.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DLWLCSMMILWR -DSM  -DLCLWR -DLWLCLWR -DLCSMMILWR  \
	$(IN_DIR)/wr_lwr.$(SRC)

$(OUT_DIR)/wr_umm_initcntsetup.$(OBJ): $(IN_DIR)/wr_umm_initcntsetup.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_initcntsetup.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_initcntsetup.$(SRC)

$(OUT_DIR)/wr_umm_rrcreestab.$(OBJ): $(IN_DIR)/wr_umm_rrcreestab.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_rrcreestab.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_rrcreestab.$(SRC)

$(OUT_DIR)/wr_umm_ctxtmod.$(OBJ): $(IN_DIR)/wr_umm_ctxtmod.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_ctxtmod.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_ctxtmod.$(SRC)

$(OUT_DIR)/wr_emm_anr.$(OBJ): $(IN_DIR)/wr_emm_anr.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_emm_anr.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) -DDG \
	$(IN_DIR)/wr_emm_anr.$(SRC)

$(OUT_DIR)/wr_umm_x2srcho.$(OBJ): $(IN_DIR)/wr_umm_x2srcho.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_x2srcho.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_x2srcho.$(SRC)

$(OUT_DIR)/wr_umm_x2tgtho.$(OBJ): $(IN_DIR)/wr_umm_x2tgtho.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_x2tgtho.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_x2tgtho.$(SRC)

$(OUT_DIR)/wr_umm_s1tgtho.$(OBJ): $(IN_DIR)/wr_umm_s1tgtho.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_s1tgtho.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_s1tgtho.$(SRC)

$(OUT_DIR)/wr_umm_s1srcho.$(OBJ): $(IN_DIR)/wr_umm_s1srcho.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_s1srcho.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_s1srcho.$(SRC)

$(OUT_DIR)/wr_umm_ho.$(OBJ): $(IN_DIR)/wr_umm_ho.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_ho.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_ho.$(SRC)

$(OUT_DIR)/wr_umm_csfbupdtcell.$(OBJ): $(IN_DIR)/wr_umm_csfbupdtcell.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_csfbupdtcell.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_csfbupdtcell.$(SRC)

 $(OUT_DIR)/wr_umm_csfb.$(OBJ): $(IN_DIR)/wr_umm_csfb.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_csfb.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_csfb.$(SRC)

$(OUT_DIR)/wr_diag.$(OBJ): $(IN_DIR)/wr_diag.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_diag.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_diag.$(SRC)



$(OUT_DIR)/wr_smm_diag_hdl.$(OBJ): $(IN_DIR)/wr_smm_diag_hdl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_smm_diag_hdl.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_smm_diag_hdl.$(SRC)

$(OUT_DIR)/wr_umm_locrpt.$(OBJ): $(IN_DIR)/wr_umm_locrpt.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_locrpt.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_locrpt.$(SRC)

$(OUT_DIR)/wr_kpi.$(OBJ): $(IN_DIR)/wr_kpi.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_kpi.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_kpi.$(SRC)


$(OUT_DIR)/wr_umm_drx.$(OBJ): $(IN_DIR)/wr_umm_drx.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/wr_umm_drx.$(OBJ) -I$(SS_DIR) $(COPTS) $(IOPTS) $(POPTS) $(CCwrFLAGS) \
	$(IN_DIR)/wr_umm_drx.$(SRC)
...
$(OUT_DIR)/libe2elnxwr.a:$(wrE2eLnxOBJS) $(wrE2eLnxOBJS1)
	$(AR) -cr $(OUT_DIR)/libe2elnxwr.a $(wrE2eLnxOBJS) $(wrE2eLnxOBJS1)
endif

ifeq (${BLDENV},lnx_ms_pre)
$(OUT_DIR)/wrperpro:$(wrE2eLnxOBJS_ms) $(wrE2eLnxOBJS_ms1)
else
$(OUT_DIR)/wrperpro:$(wrE2eLnxOBJS) $(wrE2eLnxOBJS1)
endif
