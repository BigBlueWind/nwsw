...
$(OUT_DIR)/sz_3gdb.$(OBJ): $(IN_DIR)/sz_3gdb.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/sz_3gdb.$(OBJ) $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) \
	$(IN_DIR)/sz_3gdb.$(SRC)

$(OUT_DIR)/sz_li.$(OBJ): $(IN_DIR)/sz_li.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_li.$(SRC) -o \
	$(OUT_DIR)/sz_li.$(OBJ)
$(OUT_DIR)/sz_mgmt.$(OBJ): $(IN_DIR)/sz_mgmt.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_mgmt.$(SRC) -o \
	$(OUT_DIR)/sz_mgmt.$(OBJ)
$(OUT_DIR)/sz_mi.$(OBJ): $(IN_DIR)/sz_mi.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_mi.$(SRC) -o \
	$(OUT_DIR)/sz_mi.$(OBJ)
$(OUT_DIR)/sz_msgfn.$(OBJ): $(IN_DIR)/sz_msgfn.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_msgfn.$(SRC) -o \
	$(OUT_DIR)/sz_msgfn.$(OBJ)
$(OUT_DIR)/sz_ex_ms.$(OBJ): $(IN_DIR)/sz_ex_ms.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_ex_ms.$(SRC) -o \
	$(OUT_DIR)/sz_ex_ms.$(OBJ)
$(OUT_DIR)/sz_ndb.$(OBJ): $(IN_DIR)/sz_ndb.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_ndb.$(SRC) -o \
	$(OUT_DIR)/sz_ndb.$(OBJ)
$(OUT_DIR)/sz_id.$(OBJ): $(IN_DIR)/sz_id.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_id.$(SRC) -o \
	$(OUT_DIR)/sz_id.$(OBJ)
$(OUT_DIR)/sz_sm.$(OBJ): $(IN_DIR)/sz_sm.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_sm.$(SRC) -o \
	$(OUT_DIR)/sz_sm.$(OBJ)
$(OUT_DIR)/sz_smlienb.$(OBJ): $(IN_DIR)/sz_smlienb.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_smlienb.$(SRC) -o \
	$(OUT_DIR)/sz_smlienb.$(OBJ)
$(OUT_DIR)/sz_smuienb.$(OBJ): $(IN_DIR)/sz_smuienb.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_smuienb.$(SRC) -o \
	$(OUT_DIR)/sz_smuienb.$(OBJ)
$(OUT_DIR)/sz_ptli.$(OBJ): $(IN_DIR)/sz_ptli.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_ptli.$(SRC) -o \
	$(OUT_DIR)/sz_ptli.$(OBJ)
$(OUT_DIR)/sz_ptmi.$(OBJ): $(IN_DIR)/sz_ptmi.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_ptmi.$(SRC) -o \
	$(OUT_DIR)/sz_ptmi.$(OBJ)
$(OUT_DIR)/sz_ptui.$(OBJ): $(IN_DIR)/sz_ptui.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_ptui.$(SRC) -o \
	$(OUT_DIR)/sz_ptui.$(OBJ)
$(OUT_DIR)/sz_tmr.$(OBJ): $(IN_DIR)/sz_tmr.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_tmr.$(SRC) -o \
	$(OUT_DIR)/sz_tmr.$(OBJ)
$(OUT_DIR)/sz_ui.$(OBJ): $(IN_DIR)/sz_ui.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_ui.$(SRC) -o \
	$(OUT_DIR)/sz_ui.$(OBJ)
$(OUT_DIR)/sz_utils.$(OBJ): $(IN_DIR)/sz_utils.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CCszFLAGS) $(IN_DIR)/sz_utils.$(SRC) -o \
	$(OUT_DIR)/sz_utils.$(OBJ)
