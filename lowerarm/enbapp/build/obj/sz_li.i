...

{
   ...
   { if(szCb.init.logMask & 0x20) { Buffer *_newBuf; SAddMsgRef(mBuf, szCb.init.region, szCb.init.pool, &_newBuf); ssDiagFix(0x00a10001, SZ_DIAG_NA, 0xd1, szCb.init.inst, 0x20, SS_DIAG_MSG_TYPE_HEXDUMP, _newBuf, 0, 0, 0,0, "Sending S1AP Message : "); } };
...

{
   ...
   { if(szCb.init.logMask & 0x20) { Buffer *_newBuf; SAddMsgRef(mBuf, szCb.init.region, szCb.init.pool, &_newBuf); ssDiagFix(0x00a10002, SZ_DIAG_NA, 0xd1, szCb.init.inst, 0x20, SS_DIAG_MSG_TYPE_HEXDUMP, _newBuf, 0, 0, 0,0, "Recieved S1AP Message :"); } };
   ...
   {
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 539); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szLiRcvFromLower : Peer is under reset. Ignoring the               Dat indication \n"); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 606); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szLiCOMsgHandler : Received dedicated procedure\n"); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   ;;
# 806 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 808); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctBndCfm-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
  ...
  { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a10003, SZ_DIAG_NA, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, suId, sctSapCb->spId, result, 0, "Received BndCfm from SCTP suId  = %d, spId  = %d, result  = %d"); } }
   ...
   else
   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 869); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "S1AP:SzLiSctBndCfm - Binding with lsap (%d) successful\n", suId); SPrint((&szCb.init)->prntBuf); } };
...
# 952 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 972 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 974); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctEndpOpenCfm-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
...
# 1098 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 1119 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1121); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctEndpCloseCfm-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
   ...
   if (result != 0)
   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1157); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "S1AP:SzLiSctEndpCloseCfm - EndpCloseReq fails \n"); SPrint((&szCb.init)->prntBuf); } };
...
# 1214 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 1238 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1240); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctAssocInd-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
...
# 1440 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 1461 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1463); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctAssocCfm-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };




  { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a10004, SZ_DIAG_NA, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, suAssocId, spAssocId, 0, 0, "Received AssocCfm suAssocId = %ld, spAssocId = %ld"); } }
...
# 1567 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 1593 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1595); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctTermInd-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
  ...
  { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a10005, SZ_DIAG_PEERID, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, peerId.val, assocId, status, cause, 0, "Received TermInd from SCTP AssocId = %d, status = %d, cause = %d"); } }
...
# 1729 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 1755 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1757); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctTermCfm-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
   ...
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1816); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "S1AP:SzLiSctTermCfm : Association is terminated \n"); SPrint((&szCb.init)->prntBuf); } };
...
# 1881 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 1905 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 1907); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctDatInd-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };




  { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a10006, SZ_DIAG_SUASSOCID, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, suAssocId, suAssocId, strmId, 0, 0, "Received DatInd from SCTP suAssocId = %ld, stream = %d"); } }
...

{
   ...
   ;;
# 2036 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 2038); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctFlcInd-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
  ...
  { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a10007, SZ_DIAG_PEERID, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, peerId.val, suAssocId, reason, 0, 0, "Received FlcInd suAssocId = %ld, reason  = %d"); } }
...
# 2314 "../..//s1ap/sz_li.c"
{
   ...
   ;;
# 2346 "../..//s1ap/sz_li.c"
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 2348); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "--------S1AP:SzLiSctStaInd-----(proc(%d),ent(%d),inst(%d))-------\n", pst->dstProcId, pst->dstEnt, pst->dstInst); SPrint((&szCb.init)->prntBuf); } };
  ...
  { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a10008, SZ_DIAG_PEERID, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, peerId.val, suAssocId, status, cause, 0, "Received StaInd from SCTP suAssocId = %d, status = %d, cause = %d"); } }
...

{
   ...
   {
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 2567); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szLiSndAssocReq: Association is already up and running \n"); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   {
     { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_li.c", 2634); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szLiTermAssoc: Association is already set to down \n"); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a10009, SZ_DIAG_PEERID, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, peerCb->peerId, asnErr.errCode, msgType, procCode, 0, "ASN Decoding failed, AsnErrorCode = %d, msgType = %d, procedureCode = %d "); } }
