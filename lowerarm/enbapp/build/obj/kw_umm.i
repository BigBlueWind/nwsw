...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 117 "../..//lterlcpdcp/kw_umm.c" 2
# 1 "../..//cm/cm5.h" 1
# 118 "../..//lterlcpdcp/kw_umm.c" 2
# 1 "../..//cm/cm_lte.h" 1
# 91 "../..//cm/cm_lte.h"
#define __CM_LTE_H__ 
# 101 "../..//cm/cm_lte.h"
...
# 142 "../..//lterlcpdcp/kw_umm.c" 2
# 1 "../..//cm/cm5.x" 1
# 143 "../..//lterlcpdcp/kw_umm.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 157 "../..//lterlcpdcp/kw_umm.c" 2
# 169 "../..//lterlcpdcp/kw_umm.c"
static S16 kwUmmEstHdrSz (KwRbCb *rbCb,U8 type,U16 sduCount);
static S16 kwUmmCreatePdu (KwRbCb *rbCb,Buffer **pdu,U8 fi);
static S16 kwUmmExtractHdr (KwRbCb *rbCb,Buffer *pdu,KwUmHdr **umHdr);

static S16 kwUmmReAssembleSdus (KwRbCb *rbCb, KwUmRecBuf *umRecBuf, U16 *numSdus, Bool *isPduProcessd);
# 189 "../..//lterlcpdcp/kw_umm.c"
static S16 kwUmmCheckDupPdu (KwRbCb *rbCb, KwSn curSn);
static Void kwUmmFindNextVrUr (KwUmUl *umUl, KwSn prevVrUr, KwSn *vrUr);
# 221 "../..//lterlcpdcp/kw_umm.c"
 S16 kwUmmQSdu
(
KwRbCb *rbCb,
U32 sduId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 241); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmQSdu(rbCb, sduId, mBuf)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 259 "../..//lterlcpdcp/kw_umm.c"
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&sdu, (Size) (Size)sizeof(KwSdu)) == 0) { cmMemset((U8 *)(sdu), 0, (Size)sizeof(KwSdu)); } else { (sdu) = 0L; } };
# 269 "../..//lterlcpdcp/kw_umm.c"
   SFndLenMsg(mBuf,&len);
   umDl = &(rbCb->m.um.umDl);
   ...
   umDl->bo += len;
   kwUmmEstHdrSz(rbCb,1,1);

   cmLListAdd2Tail(&(rbCb->m.um.umDl.sduQ), &sdu->lstEnt);
   ...
   kwUtlSndDStaRsp(rbCb,umDl->bo,umDl->estHdrSz,0);
# 303 "../..//lterlcpdcp/kw_umm.c"
   return(0);

}
# 771 "../..//lterlcpdcp/kw_umm.c"
 S16 kwUmmProcessSdus
(
KwRbCb *rbCb,
KwDatReq *datReq
)
...

{
   ...
   S16 pduSz;
   S16 ret;
# 803 "../..//lterlcpdcp/kw_umm.c"
   KwKwuSapCb *kwuSapCb;

   ;

   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 808); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSdus(rbCb, datReq)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 831 "../..//lterlcpdcp/kw_umm.c"
...

   {
      ...
      ((((firstNode) = ((sduQ)->crnt = (sduQ)->first)) != 0L) ? (firstNode)->node : 0L);
      sdu = (KwSdu *)(firstNode->node);
      msgLen = &(sdu->sduSz);
# 852 "../..//lterlcpdcp/kw_umm.c"
      if ( pdu == 0L )
      {
         { if (pduSz > 127) pduSz -= 3; else pduSz -= 2;};
         rbCb->m.um.umDl.numLi = 0;
         if ( sdu->mode.um.isSegmented == 1 )
            fi = 2;
         else
            fi = 0;
         { if ( rbCb->m.um.umDl.snLen == 1 ) pduSz -= 1; else if ( rbCb->m.um.umDl.snLen == 2 ) pduSz -= 2; };
...
# 877 "../..//lterlcpdcp/kw_umm.c"
      if ( *msgLen == pduSz )
      {
         SGetMsg((kwCb.init.region), (kwCb.init.pool),&tmpPdu);

         ret = SCatMsg(tmpPdu,sdu->mBuf,0);
# 899 "../..//lterlcpdcp/kw_umm.c"
         if ( pdu == 0L )
         {
            pdu = tmpPdu;
         }
         ...
         {
            ret = SCatMsg(pdu,tmpPdu,0);
# 918 "../..//lterlcpdcp/kw_umm.c"
            SPutMsg(tmpPdu);
         }
         *bo -= pduSz;
         pduSz = 0;
         ...
         { { if(sdu->mBuf) { if (sdu->mBuf != 0L) { SPutMsg(sdu->mBuf); } sdu->mBuf = 0L;}; sdu->mBuf = 0L; cmLListDelFrm(&(rbCb->m.um.umDl.sduQ),&sdu->lstEnt); { if (sdu != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) sdu, (Size) sizeof(KwSdu)); sdu = 0L; } };}; if (kwCb.numDlUmSdus == 0) { printf("ERROR: kwCb.numDlUmSdus is zero!\n"); } --kwCb.numDlUmSdus; };
         { MsgLen bytesSent = 0; ret = kwUmmCreatePdu(rbCb,&(pdu),fi); if (ret == 0 ) { SFndLenMsg(pdu, &bytesSent); pduInfo->mBuf[(pduInfo->numPdu)++] = pdu; kwCb.genSts.bytesSent += bytesSent; pdu = 0L; }};
         kwCb.genSts.pdusSent++;
# 942 "../..//lterlcpdcp/kw_umm.c"
         kwuSapCb = (KwKwuSapCb *)(kwCb.kwuSap + rbCb->kwuSapId);
         kwuSapCb->sts.sduTx++;
         sduCount++;
      }
# 959 "../..//lterlcpdcp/kw_umm.c"
      else if (*msgLen < pduSz )
      {
         SGetMsg((kwCb.init.region), (kwCb.init.pool),&tmpPdu);
         ret = SCatMsg(tmpPdu,sdu->mBuf,0);
# 979 "../..//lterlcpdcp/kw_umm.c"
         if (pdu == 0L)
         {
            pdu = tmpPdu;
         }
...
# 998 "../..//lterlcpdcp/kw_umm.c"
         ...
         *bo -= *msgLen;
         ...
         if ( *msgLen < 2048 && rbCb->m.um.umDl.numLi < 60 )
         {
            rbCb->m.um.umDl.li[(rbCb->m.um.umDl.numLi)++] = *msgLen;
         }
         else
         {
            { MsgLen bytesSent = 0; ret = kwUmmCreatePdu(rbCb,&(pdu),fi); if (ret == 0 ) { SFndLenMsg(pdu, &bytesSent); pduInfo->mBuf[(pduInfo->numPdu)++] = pdu; kwCb.genSts.bytesSent += bytesSent; pdu = 0L; }};
            kwCb.genSts.pdusSent++;
# 1026 "../..//lterlcpdcp/kw_umm.c"
            if ( pduInfo->numPdu == 5)
            {


               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 1031); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf,"Maximum Pdu limit has been reached\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 1050 "../..//lterlcpdcp/kw_umm.c"
      else {
         Buffer *remSdu;

         SGetMsg((kwCb.init.region), (kwCb.init.pool),&tmpPdu);
         ret = SSegMsg(sdu->mBuf,pduSz,&remSdu);
# 1071 "../..//lterlcpdcp/kw_umm.c"
         ret = SCatMsg(tmpPdu,sdu->mBuf,0);
# 1089 "../..//lterlcpdcp/kw_umm.c"
         SPutMsg(sdu->mBuf);
         sdu->mBuf = remSdu;
         *msgLen -= pduSz;
         *bo -= pduSz;
...
# 1167 "../..//lterlcpdcp/kw_umm.c"
   if ( pduSz > 0 && pdu != 0L )
   {
      if ( pduInfo->numPdu != 5 )
      {
         ...
         { MsgLen bytesSent = 0; ret = kwUmmCreatePdu(rbCb,&(pdu),fi); if (ret == 0 ) { SFndLenMsg(pdu, &bytesSent); pduInfo->mBuf[(pduInfo->numPdu)++] = pdu; kwCb.genSts.bytesSent += bytesSent; pdu = 0L; }};
         kwCb.genSts.pdusSent++;
# 1184 "../..//lterlcpdcp/kw_umm.c"
      }
      else
          SPutMsg(pdu);
   }
   kwUmmEstHdrSz(rbCb,2,sduCount);
   datReq->boRep.bo = rbCb->m.um.umDl.bo;
   datReq->boRep.estHdrSz = rbCb->m.um.umDl.estHdrSz;
   datReq->boRep.staPduPrsnt = 0;
   return(0);
}
# 1313 "../..//lterlcpdcp/kw_umm.c"
static S16 kwUmmCheckDupPdu
(
KwRbCb *rbCb,
U16 curSn
)
...

{
   ...
   winSz = rbCb->m.um.umUl.umWinSz << 1;
   umReOrdWinSz = rbCb->m.um.umUl.umWinSz;
   vrUh = rbCb->m.um.umUl.vrUh;
   vrUr = rbCb->m.um.umUl.vrUr;

   ur = ((vrUr-(vrUh - (umReOrdWinSz)) + winSz) % (winSz));
   uh = ((vrUh-(vrUh - (umReOrdWinSz)) + winSz) % (winSz));
   sn = ((curSn-(vrUh - (umReOrdWinSz)) + winSz) % (winSz));

   if ( ((ur < sn) && (sn < uh) &&
         (rbCb->m.um.umUl.recBuf[curSn] != 0L)) ||
         (sn < ur))
   {
      return(1);
   }
...
# 1364 "../..//lterlcpdcp/kw_umm.c"
static Void kwUmmFindNextVrUr
(
KwUmUl *umUl,
KwSn prevVrUr,
KwSn *vrUr
...

{
   ...
   ur = ((*vrUr-(vrUh - (umReOrdWinSz)) + umWinSz) % (umWinSz));
   prvUr = ((prevVrUr-(vrUh - (umReOrdWinSz)) + umWinSz) % (umWinSz));

   while (ur < prvUr )
   {
      if ( umRecBuf[prevVrUr] == 0L )
      {
         *vrUr = prevVrUr;
         break;
      }
...
# 1453 "../..//lterlcpdcp/kw_umm.c"
 S16 kwUmmProcessPdus
(
KwRbCb *rbCb,
KwPduInfo *pduInfo
)
...
# 1487 "../..//lterlcpdcp/kw_umm.c"
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 1494); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," kwUmmProcessPdus(rbCb,pduInfo) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   pduListCnt = umUl->toBeReasmbldUmPduLst.count;
   reasmblyRbListCnt = kwCb.reasmblyRbList.count;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 1513); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessPdus Count(%lu) in toBeReasmbldUmPduLst\n", pduListCnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 1529 "../..//lterlcpdcp/kw_umm.c"
      if ( kwUmmExtractHdr(rbCb,pdu,&umHdr) != 0 )
      {


         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2)| ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2)| ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 1534); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf,"kwUmmExtractHdr Failed\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


         { if (umHdr != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) umHdr, (Size) sizeof(KwUmHdr)); umHdr = 0L; } };
         SPutMsg(pdu);
         count++;
      ...
      if ( ret )
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 1558); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf,"Received a duplicate pdu with sn %d\n",curSn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&recBuf[curSn], (Size) sizeof(KwUmRecBuf)) == 0) { cmMemset((U8 *)(recBuf[curSn]), 0, sizeof(KwUmRecBuf)); } else { (recBuf[curSn]) = 0L; } };
# 1601 "../..//lterlcpdcp/kw_umm.c"
      recBuf[curSn]->pdu = pdu;
      recBuf[curSn]->umHdr = umHdr;
      SFndLenMsg(pdu,&(recBuf[curSn]->pduSz));

      kwCb.genSts.bytesRecv += recBuf[curSn]->pduSz;
      { KwSn _umWinSz = rbCb->m.um.umUl.umWinSz << 1; KwSn _vrUh = rbCb->m.um.umUl.vrUh; KwSn _umReOrdWinSz = rbCb->m.um.umUl.umWinSz; if ((((curSn-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)) < ((_vrUh-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)))) { ret = 1; } else { ret = 0; }};
      ...
      if ( !ret )
      {
         ...
         *vrUh = (curSn + 1) % umRcpWinSz;
         { KwSn _umWinSz = rbCb->m.um.umUl.umWinSz << 1; KwSn _vrUh = rbCb->m.um.umUl.vrUh; KwSn _umReOrdWinSz = rbCb->m.um.umUl.umWinSz; if ((((prevVrUr-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)) < ((_vrUh-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)))) { ret = 1; } else { ret = 0; }};
         if (!ret )
         {

            *vrUr = (*vrUh + umRcpWinSz - umReOrdWinSz) % umRcpWinSz;
            sn = (prevVrUr + 1) % umRcpWinSz;
            tSn = ((sn-(tVrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));
            ur = ((*vrUr-(tVrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));
            while ( tSn < ur )
            {
               if ( recBuf[sn] != 0L)
               {
                  ...
                  cmLListAdd2Tail(&umUl->toBeReasmbldUmPduLst, &recBuf[sn]->rlsUmPduLnk);
                  recBuf[sn]->rlsUmPduLnk.node = (U32)recBuf[sn];
                  recBuf[sn] = 0L;
     ...
     {
            { KwSn _umWinSz = rbCb->m.um.umUl.umWinSz << 1; KwSn _vrUh = rbCb->m.um.umUl.vrUh; KwSn _umReOrdWinSz = rbCb->m.um.umUl.umWinSz; if ((((rbCb->m.um.umUl.sn-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)) < ((_vrUh-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)))) { ret = 1; } else { ret = 0; }};
      if (!ret)
        {
      ...
      if ( recBuf[*vrUr] != 0L )
      {
         KwSn prevVrUr = *vrUr;
         KwSn sn = prevVrUr;
         KwSn tSn = ((sn-(*vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));
         KwSn tVrUr;
         ...
         tVrUr = ((*vrUr-(*vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));
         while ( recBuf[sn] != 0L && tSn < tVrUr )
         {
            ...
            sn = (sn + 1) % umRcpWinSz;
            tSn = ((sn-(*vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));
         }
      }

      tmrRunning = kwChkTmr((U32)rbCb, 1);

      if ( tmrRunning )
      {
         KwSn tVrUx = ((*vrUx-(*vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));
         KwSn tVrUr = ((*vrUr-(*vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));

         KwSn tVrUh = ((*vrUh-(*vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz));

         { KwSn _umWinSz = rbCb->m.um.umUl.umWinSz << 1; KwSn _vrUh = rbCb->m.um.umUl.vrUh; KwSn _umReOrdWinSz = rbCb->m.um.umUl.umWinSz; if ((((*vrUx-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)) < ((_vrUh-(_vrUh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz)))) { ret = 1; } else { ret = 0; }};
...
# 1745 "../..//lterlcpdcp/kw_umm.c"
   if( (0 == pduListCnt) && (umUl->toBeReasmbldUmPduLst.count > 0) )
   {
      cmLListAdd2Tail(&kwCb.reasmblyRbList, &rbCb->rlsReasmblyRbLnk);
      rbCb->rlsReasmblyRbLnk.node = (U32)rbCb;
   }

   if( (0 == reasmblyRbListCnt) && (1 == kwCb.reasmblyRbList.count) )
   {
      SPstTsk(&selfPstUl, kwCb.mBufUl);
   }
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 1757); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessPdus Count(%lu) in toBeReasmbldUmPduLst\n", umUl->toBeReasmbldUmPduLst.count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   kwUmmChkReasmblyLstSz(rbCb);

   return(0);
}
# 1787 "../..//lterlcpdcp/kw_umm.c"
static S16 kwUmmReAssembleSdus
(
KwRbCb *rbCb,
KwUmRecBuf *umRecBuf,
U16 *numSdus,
...
# 1814 "../..//lterlcpdcp/kw_umm.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 1828); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," kwUmmReAssembleSdus(rbCb,umRecBuf) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   *isPduProcessd = 1;
   ...
   for ( count = umRecBuf->umHdr->numSduProcessed; (count <= liCount);count++ )
   {
      ...
      SGetMsg((kwCb.init.region), (kwCb.init.pool), &sdu);
...
# 1984 "../..//lterlcpdcp/kw_umm.c"
   return(0);
}
# 2006 "../..//lterlcpdcp/kw_umm.c"
 S16 kwUmmReEstablish
(
CmLteRlcId rlcId,
KwRbCb *rbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2033); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," kwUmmReEstablish(rbCb) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (rbCb->dir & 1)
   {
      KwSn curSn = rbCb->m.um.umUl.vrUr;
      KwSn vrUh = rbCb->m.um.umUl.vrUh;
      recBuf = rbCb->m.um.umUl.recBuf;


      pduListCnt = rbCb->m.um.umUl.toBeReasmbldUmPduLst.count;
      reasmblyRbListCnt = kwCb.reasmblyRbList.count;


      rbCb->rbOp |= 0x02;
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2054); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmReEstablish:Count(%lu) in toBeReasmbldUmPduLst\n", pduListCnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      while ( curSn < vrUh )
      {
         if ( recBuf[curSn] != 0L )
         {
            ...
            cmLListAdd2Tail(&rbCb->m.um.umUl.toBeReasmbldUmPduLst, &recBuf[curSn]->rlsUmPduLnk);
            recBuf[curSn]->rlsUmPduLnk.node = (U32)recBuf[curSn];
            recBuf[curSn] = 0L;
     ...
     rbCb->m.um.umUl.vrUr = 0;
     rbCb->m.um.umUl.vrUh = 0;
     rbCb->m.um.umUl.vrUx = 0;




      if( (0 == pduListCnt) && (rbCb->m.um.umUl.toBeReasmbldUmPduLst.count > 0) )
      {
         cmLListAdd2Tail(&kwCb.reasmblyRbList, &rbCb->rlsReasmblyRbLnk);
         rbCb->rlsReasmblyRbLnk.node = (U32)rbCb;
      }
      ...
      if(0 == rbCb->m.um.umUl.toBeReasmbldUmPduLst.count)
      {
         rbCb->rbOp &= 0xfd;
      }
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2104); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmReEstablish:Count(%lu) in toBeReasmbldUmPduLst\n", rbCb->m.um.umUl.toBeReasmbldUmPduLst.count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (rbCb->dir & 2)
   {
      ...
      kwUtlEmptySduQ(&rbCb->m.um.umDl.sduQ);

      rbCb->m.um.umDl.vtUs = 0;
   }


   if ( ( rbCb->pjRbCb != 0L ) && (rbCb->dir & 1) )
   {
...
# 2149 "../..//lterlcpdcp/kw_umm.c"
   return(0);
}
# 2171 "../..//lterlcpdcp/kw_umm.c"
static S16 kwUmmCreatePdu
(
KwRbCb *rbCb,
Buffer **pdu,
U8 fi
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2195); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," kwUmmCreatePdu(rbCb,pdu,fi) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( liCount % 2 == 1 )
   {
      ...
      { Data liByte; U16 size; size = 0; while (2 > size ) { liByte = (U8) (liData >> (8*size)); SAddPreMsg((Data )liByte, *pdu); size++; }};
      liCount--;
      e = 1;
   }
   for ( count = liCount - 1;count >= 0;count = count -2 )
   {
      ...
      { Data liByte; U16 size; size = 0; while (3 > size ) { liByte = (U8) (liData >> (8*size)); SAddPreMsg((Data )liByte, *pdu); size++; }};
      e = 1;
   }
   if ( rbCb->m.um.umDl.snLen == 1)
   {
      ...
      { Data liByte; U16 size; size = 0; while (1 > size ) { liByte = (U8) (hdrData >> (8*size)); SAddPreMsg((Data )liByte, *pdu); size++; }};
   }
   else if ( rbCb->m.um.umDl.snLen == 2)
   {
      ...
      { Data liByte; U16 size; size = 0; while (2 > size ) { liByte = (U8) (hdrData >> (8*size)); SAddPreMsg((Data )liByte, *pdu); size++; }};
   }
   modVal = 2 << ((5 * rbCb->m.um.umDl.snLen)-1);;
   sn = (sn + 1) % modVal;
   rbCb->m.um.umDl.vtUs = sn;
   return(0);
}
# 2270 "../..//lterlcpdcp/kw_umm.c"
 S16 kwUmmEstHdrSz
(
KwRbCb *rbCb,
U8 type,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2290); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," kwUmmEstHdrSz(rbCb) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)| ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2368); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," kwUmmExtractHdr(rbCb,pdu,umHdr) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&*umHdr, (Size) sizeof(KwUmHdr)) == 0) { cmMemset((U8 *)(*umHdr), 0, sizeof(KwUmHdr)); } else { (*umHdr) = 0L; } };
# 2384 "../..//lterlcpdcp/kw_umm.c"
   hdr = *umHdr;
   ...
   if ( rbCb->m.um.umUl.snLen == 1)
   {
      ...
      if (ret != 0)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2396); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," SRemPreMsg Failed \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   else if ( rbCb->m.um.umUl.snLen == 2)
   {
      ...
      if (ret != 0)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2411); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," SRemPreMsgMult Failed \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   while (e && numLi < 60 && pdu)
   {
      ret = SRemPreMsgMult(dst,2,pdu);

      if (ret != 0)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2432); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," SRemPreMsgMult Failed \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if (hdr->li[numLi] == 0)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2440); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Received LI with 0 \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if ( pduSz <= totalSz )
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2447); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Corrupted PDU  \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if ( e && numLi < 60)
      {
         ...
         if (e)
         {
            ...
            if (ret != 0)
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2466); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," SRemPreMsg Failed \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
            ...
            if (hdr->li[numLi] == 0)
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2473); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Received 0 for LI \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if((numLi >= 60) && pdu && e)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2503); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," liCount exceeded the maximum count \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ((totalSz + rbCb->m.um.umUl.snLen) > tPduSz)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2516); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Corrupted PDU \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2560); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf,"  kwUmmDiscSdu(rbCb,sduId) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   sduQ = &(rbCb->m.um.umDl.sduQ);

   ((((tmpNode) = ((sduQ)->crnt = (sduQ)->first)) != 0L) ? (tmpNode)->node : 0L);
   ...
   while (tmpNode)
   {
      ...
      if (sdu->mode.um.sduId == sduId && sdu->mode.um.isSegmented == 0)
      {
         ...
         { { if(sdu->mBuf) { if (sdu->mBuf != 0L) { SPutMsg(sdu->mBuf); } sdu->mBuf = 0L;}; sdu->mBuf = 0L; cmLListDelFrm(sduQ,&sdu->lstEnt); { if (sdu != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) sdu, (Size) sizeof(KwSdu)); sdu = 0L; } };}; if (kwCb.numDlUmSdus == 0) { printf("ERROR: kwCb.numDlUmSdus is zero!\n"); } --kwCb.numDlUmSdus; };
         kwCb.genSts.numSduDisc++;
         tmpNode = 0L;
         break;
      }
      ((((tmpNode) = ((sduQ)->crnt = ((sduQ)->crnt ? (sduQ)->crnt->next : (sduQ)->first)))!= 0L) ? (tmpNode)->node : 0L);
   }
   if (tmpNode == 0L)
   {


      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2591); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf,"SDU not found for discard\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   ;
    ...
    do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2622); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf,"  kwUmmReOrdTmrExpiry(rbCb) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   pduListCnt = umUl->toBeReasmbldUmPduLst.count;
   reasmblyRbListCnt = kwCb.reasmblyRbList.count;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2644); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmReOrdTmrExp:Count(%lu) in toBeReasmbldUmPduLst\n", pduListCnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




   while ( ((prevVrUr-(vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz)) < ((*vrUr-(vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz)) )
   {
      if ( recBuf[prevVrUr] != 0L)
      {
         ...
         cmLListAdd2Tail(&umUl->toBeReasmbldUmPduLst, &recBuf[prevVrUr]->rlsUmPduLnk);
         recBuf[prevVrUr]->rlsUmPduLnk.node = (U32)recBuf[prevVrUr];
         recBuf[prevVrUr] = 0L;
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2680); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmReOrdTmrExp:Count(%lu) in toBeReasmbldUmPduLst\n", umUl->toBeReasmbldUmPduLst.count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( ((vrUh-(vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz)) > ((*vrUr-(vrUh - (umReOrdWinSz)) + umRcpWinSz) % (umRcpWinSz)) )
   {
      kwStartTmr((U32)rbCb,1);
      umUl->vrUx = vrUh;
   }
...
# 2710 "../..//lterlcpdcp/kw_umm.c"
 Void kwUmmProcessSelfMsgUl
(
KwRbCb *rbCb,
U16 *numSdus
)
...

{
   ...
   ;;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2729); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl(rbCb, numPdus)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   isPduProcessd = 1;
   umUl = &(rbCb->m.um.umUl);
   pduList = &umUl->toBeReasmbldUmPduLst;
   ...
   if(rbCb->rbOp & 0x08)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2742); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:Deletion of UL PDUs              to be done in toBeReasmbldUmPduLst\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


      while( (pduList->first) && (*numSdus < 5) )
      {
         pdu = (KwUmRecBuf*) pduList->first->node;
         cmLListDelFrm(pduList, pduList->first);
         { if (pdu->pdu != 0L) { SPutMsg(pdu->pdu); } pdu->pdu = 0L;};
         { if (pdu->umHdr != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) pdu->umHdr, (Size) sizeof(KwUmHdr)); pdu->umHdr = 0L; } };
         { if (pdu != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) pdu, (Size) sizeof(KwUmRecBuf)); pdu = 0L; } };
         (*numSdus)++;
      }

      if(0L == pduList->first)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2757); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:PDU list is empty,so                 RB is deleted from Rb List\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2772); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:Reestablishment flag is ON.              So, reassembly of UL PDUs to be done\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


      while( (pduList->first) && (*numSdus < 5) )
      {
         pdu = (KwUmRecBuf*) pduList->first->node;
         kwUmmReAssembleSdus(rbCb, pdu, numSdus, &isPduProcessd);
      ...
      if(0L == pduList->first)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2791); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:PDU list is empty,so                 RB is deleted from Rb List\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2805); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:Reassembly of UL PDUs to be done"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if(0L == pduList->first)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2824); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:PDU list is empty,so                 RB is deleted from Rb List\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if(0L != pduList->first)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2837); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:PDU list is not empty\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if( (rbList->count > 1) && (0 == (rbCb->rbOp & 0x08)) && (0 == (rbCb->rbOp & 0x02)) )
      {
         ...
         rbCb->rlsReasmblyRbLnk.node = (U32)rbCb;
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2845); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmProcessSelfMsgUl:RB is deleted from front and                 added at the end of RB List\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


      }
   }
}
# 2866 "../..//lterlcpdcp/kw_umm.c"
 Void kwUmmChkReasmblyLstSz
(
KwRbCb *rbCb
)
...

{
   ...
   if(rbCb->m.um.umUl.toBeReasmbldUmPduLst.count > 500)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 1) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_umm.c", 2882); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUmmChkReasmblyLstSz:Alarm is raised\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
