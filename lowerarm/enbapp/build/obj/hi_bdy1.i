...
# 198 "../..//tucl/hi_bdy1.c" 2
# 1 "../..//cm/cm5.h" 1
# 199 "../..//tucl/hi_bdy1.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 225 "../..//tucl/hi_bdy1.c" 2
# 1 "../..//cm/cm5.x" 1
# 226 "../..//tucl/hi_bdy1.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
# 312 "../..//tucl/hi_bdy1.c"
{
   ...
   ;;
# 342 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 344); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiActvInit(Ent(%d), Inst(%d), Region(%d), Reason(%d))\n", entity, inst, region, reason); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   ;;
# 434 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 436); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCfgReq(pst, elmnt(%d))\n", cfg->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   ;;
# 529 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 531); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStsReq(pst, action(%d), elmnt(%d))\n", action, sts->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } };


   { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 533); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SGetDateTime(DateTime(%p))\n", (Ptr)&cfmMsg.t.sts.dt); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 545); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStsReq(): general configuration not done\n"); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   ;;
# 649 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 650); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCntrlReq(pst, elmnt(%d))\n", ctl->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } };

   { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 652); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SGetDateTime(DateTime(%p))\n", (Ptr)&ctl->t.cntrl.dt); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 662); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCntrlReq(): general configuration not done\n"); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   ;;
# 756 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 757); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaReq(pst, elmnt(%d))\n", sta->hdr.elmId.elmnt); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 770); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaReq(): general configuration not done\n"); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   ;;
# 1107 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1109); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitBndReq(pst, suId(%d), spId(%d))\n", suId, spId); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   { cmMemcpy((U8 *)&sap->uiPsts.uiConCfmPst, (U8 *)&sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&sap->uiPsts.uiConIndPst, (U8 *)&sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&sap->uiPsts.uiFlcIndPst, (U8 *)&sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&sap->uiPsts.uiDatIndPst, (U8 *)&sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&sap->uiPsts.uiUDatIndPst, (U8 *)&sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&sap->uiPsts.uiDiscIndPst, (U8 *)&sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&sap->uiPsts.uiDiscCfmPst, (U8 *)&sap->uiPst, sizeof(Pst)); };
# 1193 "../..//tucl/hi_bdy1.c"
   sap->state = 0x2;
...

{
   ...
   ;;
# 1260 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1262); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUbndReq(pst, spId(%d), reason(%d))\n", spId, reason); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   for (i = 0; i < hiCb.numFdGrps; i++)
   {
      ...
      if (ret != 0)
      {
         ...
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1292); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUbndReq(): send message to group thread failed\n"); SPrint((&(hiCb.init))->prntBuf); } };
...
# 1345 "../..//tucl/hi_bdy1.c"
{
   ...
   ;;
# 1380 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1383); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitServOpenReq(pst, spId(%d), servConId(%ld), " "servTAddr(%p), tPar(%p), srvcType(%d))\n", spId, servConId, (Ptr)servTAddr, (Ptr)tPar, srvcType); SPrint((&(hiCb.init))->prntBuf); } };
# 1394 "../..//tucl/hi_bdy1.c"
   sap = hiCb.saps[spId];;
   ...
   if (sap->resCongStrt)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)15); } };
      return(0);
   }
...
# 1451 "../..//tucl/hi_bdy1.c"
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)9); } };
      return(1);
   }
   ...
   if (conCb->protocol != IPPROTO_ICMP)
   {
      ...
      if (type == SOCK_STREAM)
      {
         ...
         if (ret != 0)
         {
            { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)4); } };
            cmInetClose(&conCb->conFd);;
            { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1484); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1484); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
...
# 1508 "../..//tucl/hi_bdy1.c"
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)16); } };
      alInfo.type = 0;
      hiSendAlarm(3, (256 + 4),
                  (256 + 7), &alInfo);
      if (conCb->protocol != IPPROTO_ICMP)
         cmInetClose(&conCb->conFd);;
      { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1525); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1525); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
      return(1);
   }
   ...
   if ((icmpFilter->type == 4 && icmpFilter->u.icmpv4Filter.icmpMsgFlag))
   {
      ...
      if (ret != 0)
      {
         { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)servConId, (Reason)14); } };
         { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1540); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1540); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
         return(1);
      }
   }
   ...
   if (ret != 0)
   {
      ...
      if (conCb->protocol != IPPROTO_ICMP)
         cmInetClose(&conCb->conFd);;
      { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1569); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1569); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
      return(1);
   }
...
# 1628 "../..//tucl/hi_bdy1.c"
{
   ...
   ;;
# 1665 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1668); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConReq(pst, spId(%d), suConId(%ld), remAddr(%p), " "localAddr(%p), tPar(%p), srvcType(%d))\n", spId, suConId, (Ptr)remAddr, (Ptr)localAddr, (Ptr)tPar, srvcType); SPrint((&(hiCb.init))->prntBuf); } };
# 1678 "../..//tucl/hi_bdy1.c"
   srvc = srvcType & 0x0F;
...
# 1716 "../..//tucl/hi_bdy1.c"
   ...
   if (sap->resCongStrt)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)15); } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)9); } };
      return(1);
   }
# 1757 "../..//tucl/hi_bdy1.c"
   ...
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)conCb->suConId, (Reason)ret); } };
      { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1761); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1761); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
      return(1);
   }
   ...
   if ((remAddr && remAddr->type == 4))
   {
      ...
      if (ret == 1 || ret == 20)
      {
         { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)conCb->suConId, (Reason)(ret == 1 ? 5 : 17)); } };



         cmInetClose(&conCb->conFd);;
         { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1780); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1780); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
...
# 1800 "../..//tucl/hi_bdy1.c"
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)16); } };
      hiSendAlarm(3, (256 + 5),
                  (256 + 7), &alInfo);
      cmInetClose(&conCb->conFd);;
      { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1813); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1813); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
      return(1);
   }
   ...
   if (ret != 0)
   {
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)14); } };
      hiSendAlarm(3, (256 + 5),
                  (256 + 11), &alInfo);
      cmInetClose(&conCb->conFd);;
      { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1828); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1828); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
      return(1);
   }
...

{
   ...
   ;;
# 1916 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 1918); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConRsp(pst, spId(%d), suConId(%ld), spConId(%ld))\n", spId, suConId, spConId); SPrint((&(hiCb.init))->prntBuf); } };
# 1927 "../..//tucl/hi_bdy1.c"
   sap = hiCb.saps[spId];;
   ...
   if (ret != 0)
   {
      ...
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)1, (UConnId)suConId, (Reason)12); } };
      return(1);
   }
# 1972 "../..//tucl/hi_bdy1.c"
...

{
   ...
   ;;
# 2067 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 2069); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDatReq(pst, spId(%d), spConId(%ld), mBuf(%p)))\n", spId, spConId, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } };
# 2078 "../..//tucl/hi_bdy1.c"
   alInfo.spId = spId;
   alInfo.type = 0;
...
# 2111 "../..//tucl/hi_bdy1.c"
   ...
   {
      SPutMsg(mBuf);
      { if (sap->state == 0x2) { HiUiHitDiscInd(&sap->uiPsts.uiDiscIndPst, sap->suId, (U8)2, (UConnId)spConId, (Reason)18); } };
      return(1);
   }
...
# 2197 "../..//tucl/hi_bdy1.c"
   ...
   { { if (pthread_mutex_lock(&conCb->txQLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 2206); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; SFndLenQueue(&conCb->txQ, &qLen); { if (pthread_mutex_unlock(&conCb->txQLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 2206); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; };
   if (qLen == 0)
...
# 2305 "../..//tucl/hi_bdy1.c"
{
   ...
   ;;
# 2343 "../..//tucl/hi_bdy1.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 2345); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUDatReq(pst, spId(%d), remAddr(%p), mBuf(%p))\n", spId, (Ptr)remAddr, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } };
...
# 2821 "../..//tucl/hi_bdy1.c"
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy1.c", 2829); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDiscReq(pst, spId(%d), choice(%d), conId(%ld),           action(%d))\n", spId, choice, conId, action); SPrint((&(hiCb.init))->prntBuf); } };
# 2838 "../..//tucl/hi_bdy1.c"
   alInfo.spId = spId;
   alInfo.type = 0;
...
# 2870 "../..//tucl/hi_bdy1.c"
   ...
   if (ret != 0)
   {
      { HiUiHitDiscCfm(&sap->uiPsts.uiDiscCfmPst, sap->suId, (U8)choice, (UConnId)conId, (Action)action); };
      return(0);
   }
