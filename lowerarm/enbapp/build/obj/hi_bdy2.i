...
# 103 "../..//tucl/hi_bdy2.c" 2
# 1 "../..//cm/cm5.h" 1
# 104 "../..//tucl/hi_bdy2.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
#define LHI_ALARMINFO_TYPE_NTPRSNT 0
#define LHI_ALARMINFO_SAP_STATE 1
#define LHI_ALARMINFO_CON_STATE 2
#define LHI_ALARMINFO_MEM_ID 3
#define LHI_ALARMINFO_PAR_TYPE 4
#define LHI_ALARMINFO_TYPE_INFVER 5
# 242 "../..//cm/lhi.h"
#define LHI_INV_MBUF 1
#define LHI_INV_SRVC_TYPE 2
#define LHI_INV_TPT_ADDR 3
#define LHI_INV_TPT_PARAM 4
#define LHI_INV_ACTION 5
#define LHI_INV_FILTER_TYPE_COMB 6
...
#define HI_ST_UBND 0x1
#define HI_ST_BND 0x2
# 267 "../..//cm/lhi.h"
#define LHI_MAX_HDR_TYPE 5
# 302 "../..//cm/lhi.h"
#define LHI_LEN_INCL_HDR 0x1





#define LHILOGERROR(pst,errCode,errVal,errDesc) SLogError(pst->srcEnt, pst->srcInst, pst->srcProcId, __FILE__, __LINE__, (ErrCls)ERRCLS_DEBUG, (ErrCode)errCode, (ErrVal)errVal, errDesc)





#define LHI_ZERO(_str,_len) cmMemset((U8 *)_str, 0, _len);
...
#define ELHI001 (ERRLHI + 1)
#define ELHI002 (ERRLHI + 2)
#define ELHI003 (ERRLHI + 3)
#define ELHI004 (ERRLHI + 4)
#define ELHI005 (ERRLHI + 5)
#define ELHI006 (ERRLHI + 6)
#define ELHI007 (ERRLHI + 7)
#define ELHI008 (ERRLHI + 8)
#define ELHI009 (ERRLHI + 9)
#define ELHI010 (ERRLHI + 10)
#define ELHI011 (ERRLHI + 11)
#define ELHI012 (ERRLHI + 12)
#define ELHI013 (ERRLHI + 13)
#define ELHI014 (ERRLHI + 14)
#define ELHI015 (ERRLHI + 15)
#define ELHI016 (ERRLHI + 16)
#define ELHI017 (ERRLHI + 17)
#define ELHI018 (ERRLHI + 18)
#define ELHI019 (ERRLHI + 19)
#define ELHI020 (ERRLHI + 20)
#define ELHI021 (ERRLHI + 21)
#define ELHI022 (ERRLHI + 22)
#define ELHI023 (ERRLHI + 23)
#define ELHI024 (ERRLHI + 24)
#define ELHI025 (ERRLHI + 25)
#define ELHI026 (ERRLHI + 26)
#define ELHI027 (ERRLHI + 27)
#define ELHI028 (ERRLHI + 28)
#define ELHI029 (ERRLHI + 29)
#define ELHI030 (ERRLHI + 30)
#define ELHI031 (ERRLHI + 31)
#define ELHI032 (ERRLHI + 32)
#define ELHI033 (ERRLHI + 33)
#define ELHI034 (ERRLHI + 34)
#define ELHI035 (ERRLHI + 35)
#define ELHI036 (ERRLHI + 36)
#define ELHI037 (ERRLHI + 37)
#define ELHI038 (ERRLHI + 38)
#define ELHI039 (ERRLHI + 39)
#define ELHI040 (ERRLHI + 40)
#define ELHI041 (ERRLHI + 41)
#define ELHI042 (ERRLHI + 42)
#define ELHI043 (ERRLHI + 43)
#define ELHI044 (ERRLHI + 44)
#define ELHI045 (ERRLHI + 45)
#define ELHI046 (ERRLHI + 46)
#define ELHI047 (ERRLHI + 47)
#define ELHI048 (ERRLHI + 48)
#define ELHI049 (ERRLHI + 49)
#define ELHI050 (ERRLHI + 50)
#define ELHI051 (ERRLHI + 51)
#define ELHI052 (ERRLHI + 52)
#define ELHI053 (ERRLHI + 53)
#define ELHI054 (ERRLHI + 54)
#define ELHI055 (ERRLHI + 55)
#define ELHI056 (ERRLHI + 56)
#define ELHI057 (ERRLHI + 57)
#define ELHI058 (ERRLHI + 58)
#define ELHI059 (ERRLHI + 59)
#define ELHI060 (ERRLHI + 60)
#define ELHI061 (ERRLHI + 61)
#define ELHI062 (ERRLHI + 62)
#define ELHI063 (ERRLHI + 63)
#define ELHI064 (ERRLHI + 64)
#define ELHI065 (ERRLHI + 65)
#define ELHI066 (ERRLHI + 66)
#define ELHI067 (ERRLHI + 67)
#define ELHI068 (ERRLHI + 68)
#define ELHI069 (ERRLHI + 69)
#define ELHI070 (ERRLHI + 70)
#define ELHI071 (ERRLHI + 71)
#define ELHI072 (ERRLHI + 72)
#define ELHI073 (ERRLHI + 73)
#define ELHI074 (ERRLHI + 74)
#define ELHI075 (ERRLHI + 75)
#define ELHI076 (ERRLHI + 76)
#define ELHI077 (ERRLHI + 77)
#define ELHI078 (ERRLHI + 78)
#define ELHI079 (ERRLHI + 79)
#define ELHI080 (ERRLHI + 80)
#define ELHI081 (ERRLHI + 81)
#define ELHI082 (ERRLHI + 82)
#define ELHI083 (ERRLHI + 83)
#define ELHI084 (ERRLHI + 84)
#define ELHI085 (ERRLHI + 85)
#define ELHI086 (ERRLHI + 86)
#define ELHI087 (ERRLHI + 87)
#define ELHI088 (ERRLHI + 88)
#define ELHI089 (ERRLHI + 89)
#define ELHI090 (ERRLHI + 90)
#define ELHI091 (ERRLHI + 91)
#define ELHI092 (ERRLHI + 92)
#define ELHI093 (ERRLHI + 93)
#define ELHI094 (ERRLHI + 94)
#define ELHI095 (ERRLHI + 95)
#define ELHI096 (ERRLHI + 96)
#define ELHI097 (ERRLHI + 97)
#define ELHI098 (ERRLHI + 98)
#define ELHI099 (ERRLHI + 99)
#define ELHI100 (ERRLHI + 100)
#define ELHI101 (ERRLHI + 101)
#define ELHI102 (ERRLHI + 102)
#define ELHI103 (ERRLHI + 103)
#define ELHI104 (ERRLHI + 104)
#define ELHI105 (ERRLHI + 105)
#define ELHI106 (ERRLHI + 106)
#define ELHI107 (ERRLHI + 107)
#define ELHI108 (ERRLHI + 108)
#define ELHI109 (ERRLHI + 109)
#define ELHI110 (ERRLHI + 110)
#define ELHI111 (ERRLHI + 111)
#define ELHI112 (ERRLHI + 112)
#define ELHI113 (ERRLHI + 113)
#define ELHI114 (ERRLHI + 114)
#define ELHI115 (ERRLHI + 115)
#define ELHI116 (ERRLHI + 116)
#define ELHI117 (ERRLHI + 117)
#define ELHI118 (ERRLHI + 118)
#define ELHI119 (ERRLHI + 119)
#define ELHI120 (ERRLHI + 120)
#define ELHI121 (ERRLHI + 121)
#define ELHI122 (ERRLHI + 122)
#define ELHI123 (ERRLHI + 123)
#define ELHI124 (ERRLHI + 124)
#define ELHI125 (ERRLHI + 125)
#define ELHI126 (ERRLHI + 126)
#define ELHI127 (ERRLHI + 127)
#define ELHI128 (ERRLHI + 128)
#define ELHI129 (ERRLHI + 129)
#define ELHI130 (ERRLHI + 130)
#define ELHI131 (ERRLHI + 131)
#define ELHI132 (ERRLHI + 132)
#define ELHI133 (ERRLHI + 133)
#define ELHI134 (ERRLHI + 134)
#define ELHI135 (ERRLHI + 135)
#define ELHI136 (ERRLHI + 136)
#define ELHI137 (ERRLHI + 137)
#define ELHI138 (ERRLHI + 138)
#define ELHI139 (ERRLHI + 139)
#define ELHI140 (ERRLHI + 140)
#define ELHI141 (ERRLHI + 141)
#define ELHI142 (ERRLHI + 142)
#define ELHI143 (ERRLHI + 143)
#define ELHI144 (ERRLHI + 144)
#define ELHI145 (ERRLHI + 145)
#define ELHI146 (ERRLHI + 146)
#define ELHI147 (ERRLHI + 147)
#define ELHI148 (ERRLHI + 148)
#define ELHI149 (ERRLHI + 149)
#define ELHI150 (ERRLHI + 150)
#define ELHI151 (ERRLHI + 151)
#define ELHI152 (ERRLHI + 152)
#define ELHI153 (ERRLHI + 153)
#define ELHI154 (ERRLHI + 154)
#define ELHI155 (ERRLHI + 155)
#define ELHI156 (ERRLHI + 156)
#define ELHI157 (ERRLHI + 157)
#define ELHI158 (ERRLHI + 158)
#define ELHI159 (ERRLHI + 159)
#define ELHI160 (ERRLHI + 160)
#define ELHI161 (ERRLHI + 161)
#define ELHI162 (ERRLHI + 162)
#define ELHI163 (ERRLHI + 163)
#define ELHI164 (ERRLHI + 164)
#define ELHI165 (ERRLHI + 165)
#define ELHI166 (ERRLHI + 166)
#define ELHI167 (ERRLHI + 167)
#define ELHI168 (ERRLHI + 168)
#define ELHI169 (ERRLHI + 169)
#define ELHI170 (ERRLHI + 170)
#define ELHI171 (ERRLHI + 171)
#define ELHI172 (ERRLHI + 172)
#define ELHI173 (ERRLHI + 173)
#define ELHI174 (ERRLHI + 174)
#define ELHI175 (ERRLHI + 175)
#define ELHI176 (ERRLHI + 176)
#define ELHI177 (ERRLHI + 177)
#define ELHI178 (ERRLHI + 178)
#define ELHI179 (ERRLHI + 179)
#define ELHI180 (ERRLHI + 180)
#define ELHI181 (ERRLHI + 181)
#define ELHI182 (ERRLHI + 182)
#define ELHI183 (ERRLHI + 183)
#define ELHI184 (ERRLHI + 184)
#define ELHI185 (ERRLHI + 185)
#define ELHI186 (ERRLHI + 186)
#define ELHI187 (ERRLHI + 187)
#define ELHI188 (ERRLHI + 188)
#define ELHI189 (ERRLHI + 189)
#define ELHI190 (ERRLHI + 190)
#define ELHI191 (ERRLHI + 191)
#define ELHI192 (ERRLHI + 192)
#define ELHI193 (ERRLHI + 193)
#define ELHI194 (ERRLHI + 194)
#define ELHI195 (ERRLHI + 195)
#define ELHI196 (ERRLHI + 196)
#define ELHI197 (ERRLHI + 197)
#define ELHI198 (ERRLHI + 198)
#define ELHI199 (ERRLHI + 199)
#define ELHI200 (ERRLHI + 200)
#define ELHI201 (ERRLHI + 201)
#define ELHI202 (ERRLHI + 202)
#define ELHI203 (ERRLHI + 203)
#define ELHI204 (ERRLHI + 204)
#define ELHI205 (ERRLHI + 205)
#define ELHI206 (ERRLHI + 206)
#define ELHI207 (ERRLHI + 207)
#define ELHI208 (ERRLHI + 208)
#define ELHI209 (ERRLHI + 209)
#define ELHI210 (ERRLHI + 210)
#define ELHI211 (ERRLHI + 211)
#define ELHI212 (ERRLHI + 212)
#define ELHI213 (ERRLHI + 213)
#define ELHI214 (ERRLHI + 214)
#define ELHI215 (ERRLHI + 215)
#define ELHI216 (ERRLHI + 216)
#define ELHI217 (ERRLHI + 217)
#define ELHI218 (ERRLHI + 218)
#define ELHI219 (ERRLHI + 219)
#define ELHI220 (ERRLHI + 220)
#define ELHI221 (ERRLHI + 221)
#define ELHI222 (ERRLHI + 222)
#define ELHI223 (ERRLHI + 223)
#define ELHI224 (ERRLHI + 224)
#define ELHI225 (ERRLHI + 225)
#define ELHI226 (ERRLHI + 226)
#define ELHI227 (ERRLHI + 227)
#define ELHI228 (ERRLHI + 228)
#define ELHI229 (ERRLHI + 229)
#define ELHI230 (ERRLHI + 230)
#define ELHI231 (ERRLHI + 231)
#define ELHI232 (ERRLHI + 232)
#define ELHI233 (ERRLHI + 233)
#define ELHI234 (ERRLHI + 234)
#define ELHI235 (ERRLHI + 235)
#define ELHI236 (ERRLHI + 236)
#define ELHI237 (ERRLHI + 237)
#define ELHI238 (ERRLHI + 238)
#define ELHI239 (ERRLHI + 239)
#define ELHI240 (ERRLHI + 240)
#define ELHI241 (ERRLHI + 241)
#define ELHI242 (ERRLHI + 242)
#define ELHI243 (ERRLHI + 243)
#define ELHI244 (ERRLHI + 244)
#define ELHI245 (ERRLHI + 245)
#define ELHI246 (ERRLHI + 246)
#define ELHI247 (ERRLHI + 247)
#define ELHI248 (ERRLHI + 248)
#define ELHI249 (ERRLHI + 249)
#define ELHI250 (ERRLHI + 250)
#define ELHI251 (ERRLHI + 251)
#define ELHI252 (ERRLHI + 252)
#define ELHI253 (ERRLHI + 253)
#define ELHI254 (ERRLHI + 254)
#define ELHI255 (ERRLHI + 255)
#define ELHI256 (ERRLHI + 256)
#define ELHI257 (ERRLHI + 257)
#define ELHI258 (ERRLHI + 258)
#define ELHI259 (ERRLHI + 259)
#define ELHI260 (ERRLHI + 260)
#define ELHI261 (ERRLHI + 261)
#define ELHI262 (ERRLHI + 262)
#define ELHI263 (ERRLHI + 263)
#define ELHI264 (ERRLHI + 264)
#define ELHI265 (ERRLHI + 265)
#define ELHI266 (ERRLHI + 266)
#define ELHI267 (ERRLHI + 267)
#define ELHI268 (ERRLHI + 268)
#define ELHI269 (ERRLHI + 269)
#define ELHI270 (ERRLHI + 270)
#define ELHI271 (ERRLHI + 271)
#define ELHI272 (ERRLHI + 272)
#define ELHI273 (ERRLHI + 273)
#define ELHI274 (ERRLHI + 274)
#define ELHI275 (ERRLHI + 275)
#define ELHI276 (ERRLHI + 276)
#define ELHI277 (ERRLHI + 277)
#define ELHI278 (ERRLHI + 278)
#define ELHI279 (ERRLHI + 279)
#define ELHI280 (ERRLHI + 280)
#define ELHI281 (ERRLHI + 281)
#define ELHI282 (ERRLHI + 282)
#define ELHI283 (ERRLHI + 283)
#define ELHI284 (ERRLHI + 284)
#define ELHI285 (ERRLHI + 285)
#define ELHI286 (ERRLHI + 286)
#define ELHI287 (ERRLHI + 287)
#define ELHI288 (ERRLHI + 288)
#define ELHI289 (ERRLHI + 289)
#define ELHI290 (ERRLHI + 290)
#define ELHI291 (ERRLHI + 291)
#define ELHI292 (ERRLHI + 292)
#define ELHI293 (ERRLHI + 293)
#define ELHI294 (ERRLHI + 294)
#define ELHI295 (ERRLHI + 295)
#define ELHI296 (ERRLHI + 296)
#define ELHI297 (ERRLHI + 297)
#define ELHI298 (ERRLHI + 298)
#define ELHI299 (ERRLHI + 299)
#define ELHI300 (ERRLHI + 300)
#define ELHI301 (ERRLHI + 301)
#define ELHI302 (ERRLHI + 302)
#define ELHI303 (ERRLHI + 303)
#define ELHI304 (ERRLHI + 304)
#define ELHI305 (ERRLHI + 305)
#define ELHI306 (ERRLHI + 306)
#define ELHI307 (ERRLHI + 307)
#define ELHI308 (ERRLHI + 308)
#define ELHI309 (ERRLHI + 309)
#define ELHI310 (ERRLHI + 310)
#define ELHI311 (ERRLHI + 311)
#define ELHI312 (ERRLHI + 312)
#define ELHI313 (ERRLHI + 313)
#define ELHI314 (ERRLHI + 314)
#define ELHI315 (ERRLHI + 315)
#define ELHI316 (ERRLHI + 316)
#define ELHI317 (ERRLHI + 317)
#define ELHI318 (ERRLHI + 318)
#define ELHI319 (ERRLHI + 319)
#define ELHI320 (ERRLHI + 320)
#define ELHI321 (ERRLHI + 321)
#define ELHI322 (ERRLHI + 322)
#define ELHI323 (ERRLHI + 323)
#define ELHI324 (ERRLHI + 324)

#define ELHI325 (ERRLHI + 325)
#define ELHI326 (ERRLHI + 326)
#define ELHI327 (ERRLHI + 327)
#define ELHI328 (ERRLHI + 328)
#define ELHI329 (ERRLHI + 329)
#define ELHI330 (ERRLHI + 330)
#define ELHI331 (ERRLHI + 331)
#define ELHI332 (ERRLHI + 332)
#define ELHI333 (ERRLHI + 333)
#define ELHI334 (ERRLHI + 334)
#define ELHI335 (ERRLHI + 335)
#define ELHI336 (ERRLHI + 336)
#define ELHI337 (ERRLHI + 337)
#define ELHI338 (ERRLHI + 338)
#define ELHI339 (ERRLHI + 339)
#define ELHI340 (ERRLHI + 340)
#define ELHI341 (ERRLHI + 341)
#define ELHI342 (ERRLHI + 342)
#define ELHI343 (ERRLHI + 343)
#define ELHI344 (ERRLHI + 344)
#define ELHI345 (ERRLHI + 345)
#define ELHI346 (ERRLHI + 346)
#define ELHI347 (ERRLHI + 347)
#define ELHI348 (ERRLHI + 348)
#define ELHI349 (ERRLHI + 349)
#define ELHI350 (ERRLHI + 350)
#define ELHI351 (ERRLHI + 351)
#define ELHI352 (ERRLHI + 352)
#define ELHI353 (ERRLHI + 353)
#define ELHI354 (ERRLHI + 354)
#define ELHI355 (ERRLHI + 355)
#define ELHI356 (ERRLHI + 356)
#define ELHI357 (ERRLHI + 357)
#define ELHI358 (ERRLHI + 358)
#define ELHI359 (ERRLHI + 359)
#define ELHI360 (ERRLHI + 360)
#define ELHI361 (ERRLHI + 361)
#define ELHI362 (ERRLHI + 362)
#define ELHI363 (ERRLHI + 363)
#define ELHI364 (ERRLHI + 364)
#define ELHI365 (ERRLHI + 365)
#define ELHI366 (ERRLHI + 366)
#define ELHI367 (ERRLHI + 367)
#define ELHI368 (ERRLHI + 368)
#define ELHI369 (ERRLHI + 369)
#define ELHI370 (ERRLHI + 370)
#define ELHI371 (ERRLHI + 371)
#define ELHI372 (ERRLHI + 372)
#define ELHI373 (ERRLHI + 373)
#define ELHI374 (ERRLHI + 374)
#define ELHI375 (ERRLHI + 375)
#define ELHI376 (ERRLHI + 376)
#define ELHI377 (ERRLHI + 377)
#define ELHI378 (ERRLHI + 378)
#define ELHI379 (ERRLHI + 379)
#define ELHI380 (ERRLHI + 380)
#define ELHI381 (ERRLHI + 381)
#define ELHI382 (ERRLHI + 382)
#define ELHI383 (ERRLHI + 383)
#define ELHI384 (ERRLHI + 384)
#define ELHI385 (ERRLHI + 385)
#define ELHI386 (ERRLHI + 386)
#define ELHI387 (ERRLHI + 387)
#define ELHI388 (ERRLHI + 388)
#define ELHI389 (ERRLHI + 389)
#define ELHI390 (ERRLHI + 390)
#define ELHI391 (ERRLHI + 391)
#define ELHI392 (ERRLHI + 392)
#define ELHI393 (ERRLHI + 393)
#define ELHI394 (ERRLHI + 394)
#define ELHI395 (ERRLHI + 395)
#define ELHI396 (ERRLHI + 396)
#define ELHI397 (ERRLHI + 397)
#define ELHI398 (ERRLHI + 398)
#define ELHI399 (ERRLHI + 399)
#define ELHI400 (ERRLHI + 400)
#define ELHI401 (ERRLHI + 401)
#define ELHI402 (ERRLHI + 402)
#define ELHI403 (ERRLHI + 403)
#define ELHI404 (ERRLHI + 404)
#define ELHI405 (ERRLHI + 405)
#define ELHI406 (ERRLHI + 406)
#define ELHI407 (ERRLHI + 407)
#define ELHI408 (ERRLHI + 408)
#define ELHI409 (ERRLHI + 409)
#define ELHI410 (ERRLHI + 410)
#define ELHI411 (ERRLHI + 411)
#define ELHI412 (ERRLHI + 412)
#define ELHI413 (ERRLHI + 413)
#define ELHI414 (ERRLHI + 414)
#define ELHI415 (ERRLHI + 415)
#define ELHI416 (ERRLHI + 416)
#define ELHI417 (ERRLHI + 417)
#define ELHI418 (ERRLHI + 418)
#define ELHI419 (ERRLHI + 419)
#define ELHI420 (ERRLHI + 420)
#define ELHI421 (ERRLHI + 421)
#define ELHI422 (ERRLHI + 422)
#define ELHI423 (ERRLHI + 423)
#define ELHI424 (ERRLHI + 424)
#define ELHI425 (ERRLHI + 425)
#define ELHI426 (ERRLHI + 426)
#define ELHI427 (ERRLHI + 427)
#define ELHI428 (ERRLHI + 428)
#define ELHI429 (ERRLHI + 429)
#define ELHI430 (ERRLHI + 430)
#define ELHI431 (ERRLHI + 431)
#define ELHI432 (ERRLHI + 432)
#define ELHI433 (ERRLHI + 433)
#define ELHI434 (ERRLHI + 434)
#define ELHI435 (ERRLHI + 435)
#define ELHI436 (ERRLHI + 436)
#define ELHI437 (ERRLHI + 437)
#define ELHI438 (ERRLHI + 438)
#define ELHI439 (ERRLHI + 439)
#define ELHI440 (ERRLHI + 440)
#define ELHI441 (ERRLHI + 441)
#define ELHI442 (ERRLHI + 442)
#define ELHI443 (ERRLHI + 443)
#define ELHI444 (ERRLHI + 444)
#define ELHI445 (ERRLHI + 445)
#define ELHI446 (ERRLHI + 446)
#define ELHI447 (ERRLHI + 447)
#define ELHI448 (ERRLHI + 448)
#define ELHI449 (ERRLHI + 449)
#define ELHI450 (ERRLHI + 450)
#define ELHI451 (ERRLHI + 451)
#define ELHI452 (ERRLHI + 452)
#define ELHI453 (ERRLHI + 453)
#define ELHI454 (ERRLHI + 454)
#define ELHI455 (ERRLHI + 455)
#define ELHI456 (ERRLHI + 456)
#define ELHI457 (ERRLHI + 457)
#define ELHI458 (ERRLHI + 458)
#define ELHI459 (ERRLHI + 459)
#define ELHI460 (ERRLHI + 460)
#define ELHI461 (ERRLHI + 461)
#define ELHI462 (ERRLHI + 462)
#define ELHI463 (ERRLHI + 463)
#define ELHI464 (ERRLHI + 464)
#define ELHI465 (ERRLHI + 465)
#define ELHI466 (ERRLHI + 466)
#define ELHI467 (ERRLHI + 467)
#define ELHI468 (ERRLHI + 468)
#define ELHI469 (ERRLHI + 469)
#define ELHI470 (ERRLHI + 470)
#define ELHI471 (ERRLHI + 471)
#define ELHI472 (ERRLHI + 472)
#define ELHI473 (ERRLHI + 473)
#define ELHI474 (ERRLHI + 474)
#define ELHI475 (ERRLHI + 475)
#define ELHI476 (ERRLHI + 476)
#define ELHI477 (ERRLHI + 477)
#define ELHI478 (ERRLHI + 478)
#define ELHI479 (ERRLHI + 479)
#define ELHI480 (ERRLHI + 480)
#define ELHI481 (ERRLHI + 481)
#define ELHI482 (ERRLHI + 482)
#define ELHI483 (ERRLHI + 483)
#define ELHI484 (ERRLHI + 484)
#define ELHI485 (ERRLHI + 485)
#define ELHI486 (ERRLHI + 486)
#define ELHI487 (ERRLHI + 487)
#define ELHI488 (ERRLHI + 488)
#define ELHI489 (ERRLHI + 489)
#define ELHI490 (ERRLHI + 490)
#define ELHI491 (ERRLHI + 491)
#define ELHI492 (ERRLHI + 492)
#define ELHI493 (ERRLHI + 493)
#define ELHI494 (ERRLHI + 494)
#define ELHI495 (ERRLHI + 495)
#define ELHI496 (ERRLHI + 496)
#define ELHI497 (ERRLHI + 497)
#define ELHI498 (ERRLHI + 498)
#define ELHI499 (ERRLHI + 499)
#define ELHI500 (ERRLHI + 500)
#define ELHI501 (ERRLHI + 501)
#define ELHI502 (ERRLHI + 502)
#define ELHI503 (ERRLHI + 503)
#define ELHI504 (ERRLHI + 504)
#define ELHI505 (ERRLHI + 505)
#define ELHI506 (ERRLHI + 506)
#define ELHI507 (ERRLHI + 507)
#define ELHI508 (ERRLHI + 508)
#define ELHI509 (ERRLHI + 509)
#define ELHI510 (ERRLHI + 510)
#define ELHI511 (ERRLHI + 511)
#define ELHI512 (ERRLHI + 512)
#define ELHI513 (ERRLHI + 513)
#define ELHI514 (ERRLHI + 514)
#define ELHI515 (ERRLHI + 515)
#define ELHI516 (ERRLHI + 516)
#define ELHI517 (ERRLHI + 517)
#define ELHI518 (ERRLHI + 518)
#define ELHI519 (ERRLHI + 519)
#define ELHI520 (ERRLHI + 520)
#define ELHI521 (ERRLHI + 521)
#define ELHI522 (ERRLHI + 522)
#define ELHI523 (ERRLHI + 523)
#define ELHI524 (ERRLHI + 524)
#define ELHI525 (ERRLHI + 525)
#define ELHI526 (ERRLHI + 526)
#define ELHI527 (ERRLHI + 527)
#define ELHI528 (ERRLHI + 528)
#define ELHI529 (ERRLHI + 529)
#define ELHI530 (ERRLHI + 530)
#define ELHI531 (ERRLHI + 531)
#define ELHI532 (ERRLHI + 532)
#define ELHI533 (ERRLHI + 533)
#define ELHI534 (ERRLHI + 534)
#define ELHI535 (ERRLHI + 535)
#define ELHI536 (ERRLHI + 536)
#define ELHI537 (ERRLHI + 537)
#define ELHI538 (ERRLHI + 538)
#define ELHI539 (ERRLHI + 539)
#define ELHI540 (ERRLHI + 540)
#define ELHI541 (ERRLHI + 541)
#define ELHI542 (ERRLHI + 542)
#define ELHI543 (ERRLHI + 543)
#define ELHI544 (ERRLHI + 544)
#define ELHI545 (ERRLHI + 545)
#define ELHI546 (ERRLHI + 546)
#define ELHI547 (ERRLHI + 547)
#define ELHI548 (ERRLHI + 548)
#define ELHI549 (ERRLHI + 549)
#define ELHI550 (ERRLHI + 550)
#define ELHI551 (ERRLHI + 551)
#define ELHI552 (ERRLHI + 552)
#define ELHI553 (ERRLHI + 553)
#define ELHI554 (ERRLHI + 554)
#define ELHI555 (ERRLHI + 555)
#define ELHI556 (ERRLHI + 556)
#define ELHI557 (ERRLHI + 557)
#define ELHI558 (ERRLHI + 558)
#define ELHI559 (ERRLHI + 559)
#define ELHI560 (ERRLHI + 560)
#define ELHI561 (ERRLHI + 561)
#define ELHI562 (ERRLHI + 562)
#define ELHI563 (ERRLHI + 563)
#define ELHI564 (ERRLHI + 564)
#define ELHI565 (ERRLHI + 565)
#define ELHI566 (ERRLHI + 566)
#define ELHI567 (ERRLHI + 567)
#define ELHI568 (ERRLHI + 568)
#define ELHI569 (ERRLHI + 569)
#define ELHI570 (ERRLHI + 570)
#define ELHI571 (ERRLHI + 571)
#define ELHI572 (ERRLHI + 572)
#define ELHI573 (ERRLHI + 573)
#define ELHI574 (ERRLHI + 574)
#define ELHI575 (ERRLHI + 575)
#define ELHI576 (ERRLHI + 576)
#define ELHI577 (ERRLHI + 577)
#define ELHI578 (ERRLHI + 578)
#define ELHI579 (ERRLHI + 579)
#define ELHI580 (ERRLHI + 580)
#define ELHI581 (ERRLHI + 581)
#define ELHI582 (ERRLHI + 582)
#define ELHI583 (ERRLHI + 583)
#define ELHI584 (ERRLHI + 584)
#define ELHI585 (ERRLHI + 585)
#define ELHI586 (ERRLHI + 586)
#define ELHI587 (ERRLHI + 587)
#define ELHI588 (ERRLHI + 588)
#define ELHI589 (ERRLHI + 589)
#define ELHI590 (ERRLHI + 590)
#define ELHI591 (ERRLHI + 591)
#define ELHI592 (ERRLHI + 592)
#define ELHI593 (ERRLHI + 593)
#define ELHI594 (ERRLHI + 594)
#define ELHI595 (ERRLHI + 595)
#define ELHI596 (ERRLHI + 596)
#define ELHI597 (ERRLHI + 597)
#define ELHI598 (ERRLHI + 598)
#define ELHI599 (ERRLHI + 599)
#define ELHI600 (ERRLHI + 600)
#define ELHI601 (ERRLHI + 601)
#define ELHI602 (ERRLHI + 602)
#define ELHI603 (ERRLHI + 603)
#define ELHI604 (ERRLHI + 604)
#define ELHI605 (ERRLHI + 605)
#define ELHI606 (ERRLHI + 606)
#define ELHI607 (ERRLHI + 607)
#define ELHI608 (ERRLHI + 608)
#define ELHI609 (ERRLHI + 609)
#define ELHI610 (ERRLHI + 610)
#define ELHI611 (ERRLHI + 611)
#define ELHI612 (ERRLHI + 612)
#define ELHI613 (ERRLHI + 613)
#define ELHI614 (ERRLHI + 614)
#define ELHI615 (ERRLHI + 615)
#define ELHI616 (ERRLHI + 616)
#define ELHI617 (ERRLHI + 617)
#define ELHI618 (ERRLHI + 618)
#define ELHI619 (ERRLHI + 619)
#define ELHI620 (ERRLHI + 620)
#define ELHI621 (ERRLHI + 621)
#define ELHI622 (ERRLHI + 622)
#define ELHI623 (ERRLHI + 623)
#define ELHI624 (ERRLHI + 624)
#define ELHI625 (ERRLHI + 625)
#define ELHI626 (ERRLHI + 626)
#define ELHI627 (ERRLHI + 627)
#define ELHI628 (ERRLHI + 628)

#define ELHI629 (ERRLHI + 629)
#define ELHI630 (ERRLHI + 630)
#define ELHI631 (ERRLHI + 631)
#define ELHI632 (ERRLHI + 632)

#define ELHI633 (ERRLHI + 633)
#define ELHI634 (ERRLHI + 634)
#define ELHI635 (ERRLHI + 635)
#define ELHI636 (ERRLHI + 636)

#define ELHI637 (ERRLHI + 637)
#define ELHI638 (ERRLHI + 638)
#define ELHI639 (ERRLHI + 639)
#define ELHI640 (ERRLHI + 640)
#define ELHI641 (ERRLHI + 641)
#define ELHI642 (ERRLHI + 642)
#define ELHI643 (ERRLHI + 643)
#define ELHI644 (ERRLHI + 644)
#define ELHI645 (ERRLHI + 645)
#define ELHI646 (ERRLHI + 646)
# 112 "../..//tucl/hi_bdy2.c" 2
# 1 "../..//tucl/hit.h" 1
# 91 "../..//tucl/hit.h"
#define __HITH__ 
# 110 "../..//tucl/hit.h"
...
#define HI_ST_SRV_LISTEN 0x0
#define HI_ST_AW_CON_RSP 0x1
#define HI_ST_CLT_CONNECTING 0x2
#define HI_ST_CONNECTED 0x3
#define HI_ST_CONNECTED_NORD 0x4
#define HI_ST_CONNECTED_NOWR 0x5
#define HI_ST_CONNECTED_NORDWR 0x6
#define HI_ST_DISCONNECTING 0x7
#define HI_ST_CONNECTING 0x8
# 131 "../..//tucl/hi.h"
#define HI_FL_TCP 0x1
#define HI_FL_UDP 0x2
#define HI_FL_UDP_CLT 0x10
#define HI_FL_RAW 0x20
# 145 "../..//tucl/hi.h"
...
#define HI_PRNTBUF_SIZE 128
#define HI_UNUSED -1
#define HI_SRVCTYPE_MASK 4



#define ALL_ICMP_MSG 0x1
#define ALL_PROTO_SPEC_MSG 0x2
#define ALL_FLTRD_ICMP_MSG 0x4
#define FLTRD_PROTO_SPEC_MSG 0x8
...
#define HI_THR_ADDCON 0x1
#define HI_THR_ADDCON_CONCFM 0x2
#define HI_THR_RSPCON 0x3
#define HI_THR_DELCON_DISCIND 0x4
#define HI_THR_DELCON_DISCCFM 0x5
#define HI_THR_TXRDY 0x6
#define HI_THR_ZEROGENSTS 0x7
#define HI_THR_ZEROSAPSTS 0x8
#define HI_THR_DIE 0x9
#define HI_THR_DISSAP 0xA
#define HI_THR_STARTICMP 0xB
#define HI_THR_STOPICMP 0xC
# 223 "../..//tucl/hi.h"
#define HI_THR_DELCON 0xf


#define HI_UDP_RESV_ADDR 0x7f000001
#define HI_UDP_RESV_PORT 0
# 245 "../..//tucl/hi.h"
#define HICONGTMRS 1
#define HIQNUMENT 12
#define HIMAXSIMTMR 1
...
#define HI_TMR_CONG 1




#define HI_CONG_TMR_DURATION 1
# 282 "../..//tucl/hi.h"
#define HIDBGP(_msgClass,_arg) DBGP(&(hiCb.init), HILAYERNAME, _msgClass, _arg)




#define HI_ZERO(_str,_len) cmMemset((U8 *)_str, 0, _len);
# 345 "../..//tucl/hi.h"
#define HI_ALLOC(_size,_datPtr) { S16 _ret; _ret = SGetSBuf(hiCb.init.region, hiCb.init.pool, (Data **)&_datPtr, _size); if (_ret == ROK) cmMemset((U8*)_datPtr, 0, _size); else _datPtr = NULLP; }
# 358 "../..//tucl/hi.h"
#define HI_FREE(_size,_datPtr) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)_datPtr, _size);
# 411 "../..//tucl/hi.h"
#define HI_CHK_SPID(_spId,_event,_info,_sap) _sap = hiCb.saps[_spId];



#define HI_CHK_SAPSTATE(_sap,_event,_info) { if (_sap->pendOp.flag || hiCb.pendOp.flag) { _info.type = LHI_ALARMINFO_TYPE_NTPRSNT; hiSendAlarm(LCM_CATEGORY_INTERFACE, _event, LCM_CAUSE_INV_STATE, &_info); RETVALUE(RFAILED); } }
# 529 "../..//tucl/hi.h"
#define HI_INC_ERRSTS(_stat) _stat++;


#define HI_INC_TXSTS(_sap,_stat) _stat++;



#define HI_DEC_TXSTS(_sap,_stat) _stat--;


#define HI_ADD_TXSTS(_sap,_stat,_val) _stat += _val;
# 557 "../..//tucl/hi.h"
#define HI_INC_TXSTSMSG(_sap,_conCb) { if ((_conCb->srvcType & 0x0F) == HI_SRVC_TLS) _sap->txSts.numTxTlsMsg++; else if (_conCb->flag & HI_FL_TCP) _sap->txSts.numTxTcpMsg++; else if (_conCb->flag & HI_FL_UDP) _sap->txSts.numTxUdpMsg++; else _sap->txSts.numTxRawMsg++; }
# 570 "../..//tucl/hi.h"
#define HI_ZERO_ERRSTS() HI_ZERO(&hiCb.errSts, sizeof(HiErrSts));
# 581 "../..//tucl/hi.h"
#define HI_ZERO_TXSTS(_sap) _sap->txSts.numTxBytes = 0; _sap->txSts.numTxTcpMsg = 0; _sap->txSts.numTxUdpMsg = 0; _sap->txSts.numTxRawMsg = 0;
# 622 "../..//tucl/hi.h"
#define HI_INC_RXSTSMSG(_fdGrp,_conCb) { if ((_conCb->srvcType & 0x0F) == HI_SRVC_TLS) { _fdGrp->genRxSts.numRxTlsMsg++; _fdGrp->rxSts[_conCb->sap->spId].numRxTlsMsg++; } else if (_conCb->flag & HI_FL_TCP) { _fdGrp->genRxSts.numRxTcpMsg++; _fdGrp->rxSts[_conCb->sap->spId].numRxTcpMsg++; } else if (_conCb->flag & HI_FL_UDP) { _fdGrp->genRxSts.numRxUdpMsg++; _fdGrp->rxSts[_conCb->sap->spId].numRxUdpMsg++; } else { _fdGrp->genRxSts.numRxRawMsg++; _fdGrp->rxSts[_conCb->sap->spId].numRxRawMsg++; } }
# 651 "../..//tucl/hi.h"
#define HI_LOCK(_ptr_lock) { if (SLock(_ptr_lock) != ROK) { HiAlarmInfo _alInfo; _alInfo.type = LHI_ALARMINFO_TYPE_NTPRSNT; hiSendAlarm(LCM_CATEGORY_INTERNAL, LCM_EVENT_INV_EVT, LHI_CAUSE_LOCK_ERR, &_alInfo); HIDBGP(DBGMASK_LYR, (hiCb.init.prntBuf, "SLock() failed\n")); } }
# 664 "../..//tucl/hi.h"
#define HI_UNLOCK(_ptr_lock) { if (SUnlock(_ptr_lock) != ROK) { HiAlarmInfo _alInfo; _alInfo.type = LHI_ALARMINFO_TYPE_NTPRSNT; hiSendAlarm(LCM_CATEGORY_INTERNAL, LCM_EVENT_INV_EVT, LHI_CAUSE_UNLOCK_ERR, &_alInfo); HIDBGP(DBGMASK_LYR, (hiCb.init.prntBuf, "SUnlock() failed\n")); } }
# 702 "../..//tucl/hi.h"
#define HI_LOCKICMP(_type) HI_LOCK(&hiCb.icmpLstLock);



#define HI_UNLOCKICMP(_type) HI_UNLOCK(&hiCb.icmpLstLock);
...
#define HI_DUPLICATE_SAP_PST(_sap,_pst) { cmMemcpy((U8 *)&_sap->uiPsts.uiConCfmPst, (U8 *)&_sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&_sap->uiPsts.uiConIndPst, (U8 *)&_sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&_sap->uiPsts.uiFlcIndPst, (U8 *)&_sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&_sap->uiPsts.uiDatIndPst, (U8 *)&_sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&_sap->uiPsts.uiUDatIndPst, (U8 *)&_sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&_sap->uiPsts.uiDiscIndPst, (U8 *)&_sap->uiPst, sizeof(Pst)); cmMemcpy((U8 *)&_sap->uiPsts.uiDiscCfmPst, (U8 *)&_sap->uiPst, sizeof(Pst)); }
# 761 "../..//tucl/hi.h"
#define HI_FREECONCB(_conCb) { HiSap *_sap; _sap = _conCb->sap; HI_LOCK(&_sap->conCbHlLock); cmHashListDelete(&_sap->conCbHlCp, (PTR)_conCb); HI_UNLOCK(&_sap->conCbHlLock); if (_conCb->icmpError) HI_FREE(_conCb->numFilters * sizeof(CmIcmpError), _conCb->icmpError); SDestroyLock(&_conCb->lock); if(_conCb->flag & HI_FL_TCP) SDestroyLock(&_conCb->txQLock); HI_FREE(sizeof(HiConCb), _conCb); _conCb = NULLP; }
# 781 "../..//tucl/hi.h"
#define HI_GET_TXQLEN(_conCb,_ptr_len) { HI_LOCK(&_conCb->txQLock); SFndLenQueue(&_conCb->txQ, _ptr_len); HI_UNLOCK(&_conCb->txQLock); }
...
#define HI_FLW_CNTRL(_conCb,_reason,_event,_ptr_info) { if (_conCb->sap->cfg.flcEnb) { HI_INC_ERRSTS(hiCb.errSts.numFlcInd); HiUiHitFlcInd(&_conCb->sap->uiPsts.uiFlcIndPst, _conCb->sap->suId, _conCb->suConId, _reason); } hiSendAlarm(LCM_CATEGORY_RESOURCE, (U16)_event, LCM_CAUSE_UNKNOWN, _ptr_info); }
# 803 "../..//tucl/hi.h"
#define HI_CONIND(_conCb) { HiUiHitConInd(&_conCb->sap->uiPsts.uiConIndPst, _conCb->sap->suId, _conCb->suConId, _conCb->spConId, &_conCb->peerAddr); }
...
#define HI_CONCFM(_conCb) { HiUiHitConCfm(&_conCb->sap->uiPsts.uiConCfmPst, _conCb->sap->suId, _conCb->suConId, _conCb->spConId, &_conCb->locTptAddr); }
# 833 "../..//tucl/hi.h"
#define HI_DATIND(_conCb,_mbuf) { HiUiHitDatInd(&_conCb->sap->uiPsts.uiDatIndPst, _conCb->sap->suId, _conCb->suConId, _mbuf); }
# 848 "../..//tucl/hi.h"
#define HI_UDATIND(_conCb,_src,_dest,_parm,_lif,_mbuf) { extern int g_overused[5]; int drop = 0; int ix; for (ix = 0; ix < 5; ++ix) { if (g_overused[ix]) { drop = 1; SPutMsg((_mbuf)); break; } } if (!drop) HiUiHitUDatInd(&_conCb->sap->uiPsts.uiUDatIndPst, _conCb->sap->suId, _conCb->suConId, _src, _dest, _parm, _mbuf); }
# 869 "../..//tucl/hi.h"
#define HI_DISCIND(_sap,_choice,_id,_reason) { if (_sap->state == HI_ST_BND) { HiUiHitDiscInd(&_sap->uiPsts.uiDiscIndPst, _sap->suId, (U8)_choice, (UConnId)_id, (Reason)_reason); } }
# 879 "../..//tucl/hi.h"
#define HI_DISCCFM(_sap,_choice,_id,_action) { HiUiHitDiscCfm(&_sap->uiPsts.uiDiscCfmPst, _sap->suId, (U8)_choice, (UConnId)_id, (Action)_action); }
# 1017 "../..//tucl/hi.h"
#define HI_START_CONG_TMR(_timer,_wait,_sap) { CmTmrArg _arg; if (_wait != 0) { _arg.tq = hiCb.tq; _arg.tqCp = &(hiCb.tqCp); _arg.timers = _sap->congTimers; _arg.cb = (PTR)_sap; _arg.evnt = _timer; _arg.wait = _wait; _arg.tNum = 0; _arg.max = 1; cmPlcCbTq(&_arg); } }
# 1035 "../..//tucl/hi.h"
#define HI_STOP_CONG_TMR(_sap,_timer) { CmTmrArg _arg; _arg.tq = hiCb.tq; _arg.tqCp = &(hiCb.tqCp); _arg.timers = ((HiSap*)_sap)->congTimers; _arg.cb = (PTR)_sap; _arg.evnt = _timer; _arg.wait = 0; _arg.tNum = 0; _arg.max = 1; cmRmvCbTq(&_arg); }
# 1051 "../..//tucl/hi.h"
#define HI_SOCK_INIT() hiSockInit();



#define HI_CLOSE_SOCKET(_fd) cmInetClose(_fd);



#define HI_SHUT_SOCKET(_conCb,_type) { if (cmInetShutdown(&conCb->conFd, _type) != ROK) HI_INC_ERRSTS(hiCb.errSts.sockShutErr); }
...
#define HI_SET_SOCKOPT_REUSEADDR(_sockPtr) { U32 _optVal = CM_SOCKOPT_ENABLE; if (cmInetSetOpt(_sockPtr, CM_SOCKOPT_LEVEL_SOCKET, CM_SOCKOPT_OPT_REUSEADDR, (Ptr)&_optVal) != ROK) HI_INC_ERRSTS(hiCb.errSts.sockSOptErr); }
# 1076 "../..//tucl/hi.h"
#define HI_SET_SOCKOPT_TCP_NODELAY(_sockPtr) { U32 _optVal = CM_SOCKOPT_ENABLE; if(cmInetSetOpt(_sockPtr, CM_SOCKOPT_LEVEL_TCP, CM_SOCKOPT_OPT_TCP_NODELAY, (Ptr)&_optVal) != ROK) HI_INC_ERRSTS(hiCb.errSts.sockSOptErr); }
# 1205 "../..//tucl/hi.h"
#define HI_SOCK_DEINIT() { cmInetClose(&hiCb.resvConFd); cmInetDeInit(); }





#define HI_CHK_ADDR(_addr) (_addr && _addr->type == CM_TPTADDR_IPV4)


#define HI_CHK_HDRPARM(_parm) (_parm && _parm->type == CM_HDRPARM_IPV4)


#define HI_CHK_ICMPFILTER(_filter) (_filter->type == CM_ICMPVER4_FILTER && _filter->u.icmpv4Filter.icmpMsgFlag)



#define HI_CHK_ICMPMASK(_conCb) (_conCb->icmpMask)


#define HI_CHK_MCASTOPT(_opt) (_opt == CM_SOCKOPT_OPT_MCAST_TTL)


#define HI_CHK_MCASTDRPOPT(_opt) (_opt == CM_SOCKOPT_OPT_DRP_MCAST_MBR)


#define HI_SET_IPV4_ADDR(_addr,_host,_port) { (_addr)->address = _host; (_addr)->port = _port; }





#define HI_OPEN_SOCKET(_type,_fd,_prot,_ver) cmInetSocket(_type, _fd, _prot);


#define HI_BIND_SOCKET(_fd,_addr) cmInetBind(_fd, &(_addr)->u.ipv4TptAddr);


#define HI_GET_SOCKNAME(_fd,_locaddr) cmInetGetSockName(_fd, &(_locaddr)->u.ipv4TptAddr);


#define HI_ACCEPT(_fd,_addr,_newFd) cmInetAccept(_fd, &(_addr)->u.ipv4TptAddr, _newFd);


#define HI_CONNECT(_fd,_addr) cmInetConnect(_fd, &(_addr)->u.ipv4TptAddr);


#define HI_SEND(_fd,_addr,_mem,_buf,_txlen,_parm) cmInetSendMsg(_fd, _addr ? &(_addr)->u.ipv4TptAddr : NULLP, _mem, _buf, _txlen, CM_INET_NO_FLAG);
# 1260 "../..//tucl/hi.h"
#define HI_RECV(_fd,_addr,_mem,_buf,_rxlen,_parm,_lif) cmInetRecvMsg(_fd, &(_addr)->u.ipv4TptAddr, _mem, _buf, _rxlen, CM_INET_NO_FLAG);
# 1534 "../..//tucl/hi.h"
#define HI_LISTEN(_fd,_backLog) cmInetListen(_fd, _backLog);


#define HI_SENDMSG(_fd,_addr,_buf,_txlen,_parm,_ret) { CmInetMemInfo memInfo; memInfo.region = hiCb.init.region; memInfo.pool = hiCb.init.pool; _ret = HI_SEND(_fd, _addr, &memInfo, _buf, _txlen, _parm); }
...
#define HI_RECVMSG(_fd,_addr,_buf,_rxlen,_parm,_lif,_ret) { CmInetMemInfo memInfo; memInfo.region = hiCb.init.region; memInfo.pool = hiCb.init.pool; _ret = HI_RECV(_fd, _addr, &memInfo, _buf, _rxlen, _parm, _lif); }
# 1557 "../..//tucl/hi.h"
#define HI_GET_OFFSET(_type,_member) ((PTR)(&(((_type *)0)->_member)))




#define HI_SSL_CTX_FREE(_ctx) { SSL_CTX_free(_ctx); _ctx = NULLP; }
# 1596 "../..//tucl/hi.h"
#define HI_DIAG_LVL0(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(hiCb.init.logMask & SS_DIAG_LVL0) { ssDiagFix(_tknId, _splArgEnum, ENTHI, hiCb.init.inst, SS_DIAG_LVL0, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 1607 "../..//tucl/hi.h"
#define HI_DIAG_LVL1(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(hiCb.init.logMask & SS_DIAG_LVL1) { ssDiagFix(_tknId, _splArgEnum, ENTHI, hiCb.init.inst, SS_DIAG_LVL1, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 1618 "../..//tucl/hi.h"
#define HI_DIAG_LVL2(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(hiCb.init.logMask & SS_DIAG_LVL2) { ssDiagFix(_tknId, _splArgEnum, ENTHI, hiCb.init.inst, SS_DIAG_LVL2, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 1629 "../..//tucl/hi.h"
#define HI_DIAG_LVL3(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(hiCb.init.logMask & SS_DIAG_LVL3) { ssDiagFix(_tknId, _splArgEnum, ENTHI, hiCb.init.inst, SS_DIAG_LVL3, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 1640 "../..//tucl/hi.h"
#define HI_DIAG_LVL4(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(hiCb.init.logMask & SS_DIAG_LVL4) { ssDiagFix(_tknId, _splArgEnum, ENTHI, hiCb.init.inst, SS_DIAG_LVL4, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 114 "../..//tucl/hi_bdy2.c" 2
# 1 "../..//tucl/hi_err.h" 1
# 90 "../..//tucl/hi_err.h"
#define __HIERRH__ 
# 100 "../..//tucl/hi_err.h"
...
#define EHIBASE 0
#define ERRHI (EHIBASE +0)

#define EHI001 (ERRHI + 1)
#define EHI002 (ERRHI + 2)
#define EHI003 (ERRHI + 3)

#define EHI004 (ERRHI + 4)
#define EHI005 (ERRHI + 5)
#define EHI006 (ERRHI + 6)
#define EHI007 (ERRHI + 7)
#define EHI008 (ERRHI + 8)

#define EHI009 (ERRHI + 9)
#define EHI010 (ERRHI + 10)
#define EHI011 (ERRHI + 11)

#define EHI012 (ERRHI + 12)
#define EHI013 (ERRHI + 13)
#define EHI014 (ERRHI + 14)
#define EHI015 (ERRHI + 15)
#define EHI016 (ERRHI + 16)
#define EHI017 (ERRHI + 17)
#define EHI018 (ERRHI + 18)
#define EHI019 (ERRHI + 19)
#define EHI020 (ERRHI + 20)
#define EHI021 (ERRHI + 21)
#define EHI022 (ERRHI + 22)
#define EHI023 (ERRHI + 23)
#define EHI024 (ERRHI + 24)
#define EHI025 (ERRHI + 25)
#define EHI026 (ERRHI + 26)
#define EHI027 (ERRHI + 27)
#define EHI028 (ERRHI + 28)
#define EHI029 (ERRHI + 29)
#define EHI030 (ERRHI + 30)
#define EHI031 (ERRHI + 31)
#define EHI032 (ERRHI + 32)
#define EHI033 (ERRHI + 33)
#define EHI034 (ERRHI + 34)
#define EHI035 (ERRHI + 35)
#define EHI036 (ERRHI + 36)
#define EHI037 (ERRHI + 37)
#define EHI038 (ERRHI + 38)
#define EHI039 (ERRHI + 39)
#define EHI040 (ERRHI + 40)
#define EHI041 (ERRHI + 41)
#define EHI042 (ERRHI + 42)
#define EHI043 (ERRHI + 43)
#define EHI044 (ERRHI + 44)
#define EHI045 (ERRHI + 45)
#define EHI046 (ERRHI + 46)
#define EHI047 (ERRHI + 47)
#define EHI048 (ERRHI + 48)
#define EHI049 (ERRHI + 49)
#define EHI050 (ERRHI + 50)
#define EHI051 (ERRHI + 51)
#define EHI052 (ERRHI + 52)
#define EHI053 (ERRHI + 53)
#define EHI054 (ERRHI + 54)
#define EHI055 (ERRHI + 55)
#define EHI056 (ERRHI + 56)
#define EHI057 (ERRHI + 57)
#define EHI058 (ERRHI + 58)
#define EHI059 (ERRHI + 59)
#define EHI060 (ERRHI + 60)
#define EHI061 (ERRHI + 61)
#define EHI062 (ERRHI + 62)
#define EHI063 (ERRHI + 63)

#define EHI064 (ERRHI + 64)
#define EHI065 (ERRHI + 65)
#define EHI066 (ERRHI + 66)
#define EHI067 (ERRHI + 67)
#define EHI068 (ERRHI + 68)
#define EHI069 (ERRHI + 69)
#define EHI070 (ERRHI + 70)
#define EHI071 (ERRHI + 71)
#define EHI072 (ERRHI + 72)
#define EHI073 (ERRHI + 73)
#define EHI074 (ERRHI + 74)
#define EHI075 (ERRHI + 75)
#define EHI076 (ERRHI + 76)
#define EHI077 (ERRHI + 77)
#define EHI078 (ERRHI + 78)
#define EHI079 (ERRHI + 79)
#define EHI080 (ERRHI + 80)
#define EHI081 (ERRHI + 81)
#define EHI082 (ERRHI + 82)
#define EHI083 (ERRHI + 83)
#define EHI084 (ERRHI + 84)
#define EHI085 (ERRHI + 85)
#define EHI086 (ERRHI + 86)
#define EHI087 (ERRHI + 87)

#define EHI088 (ERRHI + 88)
#define EHI089 (ERRHI + 89)
#define EHI090 (ERRHI + 90)
#define EHI091 (ERRHI + 91)
#define EHI092 (ERRHI + 92)
#define EHI093 (ERRHI + 93)
#define EHI094 (ERRHI + 94)
#define EHI095 (ERRHI + 95)
#define EHI096 (ERRHI + 96)



#define EHI097 (ERRHI + 97)
#define EHI098 (ERRHI + 98)
#define EHI099 (ERRHI + 99)
#define EHI100 (ERRHI + 100)

#define EHI101 (ERRHI + 101)
# 115 "../..//tucl/hi_bdy2.c" 2
...
# 125 "../..//tucl/hi_bdy2.c" 2
# 1 "../..//cm/cm5.x" 1
# 126 "../..//tucl/hi_bdy2.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
typedef struct hiSap
{
   ...
   HiUiPsts uiPsts;
   pthread_mutex_t conCbHlLock;
   pthread_mutex_t resCongLock;
...
# 529 "../..//tucl/hi.x"
   ...
   pthread_mutex_t pendLock;



   pthread_mutex_t lmPstLock;
   SSTskId *tskIds;
   pthread_mutex_t icmpLstLock;
# 564 "../..//tucl/hi.x"
   CmTqCp tqCp;
   CmTqType tq[12];
...

{
   ...
   ret = cmInetSocket(SOCK_DGRAM, &hiCb.resvConFd, 0);;
   if (ret != 0)
   {
      cmInetDeInit();
      ;
...

{
   ...
   do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; stosl" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&fdGrp->readFdSet)->fds_bits)[0]) : "memory"); } while (0);
   do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; stosl" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&fdGrp->writeFdSet)->fds_bits)[0]) : "memory"); } while (0);
...
# 422 "../..//tucl/hi_bdy2.c"
   ...
   ret = cmInetSocket(SOCK_DGRAM, &fdGrp->servFd, 0);;
   if (ret == 0)
   {
   ...
   __asm__ __volatile__ ("btsl %1,%0" : "=m" (((&fdGrp->readFdSet)->fds_bits)[(((&fdGrp->servFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&fdGrp->servFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
   ...
   ret = pthread_mutex_init(&fdGrp->lock, ((void *)0));
   if (ret != 0)
      goto hiInitFdGrpCleanup3;
   ...
   ret = SRegTTsk(0x75, inst, 0x01, 0x00, 0L, hiRecvTsk);

   if (ret != 0)
      goto hiInitFdGrpCleanup4;


   ret = SCreateSTsk(13, &hiCb.tskIds[fdGrpNum]);
   if (ret != 0)
      goto hiInitFdGrpCleanup5;
         ...
         ret = SAttachTTsk(0x75, inst, hiCb.tskIds[fdGrpNum]);
...
hiInitFdGrpCleanup5:
    ...
    SDeregTTsk(0x75, inst);


hiInitFdGrpCleanup4:
   pthread_mutex_destroy(&fdGrp->lock);
...

{
   ...
   ;;
# 554 "../..//tucl/hi_bdy2.c"
   SDetachTTsk(0x75, (Inst)(hiCb.init.inst + fdGrpNum + 1));
   ...
   __asm__ __volatile__ ("btrl %1,%0" : "=m" (((&fdGrp->readFdSet)->fds_bits)[(((&fdGrp->servFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&fdGrp->servFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
   cmInetClose(&fdGrp->servFd);;
...

{
   ...
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 711); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiCompletePendOp(): invalid state!\n"); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   { if (pthread_mutex_lock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 720); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

   cmMemcpy((U8 *)&pst, (U8 *)&sap->pendOp.lmPst, sizeof (Pst));

   { if (pthread_mutex_unlock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 724); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   if (sap->pendOp.action == 7 || sap->pendOp.action == 36)
   {
      ...
      pthread_mutex_destroy(&sap->conCbHlLock);
      pthread_mutex_destroy(&sap->resCongLock);
   ...
   if (hiCb.pendOp.flag)
   {
      ...
      { if (pthread_mutex_lock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 756); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      if (hiCb.pendOp.numRem != 0)
      {
         ...
         { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 764); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 771); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 900 "../..//tucl/hi_bdy2.c"
   ...
   ret = pthread_mutex_init(&sap->conCbHlLock, ((void *)0));
   if (ret != 0)
   {
      cmHashListDeinit(&sap->conCbHlCp);
      SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)sap, sizeof (HiSap));;
   ...
   ret = pthread_mutex_init(&sap->resCongLock, ((void *)0));
   if (ret != 0)
   {
      pthread_mutex_destroy(&sap->conCbHlLock);
      cmHashListDeinit(&sap->conCbHlCp);
...
# 1020 "../..//tucl/hi_bdy2.c"
   ...
   { if (pthread_mutex_lock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1023); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      { if (pthread_mutex_unlock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1032); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 1103 "../..//tucl/hi_bdy2.c"
   { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1105); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SGetSMem(region(%d), size(%ld), &pool(%p))\n", hiCb.init.region, sMemSize, &hiCb.init.pool); SPrint((&(hiCb.init))->prntBuf); } };
# 1115 "../..//tucl/hi_bdy2.c"
...
# 1162 "../..//tucl/hi_bdy2.c"
   ...
   { S16 _ret; _ret = SGetSBuf(hiCb.init.region, hiCb.init.pool, (Data **)&hiCb.tskIds, hiCb.numFdGrps * sizeof (SSTskId)); if (_ret == 0) cmMemset((U8*)hiCb.tskIds, 0, hiCb.numFdGrps * sizeof (SSTskId)); else hiCb.tskIds = 0L; };
   if (!hiCb.tskIds)
   {
      ret = 4;
      goto hiCfgGenCleanup4;
...
# 1225 "../..//tucl/hi_bdy2.c"
   ...
   hiCb.tqCp.tmrLen = 12;
# 1260 "../..//tucl/hi_bdy2.c"
   ret = pthread_mutex_init(&hiCb.pendLock, ((void *)0));
   if (ret != 0)
   {
      ret = (256 + 7);
   ...
   ret = pthread_mutex_init(&hiCb.icmpLstLock, ((void *)0));
   if (ret != 0)
   {
      ret = (256 + 7);
...
# 1295 "../..//tucl/hi_bdy2.c"
      { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1297); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SRegTmr(entity(%d), inst(%d), period(%d))\n", hiCb.init.ent, hiCb.init.inst, 2); SPrint((&(hiCb.init))->prntBuf); } };



      ret = SRegCfgTmr(hiCb.init.ent,hiCb.init.inst,2,10,hiActvTmr);
      ...
      if (ret != 0 )
  {
   ...
   ret = pthread_mutex_init(&hiCb.lmPstLock, ((void *)0));
   if (ret != 0)
   {
      ret = (256 + 7);
...
hiCfgGenCleanup13:
   pthread_mutex_destroy(&hiCb.lmPstLock);
...
hiCfgGenCleanup12:
   ...
   pthread_mutex_destroy(&hiCb.icmpLstLock);

hiCfgGenCleanup8:
   pthread_mutex_destroy(&hiCb.pendLock);
...
hiCfgGenCleanup5:
   ...
   SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)hiCb.tskIds, hiCb.numFdGrps * sizeof (SSTskId));;
...
# 1653 "../..//tucl/hi_bdy2.c"
   switch (cfmType)
   {
      ...
      default:
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1673); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiSendLmCfm(): unknown parameter cfmType\n"); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   if (!hiCb.init.cfgDone)
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1722); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiSendAlarm(): general configuration not done\n"); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   { if (pthread_mutex_lock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1748); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

      HiMiLhiStaInd(&(hiCb.init.lmPst), &sm);

   { if (pthread_mutex_unlock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1752); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   { if (pthread_mutex_lock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1806); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   if (ret != 0)
   {
      ...
      { if (pthread_mutex_unlock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 1851); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 1922 "../..//tucl/hi_bdy2.c"
   ...
   pthread_mutex_destroy(&hiCb.lmPstLock);
# 1937 "../..//tucl/hi_bdy2.c"
      SDeregCfgTmr(hiCb.init.ent,hiCb.init.inst,2,10,hiActvTmr);
# 1981 "../..//tucl/hi_bdy2.c"
   i = hiCb.numFdGrps;
   while (--i >= 0)
   {
...

{
   ...
   switch (action)
   {
      case 36:
         ...
         { if (pthread_mutex_lock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2093); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
         ...
         for (i = 0; i < hiCb.numFdGrps; i++)
         {
            ...
            if (r != 0)
            {
               ...
               { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2117); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiCntrlSap(): send message to group thread failed\n"); SPrint((&(hiCb.init))->prntBuf); } };
         ...
         { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2124); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 2291 "../..//tucl/hi_bdy2.c"
   ...
   { if (pthread_mutex_lock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2326); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

      cmMemcpy((U8 *)&sap->pendOp.lmPst, (U8 *)pst, sizeof (Pst));

   { if (pthread_mutex_unlock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2330); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      { if (pthread_mutex_lock(&sap->resCongLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2337); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   {
      if(sap->congTimers[numTmr].tmrEvnt == 1)
      {

         { CmTmrArg _arg; _arg.tq = hiCb.tq; _arg.tqCp = &(hiCb.tqCp); _arg.timers = ((HiSap*)sap)->congTimers; _arg.cb = (U32)sap; _arg.evnt = 1; _arg.wait = 0; _arg.tNum = 0; _arg.max = 1; cmRmvCbTq(&_arg); };
      }
   }



   { if (pthread_mutex_unlock(&sap->resCongLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2355); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
# 2365 "../..//tucl/hi_bdy2.c"
      tMsg.type = 0xA;
      tMsg.spId = sap->spId;
      for (i = 0; i < hiCb.numFdGrps; i++)
      {
         ...
         if (ret != 0)
         {
            ...
            { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2374); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiCntrlSap(): send message to group thread failed\n"); SPrint((&(hiCb.init))->prntBuf); } };
...
# 2451 "../..//tucl/hi_bdy2.c"
   ...
   { if (pthread_mutex_lock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2462); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   for (i = 0; i < hiCb.cfg.numSaps; i++)
   {
      ...
      switch (cntrl->t.cntrl.subAction)
      {
         ...
         default:
            ...
            { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2499); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   { if (pthread_mutex_lock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2532); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

   cmMemcpy((U8 *)&sap->pendOp.lmPst, (U8 *)pst, sizeof (Pst));

   { if (pthread_mutex_unlock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2536); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

   cmMemcpy((U8 *)&sap->pendOp.hdr, (U8 *)hdr, sizeof (Header));



   { if (pthread_mutex_lock(&sap->resCongLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2542); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
         ...
         { if (pthread_mutex_unlock(&sap->resCongLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2560); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
# 2570 "../..//tucl/hi_bdy2.c"
         tMsg.type = 0xA;
         tMsg.spId = sap->spId;
         for (j = 0; i < hiCb.numFdGrps; j++)
         {
            ...
            if (ret != 0)
            {
               ...
               { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2579); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

               { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2582); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiCntrlSapGrp(): send message to thread failed\n"); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 2590); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 3041 "../..//tucl/hi_bdy2.c"
{
   ...
   *type = SOCK_RAW;
   ...
   {
      case 6:
         con->protocol = IPPROTO_RAW;
         break;

      case 8:
         con->protocol = IPPROTO_ICMP;
         break;
   ...
   if (pthread_mutex_init(&con->lock, ((void *)0)) != 0)
   {
      SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)con, sizeof (HiConCb));;
      alInfo.type = 0;
      hiSendAlarm(4, 4,
                  (256 + 8), &alInfo);
      return(1);
...
# 3148 "../..//tucl/hi_bdy2.c"
...

   {
      ...
      if (pthread_mutex_init(&con->txQLock, ((void *)0)) != 0)
      {
...

{
   ...
   { if (pthread_mutex_lock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3223); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   { if (pthread_mutex_unlock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3263); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   if (conCb->protocol == IPPROTO_ICMP)
   {
   ...
   while (fdGrpNum < (S16)hiCb.numFdGrps && !done)
   {
      ...
      { if (pthread_mutex_lock(&hiCb.fdGrps[fdGrpNum]->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3345); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      { if (pthread_mutex_unlock(&hiCb.fdGrps[fdGrpNum]->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3358); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   { if (pthread_mutex_lock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3423); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   { if (pthread_mutex_unlock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3433); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };



   if (ret == 0)
      { if (pthread_mutex_lock(&((*conCb)->lock)) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3438); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   { if (pthread_mutex_lock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3489); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   *conCb = prevConCb = 0L;
               ...
               (U32 *)conCb)) == 0)
   {
      if ((*conCb)->suConId == suConId)
      {
         ...
         { if (pthread_mutex_unlock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3503); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

         { if (pthread_mutex_lock(&((*conCb)->lock)) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3505); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
         flag = 0;
   ...
   if (flag)
   {
      { if (pthread_mutex_unlock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3521); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   }
...

{
   ...
   if (conCb)
      { if (pthread_mutex_unlock(&conCb->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3559); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   { if (pthread_mutex_lock(&conCb->txQLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3607); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   { if (pthread_mutex_unlock(&conCb->txQLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3617); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 3685 "../..//tucl/hi_bdy2.c"
   ...
   lCp = 0L;
# 3702 "../..//tucl/hi_bdy2.c"
   { if (pthread_mutex_lock(&hiCb.icmpLstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3702); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };;
...
# 3735 "../..//tucl/hi_bdy2.c"
   ...
   {
      ret = cmInetSocket(SOCK_RAW, fd, prot);;
      if (ret != 0)
      {
         ...
         { if (pthread_mutex_unlock(&hiCb.icmpLstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3746); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };;
   ...
   if (numUsers != 0L)
      (*numUsers)++;
# 3978 "../..//tucl/hi_bdy2.c"
   { if (pthread_mutex_unlock(&hiCb.icmpLstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 3978); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };;
...
# 4033 "../..//tucl/hi_bdy2.c"
   ...
   { if (pthread_mutex_lock(&hiCb.icmpLstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4049); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };;
...
# 4260 "../..//tucl/hi_bdy2.c"
   { if (pthread_mutex_unlock(&hiCb.icmpLstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4260); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };;
...

{
   ...
   { if (pthread_mutex_lock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4302); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   { if (pthread_mutex_lock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4303); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
          ...
          == 0)
   {
      ...
      if ((conCb->icmpMask))
         hiDelIcmpCon(conCb);
      if ((__extension__ ({register char __result; __asm__ __volatile__ ("btl %1,%2 ; setcb %b0" : "=q" (__result) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))), "m" (((&fdGrp->readFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "cc"); __result; })))
      {
         __asm__ __volatile__ ("btrl %1,%0" : "=m" (((&fdGrp->readFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
         fdGrp->numFds--;
      ...
      if ((__extension__ ({register char __result; __asm__ __volatile__ ("btl %1,%2 ; setcb %b0" : "=q" (__result) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))), "m" (((&fdGrp->writeFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "cc"); __result; })))
      {
         __asm__ __volatile__ ("btrl %1,%0" : "=m" (((&fdGrp->writeFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
         fdGrp->numWrFds--;
      }
      cmHashListDelete(&fdGrp->wrFdHlCp, (U32)conCb);
      if (conCb->flag & 0x1)
      ...
      pthread_mutex_destroy(&conCb->txQLock);
   ...
   { if (pthread_mutex_unlock(&sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4374); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   { if (pthread_mutex_unlock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4375); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 4420 "../..//tucl/hi_bdy2.c"
{
   ...
   if (ret != 0)
   {
      ...
      {
            { HiUiHitDiscCfm(&sap->uiPsts.uiDiscCfmPst, sap->suId, (U8)2, (UConnId)tMsg->spConId, (Action)tMsg->disc.action); };
   ...
   {
      if (fdGrp->numWrFds
          && (__extension__ ({register char __result; __asm__ __volatile__ ("btl %1,%2 ; setcb %b0" : "=q" (__result) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))), "m" (((selWrFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "cc"); __result; })))
      {
         (*setFds)--;
         __asm__ __volatile__ ("btrl %1,%0" : "=m" (((selWrFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
      }
      if ((__extension__ ({register char __result; __asm__ __volatile__ ("btl %1,%2 ; setcb %b0" : "=q" (__result) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))), "m" (((selRdFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "cc"); __result; })))
      {
         (*setFds)--;
         __asm__ __volatile__ ("btrl %1,%0" : "=m" (((selRdFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
      }
   }
   ...
   { if (pthread_mutex_lock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4473); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
         ...
         && tMsg->disc.action == 1))
   {
      ...
      { if (pthread_mutex_unlock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4557); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   if (tMsg->type == 0x4
       && conCb->sap->state == 0x2)
   {
      { if (conCb->sap->state == 0x2) { HiUiHitDiscInd(&conCb->sap->uiPsts.uiDiscIndPst, conCb->sap->suId, (U8)1, (UConnId)conCb->suConId, (Reason)tMsg->disc.reason); } };

   }
   else if (tMsg->type == 0x5
            && conCb->sap->state == 0x2)
   {
      { HiUiHitDiscCfm(&conCb->sap->uiPsts.uiDiscCfmPst, conCb->sap->suId, (U8)1, (UConnId)conCb->suConId, (Action)tMsg->disc.action); };
   ...
   conCb->state = 0x7;
   hiDoneWithConCb(conCb);
   { HiSap *_sap; _sap = conCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4602); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)conCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4602); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (conCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb->icmpError, conCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&conCb->lock); if(conCb->flag & 0x1) pthread_mutex_destroy(&conCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)conCb, sizeof(HiConCb));; conCb = 0L; };
...

{
   ...
   {
      if (tMsg->type == 0x2)
         { HiUiHitConCfm(&conCb->sap->uiPsts.uiConCfmPst, conCb->sap->suId, conCb->suConId, conCb->spConId, &conCb->locTptAddr); };
      goto hiProcThrAddConDone1;
   }



   { if (pthread_mutex_lock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4688); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      if (ret != 0)
      {
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4700); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcThrAddCon(): insertion into hash list failed\n"); SPrint((&(hiCb.init))->prntBuf); } };
      ...
      if (conCb->state != 0x1)
      {
         ...
         __asm__ __volatile__ ("btsl %1,%0" : "=m" (((&fdGrp->readFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
      }
...
# 4733 "../..//tucl/hi_bdy2.c"
   if (conCb->state == 0x2)
   {
      ...
      if (ret != 0)
      {
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4741); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcThrAddCon(): insertion into hash list failed\n"); SPrint((&(hiCb.init))->prntBuf); } };
      ...
      __asm__ __volatile__ ("btsl %1,%0" : "=m" (((&fdGrp->writeFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
      fdGrp->numWrFds++;
...
hiProcThrAddConDone2:
   ...
   { if (pthread_mutex_unlock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4776); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   { if (pthread_mutex_lock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4841); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   __asm__ __volatile__ ("btsl %1,%0" : "=m" (((&fdGrp->readFdSet)->fds_bits)[(((&conCb->conFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&conCb->conFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
# 4855 "../..//tucl/hi_bdy2.c"
   { if (pthread_mutex_unlock(&fdGrp->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4855); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   if (ret != 0)
   {
      ...
      {
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 4933); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcThrTxRdy(): insertion into hash list failed\n"); SPrint((&(hiCb.init))->prntBuf); } };
...

{
 ...
 U16 result = 0;
   ...
   { if (pthread_mutex_lock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5086); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };

      cmMemcpy((U8 *)&sap->pendOp.lmPst, (U8 *)&hiCb.pendOp.lmPst,
               sizeof (Pst));

   { if (pthread_mutex_unlock(&hiCb.lmPstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5091); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      if ((ret == 0) && (result == 0))
  {
   ...
   if (hiCb.pendOp.numRem == 0)
   {
      ...
      { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5159); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   { if (pthread_mutex_unlock(&hiCb.pendLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5173); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   if (tMsg->type == 0xB)
   {
      ...
      __asm__ __volatile__ ("btsl %1,%0" : "=m" (((&fdGrp->readFdSet)->fds_bits)[(((&hiCb.icmpConFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&hiCb.icmpConFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
...

{
   ...
   if (tMsg->type == 0xC)
   {
      ...
      __asm__ __volatile__ ("btrl %1,%0" : "=m" (((&fdGrp->readFdSet)->fds_bits)[(((&hiCb.icmpConFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&hiCb.icmpConFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
...
# 5383 "../..//tucl/hi_bdy2.c"
   ...
   if (ret == 1)
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5398); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcThrMsg(): receive failed on reserved fd\n"); SPrint((&(hiCb.init))->prntBuf); } };
...
# 5418 "../..//tucl/hi_bdy2.c"
   ...
   if (ret != 0)
   {
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5449); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcThrMsg(): could not unpack thread message\n"); SPrint((&(hiCb.init))->prntBuf); } };
...
# 5528 "../..//tucl/hi_bdy2.c"
      ...
      default:
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5544); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcThrMsg(): unknown message type\n"); SPrint((&(hiCb.init))->prntBuf); } };
...
# 5909 "../..//tucl/hi_bdy2.c"
    switch(evnt)
    {
     ...
     { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 5916); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiTmrEvnt() : check resource called >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n\n"); SPrint((&(hiCb.init))->prntBuf); } };
...
# 6285 "../..//tucl/hi_bdy2.c"
   ...
   { if (pthread_mutex_lock(&sap->resCongLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 6290); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
      ...
      else if (status >= hiCb.cfg.poolDropThr)
      {
         ...
         for(numTmr = 0; numTmr < 1 ; numTmr++)
         {
            if(sap->congTimers[numTmr].tmrEvnt == 1)
            {
               ...
               { CmTmrArg _arg; _arg.tq = hiCb.tq; _arg.tqCp = &(hiCb.tqCp); _arg.timers = ((HiSap*)sap)->congTimers; _arg.cb = (U32)sap; _arg.evnt = 1; _arg.wait = 0; _arg.tNum = 0; _arg.max = 1; cmRmvCbTq(&_arg); };
               { CmTmrArg _arg; if (1 != 0) { _arg.tq = hiCb.tq; _arg.tqCp = &(hiCb.tqCp); _arg.timers = sap->congTimers; _arg.cb = (U32)sap; _arg.evnt = 1; _arg.wait = 1; _arg.tNum = 0; _arg.max = 1; cmPlcCbTq(&_arg); } };
            }
    else
            {
               { CmTmrArg _arg; if (1 != 0) { _arg.tq = hiCb.tq; _arg.tqCp = &(hiCb.tqCp); _arg.timers = sap->congTimers; _arg.cb = (U32)sap; _arg.evnt = 1; _arg.wait = 1; _arg.tNum = 0; _arg.max = 1; cmPlcCbTq(&_arg); } };
...
hiChkResDone:
   ...
   { if (pthread_mutex_unlock(&sap->resCongLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy2.c", 6490); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   if (newSize > sap->cfg.txqCongStrtLim)
   {
      ...
      if (newSize > sap->cfg.txqCongDropLim)
      {
         ...
         if (!(conCb->flc & 0x2))
         {
            ...
            { if (conCb->sap->cfg.flcEnb) { hiCb.errSts.numFlcInd++;; HiUiHitFlcInd(&conCb->sap->uiPsts.uiFlcIndPst, conCb->sap->suId, conCb->suConId, 3); } hiSendAlarm(4, (U16)(256 + 12), 0, &alInfo); };
      ...
      else
      {
         ...
         if (!(conCb->flc & 0x1))
         {
            ...
            { if (conCb->sap->cfg.flcEnb) { hiCb.errSts.numFlcInd++;; HiUiHitFlcInd(&conCb->sap->uiPsts.uiFlcIndPst, conCb->sap->suId, conCb->suConId, 1); } hiSendAlarm(4, (U16)(256 + 11), 0, &alInfo); };
   ...
   else if (newSize < sap->cfg.txqCongStopLim)
   {
      ...
      if (conCb->flc & 0x1 || conCb->flc & 0x2)
      {
         ...
         { if (conCb->sap->cfg.flcEnb) { hiCb.errSts.numFlcInd++;; HiUiHitFlcInd(&conCb->sap->uiPsts.uiFlcIndPst, conCb->sap->suId, conCb->suConId, 2); } hiSendAlarm(4, (U16)(256 + 13), 0, &alInfo); };
