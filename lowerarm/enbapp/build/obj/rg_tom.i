...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//ltemac/rg_tom.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//ltemac/rg_tom.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 119 "../..//ltemac/rg_tom.c" 2
# 1 "../..//cm/cm5.x" 1
# 120 "../..//ltemac/rg_tom.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
static S16 rgTOMProcCrntiCEInDatInd ( RgMacPdu *pdu, RgUeCb *prevUeCb, RgCellCb *cellCb, TfuDatInfo *datInfo, RgInfCeInfo *ceInfo );
...
static S16 rgTOMProcCCCHSduInDatInd ( RgMacPdu *pdu, RgUeCb *prevUeCb, RgCellCb *cellCb, TfuDatInfo *datInfo, RgInfCeInfo *ceInfo );
# 186 "../..//ltemac/rg_tom.c"
#define RG_TOM_INF_ALLOC(_pdu,_size,_dataPtr,_ret) { _ret = cmGetMem((Ptr)&_pdu->memCp, _size, (Ptr *)&_dataPtr); }
# 216 "../..//ltemac/rg_tom.c"
...

{
   ...
   if (dlSf->tbs.count != 0)
   {
      ...
      while (dlSf->tbs.first)
      {
         ...
         if ((ret = rgDHMSndDatReq (dlSf, datInfo, hqCb, err)) != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 313); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlFillDatReqPdus() DHM unable                      to fill DATA request for cellId (%d)\n", cellCb->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 371 "../..//ltemac/rg_tom.c"
{
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 382); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlProcDlSf() Unable to Allocate                  TfuDatReqInfo for cellId=%d \n", cellCb->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   else
   {
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 408); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlProcDlSf() Unable to send                             data for cellId (%d)\n", cellCb->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

         cmFreeMem((Ptr)datInfo);
         return(ret);
      }
      if((datInfo->pdus.count) || (datInfo->bchDat.pres == 1))
      {

         if (rgLIMTfuDatReq(datInfo) != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 418); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlProcDlSf() Unable to send data info                      for cellId (%d)\n", cellCb->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if (cellCb == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 497); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMTtiInd() Unable to get the cellCb for cellId (%d))\n", ttiInd->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 608 "../..//ltemac/rg_tom.c"
   if ((ret = rgTOMUtlProcDlSf (dlSf, cellCb, &err)) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 611); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMTtiInd() Unable to process downlink subframe      for cellId (%d))\n", ttiInd->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if (cmAllocEvnt (sizeof (RgMacPdu), 1500, &evntMem, (Ptr*)pdu) != 0)
   {
      ...
      rgLMMStaInd(4, 13,
                                       15, &dgn);
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 666); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlAllocPduEvnt() Allocation of DUX event failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   if (cmAllocEvnt (sizeof (RgInfSfDatInd), 1500, &evntMem, (Ptr*)sfInfo) != 0)
   {
      ...
      rgLMMStaInd(4, 13,
                                       15, &dgn);
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 772); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMInfAllocPduEvnt() Allocation failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   MsgLen ccchSz;
   MsgLen cpySz;
# 1033 "../..//ltemac/rg_tom.c"
   RgUlLcCb *ulLcCb;

   cDatInd = 0L;
   dDatInd = 0L;
# 1048 "../..//ltemac/rg_tom.c"
   ulLcCb = 0L;
   ...
   if(pdu->sduLst.first)
   {
      ...
      if ((sdu->lcId == 0x00))
      {
         ...
         if ((ret = rgAllocSBuf ((Data**)&cDatInd, sizeof(RgRguCmnDatInd))) != 0)
         {
            return(1);
         }
         ...
         SCpyMsgFix (sdu->mBuf, (MsgLen)0, ccchSz, ueCb->contResId.resId,
               &cpySz);
         sdu->mBuf = 0L;
         rgUIMSndCmnDatInd(cDatInd);
         return(0);
      }
      if ((ret = rgAllocSBuf ((Data**)&dDatInd, sizeof(RgRguDedDatInd))) != 0)
      {
         return(1);
      }
...
# 1097 "../..//ltemac/rg_tom.c"
   ...
   while (node)
   {
      ...
      if(ulLcCb == 0L)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1109); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlProcMsg() Unconfigured LCID (%d)\n", sdu->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      {
         if ((ret = rgUIMSndDedDatInd(dDatInd)) != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1124); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlProcMsg() Failed to send datIndication to RGU \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            return(ret);
         }
         if ((ret = rgAllocSBuf ((Data**)&dDatInd, sizeof(RgRguDedDatInd))) != 0)
         {
...
# 1148 "../..//ltemac/rg_tom.c"
      sdu->mBuf = 0L;
      dDatInd->numLch++;
# 1168 "../..//ltemac/rg_tom.c"
      node = node->next;
   }
# 1210 "../..//ltemac/rg_tom.c"
   if((dDatInd) && (dDatInd->numLch))
   {
      ...
      if ((ret = rgUIMSndDedDatInd(dDatInd)) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1220); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMUtlProcMsg() Failed to send datIndication to RGU \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         return(ret);
      }
   }
   else if((dDatInd) && (0 == dDatInd->numLch))
   {
      ...
      rgFreeSBuf((Data **)&dDatInd,sizeof(RgRguDedDatInd));
   }

   return(0);
}
# 1249 "../..//ltemac/rg_tom.c"
...

{
   ...
   if (cellCb == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1357); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMDatInd() Unable to get the cellCb for cellId (%d))\n", datInd->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (rgTOMInfAllocPduEvnt (&sfInfo) != 0)
   {
      err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1367); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMDatInd() Unable to Allocate PDU for DUX cellId (%d))\n", datInd->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 1394 "../..//ltemac/rg_tom.c"
      if (rgTOMUtlAllocPduEvnt (&pdu) != 0)
      {
         err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1398); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMDatInd() Unable to Allocate PDU for DUX cellId (%d))\n", datInd->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
                           ...
                           datInfo->mBuf, &err)) != 0)
      {
         ...
         err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1410); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMDatInd() DUX processing failed. \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         tfuSap->sapSts.numPduDrop++;
         continue;
      }

      datInfo->mBuf = 0L;
# 1425 "../..//ltemac/rg_tom.c"
      if (ceInfo.bitMask & (1<<0))
      {
        ret = rgTOMProcCCCHSduInDatInd(pdu, prevUeCb, cellCb, datInfo, &ceInfo);
      ...
      {
        ret = rgTOMProcCrntiCEInDatInd(pdu, prevUeCb, cellCb, datInfo, &ceInfo);
      ...
      else
      {
         ...
         if (ueCb == 0L)
         {
# 1484 "../..//ltemac/rg_tom.c"
            {

               rgTOMUtlFreePduEvnt (pdu, 1);
               err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1489); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMDatInd() Unable to get the UE CB for RNTI (%d) \n", datInfo->rnti); SPrint((&rgCb.rgInit)->prntBuf); } };

               tfuSap->sapSts.numPduDrop++;
               continue;
            }
         }
# 1504 "../..//ltemac/rg_tom.c"
         if ((ret = rgTOMUtlProcMsg (cellCb, ueCb, pdu)) != 0)

         {
            rgTOMUtlFreePduEvnt (pdu, 1);
            err.errType = (((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 4);
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1509); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgTOMDatInd() Unable to handle Data Indication\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            tfuSap->sapSts.numPduDrop++;
            continue;
         }
      }

      if(rgTOMUtlInsSchInfo(pdu, sfInfo, &ceInfo, datInfo->rnti) != 0)
      {
         rgTOMInfFreePduEvnt (sfInfo);
...
# 1635 "../..//ltemac/rg_tom.c"
   ...
   {
# 1652 "../..//ltemac/rg_tom.c"
      dlSf->pcch.pdcch.rnti =
               cmnLcInfo->pcchInfo.rnti;
      dlSf->pcch.pdcch.dci =
               cmnLcInfo->pcchInfo.dciInfo;

      if (rgAllocSBuf ((Data**)&staInd, sizeof(RguCStaIndInfo)) != 0)
      {
         err->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1;
         return(1);
      }
...

{
   ...
   {
      if((ue=rgDBMGetUeCb (cell, ueInfo->allocInfo[idx].rnti)) == 0L)
      {
         ...
         if((ue=rgDBMGetUeCbFromRachLst (cell,
                     ueInfo->allocInfo[idx].rnti)) == 0L)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1801); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgHndlSchdUe(): " "No ueCb found with rnti = (%d)\n", ueInfo->allocInfo[idx].rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      rgDHMGetHqProcFrmId(ue,ueInfo->allocInfo[idx].hqProcId,&hqP);




      if(rgDHMSndStaInd(cell,ue,
               &ueInfo->allocInfo[idx], timingInfo, hqP,
               err))
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1820); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgHndlSchdUe(): " "Failure in sending StaInd for UE = (%d)\n", ueInfo->allocInfo[idx].rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if(dlSf->txDone == 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 1920); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgHndlSchdUe(): SUBFRAME Not pushed to the PHY"); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if((cell = rgDBMGetCellCb(sfInfo->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2014); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "RgSchMacSfAllocReq(): " "No cellCb found with cellId = (%d)\n", sfInfo->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if(rgHndlCmnChnl(cell, sfInfo->timingInfo,
                  &sfInfo->cmnLcInfo, &err) != 0)
   {
      return(1);
   }

   if(rgHndlRaResp(cell,sfInfo->timingInfo,
                  &sfInfo->rarInfo, &err) != 0)
   {
      return(1);
   }

   if(rgHndlSchdUe(cell, sfInfo->timingInfo,
                  &sfInfo->ueInfo, &err) != 0)
   {
      return(1);
   }
# 2069 "../..//ltemac/rg_tom.c"
   return(0);
}
# 2101 "../..//ltemac/rg_tom.c"
...
# 2117 "../..//ltemac/rg_tom.c"
{
   ...
   {
       rgTOMUtlFreePduEvnt (pdu, 1);
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2129); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\nrgTOMProcCrntiCEInDatInd() Received MSG3 with CRNTI,                    unable to find ueCb for rnti(%d)\n", ceInfo->ces.cRnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
       rgTOMUtlFreePduEvnt (pdu, 1);
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2139); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\nrgTOMProcCrntiCEInDatInd() Received MSG3 with CRNTI,                    unable to find ueCb for rnti(%d)\n", ceInfo->ces.cRnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if ((rgTOMUtlProcMsg (cellCb, ueCb, pdu)) != 0)

   {
       rgTOMUtlFreePduEvnt (pdu, 1);
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2154); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\nrgTOMProcCrntiCEInDatInd() Processing for MSG3                    failed for rnti(%d)\n", datInfo->rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 2209 "../..//ltemac/rg_tom.c"
{
   ...
   {
       rgTOMUtlFreePduEvnt (pdu, 1);
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2219); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\n rgTOMProcCCCHSduInDatInd() Received MSG3                    with CRNTI and also CCCH (%d)\n", ceInfo->ces.cRnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
       rgTOMUtlFreePduEvnt (pdu, 1);
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2230); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\n rgTOMProcCCCHSduInDatInd() Processing for MSG3                    failed for rnti(%d)\n", datInfo->rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (ueCb->dl.hqEnt.numHqProcs)
   {
       ...
       rgTOMUtlFreePduEvnt (pdu, 1);
       ;
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2241); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\n rgTOMProcCCCHSduInDatInd() Processing for MSG3                    failed for rnti(%d)\n", datInfo->rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
       rgTOMUtlFreePduEvnt (pdu, 1);
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2251); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\n rgTOMProcCCCHSduInDatInd() Harq Initialization                    failed for rnti(%d)\n", datInfo->rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
       rgTOMUtlFreePduEvnt (pdu, 1);
       { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_tom.c", 2263); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"\nrgTOMProcCCCHSduInDatInd() Processing for MSG3                    failed for rnti(%d)\n", datInfo->rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
