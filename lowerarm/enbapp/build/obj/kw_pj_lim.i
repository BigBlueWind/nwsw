...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 117 "../..//lterlcpdcp/kw_pj_lim.c" 2
# 1 "../..//cm/cm5.h" 1
# 118 "../..//lterlcpdcp/kw_pj_lim.c" 2
# 1 "../..//cm/cm_lte.h" 1
# 91 "../..//cm/cm_lte.h"
#define __CM_LTE_H__ 
# 101 "../..//cm/cm_lte.h"
...
# 138 "../..//lterlcpdcp/kw_pj_lim.c" 2
# 1 "../..//cm/cm5.x" 1
# 139 "../..//lterlcpdcp/kw_pj_lim.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 150 "../..//lterlcpdcp/kw_pj_lim.c" 2
# 181 "../..//lterlcpdcp/kw_pj_lim.c"
 Void pjLimDatInd
(
PjRbCb *pjRbCb,
Buffer *mBuf
...

{
   ...
   if(pjRbCb->rbType == 0)
   {
      ...
      if ((pjRbCb->ueCb->libInfo.state == 1) ||
            (pjRbCb->rbId == 1 && pjRbCb->state != 2))
      {
   ...
   if (ret != 0)
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lim.c", 228); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjLimDatInd: pjHdlProcessPdu Failed\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

   }

   return;
}
# 255 "../..//lterlcpdcp/kw_pj_lim.c"
 Void pjLimDatCfm
(
PjRbCb *pjRbCb,
PjDatCfm *datCfm
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lim.c", 272); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjLimCDatInd(pjRbCb(%d), datCfm)\n",pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);





   ret = pjDlmProcessCfm(pjRbCb, datCfm, 0);
# 286 "../..//lterlcpdcp/kw_pj_lim.c"
   return;
}
# 311 "../..//lterlcpdcp/kw_pj_lim.c"
 Void pjLimStaInd
(
PjRbCb *pjRbCb,
PjDatCfm *staInd
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lim.c", 327); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjLimStaInd(pjRbCb(%d), staInd)\n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   ret = pjDlmProcessCfm(pjRbCb, staInd, 1);


   if (ret != 0)
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lim.c", 336); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjLimStaInd: pjDlmProcessCfm Failed\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

   }

   return;
}
# 363 "../..//lterlcpdcp/kw_pj_lim.c"
 Void pjLimReEstCmpInd
(
PjRbCb *pjRbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lim.c", 375); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjLimReEstCmpInd(pjRbCb(%d))\n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if(pjRbCb->rbType == 0)
   {
      ...
      if (pjRbCb->rbId == 1 && pjRbCb->state == 2)
      {
...
# 402 "../..//lterlcpdcp/kw_pj_lim.c"
      if ( pjRbCb->state != 1 )
      {
         if (pjRbCb->mode == 2)
         {
            { pjRbCb->ulCb.nxtRxSn = 0; pjRbCb->ulCb.rxHfn = 0; pjUlmDecReEstCnt(pjRbCb); };
         }
         else
         {
