...
#define CM_LTE_SRB 0
#define CM_LTE_DRB 1
# 104 "../..//ltemac/rg_sch_pwr.c" 2
# 1 "../..//cm/cm_math.h" 1
# 86 "../..//cm/cm_math.h"
#define __CMMATHH__ 
# 105 "../..//ltemac/rg_sch_pwr.c" 2
# 1 "../..//cm/lrg.h" 1
# 102 "../..//cm/lrg.h"
#define __LRGH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 117 "../..//ltemac/rg_sch_pwr.c" 2
# 1 "../..//cm/cm5.x" 1
# 118 "../..//ltemac/rg_sch_pwr.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 27 "/usr/include/bits/huge_vall.h" 3 4
...
static S8 rgSCHPwrGetCqiPwrForUe ( RgSchUeCb *ue, U8 cqi );
...
static S8 rgSCHPwrGetDelta2FrmCqi ( U8 crntCqi, U8 trgCqi );
...
static Bool rgSCHPwrIsDlUeSched ( RgSchUeCb *ue, RgSchDlSf *sf );
...
static S8 rgSCHPwrGetDeltaFrmAbsTpc ( U8 tpc );
# 439 "../..//ltemac/rg_sch_pwr.c"
 Void rgSCHPwrInit
(
Void
)
...
{
   RgSchCmnUeUlPwrCb *uePwr = &((RgSchCmnUe *)((ue)->sch))->ul.ulPwrCb;
   ;;
...

{
   ...
   return((trgCqi - crntCqi) * 2);
}
# 829 "../..//ltemac/rg_sch_pwr.c"
...

{
   ...
   ;;
# 950 "../..//ltemac/rg_sch_pwr.c"
   return(rgSchPwrRbToPwrTbl[numRb]);
}
# 970 "../..//ltemac/rg_sch_pwr.c"
...

{
   ...
   if (uePwr->tpcPucchRntiCb->isFmt3a)
   {
      if (uePwr->remPucchPwr <= 1 && uePwr->remPucchPwr >= -1)
      {
         rmvUe = 1;
      }
   }
...

{
   ...
   if (uePwr->tpcPuschRntiCb->isFmt3a)
   {
      if (uePwr->remPuschPwr <= 1 && uePwr->remPuschPwr >= -1)
      {
         rmvUe = 1;
      }
   }
...

{
   ...
   uePwr->phVal -= (rgSCHPwrRbToPwr(cell,uePwr->numRb)) - rbPwr;
...
# 2380 "../..//ltemac/rg_sch_pwr.c"
   uePwr->remPuschPwr =
      ...
      rgSCHPwrGetDelta2FrmCqi(ueUl->crntUlCqi[0], uePwr->trgCqi) / 2;


   rgSCHPwrOnPuschPwrUpd(cell, ue);
   return;
}
# 2419 "../..//ltemac/rg_sch_pwr.c"
...
# 2880 "../..//ltemac/rg_sch_pwr.c"
   return(0);
}
# 2911 "../..//ltemac/rg_sch_pwr.c"
 Void rgSCHPwrUeDel
(
RgSchCellCb *cell,
RgSchUeCb *ue
...

{
   ...
   if (cb->isFmt3a)
   {
      if (((uePwr->phVal > 1) && (uePwr->remPuschPwr > 1))
            || (uePwr->remPuschPwr < -1))
      {
         toAdd = 1;
      }
...

{
   ...
   cb = &cellPwr->tpcPucchRntiLst[cellPwr->tpcPucchRntiCnt++];
   rgSCHPwrInitTpcRntiCb(cb, rnti, isFmt3a);
   return;
}
# 3184 "../..//ltemac/rg_sch_pwr.c"
...

{
   ...
   cb = &cellPwr->tpcPuschRntiLst[cellPwr->tpcPuschRntiCnt++];
   rgSCHPwrInitTpcRntiCb(cb, rnti, isFmt3a);
   return;
}
# 3221 "../..//ltemac/rg_sch_pwr.c"
...
# 4116 "../..//ltemac/rg_sch_pwr.c"
static S8 rgSCHPwrGetDeltaFrmAbsTpc
(
U8 tpc
)
