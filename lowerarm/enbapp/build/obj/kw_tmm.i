...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 116 "../..//lterlcpdcp/kw_tmm.c" 2
# 1 "../..//cm/cm5.h" 1
# 117 "../..//lterlcpdcp/kw_tmm.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 139 "../..//lterlcpdcp/kw_tmm.c" 2

# 1 "../..//cm/cm5.x" 1
# 141 "../..//lterlcpdcp/kw_tmm.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 158 "../..//lterlcpdcp/kw_tmm.c" 2

static S16 kwTmmSndStaRsp ( KwRbCb *rbCb, MsgLen bo, KwuDatReqInfo *datReqInfo);
# 187 "../..//lterlcpdcp/kw_tmm.c"
 S16 kwTmmQSdu
(
KwRbCb *rbCb,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_tmm.c", 206); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwTmmQSdu(rbCb, datReqInfo, mBuf)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&sdu, (Size) sizeof(KwSdu)) == 0) { cmMemset((U8 *)(sdu), 0, sizeof(KwSdu)); } else { (sdu) = 0L; } };
# 219 "../..//lterlcpdcp/kw_tmm.c"
   if ( rbCb->lch[0].lChType == 1 ||
        rbCb->lch[0].lChType == 2 )
   {
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_tmm.c", 284); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwTmmSndToLi(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   sduQ = &(rbCb->m.tm.sduQ);
   ((((node) = ((sduQ)->crnt = (sduQ)->first)) != 0L) ? (node)->node : 0L);
   while (node != 0L)
   {
      sdu = (KwSdu *)(node->node);
      if ( rbCb->lch[0].lChType == 1 ||
...
# 309 "../..//lterlcpdcp/kw_tmm.c"
  if ((subframe + 2) >= 10)
  {
     ...
     (sdu->mode.tm.subframe != ((subframe+2)%10)))
         {
            ...
            { if (sdu != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) sdu, (Size) sizeof(KwSdu)); sdu = 0L; } };
         }
         else
         {
            break;
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&cDatReqInfo, (Size) (Size)sizeof(RguCDatReqInfo)) == 0) { cmMemset((U8 *)(cDatReqInfo), 0, (Size)sizeof(RguCDatReqInfo)); } else { (cDatReqInfo) = 0L; } };
# 373 "../..//lterlcpdcp/kw_tmm.c"
   if ( rbCb->lch[0].lChType == 1 ||
        rbCb->lch[0].lChType == 2 )
   {
...
# 462 "../..//lterlcpdcp/kw_tmm.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_tmm.c", 471); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwTmmRcvFrmLi(rbCb, pdu)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&datIndInfo, (Size) sizeof(KwuDatIndInfo)) == 0) { cmMemset((U8 *)(datIndInfo), 0, sizeof(KwuDatIndInfo)); } else { (datIndInfo) = 0L; } };
# 482 "../..//lterlcpdcp/kw_tmm.c"
   kwKwSap = kwCb.kwuSap;
   cmMemcpy((U8 *)&(datIndInfo->rlcId), (U8 *)&(rbCb->rlcId), sizeof(CmLteRlcId));


   if ( rbCb->lch[0].lChType == 3 )
   {
...
# 523 "../..//lterlcpdcp/kw_tmm.c"
 S16 kwTmmReEstablish
(
KwRbCb *rbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_tmm.c", 536); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwTmmReEstablish(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 570 "../..//lterlcpdcp/kw_tmm.c"
static S16 kwTmmSndStaRsp
(
KwRbCb *rbCb,
MsgLen bo,
KwuDatReqInfo *datReqInfo
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) )) ^ (((0x00000002 << 4) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_tmm.c", 590); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwTmmSndStaRsp(rbCb, bo, datReqInfo)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   rguSap = &(kwCb.rguSap);

   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&staRspInfo, (Size) sizeof(RguCStaRspInfo)) == 0) { cmMemset((U8 *)(staRspInfo), 0, sizeof(RguCStaRspInfo)); } else { (staRspInfo) = 0L; } };
# 603 "../..//lterlcpdcp/kw_tmm.c"
   staRspInfo->bo = bo;
