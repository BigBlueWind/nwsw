...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 115 "../..//ltemac/rg_dbm.c" 2
# 1 "../..//cm/cm5.x" 1
# 116 "../..//ltemac/rg_dbm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...

{
   ...
   return(cmHashListInit(&rgCb.inactvCellLst, numBins, (U32) (&(((RgCellCb *) 0L)->cellLstEnt)), 0, 5, rgCb.rgInit.region, rgCb.rgInit.pool));


}
# 193 "../..//ltemac/rg_dbm.c"
 S16 rgDBMDeInitInactvCellLst
(
)
...

{
   ...
   return(cmHashListDeinit(&rgCb.inactvCellLst));
}
# 220 "../..//ltemac/rg_dbm.c"
 S16 rgDBMInsInactvCellCb
(
RgCellCb *cellCb
)
...

{
   ...
   return(cmHashListInsert(&rgCb.inactvCellLst, (U32)cellCb, (U8 *)&cellCb->cellId, (U16)sizeof(cellCb->cellId)));


}
# 250 "../..//ltemac/rg_dbm.c"
 RgCellCb* rgDBMGetInactvCellCb
(
CmLteCellId cellId
)
...

{
   ...
   cmHashListFind(&rgCb.inactvCellLst, (U8 *)&cellId,
      sizeof(cellId), 0, (U32 *)&cellCb);
   return(cellCb);

}
# 283 "../..//ltemac/rg_dbm.c"
 RgCellCb* rgDBMGetNextInactvCellCb
(
RgCellCb *cellCb
)
...
{
   RgCellCb *nextCellCb = 0L;

   ;

   cmHashListGetNext(&rgCb.inactvCellLst, (U32) cellCb, (U32 *)&nextCellCb);
   return(nextCellCb);
}
# 315 "../..//ltemac/rg_dbm.c"
 S16 rgDBMDelInactvCellCb
(
RgCellCb *cellCb
)
...

{
   ...
   return(cmHashListDelete(&rgCb.inactvCellLst, (U32)cellCb));
}
# 344 "../..//ltemac/rg_dbm.c"
 S16 rgDBMInitCellLst
(
U16 numBins
)
...

{
   ...
   return(cmHashListInit(&rgCb.cellLst, numBins, (U32) (&(((RgCellCb *) 0L)->cellLstEnt)), 0, 5, rgCb.rgInit.region, rgCb.rgInit.pool));


}
# 373 "../..//ltemac/rg_dbm.c"
 S16 rgDBMDeInitCellLst
(
)
...

{
   ...
   return(cmHashListDeinit(&rgCb.cellLst));
}
# 399 "../..//ltemac/rg_dbm.c"
 S16 rgDBMInsCellCb
(
...

{
   ...
   return(cmHashListInsert(&rgCb.cellLst, (U32)cellCb, (U8 *)&cellCb->cellId, (U16)sizeof(cellCb->cellId)));


}
# 428 "../..//ltemac/rg_dbm.c"
 RgCellCb* rgDBMGetCellCb
(
CmLteCellId cellId
)
...

{
   ...
   if ((rgCb.prevCell != 0L) && (rgCb.prevCell->cellId == cellId))
   {
      return(rgCb.prevCell);
   }
...

{
   ...
   cmHashListGetNext(&rgCb.cellLst, (U32) cellCb, (U32 *)&nextCellCb);
   return(nextCellCb);
}
# 498 "../..//ltemac/rg_dbm.c"
 S16 rgDBMDelCellCb
...

{
   ...
   return(cmHashListDelete(&rgCb.cellLst, (U32)cellCb));
}
# 528 "../..//ltemac/rg_dbm.c"
 S16 rgDBMInitCell
(
...

{
   ...
   return(cmHashListInit(&cellCb->ueLst, numBins, (U16)((U32)&(ue.ueLstEnt) - (U32)&ue), 0, 5, rgCb.rgInit.region, rgCb.rgInit.pool));
...
# 1017 "../..//ltemac/rg_dbm.c"
   return;
}
# 1033 "../..//ltemac/rg_dbm.c"
