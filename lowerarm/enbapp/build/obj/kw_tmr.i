...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 103 "../..//lterlcpdcp/kw_tmr.c" 2
# 1 "../..//cm/cm5.h" 1
# 104 "../..//lterlcpdcp/kw_tmr.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 126 "../..//lterlcpdcp/kw_tmr.c" 2
# 1 "../..//cm/cm5.x" 1
# 127 "../..//lterlcpdcp/kw_tmr.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 144 "../..//lterlcpdcp/kw_tmr.c" 2
# 158 "../..//lterlcpdcp/kw_tmr.c"
static Void kwBndTmrExpiry(U32 cb);
extern U32 macGT;
# 182 "../..//lterlcpdcp/kw_tmr.c"
 S16 kwStartTmr
(
U32 cb,
S16 tmrEvnt
...

{
   ...
   switch (tmrEvnt)
   {
      case 1:
      {
         ...
         wait = (rbCb->m.um.umUl.reOrdTmrInt * 10)/(kwCb.genCfg.timeRes * 1000);


         wait = (rbCb->m.um.umUl.reOrdTmrInt * 10)/(kwCb.genCfg.timeRes * 1000);
         if( (0 != rbCb->m.um.umUl.reOrdTmrInt) && (0 == wait) )
         {
            wait = 1;
         }
         tmr = &rbCb->m.um.umUl.reOrdTmr;
         maxTmrs = 1;
         break;
      }
      case 2:
      {
         ...
         wait = (amUl->reOrdTmrInt * 10)/(kwCb.genCfg.timeRes * 1000);
      ...
      case 3:
      {
         ...
         wait = (amUl->staProhTmrInt * 10)/(kwCb.genCfg.timeRes * 1000);
...
# 287 "../..//lterlcpdcp/kw_tmr.c"
      ...
      case 4:
      {
         ...
         wait = (amDl->pollRetxTmrInt * 10)/(kwCb.genCfg.timeRes * 1000);
      ...
      case 5:
      {
         ...
         wait = (rguSap->bndTmrInt * 10)/(kwCb.genCfg.timeRes * 1000);
...

{
   ...
   switch (tmrType)
   {
      ...
      {
         rbCb = (KwRbCb *)cb;
         timers = &rbCb->m.um.umUl.reOrdTmr;
         arg.max = 1;
         break;
      }
      case 2:
...

{
   ...
   switch (tmrEvnt)
   {
      ...
      {
         rbCb = (KwRbCb *)cb;
         if (rbCb->m.um.umUl.reOrdTmr.tmrEvnt == 1)
         {
            tmrRunning = 1;
         }
         break;
