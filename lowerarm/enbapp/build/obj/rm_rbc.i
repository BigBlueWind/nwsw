...
static RmRbcRabCb* rmRbcGetERab
(
   RmRbcUeCb *rbcUeCbPtr,
   U8 eRabId
);

static S16 rmRbcDelERab
(
  RmRbcUeCb *rbcUeCbPtr,
  RmRbcRabCb *rabCbPtr,
  RrmWrERabRel *eRabRelReqList,
  RrmWrERabRel *eRabRelRespList
);

static S16 rmRbcModifyERab
(
  RmRbcUeCb *rbcUeCbPtr,
  RrmWrERabAddMod *eRabAddModReqList,
  RrmWrERabAddMod *eRabAddModRespList
);

static S16 rmRbcAddERab
(
   RmRbcUeCb *rbcUeCbPtr,
   RrmWrERabAddMod *eRabAddModReqList,
   RrmWrERabAddMod *eRabAddModRespList
...
static Void rmRbcSortInsertUeRabCb
(
   CmLList *entryLnk,
   CmLListCp *lst
);

static Bool rmCmpArpQci
(
    RmRbcRabCb *lnkNode,
    RmRbcRabCb *entry
);

static Void rmRbcAddToHighestPriorRabLst
(
   RmRbcCellCb *rbcCellCbPtr,
   RmRbcRabCb *rabCbPtr,
   U8 arp
);

static Bool rmCmpQciPrior
(
    RmRbcRabCb *lnkNode,
    RmRbcRabCb *entry
);

static S16 rmRbcModifyHighestPriorRabLst
(
   RmRbcCellCb *rbcCellCbPtr,
   RmRbcRabCb *prevHighestPriorRabPtr,
   RmRbcRabCb *crntHighestPriorRabPtr,
   U16 ueId
);

static Void rmRbcDelFrmHighestPriorRabLst
(
    RmRbcCellCb *rbcCellCbPtr,
    U16 ueId,
    U8 arp
...
static RmRbcRabCb* rmRbcGetUeHighestPriorRab
(
   RmRbcUeCb *rbcUeCbPtr
);

static U8 rmRbcGetQciPrior
(
   U8 qci
);
# 199 "../..//enbapp/lterrm/rm_rbc.c"
 S16 rmRbcInit(Void)
{

   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[0] = RM_RBC_QCI_PRIORITY_VAL2;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[1] = RM_RBC_QCI_PRIORITY_VAL4;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[2] = RM_RBC_QCI_PRIORITY_VAL3;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[3] = RM_RBC_QCI_PRIORITY_VAL5;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[4] = RM_RBC_QCI_PRIORITY_VAL1;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[5] = RM_RBC_QCI_PRIORITY_VAL6;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[6] = RM_RBC_QCI_PRIORITY_VAL7;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[7] = RM_RBC_QCI_PRIORITY_VAL8;
   rmCb.enbCb.rbcEnbCb.qciToPriorityMap[8] = RM_RBC_QCI_PRIORITY_VAL9;
   { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 211); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcInit: RBC module initialized successfully\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
   return(0);
}
# 228 "../..//enbapp/lterrm/rm_rbc.c"
 S16 rmRbcUeCfg(RmUeCb *ueCbPtr)
{

   cmLListInit(&ueCbPtr->rbcUeCb.eRabLst);


   ueCbPtr->rbcUeCb.ueCbPtr = ueCbPtr;

   { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 237); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcUeCfg: ERab initialization done" " for the admitted UE.\n"); SPrint((&(rmCb.init))->prntBuf); } }; };


   return(0);
}
# 265 "../..//enbapp/lterrm/rm_rbc.c"
 S16 rmRbcAddCellCfg
(
   RmCellCb *cellCb,
   RrmWrCause *cause
)
{
   ...
   for(idx=0;idx<16;idx++)
   {
      ...
      { if (SGetSBuf(rmCb.init.region, rmCb.init.pool, (Data **)(&(cellCb->rbcCellCb.highestPriorRabHashLst[idx])), (sizeof(RmRbcQciPriorRabLst))) == 0) { { cmMemset((U8 *)((*(&(cellCb->rbcCellCb.highestPriorRabHashLst[idx])))), 0, ((sizeof(RmRbcQciPriorRabLst)))); }; } else { (*(&(cellCb->rbcCellCb.highestPriorRabHashLst[idx]))) = 0L; } };

      if ((cellCb->rbcCellCb.highestPriorRabHashLst) == 0L)
      {
         { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 282); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcAddCellCfg:" "Failed to allocate memory for highestPriorRabHashLst"); SPrint((&(rmCb.init))->prntBuf); } }; };

         return(1);
      }
      cmLListInit(&cellCb->rbcCellCb.highestPriorRabHashLst[idx]->qciPriorRabLst);
   }

   { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 289); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcAddCellCfg : Inititialized                        highestPriorRabHashLst successfully.\n"); SPrint((&(rmCb.init))->prntBuf); } }; };


   return(0);
}
# 312 "../..//enbapp/lterrm/rm_rbc.c"
 S16 rmRbcModCellCfg
(
   RmCellCb *cellCb
)
...
)
{
   ...
   for(idx=0;idx<16;idx++)
   {
      ...
      { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) ((cellCb->rbcCellCb.highestPriorRabHashLst[idx])), (Size) (sizeof(RmRbcQciPriorRabLst))); ((cellCb->rbcCellCb.highestPriorRabHashLst[idx])) = 0L; };

   }

   return(0);
}
# 370 "../..//enbapp/lterrm/rm_rbc.c"
static RmRbcRabCb* rmRbcGetERab
(
   RmRbcUeCb *rbcUeCbPtr,
   U8 eRabId
...
{
   CmLListCp *eRabLst = 0L;
   CmLList *eRabLstLnk = 0L;
   RmRbcRabCb *rabCbPtr = 0L;

   eRabLst = &(rbcUeCbPtr->eRabLst);
   ((((eRabLstLnk) = ((eRabLst)->crnt = (eRabLst)->first)) != 0L) ? (eRabLstLnk)->node : 0L);

   while (0L != eRabLstLnk)
   {
      rabCbPtr = (RmRbcRabCb *)(eRabLstLnk->node);
      if (rabCbPtr->eRabId == eRabId)
      {
         return(rabCbPtr);
      }
      eRabLstLnk = eRabLstLnk->next;
   }
   return(rabCbPtr);
}
# 423 "../..//enbapp/lterrm/rm_rbc.c"
 S16 rmRbcUeRecfg
(
   RmUeCb *ueCbPtr,
   RrmWrERabCfg *ueRabCfg,
...
)
{
   U8 idx;
   U8 crntArpPrior = 0;
   RmRbcRabCb *prevRabCbPtr = 0L;
   RmRbcRabCb *crntRabCbPtr = 0L;
   RmRbcRabCb *rabCbPtr = 0L;

   { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 437); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcUeRecfg : Received UE                          reconfiguration request at RBC module.\n"); SPrint((&(rmCb.init))->prntBuf); } }; };



   prevRabCbPtr = rmRbcGetUeHighestPriorRab(&(ueCbPtr->rbcUeCb));


   recfgResp->ueERabCfg = *ueRabCfg;


   for(idx=0;idx<ueRabCfg->numERabToRel;idx++)
   {

      rabCbPtr = rmRbcGetERab(&(ueCbPtr->rbcUeCb),
                                  ueRabCfg->eRabRelList[idx].eRabId);

      if(0L != rabCbPtr)
      {

         if (prevRabCbPtr->eRabId == rabCbPtr->eRabId)
         {

            crntArpPrior = rabCbPtr->eRabCfgInfo.arpInfo.priorityLvl;

            rmRbcDelFrmHighestPriorRabLst(&(ueCbPtr->cellCbPtr->rbcCellCb),
                                           ueCbPtr->ueId, crntArpPrior);
         }


         rmRbcDelERab( &(ueCbPtr->rbcUeCb), rabCbPtr,
                       &(ueRabCfg->eRabRelList[idx]),
                       &(recfgResp->ueERabCfg.eRabRelList[idx]));

      }
      else
      {
         { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 474); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcUeRecfg:" "ERab[eRabID = %d], requested to be deleted does not exists.", ueRabCfg->eRabRelList[idx].eRabId); SPrint((&(rmCb.init))->prntBuf); } }; };


         recfgResp->ueERabCfg.eRabRelList[idx].statusInfo.status = RRM_WR_CFG_FAILURE;
         recfgResp->ueERabCfg.eRabRelList[idx].statusInfo.cause = RRM_WR_CAUSE_OTHER;
         recfgResp->ueERabCfg.eRabRelList[idx].eRabId =
                                         ueRabCfg->eRabRelList[idx].eRabId;
      }
   }


   for(idx=0;idx<ueRabCfg->numERabToAddMod;idx++)
   {

      if(!ueRabCfg->eRabAddModList[idx].isERabToAdd)
      {
          rmRbcModifyERab( &(ueCbPtr->rbcUeCb),
                     &(ueRabCfg->eRabAddModList[idx]),
                     &(recfgResp->ueERabCfg.eRabAddModList[idx]));
      }
      else
      {
          rmRbcAddERab( &(ueCbPtr->rbcUeCb),
                     &(ueRabCfg->eRabAddModList[idx]),
                     &(recfgResp->ueERabCfg.eRabAddModList[idx]));
      }
   }

   if(rmCacAdmGetEstabCause(ueCbPtr) != RRM_WR_EMERGENCY)
   {
      crntRabCbPtr = rmRbcGetUeHighestPriorRab(&(ueCbPtr->rbcUeCb));
      rmRbcModifyHighestPriorRabLst( &(ueCbPtr->cellCbPtr->rbcCellCb),
                            prevRabCbPtr,
                            crntRabCbPtr,
                            ueCbPtr->ueId);
   }
...
)
{
   ...
   rbcUeCbPtr->totalGbr = rbcUeCbPtr->totalGbr
                          - rabCbPtr->eRabCfgInfo.qosInfo.gbrInfo.dlGbr
                          - rabCbPtr->eRabCfgInfo.qosInfo.gbrInfo.ulGbr;

   eRabLst = &(rbcUeCbPtr->eRabLst);

   cmLListDelFrm(eRabLst, &(rabCbPtr->erabCbLnk));
   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rabCbPtr), (Size) (sizeof(RmRbcRabCb))); (rabCbPtr) = 0L; };

   eRabRelRespList->statusInfo.status = RRM_WR_CFG_SUCCESS;
   eRabRelRespList->statusInfo.cause = RRM_WR_CAUSE_NOT_APP;
   eRabRelRespList->eRabId = eRabRelReqList->eRabId;

   { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 563); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcDelERab : Deleted ERab                        with eRabID = %d.\n", eRabRelReqList->eRabId); SPrint((&(rmCb.init))->prntBuf); } }; };


   return(0);

}
# 595 "../..//enbapp/lterrm/rm_rbc.c"
static S16 rmRbcModifyERab
(
  RmRbcUeCb *rbcUeCbPtr,
  RrmWrERabAddMod *eRabAddModReqList,
...
{
   U8 crntArpPrior = 0;
   U8 modifiedArpPrior = 0;
   U8 crntQci = 0;
   U8 modifiedQci = 0;
   CmLListCp *eRabLst = 0L;
   CmLList *rabToSortLstLnk = 0L;
   RmRbcRabCb *rabCbPtr = 0L;

   rabCbPtr = rmRbcGetERab(rbcUeCbPtr, eRabAddModReqList->eRabId);

   if(0L != rabCbPtr)
   {

      crntArpPrior = rabCbPtr->eRabCfgInfo.arpInfo.priorityLvl;
      crntQci = rabCbPtr->eRabCfgInfo.qosInfo.qci;


      rbcUeCbPtr->totalGbr = rbcUeCbPtr->totalGbr
                   - rabCbPtr->eRabCfgInfo.qosInfo.gbrInfo.dlGbr
                   - rabCbPtr->eRabCfgInfo.qosInfo.gbrInfo.ulGbr
                   + eRabAddModReqList->eRabCfg.qosInfo.gbrInfo.dlGbr
                   + eRabAddModReqList->eRabCfg.qosInfo.gbrInfo.dlGbr;


      rabCbPtr->eRabCfgInfo = eRabAddModReqList->eRabCfg;

      modifiedArpPrior = eRabAddModReqList->eRabCfg.arpInfo.priorityLvl;
      modifiedQci = eRabAddModReqList->eRabCfg.qosInfo.qci;


      if((crntArpPrior != modifiedArpPrior) || (crntQci != modifiedQci))
      {
         eRabLst = &(rbcUeCbPtr->eRabLst);


         rabToSortLstLnk = cmLListDelFrm(eRabLst, &(rabCbPtr->erabCbLnk));


         rmRbcSortInsertUeRabCb(rabToSortLstLnk, eRabLst);

      }

      eRabAddModRespList->statusInfo.status = RRM_WR_CFG_SUCCESS;
      eRabAddModRespList->statusInfo.cause = RRM_WR_CAUSE_NOT_APP;
      eRabAddModRespList->eRabId = eRabAddModReqList->eRabId;

      { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 649); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcModifyERab : Modified ERab                        with eRabID = %d.\n", eRabAddModReqList->eRabId); SPrint((&(rmCb.init))->prntBuf); } }; };

   }
   else
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 655); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcModifyERab:" "ERab[eRabID = %d], requested to be modified does not exists.", eRabAddModReqList->eRabId); SPrint((&(rmCb.init))->prntBuf); } }; };


      eRabAddModRespList->statusInfo.status = RRM_WR_CFG_FAILURE;
      eRabAddModRespList->statusInfo.cause = RRM_WR_CAUSE_OTHER;
      eRabAddModRespList->eRabId = eRabAddModReqList->eRabId;
      return(1);
   }
   return(0);
}
# 689 "../..//enbapp/lterrm/rm_rbc.c"
static S16 rmRbcAddERab
(
   RmRbcUeCb *rbcUeCbPtr,
   RrmWrERabAddMod *eRabAddModReqList,
...
{
   RmRbcRabCb *newRabCb = 0L;

   { if (SGetSBuf(rmCb.init.region, rmCb.init.pool, (Data **)(&newRabCb), (sizeof(RmRbcRabCb))) == 0) { { cmMemset((U8 *)((*(&newRabCb))), 0, ((sizeof(RmRbcRabCb)))); }; } else { (*(&newRabCb)) = 0L; } };
   if (newRabCb == 0L)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 702); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcAddERabs:" "Failed to allocate memory for RmRbcRabCb"); SPrint((&(rmCb.init))->prntBuf); } }; };

      eRabAddModRespList->statusInfo.status = RRM_WR_CFG_FAILURE;
      eRabAddModRespList->statusInfo.cause = RRM_WR_CAUSE_OUT_OF_RESOURCE;
      eRabAddModRespList->eRabId = eRabAddModReqList->eRabId;
   ...
   rbcUeCbPtr->totalGbr = rbcUeCbPtr->totalGbr
                            + eRabAddModReqList->eRabCfg.qosInfo.gbrInfo.dlGbr
                            + eRabAddModReqList->eRabCfg.qosInfo.gbrInfo.ulGbr;



   newRabCb->eRabId = eRabAddModReqList->eRabId;


   newRabCb->eRabCfgInfo = eRabAddModReqList->eRabCfg;


   newRabCb->rbcUeCbPtr = rbcUeCbPtr;


   newRabCb->erabCbLnk.node = (U32)newRabCb;
   newRabCb->rabNodeLnk.node = (U32)newRabCb;


   rmRbcSortInsertUeRabCb(&newRabCb->erabCbLnk,
                                    &(rbcUeCbPtr->eRabLst));
   ...
   { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 738); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcAddERab : Added ERab                        with eRabID = %d.\n", eRabAddModReqList->eRabId); SPrint((&(rmCb.init))->prntBuf); } }; };

   return(0);
}
# 766 "../..//enbapp/lterrm/rm_rbc.c"
static Void rmRbcSortInsertUeRabCb
(
   CmLList *entryLnk,
   CmLListCp *lst
)
{
   ...
   ((((crntLnk) = ((lst)->crnt = (lst)->first)) != 0L) ? (crntLnk)->node : 0L);


   while(crntLnk != 0L)
   {

      ret = rmCmpArpQci((RmRbcRabCb*)crntLnk->node,
                                 (RmRbcRabCb*)entryLnk->node);
      if(ret == 1)
      {
         cmLListInsCrnt(lst, entryLnk);
         break;
      }
      ((((crntLnk) = ((lst)->crnt = ((lst)->crnt ? (lst)->crnt->next : (lst)->first)))!= 0L) ? (crntLnk)->node : 0L);
   }
   if(ret == 0)
   {
...
)
{
   ...
   if(entry->eRabCfgInfo.arpInfo.priorityLvl == lnkNode->eRabCfgInfo.arpInfo.priorityLvl)
   {
      entryQci = entry->eRabCfgInfo.qosInfo.qci;
      linkQci = lnkNode->eRabCfgInfo.qosInfo.qci;


      entryQciPrior = rmRbcGetQciPrior(entryQci);
      linkQciPrior = rmRbcGetQciPrior(linkQci);

      if(entryQciPrior >= linkQciPrior)
      {
         return(0);
      }
      else
   ...
   else if(entry->eRabCfgInfo.arpInfo.priorityLvl > lnkNode->eRabCfgInfo.arpInfo.priorityLvl)
   {
      return(0);
   }
   else
...
)
{
   ...
   lst = &(rbcCellCbPtr->highestPriorRabHashLst[arp]->qciPriorRabLst);
   entryLnk = &rabCbPtr->rabNodeLnk;
   ...
   while(crntLnk != 0L)
   {
      ...
      ret = rmCmpQciPrior((RmRbcRabCb*)crntLnk->node,
                                    (RmRbcRabCb*)entryLnk->node);
      if(ret == 1)
      {
         cmLListInsCrnt(lst, entryLnk);
...
)
{
   ...
   if(0L != crntHighestPriorRabPtr)
   {
      crntArp = crntHighestPriorRabPtr->eRabCfgInfo.arpInfo.priorityLvl;
      crntQci = crntHighestPriorRabPtr->eRabCfgInfo.qosInfo.qci;
      crntQciPrior = rmRbcGetQciPrior(crntQci);

      if(0L != prevHighestPriorRabPtr)
      {
         prevArp = prevHighestPriorRabPtr->eRabCfgInfo.arpInfo.priorityLvl;
         prevQci = prevHighestPriorRabPtr->eRabCfgInfo.qosInfo.qci;
         prevQciPrior = rmRbcGetQciPrior(prevQci);



         if(prevHighestPriorRabPtr->eRabId != crntHighestPriorRabPtr->eRabId)
         {

            if((prevArp != crntArp) || (prevQciPrior != crntQciPrior))
            {
               rmRbcDelFrmHighestPriorRabLst(rbcCellCbPtr, ueId, prevArp);
            }
...
# 1053 "../..//enbapp/lterrm/rm_rbc.c"
      ...
      if(!isNodePres)
      {
         ...
         rmRbcAddToHighestPriorRabLst(rbcCellCbPtr, crntHighestPriorRabPtr,crntArp);
      }

      { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 1069); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcModifyHighestPriorRabLst : Updated                        highestPriorRabHashLst.\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
...
{
   CmLList *rabNodeLnk = 0L;
   CmLListCp *qciPriorRabLstPtr = 0L;
   RmRbcRabCb *rabNodePtr = 0L;

   qciPriorRabLstPtr =
        &(rbcCellCbPtr->highestPriorRabHashLst[arp]->qciPriorRabLst);

   ((((rabNodeLnk) = ((qciPriorRabLstPtr)->crnt = (qciPriorRabLstPtr)->first)) != 0L) ? (rabNodeLnk)->node : 0L);

   while (0L != rabNodeLnk)
   {
      rabNodePtr = (RmRbcRabCb *)(rabNodeLnk->node);
      if (rabNodePtr->rbcUeCbPtr->ueCbPtr->ueId == ueId)
      {

         cmLListDelFrm(qciPriorRabLstPtr, rabNodeLnk);
         { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_rbc.c", 1119); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmRbcDelFrmHighestPriorRabLst : Deleted                        from highestPriorRabHashLst.\n"); SPrint((&(rmCb.init))->prntBuf); } }; };

         break;
      }
      rabNodeLnk = rabNodeLnk->next;
   }
   return;
}
# 1139 "../..//enbapp/lterrm/rm_rbc.c"
static RmRbcRabCb* rmRbcGetUeHighestPriorRab
(
   RmRbcUeCb *rbcUeCbPtr
)
{
   CmLListCp *rabCbLst = 0L;
   RmRbcRabCb *rabCbPtr = 0L;

   rabCbLst = &(rbcUeCbPtr->eRabLst);

   if(0L != rabCbLst->first)
   {
      rabCbPtr = (RmRbcRabCb *)(rabCbLst->first->node);
   }

   return(rabCbPtr);
}
# 1178 "../..//enbapp/lterrm/rm_rbc.c"
 RmUeCb* rmRbcGetLeastPriorUeToRel
(
   RmCellCb *cellCbPtr
)
{
   U8 idx;
   CmLListCp *qciPriorRabLst = 0L;
   CmLList *rabNodeLnk = 0L;
   RmRbcRabCb *rabNodePtr = 0L;
   ...
   {
      qciPriorRabLst = &(cellCbPtr->rbcCellCb.highestPriorRabHashLst[idx]->qciPriorRabLst);

      ((((rabNodeLnk) = ((qciPriorRabLst)->crnt = (qciPriorRabLst)->first)) != 0L) ? (rabNodeLnk)->node : 0L);

      if(0L != rabNodeLnk)
      {
         rabNodePtr = (RmRbcRabCb *)(rabNodeLnk->node);

         return(rabNodePtr->rbcUeCbPtr->ueCbPtr);
      }
   }
   return(0L);
}
# 1223 "../..//enbapp/lterrm/rm_rbc.c"
 S16 rmRbcUeDelAllERabs
(
   RmUeCb *ueCbPtr
)
{
   ...
   CmLList *rabCbLnk = 0L;
   RmRbcRabCb *rabCbPtr = 0L;
   RmRbcRabCb *maxPriorERabPtr = 0L;


   rabCbLst = &(ueCbPtr->rbcUeCb.eRabLst);
   ((((rabCbLnk) = ((rabCbLst)->crnt = (rabCbLst)->first)) != 0L) ? (rabCbLnk)->node : 0L);

   maxPriorERabPtr = rmRbcGetUeHighestPriorRab(&(ueCbPtr->rbcUeCb));

   if(0L != maxPriorERabPtr)
   {

      crntArpPrior = maxPriorERabPtr->eRabCfgInfo.arpInfo.priorityLvl;
   ...
   while (0L != rabCbLnk)
   {
      rabCbPtr = (RmRbcRabCb *)(rabCbLnk->node);


      cmLListDelFrm(rabCbLst, rabCbLnk);
      rabCbLnk = rabCbLnk->next;
      { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rabCbPtr), (Size) (sizeof(RmRbcRabCb))); (rabCbPtr) = 0L; };
   }

   return(0);
}
# 1275 "../..//enbapp/lterrm/rm_rbc.c"
 U32 rmRbcGetTotalGbr
(
   RmUeCb *ueCbPtr
)
{
   return(ueCbPtr->rbcUeCb.totalGbr);
}
# 1296 "../..//enbapp/lterrm/rm_rbc.c"
static U8 rmRbcGetQciPrior
(
   U8 qci
)
{
   ...
   return(rmCb.enbCb.rbcEnbCb.qciToPriorityMap[qci-1]);
}
# 1322 "../..//enbapp/lterrm/rm_rbc.c"
 U8 rmRbcGetUeHighestPriorQci
(
   RmUeCb *ueCbPtr
)
{
   U8 highestQci = 0;
   U8 highestQciPrior = 0;
   U8 crntQci = 0;
   U8 crntQciPrior = 0;
   CmLListCp *rabCbLst = 0L;
   CmLList *rabCbLnk = 0L;
   ...
   highestQci = rabCbPtr->eRabCfgInfo.qosInfo.qci;
   highestQciPrior = rmRbcGetQciPrior(highestQci);
   ...
   while(0L != rabCbLnk)
   {
      ...
      crntQci = rabCbPtr->eRabCfgInfo.qosInfo.qci;
      crntQciPrior = rmRbcGetQciPrior(crntQci);
      if(crntQciPrior > highestQciPrior)
      {
         highestQciPrior = crntQciPrior;
         highestQci = crntQci;
      }
      rabCbLnk = rabCbLnk->next;
   }
