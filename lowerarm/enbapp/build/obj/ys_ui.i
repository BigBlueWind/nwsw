...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//lteclpal/ys_ui.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//lteclpal/ys_ui.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
# 107 "../..//lteclpal/ys_ui.c" 2
# 1 "../..//cm/lys.h" 1
# 102 "../..//cm/lys.h"
#define __LYS_H__ 

#define EVTLYSCFGREQ 0
#define EVTLYSCFGCFM 1
#define EVTLYSCNTRLREQ 2
#define EVTLYSCNTRLCFM 3
#define EVTLYSSTSREQ 4
#define EVTLYSSTSCFM 5
#define EVTLYSSSTAREQ 6
#define EVTLYSSSTACFM 7
#define EVTLYSUSTAIND 8
#define EVTLYSTRCIND 9
#define EVTLYSRSYSLOG 10

#define LYS_PT_NUM_SIZE 8

#define LYS_NOT_CFG 0
#define LYS_UNBND 1
#define LYS_BND 2
#define LYS_WAIT_BNDCFM 3
...
#define YS_TTI_TMR_VAL YS_TTI_TMR_VAL_CFG
# 148 "../..//lteclpal/ys.h"
...
#define YS_FREE_SDU(_sdu) { if (_sdu != NULLP) { cmFreeMem ((Ptr)(_sdu)); _sdu = NULLP; }}
# 438 "../..//lteclpal/ys.h"
#define YS_GET_BUF(_buf,_ret) { _ret = SGetMsg(ysCb.ysInit.region, ysCb.ysInit.pool, &(_buf)); }




#define YS_FREE_BUF(_buf) { if (_buf != NULLP) { SPutMsg (_buf); _buf = NULLP; }}
# 452 "../..//lteclpal/ys.h"
#define YS_INCR_TIMING_INFO(_timingInfo,_delta) { if ((_timingInfo.subframe + _delta) > (YS_NUM_SUB_FRAMES - 1)) _timingInfo.sfn = ((_timingInfo.sfn + 1) % YS_NUM_SFN); _timingInfo.subframe = ((_timingInfo.subframe + _delta) % YS_NUM_SUB_FRAMES); }
...
#define YS_DECR_TIMING_INFO(_timingInfo,_delta) { if (_timingInfo.subframe >= _delta) { _timingInfo.subframe = ((_timingInfo.subframe - _delta) % YS_NUM_SUB_FRAMES); } else { _timingInfo.sfn = (_timingInfo.sfn < 1) ? (YS_NUM_SFN - (1 - _timingInfo.sfn)) : (_timingInfo.sfn - 1); _timingInfo.subframe = (YS_NUM_SUB_FRAMES - (_delta - (_timingInfo.subframe)) % YS_NUM_SUB_FRAMES); } }
# 478 "../..//lteclpal/ys.h"
#define YS_CONVERT_STR4_TO_INT(_int,_str) { U16 _tmp16; _tmp16 = 0; _tmp16 = (U16) PutHiByte(_tmp16, (U8) _str[3]); _tmp16 = (U16) PutLoByte(_tmp16, (U8) _str[2]); _int = (U32) PutHiWord(_int, (U16) _tmp16); _tmp16 = (U16) PutHiByte(_tmp16, (U8) _str[1]); _tmp16 = (U16) PutLoByte(_tmp16, (U8) _str[0]); _int = (U32) PutLoWord(_int, (U16) _tmp16); }
# 490 "../..//lteclpal/ys.h"
#define YS_CALCULATE_HARQ_N_P(_nRB,_p,_Np) { S32 _temp; _Np = (_temp = ((_nRB * (12 * (_p) - 4)) / 36)) < 0 ? 0 : (U8)_temp; }





#define YS_CALCULATE_n_1_PUCCH_i(_M,_i,_Np,_Np1,_nCCEi,_n1PUCCH,_n1PUUCHi) { _n1PUUCHi = (((_M - _i - 1) * _Np) + (_i * _Np1) + _nCCEi + _n1PUCCH); }




#define YS_GET_DL_BW(_cfg) ((_cfg.dlBw == CTF_BW_RB_6) ? 6 : (_cfg.dlBw == CTF_BW_RB_15) ? 15 : (_cfg.dlBw == CTF_BW_RB_25) ? 25 : (_cfg.dlBw == CTF_BW_RB_50) ? 50 : (_cfg.dlBw == CTF_BW_RB_75) ? 75 : 100 )
...
#define YS_GET_UL_BW(_cfg) ((_cfg.ulBw == CTF_BW_RB_6) ? 6 : (_cfg.ulBw == CTF_BW_RB_15) ? 15 : (_cfg.ulBw == CTF_BW_RB_25) ? 25 : (_cfg.ulBw == CTF_BW_RB_50) ? 50 : (_cfg.ulBw == CTF_BW_RB_75) ? 75 : 100 )
...
#define PRINT_TIME() { struct timeval currTime; cv_gettimeofday(&currTime);}
...
#define YS_DIAG_LVL0(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(ysCb.ysInit.dbgMask & SS_DIAG_LVL0) { ssDiagFix(_tknId, _splArgEnum, ENTYS, ysCb.ysInit.inst, SS_DIAG_LVL0, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 536 "../..//lteclpal/ys.h"
#define YS_DIAG_LVL1(_tknId,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(ysCb.ysInit.dbgMask & SS_DIAG_LVL1) { ssDiagFix(_tknId, _splArgEnum, ENTYS, ysCb.ysInit.inst, SS_DIAG_LVL1, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 547 "../..//lteclpal/ys.h"
#define YS_DIAG_LVL2(_tknId,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(ysCb.ysInit.dbgMask & SS_DIAG_LVL2) { ssDiagFix(_tknId, _splArgEnum, ENTYS, ysCb.ysInit.inst, SS_DIAG_LVL2, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 558 "../..//lteclpal/ys.h"
#define YS_DIAG_LVL3(_tknId,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(ysCb.ysInit.dbgMask & SS_DIAG_LVL3) { ssDiagFix(_tknId, _splArgEnum, ENTYS, ysCb.ysInit.inst, SS_DIAG_LVL3, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 569 "../..//lteclpal/ys.h"
#define YS_DIAG_LVL4(_tknId,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(ysCb.ysInit.dbgMask & SS_DIAG_LVL4) { ssDiagFix(_tknId, _splArgEnum, ENTYS, ysCb.ysInit.inst, SS_DIAG_LVL4, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 110 "../..//lteclpal/ys_ui.c" 2

# 1 "../..//lteclpal/ys_err.h" 1
# 99 "../..//lteclpal/ys_err.h"
#define __YS_ERR_H__ 
...
#define YS_DBGMASK_RES 0
#define YS_DBGMASK_FATAL 1
#define YS_DBGMASK_ERR 2
#define YS_DBGMASK_PARAM 3
#define YS_DBGMASK_INFO 4


#define _ysp ysCb.apb

#define YS_DBGP(_tskInit,_dbgMask,_layerName,_msgClass,_arg1,_arg2) { if (_dbgMask >= (_msgClass)) { DBGP(_tskInit, _layerName, _msgClass, (ysCb.apb, "%s", _arg1)); DBGP(_tskInit, _layerName, _msgClass, _arg2); } }
# 129 "../..//lteclpal/ys_err.h"
#define YS_DBG_INT(_msgClass,_arg1,_arg2) YS_DBGP(&ysCb.ysInit, ysCb.ysInit.dbgMask, YS_LAYERNAME, _msgClass, _arg1, _arg2)




#define YS_DBG_PRNT(_msgClass,_arg) { if (ysCb.ysInit.dbgMask >= (_msgClass)) { sprintf _arg; SPrint(ysCb.apb); } }
# 145 "../..//lteclpal/ys_err.h"
...
#define YS_LOGERROR(errCls,errCode,errVal,errDesc) SLogError(ysCb.ysInit.ent, ysCb.ysInit.inst, ysCb.ysInit.procId, __FILE__, __LINE__, errCls, errCode, (ErrVal)errVal, errDesc);
...
#define YSLOGDBGERR(errCode,errVal,errDesc) YS_LOGERROR(ERRCLS_DEBUG, errCode, errVal, errDesc)
...
#define ERRYS (EYSBASE + 0)
#define ERRYST (EYSBASE + 0)

#define YSERR_NONE EYSBASE

#define EYS001 (ERRYS + 1)
#define EYS002 (ERRYS + 2)
#define EYS003 (ERRYS + 3)
#define EYS004 (ERRYS + 4)
#define EYS005 (ERRYS + 5)
#define EYS006 (ERRYS + 6)
#define EYS007 (ERRYS + 7)
#define EYS008 (ERRYS + 8)
#define EYS009 (ERRYS + 9)

#define EYS010 (ERRYS + 10)
#define EYS011 (ERRYS + 11)
#define EYS012 (ERRYS + 12)
#define EYS013 (ERRYS + 13)
#define EYS014 (ERRYS + 14)
#define EYS015 (ERRYS + 15)
#define EYS016 (ERRYS + 16)
#define EYS017 (ERRYS + 17)
#define EYS018 (ERRYS + 18)
#define EYS019 (ERRYS + 19)
#define EYS020 (ERRYS + 20)
#define EYS021 (ERRYS + 21)
#define EYS022 (ERRYS + 22)
#define EYS023 (ERRYS + 23)
#define EYS024 (ERRYS + 24)
#define EYS025 (ERRYS + 25)
#define EYS026 (ERRYS + 26)
#define EYS027 (ERRYS + 27)
#define EYS028 (ERRYS + 28)
#define EYS029 (ERRYS + 29)

#define EYS030 (ERRYS + 30)

#define EYS031 (ERRYS + 31)
#define EYS032 (ERRYS + 32)
#define EYS033 (ERRYS + 33)

#define EYS034 (ERRYS + 34)
#define EYS035 (ERRYS + 35)
#define EYS036 (ERRYS + 36)
#define EYS037 (ERRYS + 37)
#define EYS038 (ERRYS + 38)
#define EYS039 (ERRYS + 39)
#define EYS040 (ERRYS + 40)

#define EYS041 (ERRYS + 41)
#define EYS042 (ERRYS + 42)
#define EYS043 (ERRYS + 43)
#define EYS044 (ERRYS + 44)
#define EYS045 (ERRYS + 45)
#define EYS046 (ERRYS + 46)
#define EYS047 (ERRYS + 47)
#define EYS048 (ERRYS + 48)
#define EYS049 (ERRYS + 49)
#define EYS050 (ERRYS + 50)

#define EYST001 (ERRYST + 1)
#define EYST002 (ERRYST + 2)
#define EYST003 (ERRYST + 3)
#define EYST004 (ERRYST + 4)
#define EYST005 (ERRYST + 5)
#define EYST006 (ERRYST + 6)
#define EYST007 (ERRYST + 7)
#define EYST008 (ERRYST + 8)
#define EYST009 (ERRYST + 9)
#define EYST010 (ERRYST + 10)
#define EYST011 (ERRYST + 11)
#define EYST012 (ERRYST + 12)
#define EYST013 (ERRYST + 13)
#define EYST014 (ERRYST + 14)
#define EYST015 (ERRYST + 15)
#define EYST016 (ERRYST + 16)
#define EYST017 (ERRYST + 17)
#define EYST018 (ERRYST + 18)
#define EYST019 (ERRYST + 19)
#define EYST020 (ERRYST + 20)
#define EYST021 (ERRYST + 21)
#define EYST022 (ERRYST + 22)
#define EYST023 (ERRYST + 23)
#define EYST024 (ERRYST + 24)
#define EYST025 (ERRYST + 25)
#define EYST026 (ERRYST + 26)
#define EYST027 (ERRYST + 27)
#define EYST028 (ERRYST + 28)
#define EYST029 (ERRYST + 29)
#define EYST030 (ERRYST + 30)
#define EYST031 (ERRYST + 31)
#define EYST032 (ERRYST + 32)
#define EYST033 (ERRYST + 33)
#define EYST034 (ERRYST + 34)
#define EYST035 (ERRYST + 35)
#define EYST036 (ERRYST + 36)
#define EYST037 (ERRYST + 37)
#define EYST038 (ERRYST + 38)
#define EYST039 (ERRYST + 39)
#define EYST040 (ERRYST + 40)
#define EYST041 (ERRYST + 41)
#define EYST042 (ERRYST + 42)
#define EYST043 (ERRYST + 43)
#define EYST044 (ERRYST + 44)
#define EYST045 (ERRYST + 45)
#define EYST046 (ERRYST + 46)
#define EYST047 (ERRYST + 47)
#define EYST048 (ERRYST + 48)
#define EYST049 (ERRYST + 49)
#define EYST050 (ERRYST + 50)
#define EYST051 (ERRYST + 51)
# 112 "../..//lteclpal/ys_ui.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 116 "../..//lteclpal/ys_ui.c" 2
# 1 "../..//cm/cm5.x" 1
# 117 "../..//lteclpal/ys_ui.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 638 "../..//lteclpal/ys.x"
extern Void ysPalHdlDlMsg ( CmLteTimingInfo *timingInfo );
...
extern S16 ysPalSend2Peer ( Buffer *mBuf);
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 176); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 176); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiCtfBndReq(): suId = %d; spId = %d;\n", suId, spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ret = 0;
   ...
   if(spId == ysCb.ctfSap.spId)
   {
      ...
      {
         case 0:
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 193); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 193); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not Configured\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            ret = TfUiCtfBndCfm(&retPst, suId, 2);
            break;

         case 1:
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 198); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 198); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not yet bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ...
         case 2:
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 209); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 209); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP already bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            ret = TfUiCtfBndCfm(&ysCb.ctfSap.sapPst, suId, 1);
            break;
         default:
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 267); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 267); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiCtfUbndReq: spId = %d; reason = %d \n", spId, reason); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if(spId == ysCb.ctfSap.spId)
   {
      switch (ysCb.ctfSap.sapState)
      {
         case 2:
            ...
            { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 276); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 276); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Is Bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 350); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 350); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiCtfCfgReq(): spId = %d; transId = %s;\n", spId, transId.trans); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...
# 367 "../..//lteclpal/ys_ui.c"
   ...
   TfUiCtfCfgCfm(&ysCb.ctfSap.sapPst, ysCb.ctfSap.suId,
                 transId, 1);
# 429 "../..//lteclpal/ys_ui.c"
   SPutSBuf (pst->region, pst->pool, (Data *)cfgReqInfo,
         sizeof(CtfCfgReqInfo));

   return(ret);
}
# 453 "../..//lteclpal/ys_ui.c"
...

{
   ...
   ;
      ...
      { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 470); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 470); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysCtfDelCellCfg(): cellId = %d \n", cellRel->cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
# 483 "../..//lteclpal/ys_ui.c"
   ysCb.ttiReady = 0;
...

{
   ...
   *ctfSapCb = 0L;
# 550 "../..//lteclpal/ys_ui.c"
   *ctfSapCb = &ysCb.ctfSap;

   return(0);
}
# 573 "../..//lteclpal/ys_ui.c"
 S16 TfUiTfuBndReq
(
Pst *pst,
SuId suId,
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 594); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 594); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuBndReq(): suId = %d; spId = %d;\n", suId, spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   {
      case 0:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 624); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 624); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not Configured\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuBndCfm(&retPst, suId, 2);
         break;

      case 1:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 629); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 629); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not yet bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         tfuSap->suId = suId;
      ...
      case 2:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 642); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 642); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP already bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuBndCfm(&tfuSap->sapPst, suId, 1);
         break;
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 695); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 695); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuUbndReq: spId = %d; reason = %d \n", spId, reason); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 746); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 746); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuSchBndReq(): suId = %d; spId = %d;\n", suId, spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   {
      case 0:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 776); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 776); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not Configured\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuSchBndCfm(&retPst, suId, 2);
         break;

      case 1:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 781); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 781); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP Not yet bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         schTfuSap->suId = suId;
      ...
      case 2:
         { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 793); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 793); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAP already bound\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         ret = TfUiTfuSchBndCfm(&schTfuSap->sapPst, suId, 1);
         break;
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (4)) { { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 846); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Info  : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (4)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 846); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuSchUbndReq: spId = %d; reason = %d \n", spId, reason); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 902); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 902); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuCntrlReq(): spId = %d;\n", spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
# 914 "../..//lteclpal/ys_ui.c"
   if((cellCb = ysUtlGetCellCfg(cntrlReq->cellId)) == 0L)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 916); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 916); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysUtlGetCellCfg Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (cntrlReq != 0L) { cmFreeMem ((Ptr)(cntrlReq)); cntrlReq = 0L; }};
      return(1);
   }
# 934 "../..//lteclpal/ys_ui.c"
   ...
   if(ret != 0)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 940); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 940); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "CntrlReq processing Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (cntrlReq != 0L) { cmFreeMem ((Ptr)(cntrlReq)); cntrlReq = 0L; }};
      return(1);
   }
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 993); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 993); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuDatReq(): spId = %d;\n", spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1003); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1003); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysUtlGetCellCfg Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ysUtlFreeDatReq(datReq);
      return(1);
   }
   ...
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1010); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1010); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "PHY is not in running state \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ysUtlFreeDatReq(datReq);
      return(1);
   }
   ...
   tfuSapCb->tfuSts.numDatReqRcvd++;
    ...
    U8 cnt = 0;
    TfuDatReqPduInfo *temp = 0L;
    if ((TfuDatReqPduInfo *)datReq->pdus.count > 0)
    {
          ...
          for(cnt = 0; cnt < temp->nmbOfTBs; cnt++)
          {
             if (0L != temp->mBuf[cnt])
            {
                ...
                if(temp->rnti >= 1 && temp->rnti <= 60)
                {
                   ...
                   ysTrillWiresharkMsg(temp->mBuf[cnt], duplexMode, 1, 2,
                      temp->rnti, 0, datReq->timingInfo.subframe, 0, 0, 1);
                }
                else
                {
                   ysTrillWiresharkMsg(temp->mBuf[cnt], duplexMode, 1, 3,
                      temp->rnti, 0, datReq->timingInfo.subframe, 0, 0, 1);
                }
             }
          }
   ...
   if(ret != 0)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1059); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1059); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to process Data Request\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ysUtlFreeDatReq(datReq);
      return(1);
   }
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1118); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1118); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "YsUiTfuRecpReq(): spId = %d;\n", spId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1128); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1128); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysUtlGetCellCfg Failed \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (recpReq != 0L) { cmFreeMem ((Ptr)(recpReq)); recpReq = 0L; }};
      return(1);
   }
   ...
   if(cellCb->phyState != 2)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1135); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1135); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "PHY is not in running state \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (recpReq != 0L) { cmFreeMem ((Ptr)(recpReq)); recpReq = 0L; }};
      return(1);
   }
   ...
   if(ret != 0)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1149); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ui.c", 1149); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to process Reception Request\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      { if (recpReq != 0L) { cmFreeMem ((Ptr)(recpReq)); recpReq = 0L; }};
      return(1);
   }
