...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 99 "../..//lterrc/nh_init.c" 2
# 1 "../..//cm/cm5.h" 1
# 100 "../..//lterrc/nh_init.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 116 "../..//lterrc/nh_init.c" 2
# 1 "../..//cm/cm5.x" 1
# 117 "../..//lterrc/nh_init.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 129 "../..//lterrc/nh_init.c" 2
# 161 "../..//lterrc/nh_init.c"
 S16 nhActvInit
(
Ent entity,
Inst inst,
...

{
   ...
   nhCb.nhGenTqCp.tmrLen = 64;


   for (i = 0; i < 64; i++)
   {
     nhCb.nhGenTq[i].first = 0L;
     nhCb.nhGenTq[i].tail = 0L;
   }


   nhCb.nhLLyrCfgTqCp.nxtEnt = 0;
   nhCb.nhLLyrCfgTqCp.tmrLen = 64;

   for (i = 0; i < 64; i++)
   {
      nhCb.nhLLyrCfgTq[i].first = 0L;
      nhCb.nhLLyrCfgTq[i].tail = 0L;
   }
# 232 "../..//lterrc/nh_init.c"
   return(0);
