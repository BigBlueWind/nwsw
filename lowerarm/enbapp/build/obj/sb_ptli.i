...
# 144 "../..//sctp/sb_ptli.c" 2
# 1 "../..//cm/cm5.x" 1
# 145 "../..//sctp/sb_ptli.c" 2
...
#define PTSBLIHIT 
# 178 "../..//sctp/sb_ptli.c"
static S16 PtLiHitBndReq (Pst *pst, SuId suId, SpId spId);
static S16 PtLiHitServOpenReq (Pst *pst, SpId spId, UConnId servConId, CmTptAddr *servTAddr, CmTptParam *tPar, CmIcmpFilter *icmpFilter, U8 srvcType);




static S16 PtLiHitUDatReq (Pst *pst, SpId spId, UConnId spConId, CmTptAddr *remAddr, CmTptAddr *srcAddr, CmIpHdrParm *hdrParm, CmTptParam *tPar, Buffer *mBuf);
# 193 "../..//sctp/sb_ptli.c"
static S16 PtLiHitDiscReq (Pst *pst, SpId spId, U8 choice, UConnId conId, Action action, CmTptParam *tPar);
# 227 "../..//sctp/sb_ptli.c"
static HitBndReq SbLiHitBndReqMt[2] =
{
...
static HitServOpenReq SbLiHitServOpenReqMt[2] =
{
...
static HitUDatReq SbLiHitUDatReqMt[2] =
{
...
static HitDiscReq SbLiHitDiscReqMt[2] =
{
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptli.c", 320); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndReq(pst, suId(%d), spId(%d))\n", suId, spId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 366 "../..//sctp/sb_ptli.c"
{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptli.c", 377); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitServOpenReq(pst, spId(%d), servConId(%ld), servTAddr, tPar, icmpFilter, srvcType(%d))\n", spId, servConId, srvcType); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 451 "../..//sctp/sb_ptli.c"
{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptli.c", 462); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitUDatReq(pst, spId(%d), spConId(%ld), remAddr, mBuf)\n", spId, spConId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };




   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptli.c", 467); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "pst(dstEnt(%d), dstInst(%d), srcEnt(%d), srcInst(%d), selector(%d)\n", pst->dstEnt, pst->dstInst, pst->srcEnt, pst->srcInst, pst->selector); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 516 "../..//sctp/sb_ptli.c"
{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptli.c", 527); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitDiscReq(pst, spId(%d), choice(%d), conId(%ld), action(%d), tPar)\n", spId, choice, conId, action); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
