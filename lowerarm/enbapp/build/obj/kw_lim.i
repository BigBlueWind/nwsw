...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 120 "../..//lterlcpdcp/kw_lim.c" 2
# 1 "../..//cm/cm5.h" 1
# 121 "../..//lterlcpdcp/kw_lim.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 143 "../..//lterlcpdcp/kw_lim.c" 2

# 1 "../..//cm/cm5.x" 1
# 145 "../..//lterlcpdcp/kw_lim.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 163 "../..//lterlcpdcp/kw_lim.c" 2
# 193 "../..//lterlcpdcp/kw_lim.c"
 S16 KwLiRguBndCfm
(
Pst *pst,
SuId suId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 214); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguBndCfm(post, suId(%d), status(%d)\n", suId, status); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   (pst=pst);

  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x002f0001, KW_DIAG_NA, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, suId, status, 0, 0, "Received BndCfm from MAC, suId = %d, status = %d"); }}

# 245 "../..//lterlcpdcp/kw_lim.c"
   rguSap = &(kwCb.rguSap);


   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 0))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 250); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguBndCfm: For RGU SAP state=%d\n", rguSap->state); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { kwLmmSendAlarm(2, event, cause, suId, 0); };

   return(0);
}
# 311 "../..//lterlcpdcp/kw_lim.c"
 S16 KwLiRguCDatInd
(
Pst *pst,
SuId suId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 330); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguCDatInd(post, suId(%d)\n", suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x002f0002, KW_DIAG_CRNTI, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, datInd->rnti, datInd->cellId, datInd->lcId, 0, 0, "Received DatInd from MAC, Common channel, cellId = %d, lcId = %d"); }}
   ...
   ret = 0;
   rbCb = 0L;
# 349 "../..//lterlcpdcp/kw_lim.c"
   ret = kwDbmFetchRbCbForLi(0, datInd->cellId, datInd->lcId, 1, &rbCb);
   if (ret != 0)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 355); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguCDatInd: kwDbmFetchRbCbForLi --               ueId(%d), cellId(%d), lcId(%d)\n", 0, datInd->cellId, datInd->lcId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




      { if (datInd != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datInd, (Size) sizeof(RguCDatIndInfo)); datInd = 0L; } };
      return(ret);
   }
...
# 379 "../..//lterlcpdcp/kw_lim.c"
   { if (datInd != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datInd, (Size) sizeof(RguCDatIndInfo)); datInd = 0L; } };

   return(0);
}
# 408 "../..//lterlcpdcp/kw_lim.c"
 S16 KwLiRguDDatInd
(
Pst *pst,
SuId suId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 424); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguDDatInd(pst, suId(%d))\n", suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (kwUtlRcvFrmLi(datInd) != 0)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 434); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguDDatInd: kwUtlRcvFrmLi Failed\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

   }


   { if (datInd != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datInd, (Size) sizeof(RguDDatIndInfo)); datInd = 0L; } };
   return(0);
}
# 465 "../..//lterlcpdcp/kw_lim.c"
 S16 KwLiRguCStaInd
(
Pst *pst,
SuId suId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 484); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguCStaInd(post, suId(%d)\n", suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   rbCb = 0L;

  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x002f0003, KW_DIAG_NA, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, staInd->cellId, staInd->lcId, 0, 0, "Received StaInd from MAC, Common Channel, cellID = %d, lcId = %d"); }}

# 503 "../..//lterlcpdcp/kw_lim.c"
   ret = kwDbmFetchRbCbForLi(0, staInd->cellId, staInd->lcId, 2, &rbCb);
   if (ret != 0)
   {



      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 512); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguCStaInd: kwDbmFetchRbCbForLi --               ueId(%d), cellId(%d), lcId(%d)\n", 0, staInd->cellId, staInd->lcId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




      { if (staInd != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) staInd, (Size) sizeof(RguCStaIndInfo)); staInd = 0L; } };
      return(ret);
   }
   ...
   if (ret != 0)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 524); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguCStaInd: kwTmmSndToLi Failed\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 583); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguDStaInd(post, suId(%d)\n", suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (kwUtlSndToLi(staInd) != 0)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_lim.c", 593); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwLiRguDStaInd: kwUtlSndToLi Failed\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


      { if (staInd != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) staInd, (Size) sizeof(RguDStaIndInfo)); staInd = 0L; } };
      return(1);
   }
