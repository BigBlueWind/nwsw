...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 149 "../..//lterrc/nh_ptmi.c" 2
# 1 "../..//cm/cm5.x" 1
# 150 "../..//lterrc/nh_ptmi.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 166 "../..//lterrc/nh_ptmi.c" 2
# 176 "../..//lterrc/nh_ptmi.c"
#define MAXNHMI 2
# 230 "../..//lterrc/nh_ptmi.c"
static LnhStaInd NhMiLnhStaIndMt[2] =
{
...
static LnhStaCfm NhMiLnhStaCfmMt[2] =
{
...
static LnhStsCfm NhMiLnhStsCfmMt[2] =
{
...
# 292 "../..//lterrc/nh_ptmi.c"
static LnhCfgCfm NhMiLnhCfgCfmMt[2] =
{
...
static LnhCntrlCfm NhMiLnhCntrlCfmMt[2] =
{
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptmi.c", 354); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhMiLnhStaInd \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptmi.c", 391); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhMiLnhStaCfm \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptmi.c", 428); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhMiLnhStsCfm \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptmi.c", 504); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhMiLnhCfgCfm \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptmi.c", 542); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhMiLnhCntrlCfm \n"); SPrint((&nhCb.init)->prntBuf); } }; };
