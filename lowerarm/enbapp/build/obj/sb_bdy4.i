...
# 133 "../..//sctp/sb_bdy4.c" 2
# 1 "../..//cm/cm5.h" 1
# 134 "../..//sctp/sb_bdy4.c" 2
# 1 "../..//cm/cm_tpt.h" 1
# 90 "../..//cm/cm_tpt.h"
#define __CMTPTH__ 
...
# 136 "../..//sctp/sb_bdy4.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 137 "../..//sctp/sb_bdy4.c" 2
...
# 155 "../..//sctp/sb_bdy4.c" 2
# 1 "../..//cm/cm5.x" 1
# 156 "../..//sctp/sb_bdy4.c" 2
# 1 "../..//cm/cm_tpt.x" 1
# 95 "../..//cm/cm_tpt.x"
#define __CMTPTX__ 
...
# 158 "../..//sctp/sb_bdy4.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 159 "../..//sctp/sb_bdy4.c" 2
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 230); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgGen(genCfg)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( (genCfg->reConfig.altAcceptFlg != 1) &&
        (genCfg->reConfig.altAcceptFlg != 0) )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 241, (ErrCls)0x2, (ErrCode)(0 + 250), (ErrVal)(ErrVal)genCfg->reConfig.altAcceptFlg, "sbCfgGen: invalid altAcceptFlg");
...
# 255 "../..//sctp/sb_bdy4.c"
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 258, (ErrCls)0x2, (ErrCode)(0 + 252), (ErrVal)(ErrVal)genCfg->reConfig.keyTm, "sbCfgGen: invalid keyTm");

      return(13);
   }

   if (( genCfg->serviceType != 7 ) &&
       ( genCfg->serviceType != 0) &&
       ( genCfg->serviceType != 9 ) )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 267, (ErrCls)0x2, (ErrCode)(0 + 253), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid serviceType");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 274, (ErrCls)0x2, (ErrCode)(0 + 254), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid number of sctSaps");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 281, (ErrCls)0x2, (ErrCode)(0 + 255), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid number of tSaps");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 288, (ErrCls)0x2, (ErrCode)(0 + 256), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid number of Assoc");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 295, (ErrCls)0x2, (ErrCode)(0 + 257), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid number of Endpoints");
   ...
   if ( genCfg->timeRes <= 0 )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 302, (ErrCls)0x2, (ErrCode)(0 + 258), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid timeRes");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 309, (ErrCls)0x2, (ErrCode)(0 + 259), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid number of maxNmbTxChunks");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 316, (ErrCls)0x2, (ErrCode)(0 + 260), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid number of maxNmbRxChunks");

      return(13);
   }


   if ( genCfg->initARwnd < 1500)
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 324, (ErrCls)0x2, (ErrCode)(0 + 260), (ErrVal)(ErrVal)genCfg->serviceType, "sbCfgGen: invalid rwnd size (minimum of 1500 bytes needed)");

      return(13);
   }


   cmMemset((U8 *)&(sbGlobalCb.genSta), 0, sizeof(SbGenSta));;
...
# 356 "../..//sctp/sb_bdy4.c"
   if(sbGlobalCb.sbInit.cfgDone == 1)
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 359); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgGen: general config already performed\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 380 "../..//sctp/sb_bdy4.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 388); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgGen: general config \nserviceType(%d)\nmaxNmbSctSaps(%d)\n           maxNmbTSaps(%d)\nmaxNmbEndp(%d)\nmaxNmbAssoc(%d)\nmaxNmbDstAddr(%d)\n           maxNmbSrcAddr(%d)\nmaxNmbTxChunks(%ld)\nmaxNmbRxChunks(%ld) ", sbGlobalCb.genCfg.serviceType,sbGlobalCb.genCfg.maxNmbSctSaps, sbGlobalCb.genCfg.maxNmbTSaps,sbGlobalCb.genCfg.maxNmbEndp, sbGlobalCb.genCfg.maxNmbAssoc,sbGlobalCb.genCfg.maxNmbDstAddr, sbGlobalCb.genCfg.maxNmbSrcAddr,sbGlobalCb.genCfg.maxNmbTxChunks, sbGlobalCb.genCfg.maxNmbRxChunks); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 404 "../..//sctp/sb_bdy4.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 410); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "maxNmbInStrms(%d)\nmaxNmbOutStrms(%d)\ninitARwnd(%ld)\nmtuInitial(%d)\n           mtuMinInitial(%d)\nmtuMaxInitial(%d)\nperformMtu(%d)\ntimeRes(%d)\n ", sbGlobalCb.genCfg.maxNmbInStrms,sbGlobalCb.genCfg.maxNmbOutStrms, sbGlobalCb.genCfg.initARwnd,sbGlobalCb.genCfg.mtuInitial, sbGlobalCb.genCfg.mtuMinInitial,sbGlobalCb.genCfg.mtuMaxInitial, sbGlobalCb.genCfg.performMtu,sbGlobalCb.genCfg.timeRes); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 414); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgGen:hostname(%s)\n useHstName(%d) \n", sbGlobalCb.genCfg.hostname, sbGlobalCb.genCfg.useHstName); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };




   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 419); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgGen: general reconfig \nmaxInitReTx(%d)\nmaxAssocReTx(%d)\nmaxPathReTx(%d)\naltAcceptFlg(%d)\nkeyTm(%d)\nalpha(%d)\nbeta(%d)\n", sbGlobalCb.genCfg.reConfig.maxInitReTx,sbGlobalCb.genCfg.reConfig.maxAssocReTx,sbGlobalCb.genCfg.reConfig.maxPathReTx,sbGlobalCb.genCfg.reConfig.altAcceptFlg,sbGlobalCb.genCfg.reConfig.keyTm,sbGlobalCb.genCfg.reConfig.alpha,sbGlobalCb.genCfg.reConfig.beta); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 426 "../..//sctp/sb_bdy4.c"
        ...
        (cmStrlen(sbGlobalCb.genCfg.hostname) != 0) )
    {
      ...
      if(ret != 0)
      {
        SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 433, (ErrCls)0x2, (ErrCode)(0 + 261), (ErrVal)(ErrVal)0, " **** sbCfgGen: Own HostName Not Resolved **** ");
   ...
   sbGlobalCb.sbInit.lmPst.event = 0x00;

   pst = &(sbGlobalCb.sbInit.lmPst);
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 455); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "pst(dstEnt(%d), dstInst(%d), srcEnt(%d), srcInst(%d), selector(%d)\n", pst->dstEnt, pst->dstInst, pst->srcEnt, pst->srcInst, pst->selector); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   sMemSize = ( sbGlobalCb.genCfg.maxNmbSctSaps * ((sizeof(SbSctSapCb))
                + (sizeof(U32)) ) );


   sMemSize += ( sbGlobalCb.genCfg.maxNmbTSaps * ((sizeof(SbTSapCb)) +
                 (sizeof(U32)) ) );


   sMemSize += ( sbGlobalCb.genCfg.maxNmbEndp * ((sizeof(SbSctEndpCb))
                 + (sizeof(U32)) ) );
   ...
   sMemSize += ( sbGlobalCb.genCfg.maxNmbEndp * ((sizeof(SbAddrPortCb))
                 + (sizeof(U32)) ) );



   sMemSize += ( sbGlobalCb.genCfg.maxNmbAssoc *
                 ( (sizeof(SbSctAssocCb)) + (sizeof(U32)) +
                   (sizeof(SbTcb)) +
                   sbGlobalCb.genCfg.maxNmbOutStrms * (sizeof(SctStrmId)) +
                   sbGlobalCb.genCfg.maxNmbInStrms * (sizeof(SctStrmId)) +
                   (sizeof(CmLListCp)) ) );
# 505 "../..//sctp/sb_bdy4.c"
   sMemSize += ( sbGlobalCb.genCfg.maxNmbSrcAddr * ((sizeof(SbLocalAddrCb)) +
                 (sizeof(U32)) + (sizeof(CmHashListEnt))) );



   sMemSize += ( sbGlobalCb.genCfg.maxNmbDstAddr * ((sizeof(SbAssocMapCb)) +
                 (sizeof(SbAddrCb)) + (sizeof(CmHashListEnt))));


   sMemSize += ( (sbGlobalCb.genCfg.maxNmbRxChunks +
                  sbGlobalCb.genCfg.maxNmbTxChunks) * (sizeof(SbQueuedChunk)) );
# 531 "../..//sctp/sb_bdy4.c"
   ...
   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.sctSaps, genCfg->maxNmbSctSaps * sizeof(SbSctSapCb *)); if ( ret == 0 ) { cmMemset((U8*)sbGlobalCb.sctSaps, 0, genCfg->maxNmbSctSaps * sizeof(SbSctSapCb *)); sbGlobalCb.genSta.memAlloc += (genCfg->maxNmbSctSaps * sizeof(SbSctSapCb *)); } };
   if ( ret != 0 )
   {
      sbLmUndo(undoLvl);
      return(4);
   ...
   {
     sbGlobalCb.sctSaps[i] = (SbSctSapCb *) 0L;
   }


   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.tSaps, genCfg->maxNmbTSaps * sizeof(SbTSapCb *)); if ( ret == 0 ) { cmMemset((U8*)sbGlobalCb.tSaps, 0, genCfg->maxNmbTSaps * sizeof(SbTSapCb *)); sbGlobalCb.genSta.memAlloc += (genCfg->maxNmbTSaps * sizeof(SbTSapCb *)); } };
   if ( ret != 0 )
   {
      sbLmUndo(undoLvl);
      return(4);
   ...
   {
     sbGlobalCb.tSaps[i] = (SbTSapCb *) 0L;
   }


   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.assocCb, genCfg->maxNmbAssoc * sizeof(U32)); if ( ret == 0 ) { cmMemset((U8*)sbGlobalCb.assocCb, 0, genCfg->maxNmbAssoc * sizeof(U32)); sbGlobalCb.genSta.memAlloc += (genCfg->maxNmbAssoc * sizeof(U32)); } };
   if ( ret != 0 )
   {
      sbLmUndo(undoLvl);
      return(4);
   ...
   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.endpCb, genCfg->maxNmbEndp * sizeof(U32)); if ( ret == 0 ) { cmMemset((U8*)sbGlobalCb.endpCb, 0, genCfg->maxNmbEndp * sizeof(U32)); sbGlobalCb.genSta.memAlloc += (genCfg->maxNmbEndp * sizeof(U32)); } };
   if ( ret != 0 )
   {
      sbLmUndo(undoLvl);
      return(4);
   ...
   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.addrPortCb, genCfg->maxNmbEndp * sizeof(U32)); if ( ret == 0 ) { cmMemset((U8*)sbGlobalCb.addrPortCb, 0, genCfg->maxNmbEndp * sizeof(U32)); sbGlobalCb.genSta.memAlloc += (genCfg->maxNmbEndp * sizeof(U32)); } };
   ...
   {
     sbGlobalCb.endpCb[i] = (SbSctEndpCb *) 0L;
   }
   ...
   {
     sbGlobalCb.addrPortCb[i] = (SbAddrPortCb *) 0L;
   }
# 644 "../..//sctp/sb_bdy4.c"
   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.localAddrCb, genCfg->maxNmbSrcAddr * sizeof(U32)); if ( ret == 0 ) { cmMemset((U8*)sbGlobalCb.localAddrCb, 0, genCfg->maxNmbSrcAddr * sizeof(U32)); sbGlobalCb.genSta.memAlloc += (genCfg->maxNmbSrcAddr * sizeof(U32)); } };
...
# 661 "../..//sctp/sb_bdy4.c"
   ...
   {
     sbGlobalCb.localAddrCb[i] = (SbLocalAddrCb *) 0L;
   }
# 677 "../..//sctp/sb_bdy4.c"
   ret = cmHashListInit(&(sbGlobalCb.addrPortHl), genCfg->maxNmbEndp, 0, 0,
                      7 , sbGlobalCb.sbInit.region,
                        sbGlobalCb.sbInit.pool);

   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 684); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbGenCfg: could not initialize endpoint hash list\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 705 "../..//sctp/sb_bdy4.c"
   ret = cmHashListInit(&(sbGlobalCb.localAddrHl), genCfg->maxNmbSrcAddr, 0,
                        0, 4, sbGlobalCb.sbInit.region,
                        sbGlobalCb.sbInit.pool);
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 711); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbGenCfg: could not initialize local address hash list\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   undoLvl++;
    ...
    ret = cmHashListInit(&(sbGlobalCb.assocMapHl), genCfg->maxNmbDstAddr, 0,
                        0, 7 , sbGlobalCb.sbInit.region,
                        sbGlobalCb.sbInit.pool);
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 728); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbGenCfg: could not initialize association map hash list\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   ret = SRegCfgTmr(sbGlobalCb.sbInit.ent,sbGlobalCb.sbInit.inst,sbGlobalCb.genCfg.timeRes,10,sbActvTmr);


   if (ret != 0)
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 746); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbGenCfg: timer registration failed\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 872); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgSctSap(sctSapCfg(spId(%d)))\n", sctSapCfg->spId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if( (sctSapCfg->spId >= sbGlobalCb.genCfg.maxNmbSctSaps) ||
       (sctSapCfg->spId <0) )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 881, (ErrCls)0x2, (ErrCode)(0 + 262), (ErrVal)(ErrVal)sctSapCfg->spId, "sbCfgSctSap: spId out of range");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 891, (ErrCls)0x2, (ErrCode)(0 + 264), (ErrVal)0, "sbCfgSctSap: invalid maxAckDelayDg");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 898, (ErrCls)0x2, (ErrCode)(0 + 265), (ErrVal)0, "sbCfgSctSap: invalid maxBurst");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 905, (ErrCls)0x2, (ErrCode)(0 + 266), (ErrVal)0, "sbCfgSctSap: invalid maxHbBurst");

      return(13);
   }

   if ( sctSapCfg->swtch != 1 )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 912, (ErrCls)0x2, (ErrCode)(0 + 267), (ErrVal)0, "sbCfgSctSap: invalid protocol swtch");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 925, (ErrCls)0x2, (ErrCode)(0 + 268), (ErrVal)(ErrVal) 0, "sbCfgSctSap: invalid initial timer value");

      return(13);
   }

   if ( (sctSapCfg->reConfig.handleInitFlg != 1) &&
        (sctSapCfg->reConfig.handleInitFlg != 0) )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 934, (ErrCls)0x2, (ErrCode)(0 + 269), (ErrVal)(ErrVal) sctSapCfg->reConfig.handleInitFlg, "sbCfgSctSap: invalid handleInitFlg");


      return(13);
   }

   if ( (sctSapCfg->reConfig.negAbrtFlg != 1) &&
        (sctSapCfg->reConfig.negAbrtFlg != 0) )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 943, (ErrCls)0x2, (ErrCode)(0 + 270), (ErrVal)(ErrVal) sctSapCfg->reConfig.negAbrtFlg, "sbCfgSctSap: invalid negAbrtFlg");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 952, (ErrCls)0x2, (ErrCode)(0 + 271), (ErrVal)(ErrVal) sctSapCfg->reConfig.flcUpThr, "sbCfgSctSap: invalid flcUpThr");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 959, (ErrCls)0x2, (ErrCode)(0 + 272), (ErrVal)(ErrVal) 0, "sbCfgSctSap: flcUpThr <= flcLowThr");
...
# 971 "../..//sctp/sb_bdy4.c"
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 974, (ErrCls)0x2, (ErrCode)(0 + 274), (ErrVal)0, "sbCfgSctSap: invalid t5SdownGrdTm");
...
# 987 "../..//sctp/sb_bdy4.c"
   ...
   if (sctSap == (SbSctSapCb *) 0L)
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 994); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgSctSap: new SCT SAP config. request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 1021 "../..//sctp/sb_bdy4.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1026); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgSctSap: SCT SAP reconfig. request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1035, (ErrCls)0x2, (ErrCode)(0 + 276), (ErrVal)(ErrVal)sctSapCfg->reConfig.maxAckDelayTm, "sbCfgSctSap: trying to increase maxAckDelayTm");
...
# 1129 "../..//sctp/sb_bdy4.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1132); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgTSap(cfg)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if( (tSapCfg->suId >= sbGlobalCb.genCfg.maxNmbTSaps) ||
       (tSapCfg->suId < 0) )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1143, (ErrCls)0x2, (ErrCode)(0 + 277), (ErrVal)(ErrVal)tSapCfg->suId, "sbCfgTSap: suId out of range");
   ...
   if ( tSapCfg->swtch != 1 )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1150, (ErrCls)0x2, (ErrCode)(0 + 278), (ErrVal)0, "sbCfgtSap: invalid protocol swtch");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1158, (ErrCls)0x2, (ErrCode)(0 + 279), (ErrVal)(ErrVal)tSapCfg->reConfig.spId, "sbCfgTSap: spId out of range");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1166, (ErrCls)0x2, (ErrCode)(0 + 280), (ErrVal)0, "sbCfgtSap: invalid maxBndRetry");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1179, (ErrCls)0x2, (ErrCode)(0 + 281), (ErrVal)(ErrVal) 0, "sbCfgTSap: invalid tIntTmr");
   ...
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1186, (ErrCls)0x2, (ErrCode)(0 + 282), (ErrVal)(ErrVal) tSapCfg->srcNAddrLst.nmb, "sbCfgTSap: invalid number of source addresses");
   ...
   if (tSap == (SbTSapCb *) 0L)
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1196); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgTSap: new Transport SAP config. request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 1370 "../..//sctp/sb_bdy4.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1378); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgTSap: Transport SAP reconfig. request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };





    if ((tSapCfg->reConfig.sbDnsCfg.useDnsLib == 0) &&
        (tSap->tSapCfg.reConfig.sbDnsCfg.useDnsLib == 1))
    {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1387); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgTSap:useDnsLib is FALSE so deallocating the DNS library data structures \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

      cmDnsDeInitDnsCb(sbGlobalCb.dnsInfo.dnsCb);
      { if (sbGlobalCb.dnsInfo.dnsCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1389); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.dnsInfo.dnsCb, sizeof(CmDnsCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmDnsCb)); sbGlobalCb.dnsInfo.dnsCb = 0L; } };
    }


    if ((tSapCfg->reConfig.sbDnsCfg.useDnsLib == 1) &&
        (tSap->tSapCfg.reConfig.sbDnsCfg.useDnsLib == 1) &&
        (cmMemcmp((U8*)&tSap->tSapCfg.reConfig.sbDnsCfg.dnsAddr,
        (U8*)&tSapCfg->reConfig.sbDnsCfg.dnsAddr, sizeof(CmTptAddr) ) != 0 ))
    {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1400); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgTSap: This Reconfiguration is yet tobe done - DNS " " library support required\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
    ...
    if( (tSapCfg->reConfig.sbDnsCfg.useDnsLib == 1) &&
        (tSap->tSapCfg.reConfig.sbDnsCfg.useDnsLib == 0) )
    {
       { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1410); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCfgTSap:  ReInitialising DNS Library module here \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
       ...
       { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.dnsInfo.dnsCb, sizeof(CmDnsCb)); if ( ret == 0 ) { cmMemset((U8*)sbGlobalCb.dnsInfo.dnsCb, 0, sizeof(CmDnsCb)); sbGlobalCb.genSta.memAlloc += (sizeof(CmDnsCb)); } }
       cmDnsDeInitDnsCb(sbGlobalCb.dnsInfo.dnsCb);

       if( ret != 0 )
       {
          SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 1423, (ErrCls)0x2, (ErrCode)(0 + 283), (ErrVal)(ErrVal) 0, "sbCfgTSap: Memory Allocation Failure for DNSCB");


          { sbLmGenAlarm(4, 13, 15, tSapCfg->suId, 1); };
       ...
       ret = sbInitDnsCb(sbGlobalCb.dnsInfo.dnsCb, 1024,
                  &sMem, &(tSapCfg->reConfig.sbDnsCfg.dnsAddr));
       if(ret != 0)
       {
          { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 1438); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbCfgTSap: Failure returned from sbInitDnsCb \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2106); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbAllocSctSap(sctSapCfg(spId(%d)))\n", sctSapCfg->spId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sap, sizeof(SbSctSapCb)); if ( ret == 0 ) { cmMemset((U8*)sap, 0, sizeof(SbSctSapCb)); sbGlobalCb.genSta.memAlloc += (sizeof(SbSctSapCb)); } }
   if( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2113); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbAllocSctSap: could not allocate mem for SCT SAP\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

      return(4);
   }


   sap->sctSapCfg.spId = sctSapCfg->spId;




   sap->sapState = 0;
   cmMemset((U8 *)&(sap->sctSts), 0, sizeof(SbSctSapSts));;
   ...
   sap->sctPst.dstProcId = 0xFFFF;
   sap->sctPst.dstEnt = 0xFF;
   sap->sctPst.dstInst = 0xFF;
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2182); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbAllocTSap(cfg)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

   tSapCfg = &(cfg->t.cfg.s.tSapCfg);


   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sap, sizeof(SbTSapCb)); if ( ret == 0 ) { cmMemset((U8*)sap, 0, sizeof(SbTSapCb)); sbGlobalCb.genSta.memAlloc += (sizeof(SbTSapCb)); } }
   if( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2191); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbAllocTSap: could allocate static mem for transport SAP\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   sap->sapState = 0;
   sap->nmbBndRetry = 0;
   cmMemset((U8 *)&(sap->tSts), 0, sizeof(SbTSapSts));;
...
# 2238 "../..//sctp/sb_bdy4.c"
   ...
   if (sap->tSapCfg.srcNAddrLst.nmb == 0)
   {
      ...
      {
         sap->tSapCfg.srcNAddrLst.nAddr[sap->tSapCfg.srcNAddrLst.nmb]. type = 4;

         sap->tSapCfg.srcNAddrLst.nAddr[sap->tSapCfg.srcNAddrLst.nmb]. u.ipv4NetAddr = ((in_addr_t) 0x00000000);
...
# 2262 "../..//sctp/sb_bdy4.c"
   ...
   else
   {
      ...
      {
         if (sap->tSapCfg.srcNAddrLst.nAddr[i].type == 4)
         {
         ...
         else if (sap->tSapCfg.srcNAddrLst.nAddr[i].type == 6)
         {
            Bool isAny;
            { U16 _i; *(&isAny) = 1; for (_i = 0; _i < 16; _i++) { if ((sap->tSapCfg.srcNAddrLst.nAddr[i].u.ipv6NetAddr)[_i] != 0) { *(&isAny) = 0; break; } } }
...
# 2354 "../..//sctp/sb_bdy4.c"
{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2360); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLmGenAlarm(cgy(%d), evnt(%d), cause(%d), sapId(%d), swtch(%d)\n", cgy, evnt, cause, sapId, swtch); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


   if (sbGlobalCb.sbInit.usta == 0)
   {
      return;
   }


   cmMemset((U8 *)&sm, 0, sizeof(SbMgmt));;



   sm.hdr.elmId.elmnt = 2;
   sm.hdr.elmId.elmntInst1 = 0;
   sm.hdr.elmId.elmntInst2 = 0;
   sm.hdr.elmId.elmntInst3 = 0;
...
# 2406 "../..//sctp/sb_bdy4.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2408); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLmGenAlarm: Calling SbMiLsbStaInd(pst(dstEnt(%d), srcEnt(%d), selector(%d))\n", sbGlobalCb.sbInit.lmPst.dstEnt, sbGlobalCb.sbInit.lmPst.srcEnt, sbGlobalCb.sbInit.lmPst.selector); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 2450 "../..//sctp/sb_bdy4.c"
{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2457); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLmSendCfm(pst, cfmType(%d), hdr, status, reason, cfm)\n", cfmType); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 0))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2549); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLmUndo(undoLvl(%d))\n", undoLvl); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 2583 "../..//sctp/sb_bdy4.c"
      case 11 :
         ...
         (Void) SDeregCfgTmr(sbGlobalCb.sbInit.ent,sbGlobalCb.sbInit.inst,sbGlobalCb.genCfg.timeRes,10,sbActvTmr);
      ...
      case 7 :
# 2630 "../..//sctp/sb_bdy4.c"
         { if (sbGlobalCb.localAddrCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2631); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.localAddrCb, (sbGlobalCb.genCfg.maxNmbSrcAddr * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbSrcAddr * sizeof(U32))); sbGlobalCb.localAddrCb = 0L; } };
      ...
      case 6 :
         ...
         { if (sbGlobalCb.addrPortCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2641); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.addrPortCb, (sbGlobalCb.genCfg.maxNmbEndp * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbEndp * sizeof(U32))); sbGlobalCb.addrPortCb = 0L; } };



      case 5 :

         { if (sbGlobalCb.endpCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2647); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.endpCb, (sbGlobalCb.genCfg.maxNmbEndp * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbEndp * sizeof(U32))); sbGlobalCb.endpCb = 0L; } };


      case 4 :

         { if (sbGlobalCb.assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2652); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.assocCb, (sbGlobalCb.genCfg.maxNmbAssoc * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbAssoc * sizeof(U32))); sbGlobalCb.assocCb = 0L; } };


      case 3 :

         { if (sbGlobalCb.tSaps == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2657); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.tSaps, (sbGlobalCb.genCfg.maxNmbTSaps * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbTSaps * sizeof(U32))); sbGlobalCb.tSaps = 0L; } };


      case 2 :

         { if (sbGlobalCb.sctSaps == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2662); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.sctSaps, (sbGlobalCb.genCfg.maxNmbSctSaps*sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbSctSaps*sizeof(U32))); sbGlobalCb.sctSaps = 0L; } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 0))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2720); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbDetDuration(st, et, dura)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2860); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbCntrlTSap(cntrl(action(%d)))\n", action ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };





   if ( (action != 31) && (action != 7) && (action != 21) )
   {
# 2875 "../..//sctp/sb_bdy4.c"
      return(9);
   }
...
# 2965 "../..//sctp/sb_bdy4.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 2971); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbCntrlTSap: returning (%d)\n", ret ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 3011 "../..//sctp/sb_bdy4.c"
{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3034); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbTrcBuf(suId(%d), evnt(%d))\n", suId, evnt ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };




   cmMemset((U8 *)&mgt, 0, sizeof(SbMgmt));;
   ...
   if (ret != 0)
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 4))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3047); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbAcRtrvUnack: Find length message failed\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if((ret != 0) || (mLen2 != mLen))
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy4.c", 3060, (ErrCls)0x1, (ErrCode)(0 + 291), (ErrVal)(ErrVal) ret, "sbTrcBuf: Failed to create a copy of the mBuf");
   ...
   else
   {
      ...
      if(src->type == 4)
      {
        tmpU32 = htonl(src->u.ipv4TptAddr.address);
        cmInetNtoa(tmpU32, &addrStr);

         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3081); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "IPv4 Source Address :%s\n", addrStr); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 3093 "../..//sctp/sb_bdy4.c"
      if(dst->type == 4)
      {
        tmpU32 = htonl(dst->u.ipv4TptAddr.address);
        cmInetNtoa(tmpU32, &addrStr);
...
# 3109 "../..//sctp/sb_bdy4.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3192); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbTrcBuf, calling SbMiLsbTrcInd (len(%d))\n", mLen2 ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3242); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCntrlGen(cntrl(action(%d), subAction(%d)))\n", action, subAction); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if((subAction != 3) && (subAction != 5) && (subAction != 4) && (subAction != 6))
   {
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3361); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbCntrlSctSap(cntrl(action(%d)))\n", action); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 3428 "../..//sctp/sb_bdy4.c"
   ...
   if ( action == 7 )
   {
      ...
      sbGlobalCb.sctSaps[sap->sctSapCfg.spId] = (SbSctSapCb *) 0L;
      { if (sap == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3437); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sap, sizeof(SbSctSapCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctSapCb)); sap = 0L; } };
   }
...
# 3491 "../..//sctp/sb_bdy4.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3494); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLmAssocSta(assocId, cfmMsg)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if (assocId >= sbGlobalCb.genCfg.maxNmbAssoc)
   {
      ...
      return(13);
         ...
         { S16 _i; cmMemset((U8 *)(&(cfmMsg->t.ssta.s.assocSta.priNAddr)), 0, sizeof(CmNetAddr));; if ((&(assocCb->priOrig->addr)) == (CmNetAddr *)0L) { (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->type = 4; (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->u.ipv4NetAddr = 0; } else { if ((&(assocCb->priOrig->addr))->type == 4) { (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->type = 4; (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->u.ipv4NetAddr = (&(assocCb->priOrig->addr))->u.ipv4NetAddr; } else if ((&(assocCb->priOrig->addr))->type == 6) { (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->u.ipv6NetAddr[_i] = (&(assocCb->priOrig->addr))->u.ipv6NetAddr[_i]; } } else { (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->type = 4; (&(cfmMsg->t.ssta.s.assocSta.priNAddr))->u.ipv4NetAddr = 0; } } };
         ...
         if ( 0x2 == assocCb->assocState )
         {

            destAddrCount = (U8)((l)->count);
         }
         ...
         for ( i = 0; i < destAddrCount; i++ )
         {
            ...
            { S16 _i; cmMemset((U8 *)(&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i])), 0, sizeof(CmNetAddr));; if ((&(addrCb->addr)) == (CmNetAddr *)0L) { (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->type = 4; (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->u.ipv4NetAddr = 0; } else { if ((&(addrCb->addr))->type == 4) { (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->type = 4; (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->u.ipv4NetAddr = (&(addrCb->addr))->u.ipv4NetAddr; } else if ((&(addrCb->addr))->type == 6) { (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->type = 6; for (_i = 0; _i < 16; _i++) { (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->u.ipv6NetAddr[_i] = (&(addrCb->addr))->u.ipv6NetAddr[_i]; } } else { (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->type = 4; (&(cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nAddr[i]))->u.ipv4NetAddr = 0; } } };
            cfmMsg->t.ssta.s.assocSta.dstNAddrLst.nmb++;
            n = ((l)->crnt = ((l)->crnt ? (l)->crnt->next : (l)->first));
         }

         { S16 _j; cmMemset((U8 *)(&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst)), 0, sizeof(SctNetAddrLst)); (&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nmb = (&(assocCb->sbAsCb.localAddrLst))->nmb; for (_j = 0; _j < (&(assocCb->sbAsCb.localAddrLst))->nmb; _j++) { { S16 _i; cmMemset((U8 *)(&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j])), 0, sizeof(CmNetAddr));; if ((&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j])) == (CmNetAddr *)0L) { (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->type = 4; (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->u.ipv4NetAddr = 0; } else { if ((&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->type == 4) { (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->type = 4; (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->u.ipv4NetAddr = (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->u.ipv4NetAddr; } else if ((&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->type == 6) { (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->type = 6; for (_i = 0; _i < 16; _i++) { (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->u.ipv6NetAddr[_i] = (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->u.ipv6NetAddr[_i]; } } else { (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->type = 4; (&((&(cfmMsg->t.ssta.s.assocSta.srcNAddrLst))->nAddr[_j]))->u.ipv4NetAddr = 0; } } } } };
# 3738 "../..//sctp/sb_bdy4.c"
   return(0);
}
# 3757 "../..//sctp/sb_bdy4.c"
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3787); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLmDtaSta(dtaSta, cfmMsg)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { S16 _i; cmMemset((U8 *)(&(cfmMsg->t.ssta.s.dtaSta.dstNAddr)), 0, sizeof(CmNetAddr));; if ((&(dtaSta->dstNAddr)) == (CmNetAddr *)0L) { (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->type = 4; (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->u.ipv4NetAddr = 0; } else { if ((&(dtaSta->dstNAddr))->type == 4) { (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->type = 4; (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->u.ipv4NetAddr = (&(dtaSta->dstNAddr))->u.ipv4NetAddr; } else if ((&(dtaSta->dstNAddr))->type == 6) { (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->u.ipv6NetAddr[_i] = (&(dtaSta->dstNAddr))->u.ipv6NetAddr[_i]; } } else { (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->type = 4; (&(cfmMsg->t.ssta.s.dtaSta.dstNAddr))->u.ipv4NetAddr = 0; } } };




   { if (sbGlobalCb.genCfg.performMtu == 1) { if( sbGlobalCb.mtuCp.addrArray[tempAddrCb->mtuIdx] != 0L) { cfmMsg->t.ssta.s.dtaSta.mtu = sbGlobalCb.mtuCp.addrArray[tempAddrCb->mtuIdx]->mtu; cfmMsg->t.ssta.s.dtaSta.mtu -= 20; if (sbGlobalCb.genCfg.serviceType == 0) { cfmMsg->t.ssta.s.dtaSta.mtu -= 8; } ret = 0; } else { cfmMsg->t.ssta.s.dtaSta.mtu = sbGlobalCb.genCfg.mtuInitial; cfmMsg->t.ssta.s.dtaSta.mtu -= 20; ret = 1; } } else { cfmMsg->t.ssta.s.dtaSta.mtu = sbGlobalCb.genCfg.mtuInitial; cfmMsg->t.ssta.s.dtaSta.mtu -= 20; if (sbGlobalCb.genCfg.serviceType == 0) { cfmMsg->t.ssta.s.dtaSta.mtu -= 8; } ret = 0; } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 3992); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLmShutDown(Void)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   for ( i = 0; i < sbGlobalCb.genCfg.maxNmbSctSaps; i++ )
   {
      ...
      if ( sctSap != (SbSctSapCb *) 0L )
      {
         ...
         sbGlobalCb.sctSaps[sctSap->sctSapCfg.spId] = (SbSctSapCb *) 0L;
         { if (sctSap == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4004); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sctSap, sizeof(SbSctSapCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctSapCb)); sctSap = 0L; } };
      }
   }
   ...
   for ( i = 0; i < sbGlobalCb.genCfg.maxNmbTSaps; i++ )
   {
      ...
      if ( tSap != (SbTSapCb *) 0L )
      {
         ...
         sbGlobalCb.tSaps[tSap->tSapCfg.suId] = (SbTSapCb *) 0L;
         { if (tSap == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4017); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)tSap, sizeof(SbTSapCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbTSapCb)); tSap = 0L; } };
      }
   }
# 4037 "../..//sctp/sb_bdy4.c"
   { CmTmrArg _arg; _arg.tq = &(sbGlobalCb.sbTq[0]); _arg.tqCp = &(sbGlobalCb.sbTqCp); _arg.timers = &(sbGlobalCb.keyTmr); _arg.cb = 0L; _arg.evnt = 0; _arg.wait = 0; _arg.tNum = 0; _arg.max = 1; cmRmvCbTq(&_arg); };
   { CmTmrArg _arg; _arg.tq = &(sbGlobalCb.sbTq[0]); _arg.tqCp = &(sbGlobalCb.sbTqCp); _arg.timers = &(sbGlobalCb.mtuIncTmr); _arg.cb = 0L; _arg.evnt = 0; _arg.wait = 0; _arg.tNum = 0; _arg.max = 1; cmRmvCbTq(&_arg); };
   { CmTmrArg _arg; _arg.tq = &(sbGlobalCb.sbTq[0]); _arg.tqCp = &(sbGlobalCb.sbTqCp); _arg.timers = &(sbGlobalCb.mtuIncTmrUp); _arg.cb = 0L; _arg.evnt = 0; _arg.wait = 0; _arg.tNum = 0; _arg.max = 1; cmRmvCbTq(&_arg); };
   ...
   (Void) cmHashListDeinit(&sbGlobalCb.addrPortHl);
# 4077 "../..//sctp/sb_bdy4.c"
   { if (sbGlobalCb.assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4077); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.assocCb, (sbGlobalCb.genCfg.maxNmbAssoc * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbAssoc * sizeof(U32))); sbGlobalCb.assocCb = 0L; } };


   { if (sbGlobalCb.tSaps == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4080); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.tSaps, (sbGlobalCb.genCfg.maxNmbTSaps * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbTSaps * sizeof(U32))); sbGlobalCb.tSaps = 0L; } };


   { if (sbGlobalCb.sctSaps == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4083); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.sctSaps, (sbGlobalCb.genCfg.maxNmbSctSaps*sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbSctSaps*sizeof(U32))); sbGlobalCb.sctSaps = 0L; } };


   { if (sbGlobalCb.endpCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4086); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.endpCb, (sbGlobalCb.genCfg.maxNmbEndp*sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbEndp*sizeof(U32))); sbGlobalCb.endpCb = 0L; } };
# 4096 "../..//sctp/sb_bdy4.c"
   { if (sbGlobalCb.localAddrCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4096); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.localAddrCb, (sbGlobalCb.genCfg.maxNmbSrcAddr*sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbSrcAddr*sizeof(U32))); sbGlobalCb.localAddrCb = 0L; } };
         ...
         { if (sbGlobalCb.addrPortCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4104); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.addrPortCb, (sbGlobalCb.genCfg.maxNmbEndp * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((sbGlobalCb.genCfg.maxNmbEndp * sizeof(U32))); sbGlobalCb.addrPortCb = 0L; } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4181); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbUiUnbindSap(spId(%u))\n", spId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   for ( i = 0; i < sbGlobalCb.genCfg.maxNmbAssoc; i++ )
   {
      ...
      if ( assocCb != (SbSctAssocCb *) 0L )
      {
         ...
         {
            sbAsAbortAssoc(assocCb, 1);

            sbGlobalCb.assocCb[i] = (SbSctAssocCb *) 0L;
            { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4201); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
         }
      }
   }
   ...
   for ( i = 0; i < sbGlobalCb.genCfg.maxNmbEndp; i++ )
   {
    ...
    for ( k = 0; k < endpCb->localAddrLst.nmb; k++ )
         ...
         { S16 _i; cmMemset((U8 *)(&(tmpAddrPortEntry.localAddr)), 0, sizeof(CmNetAddr));; if ((&(endpCb->localAddrLst.nAddr[k])) == (CmNetAddr *)0L) { (&(tmpAddrPortEntry.localAddr))->type = 4; (&(tmpAddrPortEntry.localAddr))->u.ipv4NetAddr = 0; } else { if ((&(endpCb->localAddrLst.nAddr[k]))->type == 4) { (&(tmpAddrPortEntry.localAddr))->type = 4; (&(tmpAddrPortEntry.localAddr))->u.ipv4NetAddr = (&(endpCb->localAddrLst.nAddr[k]))->u.ipv4NetAddr; } else if ((&(endpCb->localAddrLst.nAddr[k]))->type == 6) { (&(tmpAddrPortEntry.localAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(tmpAddrPortEntry.localAddr))->u.ipv6NetAddr[_i] = (&(endpCb->localAddrLst.nAddr[k]))->u.ipv6NetAddr[_i]; } } else { (&(tmpAddrPortEntry.localAddr))->type = 4; (&(tmpAddrPortEntry.localAddr))->u.ipv4NetAddr = 0; } } };
...
# 4296 "../..//sctp/sb_bdy4.c"
         { if (tmpAddrPortCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4296); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)tmpAddrPortCb, sizeof(SbAddrPortCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbAddrPortCb)); tmpAddrPortCb = 0L; } };
         }
            ret = cmHashListDelete(&(sbGlobalCb.endpHl), (U32) endpCb);
# 4310 "../..//sctp/sb_bdy4.c"
            sbGlobalCb.endpCb[i] = (SbSctEndpCb *) 0L;
            { if (endpCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4311); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)endpCb, sizeof(SbSctEndpCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctEndpCb)); endpCb = 0L; } };
         }
      }
   }
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4368); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiOpenServer(tSap, localAddrCb)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&icmpFilter_IP, sizeof(CmIcmpFilter)); if ( ret == 0 ) { cmMemset((U8*)icmpFilter_IP, 0, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc += (sizeof(CmIcmpFilter)); } };
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4379); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiOpenServer: Couldn't allocate memory for icmpFilter_IP.\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      return(1);
   }

   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&icmpFilter_UDP, sizeof(CmIcmpFilter)); if ( ret == 0 ) { cmMemset((U8*)icmpFilter_UDP, 0, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc += (sizeof(CmIcmpFilter)); } };
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4388); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiOpenServer: Couldn't allocate memory for icmpFilter_UDP.\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      { if (icmpFilter_IP == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4390); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)icmpFilter_IP, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmIcmpFilter)); icmpFilter_IP = 0L; } };

      return(1);
   }

   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&tPar, sizeof(CmTptParam)); if ( ret == 0 ) { cmMemset((U8*)tPar, 0, sizeof(CmTptParam)); sbGlobalCb.genSta.memAlloc += (sizeof(CmTptParam)); } };
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4399); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiOpenServer: Couldn't allocate memory for tPar.\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      { if (icmpFilter_IP == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4401); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)icmpFilter_IP, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmIcmpFilter)); icmpFilter_IP = 0L; } };
      { if (icmpFilter_UDP == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4402); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)icmpFilter_UDP, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmIcmpFilter)); icmpFilter_UDP = 0L; } };

      return(1);
   }

   { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&tAddr, sizeof(CmTptAddr)); if ( ret == 0 ) { cmMemset((U8*)tAddr, 0, sizeof(CmTptAddr)); sbGlobalCb.genSta.memAlloc += (sizeof(CmTptAddr)); } };
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4411); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiOpenServer: Couldn't allocate memory for tAddr.\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      { if (icmpFilter_IP == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4413); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)icmpFilter_IP, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmIcmpFilter)); icmpFilter_IP = 0L; } };
      { if (icmpFilter_UDP == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4414); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)icmpFilter_UDP, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmIcmpFilter)); icmpFilter_UDP = 0L; } };
      { if (tPar == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4415); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)tPar, sizeof(CmTptParam)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmTptParam)); tPar = 0L; } };
   ...
   if (localAddrCb->ownAddr.type == 4)
   {
      ...
      (Void) cmMemcpy((U8 *) &(tAddr->u.ipv4TptAddr.address),
            ...
            (U32) sizeof(CmIpv4NetAddr));


      if (sbGlobalCb.genCfg.performMtu == 1)
      {

         icmpFilter_IP->type = 4;
         icmpFilter_IP->u.icmpv4Filter.icmpMsgFlag = 1;
         icmpFilter_IP->u.icmpv4Filter.allMsg = 1;
         icmpFilter_IP->u.icmpv4Filter.num = 0;
# 4451 "../..//sctp/sb_bdy4.c"
         icmpFilter_IP->u.icmpv4Filter.protocol = 132;
      }
      else
      {
         icmpFilter_IP->type = 4;
         icmpFilter_IP->u.icmpv4Filter.icmpMsgFlag = 0;
         icmpFilter_IP->u.icmpv4Filter.allMsg = 0;
         icmpFilter_IP->u.icmpv4Filter.num = 0;
         icmpFilter_IP->u.icmpv4Filter.protocol = 132;
      }
      icmpFilter_UDP->type = 0;
   }
# 4507 "../..//sctp/sb_bdy4.c"
   if (( sbGlobalCb.genCfg.serviceType == 7 ) ||
       ( sbGlobalCb.genCfg.serviceType == 9) )
   {
     tPar->type = 1;
     if(localAddrCb->ownAddr.type == 4)
     {
        tPar->u.sockParam.numOpts = 1;
        tPar->u.sockParam.sockOpts[sockOptIdx].option = 10;
        tPar->u.sockParam.sockOpts[sockOptIdx].level = IPPROTO_IP;
        tPar->u.sockParam.sockOpts[sockOptIdx].optVal.value = 1;
        sockOptIdx++;
        numSockOpts++;
     }
# 4551 "../..//sctp/sb_bdy4.c"
...
# 4634 "../..//sctp/sb_bdy4.c"
   if ( sbGlobalCb.genCfg.serviceType == 0 )
   {
      if (tAddr->type == 4)
      {
         ...
         tAddr->u.ipv4TptAddr.port = 9899;

         if (((tSap->ipv4_any == 1) &&
            (tAddr->u.ipv4TptAddr.address == ((in_addr_t) 0x00000000))) ||
            (tSap->ipv4_any == 0))
         {
      ...
      else
      {
         ...
         tAddr->u.ipv6TptAddr.port = 9899;

         { U16 _i; *(&isAny) = 1; for (_i = 0; _i < 16; _i++) { if ((tAddr->u.ipv6TptAddr.ipv6NetAddr)[_i] != 0) { *(&isAny) = 0; break; } } }
   ...
   { if (icmpFilter_IP == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4736); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)icmpFilter_IP, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmIcmpFilter)); icmpFilter_IP = 0L; } };
   { if (icmpFilter_UDP == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4737); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)icmpFilter_UDP, sizeof(CmIcmpFilter)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmIcmpFilter)); icmpFilter_UDP = 0L; } };
   { if (tPar == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4738); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)tPar, sizeof(CmTptParam)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmTptParam)); tPar = 0L; } };
   { if (tAddr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4739); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)tAddr, sizeof(CmTptAddr)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmTptAddr)); tAddr = 0L; } };
   return(0);
}
# 4761 "../..//sctp/sb_bdy4.c"
 S16 sbLiBndTO
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4782); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiBndTO(tSap)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4804 "../..//sctp/sb_bdy4.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4809); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiBndTO: Bind timeout (%u)\n", tSap->nmbBndRetry); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( tSap->nmbBndRetry > tSap->tSapCfg.reConfig.maxBndRetry )
   {
      ...
      sbGlobalCb.sbMgmt.cfm.reason = (256 + 3);
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4834); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiBndTO: max Bind timeouts reached (%u)\n", tSap->nmbBndRetry); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   else
   {
      if ( tSap->sapState == 0)
      {
         ...
         {
            sbGlobalCb.sbMgmt.cfm.status = 1;
            sbGlobalCb.sbMgmt.cfm.reason = 18;
            SbMiLsbCntrlCfm(&(sbGlobalCb.sbInit.lmPst), &(sbGlobalCb.sbMgmt));
...
# 4882 "../..//sctp/sb_bdy4.c"
               ...
               {
                  if ((localAddrCb->connected == 0) ||
                     ((sbGlobalCb.genCfg.serviceType == 0) &&
                     (localAddrCb->otherConnected == 0)))
                  {
                     if (localAddrCb->ownAddr.type == 4)
                     {
                           ...
                           (tSap->ipv4_any == 0))
                        {
                           ...
                           {
                              { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4898); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiBndTO: could not open server\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
                     ...
                     else if (localAddrCb->ownAddr.type == 6)
                     {
                           ...
                           (tSap->ipv6_any == 0))
                        {
                           if ((ret = sbLiOpenServer(tSap, localAddrCb)) != 0)
                           {
                              { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4915); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiBndTO: could not open server\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         if ( cnt == 0 )
         {
            ...
            sbGlobalCb.sbMgmt.cfm.status = 0;
            sbGlobalCb.sbMgmt.cfm.reason = 0;
            SbMiLsbCntrlCfm(&(sbGlobalCb.sbInit.lmPst), &(sbGlobalCb.sbMgmt));
   ...
   { U16 _wait; CmTmrArg _arg; _wait = tSap->tSapCfg.reConfig.tIntTmr; if (_wait != 0) { _arg.tq = &(sbGlobalCb.sbTq[0]); _arg.tqCp = &(sbGlobalCb.sbTqCp); _arg.timers = &(tSap->timer); _arg.cb = (U32)tSap; _arg.evnt = 0x8; _arg.wait = _wait; _arg.tNum = 0; _arg.max = 1; cmPlcCbTq(&_arg); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 4984); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiBindSap(suId(%d), cntrl)\n", suId ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5053); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiUnbindSap(suId(%u))\n", suId ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( tSap->sapState != 1 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5060); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiUnbindSap: Sap not bound %d\n", (U16)tSap->sapState ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

   {
      ...
      if ( localConn != (SbLocalAddrCb *)0L )
      {
         if ( localConn->suId == suId )
         {
            ...
            if (sbGlobalCb.genCfg.serviceType == 0)
            {
               if ( localConn->otherConnected == 1 )
               {
                  err = SbLiHitDiscReq( &(tSap->tPst),
                                        tSap->tSapCfg.reConfig.spId,
                                        2,
                                        localConn->spOtherConId, 4,
                                        &tPar );
               }
               else
               {
   ...
   if(sbGlobalCb.dnsInfo.dnsState == 1)
   {
      err = SbLiHitDiscReq(&(tSap->tPst), tSap->tSapCfg.reConfig.spId,
        2, sbGlobalCb.dnsInfo.spConId, 4, &tPar );
   }

   if (tSap->tSapCfg.reConfig.sbDnsCfg.useDnsLib == 1)
   {
     cmDnsDeInitDnsCb(sbGlobalCb.dnsInfo.dnsCb);
     { if (sbGlobalCb.dnsInfo.dnsCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5128); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)sbGlobalCb.dnsInfo.dnsCb, sizeof(CmDnsCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(CmDnsCb)); sbGlobalCb.dnsInfo.dnsCb = 0L; } }
   }
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5175); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiDelSap(suId(%d), cntrl)\n", suId ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   *(sbGlobalCb.tSaps + suId) = (SbTSapCb *)0L;
   { if (tSap == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5203); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)tSap, sizeof(SbTSapCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbTSapCb)); tSap = 0L; } };
...
# 5264 "../..//sctp/sb_bdy4.c"
{
   ...
   ;;
   if((localAddrCb->ownAddr.type == 4) && (addr->type == 4))
   {
# 5297 "../..//sctp/sb_bdy4.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 7))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5302); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiSend: localAddrCb(ownAddr.u.ipv4(%ld), suId(%d), suConId(%ld),           spConId(%ld), connected(%d))\ndstAddr.u.ipv4(%ld), df(%d)\n", localAddrCb->ownAddr.u.ipv4NetAddr, localAddrCb->suId, localAddrCb->suConId, localAddrCb->spConId, localAddrCb->connected, addr->u.ipv4NetAddr, df); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 5329 "../..//sctp/sb_bdy4.c"
   ...
   if (df == 1)
   {
      ...
      if (err != 0)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 4))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5351); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiSend: Find length message failed\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      if (sbGlobalCb.genCfg.performMtu == 1)
      {
         ...
         if(addrCb != 0L)
         {
            { if (sbGlobalCb.genCfg.performMtu == 1) { if( sbGlobalCb.mtuCp.addrArray[addrCb->mtuIdx] != 0L) { mtu = sbGlobalCb.mtuCp.addrArray[addrCb->mtuIdx]->mtu; mtu -= 20; if (sbGlobalCb.genCfg.serviceType == 0) { mtu -= 8; } err = 0; } else { mtu = sbGlobalCb.genCfg.mtuInitial; mtu -= 20; err = 1; } } else { mtu = sbGlobalCb.genCfg.mtuInitial; mtu -= 20; if (sbGlobalCb.genCfg.serviceType == 0) { mtu -= 8; } err = 0; } };
            if(err == 0)
            {
               if (mtu < len )
               {
   ...
   if (addr->type == 4)
   {
      ...
      hdrParm.u.hdrParmIpv4.proto.pres = 0;
      ...
      hdrParm.u.hdrParmIpv4.tos.pres = 0;
   ...
   else if (localAddrCb->ownAddr.type == 6)
   {
      ...
      cmMemcpy( (U8 *)&(src.u.ipv6TptAddr.ipv6NetAddr),
                (U8 *)&(localAddrCb->ownAddr.u.ipv6NetAddr), 16);
   }
   ...
   if (sbGlobalCb.sbInit.trc == 1)
   {
      ...
      sbTrcBuf(localAddrCb->suId, 2, mBuf, &src, &dst);
   }
   ...
   if (err != 0)
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 4))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5506); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiSend: Find length message failed\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

      { if ( mBuf != (Buffer *) 0L ) { (Void) SPutMsg(mBuf); mBuf = (Buffer *)0L; } };
      return(1);
   }
   if((dst.type == 4) && (src.type == 4))
   {
# 5525 "../..//sctp/sb_bdy4.c"
      { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 7))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5528); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbLiSend: calling SbLiHitUDatReq (spConId(%ld), dst.u.ipv4(%ld),           src.u.ipv4(%ld), mBuf.Length(%d)\n", localAddrCb->spConId, dst.u.ipv4TptAddr.address, src.u.ipv4TptAddr.address, len); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 0))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5619); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbOpenDnsServer(tSap)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   cmMemset((U8 *)&tAddr, 0, sizeof(CmTptAddr));;
   cmMemset((U8 *)&icmpFilter_UDP, 0, sizeof(CmIcmpFilter));;
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 7))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5648); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbOpenDnsServer: calling SbLiHitServOpenReq (suConId(%ld)\n", sbGlobalCb.dnsInfo.suConId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...

{
   ...
   ;
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 0))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5676); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbRslvOwnHstName(void)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   ipAddrTbl.count = 0;
    ...
    if(ret != 0)
    {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 4))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy4.c", 5688); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbRslvOwnHstName: Failure in cmInetGetHostByName \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
