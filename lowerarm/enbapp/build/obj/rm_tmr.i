...
# 95 "../..//enbapp/lterrm/rm_tmr.c" 2


static Void rmProcTmr (Ptr cb, S16 event);
# 112 "../..//enbapp/lterrm/rm_tmr.c"
 S16 rmRegInitTmr
(
Void
)
{
   ...
   ret = SRegCfgTmrMt((Ent)0xe3,(Inst)1,1,10,rmActvTmr);
   if (ret != 0)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 123); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf,"rmRegInitTmr: SRegTmr Failed \n"); SPrint((&(rmCb.init))->prntBuf); } }; };
      return(1);
   }
...
{
   cmPrcTmr(&rmCb.tqCp, rmCb.tq, (PFV) rmProcTmr);

   return(0);
}
# 183 "../..//enbapp/lterrm/rm_tmr.c"
static Void rmProcTmr
(
Ptr cb,
S16 event
)
{
   ...
   {
      case 1:
         rmCacAcbHystTmrHandler();
         break;

      case 2:
         rmCacAcbConReqHystTmrHandler(
                     &(((RmCellCb *)cb)->cacCellCb.cellAcbInfo),
                     ((RmCellCb *)cb)->cellId);
         break;
      default:
      {

         { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 203); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf,"rmProcTmr: Invalid timer [%d]\n", event); SPrint((&(rmCb.init))->prntBuf); } }; };
         break;
      }
   }
   return;
}
# 228 "../..//enbapp/lterrm/rm_tmr.c"
 S16 rmStartTmr
(
U32 cb,
S16 tmrEvnt,
...
)
{
   ...
   switch (tmrEvnt)
   {
      case 1:
         ...
         if (enbAcbInfoPtr == 0L)
         {
            { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 255); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "Could not control block while starting timer\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
            return(1);
         }

         tmrPtr = &(enbAcbInfoPtr->acbHystTmr);

         cb = (U32) &(rmCb.enbCb);
         break;

      case 2:
         cellCbPtr = rmUtlGetCellCb(cellId);
         if (cellCbPtr == 0L)
         {
            { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 268); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "Could not control block while starting timer\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
            return(1);
         }

         tmrPtr = &(cellCbPtr->cacCellCb.cellAcbInfo.acbRrcConCntHystTmr);
      ...
      default:
         {
            { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 279); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "Invalid timer event while starting timer\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
            return(1);
         }
   }

   if (tmrPtr->tmrRunning == 1)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 286); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "Timer is already running\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
      return(1);
   }
   ...
   if(wait != 0)
   {
      ...
      arg.tq = rmCb.tq;
      arg.cb = cb;
      arg.timers = &(tmrPtr->tmr);
      arg.evnt = tmrEvnt;
      arg.wait = wait;
      arg.tNum = 0;
      arg.max = tmrPtr->maxTmrs;
      tmrPtr->tmrRunning = 1;
      cmPlcCbTq(&arg);
   }
...
)
{
   ...
   {
      case 1:
         tmrPtr = &(rmCb.enbCb.cacEnbCb.enbAcbInfo.acbHystTmr);
      ...
      case 2:
         ...
         if (cellCbPtr == 0L)
         {
            { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 350); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "Could not control block while starting timer\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
            return;
         }
      ...
      default:
         {
            { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 359); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "Invalid timer event while starting timer\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
            return;
         }
   }

   if (tmrPtr->tmrRunning == 0)
   {
      { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_tmr.c", 366); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "Cannot stop timer if not running\n"); SPrint((&(rmCb.init))->prntBuf); } }; };
      return;
   }
