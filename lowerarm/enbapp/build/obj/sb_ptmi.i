...
# 148 "../..//sctp/sb_ptmi.c" 2
# 1 "../..//cm/cm5.x" 1
# 149 "../..//sctp/sb_ptmi.c" 2
...
#define MAXSBMI 2
# 224 "../..//sctp/sb_ptmi.c"
static LsbCfgCfm SbMiLsbCfgCfmMt[2] =
{
...
static LsbCntrlCfm SbMiLsbCntrlCfmMt[2] =
{
...
static LsbStsCfm SbMiLsbStsCfmMt[2] =
{
...
static LsbStaInd SbMiLsbStaIndMt[2] =
{
...
static LsbStaCfm SbMiLsbStaCfmMt[2] =
{
...
static LsbTrcInd SbMiLsbTrcIndMt[2] =
{
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptmi.c", 370); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCfgCfm(pst, cfg(%p))\n", (Void *)cfg); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   return((*SbMiLsbCfgCfmMt[pst->selector]) (pst, cfg));
}
# 393 "../..//sctp/sb_ptmi.c"
 S16 SbMiLsbCntrlCfm
(
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptmi.c", 408); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCntrlCfm(pst, cntrl(%p))\n", (Void *)cntrl); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   return((*SbMiLsbCntrlCfmMt[pst->selector]) (pst, cntrl));
}
# 431 "../..//sctp/sb_ptmi.c"
 S16 SbMiLsbStaInd
(
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptmi.c", 446); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStaInd(pst, usta(%p))\n", (Void *)usta); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   return((*SbMiLsbStaIndMt[pst->selector]) (pst, usta));
}
# 469 "../..//sctp/sb_ptmi.c"
 S16 SbMiLsbStaCfm
(
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptmi.c", 484); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStaCfm(pst, sta (0x%p))\n", (Void *)sta); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   return((*SbMiLsbStaCfmMt[pst->selector]) (pst, sta));
}
# 506 "../..//sctp/sb_ptmi.c"
 S16 SbMiLsbStsCfm
(
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptmi.c", 521); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStsCfm(pst, sts (0x%p))\n", (Void *)sts); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   return((*SbMiLsbStsCfmMt[pst->selector]) (pst, sts));
}
# 544 "../..//sctp/sb_ptmi.c"
 S16 SbMiLsbTrcInd
(
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_ptmi.c", 559); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbTrcInd(pst, trc (0x%p))\n", (Void *)trc); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



   return((*SbMiLsbTrcIndMt[pst->selector]) (pst, trc));
}
