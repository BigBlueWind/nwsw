...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 99 "../..//lteclpal/ys_tmr.c" 2
# 1 "../..//cm/cm5.h" 1
# 100 "../..//lteclpal/ys_tmr.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 116 "../..//lteclpal/ys_tmr.c" 2
# 1 "../..//cm/cm5.x" 1
# 117 "../..//lteclpal/ys_tmr.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 127 "../..//lteclpal/ys_tmr.c" 2


static Void * ysPalTtiTmrTsk (Void *);
# 168 "../..//lteclpal/ys_tmr.c"
 Void ysPrcTmrExpiry
(
Ptr cb,
S16 tmrEvnt
...

{
   ...
   switch (tmrEvnt)
   {
      ...
      default:
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_tmr.c", 205); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_tmr.c", 205); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysPrcTmrExpiry(): invalid tmrEvnt = %d", tmrEvnt); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   }
   return;
}
...

{
   ...
   if ((pthread_create(&tId, &attr, ysPalTtiTmrTsk, (Ptr)((void *)0))) != 0)
   {
      pthread_attr_destroy(&attr);

      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_tmr.c", 240); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_tmr.c", 240); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to create TTI generator thread\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };

      return(1);
   }
# 260 "../..//lteclpal/ys_tmr.c"
   return(0);
}
...

{
   ...
   clock_gettime(0, &wakeup);
   clock_gettime(0, &startTm);
   while(1)
   {
...
# 373 "../..//lteclpal/ys_tmr.c"
      ...
      while(ttiEvnt)
      {
         ...
         if (ret != 0)
         {
            { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_tmr.c", 379); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_tmr.c", 379); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
            continue;
         }
         SPstTsk(&pst, tempBuf);
         ttiEvnt--;
