...
# 41 "/usr/include/bits/environments.h" 3 4
...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 115 "../..//lteclpal/ys_pal_li.c" 2
# 1 "../..//cm/cm5.h" 1
# 116 "../..//lteclpal/ys_pal_li.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 130 "../..//lteclpal/ys_pal_li.c" 2
# 1 "../..//cm/cm5.x" 1
# 131 "../..//lteclpal/ys_pal_li.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 141 "../..//lteclpal/ys_pal_li.c" 2
# 149 "../..//lteclpal/ys_pal_li.c"
...

{
   ...
   if ((pthread_create(&tId, &attr, ysPalRcvrActvTsk, (Ptr)((void *)0))) != 0)
   {
      pthread_attr_destroy(&attr);

      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 181); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 181); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to create receiver thread\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };

      return(1);
   }
# 206 "../..//lteclpal/ys_pal_li.c"
   return(0);
}
...

{
   ...
   if((int)(ysCb.sockfd = socket(2, SOCK_DGRAM, 0)) == -1)
   {
   ...
   while(1)
   {
      ...
      {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 284); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 284); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Server-recvfrom() error\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         continue;
      }
      ...
      if (ret != 0)
      {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 292); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 292); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         continue;
      }
      ...
      if (ret != 0)
      {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 299); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 299); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SAddPstMsgMult failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         continue;
      }
      ...
      if (ret != 0)
      {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 306); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 306); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SRemPreMsg failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         continue;
      }
...

{
   ...
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 353); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 353); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SCpyMsgFix failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      return(1);
   }
   ...
   if(ret1 == -1)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 361); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_li.c", 361); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "sendto failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      return(1);
   }
