...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",234); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 263 "../..//egtpu/eg_ui.c"
        ...
        ( (uSapCb = egCb.egtSapLst[spId]) == 0L))
   {
      ...
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ui.c", 273, 0x4, ((0 + 0) + 333), 0, (Txt *)"EgUiEgtBndReq: invalid spId");;
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",283); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if (uSapCb->state == 2)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",301); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
# 344 "../..//egtpu/eg_ui.c"
   uSapCb->suId = suId;
   ...
   EgUiEgtBndCfm(&uSapCb->pst, suId, 1);
# 375 "../..//egtpu/eg_ui.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",375); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 399 "../..//egtpu/eg_ui.c"
 S16 EgUiEgtUbndReq
(
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",421); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 449 "../..//egtpu/eg_ui.c"
   (pst=pst);
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000002)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ui.c", 455); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtUbndReq: Unbind request from suId(%d), reason(%d)", spId, reason); SPrint((&(egCb.init))->prntBuf); } };
   ...
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
    ...
    ( (uSapCb = egCb.egtSapLst[spId]) == 0L))
   {
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ui.c", 466, 0x4, ((0 + 0) + 335), 0, (Txt *)"EgUiEgtUbndReq: invalid spId");;
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",476); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if (uSapCb->state == 3 || uSapCb->state == 1)
   {
      ...
      uSapCb->state = 3;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",490); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
   ...
   if(uSapCb->cfg.flag == 1)
   {
      ...
      {
         SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ui.c", 501, 0x4, ((0 + 0) + 336), 0, (Txt *)"EgUiEgtUbndReq: Failed to process the IpCb");;
         sta.dgn.dgnVal[0].type = 1;
         sta.dgn.dgnVal[0].t.sapId = spId;
...
# 553 "../..//egtpu/eg_ui.c"
      if((retValue = egMiIpCbDeInit(&uSapCb->ipCbHashList, 0)) != 0)
      {

         SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ui.c", 556, 0x4, ((0 + 0) + 338), 0, (Txt *)"EgUiEgtUbndReq: Failed to process the IpCb");;
         sta.dgn.dgnVal[0].type = 1;
         sta.dgn.dgnVal[0].t.sapId = spId;
...
# 616 "../..//egtpu/eg_ui.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",616); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 1552 "../..//egtpu/eg_ui.c"
...

{
   ...
   Pst tempPst;
# 1590 "../..//egtpu/eg_ui.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1590); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 1628 "../..//egtpu/eg_ui.c"
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
        (!egCb.egtSapLst) ||
        ( (uSapCb = egCb.egtSapLst[spId]) == 0L) ||
        (uSapCb->state != 2))
   {
      ...
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ui.c", 1637, 0x4, ((0 + 0) + 360), 0, (Txt *)"EgUiEgtEguDatReq: Invalid spId");;
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1656); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
# 1706 "../..//egtpu/eg_ui.c"
   cmMemcpy((U8*)&tempPst, (U8*)pst, sizeof(Pst));
   egUCpmProcEguDatReq(egtUEvnt, uSapCb, &tempPst);
# 1716 "../..//egtpu/eg_ui.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1716); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 1739 "../..//egtpu/eg_ui.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1754); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 1783 "../..//egtpu/eg_ui.c"
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
        (!egCb.egtSapLst) ||
        ((uSapCb = egCb.egtSapLst[spId]) == 0L) ||
        (uSapCb->state != 2))
   {
      ...
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ui.c", 1792, 0x4, ((0 + 0) + 363), 0, (Txt *)"EgUiEgtEguTnlMgmtReq: Invalid spId");;

      sta.dgn.dgnVal[0].type = 1;
      sta.dgn.dgnVal[0].t.sapId = spId;

      { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1797); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};



      egSendLmAlarm(2, 1, 3, &sta.dgn);

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1803); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
# 1838 "../..//egtpu/eg_ui.c"
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1844); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 1865 "../..//egtpu/eg_ui.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1880); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 1909 "../..//egtpu/eg_ui.c"
   if ( (spId > egCb.genCfg.nmbUSaps || spId < 0) ||
        (!egCb.egtSapLst) ||
        ((uSapCb = egCb.egtSapLst[spId]) == 0L) ||
        (uSapCb->state != 2))
   {
      ...
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ui.c", 1918, 0x4, ((0 + 0) + 366), 0, (Txt *)"EgUiEgtEguStaReq: Invalid spId");;

      sta.dgn.dgnVal[0].type = 1;
      sta.dgn.dgnVal[0].t.sapId = spId;

      { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1923); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1930); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ui.c",1942); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
