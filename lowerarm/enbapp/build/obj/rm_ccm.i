...
# 94 "../..//enbapp/lterrm/rm_ccm.c" 2
# 114 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmEnodebCfgReq(RrmWrEnbCfgReqInfo *rrmWrEnbCfgReq)
{
   S16 ret = 0;

   ret = rmCcmProcEnodebCfg(rrmWrEnbCfgReq);
   if(0 != ret)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 121); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "EnodeB Configuration Request Failed"); SPrint((&(rmCb.init))->prntBuf); } }; };
   }


   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrEnbCfgReq), (Size) (sizeof(RrmWrEnbCfgReqInfo))); (rrmWrEnbCfgReq) = 0L; };

   return(ret);
}
# 150 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmEnodebStaInd(RrmWrEnbStaIndInfo *rrmWrEnbStaInd)
{
   S16 ret = 0;

   ret = rmCcmEnodebStaInd(rrmWrEnbStaInd);
   if(0 != ret)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 157); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "EnodeB status indication Failed"); SPrint((&(rmCb.init))->prntBuf); } }; };
   }


   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrEnbStaInd), (Size) (sizeof(RrmWrEnbStaIndInfo))); (rrmWrEnbStaInd) = 0L; };
   return(ret);
}
# 186 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmCellCfgReq(RrmWrCellCfgReqInfo *rrmWrCellCfgReq)
{
   S16 ret = 0;

   ret = rmCcmProcCellCfg(rrmWrCellCfgReq);
   if(0 != ret)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 194); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "cell configuration Request Failed:[%u]", rrmWrCellCfgReq->cellId); SPrint((&(rmCb.init))->prntBuf); } }; };

   }

   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrCellCfgReq), (Size) (sizeof(RrmWrCellCfgReqInfo))); (rrmWrCellCfgReq) = 0L; };
   return(ret);
}
# 213 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmCellStaInd(RrmWrCellStaIndInfo *rrmWrCellStaInd)
{
   { { if ((&(rmCb.init))->dbgMask & (3)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 215); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "FSM triggers the Cell Statsu Indication\n"); SPrint((&(rmCb.init))->prntBuf); } }; };


   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrCellStaInd), (Size) (sizeof(RrmWrCellStaIndInfo))); (rrmWrCellStaInd) = 0L; };
   return(0);
}
# 241 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmUeStaInd(RrmWrUeStaIndInfo *rrmWrUeStaInd)
{
   S16 ret = 0;

   ret = rmCcmProcUeStaInd(rrmWrUeStaInd);
   if(0 != ret)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 248); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "UE Status Indication Failed "); SPrint((&(rmCb.init))->prntBuf); } }; };
   }

   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrUeStaInd), (Size) (sizeof(RrmWrUeStaIndInfo))); (rrmWrUeStaInd) = 0L; };
   return(ret);
}
# 276 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmUeRecfgReq(RrmWrUeRecfgReqInfo *rrmWrUeRecfgReq)
{
   S16 ret = 0;

   ret = rmCcmProcUeRecfg(rrmWrUeRecfgReq);
   if(0 != ret)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 285); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "UE Re-configuration Failed UE-CRNTI:[%u]," "TransID:[%lu]", rrmWrUeRecfgReq->crnti, rrmWrUeRecfgReq->transId); SPrint((&(rmCb.init))->prntBuf); } }; };


   }

   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrUeRecfgReq), (Size) (sizeof(RrmWrUeRecfgReqInfo))); (rrmWrUeRecfgReq) = 0L; };
   return(ret);
}
# 311 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmUeRelReq(RrmWrUeRelReqInfo *rrmWrUeRelReq)
{
   S16 ret = 0;

   ret = rmCcmProcUeRel(rrmWrUeRelReq);
   if(0 != ret)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 320); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "UE Release Request is Failed UE-CRNTI:[%u]," "TransID:[%lu]", rrmWrUeRelReq->crnti, rrmWrUeRelReq->transId); SPrint((&(rmCb.init))->prntBuf); } }; };


   }

   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrUeRelReq), (Size) (sizeof(RrmWrUeRelReqInfo))); (rrmWrUeRelReq) = 0L; };
   return(ret);
}
# 347 "../..//enbapp/lterrm/rm_ccm.c"
 S16 WrRmUeAdmitReq(RrmWrUeAdmitReqInfo *rrmWrUeAdmitReq)
{
   S16 ret = 0;

   ret = rmCcmProcUeAdmitReq(rrmWrUeAdmitReq);
   if(0 != ret)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm.c", 356); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "UE Admit Request is Failed UE-CRNTI:[%u]," "TransID:[%lu]", rrmWrUeAdmitReq->crnti, rrmWrUeAdmitReq->transId); SPrint((&(rmCb.init))->prntBuf); } }; };


   }

   { (Void) SPutSBuf(rmCb.init.region, rmCb.init.pool, (Data *) (rrmWrUeAdmitReq), (Size) (sizeof(RrmWrUeAdmitReqInfo))); (rrmWrUeAdmitReq) = 0L; };
   return(ret);
}
