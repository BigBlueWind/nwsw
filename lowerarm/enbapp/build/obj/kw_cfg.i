...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 110 "../..//lterlcpdcp/kw_cfg.c" 2
# 1 "../..//cm/cm5.h" 1
# 111 "../..//lterlcpdcp/kw_cfg.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 132 "../..//lterlcpdcp/kw_cfg.c" 2

# 1 "../..//cm/cm5.x" 1
# 134 "../..//lterlcpdcp/kw_cfg.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 151 "../..//lterlcpdcp/kw_cfg.c" 2
# 163 "../..//lterlcpdcp/kw_cfg.c"
static S16 kwCfgFillRbCb
(
KwRbCb *rbCb,
KwUeCb *ueCb,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 184); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgFillRbCb(ueId(%d), cellId(%d), rbId(%d), rbType(%d))\n", rbCb->rlcId.ueId, rbCb->rlcId.cellId, entCfg->rbId, entCfg->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 215 "../..//lterlcpdcp/kw_cfg.c"
            ...
            switch (rbCb->dir)
            {
               case 2:
                  {
                     if (entCfg->m.umInfo.dl.snLen == 5)
                     {
                        rbCb->m.um.umDl.snLen = 1;
                     }
                     else
                     {
                        rbCb->m.um.umDl.snLen = 2;
                     }
               ...
               case 1:
                  {
                     if (entCfg->m.umInfo.ul.snLen == 5)
                     {
                        rbCb->m.um.umUl.snLen = 1;
                     }
                     else
                     {
                        rbCb->m.um.umUl.snLen = 2;
                     }

                     rbCb->m.um.umUl.umWinSz = 2 << (((rbCb->m.um.umUl.snLen * 5) -1 )-1);;
                     ...
                     { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&rbCb->m.um.umUl.recBuf, (Size) winLen * sizeof(KwUmRecBuf*)) == 0) { cmMemset((U8 *)(rbCb->m.um.umUl.recBuf), 0, winLen * sizeof(KwUmRecBuf*)); } else { (rbCb->m.um.umUl.recBuf) = 0L; } };
# 273 "../..//lterlcpdcp/kw_cfg.c"
...
# 323 "../..//lterlcpdcp/kw_cfg.c"
               ...
               default:
                  {
                     ret = 1;
                     do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 331); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgFillRbCb Failed -- in UM configuraiton,                              for the invalid dir(%d)\n", rbCb->dir); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 3:
         {
            ...
            rbCb->m.am.amUl.vrMr = rbCb->m.am.amUl.vrR + 512;

            ueCb->lCh[rbCb->lch[0].lChId - 1].dlRbCb = rbCb;
            ueCb->lCh[rbCb->lch[0].lChId - 1].ulRbCb = rbCb;

            winLen = 512 << 1;
            { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&rbCb->m.am.amDl.txBuf, (Size) (winLen * sizeof(KwTx*))) == 0) { cmMemset((U8 *)(rbCb->m.am.amDl.txBuf), 0, (winLen * sizeof(KwTx*))); } else { (rbCb->m.am.amDl.txBuf) = 0L; } };
# 380 "../..//lterlcpdcp/kw_cfg.c"
            { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&rbCb->m.am.amUl.recBuf, (Size) (winLen * sizeof(KwAmRecBuf *))) == 0) { cmMemset((U8 *)(rbCb->m.am.amUl.recBuf), 0, (winLen * sizeof(KwAmRecBuf *))); } else { (rbCb->m.am.amUl.recBuf) = 0L; } };
# 392 "../..//lterlcpdcp/kw_cfg.c"
            break;
         }
      default:
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 398); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgFillRbCb Failed -- for the invalid mode(%d)\n", entCfg->entMode); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 418 "../..//lterlcpdcp/kw_cfg.c"
static S16 kwCfgUpdateRb
(
KwRbCb *rbCb,
KwCellCb *cellCb,
KwUeCb *ueCb,
...

{
   ...
   if (rbCb->mode != entCfg->entMode)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 442); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgUpdateRb():Failed--rbId(%d), rbType(%d), cellId(%d), ueId(%d)\n", rbCb->rlcId.rbId, rbCb->rlcId.rbType ,rbCb->rlcId.cellId, rbCb->rlcId.ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 1:
         {
            switch (rbCb->dir)
            {
               case 2:
                  {
                     cellCb->lCh[rbCb->lch[0].lChId - 1].dlRbCb = 0L;
                     break;
                  }
               case 1:
                  {
                     cellCb->lCh[rbCb->lch[0].lChId - 1].ulRbCb = 0L;
                     break;
                  }
            }
      ...
      case 2:
         {
            ...
            if (rbCb->dir != 3)
            {
               if (rbCb->dir == 2)
               {
                  ueCb->lCh[rbCb->lch[0].lChId - 1].dlRbCb = 0L;
                  ...
                  else
                  {
                     ...
                     if (kwCfgFillRbCb(rbCb, ueCb, entCfg) != 0)
                     {
                        return(14);
                     }
                  }
               ...
               {
                  ueCb->lCh[rbCb->lch[0].lChId - 1].ulRbCb = 0L;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 636); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb(ueId(%d), cellId(%d), cfgType(%d))\n", ueId, cellId, entCfg->cfgType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (cellId == 0)
   {
      ...
      { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 8; };


      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 657); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb(ueId(%d), cellId(%d), cfgType(%d))\n", ueId, cellId, entCfg->cfgType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { ret = 0; if (ueId == 0) { if (rbId >= 10) { ret = 1; } } else { if ((rbType != 0) && (rbType != 1)) { ret = 1; } else if (rbType == 0 &&rbId >= 3) { ret = 1; } else if (rbType == 1 &&rbId >= 32) { ret = 1; } } };
   if (ret != 0)
   {

      { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 6; };



      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 674); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- KW_VALIDATE_RBID Failed --               rbId(%d), rbType(%d), cellId(%d), ueId(%d)\n", rbId, rbType, cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ueId == 0)
   {
           ...
           (entCfg->entMode == 1))
      {
         ...
         if ( kwDbmFetchCellCb(cellId, &cellCb) == 0)
         {

            { if (cellCb->rbCb[rbId] != 0L) { rbCb = cellCb->rbCb[rbId]; } else { rbCb = 0L; } };
               ...
               )
            {
               ...
               { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 4; };



               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 708); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- kwDbmFetchRbCb - RB CB present --                        rbId(%d), cellId(%d)\n", rbId, rbCb->kwRbCb.rlcId.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         else
         {
            ...
            if ( kwDbmCreateCellCb(cellId, &cellCb) != 0)
            {

               { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 3; };



               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 725); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- kwDbmCreateCellCb Failed -- cellId(%d)                        \n", cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         { if (entCfg->lCh[0].lChId <= 0) { { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 18; }; return(1); } };


         { { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&rbCb, (Size) sizeof(RbCb)) == 0) { cmMemset((U8 *)(rbCb), 0, sizeof(RbCb)); } else { (rbCb) = 0L; } }; if ( rbCb == 0L) { { entCfm->rbId = rbId; entCfm->rbType = 0; entCfm->status.status = 2; entCfm->status.reason = 1; }; do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 736); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- kwDbmCreateRbCb Failed, rbId(%d)\n", rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0); return(1); } rbCb->kwRbCb.rlcId.rbId = rbId; cellCb->rbCb[rbId] = (rbCb); { kwCb.genSts.numOfRb++; } };
         ...
         switch (entCfg->dir)
         {
            ...
            default:
               {
                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 753); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- Wrong dir((%d)\n", entCfg->dir); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

                  { if (rbCb != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) rbCb, (Size) sizeof(RbCb)); rbCb = 0L; } };


                  { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 19; };
      ...
      else
      {
         ...
         { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = reason; };
         return(1);
      }
   }
   else
   {
      if ((((entCfg->lCh[0].type == 5) && (entCfg->entMode != 2)) ||
            (entCfg->lCh[0].type == 4)) &&
          (entCfg->entMode != 1))
      {

         if ( kwDbmFetchUeCb(ueId, cellId, &ueCb) == 0)
         {

            { RbCb **_rbCbLst; _rbCbLst = (rbType==0)?ueCb->srbCb:ueCb->drbCb; if (_rbCbLst[rbId] != 0L) { rbCb = _rbCbLst[rbId]; } else { rbCb = 0L; } };
              ...
              )
            {
               ...
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 807); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- kwDbmFetchRbCb - RB CB present --                        rbId(%d), rbType(%d), cellId(%d), ueId(%d)\n", rbId, rbCb->kwRbCb.rlcId.rbType, rbCb->kwRbCb.rlcId.cellId, rbCb->kwRbCb.rlcId.ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         else
         {
            ...
            if ( kwDbmCreateUeCb(ueId, cellId, &ueCb) != 0)
            {

               { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 2; };



               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 825); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- kwDbmCreateUeCb Failed -- cellId(%d),                         ueId(%d)\n", cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         if (entCfg->entMode == 3)
         {
            { if (entCfg->lCh[1].lChId <= 0) { { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 18; }; return(1); } };
         }



         rbCb = kwDbmCreateRbCb(rbId, rbType, ueCb, 1);
         if (rbCb == 0L)
         {

            { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 1; };


            return(1);
         }
# 864 "../..//lterlcpdcp/kw_cfg.c"
      }
      else
      {
         if (entCfg->entMode == 1)
   ...
   if (kwCfgFillRbCb(kwRbCb, ueCb, entCfg) != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 903); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgAddRb -- kwCfgFillRbCb Failed -- cellId(%d),                ueId(%d), rbId(%d), rbType(%d)\n", cellId, ueId, rbId, rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 1; entCfm->status.reason = 0; };

   return(0);
}
# 941 "../..//lterlcpdcp/kw_cfg.c"
 S16 kwCfgReCfgRb
(
CmLteRnti ueId,
CmLteCellId cellId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 969); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb(ueId(%d), cellId(%d), cfgType(%d))\n", ueId, cellId, entCfg->cfgType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { cmMemset((U8 *)(&tRbCb), 0, sizeof(KwRbCb)); };
   ...
   if (ret != 0)
   {
      ...
      { entCfm->rbId = entCfg->rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 6; };



      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 993); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb -- KW_VALIDATE_RBID Failed --               rbId(%d), rbType(%d), cellId(%d), ueId(%d)\n", rbId, rbType, cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ueId == 0)
   {
      ...
      if (ret != 0)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1012); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb -- kwDbmFetchCellCb Failed -- cellId(%d),                   rbId(%d)\n", cellId, rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if ( rbCb == 0L)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1029); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb -- kwDbmFetchRbCb Failed -- cellId(%d),                   rbId(%d)\n", cellId, rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      ret = kwCfgUpdateRb(&rbCb->kwRbCb, cellCb, 0L, entCfg);
      if (ret != 0)
      {

         { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = ret; };



         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1053); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb -- kwCfgUpdateRb Failed --                  rbId(%d), cellId(%d)\n", rbId, cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   else
   {
      ...
      if (ret != 0)
      {
         ...
         { entCfm->rbId = rbId; entCfm->rbType = rbType; entCfm->status.status = 2; entCfm->status.reason = 7; };



         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1074); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb -- kwDbmFetchUeCb Failed -- ueId(%d),            cellId(%d), rbId(%d)\n", ueId, cellId, rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if ( rbCb == 0L)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1091); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb -- kwDbmFetchRbCb Failed -- ueId(%d),            cellId(%d), rbId(%d)\n", ueId, cellId, rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      ret = kwCfgUpdateRb(&rbCb->kwRbCb, 0L, ueCb, entCfg);
      if (ret != 0)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1115); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReCfgRb -- kwCfgUpdateRb Failed --                  rbId(%d), cellId(%d), ueId(%d)\n", rbId, cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1186); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelRb(ueId(%d), cellId(%d), cfgType(%d))\n", ueId, cellId, entCfg->cfgType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1209); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReEstRb -- KW_VALIDATE_RBID Failed --               rbId(%d), rbType(%d), cellId(%d), ueId(%d)\n", rbId, rbType, cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ueId == 0)
   {
      ...
      if (ret != 0)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1235); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelRb -- kwDbmFetchCellCb - RB CB not present --                  rbId(%d), cellId(%d)\n", rbId, cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if ( rbCb == 0L)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1253); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelRb -- kwDbmFetchRbCb - RB CB present --                  rbId(%d), cellId(%d)\n", rbId, cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      switch (kwRbCb->dir)
      {
         case 2:
            {
               cellCb->lCh[kwRbCb->lch[0].lChId].dlRbCb = 0L;
               break;
            }
         case 1:
            {
               cellCb->lCh[kwRbCb->lch[0].lChId].ulRbCb = 0L;
               break;
            }
      }
   }
   ...
   else
   {
      ...
      if (ret != 0)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1293); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelRb -- kwDbmFetchRbCb - RB CB present --                  rbId(%d), ueId(%d), cellId(%d)\n", rbId, ueId, cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if ( rbCb == 0L)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1311); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelRb -- kwDbmFetchRbCb - RB CB present --                  rbId(%d), ueId(%d), cellId(%d)\n", rbId, ueId, cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         case 2:
            {
               switch (kwRbCb->dir)
               {
                  case 2:
                     {
                        ueCb->lCh[kwRbCb->lch[0].lChId].dlRbCb = 0L;
                        break;
                     }
                  case 1:
                     {
                        ueCb->lCh[kwRbCb->lch[0].lChId].ulRbCb = 0L;
                        break;
                     }
                  case 3:
                     {
                        ueCb->lCh[kwRbCb->lch[0].lChId].dlRbCb = 0L;
                        ueCb->lCh[kwRbCb->lch[1].lChId].ulRbCb = 0L;
                        break;
                     }
               }
         ...
         default:
            {
               ...
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1366); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelRb -- RLC entity Mode is wrong --                        rbId(%d), ueId(%d), cellId(%d), mode(%d).\n", rbId, ueId, cellId, kwRbCb->mode); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 1409 "../..//lterlcpdcp/kw_cfg.c"
   kwDbmDelRbCb(rbId, rbType, &rbCb, 1);
      ...
      )
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1424); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelRb -- KW_DBM_DELETE_RBCB - Failed --               rbId(%d), cellId(%d), ueId(%d)\n", entCfg->rbId, cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1485); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReEstRb(ueId(%d), cellId(%d), cfgType(%d))\n", ueId, cellId, entCfg->cfgType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { ret = 0; if (ueId == 0) { if (rlcId.rbId >= 10) { ret = 1; } } else { if ((rlcId.rbType != 0) && (rlcId.rbType != 1)) { ret = 1; } else if (rlcId.rbType == 0 &&rlcId.rbId >= 3) { ret = 1; } else if (rlcId.rbType == 1 &&rlcId.rbId >= 32) { ret = 1; } } };
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1509); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReEstRb -- KW_VALIDATE_RBID Failed --               rbId(%d), cellId(%d), ueId(%d)\n", rlcId.rbId, rlcId.cellId, rlcId.ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1526); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgReEstRb -- kwDbmFetchRbCbForUi Failed --               rbId(%d), rbType(%d), cellId(%d), ueId(%d)\n", rlcId.rbId, rlcId.rbType, rlcId.cellId, rlcId.ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1621); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelUe(ueId(%d), cellId(%d), cfgType(%d))\n", ueId, cellId, entCfg->cfgType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( ueId == 0 )
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1639); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelUe -- UeId is 0  -- cellId(%d)\n", cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1656); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelUe -- kwDbmFetchUeCb - Failed -- cellId(%d), ueId(%d)\n", cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1674); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelUe -- kwDbmDelUeCb - Failed --               cellId(%d), ueId(%d)\n", cellId, ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { entCfm->rbId = entCfg->rbId; entCfm->rbType = entCfg->rbType; entCfm->status.status = 1; entCfm->status.reason = 0; };
# 1690 "../..//lterlcpdcp/kw_cfg.c"
   return(0);
}
# 1712 "../..//lterlcpdcp/kw_cfg.c"
 S16 kwCfgDelCell
(
CmLteCellId cellId,
CkwEntCfgInfo *entCfg,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1734); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelCell( cellId(%d), cfgType(%d))\n", cellId, entCfg->cfgType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( cellId == 0 )
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1750); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelCell Failed -- cellId is 0  -- cellId(%d)\n", cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1767); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelCell -- kwDbmFetchCellCb - Failed -- cellId(%d)\n", cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1783); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgDelCell -- kwDbmDelCellCb - Failed --               cellId(%d)\n", cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
 ...
 U8 rbIdx;
        ...
        (ueInfo->cellId == newUeInfo->cellId))
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1846); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgUeIdChng -- Failed -- cellId(%d), ueId(%d) --         newCellId(%d), newUeId(%d)\n", ueInfo->cellId, ueInfo->ueId, newUeInfo->cellId, newUeInfo->ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret == 0)
   {
      ...
      if (ueCb->isUeIdChngDone == 1)
      {
         ueCb->isUeIdChngDone = 0;
         return(0);
      }


      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1864); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgUeIdChng -- NewUeCb already Exists -- cellId(%d),                ueId(%d)\n", newUeInfo->cellId, newUeInfo->ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1878); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgUeIdChng -- kwDbmFetchUeCb Failed -- cellId(%d),                ueId(%d)\n", ueInfo->cellId, ueInfo->ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   ret = cmHashListDelete(&(kwCb.ueLstCp), (U32) ueCb);
   if (ret != 0)
   {


      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1892); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgUeIdChng -- cmHashListDelete Failed -- cellId(%d),                ueId(%d)\n", ueInfo->cellId, ueInfo->ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   ueCb->key.cellId = newUeInfo->cellId;
    ...
    ret = cmHashListInsert(&(kwCb.ueLstCp), (U32)ueCb, (U8 *)&(ueCb->key),
         (U16) sizeof(KwUeKey));

  if (ret != 0)
   {

      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_cfg.c", 1911); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCfgUeIdChng -- cmHashListInsert Failed -- cellId(%d),                ueId(%d)\n", newUeInfo->cellId, newUeInfo->ueId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
