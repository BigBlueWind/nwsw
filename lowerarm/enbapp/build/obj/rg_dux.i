...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 121 "../..//ltemac/rg_dux.c" 2
# 1 "../..//cm/cm5.x" 1
# 122 "../..//ltemac/rg_dux.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 137 "../..//ltemac/rg_dux.c" 2
# 146 "../..//ltemac/rg_dux.c"
#define RG_DUX_ALLOC(_pdu,_size,_dataPtr,_ret) { _ret = cmGetMem((Ptr)&_pdu->memCp, _size, (Ptr *)&_dataPtr); }



#define RG_EXT_LCID(_lcId,_byte) { (_lcId) = (_byte) & RG_LCID_MASK; }



#define RG_EXT_EXTN_BIT(_extnBit,_byte) { (_extnBit) = ((_byte) >> RG_LCID_LEN) & 0x01; }



#define RG_INIT_CE_SUBHDR(_subHdr,_lcId) { (_subHdr)->lcId = (_lcId); (_subHdr)->subHdrLstEnt.next = NULLP; (_subHdr)->subHdrLstEnt.prev = NULLP; (_subHdr)->subHdrLstEnt.node = (PTR)(_subHdr); }
...
#define RG_INIT_SDU(_sdu,_lcId,_len) { (_sdu)->lcId = (_lcId); (_sdu)->len = (_len); (_sdu)->mBuf = NULLP; (_sdu)->sduLstEnt.next = NULLP; (_sdu)->sduLstEnt.prev = NULLP; (_sdu)->sduLstEnt.node = (PTR)(_sdu); }
# 174 "../..//ltemac/rg_dux.c"
#define RG_EXT_BS(_bsr,_bs1,_bs2,_bs3,_bs4) { _bs1 = _bsr[0] >> 2; _bs2 = (((_bsr[0] & 0x3) << 4) | (_bsr[1] >> 4)); _bs3 = (((_bsr[1] & 0x0F) << 2) | (_bsr[2] >> 6)); _bs4 = _bsr[2] & 0x3F; }
...
#define RG_UNPACK_LONG_BSR(_bsr,_mBuf,_ret) { _ret = SRemPreMsgMult((_bsr), 3, (_mBuf)); }



#define RG_UNPACK_SHORT_BSR(_bsr,_mBuf,_ret) { _ret = SUnpkU8((_bsr), (_mBuf)); }



#define RG_UNPACK_TRUNC_BSR(_bsr,_mBuf,_ret) { _ret = SUnpkU8((_bsr), (_mBuf)); }



#define RG_UNPACK_PHR(_phr,_mBuf,_ret) { _ret = SUnpkU8((_phr), (_mBuf)); }



#define RG_UNPACK_CRNTI(_rnti,_mBuf,_ret) { Data _unpkArray[2]; *_rnti = 0; _ret = SRemPreMsgMult(_unpkArray, (MsgLen) 2, _mBuf); if (_ret == ROK) { *_rnti = (U16) PutHiByte(*_rnti, (U8) _unpkArray[0]); *_rnti = (U16) PutLoByte(*_rnti, (U8) _unpkArray[1]); }}
# 228 "../..//ltemac/rg_dux.c"
static S16 rgDUXExtSduLen
(
Buffer *mBuf,
U16 *sduLen,
RgErrInfo *err
...

{
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 249); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduLen():                   SUnpkU8 failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   *sduLen = byte & 0x7F;
   if(fmt)
   {
      if(SUnpkU8(&byte,mBuf) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 260); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduLen():                   SUnpkU8 failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if(ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 314); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, " rgDUXInsSdu():                Allocation of RgSubHdr failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 369 "../..//ltemac/rg_dux.c"
{
   ...
   *subHdrChkCmp = 1;
   do
   {
      if(SUnpkU8(&byte,mBuf) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 382); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCeSubHdrs():                            SUnpkU8 failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      { (lcId) = (byte) & 0x1F; };
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 389); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCeSubHdrs(): lcId(%u)\n",lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      if(lcId == 0x1F)
      {
         if(*extnBit)
         {
            ...
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 400); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCeSubHdrs():                            padSubHdrs received more than 2\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         else
         {
            if(*numPadSubHdrs)
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 411); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCeSubHdrs():                            invalid padSubHdrs received\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 475 "../..//ltemac/rg_dux.c"
{
   ...
   *subHdrChkCmp = 1;
   ...
   do
   {
      ...
      { (lcId) = (byte) & 0x1F; };
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 490); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCeSubHdrs(): lcId(%u)\n",lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
      { (*extnBit) = ((byte) >> 0x5) & 0x01; };
      ...
      if(lcId == 0x1F)
      {
         if(*extnBit)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 498); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduSubHdrs():                         invalid padSubHdrs received\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         else
         {
            if(*numPadSubHdrs)
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 507); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCeSubHdrs():                            invalid padSubHdrs received\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      if ((lcId >= 0x1A) && (lcId <= 0X1E))
      {
         { ret = cmGetMem((Ptr)&pdu->memCp, sizeof(RgMacCeSubHdr), (Ptr *)&ceSubHdr); };
         if(ret != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 521); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, " rgDUXExtCeSubHdrs():                      Allocation of RgMacCeSubHdr failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         if(*extnBit)
         {
            if(SUnpkU8(&byte,mBuf) != 0)
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 533); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCeSubHdrs():                                  SUnpkU8 failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 592 "../..//ltemac/rg_dux.c"
{
   ...
   do
   {
      ...
      { (lcId) = (byte) & 0x1F; };
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 606); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduSubHdrs(): lcId(%u)\n",lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
      { (extnBit) = ((byte) >> 0x5) & 0x01; };
      ...
      if(lcId == 0x1F)
      {
         if(extnBit)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 614); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduSubHdrs():                         invalid padSubHdrs received\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         else
         {
            if(numPadSubHdrs)
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 623); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduSubHdrs():                            invalid padSubHdrs received\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      if(lcId <= 0x0A)
      {
         ...
         if(extnBit)
         {
            if(rgDUXExtSduLen(mBuf, &sduLen, err) != 0)
            {
               return(1);
            }
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 645); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduSubHdrs(): sduLen(%u)\n",sduLen); SPrint((&rgCb.rgInit)->prntBuf); } };
            if(rgDUXInsSdu(pdu, lcId, sduLen, err) != 0)
            {
               return(1);
            }
            if(SUnpkU8(&byte,mBuf) != 0)
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 653); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSduSubHdrs():                                  SUnpkU8 failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 672); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, " rgDUXExtSduSubHdrs(): Invalid LCID(%u) received\n" ,lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         case 0x1A:
               {
                  ...
                  if(ret != 0)
                  {
                     { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 735); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCes():                               Unpacking of PHR failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         case 0X1C:
               {
                  ...
                  if(ret != 0)
                  {
                     { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 748); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCes():                               Unpacking of Trunc BSR failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         case 0X1D:
               {
                  ...
                  if(ret != 0)
                  {
                     { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 761); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCes():                               Unpacking of Short BSR failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         case 0X1E:
               {
                  ...
                  if(ret != 0)
                  {
                     { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 775); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCes():                               Unpacking of Long BSR failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         case 0X1B:
               {
                  ...
                  if(ret != 0)
                  {
                     { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 793); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtCes():                               Unpacking of C-RNTI failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
               ...
               break;
         default:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 802); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, " rgDUXExtCes(): Invalid LCID(%u) received\n" , ceSubHdr->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   while(tmpNode)
   {
      ...
      if(!sdu->len)
      {
         ...
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 867); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSdus():                               mBuf length check failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 879); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSdus():                             SSegMsg failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (tmpBuf1 != 0L)
   {
      if(SPutMsg(tmpBuf1) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 894); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXExtSdus():                             SPutMsg failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if((!extnBit) && (subHdrChkCmp))
   {
      if(SPutMsg(mBuf) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 966); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXDemuxData():                             SPutMsg failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if((!extnBit) && (subHdrChkCmp))
   {
      ...
      if(rgDUXExtCes(pdu, ceInfo, mBuf, err) != 0)
      {
         return(1);
      }
      if(SPutMsg(mBuf) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_dux.c", 990); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDUXDemuxData():                             SPutMsg failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if(rgDUXExtSdus(pdu, mBuf, err) != 0)
   {
      return(1);
   }
   return(0);
