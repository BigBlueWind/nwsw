...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 111 "../..//lterrc/nh_cpm.c" 2
# 1 "../..//cm/cm5.x" 1
# 112 "../..//lterrc/nh_cpm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 120 "../..//lterrc/nh_cpm.c" 2


extern U32 NhBcchPcchTbSzTbl[44];
# 144 "../..//lterrc/nh_cpm.c"
 S16 nhCPMHndlDlDirTx
(
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 172); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "In Downlink Info transfer Handler \n"); SPrint((&nhCb.init)->prntBuf); } }; };

   nhDatReqSdu = datReqRspSdu->sdu.datReqSdu;

   do { (Void)cmMemset((U8*)(&(datReqParam)), 0, (Size)(sizeof(NhDatReqParam))); } while(0);
   { (datReqParam.nhId).cellId = (nhDatReqSdu)->hdr.cellId; (datReqParam.nhId).ueId = (nhDatReqSdu)->hdr.ueId; if ((nhDatReqSdu)->sdu.ueMsg.isMsgDed) { (datReqParam.nhId).isPdcpId = 1; (datReqParam.nhId).rbId = (nhDatReqSdu)->sdu.ueMsg.msg.dedMsg.dlDcchMsg.pdcpId; } else { (datReqParam.nhId).isPdcpId = 0; (datReqParam.nhId).rbId = (nhDatReqSdu)->sdu.ueMsg.msg.cmnMsg.cmnMsgInfo.rbId; } };
   ...
   if (0 != nhDBMAddMuiCb(cellAndUeCb->ueCb, &muiCb,
                            nhDatReqSdu->hdr.transId))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 196); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhDBMAddMuiCb Failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      do{ if ((mBuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_cpm.c", 197, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((mBuf)); (mBuf) = 0L; } }while(0);
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0e); (*errInfo).errCause = (0x00); };
   ...
   if ( 0 != ret )
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 210); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhPIMSendUeMsg Failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   nhUTLUpdPduSts(cellAndUeCb->ueCb, 11, 0);
...

{
   ...
   if (length > NhBcchPcchTbSzTbl[44 - 1])
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 302); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "encoded length is more than max TB size\n"); SPrint((&nhCb.init)->prntBuf); } }; };


      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0e); (*errInfo).errCause = (0x18); };

      do{ if ((encBuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_cpm.c", 306, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((encBuf)); (encBuf) = 0L; } }while(0);
      return(1);
   }

   do { S32 _minIdx, _midIdx, _maxIdx; for (_minIdx = 0, _maxIdx = 44 - 1; _minIdx <= _maxIdx;) { _midIdx = ((_minIdx + _maxIdx) / 2); if (NhBcchPcchTbSzTbl[_midIdx] < (msgOctets * 8)) { _minIdx = _midIdx + 1; } else if (NhBcchPcchTbSzTbl[_midIdx] > (msgOctets * 8)) { _maxIdx = _midIdx - 1; } else { tbSize = NhBcchPcchTbSzTbl[_midIdx]; break; } } if (_minIdx > _maxIdx) tbSize = NhBcchPcchTbSzTbl[_minIdx]; } while(0);
   ...
   { (datReqParam.nhId).cellId = (datReqRspSdu->sdu.datReqSdu)->hdr.cellId; (datReqParam.nhId).ueId = (datReqRspSdu->sdu.datReqSdu)->hdr.ueId; if ((datReqRspSdu->sdu.datReqSdu)->sdu.ueMsg.isMsgDed) { (datReqParam.nhId).isPdcpId = 1; (datReqParam.nhId).rbId = (datReqRspSdu->sdu.datReqSdu)->sdu.ueMsg.msg.dedMsg.dlDcchMsg.pdcpId; } else { (datReqParam.nhId).isPdcpId = 0; (datReqParam.nhId).rbId = (datReqRspSdu->sdu.datReqSdu)->sdu.ueMsg.msg.cmnMsg.cmnMsgInfo.rbId; } };
   datReqParam.isPdcpDatReq = 0;
   datReqParam.u.rlcParam.lcType = 2;
   { datReqParam.u.rlcParam.u.timingInfo.sfn = cmnMsg->cmnMsgInfo.timingInfo.sfn; datReqParam.u.rlcParam.u.timingInfo.subframe = cmnMsg->cmnMsgInfo.timingInfo.subframe; };
   ...
   if (0 != ret)
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 332); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Send to lower layer failed(ret:%d) \n", ret); SPrint((&nhCb.init)->prntBuf); } }; };

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0e); (*errInfo).errCause = (0x14); };
   ...
   nhUTLUpdCellPduSts(cellAndUeCb->cellCb, 3,
                        0);
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 393); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCPMUeCapEnqHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 401); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB1 is not configured.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 422); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhCPMUeCapEnqHndlr: nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 477); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCPMMobFrmEutraCmd called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x01))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 485); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB1 is not configured.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x1A); };
   ...
   if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x08))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 496); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Security procedure is not initiated.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 509); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB2 is not establisged.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 518); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Atleast one DRB is not established.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 539); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }

   cellAndUeCb->ueCb->hoToEutraOrMobFrmEutra = 25;
...
# 588 "../..//lterrc/nh_cpm.c"
{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 597); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCPMHoFrmEutraPrepTfr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x01))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 605); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB1 is not configured.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x1A); };
   ...
   if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x08))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 616); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Security procedure is not initiated.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 636); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 690); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCPMCDMACsfbParamRsp called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x01))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 698); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB1 is not configured.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x1A); };
   ...
   { (datReqParam.nhId).cellId = (datRspSdu)->hdr.cellId; (datReqParam.nhId).ueId = (datRspSdu)->hdr.ueId; (datReqParam.nhId).isPdcpId = 1; (datReqParam.nhId).rbId = (datRspSdu)->sdu.m.dlDcchMsg.pdcpId; };
   datReqParam.isPdcpDatReq = 1;

   { (msgPduAndType).pdu = (&datRspSdu->sdu.m.dlDcchMsg.m.dcchMsg); (msgPduAndType).type = (0x01); };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 718); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 779); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE Information Request Handler \n"); SPrint((&nhCb.init)->prntBuf); } }; };


   if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x01))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 784); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB1 is not configured.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x1A); };
   ...
   if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x08))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 795); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Security procedure is not initiated.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (0 != nhDBMAddMuiCb(cellAndUeCb->ueCb, &muiCb,
                            nhDatReqSdu->hdr.transId))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 823); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhDBMAddMuiCb Failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      do{ if ((mBuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_cpm.c", 824, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((mBuf)); (mBuf) = 0L; } }while(0);
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0e); (*errInfo).errCause = (0x00); };
   ...
   if ( 0 != ret )
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cpm.c", 837); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhPIMSendUeMsg Failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      nhDBMDelMuiCb(cellAndUeCb->ueCb, &muiCb);
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0e); (*errInfo).errCause = (0x00); };
   ...
   nhUTLUpdPduSts(cellAndUeCb->ueCb, 32,
                   0);
