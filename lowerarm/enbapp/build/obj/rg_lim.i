...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//ltemac/rg_lim.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//ltemac/rg_lim.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//ltemac/rg_lim.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//ltemac/rg_lim.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
static S16 rgLIMValidateSap (SuId suId);
...

{
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 186); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgLIMTfuBndReq() Call to RgLiTfuBndReq() failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   }
   return(ret);
}
# 210 "../..//ltemac/rg_lim.c"
...

{
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 232); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgLIMTfuUbndReq() Call to RgLiTfuUbndReq() failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   }
   return(ret);
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 276); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgLiTfuBndCfm SuId(%d), Status(%d)\n", suId, status); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 283); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"Incorrect SuId. Configured (%d) Recieved (%d)\n", tfuSap->sapCfg.suId, suId); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if( suId != tfuSap->sapCfg.suId)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 319); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"Incorrect SuId. Configured (%d) Recieved (%d)\n", tfuSap->sapCfg.suId, suId); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }
   if (tfuSap->sapSta.sapState != 2)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 325); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"Lower SAP not enabled SuId (%d)\n", tfuSap->sapCfg.suId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 569 "../..//ltemac/rg_lim.c"
   ...
   if((ret = RgLiTfuDatReq (&tfuSap->sapCfg.sapPst, tfuSap->sapCfg.spId,
                            datReq)) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 575); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgLIMTfuDatReq() Call to RgLiTfuDatReq() failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   }
   return(ret);
}
# 597 "../..//ltemac/rg_lim.c"
...

{
   ...
   if ((ret = rgLIMValidateSap (suId)) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lim.c", 625); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgLiTfuTtiInd() SAP Validation failed.\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
