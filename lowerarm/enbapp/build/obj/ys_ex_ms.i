...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//lteclpal/ys_ex_ms.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//lteclpal/ys_ex_ms.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 121 "../..//lteclpal/ys_ex_ms.c" 2

# 1 "../..//cm/cm5.x" 1
# 123 "../..//lteclpal/ys_ex_ms.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 137 "../..//lteclpal/ys_ex_ms.c" 2
# 145 "../..//lteclpal/ys_ex_ms.c"
 S16 ysActvTsk
(
Pst *pst,
Buffer *mBuf
...
# 235 "../..//lteclpal/ys_ex_ms.c"
      ...
      case 0xd9:
         switch (pst->event)
         {
            ...
            default:
               { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ex_ms.c", 252); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ex_ms.c", 252); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysActvTsk(): Invalid event (%d)! \n", pst->event); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ...
      case 0xd5:
         ...
         switch(pst->event)
         {
            ...
            case 15:
               ...
               break;
# 301 "../..//lteclpal/ys_ex_ms.c"
            default:
               { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ex_ms.c", 302); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ex_ms.c", 302); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysActvTsk(): Invalid event (%d)! \n",pst->event); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
               SPutMsg(mBuf);
               break;
         }
         break;
      ...
      default:
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ex_ms.c", 311); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ex_ms.c", 311); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysActvTsk(): Message from an invalid                               entity (%d)! \n", pst->srcEnt); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
