...
# 112 "../..//ltemac/rg_sch_dlfs.c" 2
# 1 "../..//ltemac/rg_sch_dlfs.h" 1
# 103 "../..//ltemac/rg_sch_dlfs.h"
#define __RGDLFSH__ 
...
#define RG_SCH_DLFS_GET_CELL(_cell) ((RgSchDlfsCellCb *) ((RgSchCmnCell*)((_cell)->sc.sch))->dl.dlfsCell)
...
#define RG_SCH_DLFS_CQI_TO_MODODR(_x,_y) do { if (_x <= 6) *(_y) = 2; else if (_x <= 9) *(_y) = 4; else *(_y) = 6;} while(0)




#define RG_SCH_DLFS_MODODR_TO_RETX_MCS(_x,_y) do { if (_x == 2) *(_y) = 29; else if (_x == 4) *(_y) = 30; else *(_y) = 31;} while(0)





#define RG_SCH_DLFS_GET_PRD_SBSIZE(_sbSize,_totDlBw) RG_SCH_DLFS_GET_LARGE_SBSIZE(_sbSize, _totDlBw)


#define RG_SCH_DLFS_GET_APRD_MODE30_SBSIZE(_sbSize,_totDlBw) RG_SCH_DLFS_GET_LARGE_SBSIZE(_sbSize, _totDlBw)


#define RG_SCH_DLFS_GET_APRD_MODE20_SBSIZE(_sbSize,_totDlBw) RG_SCH_DLFS_GET_SMALL_SBSIZE(_sbSize, _totDlBw)


#define RG_SCH_DLFS_GET_SMALL_SBSIZE(_sbSize,_totDlBw) { if ((_totDlBw) > 63) { *(_sbSize) = 4; } else if ((_totDlBw) > 26) { *(_sbSize) = 3; } else if ((_totDlBw) > 10) { *(_sbSize) = 2; } else { if ((_totDlBw) > 7) { *(_sbSize) = 2; } else { *(_sbSize) = 0; } }}
# 164 "../..//ltemac/rg_sch_dlfs.h"
#define RG_SCH_DLFS_GET_LARGE_SBSIZE(_sbSize,_totDlBw) { if ((_totDlBw) > 63) { *(_sbSize) = 8; } else if ((_totDlBw) > 26) { *(_sbSize) = 6; } else if ((_totDlBw) > 10) { *(_sbSize) = 4; } else { if ((_totDlBw) > 7) { *(_sbSize) = 4; } else { *(_sbSize) = 0; } }}
# 192 "../..//ltemac/rg_sch_dlfs.h"
#define RG_SCH_DLFS_GET_PRDICITY_AND_OFFST(_idx,_prdicity,_offset) { if ((_idx) <= 1) {*(_prdicity) = 2; *(_offset) = (U8)(_idx); } else if ((_idx) <= 6) {*(_prdicity) = 5; *(_offset) = (U8)((_idx) - 2); } else if ((_idx) <= 16) {*(_prdicity) = 10; *(_offset) = (U8)((_idx) - 7);} else if ((_idx) <= 36) {*(_prdicity) = 20; *(_offset) = (U8)((_idx) - 17); } else if ((_idx) <= 76) {*(_prdicity) = 40; *(_offset) = (U8)((_idx) - 37); } else if ((_idx) <= 156) {*(_prdicity) = 80; *(_offset) = (U8)((_idx) - 77); } else if ((_idx) <= 316) {*(_prdicity) = 160; *(_offset) = (U8)((_idx) - 157); } else if ((_idx) == 317) {*(_prdicity) = 0; *(_offset) = 0; } else if ((_idx) <= 349) {*(_prdicity) = 32; *(_offset) = (U8)((_idx) - 318); } else if ((_idx) <= 413) {*(_prdicity) = 64; *(_offset) = (U8)((_idx) - 350); } else if ((_idx) <= 541) {*(_prdicity) = 128; *(_offset) = (U8)((_idx) - 414); } else if ((_idx) <=1023) {*(_prdicity) = 0; *(_offset) = 0;}}
# 242 "../..//ltemac/rg_sch_dlfs.h"
#define RGSCHERR_DLFS_MEMERR 0
# 113 "../..//ltemac/rg_sch_dlfs.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 117 "../..//ltemac/rg_sch_dlfs.c" 2
# 1 "../..//cm/cm5.x" 1
# 118 "../..//ltemac/rg_sch_dlfs.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 130 "../..//ltemac/rg_sch_dlfs.c" 2
# 1 "../..//ltemac/rg_sch_dlfs.x" 1
# 105 "../..//ltemac/rg_sch_dlfs.x"
#define __RGDLFSX__ 
...
extern Void rgSCHDlfsDlCqiIndHndlr ( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiIndInfo, CmLteTimingInfo timingInfo );
...
# 131 "../..//ltemac/rg_sch_dlfs.c" 2
# 139 "../..//ltemac/rg_sch_dlfs.c"
static S16 rgSCHDlfsInitSf (RgSchCellCb *, RgSchDlfsSf *);
static Void rgSCHDlfsInitSfHoles (RgSchDlfsSf *);
...
static S16 rgSCHDlfsInitPrdMode20 (Inst, RgSchDlfsCellCb *, RgSchDlfsUeCb *, RgrUePrdDlCqiCfg *);
...
static S16 rgSCHDlfsGetAllocFrmHole (RgSchDlfsHole *, U8 *, U8 *);
static Void rgSCHDlfsRlsAlloc (RgSchDlfsSf *, U32 );
static Void rgSCHDlfsRlsHole (RgSchDlfsSf *, RgSchDlfsHole *);
static Void rgSCHDlfsAddHole (RgSchDlfsSf *, U8 pos);
static Void rgSCHDlfsRstHoleStart (RgSchDlfsCellCb *, RgSchDlfsSf *);


static Void rgSCHDlfsUpdWbCqi (RgSchDlfsUeCb *, U8 );
static Void rgSCHDlfsUpdPrdMode20WbCqi (RgSchDlfsCellCb *, RgSchDlfsUeCb *, TfuCqiPucchMode20 *);
...
static S16 rgSCHDlfsCalcBpIdx (CmLteTimingInfo , RgSchDlfsUeCb * ,U8 *bpIdx);
...
static Void rgSCHDlfsTxUeRbAlloc (RgSchCellCb *, RgSchCmnUeRbAlloc *);


static Void rgSCHDlfsSbAllocForTxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);

static Void rgSCHDlfsWbAllocForTxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);





static Void rgSCHDlfsRetxUeRbAlloc (RgSchCellCb *, RgSchCmnUeRbAlloc *);


static Void rgSCHDlfsSbAllocForRetxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);

static Void rgSCHDlfsWbAllocForRetxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);



static Void rgSCHDlfsTxRetxUeRbAlloc (RgSchCellCb *, RgSchCmnUeRbAlloc *);

static Void rgSCHDlfsSbAllocForTxRetxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);

static Void rgSCHDlfsWbAllocForTxRetxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);

static Void rgSCHDlfsTyp2AllocForTxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);

static Void rgSCHDlfsTyp2AllocForRetxUe (RgSchDlSf *, RgSchCellCb *, RgSchUeCb *, RgSchDlRbAlloc *);
...
static Void rgSCHDlfsAllocSb (RgSchDlfsSf *, RgSchDlfsHole *, U8 *, U8 *);



static Void rgSCHDlfsFreeSf (Inst , RgSchDlfsSf *);
static Void rgSCHDlfsFillImcs ( RgSchCellCb *, RgSchDlfsUeCb *, RgSchDlRbAlloc *, U8 isRetx);

static Void rgSCHDlfsFreeUeBp (Inst , RgSchDlfsUeCb *);
static Void rgSCHDlfsSortUeLst (CmLListCp *, CmLListCp *);
static Void rgSCHDlfsSortSbCqiLst (RgSchDlfsUeCb *);
static Void rgSCHDlfsCalcSbCqiDeviation (RgSchDlfsUeCb *);
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 335); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsCellCfg: thresholdCqi: %d, DL BW: %d" "\n", (int)cellCfg->dlfsCfg.thresholdCqi, (int)cellCfg->bwCfg.dlTotalBw); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if(ret != 0)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 343); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for DLFS cell\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 359); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for DLFS cell %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };

      err->errCause = 0;
      return(ret);
   }

   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 365); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsCellCfg Successful for cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };


   return(ret);
}
# 400 "../..//ltemac/rg_sch_dlfs.c"
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 425); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsCellRecfg: thresholdCqi: %d, " "isDlFreqSel: %d, isCellFreqSel: %d\n", cellRecfg->dlfsRecfg.thresholdCqi, cellRecfg->dlfsRecfg.isDlFreqSel, cmnCell->dl.isDlFreqSel); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (!cellRecfg->dlfsRecfg.isDlFreqSel)
   {
      if (cmnCell->dl.isDlFreqSel)
      {
         ...
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 444); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Frequency selective disabled for cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (!(cmnCell->dl.isDlFreqSel))
   {
      ...
      if(ret != 0)
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 460); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for DLFS cell\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
      ...
      if ((ret = rgSCHDlfsInitCell(cell, dlfsCell))!= 0)
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 472); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for DLFS cell %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
      ...
      while ((ue = rgSCHDbmGetNextUeCb(cell, prvUe)) != 0L)
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 484); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "DLFS cell reconfig failed for cell%d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
      ...
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 492); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Frequency selective enabled for cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 506); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Reconfig for frequency selective cell done: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };

   return(0);
}
# 535 "../..//ltemac/rg_sch_dlfs.c"
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 551); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsCellDel: cellId: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   for (dlsfIdx = 0; dlsfIdx < 20; ++dlsfIdx)
   {
      ...
      (cell->subFrms[dlsfIdx])->dlfsSf = 0L;
   }
   ...
   if (dlfsCell)
   {
      ...
      rgSCHUtlFreeSBuf(instIdx, (Data**)(&(((RgSchCmnCell*) ((cell)->sc.sch))->dl.dlfsCell)),
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 629); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsUeCfg: cellId: %d, crnti %d periodic mode pres: %d " "aperiodic mode pres: %d\n", cell->cellId, ueCfg->crnti, ueCfg->ueDlCqiCfg.prdCqiCfg.pres, ueCfg->ueDlCqiCfg.aprdCqiCfg.pres); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
# 638 "../..//ltemac/rg_sch_dlfs.c"
   ret = rgSCHDlfsCreateUe(cell, ue);
   if (ret != 0)
   {
      err->errCause = 0;
...

{
   S16 ret = 0;
   Inst instIdx = cell->instIdx;
   RgSchDlfsUeCb *dlfsUe = ((RgSchDlfsUeCb *)((RgSchCmnUe *)((ue)->sch))->dl.dlfsUe);
   ;;

   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 699); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsUeRecfg: cellId: %d, ueId %d\n", cell->cellId, ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (ueRecfg->ueRecfgTypes & (1<<2))
   {
      ...
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 709); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Reconfiguring periodic reporting mode, pres: %d\n", ueRecfg->prdDlCqiRecfg.pres); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };


      if (ueRecfg->prdDlCqiRecfg.pres)
      {
         ret = rgSCHDlfsUpdPrdModeCfg(cell, ue, &ueRecfg->prdDlCqiRecfg);
# 723 "../..//ltemac/rg_sch_dlfs.c"
         if (ret != 0)
         {
            err->errCause = 0;
            return(1);
   ...
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 746); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Reconfiguring aperiodic reporting mode, pres: %d\n", ueRecfg->aprdDlCqiRecfg.pres); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 761); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsUeRecfg: numSbCqi: %d, numBps: %d, prdSbSize: %d," "aprdSbSize %d\n", dlfsUe->numSbCqi, dlfsUe->numBp, dlfsUe->prdSbSize, dlfsUe->aprdSbSize); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };



   return(0);
}
# 785 "../..//ltemac/rg_sch_dlfs.c"
 Void rgSCHDlfsUeDel
(
RgSchCellCb *cell,
RgSchUeCb *ue
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 801); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsUeDel: cellId: %d, ueId: %d\n", cell->cellId, ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 887); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsDlCqiIndHndlr: cellId: %d, ueId: %d\n", cell->cellId, ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (cqiIndInfo->isPucchInfo)
   {
      ...
      switch (pucchCqiInfo->mode)
      {
         case TFU_PUCCH_CQI_MODE10:
            {
               ...
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 905); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating periodic mode 1-0 wideband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
         ...
         case TFU_PUCCH_CQI_MODE20:
            {
               ...
               if (pucchCqiInfo->u.mode20Info.u.cqi.isWideband)
               {
                  ...
                  { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 921); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating periodic mode 2-0 wideband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
               ...
               else
               {
                  ...
                  { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 929); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating periodic mode 2-0 subband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
         ...
         case TFU_PUCCH_CQI_MODE11:
            {
               ...
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 946); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating periodic mode 1-1 wideband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
               ...
               {
                  cw2Cqi = cw1Cqi - rgSchCmnDlCqiDiffOfst[ pucchCqiInfo->u.mode11Info.u.cqi.wideDiffCqi.val];

                  avgCqi = (cw1Cqi+cw1Cqi)/2;
               }
         ...
         case TFU_PUCCH_CQI_MODE21:
            {
               ...
               if (pucchCqiInfo->u.mode21Info.u.cqi.isWideband)
               {
                  ...
                  { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 969); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating periodic mode 2-1 wideband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
               ...
               else
               {
                  ...
                  { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 977); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating periodic mode 2-1 subband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
         ...
         default:
            {
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 987); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Invalid periodic CQI reporting mode config %d" ,(int)pucchCqiInfo->mode); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   else
   {
      ...
      switch (puschCqiInfo->mode)
      {
         case TFU_PUSCH_CQI_MODE_20:
            {
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1002); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating aperiodic mode 2-0 wideband and " "subband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
         ...
         case TFU_PUSCH_CQI_MODE_30:
            {
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1016); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating aperiodic mode 3-0 wideband and " "subband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
         ...
         case TFU_PUSCH_CQI_MODE_12:
            {
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1032); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating aperiodic mode 1-2 wideband and " "subband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };




               rgSCHDlfsUpdWbCqi(dlfsUe,
                     (U8)((puschCqiInfo->u.mode12Info.cqiIdx[0] + puschCqiInfo->u.mode12Info.cqiIdx[1])/2));

               break;
            }
         case TFU_PUSCH_CQI_MODE_22:
            {
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1044); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating aperiodic mode 1-2 wideband and " "subband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };




               rgSCHDlfsUpdWbCqi(dlfsUe,
                     (U8) ((puschCqiInfo->u.mode22Info.cqi[0] + puschCqiInfo->u.mode22Info.cqi[1])/2));
         ...
         case TFU_PUSCH_CQI_MODE_31:
            {
               { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1059); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating aperiodic mode 1-2 wideband and " "subband CQI\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };




               rgSCHDlfsUpdWbCqi(dlfsUe,
                    (U8) ((puschCqiInfo->u.mode31Info.wideBandCqi[0] + puschCqiInfo->u.mode31Info.wideBandCqi[1])/2));
         ...
         default:
            {
               { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1074); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Invalid aperiodic CQI reporting mode config %d" ,(int)puschCqiInfo->mode); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   for (raRspCnt = 0; raRspCnt < 4; ++raRspCnt)
   {
      ...
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1174); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "RAR Allocation failed for RAR idx: %d, rbsReq: %d," " rbsAlloc: %d\n", raRspCnt, reqAllocInfo->rbsReq, (int)reqAllocInfo->rbsAlloc); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   dlfsSf = (RgSchDlfsSf *)((allocInfo->dedAlloc.dedDlSf)->dlfsSf);
...

{
   ...
   switch (mode)
   {
      case RGR_PRD_CQI_MOD20:
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1298); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Configuring to periodic mode 2-0\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
      ...
      default:
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1311); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Configuring to periodic mode 1-0\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   switch (aprdCqiCfg->aprdModeEnum)
   {
      case RGR_APRD_CQI_MOD20:
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1368); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Reconfiguring to aperiodic mode 2-0\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
      ...
      default:
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1376); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Reconfiguring to aperiodic mode 3-0\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
...

   {
      ...
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1471); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for DLFS sub-frame\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      ...
      dlfsSf = (RgSchDlfsSf *)((cell->subFrms[dlsfIdx])->dlfsSf);
      if ((ret = rgSCHDlfsInitSf(cell,dlfsSf)) != 0)
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1481); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for sub-bands %d\n", dlsfIdx); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1492); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsInitCell Successful for cell: %d, rbgSize: %d," "numBp: %d, numDlSb: %d, maxDlSbPerUe: %d\n", cell->cellId, dlfsCell->rbgSize, dlfsCell->numBp, dlfsCell->numDlSb, dlfsCell->maxDlSbPerUe); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   RgSchCmnDlUe *cmnDlUe = &(((RgSchCmnUe *)((ue)->sch))->dl);
   ...
   if(ret != 0)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1538); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for DLFS Ue\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };

      return(ret);
   }

   dlfsUe = ((RgSchDlfsUeCb *)((RgSchCmnUe *)((ue)->sch))->dl.dlfsUe);
   ...
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1551); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Allocation for sub-band cqi list failed for the UE %d", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 1582 "../..//ltemac/rg_sch_dlfs.c"
   if (ue->dl.ueDlCqiCfg.aprdCqiCfg.pres)
   {
      rgSCHDlfsUpdAprdModeCfg(cell, ue, &ue->dl.ueDlCqiCfg.aprdCqiCfg);
   }

   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1590); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsUeCfg: numSbCqi: %d, numBps: %d, prdSbSize: %d," "aprdSbSize %d\n", dlfsUe->numSbCqi, dlfsUe->numBp, dlfsUe->prdSbSize, dlfsUe->aprdSbSize); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   if((ret = rgSCHUtlAllocSBuf(instIdx,
               (Data**)&(dlfsSf->dlSb),
             dlfsSf->numDlSb * sizeof(RgSchDlfsSb))) != 0)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1641); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for sub-bands\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 1830 "../..//ltemac/rg_sch_dlfs.c"
static S16 rgSCHDlfsInitPrdMode20
(
Inst instIdx,
RgSchDlfsCellCb *dlfsCell,
RgSchDlfsUeCb *dlfsUe,
...

{
   ...
   { if ((prdCqiCfg->cqiPmiCfgIdx) <= 1) {*(&dlfsUe->periodicity) = 2; *(&dlfsUe->cqiRptOffst) = (U8)(prdCqiCfg->cqiPmiCfgIdx); } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 6) {*(&dlfsUe->periodicity) = 5; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 2); } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 16) {*(&dlfsUe->periodicity) = 10; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 7);} else if ((prdCqiCfg->cqiPmiCfgIdx) <= 36) {*(&dlfsUe->periodicity) = 20; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 17); } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 76) {*(&dlfsUe->periodicity) = 40; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 37); } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 156) {*(&dlfsUe->periodicity) = 80; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 77); } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 316) {*(&dlfsUe->periodicity) = 160; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 157); } else if ((prdCqiCfg->cqiPmiCfgIdx) == 317) {*(&dlfsUe->periodicity) = 0; *(&dlfsUe->cqiRptOffst) = 0; } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 349) {*(&dlfsUe->periodicity) = 32; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 318); } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 413) {*(&dlfsUe->periodicity) = 64; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 350); } else if ((prdCqiCfg->cqiPmiCfgIdx) <= 541) {*(&dlfsUe->periodicity) = 128; *(&dlfsUe->cqiRptOffst) = (U8)((prdCqiCfg->cqiPmiCfgIdx) - 414); } else if ((prdCqiCfg->cqiPmiCfgIdx) <=1023) {*(&dlfsUe->periodicity) = 0; *(&dlfsUe->cqiRptOffst) = 0;}};
# 1871 "../..//ltemac/rg_sch_dlfs.c"
   ...
   if (dlfsUe->numBp)
   {
      if((ret = rgSCHUtlAllocSBuf(instIdx,
            ...
            != 0)
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 1881); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Allocation for bandwidth parts failed for" "the UE\n"); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 1904 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsInitSfHoles
(
RgSchDlfsSf *dlfsSf
)
...

{
   ...
   for (sbIdx = 0; sbIdx < dlfsSf->numDlSb; ++sbIdx)
   {
      ...
      hole->isAvail = 1;
      hole->holeLnk.node = (U32)hole;
      cmLListAdd2Tail(&(dlfsSf->holeLst), &(hole->holeLnk));
   }

   return;
}
# 1944 "../..//ltemac/rg_sch_dlfs.c"
...
# 1994 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsRstHoleStart
(
RgSchDlfsCellCb *dlfsCell,
RgSchDlfsSf *dlfsSf
)
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2086); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsCcchSduAlloc: cell: %d, isRetx: %d, reqLst Count: %d\n", cell->cellId, isRetx, (int)ccchSduLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      reqAllocInfo = &(((RgSchUeCb *)(ccchSduAllocNode->node))->dl.dlAllocCb);;

      { (&(reqAllocInfo->schdLstLnk))->node = (U32)(RgSchUeCb *)(ccchSduAllocNode->node); (&(reqAllocInfo->schdLstLnk))->prev = 0L; (&(reqAllocInfo->schdLstLnk))->next = 0L;};
      ...
      cmLListAdd2Tail(allocLst, &(reqAllocInfo->schdLstLnk));
   ...
   while (ccchSduAllocNode)
   {
      ...
      cmLListAdd2Tail(nonAllocLst, &(reqAllocInfo->schdLstLnk));
      ccchSduAllocNode = ccchSduAllocNode->next;
   }

   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2118); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsCcchSduAlloc done: cellId : %d, allocCount: %d " "nonAllocCount: %d\n", cell->cellId, (int)allocLst->count, (int)nonAllocLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };



   return(ret);
}
# 2141 "../..//ltemac/rg_sch_dlfs.c"
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2180); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsMsg4Alloc: cell: %d, isRetx: %d, reqLst Count: %d\n", cell->cellId, isRetx, (int)msg4Lst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   while (msg4AllocNode)
   {
      reqAllocInfo = &(((RgSchRaCb *)(msg4AllocNode->node))->rbAllocInfo);;

      { (&(reqAllocInfo->schdLstLnk))->node = (U32)(RgSchRaCb *)(msg4AllocNode->node); (&(reqAllocInfo->schdLstLnk))->prev = 0L; (&(reqAllocInfo->schdLstLnk))->next = 0L;};
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2212); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsMsg4Alloc done: cellId : %d, allocCount: %d " "nonAllocCount: %d\n", cell->cellId, (int)allocLst->count, (int)nonAllocLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };



   return(ret);
}
# 2234 "../..//ltemac/rg_sch_dlfs.c"
...

{
   ...
   {
# 2267 "../..//ltemac/rg_sch_dlfs.c"
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2269); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf,"DL BW exhausted for cell:" " %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 2286 "../..//ltemac/rg_sch_dlfs.c"
   cmnAllocInfo->pdcch = rgSCHCmnCmnPdcchAlloc(cell, cmnAllocInfo->dlSf);
   if (cmnAllocInfo->pdcch == 0L)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2290); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf,"Commom PDCCH exhausted for cell:" " %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 2342 "../..//ltemac/rg_sch_dlfs.c"
   return(0);
}
# 2394 "../..//ltemac/rg_sch_dlfs.c"
...

{
   ...
   CmLListCp *ueLst = 0L;
   CmLListCp *schdUeLst = 0L;
   CmLListCp *nonSchdUeLst = 0L;

   RgSchDlfsUeCb *dlfsUe = 0L;
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2439); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsTxUeRbAlloc: cell: %d, reqLst Count: %d\n", cell->cellId, (int)ueLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (dlfsSf->holeLst.count)
   {
      ...
      lstPtr = ((schdUeLst)->crnt = (schdUeLst)->first);
      while (dlfsSf->holeLst.count && lstPtr)
      {
         ue = (RgSchUeCb *)(lstPtr->node);
         dlfsUe = ((RgSchDlfsUeCb *)((RgSchCmnUe *)((ue)->sch))->dl.dlfsUe);
         dlAllocCb = &((ue)->dl.dlAllocCb);;
...
# 2542 "../..//ltemac/rg_sch_dlfs.c"
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2545); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsTxUeRbAlloc done: cell: %d, allocLst Count: %d" " nonallocLst count %d\n", cell->cellId,(int)schdUeLst->count, (int)nonSchdUeLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2637); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsRetxUeRbAlloc: cell: %d, reqLst Count: %d\n", cell->cellId,(int)ueLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2720); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsRetxUeRbAlloc done: cell: %d, allocLst Count: %d" " nonallocLst count %d\n", cell->cellId, (int)schdUeLst->count, (int)nonSchdUeLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 2757 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsTxRetxUeRbAlloc
(
RgSchCellCb *cell,
RgSchCmnUeRbAlloc *allocInfo
)
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2795); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsTxRetxUeRbAlloc: cell: %d, reqLst Count: %d\n", cell->cellId,(int)ueLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 2881 "../..//ltemac/rg_sch_dlfs.c"
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 2884); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHDlfsTxRetxUeRbAlloc done: cell: %d, allocLst Count: %d" " nonallocLst count %d\n", cell->cellId, (int)schdUeLst->count, (int)nonSchdUeLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 2905 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsCalcSbCqiDeviation
(
RgSchDlfsUeCb *dlfsUe
)
...
# 2953 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsSortSbCqiLst
(
RgSchDlfsUeCb *dlfsUe
)
...
{
   U8 sbCqiIdx;
   RgSchDlfsSbCqi *nextSbCqi = 0L;
   ;;

   dlfsUe->sortSbCqiLst = &dlfsUe->sbCqiLst[0];
   dlfsUe->sortSbCqiLst->nxtSbCqi = 0L;
   ...
   for(sbCqiIdx = 1; sbCqiIdx < dlfsUe->numSbCqi; ++sbCqiIdx)
   {
      ...
      if (!(nextSbCqi->nxtSbCqi))
      {
         ...
         (dlfsUe->sbCqiLst[sbCqiIdx]).nxtSbCqi = 0L;
         nextSbCqi->nxtSbCqi = &(dlfsUe->sbCqiLst[sbCqiIdx]);
      }
   }
...

{
   ...
   {
      sbCqiCw2 = sbCqiCw1 - rgSchCmnDlCqiDiffOfst[ mode21CqiInfo->u.cqi.u.subCqi.diffCqi.val];

      avgSbCqi = (sbCqiCw1 + sbCqiCw2)/2;
   }
# 3548 "../..//ltemac/rg_sch_dlfs.c"
   rgSCHDlfsCalcBpIdx(timingInfo, dlfsUe, &rcvdBpIdx);
...
# 3626 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsUpdPrdMode20WbCqi
(
RgSchDlfsCellCb *dlfsCell,
RgSchDlfsUeCb *dlfsUe,
TfuCqiPucchMode20 *mode20CqiInfo
...

{
   ...
   {
      cw2Cqi = cw1Cqi - rgSchCmnDlCqiDiffOfst[ mode21CqiInfo->u.cqi.u.wideCqi.diffCqi.val];
...
# 3794 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsSortUeLst
(
CmLListCp *usUeLst,
CmLListCp *sUeLst
)
...

{
   ...
   RgSchUeCb *usUe;
   CmLList *sLnkNode = 0L;
   CmLList *usLnkNode = 0L;
   CmLList *prvLnkNode = 0L;
   ;;


   usLnkNode = ((usUeLst)->crnt = (usUeLst)->first);
   while (usLnkNode)
   {
      usUe = (RgSchUeCb *)usLnkNode->node;
      usDlfsUe = ((RgSchDlfsUeCb *)((RgSchCmnUe *)(((RgSchUeCb *)usLnkNode->node)->sch))->dl.dlfsUe);


      sLnkNode = &(usUe->dl.dlAllocCb.schdLstLnk);
      { (sLnkNode)->node = (U32)usUe; (sLnkNode)->prev = 0L; (sLnkNode)->next = 0L;};


      prvLnkNode = ((sUeLst)->crnt = (sUeLst)->first);


      while ((prvLnkNode) &&
            ((prvDlfsUe = ((RgSchDlfsUeCb *)((RgSchCmnUe *)(((RgSchUeCb*)prvLnkNode->node)->sch))->dl.dlfsUe)) != 0L) &&
...
# 3912 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsWbAllocForTxUe
(
RgSchDlSf *dlSf,
RgSchCellCb *cell,
RgSchUeCb *ue,
...

{
   ...
   if (totAllocRbs)
   {
      ...
      dlRbAlloc->pdcch =
         rgSCHCmnPdcchAlloc(cell, dlSf, y, dlfsUe->imcsCqi, dlRbAlloc->dciFormat, 0);
      ...
      rgSCHDlfsFillImcs(cell, dlfsUe, dlRbAlloc, 0);
...
# 4047 "../..//ltemac/rg_sch_dlfs.c"
static Bool rgSCHDlfsAreHolesAdjcnt
(
RgSchDlfsHole *hole,
...
# 4094 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsTyp2AllocForTxUe
(
RgSchDlSf *dlSf,
RgSchCellCb *cell,
RgSchUeCb *ue,
...

{
   ...
   while (remRbsReq && (numSbAlloc < dlfsCell->maxDlSbPerUe))
   {
      ...
      if (holeLnk)
      {
         ...
         if (rgSCHDlfsAreHolesAdjcnt(hole, nxtHole) == 0)
         {
...
# 4226 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsTyp2AllocForRetxUe
(
RgSchDlSf *dlSf,
RgSchCellCb *cell,
RgSchUeCb *ue,
...

{
   ...
   if (totAllocRbs)
   {
      ...
      if ((dlUe->proc->tbInfo[0].isAckNackDtx == 4) || (dlUe->proc->tbInfo[0].isAckNackDtx == 4))
      {
         dlRbAlloc->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, dlfsUe->imcsCqi, dlRbAlloc->dciFormat, 1);

      }
      else{
         dlRbAlloc->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, dlfsUe->imcsCqi, dlRbAlloc->dciFormat, 0);
      ...
      rgSCHDlfsFillImcs(cell, dlfsUe, dlRbAlloc, 1);
...
# 4374 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsWbAllocForRetxUe
(
RgSchDlSf *dlSf,
RgSchCellCb *cell,
RgSchUeCb *ue,
...
# 4517 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsWbAllocForTxRetxUe
(
RgSchDlSf *dlSf,
RgSchCellCb *cell,
RgSchUeCb *ue,
...

{
   ...
   if (totAllocRbs)
   {
      ...
      do { if (dlfsUe->imcsCqi <= 6) *(&mod) = 2; else if (dlfsUe->imcsCqi <= 9) *(&mod) = 4; else *(&mod) = 6;} while(0);
      do { if (mod == 2) *(&dlRbAlloc->tbInfo[0].imcs) = 29; else if (mod == 4) *(&dlRbAlloc->tbInfo[0].imcs) = 30; else *(&dlRbAlloc->tbInfo[0].imcs) = 31;} while(0);
      ...
      if ((dlRbAlloc->tbInfo[1].schdlngForTb) && (dlRbAlloc->rbsAlloc != 0))
      {
         ...
         do { if (iTbs2 <= 9) dlRbAlloc->tbInfo[1].imcs = iTbs2; else if (iTbs2 <= 15) dlRbAlloc->tbInfo[1].imcs = iTbs2 + 1; else dlRbAlloc->tbInfo[1].imcs = iTbs2 + 2;} while(0);
...
# 5023 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsSbAllocForTxRetxUe
(
RgSchDlSf *dlSf,
RgSchCellCb *cell,
RgSchUeCb *ue,
...
# 5192 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsFillImcs
(
RgSchCellCb *cell,
RgSchDlfsUeCb *dlfsUe,
...

{
   ...
   if (!isRetx)
   {
      ...
      do { if (iTbs1 <= 9) alloc->tbInfo[0].imcs = iTbs1; else if (iTbs1 <= 15) alloc->tbInfo[0].imcs = iTbs1 + 1; else alloc->tbInfo[0].imcs = iTbs1 + 2;} while(0);
      alloc->tbInfo[0].bytesAlloc = rgTbSzTbl[noLyr1 - 1][iTbs1][alloc->rbsAlloc - 1]/8;
      if (alloc->tbInfo[1].schdlngForTb)
      {
         iTbs2 = (*(RgSchCmnCqiToTbs *)(cmnCell->dl.cqiToTbsTbl[noLyr2 - 1]))
            [dlfsUe->imcsCqi];
         do { if (iTbs2 <= 9) alloc->tbInfo[1].imcs = iTbs2; else if (iTbs2 <= 15) alloc->tbInfo[1].imcs = iTbs2 + 1; else alloc->tbInfo[1].imcs = iTbs2 + 2;} while(0);
   ...
   else
   {
      ...
      do { if (mod == 2) *(&alloc->tbInfo[0].imcs) = 29; else if (mod == 4) *(&alloc->tbInfo[0].imcs) = 30; else *(&alloc->tbInfo[0].imcs) = 31;} while(0);
      do { if (mod == 2) *(&alloc->tbInfo[1].imcs) = 29; else if (mod == 4) *(&alloc->tbInfo[1].imcs) = 30; else *(&alloc->tbInfo[1].imcs) = 31;} while(0);
   }

   return;
}
# 5269 "../..//ltemac/rg_sch_dlfs.c"
...

{
   ...
   ;;
# 5295 "../..//ltemac/rg_sch_dlfs.c"
   *bpIdx = ((prdNum % hVal) - 1) % dlfsUe->numBp;

   return(0);
}
# 5314 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsAddHole
(
RgSchDlfsSf *dlfsSf,
U8 pos
)
...
{
   ;;
   dlfsSf->dlSb[pos].isAvail = 1;
   cmLListAdd2Tail(&dlfsSf->holeLst, &(dlfsSf->dlSb[pos].holeLnk));

   return;
}
# 5346 "../..//ltemac/rg_sch_dlfs.c"
static Void rgSCHDlfsRlsHole
(
RgSchDlfsSf *dlfsSf,
RgSchDlfsHole *hole
)
...
# 5378 "../..//ltemac/rg_sch_dlfs.c"
static S16 rgSCHDlfsGetAllocFrmHole
(
RgSchDlfsHole *hole,
U8 *allocIdx,
U8 *numAllocRbs
...

{
   ...
   if (reqAllocInfo->rbsReq)
   {
      ...
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 5535); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "DLFS BCCH Allocation done: rbsReq: %d, rbsAlloc: %d\n", reqAllocInfo->rbsReq, reqAllocInfo->rbsAlloc); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      rgSCHDlfsCmnRbAlloc(cell, reqAllocInfo);
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dlfs.c", 5545); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "PCCH Allocation done: rbsReq: %d, rbsAlloc: %d\n", reqAllocInfo->rbsReq, reqAllocInfo->rbsAlloc); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
