...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 120 "../..//ltemac/rg_utl.c" 2
# 1 "../..//cm/cm5.x" 1
# 121 "../..//ltemac/rg_utl.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...

{
   ...
   *pData = 0L;
   ...
   if (SGetSBuf(rgCb.rgInit.region, rgCb.rgInit.pool, pData, size) != 0)
   {
     dgn.type = 1;
     ...
     rgLMMStaInd(4, 12,
                                       15, &dgn);
      SLogError(rgCb.rgInit.ent, rgCb.rgInit.inst, rgCb.rgInit.procId, (Txt *) "../..//ltemac/rg_utl.c", (S32) 196, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 28)), (ErrVal) (0), (Txt *) "Unable to Allocate Buffer");
      return(1);
   }


   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_utl.c", 202); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "SGetSBuf(Region (%d), Pool (%d), Size (%ld)), Data (0x%p))\n", rgCb.rgInit.region, rgCb.rgInit.pool, size, *pData); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_utl.c", 256); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "SPutSBuf(Region (%d), Pool (%d), Size (%ld), Data (0x%lx))\n", rgCb.rgInit.region, rgCb.rgInit.pool, size, (U32) *data); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      SLogError(rgCb.rgInit.ent, rgCb.rgInit.inst, rgCb.rgInit.procId, (Txt *) "../..//ltemac/rg_utl.c", (S32) 267, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 29)), (ErrVal) ((ErrVal) 0), (Txt *) "rgFreeSBuf failed.\n");
      return;
   }
...

{
   ...
   ret = SGetMsg((rgCb.rgInit.region), (rgCb.rgInit.pool), mBuf);
   ...
   if (0 != ret)
   {
      ...
      rgLMMStaInd(4, 13,
                                       15, &dgn);
      SLogError(rgCb.rgInit.ent, rgCb.rgInit.inst, rgCb.rgInit.procId, (Txt *) "../..//ltemac/rg_utl.c", (S32) 320, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 30)), (ErrVal) (0), (Txt *) "Unable to Allocate Buffer");
      return(1);
   }
...
# 619 "../..//ltemac/rg_utl.c"
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_utl.c", 621); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgAllocEventMem(): cmAllocEvnt Failed.\n"); SPrint((&rgCb.rgInit)->prntBuf); } }
      return(1);
   }
