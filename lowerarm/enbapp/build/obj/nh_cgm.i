...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 114 "../..//lterrc/nh_cgm.c" 2
# 1 "../..//cm/cm5.x" 1
# 115 "../..//lterrc/nh_cgm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 123 "../..//lterrc/nh_cgm.c" 2


 NhCb nhCb;

static Void nhCGMUpdTransCbRlsRbCfgMask (TransCb *transCtrlBlk, NhActvUeCb *ueCb);

static Void nhCGMUpdTransCbModRbCfgMask (TransCb *transCtrlBlk);
static Void nhCGMUpdTransCbAddRbCfgMask (TransCb *transCtrlBlk);
static Void nhCGMUpdTransCbSecCfgMask (TransCb *transCtrlBlk);
static S16 nhCGMUpdCellCfgInOrdrdCfg ( NhuCellCfgReqSdus *cellCfgSdu, NhCellOrdrdCfg *ordrdCfg);

static S16 nhCGMUpdPdcpSduStaUeCbExpCfg (TransCb *transCtrlBlk, NhuUeCfgInfo *ueCfg);

 S16 nhCGMUpdTransCbResetMacCfgMask ( TransCb *transCtrlBlk);
 S16 nhCGMUpdTransCbRestbSrb1CfgMask ( TransCb *transCtrlBlk);
static S16 nhCGMUpdUeCbExpCfg ( TransCb *transCtrlBlk, NhuUeCfgInfo *ueCfg);

static Void nhCGMUpdTransCbUeCfgMask ( TransCb *transCtrlBlk, NhActvUeCb *ueCb);





static Void nhCGMUpdTransCbRestbRbCfgMask ( TransCb *transCtrlBlk, NhActvUeCb *ueCb);
# 164 "../..//lterrc/nh_cgm.c"
static S16 nhCGMUpdUeCbExpCfg
(
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 180); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating Explicit Configuration in Trans Control Block \n"); SPrint((&nhCb.init)->prntBuf); } }; };


   if (ueCfg->ueCfgBitMsk & 0x08)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 185); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating UE CFG in ordered cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };



      if(transCtrlBlk->cause == 0xEE)
      {
         transCtrlBlk->ordrdCfg.actionMask |= 0x0040;
      }
   }

   if (ueCfg->ueCfgBitMsk & 0x01)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 197); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating Rb CFG in ordered cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };

      if (ueCfg->rbCfgAllList.rbCfgTypBitMsk & 0x01)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 201); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating Rb ADD CFG in ordered cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&transCtrlBlk->ordrdCfg.rbToAddCfgList.rbCfgInfoList), (noRbToCfg * sizeof(NhuRbCfgInfo))) == 0) { do { (Void)cmMemset((U8*)((*(&transCtrlBlk->ordrdCfg.rbToAddCfgList.rbCfgInfoList))), 0, (Size)((noRbToCfg * sizeof(NhuRbCfgInfo)))); } while(0); } else { (*(&transCtrlBlk->ordrdCfg.rbToAddCfgList.rbCfgInfoList)) = 0L; } } while(0);



         if (0L == transCtrlBlk->ordrdCfg.rbToAddCfgList.rbCfgInfoList)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 215); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot allocate mem for Add RB list"); SPrint((&nhCb.init)->prntBuf); } }; };

            return(1);
         }

         do { (Void)cmMemcpy((U8*)(transCtrlBlk->ordrdCfg.rbToAddCfgList.rbCfgInfoList),(const U8*)(ueCfg->rbCfgAllList.rbToAddCfgList.rbCfgInfoList), (Size)(noRbToCfg * sizeof(NhuRbCfgInfo)));} while(0);
      ...
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 228); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating Rb MOD CFG in ordered cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList), (noRbToCfg * sizeof(NhuRbCfgInfo))) == 0) { do { (Void)cmMemset((U8*)((*(&transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList))), 0, (Size)((noRbToCfg * sizeof(NhuRbCfgInfo)))); } while(0); } else { (*(&transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList)) = 0L; } } while(0);



         if (0L == transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 242); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot allocate mem for modified RB list"); SPrint((&nhCb.init)->prntBuf); } }; };

            return(1);
         }

         do { (Void)cmMemcpy((U8*)(transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList),(const U8*)(ueCfg->rbCfgAllList.rbToModCfgList.rbCfgInfoList), (Size)(noRbToCfg * sizeof(NhuRbCfgInfo)));} while(0);




         if(0 != nhCGMUpdPdcpSduStaUeCbExpCfg(transCtrlBlk, ueCfg))
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 254); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhCGMUpdPdcpSduStaUeCbExpCfg function failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };
     ...
     {
        { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 264); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating Rb RLS CFG in ordered cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
        ...
        do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&transCtrlBlk->ordrdCfg.rbToRlsCfgList.rbsToRel), (noRbToCfg * sizeof(NhuRbCfgInfo))) == 0) { do { (Void)cmMemset((U8*)((*(&transCtrlBlk->ordrdCfg.rbToRlsCfgList.rbsToRel))), 0, (Size)((noRbToCfg * sizeof(NhuRbCfgInfo)))); } while(0); } else { (*(&transCtrlBlk->ordrdCfg.rbToRlsCfgList.rbsToRel)) = 0L; } } while(0);



        if (0L == transCtrlBlk->ordrdCfg.rbToRlsCfgList.rbsToRel)
        {
           { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 277); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot allocate mem for release RB list"); SPrint((&nhCb.init)->prntBuf); } }; };

           return(1);
        }

        do { (Void)cmMemcpy((U8*)(transCtrlBlk->ordrdCfg.rbToRlsCfgList.rbsToRel),(const U8*)(ueCfg->rbCfgAllList.rbToRlsCfgList.rbsToRel), (Size)(noRbToCfg * sizeof(NhuRbId)));} while(0);
   ...
   if (ueCfg->conReCfgCause & 0x02)
   {
      transCtrlBlk->ordrdCfg.actionMask |= 0x0080;
   }

   if (ueCfg->conReCfgCause & 0x04)
   {


      transCtrlBlk->ordrdCfg.actionMask |= 0x0200;
      transCtrlBlk->ordrdCfg.actionMask |= 0x0400;
   }


   if(ueCfg->ueCfgBitMsk & 0x02)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 308); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating TrCh CFG in ordered cfg\n"); SPrint((&nhCb.init)->prntBuf); } }; };

      do { (Void)cmMemcpy((U8*)(&transCtrlBlk->ordrdCfg.trChCfg),(const U8*)(&ueCfg->trChCfg), (Size)(sizeof(NhuTrChCfg)));} while(0);


      transCtrlBlk->ordrdCfg.actionMask |= 0x0008;
   }

   if (ueCfg->ueCfgBitMsk & 0x04)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 318); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating Security CFG in ordered cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };


      do { (Void)cmMemcpy((U8*)(&transCtrlBlk->ordrdCfg.secCfg),(const U8*)(&ueCfg->secCfg), (Size)(sizeof(NhuSecurityCfg)));} while(0);


      transCtrlBlk->ordrdCfg.actionMask |= 0x0020;
   }
# 339 "../..//lterrc/nh_cgm.c"
   return(0);
}
...

{
   ...
   retVal = nhCGMLowerLyrCfgReq(cellAndUeCb, cfgInfo, transCtrlBlk, 1);

   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 382); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot perform lower layer config"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 424); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Release lower layer Cfg.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(1 == nhLIMRlsLowerLyrCfg(ueCb))
   {
       { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 440); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhLIMRlsLowerLyrCfg failed for UEID %d CellId %d \n", nhIdentity.ueId, nhIdentity.cellId); SPrint((&nhCb.init)->prntBuf); } }; };


       return(1);
   }

   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 444); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "delete UE CB.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

   if (1 == nhDBMDeleteUeCb(cellCb, &ueCb))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 448); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhDBMDeleteUeCb failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
...

{
   ...
   transCtrlBlk->secCfgMapTbl[0].status = 1;
   transCtrlBlk->secCfgMapTbl[0].action = 0x01;
   transCtrlBlk->secCfgMapTbl[1].status = 1;
   transCtrlBlk->secCfgMapTbl[1].action = 0x01;
   ...
   if(ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 502); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"LIM Send Cfg Faied\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(ret);
   }
...

{
   ...
   if (0 != ret)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 559); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Update of ordered configuration                                     in UeCb failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(cfgReqd)
   {
         ...
         transCtrlBlk->ordrdCfg.ueInfo.crntiCfgType == 0x02)
      {
         ...
         if(0 != ret)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 585); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE addition to cell                                        hash list failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      if(0 != ret)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 594); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"LIM Send Cfg Failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         return(ret);
      }
   }
...
# 621 "../..//lterrc/nh_cgm.c"
 S16 nhCGMUpdCellTransCbCfgMask
(
...

{
   ...
   switch(cellCfgSdu->sdu.cfgType)
   {
      case 0x01:
      {
         ...
         transCb->cfgAction = 0x01;

         transCb->cfgMask |= 0x02;
         transCb->macMapTbl[macMapCnt].status = 1;
         transCb->macMapTbl[macMapCnt].logChId = 0;
         macMapCnt++;
         ...
         {
            transCb->cfgMask |= 0x01;


            transCb->rlcMapTbl[rlcMapCnt].status = 1;
               ...
               (rbCfgInfo->ulRbCfg.ulRbBitMsk & 0x01))
            {
               transCb->macMapTbl[macMapCnt].logChId =
                                   rbCfgInfo->lcId.lcId;
               transCb->macMapTbl[macMapCnt].dir = 0x02;
            }
                    ...
                    (rbCfgInfo->dlRbCfg.dlRbBitMsk & 0x01))
            {
               transCb->macMapTbl[macMapCnt].logChId =
                                   rbCfgInfo->lcId.lcId;
               transCb->macMapTbl[macMapCnt].dir = 0x01;
            }
...
# 747 "../..//lterrc/nh_cgm.c"
      ...
      case 0x04:
      {
         ...
         transCb->cfgAction = 0x04;


         transCb->cfgMask |= 0x02;
         transCb->macMapTbl[macMapCnt].status = 1;
         transCb->macMapTbl[macMapCnt].logChId = 0;
         transCb->macMapTbl[macMapCnt].dir = 0;


         transCb->cfgMask |= 0x01;
         transCb->rlcMapTbl[rlcMapCnt].status = 1;
         transCb->rlcMapTbl[rlcMapCnt].rbId = 0;
# 773 "../..//lterrc/nh_cgm.c"
      }
      break;
      default:
      {
         ...
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 779); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Incorrect cell config type detected after validation \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 811 "../..//lterrc/nh_cgm.c"
static S16 nhCGMUpdCellCfgInOrdrdCfg
(
NhuCellCfgReqSdus *cellCfgSdu,
...
{
   S16 ret;
   NhuCellCfgInfo *cellCfgInfo=0L;
   NhuCellCfgInfo *cellCfgFrmSdu=0L;
   NhuCellReCfgInfo *cellRecfgFrmSdu=0L;
   ...
   switch (cellCfgSdu->sdu.cfgType)
   {
      case 0x01:
      {
         ...
         do { (Void)cmMemcpy((U8*)((cellCfgInfo)),(const U8*)((cellCfgFrmSdu)), (Size)(sizeof(NhuCellCfgInfo)));} while(0);


         cellCfgInfo->rbToAddCfgList.rbCfgInfoList = 0L;

         if (cellCfgFrmSdu->cellCfgBitMsk & 0x01)
         {
            do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&(cellCfgInfo->rbToAddCfgList.rbCfgInfoList)), (((cellCfgFrmSdu->rbToAddCfgList.numOfRbCfgInfo) * sizeof(NhuRbCfgInfo)))) == 0) { do { (Void)cmMemset((U8*)((*(&(cellCfgInfo->rbToAddCfgList.rbCfgInfoList)))), 0, (Size)((((cellCfgFrmSdu->rbToAddCfgList.numOfRbCfgInfo) * sizeof(NhuRbCfgInfo))))); } while(0); } else { (*(&(cellCfgInfo->rbToAddCfgList.rbCfgInfoList))) = 0L; } } while(0);




            if (0L == cellCfgInfo->rbToAddCfgList.rbCfgInfoList)
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 855); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot allocate mem for Add RB config \n"); SPrint((&nhCb.init)->prntBuf); } }; };

               return(1);
            }


            do { (Void)cmMemcpy((U8*)((cellCfgInfo->rbToAddCfgList.rbCfgInfoList)),(const U8*)((cellCfgFrmSdu->rbToAddCfgList.rbCfgInfoList)), (Size)(((cellCfgFrmSdu->rbToAddCfgList.numOfRbCfgInfo) * sizeof(NhuRbCfgInfo))));} while(0);
      ...
      case 0x02:
      {
         ...
         do { (Void)cmMemcpy((U8*)(&(ordrdCfg->reCfgActvnTime)),(const U8*)(&(cellRecfgFrmSdu->actvnTime)), (Size)(sizeof(CmLteTimingInfo)));} while(0);




         if (cellRecfgFrmSdu->cellCfgBitMsk & 0x08)
         {
            do { (Void)cmMemcpy((U8*)(&(cellCfgInfo->macCmnCfg)),(const U8*)(&(cellRecfgFrmSdu->macCmnCfg)), (Size)(sizeof(NhuCmnMacCfg)));} while(0);
...
# 928 "../..//lterrc/nh_cgm.c"
      ...
      default:
      {
         ...
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 938); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid config type(cfgType: %d) in cell cfg \n", cellCfgSdu->sdu.cfgType); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   do { (Void)cmMemset((U8*)(&cellCb->cellTransCb), 0, (Size)(sizeof(NhCellTransCb))); } while(0);
   ret = 0;




   do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&(cellCb->cellTransCb.cellOrdrdCfg)), (sizeof(NhCellOrdrdCfg))) == 0) { do { (Void)cmMemset((U8*)((*(&(cellCb->cellTransCb.cellOrdrdCfg)))), 0, (Size)((sizeof(NhCellOrdrdCfg)))); } while(0); } else { (*(&(cellCb->cellTransCb.cellOrdrdCfg))) = 0L; } } while(0);

   if (0L == cellCb->cellTransCb.cellOrdrdCfg)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 993); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot allocate mem for Ordered configuration"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1003); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "start timer failed  \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { if ((cellCb->cellTransCb.cellOrdrdCfg) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_cgm.c", 1005, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(cellCb->cellTransCb.cellOrdrdCfg), (Size)(sizeof(NhCellOrdrdCfg))); (cellCb->cellTransCb.cellOrdrdCfg) = 0L; } };
   ...
   if (0 != ret)
   {
      ...
      if ((cellCfgSdu->sdu.cfgType == 0x01) &&
          (cellCfgSdu->sdu.u.cfgInfo.cellCfgBitMsk & 0x01))
      {
         cellInfoFrmSdu = &(cellCfgSdu->sdu.u.cfgInfo);
         { if ((cellOrdrdCfg->cellCfgInfo.rbToAddCfgList.rbCfgInfoList) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_cgm.c", 1028, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(cellOrdrdCfg->cellCfgInfo.rbToAddCfgList.rbCfgInfoList), (Size)(((cellInfoFrmSdu->rbToAddCfgList.numOfRbCfgInfo) * sizeof(NhuRbCfgInfo)))); (cellOrdrdCfg->cellCfgInfo.rbToAddCfgList.rbCfgInfoList) = 0L; } };




         { if ((cellCb->cellTransCb.cellOrdrdCfg) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_cgm.c", 1031, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(cellCb->cellTransCb.cellOrdrdCfg), (Size)(sizeof(NhCellOrdrdCfg))); (cellCb->cellTransCb.cellOrdrdCfg) = 0L; } };
...
# 1060 "../..//lterrc/nh_cgm.c"
static Void nhCGMUpdTransCbUeCfgMask
(
TransCb *transCtrlBlk,
NhActvUeCb *ueCb
)
...

{
   ...
   if (transCtrlBlk->ordrdCfg.actionMask & 0x0040)
   {
      if(transCtrlBlk->ordrdCfg.ueInfo.crntiCfgType == 0x01)
      {
         transCtrlBlk->cfgMask |= 0x02;
         transCtrlBlk->ueMapTbl[0].status = 1;
         transCtrlBlk->ueMapTbl[0].action = 0x01;
      }
      else if(transCtrlBlk->ordrdCfg.ueInfo.crntiCfgType ==
                      0x02)
      {
# 1096 "../..//lterrc/nh_cgm.c"
         transCtrlBlk->cfgMask |= 0x02;
         transCtrlBlk->ueMapTbl[0].status = 1;
         transCtrlBlk->ueMapTbl[0].action =
                                     0x02;

         transCtrlBlk->cfgMask |= 0x01;
         transCtrlBlk->ueMapTbl[1].status = 1;
         transCtrlBlk->ueMapTbl[1].action =
                                     0x07;

         transCtrlBlk->cfgMask |= 0x04;
         transCtrlBlk->ueMapTbl[2].status = 1;
      ...
      else
      {
         ...
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1116); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid ue cfgtype"); SPrint((&nhCb.init)->prntBuf); } }; };
         return;
      }
   }
   else
   {
      if ((transCtrlBlk->ordrdCfg.actionMask & 0x0008) ||
          (transCtrlBlk->ordrdCfg.actionMask & 0x0010))
      {
          transCtrlBlk->cfgMask |= 0x02;
          transCtrlBlk->ueMapTbl[0].status = 1;
          transCtrlBlk->ueMapTbl[0].action =
...
# 1153 "../..//lterrc/nh_cgm.c"
static Void nhCGMUpdTransCbAddRbCfgMask
(
TransCb *transCtrlBlk
)
        ...
        rbCount++)
   {
         ...
         (rbCfgInfo->dlRbCfg.dlRbBitMsk & 0x01)))
      {
         ...
         if((rbCfgInfo->rbCfgBitMsk & 0x02) &&
            (rbCfgInfo->dlRbCfg.dlRbBitMsk & 0x01))
         {
            transCtrlBlk->macLchMapTbl[0].logchsToAdd |=
                                       (1 << (rbCfgInfo->lcId.lcId - 1));
         }
...
# 1283 "../..//lterrc/nh_cgm.c"
static Void nhCGMUpdTransCbModRbCfgMask
(
TransCb *transCtrlBlk
)
...

{
   ...
   transCtrlBlk->macLchMapTbl[1].modCfmStatus =
                     transCtrlBlk->macLchMapTbl[1].logchsToMod;
   transCtrlBlk->macLchMapTbl[0].modCfmStatus =
                     transCtrlBlk->macLchMapTbl[0].logchsToMod;
...
# 1402 "../..//lterrc/nh_cgm.c"
static Void nhCGMUpdTransCbRlsRbCfgMask
(
TransCb *transCtrlBlk,
NhActvUeCb *ueCb
)
...

{
        ...
        rbCount++)
   {
      ...
      if(rbId.rbTyp == 0)
      {
         transCtrlBlk->rlcMapTbl.srbToCfg[2] |= (1 <<(rbId.rbId-1));
      }
      else
      {
         transCtrlBlk->rlcMapTbl.drbToCfg[2] |= (1 <<(rbId.rbId-1));
      }
...
# 1522 "../..//lterrc/nh_cgm.c"
static Void nhCGMUpdTransCbSecCfgMask
(
TransCb *transCtrlBlk
)
...
# 1619 "../..//lterrc/nh_cgm.c"
static Void nhCGMUpdTransCbRestbRbCfgMask
(
TransCb *transCtrlBlk,
NhActvUeCb *ueCb
)
...
# 1673 "../..//lterrc/nh_cgm.c"
 S16 nhCGMUpdTransCbCfgMask
(
TransCb *transCtrlBlk,
NhActvUeCb *ueCb
)
...

{
   ...
   if (transCtrlBlk->ordrdCfg.actionMask & 0x0200)
   {
      nhCGMUpdTransCbRestbSrb1CfgMask(transCtrlBlk);
   }

   if (transCtrlBlk->ordrdCfg.actionMask & 0x0400)
   {
      nhCGMUpdTransCbResetMacCfgMask(transCtrlBlk);
   }
# 1738 "../..//lterrc/nh_cgm.c"
   transCtrlBlk->cfmMask = transCtrlBlk->cfgMask;

   return(0);

}
# 1764 "../..//lterrc/nh_cgm.c"
 S16 nhCGMDeleteTrans
(
NhActvUeCb *ueCb,
TransCb *transCtrlBlk
)
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1790); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhCGMDeleteTrans: Release lower layer Cfg.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (transCtrlBlk->ordrdCfg.actionMask)
   {
      if (transCtrlBlk->cfmStatus == transCtrlBlk->cfgMask)
      {
         ...
         if(0 != ret)
         {
             { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1805); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhLIMHndlRvrtCfg Failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1813); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Ongoing configuration, cannot delete transCtrlBlk \n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { (hdr).cellId = (nhIdentity).cellId; (hdr).ueId = (nhIdentity).ueId; };
         hdr.transId = (U32)transCtrlBlk->nxTransId;

         { (*errInfo).errPres = 1; (*errInfo).errType = (0x04); (*errInfo).errCause = (0x05); };

         { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1819); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
         return(1);
      }
   }
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1826); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"delete Trans CB. \n"); SPrint((&nhCb.init)->prntBuf); } }; };


   if (1 == nhDBMDelTransCb(ueCb, &transCtrlBlk))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1831); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUDMDelTransInfoBlock Failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }

   return(0);
}
# 1857 "../..//lterrc/nh_cgm.c"
 S16 nhCGMUpdTransCbRestbSrb1CfgMask
(
TransCb *transCtrlBlk
)
...

{
   ...
   if (transCtrlBlk->ordrdCfg.actionMask & 0x0020)
   {
    ...
    if(0L == tmpNode)
    {
       { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1898); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation failed for adding CmLList.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
    ...
    if(0L == rbInfo)
    {
       { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1905); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation failed for adding radio bearer.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

       { if ((tmpNode) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_cgm.c", 1906, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(tmpNode), (Size)(sizeof(CmLList))); (tmpNode) = 0L; } };
       return(4);
    }
 ...
 S16 nhCGMUpdTransCbResetMacCfgMask
(
TransCb *transCtrlBlk
)
...

{
   ...
   transCtrlBlk->cfgMask |= 0x02;
   transCtrlBlk->rstTbl[0].status = 1;
   transCtrlBlk->rstTbl[0].action = 0x08;

   return(0);
}
# 1965 "../..//lterrc/nh_cgm.c"
 S16 nhCGMPdcpDiscReqdCfgReq
(
TransCb *transCtrlBlk,
NhCellAndUeCb *cellAndUeCb
)
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 1980); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf," nhCGMPdcpDiscReqdCfgReq called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   transCtrlBlk->secCfgMapTbl[0].status = 0;
   transCtrlBlk->secCfgMapTbl[1].status = 0;
   ...
   do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList), (1 * sizeof(NhuRbCfgInfo))) == 0) { do { (Void)cmMemset((U8*)((*(&transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList))), 0, (Size)((1 * sizeof(NhuRbCfgInfo)))); } while(0); } else { (*(&transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList)) = 0L; } } while(0);



   if (0L == transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 2005); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot allocate mem for Mod RB list"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList->rbId.rbId =
                    1;
   transCtrlBlk->ordrdCfg.rbToModCfgList.rbCfgInfoList->rbId.rbTyp = 0;
   ...
   if(ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 2025); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"LIM Send Cfg Faied\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }

   return(0);
}
# 2050 "../..//lterrc/nh_cgm.c"
static S16 nhCGMUpdPdcpSduStaUeCbExpCfg
(
TransCb *transCtrlBlk,
NhuUeCfgInfo *ueCfg
)
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 2071); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Updating Explicit Configuration in Trans Control Block for                HO PDCP SDU status info \n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   for(rbCnt = 0; rbCnt < noRbToCfg; rbCnt++)
   {
      ...
      if (pdcpCfgBitMsk & 0x20)
      {
             ...
             (hoPdcpSduStaInfo->numBits > 0) )
         {
            ...
            do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&hoPdcpSduStaInfo->ulBitMap), (ulBitMapSize)) == 0) { do { (Void)cmMemset((U8*)((*(&hoPdcpSduStaInfo->ulBitMap))), 0, (Size)((ulBitMapSize))); } while(0); } else { (*(&hoPdcpSduStaInfo->ulBitMap)) = 0L; } } while(0);

            if(0L == hoPdcpSduStaInfo->ulBitMap)
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_cgm.c", 2097); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot allocate mem for ulBitMap in ordered config"); SPrint((&nhCb.init)->prntBuf); } }; };
            ...
            do { (Void)cmMemcpy((U8*)(hoPdcpSduStaInfo->ulBitMap),(const U8*)(ueCfg->rbCfgAllList.rbToModCfgList.rbCfgInfoList[rbCnt]. pdcpCfg.hoPdcpSduStaInfo.ulBitMap), (Size)(ulBitMapSize));} while(0);
