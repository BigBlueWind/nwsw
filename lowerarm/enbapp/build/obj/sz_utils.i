...
# 97 "../..//s1ap/sz_utils.c" 2
# 1 "../..//cm/cm5.h" 1
# 98 "../..//s1ap/sz_utils.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 127 "../..//s1ap/sz_utils.c" 2
# 1 "../..//cm/cm5.x" 1
# 128 "../..//s1ap/sz_utils.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
# 151 "../..//s1ap/sz_utils.c" 2

# 1 "../..//cm/szt_asn.x" 1
# 153 "../..//s1ap/sz_utils.c" 2
...

{
   ...
   if(((SztResetTyp *)rstIe)->choice.val == 1)
   {
      ...
      if ((cmGetMem(&((*rstAckPdu)->memCp), sizeof(SztProtIE_Field_ResetAckgIEs),
          (Ptr *)&((*rstAckPdu)->pdu.val.successfulOutcome.value. u.sztResetAckg.protocolIEs.member))) !=0)
      ...
      for(idx = 0; idx < numCon; idx++)
      {
         ...
         szFillTknU32(&(ie1->value.u.sztUE_assocLogS1_ConItem.mME_UE_S1AP_ID), ((SztResetTyp *)rstIe)->val.partOfS1_Intf.member[idx].value.u.sztUE_assocLogS1_ConItem.mME_UE_S1AP_ID.val);

         szFillTknU32(&(ie1->value.u.sztUE_assocLogS1_ConItem.eNB_UE_S1AP_ID), ((SztResetTyp *)rstIe)->val.partOfS1_Intf.member[idx].value.u.sztUE_assocLogS1_ConItem.eNB_UE_S1AP_ID.val);
...
# 1284 "../..//s1ap/sz_utils.c"
   return(0);
}
# 1302 "../..//s1ap/sz_utils.c"
...
# 1358 "../..//s1ap/sz_utils.c"
   ...
   szFillTknU8(&(ie->value.u.sztCause.choice),causeChoice);
   szFillTknU32(&(ie->value.u.sztCause.val.radioNw),causeVal);
# 1441 "../..//s1ap/sz_utils.c"
   return(0);
}
# 1458 "../..//s1ap/sz_utils.c"
...
# 1513 "../..//s1ap/sz_utils.c"
   ...
   szFillTknU8(&(ie->value.u.sztCause.choice),causeChoice);
   szFillTknU32(&(ie->value.u.sztCause.val.radioNw),causeVal);
# 1593 "../..//s1ap/sz_utils.c"
   return(0);
}
# 1610 "../..//s1ap/sz_utils.c"
 S16 szValidateSdus
(
S1apPdu *pdu,
U8 primType,
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_utils.c", 2114); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szUtilsGetConCb : Received dedicated procedure\n"); SPrint((&szCb.init)->prntBuf); } };
...
# 2352 "../..//s1ap/sz_utils.c"
   return(0);
}
# 2369 "../..//s1ap/sz_utils.c"
...
# 2536 "../..//s1ap/sz_utils.c"
   return(0);
}
# 2554 "../..//s1ap/sz_utils.c"
...
# 2737 "../..//s1ap/sz_utils.c"
   return(0);
}
# 2754 "../..//s1ap/sz_utils.c"
...
# 2898 "../..//s1ap/sz_utils.c"
   return(0);
}
# 2915 "../..//s1ap/sz_utils.c"
...
# 3059 "../..//s1ap/sz_utils.c"
   return(0);
}
# 3077 "../..//s1ap/sz_utils.c"
...
# 3220 "../..//s1ap/sz_utils.c"
   return(0);
}
# 3241 "../..//s1ap/sz_utils.c"
...
# 3259 "../..//s1ap/sz_utils.c"
{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_utils.c", 3266); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szUtilsBldUnsucOutComeMsg : Received dedicated procedure\n"); SPrint((&szCb.init)->prntBuf); } };
