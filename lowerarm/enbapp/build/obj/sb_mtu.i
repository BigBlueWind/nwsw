...
static U16 sbMtuChecksum (U16 *buffer, U16 size);


static S16 sbMtuParseIcmp (SbMtuCp *mtuCp, U8 ver, Bool *valid, U16 *mtu, CmNetAddr *dst, Buffer *mBuf);
# 163 "../..//sctp/sb_mtu.c"
 S16 sbMtuGetMemReq
(
U16 maxAddr,
...
# 186 "../..//sctp/sb_mtu.c"
   ...
   *memSz = maxAddr * (sizeof(SbMtuAddrCb) + sizeof(CmListEnt) + sizeof(U32));
...
# 248 "../..//sctp/sb_mtu.c"
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 253); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuInit(mtuCp, maxAddr(%d), minMtu(%d), maxMtu(%d), startMtu(%d), pool, region)\n", maxAddr, minMtu, maxMtu, startMtu); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 279 "../..//sctp/sb_mtu.c"
   mtuCp->pool = pool;
   mtuCp->region = region;
   ...
   { ret = SGetSBuf(mtuCp->region, mtuCp->pool, (Data**)&mtuCp->addrArray, (maxAddr*sizeof(SbMtuAddrCb *))); if ( ret == 0 ) { cmMemset((U8*)mtuCp->addrArray, 0, (maxAddr*sizeof(SbMtuAddrCb *))); } else { mtuCp->addrArray = 0L; } };
   if(ret != 0)
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_mtu.c", 294, (ErrCls)0x4, (ErrCode)(0 + 326), (ErrVal)(ErrVal) mtuCp->state, "sbMtuInit(): Memory Allocation failed");
      return(1);
   }
   ...
   {
      mtuCp->addrArray[i] = (SbMtuAddrCb *)0L;
   }


   cmHashListInit(&(mtuCp->addrHl), maxAddr, 0, 1, 4, region, pool);
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 351); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuGetMtuCb(mtuCp, addr, idx)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 384 "../..//sctp/sb_mtu.c"
   mtuAddr = (SbMtuAddrCb *)0L;
   err = cmHashListFind(&(mtuCp->addrHl), (U8 *)addr, sizeof(CmNetAddr), 0,
                        (U32 *)&mtuAddr);

   if ( (err != 0) || (mtuAddr == (SbMtuAddrCb *)0L) )
   {

      mtuAddr = (SbMtuAddrCb *)0L;
      if( mtuCp->addrArray[mtuCp->nextIdx] != 0L )
      {
          ...
          if(mtuCp->addrArray[mtuCp->nextIdx] != 0L)
          {
              SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_mtu.c", 409, (ErrCls)0x4, (ErrCode)(0 + 331), (ErrVal)(ErrVal) err, "sbMtuGetMtuCb: No Free Entries found in Address array");
      ...
      { err = SGetSBuf(mtuCp->region, mtuCp->pool, (Data**)&mtuAddr, sizeof(SbMtuAddrCb)); if ( err == 0 ) { cmMemset((U8*)mtuAddr, 0, sizeof(SbMtuAddrCb)); } else { mtuAddr = 0L; } };
      if (err != 0)
      {
         return(4);
      }
      ...
      { S16 _i; cmMemset((U8 *)(&(mtuAddr->addr)), 0, sizeof(CmNetAddr));; if ((addr) == (CmNetAddr *)0L) { (&(mtuAddr->addr))->type = 4; (&(mtuAddr->addr))->u.ipv4NetAddr = 0; } else { if ((addr)->type == 4) { (&(mtuAddr->addr))->type = 4; (&(mtuAddr->addr))->u.ipv4NetAddr = (addr)->u.ipv4NetAddr; } else if ((addr)->type == 6) { (&(mtuAddr->addr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(mtuAddr->addr))->u.ipv6NetAddr[_i] = (addr)->u.ipv6NetAddr[_i]; } } else { (&(mtuAddr->addr))->type = 4; (&(mtuAddr->addr))->u.ipv4NetAddr = 0; } } };

      err = cmHashListInsert(&(mtuCp->addrHl), (U32) mtuAddr,
                             (U8 *)&(mtuAddr->addr),
                             sizeof(CmNetAddr));
# 454 "../..//sctp/sb_mtu.c"
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 502); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuDeleteMtuCb(mtuCp, idx(%d))\n", idx); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 522 "../..//sctp/sb_mtu.c"
...
# 534 "../..//sctp/sb_mtu.c"
   ...
   {
      cmHashListDelete(&(mtuCp->addrHl), (U32)mtuAddr);
      { (Void) SPutSBuf(mtuCp->region, mtuCp->pool, (Data*)mtuAddr, sizeof(SbMtuAddrCb)); };
      mtuCp->addrArray[idx]= 0L;
   }
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 583); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuQuerySz(mtuCp, addr, mtu)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 622 "../..//sctp/sb_mtu.c"
   mtuAddr = (SbMtuAddrCb *)0L;
   err = cmHashListFind(&(mtuCp->addrHl), (U8 *)addr, sizeof(CmNetAddr), 0,
                        (U32 *)&mtuAddr);
   ...
   if ( err != 0 )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_mtu.c", 629, (ErrCls)0x4, (ErrCode)(0 + 341), (ErrVal)(ErrVal) err, "sbMtuQuerySz: failed to find entry in hashlist ");
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 684); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuQueryDf(mtuCp, addr, msgSz(%d), df)\n", msgSz); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 697 "../..//sctp/sb_mtu.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 698); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuQueryDf(mtuCp, addr, msgSz(%d), df)\n", msgSz); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 731 "../..//sctp/sb_mtu.c"
   mtuAddr = (SbMtuAddrCb *)0L;
   ...
   if ( err != 0 )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_mtu.c", 738, (ErrCls)0x4, (ErrCode)(0 + 347), (ErrVal)(ErrVal) err, "sbMtuQueryDf: failed to find entry in hashlist ");
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 793); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuDestroy(mtuCp)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 805 "../..//sctp/sb_mtu.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 805); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuDestroy(mtuCp)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 820 "../..//sctp/sb_mtu.c"
   mtuCp->minMtu = 0;
   mtuCp->maxMtu = 0;
   mtuCp->startMtu = 0;
   ...
   for(i=0;i<mtuCp->maxAddr;i++)
   {
      ...
      if(mtuAddr != 0L)
      {
          err = cmHashListDelete(&(mtuCp->addrHl), (U32)&mtuAddr->addr);
          if (err != 0 )
          {
              SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_mtu.c", 839, (ErrCls)0x4, (ErrCode)(0 + 350), (ErrVal)(ErrVal) err, "sbMtuDestroy():" "Could not delete hash list entry");
   ...
   { if (mtuCp->addrArray == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 846); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)mtuCp->addrArray, (mtuCp->maxAddr * sizeof(U32))); sbGlobalCb.genSta.memAlloc -= ((mtuCp->maxAddr * sizeof(U32))); mtuCp->addrArray = 0L; } };
   mtuCp->maxAddr = 0;
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 904); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuIncMtu(mtuCp)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 916 "../..//sctp/sb_mtu.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 916); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuIncMtu(mtuCp)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 932 "../..//sctp/sb_mtu.c"
   for(i=0;i <mtuCp->maxAddr;i++)
   {
      mtuAddr=mtuCp->addrArray[i];
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 979); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuIncMtuUpper(mtuCp)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 991 "../..//sctp/sb_mtu.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 991); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuIncMtuUpper(mtuCp)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 1007 "../..//sctp/sb_mtu.c"
   for(i=0;i <mtuCp->maxAddr;i++)
   {
      mtuAddr=mtuCp->addrArray[i];
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1062); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf, "sbMtuRcvIcmp(mtuCp, mBuf, ver(%u))\n", ver); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 1074 "../..//sctp/sb_mtu.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1074); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuRcvIcmp(mtuCp, mBuf)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 1092 "../..//sctp/sb_mtu.c"
   cmMemset((U8 *)&dst, 0, (U32)sizeof(CmNetAddr));
   err = sbMtuParseIcmp(mtuCp, ver, &valid, &mtu, &dst, mBuf);
# 1105 "../..//sctp/sb_mtu.c"
   if (valid == 0)
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1107); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuRcvIcmp(): Not an P-MTU D ICMP message\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      return(1);
   }

   mtuAddr = (SbMtuAddrCb *)0L;
   err = cmHashListFind(&(mtuCp->addrHl), (U8 *)&dst, sizeof(CmNetAddr), 0, (U32 *)&mtuAddr);
# 1124 "../..//sctp/sb_mtu.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1124); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuRcvIcmp: old mtu = %d\n", mtuAddr->mtu); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   if (mtu == 0)
   {
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1136); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuRcvIcmp: new mtu = %d\n", mtuAddr->mtu); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

   return(0);
}
# 1157 "../..//sctp/sb_mtu.c"
static U16 sbMtuChecksum
(
U16 *buffer,
U16 size
)
...
# 1228 "../..//sctp/sb_mtu.c"
{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1246); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(mtuCp, ver, valid, mtu, mBuf)\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   *valid = 0;
   ...
   if (ver == 4)
   {
      if (msgLen < 36)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1257); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Message Length too short\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         return(0);
      }
      ...
      if (msgLen > 36)
      {
         ...
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1269); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Message Length(%d) larger than neccessary\n", msgLen); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      }

      { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&ip4Hdr, msgLen); if ( ret == 0 ) { cmMemset((U8*)ip4Hdr, 0, msgLen); sbGlobalCb.genSta.memAlloc += (msgLen); } };
      if ( ret != 0 )
      {
          { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 7))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1277); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbmtuParseIcmp: Fail To allocate memory \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      if (newCrc != 0)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1293); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Checksum failure, newCRC(%u)\n", newCrc); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


         { if (ip4Hdr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1295); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)ip4Hdr, msgLen); sbGlobalCb.genSta.memAlloc -= (msgLen); ip4Hdr = 0L; } };
         return(0);
      }
      ...
      if (ip4Hdr[0] != 3)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1305); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Not a P-MTU D usable ICMP message\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         { if (ip4Hdr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1306); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)ip4Hdr, msgLen); sbGlobalCb.genSta.memAlloc -= (msgLen); ip4Hdr = 0L; } };
         return(0);
      }

      if (ip4Hdr[1] != 4)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1312); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Not a P-MTU D usable ICMP message\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         { if (ip4Hdr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1313); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)ip4Hdr, msgLen); sbGlobalCb.genSta.memAlloc -= (msgLen); ip4Hdr = 0L; } };
         return(0);
      }
      ...
      *valid = 1;
      { if (ip4Hdr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1324); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)ip4Hdr, msgLen); sbGlobalCb.genSta.memAlloc -= (msgLen); ip4Hdr = 0L; } };
   }
   else if (ver == 6)
   {
      if (msgLen < 48)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1330); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Message Length too short\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         return(0);
      }

      { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&ip6Hdr, msgLen); if ( ret == 0 ) { cmMemset((U8*)ip6Hdr, 0, msgLen); sbGlobalCb.genSta.memAlloc += (msgLen); } };
      if ( ret != 0 )
      {
          { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 7))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1338); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbmtuParseIcmp: Fail To allocate memory \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      if (ip6Hdr[0] != 2)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1354); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Not a P-MTU D usable ICMP message\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         { if (ip6Hdr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1355); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)ip6Hdr, msgLen); sbGlobalCb.genSta.memAlloc -= (msgLen); ip6Hdr = 0L; } };
         return(0);
      }

      if (ip6Hdr[1] != 0)
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 9))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1361); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (mtuCp->prntBuf,"sbMtuParseIcmp(): Not a P-MTU D usable ICMP message\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         { if (ip6Hdr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1362); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)ip6Hdr, msgLen); sbGlobalCb.genSta.memAlloc -= (msgLen); ip6Hdr = 0L; } };
         return(0);
      }
      ...
      *valid = 1;
      ...
      { if (ip6Hdr == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_mtu.c", 1373); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)ip6Hdr, msgLen); sbGlobalCb.genSta.memAlloc -= (msgLen); ip6Hdr = 0L; } };
   }
# 1386 "../..//sctp/sb_mtu.c"
   return(0);
}
