...
# 116 "../..//lterrc/nh_ccm.c" 2
# 1 "../..//cm/nhu_asn.h" 1
# 117 "../..//lterrc/nh_ccm.c" 2
# 1 "../..//cm/lnh.h" 1
# 90 "../..//cm/lnh.h"
#define __LNHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 123 "../..//lterrc/nh_ccm.c" 2
# 1 "../..//cm/cm5.x" 1
# 124 "../..//lterrc/nh_ccm.c" 2
...
# 139 "../..//lterrc/nh_ccm.c" 2
# 1 "../..//cm/nhu_asn.x" 1
# 140 "../..//lterrc/nh_ccm.c" 2
# 1 "../..//cm/lnh.x" 1
# 100 "../..//cm/lnh.x"
#define __LNHX__ 
# 121 "../..//cm/lnh.x"
...
#define NH_CCM_DEL_UECB_TRANSCB(_isDelTransCb,_transCb,_isDeleteUe,_cellCb,_ueCb) { if(TRUE == _isDelTransCb) { nhDBMDelTransCb(*_ueCb, _transCb); } if(TRUE == _isDeleteUe) { nhDBMDeleteUeCb(_cellCb, _ueCb); } }
# 193 "../..//lterrc/nh_ccm.c"
 S16 nhCCMConSetupHdlr
(
...

{
   ...
   NhActvUeCb *ueCb = 0L;
   NhCellCb *cellCb;
   Bool isUeCbCreated = 0;
   Bool isTransCbCreated = 0;

   ;

   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 222); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConSetupHdlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   nhUTLGetRrcTransId((Void *) & (datRspSdu->sdu.m.dlCcchMsg), 3,
                    NH_SDU_DL_CCCH, &msgTransId);
   (msgTransKey) = (((msgType) << 8) | (msgTransId));;

   { (msgPduAndType).pdu = (&datRspSdu->sdu.m.dlCcchMsg.ccchMsg); (msgPduAndType).type = (0x03); };



   { (datReqParam.nhId).cellId = (datRspSdu)->hdr.cellId; (datReqParam.nhId).ueId = 0; (datReqParam.nhId).isPdcpId = 0; (datReqParam.nhId).rbId = (datRspSdu)->sdu.m.dlCcchMsg.rbId; };
   datReqParam.isPdcpDatReq = 0;
   datReqParam.u.rlcParam.lcType = 3;
   ...
   if(1 == datRspSdu->sdu.isUeCfgPres)
   {
      ...
      else
      {
         ...
         if (0 != retVal)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 263); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot create UE control block.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 279); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Unable to create transaction control block.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&ueCb, &transCb); } if(1 == isUeCbCreated) { nhDBMDeleteUeCb(cellCb, &ueCb); } };
      ...
      if(datRspSdu->hdr.ueId > 0)
      {
         if(datRspSdu->hdr.ueId != datRspSdu->sdu.m.dlCcchMsg.tmpCrnti)
         {
            ...
            transCb->ordrdCfg.actionMask |= 0x0040;
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 320); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndStoreMsg failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&ueCb, &transCb); } if(1 == isUeCbCreated) { nhDBMDeleteUeCb(cellCb, &ueCb); } };
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 332); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot perform lower layer config.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   else
   {
         ...
         if(0 != retVal)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 360); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   (msgTransId=msgTransId);

   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 424); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConRstbRejHdlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 445); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }



   nhUTLUpdCellPduSts(cellAndUeCb->cellCb, 16,
                   0);
   ...
   if(datRspSdu->hdr.ueId > 0)
   {
      ...
      if(0L == ueCb)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 467); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE Control block does not exist.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 469); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot release the configuration.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      if(0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 480); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhCGMCnclUe failed for CRNTI: %d and CellId: %d.\n", datReqParam.nhId.ueId, datReqParam.nhId.cellId); SPrint((&nhCb.init)->prntBuf); } }; };


         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x0b); };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 537); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConRejHdlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 558); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }



   nhUTLUpdCellPduSts(cellAndUeCb->cellCb, 7,
                   0);
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 615); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConSetupCmpHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };



   nhUTLUpdPduSts(cellAndUeCb->ueCb, 6,
               0);
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 632); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUIMDatInd failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 687); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConRlsHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 702); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Unable to create transaction control block.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   { (msgPduAndType).pdu = (&datReqSdu->sdu.ueMsg.msg.dedMsg.dlDcchMsg.m.dcchMsg); (msgPduAndType).type = (0x01); };




   { (datReqParam.nhId).cellId = (datReqSdu)->hdr.cellId; (datReqParam.nhId).ueId = (datReqSdu)->hdr.ueId; if ((datReqSdu)->sdu.ueMsg.isMsgDed) { (datReqParam.nhId).isPdcpId = 1; (datReqParam.nhId).rbId = (datReqSdu)->sdu.ueMsg.msg.dedMsg.dlDcchMsg.pdcpId; } else { (datReqParam.nhId).isPdcpId = 0; (datReqParam.nhId).rbId = (datReqSdu)->sdu.ueMsg.msg.cmnMsg.cmnMsgInfo.rbId; } };
   datReqParam.isPdcpDatReq = 1;
   datReqParam.isMsgEncoded = 0;
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 723); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   nhUTLUpdPduSts(cellAndUeCb->ueCb, msgType, 0);


   return(0);
}
# 760 "../..//lterrc/nh_ccm.c"
 S16 nhCCMConRlsCmpHndlr
(
NhuDatIndSdus *nhuDatIndSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   (nhuDatIndSdu=nhuDatIndSdu);

   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 783); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConRlsCmpHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

   (msgTransKey) = (((10) << 8) | (msgTransId));;
   ...
   if(0L == transCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 793); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Unable to retrieve transCb for UE ID:%d \n", cellAndUeCb->ueCb->ueCbKey.crnti); SPrint((&nhCb.init)->prntBuf); } }; };

      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 794); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"with transId: %d.\n", msgTransId); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 804); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCGMCnclUe failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 859); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMReCfgReqHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   { switch((0x08)) { default: (ies) = &(((NhuDatReqSdus *)(datReqSdu))->sdu.ueMsg.msg.dedMsg. dlDcchMsg.m.dcchMsg.message.val.c1.val.rrcConRecfgn. criticalExtns.val.c1.val.rrcConRecfgn_r8); break; case 0x18: (ies) = &(((NhuEncReqSdus *)(datReqSdu))->sdu.u.dcchMsg.message. val.c1.val.rrcConRecfgn.criticalExtns.val.c1.val. rrcConRecfgn_r8); break; }};
   if ( !((((ies->securityConfigHO).pres.val) != 0) ||
         datReqSdu->sdu.ueCfg.conReCfgCause & 0x08))
   {



      if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & (0x08 | 0x02)))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 876); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Message Cannot be sent unprotected.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x1B); };
   ...
   if ((((ies->mobilityCntrlInfo).pres.val) != 0))
   {

      if(!(cellAndUeCb->ueCb->crntCfg.bitMskPres & 0x0040))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 893); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB2 is not establisged.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x34); };

         return(1);
      }


      if(!(cellAndUeCb->ueCb->crntCfg.bitMskPres & 0x0080))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 902); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Atleast one DRB is not established.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x35); };
   ...
   if (1 == datReqSdu->sdu.isUeCfgPres)
    {
      (msgTransKey) = (((msgType) << 8) | (msgTransId));;
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 923); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Unable to create transaction control block.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 945); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndStoreMsg failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&(cellAndUeCb->ueCb), &transCb); } if(1 == 0) { nhDBMDeleteUeCb(0L, &(cellAndUeCb->ueCb)); } };
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 958); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot send lower layer configuration.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&(cellAndUeCb->ueCb), &transCb); } if(1 == 0) { nhDBMDeleteUeCb(0L, &(cellAndUeCb->ueCb)); } };


         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x33); };
   ...
   else
   {
      ...
      if(0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 982); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&(cellAndUeCb->ueCb), &transCb); } if(1 == 0) { nhDBMDeleteUeCb(0L, &(cellAndUeCb->ueCb)); } };
...
# 1019 "../..//lterrc/nh_ccm.c"
 S16 nhCCMReCfgCmpHndlr
(
NhuDatIndSdus *nhuDatIndSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1043); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMReCfgCmpHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(cellAndUeCb->ueCb->hoToEutraOrMobFrmEutra == 30)
   {


      nhUTLUpdCellPduSts(cellAndUeCb->cellCb, 30,
                         2);
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1063); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUIMDatInd failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      }
      cellAndUeCb->ueCb->hoToEutraOrMobFrmEutra = 0;
      return(retVal);
   }
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1086); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUIMDatInd failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }

   return(0);
}
# 1113 "../..//lterrc/nh_ccm.c"
 S16 nhCCMSecModCmdHndlr
(
NhDatReqRspSdu *datReqRspSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1140); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMSecModCmdHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (1 == datReqSdu->sdu.isUeCfgPres)
   {
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1165); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Unable to create transaction control block.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1179); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Could not store lower layer config.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         return(retVal);
      }


      if(transCb->ordrdCfg.actionMask & 0x0020)
      {
         ...
         if (0 != retVal)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1192); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLEncAndStoreMsg failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         if(datReqSdu->sdu.ueCfg.conReCfgCause & 0x01 ||
         ...
         if (0 != retVal)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1216); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot perform lower layer config.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      else
      {
         ...
         if (!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x04))
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1238); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Security not configured, Can't send Sec Mode Command\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1259); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&(cellAndUeCb->ueCb), &transCb); } if(1 == 0) { nhDBMDeleteUeCb(0L, &(cellAndUeCb->ueCb)); } };
...
# 1302 "../..//lterrc/nh_ccm.c"
 S16 nhCCMSecModCmpHndlr
(
NhuDatIndSdus *nhuDatIndSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1326); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMSecModCmpHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   cellAndUeCb->ueCb->rbSecCfgBitMask |= 0x08;
   cellAndUeCb->ueCb->rbSecCfgBitMask &= ~0x02;

   (msgTransKey) = (((17) << 8) | (msgTransId));;
   transCb = nhUTLGetTransCbFrmMsgTransId(cellAndUeCb->ueCb, msgTransKey);
   ...
   if(0L == transCb)
   {
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1353); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMSecModCmpHndlr: NULL transCb found .\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         return(1);
      }
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1366); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"DiscReqd cfg request failed .\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   }
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1373); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUIMDatInd failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }

   return(0);
}
# 1401 "../..//lterrc/nh_ccm.c"
 S16 nhCCMSecModFailHndlr
(
NhuDatIndSdus *nhuDatIndSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1422); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMSecModFailHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1442); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUIMDatInd failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }

   return(0);
}
# 1468 "../..//lterrc/nh_ccm.c"
 S16 nhCCMUlCmnHndlr
(
NhuDatIndSdus *nhuDatIndSdu,
NhCellAndUeCb *cellAndUeCb,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1493); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMUlCmnHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };



   nhUTLUpdCellPduSts(cellAndUeCb->cellCb, msgType, 0);
   ...
   if(13 == msgType)
   {
           ...
           criticalExtns.val.rrcConReestbRqst_r8.reestablishmentCause.val)
      {
         ...
         if( (0L != ueCb) &&
             (25 == ueCb->hoToEutraOrMobFrmEutra) )
         {

            nhUTLUpdCellPduSts(cellAndUeCb->cellCb, 25,
                               1);
            ueCb->hoToEutraOrMobFrmEutra = 0;
         }
      }
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1533); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUIMDatInd failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }

   return(0);
}
# 1558 "../..//lterrc/nh_ccm.c"
 S16 nhCCMCountChkHndlr
(
NhDatReqRspSdu *datReqRspSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1583); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMCountChkHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1604); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMCountChkHndlr: nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&(cellAndUeCb->ueCb), &transCb); } if(1 == 0) { nhDBMDeleteUeCb(0L, &(cellAndUeCb->ueCb)); } };
...
# 1637 "../..//lterrc/nh_ccm.c"
 S16 nhCCMUlDedMsgHndlr
(
NhuDatIndSdus *nhuDatIndSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1658); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMUlDedMsgHndlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1669); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUIMDatInd failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }

   return(0);
}
# 1700 "../..//lterrc/nh_ccm.c"
 S16 nhCCMConRestbHdlr
(
NhDatReqRspSdu *datReqRspSdu,
NhCellAndUeCb *cellAndUeCb,
U8 msgTransId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1730); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConRestbHdlr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   nhUTLGetRrcTransId((Void *) & (datRspSdu->sdu.m.dlCcchMsg), 0,
                    NH_SDU_DL_CCCH, &msgTransId);
   (msgTransKey) = (((msgType) << 8) | (msgTransId));;
   ...
   if(1 == datRspSdu->sdu.isUeCfgPres)
   {
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1767); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Unable to create transaction control block.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      transCb->ordrdCfg.actionMask |= 0x0200;
      transCb->ordrdCfg.actionMask |= 0x0400;
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1798); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndStoreMsg failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&ueCb, &transCb); } if(1 == isUeCbCreated) { nhDBMDeleteUeCb(cellCb, &ueCb); } };
      ...
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1810); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot store lower layer config.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x0a); };
   ...
   else
   {
       ...
       if(0 != retVal)
       {
          { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ccm.c", 1832); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhCCMConRestbHdlr: nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
          { if(1 == isTransCbCreated) { nhDBMDelTransCb(*&(cellAndUeCb->ueCb), &transCb); } if(1 == 0) { nhDBMDeleteUeCb(0L, &(cellAndUeCb->ueCb)); } };
