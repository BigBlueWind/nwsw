...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 112 "../..//lterlcpdcp/kw_pj_lmm.c" 2
# 1 "../..//cm/cm5.h" 1
# 113 "../..//lterlcpdcp/kw_pj_lmm.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 132 "../..//lterlcpdcp/kw_pj_lmm.c" 2

# 1 "../..//cm/cm5.x" 1
# 134 "../..//lterlcpdcp/kw_pj_lmm.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 150 "../..//lterlcpdcp/kw_pj_lmm.c" 2





extern S16 kwActvTmr (Void);

static S16 pjLmmSendCfm (Pst *pst,PjMngmt *cfm,U8 type,Header *hdr);
static S16 pjLmmGenCfg (PjGenCfg *cfg);
static S16 pjLmmPjuSapCfg (PjSapCfg *cfg);
static S16 pjLmmCpjSapCfg (PjSapCfg *cfg);
static S16 pjLmmGenCntrl (PjMngmt *cntrl);
static S16 pjLmmFormLmCfm (Pst *pst, Header *hdr, Reason reason);
static S16 pjLmmGetPjuSapSta (PjPjuSapSta *sta);
static S16 pjLmmGetCpjSapSta (PjCpjSapSta *sta);
static S16 pjLmmGetGenSts (PjGenSts *sts,Action action);
static S16 pjLmmGetSapSts (PjMngmt *sts,Elmnt elmnt,Action action);
# 190 "../..//lterlcpdcp/kw_pj_lmm.c"
...

{
   ...
   { cmMemset((U8 *)&(kwCb.pjGenCfg), (U8)0, sizeof(PjGenCfg)); };
   { cmMemcpy((U8*)&(kwCb.pjGenCfg), (U8 *)cfg, sizeof(PjGenCfg)); };


   { cmMemset((U8 *)&(kwCb.pjuSap[0]), (U8)0, sizeof(KwPjuSapCb)); };
   { cmMemset((U8 *)&(kwCb.pjuSap[1]), (U8)0, sizeof(KwPjuSapCb)); };


   { cmMemset((U8 *)&(kwCb.cpjSap), (U8)0, sizeof(KwCpjSapCb)); };

   { cmMemcpy((U8*)&(kwCb.pjInit.lmPst), (U8 *)&cfg->lmPst, sizeof(Pst)); };
...

{
   ...
   cfm->hdr.entId.inst = kwCb.pjInit.inst;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 387); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjCfgReq(post, elmId(%d))\n", cfg->hdr.elmId.elmnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00360001, PJ_DIAG_NA, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, cfg->hdr.elmId.elmnt, 0, 0, 0, "Received CfgReq from LM, element = %d"); } }
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 454); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjCfgReq - cfm: status(%d) reason(%d)\n", rCfm.cfm.status, rCfm.cfm.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 531); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjCntrlReq(post, elmId(%d))\n", cntrl->hdr.elmId.elmnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00360002, PJ_DIAG_NA, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, cntrl->hdr.elmId.elmnt, 0, 0, 0, "Received CntrlReq from LM, element = %d"); } }
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 574); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjCntrlReq - cfm: reason(%d)\n", reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   ret = pjLmmFormLmCfm(pst, &cntrl->hdr, reason);
   return(ret);
}
# 593 "../..//lterlcpdcp/kw_pj_lmm.c"
 S16 PjMiLpjStaReq
(
Pst *pst,
PjMngmt *sta
...

{
  ...
  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00360003, PJ_DIAG_NA, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, sta->hdr.elmId.elmnt, 0, 0, 0, "Received StaReq from LM, element = %d"); } }




   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 616); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjStaReq(post, elmId(%d))\n", sta->hdr.elmId.elmnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 674); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjStaReq - cfm: status(%d) reason(%d)\n", rSta.cfm.status, rSta.cfm.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
  ...
  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00360004, PJ_DIAG_NA, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, sts->hdr.elmId.elmnt, 0, 0, 0, "Received StsReq from LM, element = %d"); } }




   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 735); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjStsReq(post, elmId(%d),action(%d))\n", action, sts->hdr.elmId.elmnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 6) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 779); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjMiLpjStsReq - cfm: status(%d) reason(%d)\n", rSts.cfm.status, rSts.cfm.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 1:
      {
         switch(sAction)
         {
            ...
            case 5:
            {
               ...
               (kwCb.init.dbgMask) |= dbgCntrl->dbgMask;
...

{
   ...
   { cmMemcpy((U8*)sts, (U8 *)&(kwCb.pjGenSts), sizeof (PjGenSts)); };
   ...
   if(mBuf != 0L)
   {
     ...
     if(kwCb.trcLen == -1)
     {
            ...
            != 0)
        {
           ...
           do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 6) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 1690); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "\npjLmmSendTrc(): SCpyMsgMsg Failed."); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
     ...
     else if(kwCb.trcLen > 0)
     {
        ...
        {
           do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 6) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 1703); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "\npjLmmSendTrc(): SFndLenMsg Failed."); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
        ...
        if(bufLen < kwCb.trcLen)
        {
           ...
           if (SCpyMsgMsg(mBuf, pst.region, pst.pool, &dstMbuf)
              != 0)
           {
              do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 6) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 1715); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "\npjLmmSendTrc(): SCpyMsgMsg Failed."); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
        ...
        if(bufLen >= kwCb.trcLen)
        {
           ...
           { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&tempBuf, (Size) kwCb.trcLen) == 0) { cmMemset((U8 *)(tempBuf), 0, kwCb.trcLen); } else { (tempBuf) = 0L; } };
# 1740 "../..//lterlcpdcp/kw_pj_lmm.c"
           if (SCpyMsgFix(mBuf,0,kwCb.trcLen,tempBuf,&tempCnt) != 0)
           {
              do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 6) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 1743); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "\npjLmmSendTrc(): SCpyMsgFix Failed."); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
           ...
           {
              do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 6) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 1750); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "\npjLmmSendTrc(): dstMbuf Allocation Failed."); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

              return(1);
           }

           if (SCpyFixMsg(tempBuf,dstMbuf,0,kwCb.trcLen,&tempCnt) != 0)
           {
              do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 6) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 6) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_lmm.c", 1757); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "\npjLmmSendTrc(): SCpyFixMsg Failed."); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

              return(1);
           }


           { if (tempBuf != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) tempBuf, (Size) kwCb.trcLen); tempBuf = 0L; } };
