...
# 100 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm_err.h" 1
# 91 "../..//cm/cm_err.h"
#define __CMERRH__ 
# 105 "../..//cm/cm_err.h"
...
# 119 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//egtpu/eg_dbutl.h" 1
# 183 "../..//egtpu/eg_dbutl.h"
...
#define SEND_HASH_FAIL_ALARM() { EgUsta sta; cmMemset( (U8* )&sta, 0, sizeof(EgUsta)); sta.dgn.dgnVal[0].type = LEG_PAR_GEN; egSendLmAlarm(LCM_CATEGORY_INTERNAL, LCM_EVENT_LYR_SPECIFIC, LCM_CAUSE_HASH_FAIL, &sta.dgn); }
# 118 "../..//egtpu/eg_tunn.h"
#define GET_TUNN_FRM_EVENT(event,teCCb) { if((event->lclTeid.pres != PRSNT_NODEF) || (event->lclTeid.val == 0)) { *teCCb = NULLP; EG_DBG_ERR(EG_DBG_TUNN, 0, (egp, "Message received on a non-existent tunnel.")); event->resultType = EGT_ERR_UNKNOWN_TEID_MSG; egSendErrInd(event, usap); EG_RETVALUE( RFAILED); } else { EgTECCb **teCCbIdx; teCCbIdx = NULLP; teCCbIdx = egGetTunnelCb(event->lclTeid.val); if (teCCbIdx != NULLP) *teCCb = *teCCbIdx; }}
# 121 "../..//egtpu/eg_tunn.c" 2
# 132 "../..//egtpu/eg_tunn.c"
# 1 "../..//cm/gen.x" 1
# 133 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/ssi.x" 1
# 134 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 135 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 136 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 137 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm_mblk.x" 1
# 138 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm_llist.x" 1
# 91 "../..//cm/cm_llist.x"
#define __CMLLISTX__ 
...
# 139 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm5.x" 1
# 140 "../..//egtpu/eg_tunn.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
# 157 "../..//egtpu/eg_tunn.c" 2
# 171 "../..//egtpu/eg_tunn.c"
static S16 egUTunHdlMsgTypeEchoReq ( EgUSapCb *usap, EgtUEvnt *egtUEvnt, EgIpCb *ipCb );
# 2703 "../..//egtpu/eg_tunn.c"
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",2714); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",2722); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 2737 "../..//egtpu/eg_tunn.c"
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",2748); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",2756); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 5148 "../..//egtpu/eg_tunn.c"
 S16 egCpyCmTptAddr
(
CmTptAddr *dst,
CmTptAddr *src
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5159); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
...
# 5180 "../..//egtpu/eg_tunn.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5180); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 5200 "../..//egtpu/eg_tunn.c"
 S16 egUTunnTeidMod
(
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5218); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if (frmDstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5240); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Destination IP not configured"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5241); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(96); };
   }
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5256); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n TEID not configured"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5257); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(98); };
   }
# 5278 "../..//egtpu/eg_tunn.c"
   ...
   if(frmDstCb->teIdLst.nmbEnt == 0)
   {
      ...
      egSendLmAlarm(2, 1,
            (256 + 7), &sta.dgn);
      { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)frmDstCb); cmHashListDeinit(&(frmDstCb->teIdLst)); { if (frmDstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5290); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)frmDstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) frmDstCb, (Size) sizeof(EgDestAddrCb)); (frmDstCb) = 0L; }}; };
   }
   ...
   if (dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &dstCb, (Size) sizeof(EgDestAddrCb)) == 0) { cmMemset((U8 *)(*&dstCb), 0, sizeof(EgDestAddrCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5308); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&dstCb) = 0L; {}; } };
      ...
      if(dstCb == 0L)
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5316); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(97); };
      }
      ...
      if(ret != 0)
      {
         ...
         { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5335); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }};
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5336); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5341); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(97); };
      }
      ...
      if(ret !=0)
      {
         { cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5365); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5366); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5371); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(103); };
      }
   }
   ...
   if(ret !=0)
   {
      ...
      {
         { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5386); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
      }
      { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5388); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5393); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(103); };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5402); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };

}
# 5418 "../..//egtpu/eg_tunn.c"
 S16 egUTunnTeidDel
(
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5442); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 5453 "../..//egtpu/eg_tunn.c"
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.tnlMgmt.dstIpAddr.type; if(egtUEvnt->u.tnlMgmt.dstIpAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.dstIpAddr.u.ipv4TptAddr.address; } };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5466); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  Destination does not exist"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5467); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(96); };
   }
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5484); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n TEID already deleted (%ld)", egtUEvnt->u.tnlMgmt.teId); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



     { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5487); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(98); };
   }
# 5622 "../..//egtpu/eg_tunn.c"
   ...
   { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5651); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};
   ...
   if(dstCb->teIdLst.nmbEnt == 0)
   {
      ...
      { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5670); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
   }

   egCb.genSts.numActvTnls--;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5675); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };

}
# 5692 "../..//egtpu/eg_tunn.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5714); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   dstCb = 0L;
   teidCb = 0L;
   ret = 0;
# 5728 "../..//egtpu/eg_tunn.c"
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.tnlMgmt.dstIpAddr.type; if(egtUEvnt->u.tnlMgmt.dstIpAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.dstIpAddr.u.ipv4TptAddr.address; } };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5740); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid Destination IP"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5741); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(96); };
   }
   ret = cmHashListFind(&(dstCb->teIdLst),
         (U8 *)&(egtUEvnt->u.tnlMgmt.teId),
         sizeof(U32), 0, (U32 *)&teidCb);
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5752); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid Teid"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5753); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(98); };
   }
   ...
   if(!teidCb->reOrdering)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5761); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(99); };
   }
# 5852 "../..//egtpu/eg_tunn.c"
   egFlushAllPackets(teidCb);
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5865); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 5880 "../..//egtpu/eg_tunn.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5896); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5917); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid Destination"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5918); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(96); };
   }
   ret = cmHashListFind(&(dstCb->teIdLst),
         (U8 *)&(egtUEvnt->u.tnlMgmt.teId),
         sizeof(U32), 0, (U32 *)&teidCb);
   ...
   if (teidCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5929); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Invalid TEID"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5930); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(98); };
   }
# 5947 "../..//egtpu/eg_tunn.c"
   if(teidCb->reOrdering)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5949); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5972); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for SeqInfo\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5977); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5983); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for reordering bufer\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",5988); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
# 6002 "../..//egtpu/eg_tunn.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6002); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 6017 "../..//egtpu/eg_tunn.c"
 S16 egUTunnTeidAdd
(
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6033); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   dstCb = 0L;
   teidCb = 0L;
   ret = 0;
# 6046 "../..//egtpu/eg_tunn.c"
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.tnlMgmt.dstIpAddr.type; if(egtUEvnt->u.tnlMgmt.dstIpAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.tnlMgmt.dstIpAddr.u.ipv4TptAddr.address; } };
   ...
   if (dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &dstCb, (Size) sizeof(EgDestAddrCb)) == 0) { cmMemset((U8 *)(*&dstCb), 0, sizeof(EgDestAddrCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6064); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&dstCb) = 0L; {}; } };

      if(dstCb == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6069); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  Memory Allocation for destination failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6073); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(97); };
      }
      ...
      if(ret != 0)
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6093); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  TEID Hash List initialisation failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6094); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }};



         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6098); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(97); };
      }
      ...
      if(ret !=0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6123); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n  Hash List insertion of destination                   CB into Source IP failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


         { cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6124); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };



         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6128); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(103); };
      }
      ...
      if(!egCb.egUCb.echoTmrStarted && egCb.genCfg.echoTmr.enb)
      {
         ...
         if (ret != 0)
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6140); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n  Starting of Echo Timer Failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         }
    else
    {
   ...
   { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &teidCb, (Size) sizeof(EgTeIdCb)) == 0) { cmMemset((U8 *)(*&teidCb), 0, sizeof(EgTeIdCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6152); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&teidCb) = 0L; {}; } };
   ...
   if(teidCb == 0L)
   {
      if(dstCb->teIdLst.nmbEnt == 0)
      {
         ...
         { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6161); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
      }



      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6166); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(97); };
   }
   ...
   if(ret !=0)
   {
      if(dstCb->teIdLst.nmbEnt == 0)
      {
         ...
         { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6204); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
      }
      { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6206); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6211); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(103); };
   }
   ...
   if(teidCb->reOrdering == 1)
   {
      ...
      if(teidCb->seqInfo == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6232); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for reordering bufer\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         cmHashListDelete(&(dstCb->teIdLst), (U32)teidCb);
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6234); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};
         ...
         if(dstCb->teIdLst.nmbEnt == 0)
         {
            ...
            { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6242); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
         }



         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6247); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      if(teidCb->seqInfo->pduArray == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6254); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Cannot allocate memory for reordering bufer\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         cmHashListDelete(&(dstCb->teIdLst), (U32)teidCb);
         { if (teidCb->seqInfo != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6256); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb->seqInfo, (U32)sizeof(SeqInfo) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb->seqInfo, (Size) sizeof(SeqInfo)); (teidCb->seqInfo) = 0L; }};
         { if (teidCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6257); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb, (U32)sizeof(EgTeIdCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb, (Size) sizeof(EgTeIdCb)); (teidCb) = 0L; }};
         ...
         if(dstCb->teIdLst.nmbEnt == 0)
         {
            ...
            { cmHashListDelete(&(ipCb->destAddrCbLst), (U32)dstCb); cmHashListDeinit(&(dstCb->teIdLst)); { if (dstCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6265); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)dstCb, (U32)sizeof(EgDestAddrCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) dstCb, (Size) sizeof(EgDestAddrCb)); (dstCb) = 0L; }}; };
         }




         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6271); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6303); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };

}
# 6320 "../..//egtpu/eg_tunn.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6336); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(ipCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6363); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Source IP not configured"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6380); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
# 6407 "../..//egtpu/eg_tunn.c"
...
# 6457 "../..//egtpu/eg_tunn.c"
         ...
         (egtUEvnt->u.tnlMgmt.action == 2))
   {
      ...
      {
         EgUiEgtEguLclTnlMgmtCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6463); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
      }
   }
# 6492 "../..//egtpu/eg_tunn.c"
   if(ret != 0)
   {
      egtUEvnt->u.tnlMgmt.cfmStatus.status = 1;
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6499); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 6515 "../..//egtpu/eg_tunn.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6535); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
...
# 6578 "../..//egtpu/eg_tunn.c"
   ...
   if(ipCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6587); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if(portInfo == 1)
   {
      ...
      if(srvCb == 0L)
      {
         ...
         EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6606); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
   ...
   else
   {
      ...
      if(dstCb == 0L)
      {
         ...
         EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6640); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      if(dstCb->multicastAddr == 1)
      {
         ...
         EgUiEgtEguStaCfm(&(usap->pst), usap->suId, egtUEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6648); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6666); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };

}
# 6683 "../..//egtpu/eg_tunn.c"
 S16 egUFreeUiEvnt
(
EgtUEvnt *egtUEvnt
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6693); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6700); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6701); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 6719 "../..//egtpu/eg_tunn.c"
static S16 egUTunHdlMsgTypeEchoReq
(
EgUSapCb *usap,
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6737); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   cmMemset((U8 *)&keyAddr, 0 ,sizeof(CmTptAddr));
   { keyAddr.type = egtUEvnt->u.egMsg->remAddr.type; if(egtUEvnt->u.egMsg->remAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = egtUEvnt->u.egMsg->remAddr.u.ipv4TptAddr.address; } };
   ...
   if(dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6760); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6764); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"failed to allocate the memory for egtevnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6765); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }



      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_INV_DST_IP; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6772); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if(dstCb->multicastAddr == 1)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6780); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6784); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6785); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }



      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_DST_MULT_IP; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6792); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }



   { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtUStaEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtUStaEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6797); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtUStaEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtUStaEvnt) = 0L; {}; } };
   if (egtUStaEvnt == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6801); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6802); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   EgUiEgtEguUStaInd (&(usap->pst), usap->suId,
         egtUStaEvnt);
   egUFreeUiEvnt(egtUEvnt);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6822); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 6841 "../..//egtpu/eg_tunn.c"
static S16 egUTunHdlMsgTypeErrInd
(
EgUSapCb *usap,
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6860); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6879); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6883); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6884); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_INV_DST_IP; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6891); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if(dstCb->multicastAddr == 1)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6902); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6906); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6907); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_DST_MULT_IP; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6914); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   *intfType = dstCb->intfType;
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6921); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };


}
# 6940 "../..//egtpu/eg_tunn.c"
static S16 egUTunHdlMsgTypeEndMark
(
EgUSapCb *usap,
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6959); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6977); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6981); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6982); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_INV_DST_IP; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6989); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }



   *intfType = dstCb->intfType;
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",6995); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 7016 "../..//egtpu/eg_tunn.c"
static S16 egUTunHdlMsgType
(
EgUSapCb *usap,
EgtUEvnt *egtUEvnt,
EgIpCb *ipCb,
...
# 7032 "../..//egtpu/eg_tunn.c"
{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7038); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
      ...
      case EGT_GTPU_MSG_ECHO_REQ:
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7054); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      ...
      case EGT_GTPU_MSG_ECHO_RSP:
         {
            ...
            { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7063); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
            if (egtErrEvnt == 0L)
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7067); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

               { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7068); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
            }



            { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_MSG_NOT_ALLWD; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
            egUFreeUiEvnt(egtUEvnt);
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7075); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
            break;
         }
      ...
      case EGT_GTPU_MSG_ERROR_IND:
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7082); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(egUTunHdlMsgTypeErrInd(usap, egtUEvnt, ipCb, intfType)); };
            break;
         }
      case EGT_GTPU_MSG_END_MARKER:
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7091); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(egUTunHdlMsgTypeEndMark(usap, egtUEvnt, ipCb, intfType)); };
            break;
         }
      default:
         {
   ...
   if(dstCb == 0L)
   {
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7117); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7121); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7122); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      { egtErrEvnt->u.errInd.errCause = (EgtErrType)EGT_ERR_INV_DST_IP; egtErrEvnt->u.errInd.localTeid = egtUEvnt->u.egMsg->lclTeid; egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr),&(egtUEvnt->u.egMsg->remAddr)); egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr),&(egtUEvnt->u.egMsg->srcAddr)); egCb.genSts.numErrInd++; EgUiEgtEguErrInd (&(usap->pst), usap->suId, egtErrEvnt); };
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7129); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }

   *maxTPduSize = dstCb->maxTPduSize;

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7134); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 7153 "../..//egtpu/eg_tunn.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7179); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(ipCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7208); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Source IP not configured"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7222); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7226); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7227); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7234); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
# 7276 "../..//egtpu/eg_tunn.c"
   cmHashListFind(&(ipCb->tptServCbLst),
         (U8 *) &(portNum),
         sizeof(U16), 0, (U32 *)&(srvCb));
   ...
   if(srvCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7282); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Server not configured"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7296); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7300); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7302); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      egUFreeUiEvnt(egtUEvnt);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7306); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
# 7350 "../..//egtpu/eg_tunn.c"
   if ((ret = egUTunHdlMsgType(usap, egtUEvnt, ipCb, &intfType, &maxTPduSize)) != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7352); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
...
# 7368 "../..//egtpu/eg_tunn.c"
   ...
   { if (egtUEvnt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7397); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtUEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtUEvnt, (Size) sizeof(EgtUEvnt)); (egtUEvnt) = 0L; }};
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_tunn.c",7411); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
