...
# 100 "../..//x2ap/cz_ex_ms.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//x2ap/cz_ex_ms.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 120 "../..//x2ap/cz_ex_ms.c" 2
# 1 "../..//cm/cm5.x" 1
# 121 "../..//x2ap/cz_ex_ms.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
# 128 "../..//x2ap/cz_ex_ms.c" 2
# 1 "../..//cm/czt_asn.x" 1
# 129 "../..//x2ap/cz_ex_ms.c" 2
# 161 "../..//x2ap/cz_ex_ms.c"
 S16 czActvTsk
(
Pst *pst,
...

{
   ...
   Txt __tapa_fun[255]; sprintf(__tapa_fun,"czActvTsk"); { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","../..//x2ap/cz_ex_ms.c",174, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf," Entering\n"); SPrint(czCb.init.prntBuf); }; ;; } };
# 191 "../..//x2ap/cz_ex_ms.c"
      ...
      case 0x0E:
      {
         switch(pst->event)
         {
            ...
            case 7:
               ...
               break;
            default:
               do { if (czCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","../..//x2ap/cz_ex_ms.c",221, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " [" "\"ERROR\"" "]" ); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, ":"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "Invalid event from Layer Manager: czActvTsk Failed"); SPrint(czCb.init.prntBuf); }; { sprintf (czCb.init.prntBuf, "\n"); SPrint(czCb.init.prntBuf); }; } }while(0);
...
# 305 "../..//x2ap/cz_ex_ms.c"
   ...
   SExitTsk();
   do { if (czCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (czCb.init.prntBuf, " [%s 0x%x:%x]", "LTE-X2AP", czCb.init.ent,czCb.init.inst); SPrint(czCb.init.prntBuf); }; } { { sprintf (czCb.init.prntBuf, " [%s:%d:%s]","../..//x2ap/cz_ex_ms.c",373, __tapa_fun); SPrint(czCb.init.prntBuf); }; } { sprintf (czCb.init.prntBuf, " Exiting\n"); SPrint(czCb.init.prntBuf); }; } return(0); }while(0);
