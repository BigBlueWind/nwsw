...
# 103 "../..//tucl/hi_bdy3.c" 2
# 1 "../..//cm/cm5.h" 1
# 104 "../..//tucl/hi_bdy3.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 125 "../..//tucl/hi_bdy3.c" 2
# 1 "../..//cm/cm5.x" 1
# 126 "../..//tucl/hi_bdy3.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
# 212 "../..//tucl/hi_bdy3.c"
{
   ...
   { U32 _optVal = 1; if (cmInetSetOpt(&fd, 1, 1, (Ptr)&_optVal) != 0) hiCb.errSts.sockSOptErr++;; };
   ...
   if (type == SOCK_STREAM)
      { U32 _optVal = 1; if(cmInetSetOpt(&fd, IPPROTO_TCP, 6, (Ptr)&_optVal) != 0) hiCb.errSts.sockSOptErr++;; };
   ...
   if (tPar && (tPar->type != 0 ))
   {
      ...
      if (ret != 0)
      {
         ...
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 265); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "Could not set socket options\n"); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   if (icmpFilter->type == 4)
   {
      ...
      {
         if (icmpv4Filter->protocol == IPPROTO_RAW)
            conCb->icmpMask |= 0x1;
         else
         {
...

{
   ...
   {
      hdr = &conCb->sap->cfg.hdrInf[(conCb->srvcType >> 4) - 1];
...

{
   ...
   for (; ;)
   {
      ...
      else if (conCb->rxLen > conCb->pendLen)
      {
         ...
         { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 1737); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SSegMsg(mBuf1(%p), idx(%ld), mBuf2(%p))\n", (Ptr)mBuf, conCb->pendLen, (Ptr)tBuf); SPrint((&(hiCb.init))->prntBuf); } };
# 1745 "../..//tucl/hi_bdy3.c"
   ...
   while (qLen)
   {
      ...
      { HiUiHitDatInd(&conCb->sap->uiPsts.uiDatIndPst, conCb->sap->suId, conCb->suConId, tBuf); };
   }
...
# 1830 "../..//tucl/hi_bdy3.c"
{
   ...
   for (; ;)
   {
      ...
      else
      {
         ...
         { if ((&(hiCb.init))->dbgMask & (0x00000001)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 1888); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SSegMsg(mBuf1(%p), idx(%ld), mBuf2(%p))\n", (Ptr)mBuf, conCb->pendLen, (Ptr)tBuf); SPrint((&(hiCb.init))->prntBuf); } };
# 1896 "../..//tucl/hi_bdy3.c"
         ret = SSegMsg(mBuf, (U16)conCb->pendLen, &tBuf);
         if(ret !=0)
         {
   ...
   while (qLen)
   {
      ...
      { extern int g_overused[5]; int drop = 0; int ix; for (ix = 0; ix < 5; ++ix) { if (g_overused[ix]) { drop = 1; SPutMsg((tBuf)); break; } } if (!drop) HiUiHitUDatInd(&conCb->sap->uiPsts.uiUDatIndPst, conCb->sap->suId, conCb->suConId, srcAddr, destAddr, hdrParm, tBuf); };
   }
...
# 2008 "../..//tucl/hi_bdy3.c"
   ...
   { extern int g_overused[5]; int drop = 0; int ix; for (ix = 0; ix < 5; ++ix) { if (g_overused[ix]) { drop = 1; SPutMsg((mBuf)); break; } } if (!drop) HiUiHitUDatInd(&conCb->sap->uiPsts.uiUDatIndPst, conCb->sap->suId, conCb->suConId, &srcAddr, &destAddr, &hdrParm, mBuf); };
...
# 2155 "../..//tucl/hi_bdy3.c"
   ...
   if (ret != 0)
   {
      ...
      { if (pthread_mutex_unlock(&hiCb.icmpLstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 2240); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };;
...
# 2272 "../..//tucl/hi_bdy3.c"
   ...
   { if (pthread_mutex_unlock(&hiCb.icmpLstLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 2395); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };;
...

{
   ...
   { if (pthread_mutex_lock(&conCb->txQLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 2878); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
   ...
   { if (pthread_mutex_unlock(&conCb->txQLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 2921); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   else if (ret != 0)
   {
      hiSendAlarm(3, (256 + 1),
                  (256 + 1), &alInfo);
      { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 2986); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiAcceptTcpCon(): failed to accept connection\n"); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   if((conCb->flag & 0x1)&& (conCb->ipTos != 0xFF))
      {
              ...
              ret = cmInetSetOpt(&fd,IPPROTO_IP, 12, (Void*)&optVal);
              if ( ret != 0 )
              {
   ...
   {
      cmInetClose(&fd);;
      { HiSap *_sap; _sap = newConCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3046); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)newConCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3046); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (newConCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)newConCb->icmpError, newConCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&newConCb->lock); if(newConCb->flag & 0x1) pthread_mutex_destroy(&newConCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)newConCb, sizeof(HiConCb));; newConCb = 0L; };
      return(1);
   }
...

{
   ...
   while (maxCons)
   {
      ...
      if (ret != 0)
      {
         ...
         hiSendAlarm(3, 4,
                     (256 + 11), &alInfo);
         { HiSap *_sap; _sap = newConCb->sap; { if (pthread_mutex_lock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3119); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; cmHashListDelete(&_sap->conCbHlCp, (U32)newConCb); { if (pthread_mutex_unlock(&_sap->conCbHlLock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3119); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } }; if (newConCb->icmpError) SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)newConCb->icmpError, newConCb->numFilters * sizeof(CmIcmpError));; pthread_mutex_destroy(&newConCb->lock); if(newConCb->flag & 0x1) pthread_mutex_destroy(&newConCb->txQLock); SPutSBuf(hiCb.init.region, hiCb.init.pool, (Data *)newConCb, sizeof(HiConCb));; newConCb = 0L; };
         break;
      }
      ...
      if (newConCb->state == 0x1)
         { HiUiHitConInd(&newConCb->sap->uiPsts.uiConIndPst, newConCb->sap->suId, newConCb->suConId, newConCb->spConId, &newConCb->peerAddr); };
   }
...
# 3339 "../..//tucl/hi_bdy3.c"
      ...
      else
      {
         ...
         else
         {
            if (mLen > 0)
            {
               { HiUiHitDatInd(&conCb->sap->uiPsts.uiDatIndPst, conCb->sap->suId, conCb->suConId, mBuf); };
            }
         }
      }
   }
...

{
   ...
   { if (pthread_mutex_lock(&conCb->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3433); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
hiProcTxDone:
   ...
   { if (pthread_mutex_unlock(&conCb->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3530); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...
# 3583 "../..//tucl/hi_bdy3.c"
   ...
   { if (pthread_mutex_lock(&conCb->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 9), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3592); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SLock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
            ...
            || conCb->state == 0x5)
      {
         ...
         if (conCb->sap->resCongStrt == 1)
         {
            ...
            {
               if(conCb->sap->congTimers[numTmr].tmrEvnt == 1)
               {
                  timerRun = 1;
               }
            }
...
# 3661 "../..//tucl/hi_bdy3.c"
   ...
   { if (pthread_mutex_unlock(&conCb->lock) != 0) { HiAlarmInfo _alInfo; _alInfo.type = 0; hiSendAlarm(3, 4, (256 + 10), &_alInfo); { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3668); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "SUnlock() failed\n"); SPrint((&(hiCb.init))->prntBuf); } }; } };
...

{
   ...
   if ((__extension__ ({register char __result; __asm__ __volatile__ ("btl %1,%2 ; setcb %b0" : "=q" (__result) : "r" (((int) ((&fdGrp->servFd)->fd)) % (8 * sizeof (__fd_mask))), "m" (((selRdFdSet)->fds_bits)[(((&fdGrp->servFd)->fd) / (8 * sizeof (__fd_mask)))]) : "cc"); __result; })))
   {
      setFds--;
      __asm__ __volatile__ ("btrl %1,%0" : "=m" (((selRdFdSet)->fds_bits)[(((&fdGrp->servFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&fdGrp->servFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
   ...
   if (fdGrp->procIcmp
       && (__extension__ ({register char __result; __asm__ __volatile__ ("btl %1,%2 ; setcb %b0" : "=q" (__result) : "r" (((int) ((&hiCb.icmpConFd)->fd)) % (8 * sizeof (__fd_mask))), "m" (((selRdFdSet)->fds_bits)[(((&hiCb.icmpConFd)->fd) / (8 * sizeof (__fd_mask)))]) : "cc"); __result; })))
   {
      setFds--;
      __asm__ __volatile__ ("btrl %1,%0" : "=m" (((selRdFdSet)->fds_bits)[(((&hiCb.icmpConFd)->fd) / (8 * sizeof (__fd_mask)))]) : "r" (((int) ((&hiCb.icmpConFd)->fd)) % (8 * sizeof (__fd_mask))) : "cc","memory");
      hiRecvIcmpMsg();
   }
# 3817 "../..//tucl/hi_bdy3.c"
   if (fdGrp->numWrFds)
   {
      ...
      while (setFds)
      {
         ...
         if (ret != 0)
         {
            { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3834); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcFds(): could not find fd in hash list\n"); SPrint((&(hiCb.init))->prntBuf); } };
   ...
   while (setFds)
   {
      ...
      {
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3857); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcFds(): could not get next set fd\n"); SPrint((&(hiCb.init))->prntBuf); } };
      ...
      if (ret != 0)
      {
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3867); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiProcFds(): could not find fd in hash list\n"); SPrint((&(hiCb.init))->prntBuf); } };
...
# 3967 "../..//tucl/hi_bdy3.c"
      ...
      if (ret != 0)
      {
         { if ((&(hiCb.init))->dbgMask & (0x00000100)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_bdy3.c", 3975); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "hiRecvTsk: select() failure\n"); SPrint((&(hiCb.init))->prntBuf); } };
