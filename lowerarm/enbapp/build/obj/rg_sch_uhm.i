...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 120 "../..//ltemac/rg_sch_uhm.c" 2
# 1 "../..//cm/cm5.x" 1
# 121 "../..//ltemac/rg_sch_uhm.c" 2
# 1 "../..//cm/cm_lte.x" 1
# 91 "../..//cm/cm_lte.x"
#define __CM_LTE_X__ 
...
# 134 "../..//ltemac/rg_sch_uhm.c" 2
# 144 "../..//ltemac/rg_sch_uhm.c"
 U8 rgRvIdxTable[] = {0, 3, 1, 2};
 U8 rgRvTable[] = {0, 2, 3 ,1};
# 182 "../..//ltemac/rg_sch_uhm.c"
...

{
   ...
   return(&(ue->ul.hqEnt.hqProcCb[idx]));
}
# 432 "../..//ltemac/rg_sch_uhm.c"
 Void rgSCHUhmNewTx
(
RgSchUlHqProcCb *hqProc,
U8 maxHqRetx,
...
# 566 "../..//ltemac/rg_sch_uhm.c"
 Void rgSCHUhmUpdMsg3Hq
(
...
# 634 "../..//ltemac/rg_sch_uhm.c"
   for(i=0; i < ueCb->ul.hqEnt.numHqPrcs; i++)
   {
      ueCb->ul.hqEnt.hqProcCb[i].procId = i;
      ueCb->ul.hqEnt.hqProcCb[i].ulSfIdx = 0xff;
      ueCb->ul.hqEnt.hqProcCb[i].alloc = 0L;
   }

   return;
}
# 663 "../..//ltemac/rg_sch_uhm.c"
...

{
   ...
   ;;
# 749 "../..//ltemac/rg_sch_uhm.c"
   return;
}
# 772 "../..//ltemac/rg_sch_uhm.c"
   ...
   while (ulAlloc)
   {
      ...
      if(nDmrs != 10)
      {
         if(ulAlloc->hqProc->rcvdCrcInd)
         {
            ...
            rgSCHUtlAddPhich (cellCb, frm, 1, nDmrs, rbStart);

         }

         else
         {
# 867 "../..//ltemac/rg_sch_uhm.c"
            rgSCHUtlAddPhich (cellCb, frm, 0, nDmrs, rbStart);
...

{
   ...
   ueCb->ul.hqEnt.numHqPrcs = 8;
# 926 "../..//ltemac/rg_sch_uhm.c"
   return(0);
}
