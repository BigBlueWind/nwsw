...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 121 "../..//ltemac/rg_sch_lmm.c" 2
# 1 "../..//cm/cm5.x" 1
# 122 "../..//ltemac/rg_sch_lmm.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 269); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmSapCfg(): SAP Config Requested" " for %dth sap of sapType=%d", sapIdx, sapType); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch(sapType)
   {
      case 1 + 2:
         ...
         {
            ret = 13;
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 281); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmSapCfg(): unsupported" " Selector value for RGR."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 1 + 4:
         ...
         {
            ret = 13;
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 315); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmSapCfg(): unsupported" " Selector value for TFU."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 392); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmInstCfg(): Instance " "Configuration Request"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 402); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmInstCfg(): unsupported " "Selector value for lmPst."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 428); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmInstCfg: SGetSBuf for " "RGR saps failed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 439); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmInstCfg: SGetSBuf for TFU " "saps failed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 450); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmInstCfg: SGetSBuf for bind" " confirm responses failed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (SRegCfgTmrMt(rgSchCb[inst].rgSchInit.ent,dInst,(S16)rgSchCb[inst].genCfg.tmrRes,10,schActvTmr) != 0)

   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 478); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmInstCfg(): Failed to " "register timer."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   Inst dInst = inst + 1;
   U8 idx;
# 526 "../..//ltemac/rg_sch_lmm.c"
   ;

   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 529); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmShutdown(): Layer Shutdown " "Requested"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 571 "../..//ltemac/rg_sch_lmm.c"
   ...
   (Void) SDeregCfgTmrMt(rgSchCb[inst].rgSchInit.ent,dInst,(S16)rgSchCb[inst].genCfg.tmrRes,10,schActvTmr);
...

{
   ...
   Inst inst = (cfmPst->srcInst - 1);
   ;

   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 663); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmGenCntrl(): Control Req for " "STGEN"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 712 "../..//ltemac/rg_sch_lmm.c"
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 722); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmGenCntrl(): " "invalid subaction=%d", cntrl->t.cntrl.subAction); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 2:
         ...
         switch(cntrl->t.cntrl.subAction)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 746); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmGenCntrl():" " invalid subaction=%d", cntrl->t.cntrl.subAction); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      default:
         cfm->cfm.status = 1;
         cfm->cfm.reason = 13;
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 758); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmGenCntrl(): invalid" " action=%d", cntrl->t.cntrl.action); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 802); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmSapCntrl(): Control Req for" " SAP (%d)", cntrl->hdr.elmId.elmnt); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 1 + 4:
         ...
         switch(cntrl->t.cntrl.action)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 900); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmSapCntrl(): " "invalid action=%d", cntrl->t.cntrl.action); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 1 + 2:
         ...
         switch(cntrl->t.cntrl.action)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 923); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmSapCntrl(): " "invalid action=%d", cntrl->t.cntrl.action); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   inst = (reqPst->dstInst - 1);

   cfmPst->srcEnt = rgSchCb[inst].rgSchInit.ent;
   cfmPst->srcInst = rgSchCb[inst].rgSchInit.inst + 1;
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1031); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmStartTmr(): Timer start " "request for tmrEvnt=%d, tmrVal=%ld", tmrEvnt, tmrVal); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1094); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmStopTmr(): Timer stop request" " for tmrEvnt=%d",tmrEvnt); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1121); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmStopTmr(): tmrEvnt=%d" " search result is ret=%d",tmrEvnt,ret); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   return(ret);
}
# 1144 "../..//ltemac/rg_sch_lmm.c"
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1163); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmTmrExpiry(): Timer Expired" " for tmrEvnt=%d",tmrEvnt); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch(tmrEvnt)
   {
      case 1:
         ...
         {
            rgSCHLmmStaInd((U8)(tfuSap->sapCfg.sapPst.srcInst - 1),
                           (U16)2, (U16)8,
                           (U16)10, (RgUstaDgn *)0L);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1175); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmTmrExpiry(): Max" " Bind Retries Exceeded."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         }
         else
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1180); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmTmrExpiry(): Retry" " Bind"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


            if (tfuSap->sapCfg.bndTmr.enb == 1)
            {
               ret = rgSCHLmmStartTmr((U8)(tfuSap->sapCfg.sapPst.srcInst - 1),
                                  1,
                                 (U32)tfuSap->sapCfg.bndTmr.val, cb);
            }


            rgSCHUtlTfuBndReq((U8)(tfuSap->sapCfg.sapPst.srcInst - 1),
            tfuSap->sapCfg.suId, tfuSap->sapCfg.spId);
         }
         break;
      default:
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1196); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmTmrExpiry(): Invalid" " tmrEvnt=%d", tmrEvnt); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1246); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmBndCfm(): suId=%d, status=%d," " sapState=%d", suId, status, rgSchCb[inst].tfuSap[suId].sapSta.sapState); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch(status)
   {
      case 1:
         ...
         rgSCHLmmStaInd((U8)(rgSchCb[inst].tfuSap->sapCfg.sapPst.srcInst - 1),
               2, 11,
               256, (RgUstaDgn *)0L);
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1286); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmTmrExpiry(): Max" " Bind Retries Exceeded."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 1344 "../..//ltemac/rg_sch_lmm.c"
{
   RgMngmt usta;

   ;

   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1350); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmStaInd(): category=%d," " event=%d, cause=%d", category, event, cause); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   if(rgSchCb[inst].rgSchInit.usta == 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_lmm.c", 1354); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHLmmStaInd(): USTA Ind " "Disabled."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
