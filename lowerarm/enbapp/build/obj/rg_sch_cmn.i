...
#undef RG_DEBUG
# 1 "<command line>"
#define xRG_PHASE2_SCHED 1
# 1 "<command line>"
#define xRGR_V1 1
# 1 "<command line>"
#define xRG_UL_DELTA 2
# 1 "<command line>"
#undef TFU_UPGRADE
# 1 "../..//ltemac/rg_sch_cmn.c"
# 95 "../..//ltemac/rg_sch_cmn.c"
# 1 "../..//mt/envopt.h" 1
# 94 "../..//mt/envopt.h"
#define __ENVOPTH__ 
# 179 "../..//mt/envopt.h"
...
# 102 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/cm_err.h" 1
# 91 "../..//cm/cm_err.h"
#define __CMERRH__ 
# 105 "../..//cm/cm_err.h"
#define ECMBASE (ERRCM + 0)
#define ECMXXX (ECMBASE)
...
#define ECM005 (ERRCM + 5)
#define ECM006 (ERRCM + 6)
#define ECM007 (ERRCM + 7)
#define ECM008 (ERRCM + 8)
#define ECM009 (ERRCM + 9)
#define ECM010 (ERRCM + 10)
#define ECM011 (ERRCM + 11)
#define ECM012 (ERRCM + 12)
#define ECM013 (ERRCM + 13)
#define ECM014 (ERRCM + 14)
#define ECM015 (ERRCM + 15)
#define ECM016 (ERRCM + 16)
#define ECM017 (ERRCM + 17)
#define ECM018 (ERRCM + 18)
#define ECM019 (ERRCM + 19)
#define ECM020 (ERRCM + 20)
#define ECM021 (ERRCM + 21)
#define ECM022 (ERRCM + 22)
#define ECM023 (ERRCM + 23)
#define ECM024 (ERRCM + 24)
#define ECM025 (ERRCM + 25)
#define ECM026 (ERRCM + 26)
#define ECM027 (ERRCM + 27)
#define ECM028 (ERRCM + 28)
#define ECM029 (ERRCM + 29)
#define ECM030 (ERRCM + 30)
#define ECM031 (ERRCM + 31)
#define ECM032 (ERRCM + 32)
#define ECM033 (ERRCM + 33)
#define ECM034 (ERRCM + 34)
#define ECM035 (ERRCM + 35)
#define ECM036 (ERRCM + 36)


#define ECM037 (ERRCM + 37)
#define ECM038 (ERRCM + 38)
#define ECM039 (ERRCM + 39)
#define ECM040 (ERRCM + 40)
#define ECM041 (ERRCM + 41)
#define ECM042 (ERRCM + 42)
#define ECM043 (ERRCM + 43)
#define ECM044 (ERRCM + 44)
#define ECM045 (ERRCM + 45)
#define ECM046 (ERRCM + 46)
#define ECM047 (ERRCM + 47)
#define ECM048 (ERRCM + 48)
#define ECM049 (ERRCM + 49)
#define ECM050 (ERRCM + 50)
#define ECM051 (ERRCM + 51)
#define ECM052 (ERRCM + 52)
#define ECM053 (ERRCM + 53)
#define ECM054 (ERRCM + 54)
#define ECM055 (ERRCM + 55)
#define ECM056 (ERRCM + 56)
#define ECM057 (ERRCM + 57)
#define ECM058 (ERRCM + 58)
#define ECM059 (ERRCM + 59)
#define ECM060 (ERRCM + 60)
#define ECM061 (ERRCM + 61)
#define ECM062 (ERRCM + 62)
#define ECM063 (ERRCM + 63)
#define ECM064 (ERRCM + 64)
#define ECM065 (ERRCM + 65)
#define ECM066 (ERRCM + 66)
#define ECM067 (ERRCM + 67)
#define ECM068 (ERRCM + 68)
#define ECM069 (ERRCM + 69)
#define ECM070 (ERRCM + 70)
#define ECM071 (ERRCM + 71)
#define ECM072 (ERRCM + 72)
#define ECM073 (ERRCM + 73)
#define ECM074 (ERRCM + 74)
#define ECM075 (ERRCM + 75)
#define ECM076 (ERRCM + 76)
#define ECM077 (ERRCM + 77)
#define ECM078 (ERRCM + 78)
#define ECM079 (ERRCM + 79)
#define ECM080 (ERRCM + 80)
#define ECM081 (ERRCM + 81)
#define ECM082 (ERRCM + 82)
#define ECM083 (ERRCM + 83)
#define ECM084 (ERRCM + 84)
#define ECM085 (ERRCM + 85)
#define ECM086 (ERRCM + 86)
#define ECM087 (ERRCM + 87)
#define ECM088 (ERRCM + 88)
#define ECM089 (ERRCM + 89)
#define ECM090 (ERRCM + 90)
#define ECM091 (ERRCM + 91)
#define ECM092 (ERRCM + 92)
#define ECM093 (ERRCM + 93)
#define ECM094 (ERRCM + 94)
#define ECM095 (ERRCM + 95)
#define ECM096 (ERRCM + 96)
#define ECM097 (ERRCM + 97)
#define ECM098 (ERRCM + 98)
#define ECM099 (ERRCM + 99)
#define ECM100 (ERRCM + 100)
#define ECM101 (ERRCM + 101)
#define ECM102 (ERRCM + 102)
#define ECM103 (ERRCM + 103)
#define ECM104 (ERRCM + 104)
#define ECM105 (ERRCM + 105)
#define ECM106 (ERRCM + 106)
#define ECM107 (ERRCM + 107)
#define ECM108 (ERRCM + 108)
#define ECM109 (ERRCM + 109)
#define ECM110 (ERRCM + 110)
#define ECM111 (ERRCM + 111)
#define ECM112 (ERRCM + 112)
#define ECM113 (ERRCM + 113)
#define ECM114 (ERRCM + 114)
#define ECM115 (ERRCM + 115)
#define ECM116 (ERRCM + 116)
#define ECM117 (ERRCM + 117)
#define ECM118 (ERRCM + 118)
#define ECM119 (ERRCM + 119)
#define ECM120 (ERRCM + 120)
#define ECM121 (ERRCM + 121)
#define ECM122 (ERRCM + 122)
#define ECM123 (ERRCM + 123)
#define ECM124 (ERRCM + 124)
#define ECM125 (ERRCM + 125)
#define ECM126 (ERRCM + 126)
#define ECM127 (ERRCM + 127)
#define ECM128 (ERRCM + 128)
#define ECM129 (ERRCM + 129)
#define ECM130 (ERRCM + 130)
#define ECM131 (ERRCM + 131)
#define ECM132 (ERRCM + 132)
#define ECM133 (ERRCM + 133)
#define ECM134 (ERRCM + 134)
#define ECM135 (ERRCM + 135)
#define ECM136 (ERRCM + 136)
#define ECM137 (ERRCM + 137)
#define ECM138 (ERRCM + 138)
#define ECM139 (ERRCM + 139)
#define ECM140 (ERRCM + 140)
#define ECM141 (ERRCM + 141)
#define ECM142 (ERRCM + 142)
#define ECM143 (ERRCM + 143)
#define ECM144 (ERRCM + 144)
#define ECM145 (ERRCM + 145)
#define ECM146 (ERRCM + 146)
#define ECM147 (ERRCM + 147)
#define ECM148 (ERRCM + 148)
#define ECM149 (ERRCM + 149)
#define ECM150 (ERRCM + 150)
#define ECM151 (ERRCM + 151)
#define ECM152 (ERRCM + 152)
#define ECM153 (ERRCM + 153)
#define ECM154 (ERRCM + 154)
#define ECM155 (ERRCM + 155)
#define ECM156 (ERRCM + 156)
#define ECM157 (ERRCM + 157)
#define ECM158 (ERRCM + 158)
#define ECM159 (ERRCM + 159)
#define ECM160 (ERRCM + 160)
#define ECM161 (ERRCM + 161)
#define ECM162 (ERRCM + 162)
#define ECM163 (ERRCM + 163)
#define ECM164 (ERRCM + 164)
#define ECM165 (ERRCM + 165)
#define ECM166 (ERRCM + 166)
#define ECM167 (ERRCM + 167)
#define ECM168 (ERRCM + 168)
#define ECM169 (ERRCM + 169)
#define ECM170 (ERRCM + 170)
#define ECM171 (ERRCM + 171)
#define ECM172 (ERRCM + 172)
#define ECM173 (ERRCM + 173)
#define ECM174 (ERRCM + 174)
#define ECM175 (ERRCM + 175)
#define ECM176 (ERRCM + 176)
# 103 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/cm_lte.h" 1
# 91 "../..//cm/cm_lte.h"
#define __CM_LTE_H__ 
# 101 "../..//cm/cm_lte.h"
...
#define CM_LTE_SRB 0
#define CM_LTE_DRB 1
# 104 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/cm5.h" 1
# 105 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/lrg.h" 1
# 102 "../..//cm/lrg.h"
#define __LRGH__ 
...
# 107 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/tfu.h" 1
# 94 "../..//cm/tfu.h"
#define __TFU_H__ 
# 107 "../..//cm/tfu.h"
#define TFU_BLKSZ 1500
# 116 "../..//cm/tfu.h"
#define TFU_MAX_RAPID_IN_SUBFRAME 64
#define TFU_MAX_UL_SUBBAND 110
#define TFU_MAX_DL_SUBBAND 110
...
#define TFU_MAX_M 4
#define TFU_MAX_2BIT_TPC 16
#define TFU_MAX_1BIT_TPC 32
...
#define TFU_MAX_MEMBLK_SIZE 1500


#define TFU_UBNDREQ_MNGMT 1


#define EVTTFUBNDREQ 1
#define EVTTFUBNDCFM 2
#define EVTTFUUBNDREQ 3
#define EVTTFUSCHBNDREQ 4
#define EVTTFUSCHBNDCFM 5
#define EVTTFUSCHUBNDREQ 6
#define EVTTFURAREQIND 7
#define EVTTFURECPREQ 8
#define EVTTFUULCQIIND 9
#define EVTTFUHQIND 10
#define EVTTFUDLCQIIND 11
#define EVTTFUSRIND 12
#define EVTTFUDATIND 13
#define EVTTFUCRCIND 14
#define EVTTFUTIMINGADVIND 15
#define EVTTFUDATREQ 16
#define EVTTFUTTIIND 17
#define EVTTFUSCHTTIIND 18
#define EVTTFUCNTRLREQ 19
#define EVTTFUPUCCHDELPWR 20
# 175 "../..//cm/tfu.h"
#define TFU_SEL_TC 1
#define TFU_SEL_LC 0
#define TFU_SEL_LWLC 2
...
#define ETFU001 (ERRTFU + 1)
#define ETFU002 (ERRTFU + 2)
#define ETFU003 (ERRTFU + 3)
#define ETFU004 (ERRTFU + 4)
#define ETFU005 (ERRTFU + 5)
#define ETFU006 (ERRTFU + 6)
#define ETFU007 (ERRTFU + 7)
#define ETFU008 (ERRTFU + 8)
#define ETFU009 (ERRTFU + 9)
#define ETFU010 (ERRTFU + 10)
#define ETFU011 (ERRTFU + 11)
#define ETFU012 (ERRTFU + 12)
#define ETFU013 (ERRTFU + 13)
#define ETFU014 (ERRTFU + 14)
#define ETFU015 (ERRTFU + 15)
#define ETFU016 (ERRTFU + 16)
#define ETFU017 (ERRTFU + 17)
#define ETFU018 (ERRTFU + 18)
#define ETFU019 (ERRTFU + 19)
#define ETFU020 (ERRTFU + 20)
#define ETFU021 (ERRTFU + 21)
#define ETFU022 (ERRTFU + 22)
#define ETFU023 (ERRTFU + 23)
#define ETFU024 (ERRTFU + 24)
#define ETFU025 (ERRTFU + 25)
#define ETFU026 (ERRTFU + 26)
#define ETFU027 (ERRTFU + 27)
#define ETFU028 (ERRTFU + 28)
#define ETFU029 (ERRTFU + 29)
#define ETFU030 (ERRTFU + 30)
#define ETFU031 (ERRTFU + 31)
#define ETFU032 (ERRTFU + 32)
#define ETFU033 (ERRTFU + 33)
#define ETFU034 (ERRTFU + 34)
#define ETFU035 (ERRTFU + 35)
#define ETFU036 (ERRTFU + 36)
#define ETFU037 (ERRTFU + 37)
#define ETFU038 (ERRTFU + 38)
#define ETFU039 (ERRTFU + 39)
#define ETFU040 (ERRTFU + 40)
#define ETFU041 (ERRTFU + 41)
#define ETFU042 (ERRTFU + 42)
#define ETFU043 (ERRTFU + 43)
#define ETFU044 (ERRTFU + 44)
#define ETFU045 (ERRTFU + 45)
#define ETFU046 (ERRTFU + 46)
#define ETFU047 (ERRTFU + 47)
#define ETFU048 (ERRTFU + 48)
#define ETFU049 (ERRTFU + 49)
#define ETFU050 (ERRTFU + 50)
#define ETFU051 (ERRTFU + 51)
#define ETFU052 (ERRTFU + 52)
#define ETFU053 (ERRTFU + 53)
#define ETFU054 (ERRTFU + 54)
#define ETFU055 (ERRTFU + 55)
#define ETFU056 (ERRTFU + 56)
#define ETFU057 (ERRTFU + 57)
#define ETFU058 (ERRTFU + 58)
#define ETFU059 (ERRTFU + 59)
#define ETFU060 (ERRTFU + 60)
#define ETFU061 (ERRTFU + 61)
#define ETFU062 (ERRTFU + 62)
#define ETFU063 (ERRTFU + 63)
#define ETFU064 (ERRTFU + 64)
#define ETFU065 (ERRTFU + 65)
#define ETFU066 (ERRTFU + 66)
#define ETFU067 (ERRTFU + 67)
#define ETFU068 (ERRTFU + 68)
#define ETFU069 (ERRTFU + 69)
#define ETFU070 (ERRTFU + 70)
#define ETFU071 (ERRTFU + 71)
#define ETFU072 (ERRTFU + 72)
#define ETFU073 (ERRTFU + 73)
#define ETFU074 (ERRTFU + 74)
#define ETFU075 (ERRTFU + 75)
#define ETFU076 (ERRTFU + 76)
#define ETFU077 (ERRTFU + 77)
#define ETFU078 (ERRTFU + 78)
#define ETFU079 (ERRTFU + 79)
#define ETFU080 (ERRTFU + 80)
#define ETFU081 (ERRTFU + 81)
#define ETFU082 (ERRTFU + 82)
#define ETFU083 (ERRTFU + 83)
#define ETFU084 (ERRTFU + 84)
#define ETFU085 (ERRTFU + 85)
#define ETFU086 (ERRTFU + 86)
#define ETFU087 (ERRTFU + 87)
#define ETFU088 (ERRTFU + 88)
#define ETFU089 (ERRTFU + 89)
#define ETFU090 (ERRTFU + 90)
#define ETFU091 (ERRTFU + 91)
#define ETFU092 (ERRTFU + 92)
#define ETFU093 (ERRTFU + 93)
#define ETFU094 (ERRTFU + 94)
#define ETFU095 (ERRTFU + 95)
#define ETFU096 (ERRTFU + 96)
#define ETFU097 (ERRTFU + 97)
#define ETFU098 (ERRTFU + 98)
#define ETFU099 (ERRTFU + 99)
#define ETFU100 (ERRTFU + 100)
#define ETFU101 (ERRTFU + 101)
#define ETFU102 (ERRTFU + 102)
#define ETFU103 (ERRTFU + 103)
#define ETFU104 (ERRTFU + 104)
#define ETFU105 (ERRTFU + 105)
#define ETFU106 (ERRTFU + 106)
#define ETFU107 (ERRTFU + 107)
#define ETFU108 (ERRTFU + 108)
#define ETFU109 (ERRTFU + 109)
#define ETFU110 (ERRTFU + 110)
#define ETFU111 (ERRTFU + 111)
#define ETFU112 (ERRTFU + 112)
#define ETFU113 (ERRTFU + 113)
#define ETFU114 (ERRTFU + 114)
#define ETFU115 (ERRTFU + 115)
#define ETFU116 (ERRTFU + 116)
#define ETFU117 (ERRTFU + 117)
#define ETFU118 (ERRTFU + 118)
#define ETFU119 (ERRTFU + 119)
#define ETFU120 (ERRTFU + 120)
#define ETFU121 (ERRTFU + 121)
#define ETFU122 (ERRTFU + 122)
#define ETFU123 (ERRTFU + 123)
#define ETFU124 (ERRTFU + 124)
#define ETFU125 (ERRTFU + 125)
#define ETFU126 (ERRTFU + 126)
#define ETFU127 (ERRTFU + 127)
#define ETFU128 (ERRTFU + 128)
# 108 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//ltemac/rg_env.h" 1
# 103 "../..//ltemac/rg_env.h"
#define __RGENVH__ 
...
#define RG_SCH_CMN_DL_DELTA RG_DL_DELTA
...
# 109 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//ltemac/rg_sch_err.h" 1
# 99 "../..//ltemac/rg_sch_err.h"
...
#define RGSCHLOGERROR(_inst,errCls,errCode,errVal,errDesc) SLogError(rgSchCb[_inst].rgSchInit.ent, rgSchCb[_inst].rgSchInit.inst, rgSchCb[_inst].rgSchInit.procId, (Txt *) __FILE__, (S32) __LINE__, (ErrCls) (errCls), (ErrCode) (errCode), (ErrVal) (errVal), (Txt *) errDesc)
# 122 "../..//ltemac/rg_sch_err.h"
#define ERGBASE 0

#define ERGXXX (ERGBASE + 0)
#define ERRRG (ERGBASE + 0)

#define RGSCHERR_NONE ERGBASE

#define ERG001 (ERRRG + 1)
#define ERG002 (ERRRG + 2)
#define ERG003 (ERRRG + 3)
#define ERG004 (ERRRG + 4)
#define ERG005 (ERRRG + 5)
#define ERG006 (ERRRG + 6)
#define ERG007 (ERRRG + 7)
#define ERG008 (ERRRG + 8)
#define ERG009 (ERRRG + 9)
#define ERG010 (ERRRG + 10)

#define ERG011 (ERRRG + 11)

#define ERG012 (ERRRG + 12)

#define ERG013 (ERRRG + 13)
#define ERG014 (ERRRG + 14)

#define ERG015 (ERRRG + 15)
#define ERG016 (ERRRG + 16)
#define ERG017 (ERRRG + 17)
#define ERG018 (ERRRG + 18)
#define ERG019 (ERRRG + 19)
#define ERG020 (ERRRG + 20)
#define ERG021 (ERRRG + 21)
#define ERG022 (ERRRG + 22)
...
# 110 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//ltemac/rg_sch_inf.h" 1
# 90 "../..//ltemac/rg_sch_inf.h"
#define __GKSCH_H__ 
...
#define RGSCH_DL_BW_PERCNT_HIKE 40

#define RGSCH_MAX_NUM_DED_LC 10
#define RGSCH_MAX_NUM_CMN_LC 5

#define RGSCH_MAX_LCG_PER_UE 4
#define RGSCH_CON_RES_ID_SZ 6
#define RGSCH_DELTA_MAC_PHY 1



#define RGSCH_MAX_RA_RNTI 10

#define RGSCH_MAX_CMN_LC_BUF RGSCH_DELTA_MAC_PHY

#define RGSCH_MAX_RAPID 64
...
#define RGSCH_TQ_SIZE 100
#define RGSCH_MAX_TIMER RGSCH_MAX_LOWERSAP
#define RGSCH_NMB_CELL_HASHBIN 10

#define RGSCH_NMB_UE_HASHBIN 10

#define RGSCH_BNDREQ_TMR 1
#define RGSCH_MAX_BNDRETRY 2


#define RGSCH_UE_TQ_SIZE 10

#define RGSCH_INVALID_SCHD_TYPE 255
#define RGSCH_MAX_UE_PER_CELL 0xFFFF

#define RGSCH_MAX_UE_BIN_PER_CELL 128
#define RGSCH_MIN_DL_BW 6
#define RGSCH_MAX_DL_BW 110
#define RGSCH_MIN_UL_BW 6
#define RGSCH_MAX_UL_BW 110

#define RGSCH_NUM_SC_IN_RB 12
#define RGSCH_NUM_PBCH_SYM 4
#define RGSCH_NUM_PSS_SSS_SYM 2
#define RGSCH_NUM_CELL_RS_ONE_ANT_PORT 8
#define RGSCH_NUM_CELL_RS_TWO_ANT_PORT 16
#define RGSCH_NUM_CELL_RS_FOUR_ANT_PORT 24
#define RGSCH_TOT_NUM_SYM_NORCP 168
#define RGSCH_TOT_NUM_SYM_EXTCP 144


#define RGSCH_MIN_CFI_VAL 1
#define RGSCH_MAX_CFI_VAL 3
#define RGSCH_QM_BPSK 2
#define RGSCH_QM_QPSK 4
#define RGSCH_QM_64QAM 6
#define RGSCH_MIN_SRS_SFCFG_IDX 0

#define RGSCH_MAX_SRS_SFCFG_IDX 15

#define RGSCH_MAX_SRS_TX_OFFSET 8





#define RGSCH_MIN_MAC_RNTI 11
...
#define RGSCH_MAX_GRP_PWR_FMT3_IDX 15
#define RGSCH_MAX_GRP_PWR_FMT3A_IDX 31
...
#define RGSCH_PUCCH_MAXVAL_CS 7
#define RGSCH_PUCCH_MINVAL_DS 1
#define RGSCH_PUCCH_MAXVAL_DS 3
...
#define RGSCH_MAX_RA_PREAMBLE_FMT 3

#define RGSCH_MAX_RA_WINSIZE 10

#define RGSCH_MIN_RA_WINSIZE 2

#define RGSCH_MIN_NUM_RA_PREAMBLE 4

#define RGSCH_MAX_NUM_RA_PREAMBLE 64

#define RGSCH_NUM_RA_RB 6

#define RGSCH_MAX_UL_RB 110
...
#define RGSCH_RGR_CFG 1


#define RGSCH_MIN_MSG3_GRNT_SZ 7
...
#define RGSCH_CALC_SF_DIFF(_time1,_time2) (_time1.sfn*10+_time1.subframe) < (_time2.sfn*10+_time2.subframe)? ((_time1.sfn+RGSCH_MAX_SFN)*10+_time1.subframe) - (_time2.sfn*10+_time2.subframe) : (_time1.sfn*10+_time1.subframe) - (_time2.sfn*10+_time2.subframe)





#define RGSCHADDTOCRNTTIME(crntTime,toFill,incr) if ((crntTime.subframe + (incr)) >= RGSCH_NUM_SUB_FRAMES) toFill.sfn = (crntTime.sfn + (crntTime.subframe + (incr))/RGSCH_NUM_SUB_FRAMES) % RGSCH_MAX_SFN; else toFill.sfn = crntTime.sfn; toFill.subframe = (crntTime.subframe + (incr)) % RGSCH_NUM_SUB_FRAMES;
# 351 "../..//ltemac/rg_sch.h"
#define RGSCHDECRFRMCRNTTIME(_crntDl,_prevDl,decr) do { S32 _subframe; _subframe = _crntDl.sfn * RGSCH_NUM_SUB_FRAMES + _crntDl.subframe; _subframe = _subframe - decr; if(_subframe < 0) { _subframe = (RGSCH_MAX_SFN * RGSCH_NUM_SUB_FRAMES) + _subframe; } _prevDl.sfn = _subframe / RGSCH_NUM_SUB_FRAMES; _prevDl.subframe = _subframe % RGSCH_NUM_SUB_FRAMES; } while(0)
# 367 "../..//ltemac/rg_sch.h"
#define RGSCHSUBFRMCRNTTIME(crntTime,toFill,dcr) { if (crntTime.sfn == 0) { if ((crntTime.subframe - (dcr)) < 0) { toFill.sfn = RGSCH_MAX_SFN - 1; } else { toFill.sfn = crntTime.sfn; } } else { if ((crntTime.subframe - (dcr)) < 0) { toFill.sfn = crntTime.sfn - 1; } else toFill.sfn = crntTime.sfn; } toFill.subframe = (RGSCH_NUM_SUB_FRAMES + crntTime.subframe - (dcr)) % (RGSCH_NUM_SUB_FRAMES); }
# 392 "../..//ltemac/rg_sch.h"
#define RGSCHCPYTIMEINFO(src,dst) dst.sfn = src.sfn; dst.subframe = src.subframe;
...
#define RGSCHDBGPRM(inst,_args) DBGP(&rgSchCb[inst].rgSchInit, RGSCHLAYERNAME, DBGMASK_PRM, _args)

#define RGSCHDBGERR(inst,_args) DBGP(&rgSchCb[inst].rgSchInit, RGSCHLAYERNAME, DBGMASK_ERR, _args)

#define RGSCHDBGINFO(inst,_args) DBGP(&rgSchCb[inst].rgSchInit, RGSCHLAYERNAME, DBGMASK_INFO, _args)
# 452 "../..//ltemac/rg_sch.h"
#define RGSCH_FREE_MSG(_buf) { if (NULLP != (_buf)) { SPutMsg((_buf)); _buf = NULLP; } }
# 475 "../..//ltemac/rg_sch.h"
#define RGSCH_DROP_RGUDDATREQ_MBUF(_datReq) { U32 idx1,idx2,idx; if (_datReq != NULLP) { for (idx=0; idx < _datReq->numLch; idx++) { for (idx1=0; idx1 < RGU_MAX_PDUSET; idx1++) { for (idx2=0; idx2 < _datReq->lchData[idx].pdu[idx1].numPdu; idx2++) { RGSCH_FREE_MSG(_datReq->lchData[idx].pdu[idx1].mBuf[idx2]); } } } }}
# 506 "../..//ltemac/rg_sch.h"
#define RGSCH_DROP_RGUCDATREQ_MBUF(_datReq) { U32 idx1; if (_datReq != NULLP) { for (idx1 = 0; idx1 < RGU_MAX_PDUSET; idx1++) { if (_datReq->pdu != NULLP) { RGSCH_FREE_MSG(_datReq->pdu[idx1]); } } }}
# 523 "../..//ltemac/rg_sch.h"
...
#define RGSCH_INCR_SUB_FRAME(x,y) do { if ((x.subframe += y) > 9) { RGSCH_INCR_FRAME(x.sfn); x.subframe -= 10; }} while(0)
...
#define RG_SCH_TMR_ACKNACK_REP 1
#define RG_SCH_TMR_MEASGAP 2
#define RG_SCH_TMR_UL_ACKNACK 3
#define RG_SCH_TMR_DL_ACKNACK 4
#define RG_SCH_TMR_UL_MEASGAP 5
#define RG_SCH_TMR_DL_MEASGAP 6
#define RG_SCH_TMR_TA 7




#define RG_SCH_TMR_BSR 8



#define RG_SCH_TMR_DLINACTV 2
#define RG_SCH_MEAS_GAP_LEN 6
# 825 "../..//ltemac/rg_sch.h"
#define RG_SCH_DRX_WILL_UE_RPRT_CQI(_ue,_res) do{ _res = TRUE; }while(0)
# 834 "../..//ltemac/rg_sch.h"
...
#define RGSCH_SI_DFLT 0
#define RGSCH_SI_SICFG_UPD (1<<0)
#define RGSCH_SI_MIB_UPD (1<<1)
#define RGSCH_SI_SIB1_UPD (1<<2)
#define RGSCH_SI_SI_UPD (1<<3)

#define RGSCH_MIB_PERIODICITY 4
#define RGSCH_SIB1_PERIODICITY 8
#define RGSCH_SIB1_RPT_PERIODICITY 2
#define RGSCH_MIB_TX_SF_NUM 0
#define RGSCH_SIB1_TX_SF_NUM 5

#define RGSCH_SI_SIID_LOWER_LMT 1

#define RGSCHCHKNUPDSIPDU(_CRNTINFO,_NEWINFO,_NEWPDU,_BITMSK,_BITFLG) do{ if(NULLP == _CRNTINFO) { _CRNTINFO = _NEWPDU; } else { if(NULLP != _NEWINFO) { SPutMsg(_NEWINFO); _NEWINFO = NULLP; } _NEWINFO = _NEWPDU; _BITMSK |= _BITFLG; }}while(0)
# 873 "../..//ltemac/rg_sch.h"
#define RGSCH_SET_SI_INFO(_CRNTPTR,_NEWPTR) do{ if(NULLP != _CRNTPTR) SPutMsg(_CRNTPTR); _CRNTPTR = _NEWPTR; _NEWPTR = NULLP;}while(0)
# 1275 "../..//ltemac/rg_sch.h"
#define RG_SCH_IS_PAPRSNT(_ue) ((_ue)->pA.pres == TRUE)


#define RG_SCH_UE_CFG_ISPAPRSNT(_info) ((_info).pAPrsnt == TRUE)
# 112 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//ltemac/rg_sch_cmn.h" 1
# 90 "../..//ltemac/rg_sch_cmn.h"
#define __RGSCHCMNH__ 
# 101 "../..//ltemac/rg_sch_cmn.h"
...
#define RG_SCH_CMN_IS_UL_UE_RETX(ue) ((&(ue)->ul.hqEnt.hqProcCb[ ((RgSchCmnCell *)(ue->cell->sc.sch))->ul.schdHqProcIdx])->alloc)
# 139 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_IS_UE_SCHDLD(ue) (ue->dl.dlAllocCb.reqLnk.node != NULLP)


#define RG_SCH_CMN_PROC_SLCTD_FOR_RETX(proc) ((proc->tbInfo[0].txCntr | proc->tbInfo[1].txCntr))
...
#define RG_SCH_CMN_DL_SVC_IS_GBR(svc) ((((RgSchCmnDlSvc*)(svc->sch))->prio >= RG_SCH_CMN_DL_GBR_PRIO_START) && (((RgSchCmnDlSvc*)(svc->sch))->prio <= RG_SCH_CMN_DL_GBR_PRIO_END))
# 164 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_CQI_TO_PDSCH_EFF_CFI0 {207, 271, 333, 431, 648, 899, 1161, 1482, 1889, 2103, 2905, 3412, 3956, 4474, 4655, 5397}




#define RG_SCH_CMN_CQI_TO_PDSCH_EFF_CFI1 {178, 222, 296, 364, 577, 856, 1125, 1411, 1833, 2460, 2612, 3453, 4026, 4595, 5090, 5902}




#define RG_SCH_CMN_CQI_TO_PDSCH_EFF_CFI2 {175, 255, 326, 400, 636, 944, 1240, 1556, 2021, 2536, 2881, 3504, 4116, 4772, 5398, 5616}




#define RG_SCH_CMN_CQI_TO_PDSCH_EFF_CFI3 {208, 295, 362, 446, 708, 869, 1207, 1734, 1991, 2540, 3212, 3561, 4248, 4590, 5322, 5653}
...
#define RG_SCH_CMN_CQI_TO_PDCCH_EFF { 400, 100, 150, 200, 250, 280, 340, 365, 380, 400, 500, 600, 700, 800, 900, 1000}




#define RG_SCH_CMN_2LYR_CQI_TO_PDSCH_EFF_CFI0 {188, 226, 309, 366, 412, 539, 662, 859, 1052, 1293, 1535, 2585, 2957, 3340, 4775, 5300}




#define RG_SCH_CMN_2LYR_CQI_TO_PDSCH_EFF_CFI1 {197, 232, 306, 322, 408, 450, 588, 723, 938, 1150, 1413, 1679, 2826, 3233, 5222, 5796}




#define RG_SCH_CMN_2LYR_CQI_TO_PDSCH_EFF_CFI2 {166, 207, 233, 307, 343, 408, 422, 495, 586, 648, 797, 1035, 1268, 1558, 3117, 3567}




#define RG_SCH_CMN_2LYR_CQI_TO_PDSCH_EFF_CFI3 {177, 200, 221, 287, 323, 386, 433, 497, 522, 676, 722, 888, 1153, 1413, 1737, 3476}



#define RG_SCH_CMN_SET_FORCE_TD(_ue,_event) { RgSchCmnDlUe *_ueDl = RG_SCH_CMN_GET_DL_UE((_ue)); _ueDl->mimoInfo.forceTD |= (_event); }




#define RG_SCH_CMN_UNSET_FORCE_TD(_ue,_event) { RgSchCmnDlUe *_ueDl = RG_SCH_CMN_GET_DL_UE((_ue)); _ueDl->mimoInfo.forceTD &= ~(_event); }




#define RG_SCH_CMN_INIT_FORCE_TD(_ue,_val) { RgSchCmnDlUe *_ueDl = RG_SCH_CMN_GET_DL_UE((_ue)); _ueDl->mimoInfo.forceTD = (_val); }





#define RG_SCH_CMN_TBS_TO_MCS(x,y) do { if (x <= 9) y = x; else if (x <= 15) y = x + 1; else y = x + 2;} while(0)
...
#define RG_SCH_CMN_MCS_TO_TBS(x,y) do { if (x <= 9) y = x; else if (x <= 16) y = x - 1; else y = x - 2; }while(0)
...
#define RG_SCH_CMN_UE_IDLE_THRSLD(ue) ((ue->dl.taCb.cfgTaTmr > 0)? (RG_SCH_CMN_UE_IDLETIME_FCTR * ue->dl.taCb.cfgTaTmr) : (RG_SCH_CMN_UE_IDLETIME_FCTR * RG_SCH_CMN_DFLT_TATMR))
...
#define RG_SCH_CMN_SVC_IS_GBR(svc) ((((RgSchCmnDlSvc*)(svc->sch))->prio >= RG_SCH_CMN_DL_GBR_PRIO_START) && (((RgSchCmnDlSvc*)(svc->sch))->prio <= RG_SCH_CMN_DL_GBR_PRIO_END))


#define RG_SCH_CMN_SVC_IS_AMBR(svc) ((((RgSchCmnDlSvc*)(svc->sch))->prio > RG_SCH_CMN_DL_GBR_PRIO_END) && (((RgSchCmnDlSvc*)(svc->sch))->prio <= RG_SCH_CMN_MAX_PRIO))


#define RG_SCH_CMN_TBS_TO_MODODR(x,y) do { if (x <= 9) y = 2; else if (x <= 15) y = 4; else y = 6;} while(0)
...
#define RG_SCH_UL_MCS_TO_MODODR(x,y) do { y = (TfuModScheme)rgUlIMcsTbl[x].qm;} while(0)



#define RG_SCH_CMN_ITBS_TO_RETX_IMCS(iTbs,iMcs) do { if ((iTbs) <= 9) (iMcs) = 29; else if ((iTbs) <= 15) (iMcs) = 30; else (iMcs) = 31;} while(0)
# 293 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_GET_MCS_FOR_RETX(tb,retxMcs) do { if ((tb->isAckNackDtx == TFU_HQFDB_DTX)) { retxMcs = tb->dlGrnt.iMcs; } else { if (tb->dlGrnt.iMcs < 29) { U8 _iTbs; RG_SCH_CMN_MCS_TO_TBS(tb->dlGrnt.iMcs, _iTbs); RG_SCH_CMN_ITBS_TO_RETX_IMCS(_iTbs, retxMcs); } else { retxMcs = tb->dlGrnt.iMcs; } }}while(0)
# 310 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_TBS_TO_MCS_DTX(proc,iTbs,imcs) do { if ((proc->isAckNackDtx == TFU_HQFDB_DTX)) { RG_SCH_CMN_TBS_TO_MCS(iTbs, imcs); } else { RG_SCH_CMN_ITBS_TO_RETX_IMCS(iTbs, imcs); } }while(0)
# 320 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_UL_IS_CQI_VALID(cqi) ((cqi) > 0 && (cqi) < RG_SCH_CMN_UL_NUM_CQI)


#define RG_SCH_CMN_DL_GET_HDR_EST(svc,hdrEst) do { hdrEst = svc->estRlcHdrSz; hdrEst += RG_SCH_CMN_DED_MAX_HDRSIZE * RG_SCH_CMN_MAX_DED_SDU; if (svc->staPduPrsnt) { hdrEst += RG_SCH_CMN_DED_MAX_HDRSIZE; }} while(0)
# 337 "../..//ltemac/rg_sch_cmn.h"
...
#define RG_SCH_CMN_REFRESH_TIME 100
...
#define RG_SCH_CMN_IS_RI_VALID(ri) (ri >= RG_SCH_CMN_MIN_RI && ri <= RG_SCH_CMN_MAX_RI)



#define RGSCHCMNADDTOCRNTTIME(crntTime,toFill,incr) if ((crntTime.subframe + incr) > (RGSCH_NUM_SUB_FRAMES - 1)) toFill.sfn = (crntTime.sfn + 1) % RGSCH_MAX_SFN; else toFill.sfn = crntTime.sfn; toFill.subframe = (crntTime.subframe + incr) % RGSCH_NUM_SUB_FRAMES;
...
#define RG_SCH_CMN_DECR_FRAME(_x,_y) { S16 _tmpNo = (_x) - (_y); if(_tmpNo < 0) { (_x) = _tmpNo + RGSCH_MAX_SFN; } else { (_x) = _tmpNo; }}
# 455 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_MAX_MSG3_IMCS 15


#define RG_SCH_CMN_AN_FDBK_TBLSZ_INIT(cell) { switch(RG_SCH_CMN_DL_DELTA) { case 1: case 2: case 3: rgSchTddANFdbkMapTbl[cell->ulDlCfgIdx] += 1; break; default: break; } }
# 471 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_CALC_RARSPLST_SIZE(cell,raArrsz) { S16 _sfNum=0; for(_sfNum=RGSCH_NUM_SUB_FRAMES-1; _sfNum >= 0; _sfNum--) { if(rgSchTddUlDlSubfrmTbl[(cell)->ulDlCfgIdx][_sfNum] == RG_SCH_TDD_UL_SUBFRAME) { break; } } (raArrSz) = (_sfNum + ((RgSchCmnCell *)(cell)->sc.sch)->dl.numRaSubFrms + RG_SCH_CMN_RARSP_WAIT_PRD + (cell)->rachCfg.raWinSize - 1) / RGSCH_NUM_SUB_FRAMES + 1; }
# 488 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_RA_TYPE0 0
#define RG_SCH_CMN_RA_TYPE1 1
#define RG_SCH_CMN_RA_TYPE2 2
# 648 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_GET_ALLOCCB_FRM_UE(_ue) &((_ue)->dl.dlAllocCb);
#define RG_SCH_CMN_GET_ALLOCCB_FRM_RACB(_raCb) &((_raCb)->rbAllocInfo);
#define RG_SCH_CMN_INIT_SCHD_LNK(_schdLstLnk,_node) { (_schdLstLnk)->node = (PTR)_node; (_schdLstLnk)->prev = NULLP; (_schdLstLnk)->next = NULLP;}
# 659 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_FILL_DL_TXINFO(_allocInfo,_rb,_sFlg,_prcInf,_numLyr,_sf) { _allocInfo->rbsReq = _rb; _allocInfo->mimoAllocInfo.swpFlg = _sFlg; _allocInfo->mimoAllocInfo.precIdxInfo = _prcInf; _allocInfo->mimoAllocInfo.numTxLyrs = _numLyr; _allocInfo->dlSf = _sf;}
# 668 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_FILL_DL_TBINFO(_tbInfo,_bytsReq,_iTbs,_imcs,_tbCb,_noLyr) { (_tbInfo)->schdlngForTb = TRUE; (_tbInfo)->bytesReq = _bytsReq; (_tbInfo)->iTbs = _iTbs; (_tbInfo)->imcs = _imcs; (_tbInfo)->tbCb = _tbCb; (_tbInfo)->noLyr = _noLyr;}
# 679 "../..//ltemac/rg_sch_cmn.h"
#define RG_SCH_CMN_TD_RI_1 0x01

#define RG_SCH_CMN_TD_NO_PMI 0x02
#define RG_SCH_CMN_TD_TXMODE_RECFG 0x04
...
#define RG_SCH_CMN_MAX_CODE_RATE_16QAM 85
...
#define RG_SCH_CMN_UPD_RBS_TO_ADD(_CELL,_DLSF,_ALLCINFO,_RBSREQ,_RBSTOADD) { U8 addtlRbsAvl; addtlRbsAvl = rgSCHCmnFindNumAddtlRbsAvl(_CELL,_DLSF,_ALLCINFO); if(_RBSREQ > addtlRbsAvl) { _RBSTOADD = addtlRbsAvl; } else { _RBSTOADD = _RBSREQ; }}
# 113 "../..//ltemac/rg_sch_cmn.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 117 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/cm5.x" 1
# 118 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
typedef struct tfuSubbandMode22
{
   U8 cqi;
...
typedef struct tfuCqiPuschMode22
{
   ...
   TfuSubbandMode22 subbandArr[110];
...
extern S16 cmPkTfuSubbandMode22 ( TfuSubbandMode22 *param, Buffer *mBuf );



extern S16 cmUnpkTfuSubbandMode22 ( TfuSubbandMode22 *param, Buffer *mBuf );
...
# 3434 "../..//cm/tfu.x"
extern S16 cmPkTfuUeMsg3RecpReq ( TfuUeMsg3RecpReq *param, Buffer *mBuf );



extern S16 cmUnpkTfuUeMsg3RecpReq ( TfuUeMsg3RecpReq *param, Buffer *mBuf );
...
extern S16 cmPkRgSchHqRetxStats ( RgSchHqRetxStats *param, Buffer *mBuf );



extern S16 cmPkRgSchNackAckStats ( RgSchNackAckStats *param, Buffer *mBuf );



extern S16 cmPkRgHqNumRetx ( RgSchHqNumRetx *param, Buffer *mBuf );



extern S16 cmPkRgAckNack ( RgAckNack *param, Buffer *mBuf );




extern S16 cmUnpkRgSchHqRetxStats ( RgSchHqRetxStats *param, Buffer *mBuf );



extern S16 cmUnpkRgSchNackAckStats ( RgSchNackAckStats *param, Buffer *mBuf );



extern S16 cmUnpkRgHqNumRetx ( RgSchHqNumRetx *param, Buffer *mBuf );



extern S16 cmUnpkRgAckNack ( RgAckNack *param, Buffer *mBuf );
...
extern S16 cmPkRgSchUlAllocCntrl ( RgSchUlAllocCntrl *param, Buffer *mBuf );




extern S16 cmUnpkRgSchUlAllocCntrl ( RgSchUlAllocCntrl *param, Buffer *mBuf );
# 126 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//cm/rgr.x" 1
# 91 "../..//cm/rgr.x"
#define __RGR_X__ 
# 101 "../..//cm/rgr.x"
...
# 127 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//ltemac/rg_sch_inf.x" 1
# 95 "../..//ltemac/rg_sch_inf.x"
#define __GKSCH_X__ 
# 104 "../..//ltemac/rg_sch_inf.x"
...
struct _rgSchdApis
{
   ...
   RgSchUlAlloc *(*rgSCHFirstHqFdbkAlloc) (RgSchCellCb *cell);
   RgSchUlAlloc *(*rgSCHNextHqFdbkAlloc) (RgSchCellCb *cell, RgSchUlAlloc *alloc);

   Void (*rgSCHDlProcAddToRetx) (RgSchCellCb *cell,RgSchDlHqProcCb *hqP);
   Void (*rgSCHDlCqiInd) (RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiInd, CmLteTimingInfo timingInfo);
...
{
# 1264 "../..//ltemac/rg_sch.x"
   CmLListCp raReqLst[10];
...
# 1796 "../..//ltemac/rg_sch.x"
}RgSchUeMimoInfo;
# 1995 "../..//ltemac/rg_sch.x"
struct rgSchUeCb
{
...
extern RgSchCb rgSchCb[1];
# 2514 "../..//ltemac/rg_sch.x"
...
extern S16 rgSCHTomTtiInd ( RgSchCellCb *cell, SuId suId, TfuTtiIndInfo *ttiInd);
...
extern S16 rgSCHCmnUlTti (RgSchCellCb *cell, RgSchErrInfo *err);
...
extern S16 rgSCHUhmHqEntInit (RgSchUeCb *ueCb);




extern Void rgSCHUhmProcDatInd (RgSchCellCb *cell, RgSchUeCb *ue, CmLteTimingInfo frm, U8 cqi);
...
extern Void rgSCHUhmProcHqFailure (RgSchCellCb *cell, RgSchUeCb *ue, CmLteTimingInfo frm, TknU8 rv, U8 cqi);


extern RgSchUlHqProcCb* rgSCHUhmGetUlHqProc ( RgSchUeCb *ue, U8 idx);

extern Void rgSCHUhmNewTx (RgSchUlHqProcCb *hqProc, U8 maxHqRetx, RgSchUlAlloc *alloc);

extern Void rgSCHUhmFreeProc (RgSchUlHqProcCb *hqProc);
extern Void rgSCHUhmRetx (RgSchUlHqProcCb *hqProc, RgSchUlAlloc *alloc);
extern Void rgSCHUhmUpdMsg3Hq (RgSchUlHqProcCb** msg3HpRefRef, U8 msg3HqProcId, RgSchUeCb *ue);
...
extern Void rgSCHUhmFreeUe ( RgSchUeCb *ueCb);
extern S16 rgSCHUhmAppendPhich ( RgSchCellCb *cellCb, CmLteTimingInfo frm );
...
# 2985 "../..//ltemac/rg_sch.x"
extern RgSchDlHqEnt *rgSCHDhmHqEntInit (RgSchCellCb *cell);
extern S16 rgSCHDhmGetAvlHqProc (RgSchUeCb *ue, CmLteTimingInfo timingInfo, RgSchDlHqProcCb **hqP);
...
extern S16 rgSCHDhmGetCcchSduHqProc (RgSchUeCb *ueCb, CmLteTimingInfo timeInfo);
...
extern Void rgSCHMeasGapANRepUeDel ( RgSchCellCb *cell, RgSchUeCb *ue );
...
extern S16 rgSCHUtlAddPhich (RgSchCellCb *cellCb, CmLteTimingInfo frm, U8 hqFeedBack, U8 nDmrs, U8 rbStart);
...
extern S16 rgSCHUtlAllocRcptInfo (RgSchUlAlloc *alloc, CmLteRnti *rnti, U8 *iMcsRef, U8 *rbStartRef, U8 *numRbRef, U8 *rvRef, U16 *size, TfuModScheme *modType,Bool *isRtx, U8 *nDmrs, Bool *ndi, U8 *hqPId);
# 3221 "../..//ltemac/rg_sch.x"
...
extern S16 rgSCHUtlTti (RgSchCellCb *cell, RgSchErrInfo *err);
...
extern S16 rgSCHUtlUpdBsrShort (RgSchCellCb *cell, RgSchUeCb *ue, U8 lcgId, U8 bsr, RgSchErrInfo *err);

extern S16 rgSCHUtlUpdBsrTrunc (RgSchCellCb *cell, RgSchUeCb *ue, U8 lcgId, U8 bsr, RgSchErrInfo *err);

extern S16 rgSCHUtlUpdBsrLong (RgSchCellCb *cell, RgSchUeCb *ue, U8 bsr1,U8 bsr2,U8 bsr3,U8 bsr4, RgSchErrInfo *err);
...
extern RgSchUlAlloc *rgSCHUtlFirstHqFdbkAlloc (RgSchCellCb *cell);
extern RgSchUlAlloc *rgSCHUtlNextHqFdbkAlloc (RgSchCellCb *cell, RgSchUlAlloc *alloc);
...
extern S16 rgSCHUtlFillRgInfRarInfo (RgSchDlSf *sf,RgInfSfAlloc *sfAlloc);
extern S16 rgSCHUtlFillPdschDciInfo (TfuPdschDciInfo *pdschDci,TfuDciInfo *pdcchDci);

extern Void rgSCHUtlFillRgInfUeInfo (RgSchDlSf *sf,RgInfSfAlloc *sfAlloc);
...
# 3421 "../..//ltemac/rg_sch.x"
extern S16 rgSCHUtlUlSfInit ( RgSchCellCb *cell, RgSchUlSf *sf, U8 idx, U8 maxUePerSf, U8 sbStartIdx, U8 numSb );
...
# 3647 "../..//ltemac/rg_sch.x"
 Void rgSCHUtlRlsRnti ( RgSchCellCb *cellCb, RgSchUeCb *ue );
# 129 "../..//ltemac/rg_sch_cmn.c" 2
# 1 "../..//ltemac/rg_sch_cmn.x" 1
# 105 "../..//ltemac/rg_sch_cmn.x"
#define __RGSCHCMNX__ 
# 114 "../..//ltemac/rg_sch_cmn.x"
...
struct _rgDlSchdApis
{
   ...
   Void (*rgSCHDlSched) (RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *allocInfo);
   Void (*rgSCHDlDedBoUpd) (RgSchCellCb *cell, RgSchUeCb *ue, RgSchDlLcCb *svc);
   Void (*rgSCHDlProcAddToRetx) (RgSchCellCb *cell,RgSchDlHqProcCb *hqP);
   Void (*rgSCHDlCqiInd) (RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiInd);
...
struct _rgDlfsSchdApis
{
   ...
   Void (*rgSCHDlfsDlCqiInd) (RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiRpt, CmLteTimingInfo timingInfo);
...
typedef struct rgSchCmnUeRbAlloc
{
   ...
   CmLListCp schdTxUeLst;
   CmLListCp schdRetxUeLst;
   CmLListCp nonSchdTxUeLst;
   CmLListCp nonSchdRetxUeLst;



   CmLListCp txRetxUeLst;

   CmLListCp schdTxRetxUeLst;
   CmLListCp nonSchdTxRetxUeLst;
...
extern RgSchUlAlloc *rgSCHCmnFirstHqFdbkAlloc ( RgSchCellCb *cell );


extern RgSchUlAlloc *rgSCHCmnNextHqFdbkAlloc ( RgSchCellCb *cell, RgSchUlAlloc *alloc );



extern Void rgSCHCmnDlDedBoUpd ( RgSchCellCb *cell, RgSchUeCb *ue, RgSchDlLcCb *svc );
# 1334 "../..//ltemac/rg_sch_cmn.x"
...
extern Void rgSCHCmnDlCqiInd ( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiRpt, CmLteTimingInfo timingInfo );
# 1367 "../..//ltemac/rg_sch_cmn.x"
...
extern RgSchUlAlloc *rgSCHCmnUlSbAlloc ( RgSchUlSf *sf, U8 numSb, RgSchUlHole *hole, U8 retxNumSb );





extern Void rgSCHCmnRlsUlSf ( RgSchCellCb *cell );



extern Void rgSCHCmnUlRecMsg3Alloc ( RgSchCellCb *cell, RgSchUeCb *ue, RgSchRaCb *raCb );
# 1394 "../..//ltemac/rg_sch_cmn.x"
 Void rgSCHCmnUpdVars ( RgSchCellCb *cell );
# 1462 "../..//ltemac/rg_sch_cmn.x"
extern U8 rgSCHCmnGetUlHqProcIdx (CmLteTimingInfo *timeInfo, RgSchCellCb *cell);



extern Void rgSCHCmnUlFreeAllocation ( RgSchUlSf *sf, RgSchUlAlloc *alloc );
...
# 1515 "../..//ltemac/rg_sch_cmn.x"
extern RgSchPdcch *rgSCHCmnPdcchAlloc ( RgSchCellCb *cell, RgSchDlSf *subFrm, U32 y, U8 cqi, TfuDciFormat dciFrmt, Bool isDtx );
...
extern Void rgSCHCmnUpdDai ( RgSchUeCb *ue, CmLteTimingInfo *fdbkTime, U8 m, Bool havePdcch );
...
extern U8 rgSCHCmnUlGetITbs ( RgSchUeCb *ue, Bool isEcp );



extern Void rgSCHCmnUlAllocFillRbInfo ( RgSchCmnUlCell *cellUl, RgSchUlAlloc *alloc );



extern Void rgSCHCmnDlUeResetTemp ( RgSchUeCb *ue );


extern Void rgSCHCmnUlUeResetTemp ( RgSchUeCb *ue );
...
# 1641 "../..//ltemac/rg_sch_cmn.x"
extern Void rgSCHCmnUlAdd2UeLst ( RgSchCmnUlRbAllocInfo *allocInfo, RgSchUeCb *ue );
...
extern Void rgSCHPwrUpdPhr ( RgSchCellCb *cell, RgSchUeCb *ue, U8 phr, RgSchCmnAllocRecord *allocInfo);
...
static Void rgSCHUpdSiCtx (RgSchCellCb *cell);
...
# 190 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnDlCqiOnPucchInd ( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiRpt );




static Void rgSCHCmnDlCqiOnPuschInd ( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiRpt );
# 215 "../..//ltemac/rg_sch_cmn.c"
...
typedef U8 (*RgSchCmnDlGetPrecInfFunc) (RgSchUeCb *ue, U8 numLyrs, Bool bothCwEnbld);
...
static U8 rgSCHCmnDlTM3PrecInf2 ( RgSchUeCb *ue, U8 numTxLyrs, Bool bothCwEnbld );




static U8 rgSCHCmnDlTM3PrecInf4 ( RgSchUeCb *ue, U8 numTxLyrs, Bool bothCwEnbld );




static U8 rgSCHCmnDlTM4PrecInf2 ( RgSchUeCb *ue, U8 numTxLyrs, Bool bothCwEnbld );




static U8 rgSCHCmnDlTM4PrecInf4 ( RgSchUeCb *ue, U8 numTxLyrs, Bool bothCwEnbld );
...
static Void rgSCHCmnDlRbInfoAddUeTx ( RgSchCmnDlRbAllocInfo *allocInfo, RgSchUeCb *ue );



static Void rgSCHCmnDlRbInfoAddUeRetx ( RgSchCmnDlRbAllocInfo *allocInfo, RgSchUeCb *ue );
...
# 528 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnFillHqPTb ( RgSchCellCb *cell, RgSchDlRbAlloc *rbAllocInfo, U8 tbAllocIdx, RgSchPdcch *pdcch );
# 560 "../..//ltemac/rg_sch_cmn.c"
...
const static S16 rgSchCmnBiTbl[] = {
...
# 669 "../..//ltemac/rg_sch_cmn.c"
static U8 rgSchCmnDlQciPrio[9] = {1, 2, 1, 2, 0, 3, 3, 4, 5};
# 680 "../..//ltemac/rg_sch_cmn.c"
static U16 rgSchCmnCqiPdschEff[4][16] = {{207, 271, 333, 431, 648, 899, 1161, 1482, 1889, 2103, 2905, 3412, 3956, 4474, 4655, 5397} ,{178, 222, 296, 364, 577, 856, 1125, 1411, 1833, 2460, 2612, 3453, 4026, 4595, 5090, 5902},
    {175, 255, 326, 400, 636, 944, 1240, 1556, 2021, 2536, 2881, 3504, 4116, 4772, 5398, 5616},{208, 295, 362, 446, 708, 869, 1207, 1734, 1991, 2540, 3212, 3561, 4248, 4590, 5322, 5653}};
...
RgSchUeCatTbl rgUeCatTbl = {
   {5160, 10296, 250368, 0, 10296, 1},
   {25456, 51024, 1237248, 0, 51024, 2},
   {51024, 75376, 1237248, 0, 102048, 2},
   {51024, 75376, 1827072, 0, 150752, 2},
   {75376, 149776, 3667200, 1, 299552, 4}
};
# 1142 "../..//ltemac/rg_sch_cmn.c"
...
static Void rgSCHCmnFillPdcchOdr2Sf ( RgSchUeCb *ue, RgSchPdcch *pdcc, U8 rapId, U8 prachMskIdx );
...
# 1274 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnDlAllocFnlz ( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *allocInfo );
...
static Void rgSCHCmnAddUeToRefreshQ ( RgSchCellCb *cell, RgSchUeCb *ue );
...
static Void rgSCHCmnUpdUeUlCqiInfo ( RgSchUeCb *ue, RgSchCmnUlUe *ueUl, RgSchCmnUe *ueSchCmn, RgSchCmnCell *cellSchd );
...
# 1359 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnUlRbAllocForLst ( RgSchCellCb *cell, RgSchUlSf *sf, U32 count, CmLListCp *reqLst, CmLListCp *schdLst, CmLListCp *nonSchdLst, Bool isRetx );
# 1369 "../..//ltemac/rg_sch_cmn.c"
static S16 rgSCHCmnUlRbAllocForUe ( RgSchCellCb *cell, RgSchUlSf *sf, RgSchUeCb *ue, U8 maxRb, Bool isRetx, RgSchUlHole *hole );
# 1378 "../..//ltemac/rg_sch_cmn.c"
...
# 1387 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnUlNonadapRetx ( RgSchCmnUlCell *cellUl, RgSchUlAlloc *alloc );




static Void rgSCHCmnDlCmnChAlloc ( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *allocInfo );
...
static Void rgSCHCmnClcRbAlloc ( RgSchCellCb *cell, U32 bo, U8 cqi, U8 *rb, U32 *tbs, U8 *mcs );
# 1438 "../..//ltemac/rg_sch_cmn.c"
...
static Void rgSCHCmnDlSetUeAllocLmt ( RgSchCmnCell *cellSch, RgSchCmnDlUe *ueDl );
...
# 1498 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnDlHdlTxModeRecfg ( RgSchUeCb *ue, RgrUeRecfg *ueRecfg );
# 1510 "../..//ltemac/rg_sch_cmn.c"
...
static Void rgSCHCmnNonDlfsPbchRbAllocAdj ( RgSchCellCb *cell, RgSchDlRbAlloc *cmnAllocInfo, U8 pbchSsRsSym );
...
static U32 rgSCHCmnCalcRiv ( U8 bw, U8 rbStart, U8 numRb);
# 1698 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   rgSchCmnDciFrmtSizes[0] = 1 +
                             1 +
                             rgSCHUtlLog32bitNbase2((cell->bwCfg.ulTotalBw * (cell->bwCfg.ulTotalBw + 1))/2) +
   ...
   rgSchCmnDciFrmtSizes[2] = 1 +
               ...
               2 +
               2 +
               1 + rgSCHUtlLog32bitNbase2((cell->bwCfg.dlTotalBw * (cell->bwCfg.dlTotalBw + 1))/2);
   ...
   rgSchCmnDciFrmtSizes[3] = 1 +
                             rgSCHUtlLog32bitNbase2((cell->bwCfg.dlTotalBw * (cell->bwCfg.dlTotalBw + 1))/2) +
   ...
   rgSchCmnDciFrmtSizes[4] = (cell->bwCfg.dlTotalBw < 50)? 0:1 +
                             ...
                             (rgSCHUtlLog32bitNbase2((cell->bwCfg.dlTotalBw/2 * (cell->bwCfg.dlTotalBw/2 + 1))/2)) :

                             (rgSCHUtlLog32bitNbase2((cell->bwCfg.dlTotalBw/4 * (cell->bwCfg.dlTotalBw/4 + 1))/2)) +
...
# 2190 "../..//ltemac/rg_sch_cmn.c"
   ...
   for (idx = 0; idx < 3; idx++)
   {
      for (i = 0; i < 4; i++)
      {
         ...
         rgSCHCmnCompEff((U8)(i + 1), 0, idx, rgSchCmnEffTbl[0][0][idx][i]);

         rgSCHCmn2LyrCompEff((U8)(i + 1), 0, idx, rgSchCmnEffTbl[1][0][idx][i]);
...
# 2309 "../..//ltemac/rg_sch_cmn.c"
   ...
   for (idx = 0; idx < 3; idx++)
   {
      for (i = 0; i < 4; i++)
      {
         ...
         rgSCHCmnCompEff( (U8)(i + 1 ), (U8)1, idx, rgSchCmnEffTbl[0][1][idx][i]);

         rgSCHCmn2LyrCompEff((U8)(i + 1), (U8) 1,idx, rgSchCmnEffTbl[1][1][idx][i]);
...

{
   ...
   rgSCHCmnCompUlEff(3,0,rgSchCmnUlEffTbl[0]);
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2645); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlRlsSubFrm\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 2682 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnDlCmnChAlloc
(
RgSchCellCb *cell,
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2701); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCmnChAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 2725 "../..//ltemac/rg_sch_cmn.c"
   rgSCHCmnDlRaRsp(cell, allocInfo);


   return;
}
# 2750 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2769); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnCcchSduAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   if (allocInfo->ccchSduAlloc.ccchSduDlSf->bw <=
       allocInfo->ccchSduAlloc.ccchSduDlSf->bwAssigned)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2776); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnCcchSduAlloc():                                           bw<=bwAssigned"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }

   if (rgSCHDhmGetCcchSduHqProc(ueCb, cellSch->dl.time) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2783); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnCcchSduAlloc():                                        rgSCHDhmGetCcchSduHqProc failed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2792); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnCcchSduAlloc():                                     rgSCHCmnCcchSduDedAlloc failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }
   cmLListAdd2Tail(&allocInfo->ccchSduAlloc.ccchSduTxLst, &ueCb->dl.dlAllocCb.reqLnk);
   ueCb->dl.dlAllocCb.reqLnk.node = (U32)ueCb;

   return(0);
}
# 2816 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2833); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchSduTx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2884); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchTx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2939); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchSduTx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while(node)
   {
      ...
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 2948); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnDlCcchSduRetx():                  HqprocId=%d",hqP->procId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      ...
      ueCb->dl.dlAllocCb.tbInfo[0].imcs = hqP->tbInfo[0].dlGrnt.iMcs;
      ...
      ueCb->dl.dlAllocCb.tbInfo[0].schdlngForTb = 1;

      retxBw += ueCb->dl.dlAllocCb.rbsReq;

      cmLListAdd2Tail(&allocInfo->ccchSduAlloc.ccchSduRetxLst, &ueCb->dl.dlAllocCb.reqLnk);
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3015); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchRetx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while(node)
   {
      ...
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3023); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnDlCcchRetx():                  HqprocId=%d",hqP->procId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      ...
      raCb->rbAllocInfo.tbInfo[0].imcs = hqP->tbInfo[0].dlGrnt.iMcs;
      ...
      cmLListAdd2Tail(&allocInfo->msg4Alloc.msg4RetxLst, &raCb->rbAllocInfo.reqLnk);

      raCb->rbAllocInfo.reqLnk.node = (U32)raCb;
   }
   allocInfo->msg4Alloc.msg4DlSf->bwAssigned += retxBw;
   return;
}
# 3077 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3105); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlBcchPcch\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   do { if ((frm.subframe += (2 + 1) + 1) > 9) { frm.sfn = ((frm.sfn) + 1) & 0x03ff; frm.subframe -= 10; }} while(0);




   sf = rgSCHUtlSubFrmGet(cell, frm);
# 3217 "../..//ltemac/rg_sch_cmn.c"
...
# 3392 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3402); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnClcAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3430); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnClcAlloc():                                        BW allocation failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3514); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnCmnPdcchAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   aggrLvl = cellSch->dl.cmnChAggrLvl;
   pdcchInfo = &(subFrm->pdcchInfo);

   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3520); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnCmnPdcchAlloc():                                      AggrLvl=%d", aggrLvl); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 3610 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3621); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnClcRbAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 3643 "../..//ltemac/rg_sch_cmn.c"
   ...
   *rb = (((noRes) + (cellDl->noResPerRb)-1) / (cellDl->noResPerRb));
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3706); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnMsg4Alloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   if (allocInfo->msg4Alloc.msg4DlSf->bw <=
       allocInfo->msg4Alloc.msg4DlSf->bwAssigned)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3713); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnMsg4Alloc():                                           bw<=bwAssigned"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3720); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnMsg4Alloc():                                        rgSCHDhmGetMsg4HqProc failed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3729); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnMsg4Alloc():                                     rgSCHCmnMsg4DedAlloc failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }
   cmLListAdd2Tail(&allocInfo->msg4Alloc.msg4TxLst, &raCb->rbAllocInfo.reqLnk);
   raCb->rbAllocInfo.reqLnk.node = (U32)raCb;

   return(0);
}
# 3767 "../..//ltemac/rg_sch_cmn.c"
...
# 3785 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3801); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnPdcchAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3838); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnPdcchAlloc():                                       aggrlvl:nCce:y=%d:%d:%d", aggrLvl, pdcchInfo->nCce, (int)y); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   RgSchCmnDlCell *ueDl = &(((RgSchCmnCell *)((cell)->sc.sch))->dl);
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3924); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnCcchSduDedAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   effBo = ueCb->dlCcchInfo.bo + 1;


   rgSCHCmnClcRbAlloc(cell, effBo, ueDl->ccchCqi, &rbAllocinfo->rbsReq, &rbAllocinfo->tbInfo[0].bytesReq,
   ...
   if ((S16)rbAllocinfo->rbsReq > ((S16)(rbAllocinfo->dlSf->bw - rbAllocinfo->dlSf->bwAssigned)))
   ...
   rbAllocinfo->dlSf->bwAssigned = rbAllocinfo->dlSf->bwAssigned + rbAllocinfo->rbsReq;
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 3994); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnMsg4DedAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   rgSCHCmnClcRbAlloc(cell, effBo, raCb->ccchCqi, &rbAllocinfo->rbsReq, &rbAllocinfo->tbInfo[0].bytesReq, &rbAllocinfo->tbInfo[0].imcs );
# 4011 "../..//ltemac/rg_sch_cmn.c"
   if ((S16)rbAllocinfo->rbsReq > ((S16)(rbAllocinfo->dlSf->bw - rbAllocinfo->dlSf->bwAssigned)))
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4171); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlRaRsp\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   frm = cell->crntTime;
   do { if ((frm.subframe += (2 + 1)) > 9) { frm.sfn = ((frm.sfn) + 1) & 0x03ff; frm.subframe -= 10; }} while(0);
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4196); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnDlRaRsp():sfNum:winStart=%d:%d", frm.subframe, winStart); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   for(i = 0; ((i < cell->rachCfg.raWinSize) && (noRaRnti < 4)); i++)
   {
      rarnti = (winStart + i) >= 10 ?
               (winStart + i - 10) : (winStart + i);
      if (cell->raInfo.raReqLst[rarnti].first != 0L)
      {
         allocInfo->raRspAlloc[noRaRnti].biEstmt = (!i * 1);

         if (rgSCHCmnRaRspAlloc(cell, subFrm, rarnti,
                                 (U8)(rarnti+1), noRaRnti, allocInfo) != 0)
         {
...
# 4261 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4287); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnRaRspAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   if (subFrm->bw == subFrm->bwAssigned)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4292); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnRaRspAlloc():                bw == bwAssigned"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (reqLst->count == 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4300); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnRaRspAlloc():                reqLst Count=0"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while (1)
   {
      ...
      noBytes = ((remNumRapid) * 7) + allocInfo->raRspAlloc[noRaRnti].biEstmt;
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4365); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnRaRspAlloc():                BW alloc suceeded for %d rapIds", remNumRapid); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (!isAlloc)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4374); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnRaRspAlloc():                BW alloc Failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   *ulAllocRef = 0L;
   ...
   if ((hole = rgSCHUtlUlHoleFirst(sf)) != 0L)
   {
      if (numSb <= hole->num)
      {
         ...
         alloc->grnt.datSz = rgTbSzTbl[0][rgSCHCmnUlGetITbsFrmIMcs(iMcs)] [alloc->grnt.numRb-1] / 8;
...

{
   ...
   ueDl->mimoInfo.cwInfo[0].iTbs[0] = (*(RgSchCmnCqiToTbs *)(cellSch->dl.cqiToTbsTbl[0])) [ueDl->mimoInfo.cwInfo[0].cqi];


   ueDl->mimoInfo.cwInfo[0].iTbs[1] = (*(RgSchCmnCqiToTbs *)(cellSch->dl.cqiToTbsTbl[1])) [ueDl->mimoInfo.cwInfo[0].cqi];


   ueDl->mimoInfo.cwInfo[0].eff[0] = (*(RgSchCmnTbSzEff *)(cellSch->dl.cqiToEffTbl[0])) [ueDl->mimoInfo.cwInfo[0].iTbs[0]];


   ueDl->mimoInfo.cwInfo[0].eff[1] = (*(RgSchCmnTbSzEff *)(cellSch->dl.cqiToEffTbl[1])) [ueDl->mimoInfo.cwInfo[0].iTbs[1]];



   ueDl->mimoInfo.cwInfo[1].iTbs[0] = (*(RgSchCmnCqiToTbs *)(cellSch->dl.cqiToTbsTbl[0])) [ueDl->mimoInfo.cwInfo[1].cqi];


   ueDl->mimoInfo.cwInfo[1].iTbs[1] = (*(RgSchCmnCqiToTbs *)(cellSch->dl.cqiToTbsTbl[1])) [ueDl->mimoInfo.cwInfo[1].cqi];


   ueDl->mimoInfo.cwInfo[1].eff[0] = (*(RgSchCmnTbSzEff *)(cellSch->dl.cqiToEffTbl[0])) [ueDl->mimoInfo.cwInfo[1].iTbs[0]];


   ueDl->mimoInfo.cwInfo[1].eff[1] = (*(RgSchCmnTbSzEff *)(cellSch->dl.cqiToEffTbl[1])) [ueDl->mimoInfo.cwInfo[1].iTbs[1]];




   (ueDl->mimoInfo.ri/2 == 0)? (ueDl->mimoInfo.cwInfo[0].noLyr = 1) : (ueDl->mimoInfo.cwInfo[0].noLyr = ueDl->mimoInfo.ri/2);

   ueDl->mimoInfo.cwInfo[1].noLyr = ueDl->mimoInfo.ri - ueDl->mimoInfo.cwInfo[0].noLyr;
# 4632 "../..//ltemac/rg_sch_cmn.c"
   ...
   maxRb = ((ueDl->maxSbSz)/(cellSch->dl.noResPerRb * modOrder * ueDl->mimoInfo.ri));
   ...
   {
      if (ueDl->mimoInfo.cwInfo[0].eff[ueDl->mimoInfo.cwInfo[0].noLyr-1] < ueDl->mimoInfo.cwInfo[1].eff[ueDl->mimoInfo.cwInfo[1].noLyr-1])
...
{
   RgSchCmnUlUe *cmnUlUe = &(((RgSchCmnUe *)((ue)->sch))->ul);
...

{
   ...
   pdcch->dci.u.format1aInfo.isPdcchOrder = 0;
         ...
         pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.mcs = rbAllocInfo->tbInfo[0].imcs;
...
# 4824 "../..//ltemac/rg_sch_cmn.c"
      ...
      case TFU_DCI_FORMAT_1:
         ...
         break;
      default:
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 4860); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Allocator's icorrect                   dciForamt Fill\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         break;
   }
   return;
}
# 5123 "../..//ltemac/rg_sch_cmn.c"
...
# 5138 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 5152); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnFillHqPTb():                  For tbIdx = %x,TbInfo is disabled",tbInfo->tbIdx); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 5161); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnFillHqPTb():                  For Tb re-transmission HqprocId=%d txcntr=%d",hqP->procId,tbInfo->txCntr); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   else
   {
      ...
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 5184); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnFillHqPTb():                  For Tb transmission HqprocId=%d txcntr=%d",hqP->procId,tbInfo->txCntr); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   switch(rbAllocInfo->dciFormat)
   {
      case TFU_DCI_FORMAT_1:
          {
              rgSCHCmnFillHqPPdcchDciFrmt1(cell, rbAllocInfo, hqP, pdcch, tpc);

              break;
          }
      case TFU_DCI_FORMAT_1A:
          {
              rgSCHCmnFillHqPPdcchDciFrmt1A(cell, rbAllocInfo, hqP, pdcch, tpc);

              break;
          }
      case TFU_DCI_FORMAT_1B:
          {
              rgSCHCmnFillHqPPdcchDciFrmt1B(cell, rbAllocInfo, hqP, pdcch, tpc);

              break;
          }
      case TFU_DCI_FORMAT_2:
          {
              rgSCHCmnFillHqPPdcchDciFrmt2(cell, rbAllocInfo, hqP, pdcch, tpc);

              break;
          }
      case TFU_DCI_FORMAT_2A:
          {
               rgSCHCmnFillHqPPdcchDciFrmt2A(cell, rbAllocInfo, hqP, pdcch, tpc);

               break;
          }
      default:
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 5300); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnFillHqPPdcch:Allocator's                      incorrect dciForamt Fill\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         break;
   }
   return;
}
# 5329 "../..//ltemac/rg_sch_cmn.c"
...
# 5345 "../..//ltemac/rg_sch_cmn.c"
{
# 5357 "../..//ltemac/rg_sch_cmn.c"
    ;
    ...
    pdcch->dci.u.format1Info.tpcCmd = tpc;
       ...
       pdcch->dci.u.format1Info.allocInfo.resAllocMap[3] =
           ((rbAllocInfo->allocInfo.raType0.dlAllocBitMask & 0x000000ff));
# 5396 "../..//ltemac/rg_sch_cmn.c"
    pdcch->dci.u.format1Info.allocInfo.harqProcId = hqP->procId;


    pdcch->dci.u.format1Info.allocInfo.ndi = rbAllocInfo->tbInfo[0].tbCb->ndi;


    pdcch->dci.u.format1Info.allocInfo.mcs = rbAllocInfo->tbInfo[0].imcs;

    pdcch->dci.u.format1Info.allocInfo.rv = rbAllocInfo->tbInfo[0].tbCb->dlGrnt.rv;
# 5433 "../..//ltemac/rg_sch_cmn.c"
    { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 5444); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n" "rgSCHCmnFillHqPPdcchDciFrmt1():               pdcch info resAllocMap[0]=%c,resAllocMap[1]=%c,               resAllocMap[2]=%c,resAllocMap[3]=%c,procId=%c,               ndi=%c,mcs=%c,rv=%c",pdcch->dci.u.format1Info.allocInfo.resAllocMap[0], pdcch->dci.u.format1Info.allocInfo.resAllocMap[1], pdcch->dci.u.format1Info.allocInfo.resAllocMap[2], pdcch->dci.u.format1Info.allocInfo.resAllocMap[3], pdcch->dci.u.format1Info.allocInfo.harqProcId, pdcch->dci.u.format1Info.allocInfo.ndi, pdcch->dci.u.format1Info.allocInfo.mcs, pdcch->dci.u.format1Info.allocInfo.rv); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
# 5447 "../..//ltemac/rg_sch_cmn.c"
       return;
}
# 5472 "../..//ltemac/rg_sch_cmn.c"
...
# 5488 "../..//ltemac/rg_sch_cmn.c"
{
# 5500 "../..//ltemac/rg_sch_cmn.c"
    ;
...
# 5529 "../..//ltemac/rg_sch_cmn.c"
    pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.harqProcId.val =
                                              hqP->procId;

    pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.ndi = rbAllocInfo->tbInfo[0].tbCb->ndi;

    pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.rv = rbAllocInfo->tbInfo[0].tbCb->dlGrnt.rv;
    ...
    rgSCHCmnCalcRiv (cell->bwCfg.dlTotalBw,
                  rbAllocInfo->allocInfo.raType2.rbStart,
                  rbAllocInfo->allocInfo.raType2.numRb);
# 5576 "../..//ltemac/rg_sch_cmn.c"
    { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 5583); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n" "rgSCHCmnFillHqPPdcchDciFrmt1A():               pdcch info procId=%c,ndi=%c,mcs=%c,riv=%lu,tpccmd=%c", pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.harqProcId.val, pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.ndi, pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.mcs, pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.alloc.u.riv, pdcch->dci.u.format1aInfo.t.pdschInfo.tpcCmd); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
# 5585 "../..//ltemac/rg_sch_cmn.c"
    return;
}
# 5610 "../..//ltemac/rg_sch_cmn.c"
...
# 5626 "../..//ltemac/rg_sch_cmn.c"
{
# 5638 "../..//ltemac/rg_sch_cmn.c"
    ;

    rgSCHCmnFillHqPTb(cell, rbAllocInfo, 0, pdcch);
    pdcch->dci.u.format1bInfo.tpcCmd = tpc;

    pdcch->dci.u.format1bInfo.allocInfo.mcs = rbAllocInfo->tbInfo[0].imcs;
# 5660 "../..//ltemac/rg_sch_cmn.c"
    pdcch->dci.u.format1bInfo.allocInfo.harqProcId = hqP->procId;

    pdcch->dci.u.format1bInfo.allocInfo.ndi = rbAllocInfo->tbInfo[0].tbCb->ndi;

    pdcch->dci.u.format1bInfo.allocInfo.rv = rbAllocInfo->tbInfo[0].tbCb->dlGrnt.rv;
    ...
    pdcch->dci.u.format1bInfo.allocInfo.pmiCfm = rbAllocInfo->mimoAllocInfo.precIdxInfo >> 4;

    pdcch->dci.u.format1bInfo.allocInfo.tPmi = rbAllocInfo->mimoAllocInfo.precIdxInfo & 0x0F;
# 5698 "../..//ltemac/rg_sch_cmn.c"
    { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 5707); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n" "rgSCHCmnFillHqPPdcchDciFrmt1B():               pdcch info procId=%c,ndi=%c,mcs=%c,riv=%lu,tpccmd=%c,pmiCfm=%c,tPmi=%c", pdcch->dci.u.format1bInfo.allocInfo.harqProcId, pdcch->dci.u.format1bInfo.allocInfo.ndi, pdcch->dci.u.format1bInfo.allocInfo.mcs, pdcch->dci.u.format1bInfo.allocInfo.alloc.u.riv, pdcch->dci.u.format1bInfo.tpcCmd, pdcch->dci.u.format1bInfo.allocInfo.pmiCfm, pdcch->dci.u.format1bInfo.allocInfo.tPmi); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
# 5709 "../..//ltemac/rg_sch_cmn.c"
    return;

}
# 5735 "../..//ltemac/rg_sch_cmn.c"
...
# 5751 "../..//ltemac/rg_sch_cmn.c"
{
# 5763 "../..//ltemac/rg_sch_cmn.c"
    ;
...
# 5808 "../..//ltemac/rg_sch_cmn.c"
     ...
     pdcch->dci.u.format2Info.allocInfo.tbInfo[rbAllocInfo->tbInfo[0]. tbCb->tbIdx].ndi = rbAllocInfo->tbInfo[0].tbCb->ndi;


     pdcch->dci.u.format2Info.allocInfo.tbInfo[rbAllocInfo->tbInfo[0]. tbCb->tbIdx].mcs = rbAllocInfo->tbInfo[0].imcs;

     pdcch->dci.u.format2Info.allocInfo.tbInfo[rbAllocInfo->tbInfo[0]. tbCb->tbIdx].rv = rbAllocInfo->tbInfo[0].tbCb->dlGrnt.rv;
     ...
     {
            pdcch->dci.u.format2Info.allocInfo.tbInfo[rbAllocInfo->tbInfo[1]. tbCb->tbIdx].ndi = rbAllocInfo->tbInfo[1].tbCb->ndi;


            pdcch->dci.u.format2Info.allocInfo.tbInfo[rbAllocInfo->tbInfo[1]. tbCb->tbIdx].mcs = rbAllocInfo->tbInfo[1].imcs;

            pdcch->dci.u.format2Info.allocInfo.tbInfo[rbAllocInfo->tbInfo[1]. tbCb->tbIdx].rv = rbAllocInfo->tbInfo[1].tbCb->dlGrnt.rv;
...
# 5859 "../..//ltemac/rg_sch_cmn.c"
     return;
}
# 5884 "../..//ltemac/rg_sch_cmn.c"
...
# 5900 "../..//ltemac/rg_sch_cmn.c"
{
# 5911 "../..//ltemac/rg_sch_cmn.c"
    ;
...
# 5971 "../..//ltemac/rg_sch_cmn.c"
    ...
    pdcch->dci.u.format2AInfo.allocInfo.tbInfo[rbAllocInfo->tbInfo[0]. tbCb->tbIdx].ndi = rbAllocInfo->tbInfo[0].tbCb->ndi;


    pdcch->dci.u.format2AInfo.allocInfo.tbInfo[rbAllocInfo->tbInfo[0]. tbCb->tbIdx].mcs = rbAllocInfo->tbInfo[0].imcs;

    pdcch->dci.u.format2AInfo.allocInfo.tbInfo[rbAllocInfo->tbInfo[0]. tbCb->tbIdx].rv = rbAllocInfo->tbInfo[0].tbCb->dlGrnt.rv;
    ...
    if (rbAllocInfo->tbInfo[1].schdlngForTb == 1)
    {
            pdcch->dci.u.format2AInfo.allocInfo.tbInfo[rbAllocInfo->tbInfo[1]. tbCb->tbIdx].ndi = rbAllocInfo->tbInfo[1].tbCb->ndi;


            pdcch->dci.u.format2AInfo.allocInfo.tbInfo[rbAllocInfo->tbInfo[1]. tbCb->tbIdx].mcs = rbAllocInfo->tbInfo[1].imcs;

            pdcch->dci.u.format2AInfo.allocInfo.tbInfo[rbAllocInfo->tbInfo[1]. tbCb->tbIdx].rv = rbAllocInfo->tbInfo[1].tbCb->dlGrnt.rv;
    ...
    pdcch->dci.u.format2AInfo.allocInfo.precoding =
            rbAllocInfo->mimoAllocInfo.precIdxInfo;
# 6025 "../..//ltemac/rg_sch_cmn.c"
    return;
}
# 6041 "../..//ltemac/rg_sch_cmn.c"
...
# 6107 "../..//ltemac/rg_sch_cmn.c"
   ...
   if ((cell->crntTime.subframe + (4 - 2) + 4) > (10 - 1)) timeInfo.sfn = (cell->crntTime.sfn + 1) % 1024; else timeInfo.sfn = cell->crntTime.sfn; timeInfo.subframe = (cell->crntTime.subframe + (4 - 2) + 4) % 10;

   cellUl->schdHqProcIdx = rgSCHCmnGetUlHqProcIdx(&timeInfo, cell);


   idx = (cellUl->idx + (2 + 1) + 6);
   cellUl->msg3SchdIdx = ((idx) % (8 +8));

   if ((cell->crntTime.subframe + (2 + 1)+ 6) > (10 - 1)) timeInfo.sfn = (cell->crntTime.sfn + 1) % 1024; else timeInfo.sfn = cell->crntTime.sfn; timeInfo.subframe = (cell->crntTime.subframe + (2 + 1)+ 6) % 10;

   cellUl->msg3SchdHqProcIdx = rgSCHCmnGetUlHqProcIdx(&timeInfo, cell);
# 6135 "../..//ltemac/rg_sch_cmn.c"
   idx = (cellUl->idx + 2);

   cellUl->rcpReqIdx = ((idx) % (8 +8));
# 6148 "../..//ltemac/rg_sch_cmn.c"
   idx = (cellUl->idx - 2 + 1 + 8 +8);

   cellUl->hqFdbkIdx = (idx % (8 +8));
...

{
   ...
   idx = (timeInfo->sfn * 10 + timeInfo->subframe);
   procId = idx % 8;
# 6314 "../..//ltemac/rg_sch_cmn.c"
   return(procId);
}
# 6332 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   RgSchCmnDlUe *ueDl = &(((RgSchCmnUe *)((ue)->sch))->dl);
   RgSchDlSf *sf;
   U32 y;
   ...
   return(rgSCHCmnPdcchAlloc(cell, sf, y, ueDl->mimoInfo.cwInfo[0].cqi, TFU_DCI_FORMAT_0, 0));
}
# 6419 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ue->dl.reqForCqi = 0;
# 6632 "../..//ltemac/rg_sch_cmn.c"
   return;
}
# 6649 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   CmTmrArg arg;
   RgSchCmnUeInfo *ueSchd = &(((RgSchCmnUe *)((ue)->sch))->cmn);
...

{
   ...
   RgSchCmnUlUe *ueUl = &(((RgSchCmnUe *)((ue)->sch))->ul);
   U8 lcgCnt=0;
   RgSchCmnLcg *lcgCmn;
   CmLList *node;
...
# 6837 "../..//ltemac/rg_sch_cmn.c"
   cellSchd->apisDl->rgSCHDlUeReset(cell, ue);
}
# 6857 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ueUl->ulTransTime.sfn = timingInfo.sfn; ueUl->ulTransTime.subframe = timingInfo.subframe;;
...

{
   ...
   if((rgSCHUtlAllocSBuf(cell->instIdx,
               (Data**)&(ue->sch), (sizeof(RgSchCmnUe))) != 0))
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7304); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      err->errCause = (((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1);
      return(1);
   }
   ueSchCmn = ((RgSchCmnUe *)((ue)->sch));
   ...
   if (ueCfg->txMode.pres == 1)
   {
      ...
      {
         { RgSchCmnDlUe *_ueDl = &(((RgSchCmnUe *)(((ue))->sch))->dl); _ueDl->mimoInfo.forceTD |= (0x02); };
      }
      if (ueCfg->txMode.txModeEnum == RGR_UE_TM_3)
      {
         { RgSchCmnDlUe *_ueDl = &(((RgSchCmnUe *)(((ue))->sch))->dl); _ueDl->mimoInfo.forceTD |= (0x01); };
      }
   }
...
# 7368 "../..//ltemac/rg_sch_cmn.c"
   ...
   if (ueCfg->ueQosCfg.ambrPres)
   {
      ...
      ueDl->ambrCfgd = (ueCfg->ueQosCfg.dlAmbr * 100)/100;
   }
   else
   {
   ...
   for(cnt = 0; cnt < ue->dl.hqEnt->numHqPrcs; cnt++)
   {
      ...
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7389); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7397); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Spec Sched DL UE CFG FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
   ...
   ueUl->maxBytesPerUePerTti = rgUeCatTbl[ueSchCmn->cmn.ueCat].maxUlBits * 14 / (16*8);



   if (ueCfg->ueQosCfg.ueBr == 0)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7415); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "UeBr configured as 0"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };

      err->errCause = (((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1);
      return(1);
   }
   ueUl->cfgdUeBR = (ueCfg->ueQosCfg.ueBr * 100)/100;
   ueUl->effUeBR = ueUl->cfgdUeBR;
   ueUl->ulTransTime.sfn = cell->crntTime.sfn; ueUl->ulTransTime.subframe = cell->crntTime.subframe;;
   ...
   for (cnt = 0; cnt < 10; cnt++)
   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7431); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         err->errCause = (((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1);
         return(1);
      }
   ...
   for (cnt=0; cnt<4; cnt++)
   {
      ...
      if (ret != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7447); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnRgrUeCfg():                   SCH struct alloc failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7457); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Could not do power config for UE\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };

      return(1);
   }
# 7470 "../..//ltemac/rg_sch_cmn.c"
   if ((cellSchd->apisUl->rgSCHRgrUlUeCfg(cell, ue, ueCfg, err)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7472); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Spec Sched UL UE CFG FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
   ...
   if (cellSchd->dl.isDlFreqSel)
   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7481); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "DLFS UE config FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         return(1);
      }
   }


   rgSCHCmnAddUeToRefreshQ(cell, ue);

   return(0);
}
# 7524 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   {
      { RgSchCmnDlUe *_ueDl = &(((RgSchCmnUe *)(((ue))->sch))->dl); _ueDl->mimoInfo.forceTD &= ~(0x04); };
   ...
   if (ueRecfg->txMode.tmTrnstnState == RGR_TXMODE_RECFG_START)
   {
      ...
      { RgSchCmnDlUe *_ueDl = &(((RgSchCmnUe *)(((ue))->sch))->dl); _ueDl->mimoInfo.forceTD = (0); };
      { RgSchCmnDlUe *_ueDl = &(((RgSchCmnUe *)(((ue))->sch))->dl); _ueDl->mimoInfo.forceTD |= (0x04); };
# 7596 "../..//ltemac/rg_sch_cmn.c"
      ueDl->mimoInfo.ri = 1;
...

{
   RgSchCmnUlUe *ueUl = &(((RgSchCmnUe *)((ue)->sch))->ul);
   RgSchCmnDlUe *ueDl = &(((RgSchCmnUe *)((ue)->sch))->dl);
   RgSchCmnUe *ueSchCmn = ((RgSchCmnUe *)((ue)->sch));
   RgSchCmnCell *cellSchd = ((RgSchCmnCell *)((cell)->sc.sch));
...
# 7846 "../..//ltemac/rg_sch_cmn.c"
   ...
   if (ueRecfg->ueRecfgTypes & (1<<2))
   {
      if ((ueRecfg->prdDlCqiRecfg.pres == 1)
            && (ueRecfg->prdDlCqiRecfg.prdModeEnum != RGR_PRD_CQI_MOD10)
            && (ueRecfg->prdDlCqiRecfg.prdModeEnum != RGR_PRD_CQI_MOD20))
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7868); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Unsupported periodic CQI reporting mode" " %d\n", (int)ueRecfg->prdDlCqiRecfg.prdModeEnum); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (ueRecfg->ueRecfgTypes & (1<<6))
   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7881); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Power Reconfiguration Failed \n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (ueRecfg->ueRecfgTypes & (1<<4))
   {
      ...
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7892); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "UeBr configured as 0"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };

         err->errCause = (((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1);
         return(1);
      }
      ueUl->cfgdUeBR = (ueRecfg->ueQosRecfg.ueBr * 100)/100;


      if (ueRecfg->ueQosRecfg.ambrPres)
      {
         ueDl->ambrCfgd = (ueRecfg->ueQosRecfg.dlAmbr * 100)/100;

      }


      rgSCHCmnDelUeFrmRefreshQ(cell, ue);
      rgSCHCmnTmrExpiry((U32)ue, 1);
   }

   if ((cellSchCmn->apisUl->rgSCHRgrUlUeRecfg(cell, ue, ueRecfg, err)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7912); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Spec Sched UL UE ReCFG FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
   if ((cellSchCmn->apisDl->rgSCHRgrDlUeRecfg(cell, ue, ueRecfg, err)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7917); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Spec Sched DL UE ReCFG FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }

   if (cellSchCmn->dl.isDlFreqSel)
   {
      if ((cellSchCmn->apisDlfs->rgSCHDlfsUeRecfg(cell, ue, ueRecfg, err)) != 0)

      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 7926); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "DLFS UE re-config FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         return(1);
      }
   }
# 7941 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 7958 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 8197); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCnsdrCmnRt\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 8288); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnDlCnsdrCmnRt():             ResPerRb=%d, maxDlBwPerUe=%d, maxDlRetxBw=%d, iTbs2Rbs=%d,             iTbs3Rbs=%d, cmnChAggrLvl=%d, ccchCqi=%d", cellDl->dl.noResPerRb, cellDl->dl.maxDlBwPerUe, cellDl->dl.maxDlRetxBw, cellDl->dl.cmnChITbs.iTbs2Rbs, cellDl->dl.cmnChITbs.iTbs3Rbs, cellDl->dl.cmnChAggrLvl, cellDl->dl.ccchCqi); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 8565); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlRgrCellCfg\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   cellSch->dl.noResPerRb = (((noSymPerSlot * 2)
...
# 8756 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   ccchMcs = rgSCHCmnUlGetIMcsFrmITbs(ccchTbs,3);
...

{
   ...
   n1Rb = (U8)(((n1Max - (c*n1Cs/pucchDeltaShft)) + (n1PerRb)-1) / (n1PerRb));
   mixedRb = (((n1Cs) + (8)-1) / (8));
   exclRb = n2Rb + mixedRb + n1Rb;

   if (exclRb >= ulBw)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 8983); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSchCmnUlCalcAvailBw():                                    No bw available for PUSCH\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }

   *rbStartRef = (((exclRb) + (2)-1) / (2));
   *bwAvailRef = ulBw - (((exclRb) + (2)-1) / (2)) * 2;
   return(0);
}
# 9016 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnUlCalcBwInfo
(
U8 rbStart,
U8 numRb,
U8 *sbStart,
...
# 9201 "../..//ltemac/rg_sch_cmn.c"
   ...
   {
      cellUl->ulNumRePerRb = 132;
   }
   else
   {

      cellUl->ulNumRePerRb = 108;
   }

   if (sbSize != rgSchCmnMult235Tbl[sbSize].match)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9223); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnUlCellInit():                                       Invalid subband size %d\n", sbSize); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (maxSbPerUe == 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9230); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnUlCellInit():                                maxUlBwPerUe/sbSize is zero\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9239); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnUlCellInit(): Invalid cqi\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
   ...
   if (numSb <= numRaSb)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9286); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnUlCellInit():                                  No bw available for PUSCH\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }
# 9312 "../..//ltemac/rg_sch_cmn.c"
...
# 9343 "../..//ltemac/rg_sch_cmn.c"
   for (i = 0; i < maxSubfrms; ++i)
   {
# 9365 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9435); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   if (recfg->recfgTypes & (1<<4))
   {
      ...
      {
         err->errCause = (((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1);
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9540); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnRgrCellRecfg():                                            Invalid cqi\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 9691 "../..//ltemac/rg_sch_cmn.c"
   return;
}
# 9708 "../..//ltemac/rg_sch_cmn.c"
...
# 9850 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9865); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnRgrLchCfg():" " SCH struct alloc failed.\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
  ...
  if(lcCfg->lcType != 5)
  {
      ...
      if (ret != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9876); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSchCmnCrgLcCfg():          DlQos validation failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      ((RgSchCmnDlSvc *)(dlLc->sch))->gbr = (lcCfg->dlInfo.dlQos.gbr * 100)/100;

      ((RgSchCmnDlSvc *)(dlLc->sch))->mbr = (lcCfg->dlInfo.dlQos.mbr * 100)/100;
...
# 9916 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 9942 "../..//ltemac/rg_sch_cmn.c"
...
# 9958 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   if(dlLc->lcType !=5)
   {
      ...
      if (ret != 0)
      {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9973); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nDlQos validation failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      err->errCause = (((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1);
      return(ret);
      }
      if (((RgSchCmnDlSvc *)(dlLc->sch))->prio != rgSchCmnDlQciPrio[dlqci])
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 9980); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nQci, hence lc Priority change                                          not supported."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         err->errCause = (((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1);
         return(ret);
      }
      ((RgSchCmnDlSvc *)(dlLc->sch))->gbr = (lcRecfg->dlRecfg.dlQos.gbr * 100)/100;

      ((RgSchCmnDlSvc *)(dlLc->sch))->mbr = (lcRecfg->dlRecfg.dlQos.mbr * 100)/100;
...
# 10010 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 10034 "../..//ltemac/rg_sch_cmn.c"
...
# 10159 "../..//ltemac/rg_sch_cmn.c"
   lcgCmn->bs = 0;
   cellSch->apisUl->rgSCHFreeUlLcg(cell, ue, lcg);
   return;
}
# 10183 "../..//ltemac/rg_sch_cmn.c"
...
# 10213 "../..//ltemac/rg_sch_cmn.c"
   rgSCHUtlFreeSBuf(cell->instIdx,
         (Data**)(&(svc->sch)), (sizeof(RgSchCmnDlSvc)));
   return;
}
# 10245 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10265); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchSduRetxFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10341); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchRetxFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   node = allocInfo->msg4Alloc.schdMsg4RetxLst.first;
   while (node)
   {
      RgSchRaCb *raCb = (RgSchRaCb *)(node->node);
      rbAllocInfo = &raCb->rbAllocInfo;
      hqP = raCb->dlHqE->msg4Proc;
      node = node->next;
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10421); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchSduTxFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10514); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCcchTxFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   U8 allocRapidCnt = 0;
# 10694 "../..//ltemac/rg_sch_cmn.c"
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10695); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlRaRspFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for (rarCnt=0; rarCnt<4; rarCnt++)
   {
      ...
      else
      {
         ...
         while (allocRapidCnt)
         {
            ...
            rgSCHCmnMsg3GrntReq(cell, raCb->tmpCrnti, preamGrpA, raCb->msg3HqProcRef, &ulAllocRef, &raCb->msg3HqProcId);
            ...
            do { if ((raCb->msg3AllocTime.subframe += (2 + 1) + 6) > 9) { raCb->msg3AllocTime.sfn = ((raCb->msg3AllocTime.sfn) + 1) & 0x03ff; raCb->msg3AllocTime.subframe -= 10; }} while(0);
# 10781 "../..//ltemac/rg_sch_cmn.c"
         ...
         if ((rarCnt == 0) && (raRspAlloc->biEstmt))
         {
            reqLst = &cell->raInfo.raReqLst[raRspAlloc->raIndex];
            if (reqLst->count)
            {
                  ...
                  (subFrm->raRsp[rarCnt].contFreeUeLst.first == 0L))
         {
            ...
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10815); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nnrgSCHCmnRaRspAlloc():                      Not even one RaReq."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   U8 nextSfIdx = (cell->crntSfIdx+1) % 10;
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10939); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlBcchPcchFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 10954 "../..//ltemac/rg_sch_cmn.c"
      nextSfIdx = (cell->crntSfIdx+1) % 10;
      ...
      if(pcch == 0L)
      {
          { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 10962); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\n rgSCHCmnDlBcchPcchFnlz( ):                      No Pcch Present."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (rbAllocInfo->pdcch)
   {
      ...
      else
      {
         ...
         ((((ptr) = ((&cell->siCb.siCtxLst)->crnt = (&cell->siCb.siCtxLst)->first)) != 0L) ? (ptr)->node : 0L);
         if(0L == ptr)
            return;
         ...
         SCpyMsgMsg(cell->siCb.crntSiInfo.si[crntSiCtx->siId-1],
               ...
               rgSchCb[cell->instIdx].rgSchInit.pool,
               &subfrmAlloc->cmnLcInfo.bcchInfo.pdu);
# 11051 "../..//ltemac/rg_sch_cmn.c"
         subFrm->bcch.pdcch->dci.u.format1aInfo.t.pdschInfo.allocInfo.rv =
            rgSCHCmnDlCalcRvForBcch(cell, 1, i);
      }
# 11066 "../..//ltemac/rg_sch_cmn.c"
...
# 11242 "../..//ltemac/rg_sch_cmn.c"
   ...
   rgSCHCmnUlRbAllocForLst(cell, sf, allocInfo->ueLst.count,
         ...
         &allocInfo->nonSchdUeLst, (Bool)0);

   return;
}
# 11295 "../..//ltemac/rg_sch_cmn.c"
...
# 11417 "../..//ltemac/rg_sch_cmn.c"
{
   RgSchCmnUlCell *cellUl = &(((RgSchCmnCell *)((cell)->sc.sch))->ul);
   RgSchCmnUlUe *ueUl = &(((RgSchCmnUe *)((ue)->sch))->ul);
# 11428 "../..//ltemac/rg_sch_cmn.c"
   ...
   CmLteUeCategory ueCtg = (((((RgSchCmnUe *)((ue)->sch)))->cmn.ueCat + 1));
   ...
   if(pdcch == 0L)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 11458); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHCmnUlRbAllocForUe(): Could not get PDCCH\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };

      return(1);
   }

   iTbs = rgSCHCmnUlGetITbs(ue, cell->isCpUlExtend);
# 11472 "../..//ltemac/rg_sch_cmn.c"
   if (!cell->isCpUlExtend)
   {
...
# 11504 "../..//ltemac/rg_sch_cmn.c"
   ...
   else
   {
     ...
     if(((numSb*sbSize) + rbstart) > maxRb)
     {

       numSb = ((maxRb - rbstart)/sbSize);
     ...
     if(!numSb)
     {
         if((sbSize +rbstart) < cellUl->maxUlBwPerUe)
             numSb = 1;
   ...
   if(numSb)
   {
   alloc = rgSCHCmnUlSbAlloc(sf, (U8) (((numSb) <= (cellUl->maxSbPerUe) ? (numSb) : (cellUl->maxSbPerUe))), hole, retxNumSb);

   }
   if (alloc == 0L)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 11594); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHCmnUlRbAllocForUe(): Could not get UlAlloc\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 11697 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 11715 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 11771); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnUlAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 11797 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnDlAllocFnlz
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *allocInfo
)
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 11813); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 12093 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnCnsldtSfAlloc
(
RgSchCellCb *cell
)
...
# 12126 "../..//ltemac/rg_sch_cmn.c"
   if ((cell->crntTime.subframe + ((2 + 1) - 2)) >= 10) subfrmAlloc->timingInfo.sfn = (cell->crntTime.sfn + (cell->crntTime.subframe + ((2 + 1) - 2))/10) % 1024; else subfrmAlloc->timingInfo.sfn = cell->crntTime.sfn; subfrmAlloc->timingInfo.subframe = (cell->crntTime.subframe + ((2 + 1) - 2)) % 10;;
   ...
   {
# 12167 "../..//ltemac/rg_sch_cmn.c"
         RgSchMacSfAlloc(&pst, subfrmAlloc);
   }

   return;
}
# 12187 "../..//ltemac/rg_sch_cmn.c"
...
# 12242 "../..//ltemac/rg_sch_cmn.c"
   return;
}
# 12259 "../..//ltemac/rg_sch_cmn.c"
...
# 12299 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnDlAlloc
(
RgSchCellCb *cell
)
...
# 12498 "../..//ltemac/rg_sch_cmn.c"
   ...
   if (cell->ulSchdType != 2)
   {
      ueUl->effBsr = ((ueUl->nonLcg0Bs) <= (ueUl->effUeBR) ? (ueUl->nonLcg0Bs) : (ueUl->effUeBR)) + ((RgSchCmnLcg *)(ue->ul.lcgArr[0].sch))->bs;

   }
   else
   {
      ueUl->effBsr = ueUl->nonLcg0Bs + ((RgSchCmnLcg *)(ue->ul.lcgArr[0].sch))->bs;
...
# 12716 "../..//ltemac/rg_sch_cmn.c"
   rgSCHCmnCnsldtSfAlloc(cell);

   cell->crntSfIdx = (++cell->crntSfIdx) % 10;
...
# 12831 "../..//ltemac/rg_sch_cmn.c"
   cellSch->apisDl->rgSCHDlDedBoUpd(cell, ue, svc);
   return;
}
# 12852 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 12908); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnDlMsg4ProcRmvFrmRetx():                  HqprocId=%d",hqP->procId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };

   if (hqP->tbInfo[0].ccchSchdInfo.retxLnk.node)
   {
      if (hqP->hqE->msg4Proc == hqP)
      {
         cmLListDelFrm(&cellSch->dl.msg4RetxLst, &hqP->tbInfo[0].ccchSchdInfo.retxLnk);
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 12963); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnDlProcAddToRetx():                  HqprocId=%d",hqP->procId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };

   if (hqP->hqE->msg4Proc == hqP)
   {
       { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 12967); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHCmnDlProcAddToRetx():                  msg4proc added for retx"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };



      cmLListAdd2Tail(&cellSch->dl.msg4RetxLst, &hqP->tbInfo[0].ccchSchdInfo.retxLnk);
   ...
   {
# 12994 "../..//ltemac/rg_sch_cmn.c"
      cellSch->apisDl->rgSCHDlProcAddToRetx(cell, hqP);
   }
   return;
}
# 13024 "../..//ltemac/rg_sch_cmn.c"
...
{
   RgSchCmnDlUe *ueDl = &(((RgSchCmnUe *)((ue)->sch))->dl);
   RgSchCmnUe *ueSch = ((RgSchCmnUe *)((ue)->sch));

   Inst inst = cell->instIdx;

   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13043); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlSetUeRi\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   ueDl->mimoInfo.ri = ((ri) <= (rgUeCatTbl[ueSch->cmn.ueCat].maxTxLyrs) ? (ri) : (rgUeCatTbl[ueSch->cmn.ueCat].maxTxLyrs));
...
# 13084 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnDlSetUePmi
(
RgSchCellCb *cell,
RgSchUeCb *ue,
U8 pmi
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13102); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlSetUePmi\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13199); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCqiOnPucchInd \n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 13208 "../..//ltemac/rg_sch_cmn.c"
   switch(pucchCqi->mode)
   {
      case TFU_PUCCH_CQI_MODE10:
         ...
         else if (pucchCqi->u.mode10Info.type == TFU_RPT_RI)
         {
            ...
            {
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13241); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid RI value(%x)\n", pucchCqi->u.mode10Info.u.ri); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case TFU_PUCCH_CQI_MODE11:
         if (pucchCqi->u.mode11Info.type == TFU_RPT_CQI)
         {
                  ...
                  (pucchCqi->u.mode11Info.u.cqi.cqi < 16))
            {
               ...
               {
                  ueDl->mimoInfo.cwInfo[1].cqi = ueDl->mimoInfo.cwInfo[0].cqi - rgSchCmnDlCqiDiffOfst[pucchCqi->u.mode11Info.u. cqi.wideDiffCqi.val];
            ...
            rgSCHCmnDlSetUePmi(cell, ue, pucchCqi->u.mode11Info.u.cqi.pmi);
         ...
         else if (pucchCqi->u.mode11Info.type == TFU_RPT_RI)
         {
            ...
            {
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13289); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid RI value(%x)\n", pucchCqi->u.mode11Info.u.ri); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case TFU_PUCCH_CQI_MODE20:
         if (pucchCqi->u.mode20Info.type == TFU_RPT_CQI)
         {
            ...
            if (pucchCqi->u.mode20Info.u.cqi.isWideband)
            {
               ...
               {
                  ueDl->mimoInfo.cwInfo[0].cqi = pucchCqi->u.mode20Info.u.cqi. u.wideCqi;
         ...
         else if (pucchCqi->u.mode20Info.type == TFU_RPT_RI)
         {
            ...
            {
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13329); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid RI value(%x)\n", pucchCqi->u.mode20Info.u.ri); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case TFU_PUCCH_CQI_MODE21:
         if (pucchCqi->u.mode21Info.type == TFU_RPT_CQI)
         {
            ...
            if (pucchCqi->u.mode21Info.u.cqi.isWideband)
            {
               ...
               {
                  ueDl->mimoInfo.cwInfo[0].cqi = pucchCqi->u.mode21Info.u.cqi. u.wideCqi.cqi;

                  if (pucchCqi->u.mode21Info.u.cqi.u.wideCqi.diffCqi.pres)
                  {
                     ueDl->mimoInfo.cwInfo[1].cqi = ueDl->mimoInfo.cwInfo[0].cqi - rgSchCmnDlCqiDiffOfst[pucchCqi->u.mode21Info.u. cqi.u.wideCqi.diffCqi.val];
               ...
               rgSCHCmnDlSetUePmi(cell, ue, pucchCqi->u.mode21Info.u.cqi.u.wideCqi.pmi);
         ...
         else if (pucchCqi->u.mode21Info.type == TFU_RPT_RI)
         {
            ...
            {
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13382); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid RI value(%x)\n", pucchCqi->u.mode21Info.u.ri); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      default:
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13390); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Unknown CQI Mode %d\n", pucchCqi->mode); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13468); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCqiOnPuschInd \n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   if (puschCqi->ri.pres == 1)
   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13479); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid RI value(%x)\n", puschCqi->ri.val); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         return;
      }
   }
# 13491 "../..//ltemac/rg_sch_cmn.c"
   switch(puschCqi->mode)
   {
      ...
      default:
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13644); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Unknown CQI Mode %d\n", puschCqi->mode); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 13653 "../..//ltemac/rg_sch_cmn.c"
         }
         break;
   }
...
{
   RgSchCmnCell *cellSch = ((RgSchCmnCell *)((cell)->sc.sch));
# 13706 "../..//ltemac/rg_sch_cmn.c"
   Inst inst = cell->instIdx;

   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 13709); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlCqiInd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 13721 "../..//ltemac/rg_sch_cmn.c"
...
# 13753 "../..//ltemac/rg_sch_cmn.c"
   rgSCHCmnDlSetUeAllocLmt(cellSch, &(((RgSchCmnUe *)((ue)->sch))->dl));
...

{
   ...
   if (rgSCHCmnUeIdleExdThrsld(cell, ue) == 0)
   {
...
# 14309 "../..//ltemac/rg_sch_cmn.c"
   for (lcgCnt=0; lcgCnt<4; lcgCnt++)
   {
# 14328 "../..//ltemac/rg_sch_cmn.c"
...
# 14390 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   {
# 14422 "../..//ltemac/rg_sch_cmn.c"
      ((RgSchCmnLcg *)(ue->ul.lcgArr[cnt].sch))->bs = 0;
   }
   ((RgSchCmnLcg *)(ulLcg->sch))->bs = rgSchCmnBsrTbl[bsr];
   ueUl->totalBsr = rgSchCmnBsrTbl[bsr];
# 14439 "../..//ltemac/rg_sch_cmn.c"
...
# 14511 "../..//ltemac/rg_sch_cmn.c"
   ...
   if ((ue->bsrTmr.tmrEvnt != -1) && (ueUl->totalBsr == 0))
   {
      rgSCHTmrStopTmr(cell, ue->bsrTmr.tmrEvnt, ue);
   }
...

{
   ...
   {
      nonLcg0Bs = outStndAlloc - ((RgSchCmnLcg *)(ue->ul.lcgArr[0].sch))->bs;
...

{
   ...
   CmLteUeCategory ueCtgy = (((((RgSchCmnUe *)((ue)->sch)))->cmn.ueCat + 1));
   U8 cqi;

   ;;
# 15554 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   if (ue->dl.dlAllocCb.reqLnk.node == 0L)
   {
      cmLListAdd2Tail(&allocInfo->dedAlloc.txUeLst, &ue->dl.dlAllocCb.reqLnk);
      ue->dl.dlAllocCb.reqLnk.node = (U32)ue;
   }
   return;
}
# 15623 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   cmLListAdd2Tail(&allocInfo->dedAlloc.retxUeLst, &ue->dl.dlAllocCb.reqLnk);
   ue->dl.dlAllocCb.reqLnk.node = (U32)ue;
   return;
}
# 15659 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   cmLListAdd2Tail(&allocInfo->dedAlloc.txRetxUeLst, &ue->dl.dlAllocCb.reqLnk);
   ue->dl.dlAllocCb.reqLnk.node = (U32)ue;
   return;
}
# 16480 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   U32 sfDiff = (cell->crntTime.sfn*10+cell->crntTime.subframe) < (ueUl->ulTransTime.sfn*10+ueUl->ulTransTime.subframe)? ((cell->crntTime.sfn+1024)*10+cell->crntTime.subframe) - (ueUl->ulTransTime.sfn*10+ueUl->ulTransTime.subframe) : (cell->crntTime.sfn*10+cell->crntTime.subframe) - (ueUl->ulTransTime.sfn*10+ueUl->ulTransTime.subframe);

   ;;



   if (sfDiff > (U32)((ue->dl.taCb.cfgTaTmr > 0)? (3 * ue->dl.taCb.cfgTaTmr) : (3 * 10)))
   {
      return(0);
   }
   else
...

{
   ...
   {
      cellSch->rachCfg.rapIdMap[cnt].rapId = cellSch->rachCfg.dedPrmStart + cnt;
   ...
   {
      cellSch->rachCfg.applFrm.sfn = (cell->crntTime.sfn + (cell->crntTime.sfn % 2)) % 1024;

   }
# 16698 "../..//ltemac/rg_sch_cmn.c"
   else
   {
   ...
   if (cellSch->rachCfg.applFrm.sfn == cell->crntTime.sfn)
   {
      ...
      {
         if (cell->crntTime.subframe < cell->rachCfg.raOccasion.subFrameNum[cellSch->rachCfg.prachMskIndx])
      ...
      if (cellSch->rachCfg.prachMskIndx == cell->rachCfg.raOccasion.size)
      {
         ...
         {
            cellSch->rachCfg.applFrm.sfn = (cellSch->rachCfg.applFrm.sfn+1) % 1024;

         }
         else
         {
            cellSch->rachCfg.applFrm.sfn = (cellSch->rachCfg.applFrm.sfn+2) % 1024;

         }
         cellSch->rachCfg.prachMskIndx = 0;
      }
      cellSch->rachCfg.applFrm.subframe = cell->rachCfg.raOccasion.subFrameNum[cellSch->rachCfg.prachMskIndx];
...

{
   ...
   if (cellSch->rachCfg.prachMskIndx == cell->rachCfg.raOccasion.size - 1)
   {
      ...
      cellSch->rachCfg.applFrm.subframe = cell->rachCfg.raOccasion. subFrameNum[0];
...
# 16901 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   if (cell->macPreambleSet.pres == 1)
   {
      ...
      if ((*pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, ueDl->mimoInfo.cwInfo[0].cqi, TFU_DCI_FORMAT_1A, 0)) == 0L)
      {
         return(1);
      }
      ...
      *rapId = cellSch->rachCfg.dedPrmStart +
      ...
      cmLListAdd2Tail(&cellSch->rachCfg.rapIdMap[*rapId - cellSch-> rachCfg.dedPrmStart].assgndUes, &ueDl->rachInfo.rapIdLnk);
...

{
   ...
   while (node)
   {
      ...
      if (rgSCHCmnAllocPOParam(cell, dlSf, ue, &pdcch, &rapId, &prachMskIdx) != 0)

      {
# 17025 "../..//ltemac/rg_sch_cmn.c"
         break;
      }
...

{
   ...
   {
      cmLListDelFrm(&cellSch->rachCfg.rapIdMap[ueDl->rachInfo.poRapId - cellSch->rachCfg.dedPrmStart].assgndUes, &ueDl->rachInfo.rapIdLnk);

      ueDl->rachInfo.rapIdLnk.node = 0L;
   }
   return;
}
# 17236 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 17255); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnHdlHoPo\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 17323); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnGetHoUe\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 17381); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnGetPoUe\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   ueLst = &cellSch->rachCfg.rapIdMap[raReq->raReq.rapId - cellSch->rachCfg.dedPrmStart].assgndUes;
...
# 17422 "../..//ltemac/rg_sch_cmn.c"
static U8 rgSCHCmnUlGetCqi
(
RgSchUeCb *ue,
...
# 17544 "../..//ltemac/rg_sch_cmn.c"
   eff = rgSchCmnNorUlEff[0][iTbs];


   bits = ueUl->alloc.reqBytes * 8;
# 17556 "../..//ltemac/rg_sch_cmn.c"
   if (bits < rgSCHCmnUlMinTbBitsForITbs(cellUl, iTbs))
   {
      numSb = 1;
   }
   ...
   alloc = rgSCHCmnUlSbAlloc(sf, (U8)((numSb) <= (cellUl->maxSbPerUe) ? (numSb) : (cellUl->maxSbPerUe)), hole, (U8)0);

   if (alloc == 0L)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 17590); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHCmnUlRbAllocForPoHoUe(): Could not get UlAlloc\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 17667); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnAllocPoHoGrnt\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   if (!dstAlloc->forMsg3)
   {
      ueUl = &(((RgSchCmnUe *)((dstAlloc->ue)->sch))->ul);
      ueUl->alloc.alloc = dstAlloc;
# 17826 "../..//ltemac/rg_sch_cmn.c"
   }

   return;
}
# 17853 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   if ((alloc = rgSCHUtlUlAllocFirst(newSf)) != 0L)
   {
      do
      {
         ...
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 18082); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHCmnUlPrcNonAdptRetx(): Non-Adpt RETX                 for rnti %d\n", alloc->rnti); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
  ...
  if(alloc->ue != 0L)
  {
      ...
      hqRetxStats.ulCqiStat[(cqi - 1)].totalTx = hqRetxStats.ulCqiStat[(cqi - 1)].numOfHQ_1 + (hqRetxStats.ulCqiStat[(cqi - 1)].numOfHQ_2 * 2) + (hqRetxStats.ulCqiStat[(cqi - 1)].numOfHQ_3 * 3) + (hqRetxStats.ulCqiStat[(cqi - 1)].numOfHQ_4 * 4);
         ...
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 18221); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHCmnUlRmvCmpltdAllocs():                 Process removed from allocation for rnti %d\n", alloc->rnti); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   alloc->hqProc->reTxAlloc.tbSz =
      ...
      rgTbSzTbl[0][rgSCHCmnUlGetITbsFrmIMcs(alloc->grnt.iMcs)] [alloc->grnt.numRb-1]/8;
...
# 18358 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnUlAdapRetxForUe
(
RgSchCellCb *cell,
RgSchUlSf *sf,
RgSchUlHqProcCb *proc,
...

{
   ...
   S16 ret;
   ;;
   ret = rgSCHCmnUlRbAllocForUe(cell, sf, ue, maxRb, 1, hole);
   if(ret != 0)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 18382); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHCmnUlAdapRetxForUe(): Could not do " "allocation for UE %d in this TTI\n", ue->ueId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 18390); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHCmnUlAdapRetxForUe(): alloc made           for UE %d\n", ue->ueId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 18414 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHCmnUlAdapRetxForMsg3
(
RgSchCellCb *cell,
RgSchUlSf *sf,
RgSchUlHqProcCb *proc,
...

{
   ...
   if (pdcch == 0L)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 18452); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Common PDCCH unavailable for msg3 retx for cell: %d\n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   if (numSb <= hole->num)
   {
      ...
      pdcch->dci.u.format0Info.nDmrs = alloc->grnt.nDmrs;
      pdcch->dci.u.format0Info.tpcCmd = alloc->grnt.tpc;
# 18512 "../..//ltemac/rg_sch_cmn.c"
   }
   return;
}
# 18531 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 18685); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnDlRbAlloc: cellId: %d isCellFreqSel: %d\n", cell->cellId, cellSch->dl.isDlFreqSel); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 18715 "../..//ltemac/rg_sch_cmn.c"
   return;
}
# 19636 "../..//ltemac/rg_sch_cmn.c"
...
# 19652 "../..//ltemac/rg_sch_cmn.c"
{
    ...
    U8 numResvdRePerSf = ((dlSf->pcfichInfo * 12) + (cell->numCellRSPerSf - (1 << cell->numTxAntPorts)));
    ...
    if(dlSf->sfNum == 5)
    {
        ...
        numResvdRePerSpclSf = (((dlSf->pcfichInfo + 2) *
                                  12) + (cell->numCellRSPerSf - (1 << cell->numTxAntPorts)));
    }
    else if (dlSf->sfNum == 0)
    {
        rgSCHCmnFindNumPbchOvrlapRbs(cell,dlSf,allocInfo,&numOvrlapgPbchRb);
        numResvdRePerSpclSf = (((dlSf->pcfichInfo + 2 + 4) *
                                  12) + (cell->numCellRSPerSf - ((1 << cell->numTxAntPorts)*2)));
    }

    numPdschRe = (12 * 14 * allocInfo->rbsReq) - ((numResvdRePerSf * (allocInfo->rbsReq - numOvrlapgPbchRb)) + (numResvdRePerSpclSf * numOvrlapgPbchRb));



    code_rate = (((allocInfo->tbInfo[idx].bytesReq)*8*100)/(numPdschRe * 6));

    { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 19684); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "\n rgSCHCmnFindCodeRate tbSize=%lu numPdschRe=%lu coderate=%lu", allocInfo->tbInfo[idx].bytesReq,numPdschRe,code_rate); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };



    return;
}
# 19712 "../..//ltemac/rg_sch_cmn.c"
...
# 19876 "../..//ltemac/rg_sch_cmn.c"
{
    ...
    if (allocInfo->raType == 0)
    {
         addtlRbsAvl = (((dlSf->type0End - dlSf->type2End + 1)* cell->rbgSize) - dlSf->lstRbgDfct) - allocInfo->rbsReq;
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 20021); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnNonDlfsPbchRbAllocAdj: cell: %d\n", cell->cellId ); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 20224 "../..//ltemac/rg_sch_cmn.c"
   if(dlSf->bwAlloced == dlSf->bw)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 20228); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: DL BW exhausted for common allocation" " cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (allocInfo->rbsReq > (dlSf->bw - dlSf->bwAlloced))
   {
      ...
      {
# 20256 "../..//ltemac/rg_sch_cmn.c"
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 20259); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: DL BW exhausted for common allocation" " cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 20273 "../..//ltemac/rg_sch_cmn.c"
   allocInfo->pdcch = rgSCHCmnCmnPdcchAlloc(cell, dlSf);
   if (allocInfo->pdcch == 0L)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 20278); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: common PDCCH exhausted for cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 20292 "../..//ltemac/rg_sch_cmn.c"
   ...
   rgSCHCmnNonDlfsUpdTyp2Alloc(cell, dlSf, allocInfo->allocInfo.raType2.rbStart, allocInfo->allocInfo.raType2.numRb);




   allocInfo->tbInfo[0].bytesAlloc = allocInfo->tbInfo[0].bytesReq;
# 20381 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 20405 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   if (allocInfo->raType == 0)
   {
    ...
    dlSf->lstRbgDfct = 0;
      ...
      if(allocInfo->rbsReq <= (((dlSf->type0End - dlSf->type2End + 1)* cell->rbgSize) - dlSf->lstRbgDfct))
      ...
      else
      {
         ...
         if(allocInfo->tbInfo[0].tbCb->txCntr == 0)
         {
            ...
            allocInfo->rbsReq = (((dlSf->type0End - dlSf->type2End + 1)* cell->rbgSize) - dlSf->lstRbgDfct);
...

{
   ...
   dlUe = &(((RgSchCmnUe *)((ue)->sch))->dl);
   allocInfo = &((ue)->dl.dlAllocCb);;
   *isDlBwAvail = 1;


   if (rgSCHCmnNonDlfsBwAvlbl(cell, dlSf, allocInfo) != 1)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 20816); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: DL BW exhausted for dedicated allocation" " cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      allocInfo->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, dlUe->mimoInfo.cwInfo[0].cqi, allocInfo->dciFormat, 1);
   }
   else
   {
      allocInfo->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, dlUe->mimoInfo.cwInfo[0].cqi, allocInfo->dciFormat,0);
   }
   if (!(allocInfo->pdcch))
   {
      ...
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 20846); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: PDCCH exhausted for ue: %d, cqi: %d\n", ue->ueId, dlUe->mimoInfo.cwInfo[0].cqi); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };


      return(1);
   }
# 20859 "../..//ltemac/rg_sch_cmn.c"
      if(dlSf->sfNum)
      {
...
# 21006 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 21031 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21074); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnNonDlfsCcchSduAlloc: cell: %d, reqLst Count: %d\n", cell->cellId, (int)ccchSduLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      ueCb = (RgSchUeCb *)(toBeSchdLnk->node);
      dlAlloc = &((ueCb)->dl.dlAllocCb);;
      schdLnkNode = &dlAlloc->schdLstLnk;
      { (schdLnkNode)->node = (U32)ueCb; (schdLnkNode)->prev = 0L; (schdLnkNode)->next = 0L;};
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21108); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnNonDlfsCcchSduAlloc done: cell: %d, allocLst Count: %d" " nonallocLst count: %d \n", cell->cellId, (int)schdCcchSduLst->count,(int)nonSchdCcchSduLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   U32 y;
   RgSchDlRbAlloc *allocInfo;
   RgSchCmnDlUe *ueDl = &(((RgSchCmnUe *)((ueCb)->sch))->dl);
   ...
   allocInfo = &((ueCb)->dl.dlAllocCb);;


   if(dlSf->bwAlloced == dlSf->bw)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21167); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: DL BW exhausted for CcchSdu allocation" " cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (allocInfo->rbsReq > (dlSf->bw - dlSf->bwAlloced))
   {
      ...
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21191); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: DL BW exhausted for common allocation" " cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (ueDl->proc->tbInfo[0].isAckNackDtx == 4)
   {
      ...
      allocInfo->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, ueDl->mimoInfo.cwInfo[0].cqi, TFU_DCI_FORMAT_1A, 1);
   }
   else
   {
      allocInfo->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, ueDl->mimoInfo.cwInfo[0].cqi, TFU_DCI_FORMAT_1A, 0);
   }
   if (!(allocInfo->pdcch))
   {

      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21214); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: PCCCH exhausted for CcchSdu, cqi: %d\n", ueDl->mimoInfo.cwInfo[0].cqi); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   if(dlSf->bwAlloced == dlSf->bw)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21333); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: DL BW exhausted for Msg4 allocation" " cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (allocInfo->rbsReq > (dlSf->bw - dlSf->bwAlloced))
   {
      ...
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21353); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: DL BW exhausted for common allocation" " cell: %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      allocInfo->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, raCb->ccchCqi, TFU_DCI_FORMAT_1A, 1);
   }
   else
   {
      allocInfo->pdcch = rgSCHCmnPdcchAlloc(cell, dlSf, y, raCb->ccchCqi, TFU_DCI_FORMAT_1A, 0);
   }
   if (!(allocInfo->pdcch))
   {

      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21378); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Non-DLFS allocation: PCCCH exhausted for Msg4, cqi: %d\n", raCb->ccchCqi); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21513); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnNonDlfsMsg4Alloc: cell: %d, reqLst Count: %d\n", cell->cellId, (int)msg4Lst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   for (; toBeSchdLnk; toBeSchdLnk = toBeSchdLnk->next)
   {
      raCb = (RgSchRaCb *)(toBeSchdLnk->node);
      dlAlloc = &((raCb)->rbAllocInfo);;
      schdLnkNode = &dlAlloc->schdLstLnk;
      { (schdLnkNode)->node = (U32)raCb; (schdLnkNode)->prev = 0L; (schdLnkNode)->next = 0L;};
...
# 21551 "../..//ltemac/rg_sch_cmn.c"
   }

   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21556); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnNonDlfsMsg4Alloc done: cell: %d, allocLst Count: %d" " nonallocLst count: %d \n", cell->cellId, (int)schdMsg4Lst->count,(int)nonSchdMsg4Lst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 21602 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21626); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnNonDlfsDedRbAlloc: cell: %d, reqLst Count: %d\n", cell->cellId, (int)ueLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   for (; toBeSchdLnk; toBeSchdLnk = toBeSchdLnk->next)
   {
      ue = (RgSchUeCb *)(toBeSchdLnk->node);
      dlAlloc = &((ue)->dl.dlAllocCb);;
      schdLnkNode = &dlAlloc->schdLstLnk;
      { (schdLnkNode)->node = (U32)ue; (schdLnkNode)->prev = 0L; (schdLnkNode)->next = 0L;};
      ...
      if (!isDlBwAvail)
      {
         ...
         do
         {
            ...
            schdLnkNode = &dlAlloc->schdLstLnk;
            { (schdLnkNode)->node = (U32)ue; (schdLnkNode)->prev = 0L; (schdLnkNode)->next = 0L;};
            cmLListAdd2Tail(nonSchdUeLst, schdLnkNode);
            toBeSchdLnk = toBeSchdLnk->next;
         } while(toBeSchdLnk);
         return;
      }
      ...
      if (ret == 0)
      {
         ...
         cmLListAdd2Tail(schdUeLst, schdLnkNode);
   {
# 21680 "../..//ltemac/rg_sch_cmn.c"
   }
      }
      else
      {
...
# 21712 "../..//ltemac/rg_sch_cmn.c"
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 21715); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHCmnNonDlfsDedRbAlloc done: cell: %d, allocLst Count: %d" " nonallocLst count: %d \n", cell->cellId, (int)schdUeLst->count,(int)nonSchdUeLst->count); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...
# 22124 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   allocInfo->dciFormat = rgSCHCmnSlctPdcchFrmt(cell, ue, &allocInfo->raType);

   ret = rgSCHCmnDlAlloc1CwTxRb(cell, subFrm, ue, &proc->tbInfo[0], bo, &numRb, effBo);
   ...
   {
      rgSCHCmnDlRbInfoAddUeTx(cellWdAllocInfo, ue);
   }
...
# 22202 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   {
      rgSCHCmnDlRbInfoAddUeRetx(cellWdAllocInfo, ue);
   }
...
# 22389 "../..//ltemac/rg_sch_cmn.c"
{
   ;;
   rgSCHCmnDlAllocTxRb1Tb1Cw(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);
   return;
}
# 22421 "../..//ltemac/rg_sch_cmn.c"
...
# 22441 "../..//ltemac/rg_sch_cmn.c"
{
   ;;
   rgSCHCmnDlAllocRetxRb1Tb1Cw(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);
   return;
}
# 22473 "../..//ltemac/rg_sch_cmn.c"
...
# 22493 "../..//ltemac/rg_sch_cmn.c"
{

   ;;


   rgSCHCmnDlTM3TxTx(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);


   return;
}
# 22530 "../..//ltemac/rg_sch_cmn.c"
...
# 22550 "../..//ltemac/rg_sch_cmn.c"
{
         ...
         (proc->tbInfo[1].state == HQ_TB_NACKED))
   {
      ...
      rgSCHCmnDlTM3RetxRetx(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);
   ...
   else
   {
      ...
      rgSCHCmnDlTM3TxRetx(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);

   }

   return;
}
# 22600 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 22619); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnSlctPdcchFrmt\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 22685 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   allocInfo = &((ue)->dl.dlAllocCb);;
   swpFlg = 0;
# 22722 "../..//ltemac/rg_sch_cmn.c"
   {
      allocInfo->dciFormat = TFU_DCI_FORMAT_2A;
      allocInfo->raType = 0;

      ret = rgSCHCmnDlAlloc2CwRetxRb(cell, subFrm, ue, proc, &numRb, &swpFlg, effBo);
      ...
      precInfo = (getPrecInfoFunc[0][cell->numTxAntPorts/2 - 1]) (ue, noTxLyrs, 1);
...
# 22814 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   else
   {
      ...
      if (ueDl->mimoInfo.ri > 1)
      {
         ...
         precInfo = (getPrecInfoFunc[1][cell->numTxAntPorts/2 - 1]) (ue, noTxLyrs, 1);
      ...
      else
      {
         ...
         noTxLyrs = 1;
         precInfo = (getPrecInfoFunc[1][cell->numTxAntPorts/2 - 1]) (ue, noTxLyrs, 0);
...
# 23260 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   rgSCHCmnDlSMGetAttrForTxRetx(ue, proc, retxTb, txTb, frthrScp, swpFlg);
   ...
   if (*frthrScp)
   {
      ...
      *prcdngInf = (getPrecInfoFunc[0][cell->numTxAntPorts/2 - 1]) (ue, ueDl->mimoInfo.ri, *frthrScp);
   ...
   else
   {
      ...
      else
      {
         if ((*retxTb)->numLyrs == 2)
         {
            ...
            *dciFrmt = TFU_DCI_FORMAT_2A;
            *raType = 0;
            *prcdngInf = (getPrecInfoFunc[0][cell->numTxAntPorts/2 - 1]) (ue, *numTxLyrs, *frthrScp);
...
# 23427 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   *frthrScp = 0 ;
   ...
   if (ueDl->mimoInfo.ri == 1)
   {
      ...
      *raType = 0;
      *frthrScp = 0;
      *prcdngInf = (getPrecInfoFunc[1][cell->numTxAntPorts/2 - 1]) (ue, *numTxLyrs, 0);
   ...
   *raType = 0;
   if (*frthrScp)
   {
      ...
      *prcdngInf = (getPrecInfoFunc[1][cell->numTxAntPorts/2 - 1]) (ue, ueDl->mimoInfo.ri, *frthrScp);
   ...
   else
   {
      if (cell->numTxAntPorts == 2)
      {
         ...
         *numTxLyrs = 1;
         *prcdngInf = (getPrecInfoFunc[1][cell->numTxAntPorts/2 - 1]) (ue, *numTxLyrs, *frthrScp);
...
# 23586 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   rgSCHCmnDlGetAttrForTM3(cell, ue, proc, &numTxLyrs, &allocInfo->dciFormat, &prcdngInf, &retxTb, &txTb, &frthrScp, &swpFlg, &allocInfo->raType);


   if (frthrScp)
   {
      ret = rgSCHCmnDlAlloc2CwTxRetxRb(cell, subFrm, ue, retxTb, txTb, &numRb, effBo);
...
# 23630 "../..//ltemac/rg_sch_cmn.c"
      rgSCHCmnDlRbInfoAddUeRetxTx(cellWdAllocInfo, ue);
   }
   else
   {
...
# 23711 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   rgSCHCmnDlGetAttrForTM4(cell, ue, proc, &numTxLyrs, &allocInfo->dciFormat, &prcdngInf, &retxTb, &txTb, &frthrScp, &swpFlg, &allocInfo->raType);
...
# 24067 "../..//ltemac/rg_sch_cmn.c"
{
   ;;


   rgSCHCmnDlTM4TxTx(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);


   return;
}
# 24104 "../..//ltemac/rg_sch_cmn.c"
...
# 24124 "../..//ltemac/rg_sch_cmn.c"
{
         ...
         (proc->tbInfo[1].state == HQ_TB_NACKED))
   {
      ...
      rgSCHCmnDlTM4RetxRetx(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);
   ...
   else
   {
      ...
      rgSCHCmnDlTM4TxRetx(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);

   }

   return;
}
# 24281 "../..//ltemac/rg_sch_cmn.c"
...
# 24485 "../..//ltemac/rg_sch_cmn.c"
{
   ;;
   rgSCHCmnDlAllocTxRb1Tb1Cw(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);
   return;
}
# 24517 "../..//ltemac/rg_sch_cmn.c"
...
# 24537 "../..//ltemac/rg_sch_cmn.c"
{
   ;;
   rgSCHCmnDlAllocRetxRb1Tb1Cw(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);
   return;
}
# 24566 "../..//ltemac/rg_sch_cmn.c"
...
# 24586 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   *effBo = 0;
   ...
   (dlAllocTxRbFunc[ue->mimoInfo.txMode - 1])(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);


   return(0);
}
# 24627 "../..//ltemac/rg_sch_cmn.c"
...
# 24713 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   *effBo = 0;
   ...
   (dlAllocRetxRbFunc[ue->mimoInfo.txMode - 1])(cell, subFrm, ue, bo, effBo, proc, cellWdAllocInfo);


   return(0);
}
# 24763 "../..//ltemac/rg_sch_cmn.c"
...
# 24783 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 24809); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlAlloc1CwTxRb\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   if ((allocInfo->rbsReq >= ueDl->maxRb) ||
         (allocInfo->tbInfo[0].bytesReq >= ueDl->maxTbSz/8))
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 24816); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnDlAllocRb():               UEs max allocation exceed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   tempNumRb = (((noRes) + (cellDl->noResPerRb)-1) / (cellDl->noResPerRb));
   ...
   if ((S16)(tempNumRb - allocInfo->rbsReq) > (S16)(subFrm->bw - subFrm->bwAssigned))

   {
      tempNumRb = subFrm->bw - subFrm->bwAssigned + allocInfo->rbsReq;
   }
# 24862 "../..//ltemac/rg_sch_cmn.c"
...
# 24997 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25023); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlAlloc2CwTxRb\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   if ((allocInfo->tbInfo[0].bytesReq + allocInfo->tbInfo[1].bytesReq >= ueDl->maxTbBits/8) ||

         (allocInfo->tbInfo[0].bytesReq >= ueDl->maxTbSz/8) ||
         (allocInfo->tbInfo[1].bytesReq >= ueDl->maxTbSz/8) ||
         (allocInfo->rbsReq >= ueDl->maxRb))
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25033); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHCmnDlAllocRb():               UEs max allocation exceed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   bo = (((bo*eff1)/(eff1+eff2)) <= (ueDl->maxTbSz/8) ? ((bo*eff1)/(eff1+eff2)) : (ueDl->maxTbSz/8)) +
      (((bo*eff2)/(eff1+eff2)) <= (ueDl->maxTbSz/8) ? ((bo*eff2)/(eff1+eff2)) : (ueDl->maxTbSz/8)) +
      1;
   ...
   numRb = (((noRes) + (cellDl->noResPerRb)-1) / (cellDl->noResPerRb));
   ...
   if ((S16)(numRb - allocInfo->rbsReq) > (S16)(subFrm->bw - subFrm->bwAssigned))

   {
      numRb = subFrm->bw - subFrm->bwAssigned + allocInfo->rbsReq;
   }
# 25085 "../..//ltemac/rg_sch_cmn.c"
   subFrm->bwAssigned = subFrm->bwAssigned + numRb - allocInfo->rbsReq;
   ...
   *numRbRef = (U8)numRb;
# 25113 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 25143 "../..//ltemac/rg_sch_cmn.c"
...
# 25164 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25181); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlAlloc2CwTxRetxRb\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   *numRb = reTxTb->dlGrnt.numRb;
   ...
   do { if (otherCw->iTbs[noLyr2-1] <= 9) imcs2 = otherCw->iTbs[noLyr2-1]; else if (otherCw->iTbs[noLyr2-1] <= 15) imcs2 = otherCw->iTbs[noLyr2-1] + 1; else imcs2 = otherCw->iTbs[noLyr2-1] + 2;} while(0);
   tb2Sz = rgTbSzTbl[noLyr2-1][otherCw->iTbs[noLyr2-1]] [*numRb-1]/8;
   ...
   { (&allocInfo->tbInfo[1])->schdlngForTb = 1; (&allocInfo->tbInfo[1])->bytesReq = tb2Sz; (&allocInfo->tbInfo[1])->iTbs = otherCw->iTbs[noLyr2-1]; (&allocInfo->tbInfo[1])->imcs = imcs2; (&allocInfo->tbInfo[1])->tbCb = txTb; (&allocInfo->tbInfo[1])->noLyr = noLyr2;};

   *effBo = reTxTb->tbSz + tb2Sz;

   return(0);
}
# 25235 "../..//ltemac/rg_sch_cmn.c"
...
# 25256 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25269); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlAlloc2CwRetxRb\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 25306 "../..//ltemac/rg_sch_cmn.c"
   return(0);
}
# 25334 "../..//ltemac/rg_sch_cmn.c"
...
# 25355 "../..//ltemac/rg_sch_cmn.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25366); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlAlloc1CwRetxRb\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25643); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHCmnDlBcchPcchAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25713); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHBcchPcchDlRbAlloc: cellId: %d isCellFreqSel: %d\n", cell->cellId, cellSch->dl.isDlFreqSel); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25820); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHChkNUpdSiCfg\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   do { if ((crntTmInfo.subframe += (2 + 1) + 1) > 9) { crntTmInfo.sfn = ((crntTmInfo.sfn) + 1) & 0x03ff; crntTmInfo.subframe -= 10; }} while(0);
   ...
   {
      do{ if(0L != cell->siCb.crntSiInfo.mib) SPutMsg(cell->siCb.crntSiInfo.mib); cell->siCb.crntSiInfo.mib = cell->siCb.newSiInfo.mib; cell->siCb.newSiInfo.mib = 0L;}while(0);
   ...
   {
      do{ if(0L != cell->siCb.crntSiInfo.sib1) SPutMsg(cell->siCb.crntSiInfo.sib1); cell->siCb.crntSiInfo.sib1 = cell->siCb.newSiInfo.sib1; cell->siCb.newSiInfo.sib1 = 0L;}while(0);
   ...
   if(cell->siCb.siBitMask & (1<<3))
   {
            ...
            (cell->siCfg.numSi != cell->siCb.newSiCfg.numSi))
      {
         ...
         {
            do{ if(0L != cell->siCb.crntSiInfo.si[idx]) SPutMsg(cell->siCb.crntSiInfo.si[idx]); cell->siCb.crntSiInfo.si[idx] = cell->siCb.newSiInfo.si[idx]; cell->siCb.newSiInfo.si[idx] = 0L;}while(0);
         ...
         if(cell->siCfg.numSi > cell->siCb.newSiCfg.numSi)
         {
            ...
            {
               { if (0L != (cell->siCb.crntSiInfo.si[idx])) { SPutMsg((cell->siCb.crntSiInfo.si[idx])); cell->siCb.crntSiInfo.si[idx] = 0L; } };
            }
         }
      }
      else
      {
         ...
         {
            if(0L != cell->siCb.newSiInfo.si[idx])
            {
               do{ if(0L != cell->siCb.crntSiInfo.si[idx]) SPutMsg(cell->siCb.crntSiInfo.si[idx]); cell->siCb.crntSiInfo.si[idx] = cell->siCb.newSiInfo.si[idx]; cell->siCb.newSiInfo.si[idx] = 0L;}while(0);
   ...
   cell->siCb.siBitMask = 0;

   return;
}
# 25932 "../..//ltemac/rg_sch_cmn.c"
static Void rgSCHUpdSiCtx
(
RgSchCellCb *cell
)
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25949); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUpdSiCtx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if(0 != ((&cell->siCb.siCtxLst)->count))
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 25970); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUpdSiCtx:SI Context already exists, returning!\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for(idx = 0;idx < cell->siCfg.numSi;idx++)
   {
      ...
      if((crntTmInfo.sfn % cell->siCfg.siPeriodicity[idx] == 0)
            &&
            (0L != cell->siCb.crntSiInfo.si[idx])
        )
      {
         ...
         if ((cell->siCb.siCtx[idx].timeToTx.subframe + (cell->siCfg.siWinSize-1)) >= 10) cell->siCb.siCtx[idx].maxTimeToTx.sfn = (cell->siCb.siCtx[idx].timeToTx.sfn + (cell->siCb.siCtx[idx].timeToTx.subframe + (cell->siCfg.siWinSize-1))/10) % 1024; else cell->siCb.siCtx[idx].maxTimeToTx.sfn = cell->siCb.siCtx[idx].timeToTx.sfn; cell->siCb.siCtx[idx].maxTimeToTx.subframe = (cell->siCb.siCtx[idx].timeToTx.subframe + (cell->siCfg.siWinSize-1)) % 10;


            cmLListAdd2Tail(&cell->siCb.siCtxLst,
                  &cell->siCb.siCtx[idx].lnk);
         cell->siCb.siCtx[idx].lnk.node = (U32)&cell->siCb.siCtx[idx];
      }

      if ((nextTmInfo.subframe + (cell->siCfg.siWinSize)) >= 10) nextTmInfo.sfn = (nextTmInfo.sfn + (nextTmInfo.subframe + (cell->siCfg.siWinSize))/10) % 1024; else nextTmInfo.sfn = nextTmInfo.sfn; nextTmInfo.subframe = (nextTmInfo.subframe + (cell->siCfg.siWinSize)) % 10;

   }

   return;
}
# 26022 "../..//ltemac/rg_sch_cmn.c"
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 26048); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHDlSiSched\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   do { if ((crntTimInfo.subframe += (2 + 1) + 1) > 9) { crntTimInfo.sfn = ((crntTimInfo.sfn) + 1) & 0x03ff; crntTimInfo.subframe -= 10; }} while(0);
         ...
         && (5 == crntTimInfo.subframe))
   {
      ...
      if(0L == cell->siCb.crntSiInfo.sib1)
         return;
   ...
   else
   {
      ...
      ((((tmp) = ((&cell->siCb.siCtxLst)->crnt = (&cell->siCb.siCtxLst)->first)) != 0L) ? (tmp)->node : 0L);
      if(0L == tmp)
         return;
      ...
      SFndLenMsg(cell->siCb.crntSiInfo.si[crntSiCtx->siId-1],
            &msgLen);
      crntSiCtx->i = (crntTimInfo.sfn*10+crntTimInfo.subframe) < (crntSiCtx->timeToTx.sfn*10+crntSiCtx->timeToTx.subframe)? ((crntTimInfo.sfn+1024)*10+crntTimInfo.subframe) - (crntSiCtx->timeToTx.sfn*10+crntSiCtx->timeToTx.subframe) : (crntTimInfo.sfn*10+crntTimInfo.subframe) - (crntSiCtx->timeToTx.sfn*10+crntSiCtx->timeToTx.subframe);
   ...
   {
      SLogError(rgSchCb[cell->instIdx].rgSchInit.ent, rgSchCb[cell->instIdx].rgSchInit.inst, rgSchCb[cell->instIdx].rgSchInit.procId, (Txt *) "../..//ltemac/rg_sch_cmn.c", (S32) 26185, (ErrCls) (0x2), (ErrCode) (((0 + 0) + 11)), (ErrVal) ((ErrVal)msgLen), (Txt *) "rgSCHDlSiSched(): msgLen does not match            any valid TB Size.");
   ...
   if (rb > sf->bw - sf->bwAssigned)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 26211); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "\nrgSCHDlSiSched(): " "BW allocation failed."); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_cmn.c", 26349); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "\n rgSCHCmnChkRetxAllowDtx(): ueId=%d ", ueCb->ueId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
