...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//lterrc/nh_ex_ms.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//lterrc/nh_ex_ms.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 136 "../..//lterrc/nh_ex_ms.c" 2
# 163 "../..//lterrc/nh_ex_ms.c"
 S16 nhActvTsk
(
Pst *post,
Buffer *mBuf
      ...
      case 0x0E:
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ex_ms.c", 217); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhActvTsk: Invalid event(%d) from SM\n", pst->event); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      case 0xda :
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ex_ms.c", 272); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhActvTsk: Invalid event(%d) from RRC user\n", pst->event); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      case 0xd8 :
      {
         switch(pst->event)
         {
            ...
            case 0x41 :
               ...
               break;
            case 0x45 :
               cmUnpkPjuDatCfm(NhLiPjuDatCfm, pst, mBuf);
               break;
            case 0x44 :
            ...
            default:
               ...
               SPutMsg(mBuf);
               { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ex_ms.c", 324); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhActvTsk: Invalid event(%d) from PDCP\n", pst->event); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      case 0xd7 :
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ex_ms.c", 357); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhActvTsk: Invalid event(%d) from RLC\n", pst->event); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      case 0xd6 :
      {
         switch(pst->event)
         {
            ...
            default:
               ...
               SPutMsg(mBuf);
               { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ex_ms.c", 378); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhActvTsk: Invalid event(%d) from MAC\n", pst->event); SPrint((&nhCb.init)->prntBuf); } }; };

               break;
         }
         break;
      }
# 414 "../..//lterrc/nh_ex_ms.c"
      default:
         SPutMsg(mBuf);
         { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ex_ms.c", 417); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhActvTsk: Event from Unknown entity(%d)\n", pst->srcEnt); SPrint((&nhCb.init)->prntBuf); } }; };
