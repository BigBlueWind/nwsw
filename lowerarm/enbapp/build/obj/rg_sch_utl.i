...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//ltemac/rg_sch_utl.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//ltemac/rg_sch_utl.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 192 "../..//ltemac/rg_sch_utl.c"
#define RGSCH_NUM_PCFICH_REG 4
#define RGSCH_NUM_REG_PER_CCE 9
#define RGSCH_NUM_REG_PER_PHICH_GRP 3
# 208 "../..//ltemac/rg_sch_utl.c"
#define RGSCH_INITPHICH(_phich,_hqFeedBack,_nDmrs,_rbStart) { (_phich)->hqFeedBack = _hqFeedBack; (_phich)->rbStart = _rbStart; (_phich)->nDmrs = _nDmrs; (_phich)->lnk.next = NULLP; (_phich)->lnk.prev = NULLP; (_phich)->lnk.node = (PTR)(_phich); }
# 218 "../..//ltemac/rg_sch_utl.c"
#define RGSCH_PHICH_ALLOC(_inst,_dataPtr,_size,_ret) { _ret = rgSCHUtlAllocSBuf(_inst, (Data **)&_dataPtr, _size); }





#define RGSCH_PHICH_FREE(_inst,_dataPtr,_size) { rgSCHUtlFreeSBuf(_inst, (Data **)(&(_dataPtr)), _size); }
# 386 "../..//ltemac/rg_sch_utl.c"
...
# 402 "../..//ltemac/rg_sch_utl.c"
{
   ...
   U8 aggrLvlVal;
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 409); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlPdcchAvail\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 510); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlPdcchPut\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 567 "../..//ltemac/rg_sch_utl.c"
static Void rgSCHUtlPdcchInit
(
RgSchCellCb *cell,
RgSchDlSf *subFrm,
U16 nCce
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 586); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlPdcchInit\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 698 "../..//ltemac/rg_sch_utl.c"
{
   ...
   if(ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 711); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, " rgSCHUtlAddPhich(): " "Allocation of RgSchPhich failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { (phich)->hqFeedBack = hqFeedBack; (phich)->rbStart = rbStart; (phich)->nDmrs = nDmrs; (phich)->lnk.next = 0L; (phich)->lnk.prev = 0L; (phich)->lnk.node = (U32)(phich); };

   cmLListAdd2Tail(&dlSf->phichInfo.phichs, &phich->lnk);
   return(0);
}
# 742 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 808); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlSubFrmGet\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   sf = cell->subFrms[((frm.sfn & 1) * 10) + frm.subframe];

   return(sf);
}
# 838 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 856); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlSubFrmPut\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   sf->bwAssigned = 0;
# 877 "../..//ltemac/rg_sch_utl.c"
   sf->bwAlloced = 0;

   sf->type2Start = 0;

   sf->txDone = 0;
# 891 "../..//ltemac/rg_sch_utl.c"
   sf->type2End = 0;
...
# 1486 "../..//ltemac/rg_sch_utl.c"
{
   ...
   if ( !alloc->forMsg3 )
   {
     ueCtgy = (((((RgSchCmnUe *)((alloc->ue)->sch)))->cmn.ueCat + 1));
   }
...

{
   ...
   for(i = 0; i < 20; i++)
   {
      ...
      {
         sf->bw = cell->bwCfg.dlTotalBw + (cell->bwCfg.dlTotalBw * 40)/100;
   ...
   for (sfCount = 0; sfCount < 20; sfCount++)
   {
...

{
   ...
   hqP->tbInfo[tbIdx].sfLnk.node = (U32)&hqP->tbInfo[tbIdx];

   hqP->tbInfo[tbIdx].subFrm = subFrm;
}
# 2942 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   else
   {
      ...
      hqP->tbInfo[tbIdx].sfLnk.node = (U32)0L;

      hqP->tbInfo[tbIdx].subFrm = 0L;
   }
}
# 2993 "../..//ltemac/rg_sch_utl.c"
...
{
   ;;
   return(cell->sc.apis->rgSCHTti(cell, err));
}
# 3185 "../..//ltemac/rg_sch_utl.c"
...
# 3365 "../..//ltemac/rg_sch_utl.c"
 S16 rgSCHUtlUpdBsrShort
(
RgSchCellCb *cell,
RgSchUeCb *ue,
U8 lcgId,
...
# 3381 "../..//ltemac/rg_sch_utl.c"
{
   ;;
   return(cell->sc.apis->rgSCHUpdBsrShort(cell, ue, &ue->ul.lcgArr[lcgId], bsr, err));
}
# 3407 "../..//ltemac/rg_sch_utl.c"
 S16 rgSCHUtlUpdBsrTrunc
(
RgSchCellCb *cell,
RgSchUeCb *ue,
U8 lcgId,
...
# 3423 "../..//ltemac/rg_sch_utl.c"
{
   ;;
   return(cell->sc.apis->rgSCHUpdBsrTrunc(cell, ue, &ue->ul.lcgArr[lcgId], bsr, err));
}
# 3453 "../..//ltemac/rg_sch_utl.c"
 S16 rgSCHUtlUpdBsrLong
(
RgSchCellCb *cell,
RgSchUeCb *ue,
U8 bsr0,
...
# 3473 "../..//ltemac/rg_sch_utl.c"
{
   ...
   bsArr[2] = bsr2;
   bsArr[3] = bsr3;
   return(cell->sc.apis->rgSCHUpdBsrLong(cell, ue, bsArr, err));
}
# 3502 "../..//ltemac/rg_sch_utl.c"
 S16 rgSCHUtlUpdPhr
(
RgSchCellCb *cell,
RgSchUeCb *ue,
...
{
   ;;
   return(cell->sc.apis->rgSCHFirstHqFdbkAlloc(cell));
}
# 3776 "../..//ltemac/rg_sch_utl.c"
...
{
   ;;
   return(cell->sc.apis->rgSCHNextHqFdbkAlloc(cell, alloc));
}
# 3812 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 3842); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHUtlTfuBndReq() Call to RgLiTfuBndReq()" " failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   }
   return(ret);
}
# 3865 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 3888); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHUtlTfuUBndReq() Call to" " RgLiTfuUbndReq() failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   }
   return(ret);

}
# 3909 "../..//ltemac/rg_sch_utl.c"
...

{
...

   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 3984); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"Memory allocation FAILED for UE Alloc"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         return(1);
      }
   }
...

{
...

   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 4090); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"Memory allocation FAILED for UE Alloc"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         return(1);
      }
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 4099); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"Memory allocation FAILED for RARNTI"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         return(1);
      }
      for(indx = 0; indx < 4; indx++)
      {
         if((rgSCHUtlAllocSBuf(inst,
            (Data**)&(cell->sfAllocArr[idx].rarInfo.raRntiInfo[indx].crntiInfo),
                   (sizeof(RgInfCrntiInfo)*10))) != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 4108); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Memory allocation FAILED for RNTI"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
            return(1);
         }
      }
...
# 4237 "../..//ltemac/rg_sch_utl.c"
                      ...
                      pData, size) != 0)
   {
     ...
     rgSCHLmmStaInd(inst, 4, 12,
                                       15, &dgn);
     SLogError(rgSchCb[inst].rgSchInit.ent, rgSchCb[inst].rgSchInit.inst, rgSchCb[inst].rgSchInit.procId, (Txt *) "../..//ltemac/rg_sch_utl.c", (S32) 4247, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 15)), (ErrVal) (0), (Txt *) "Unable to Allocate Buffer");
     return(1);
   }


   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 4254); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "SGetSBuf(Region (%d), Pool (%d), " "Size (%ld)), Data (0x%p))\n", rgSchCb[inst].rgSchInit.region, rgSchCb[inst].rgSchInit.pool, size, *pData); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 4262 "../..//ltemac/rg_sch_utl.c"
   cmMemset((U8 *)*pData, 0x00, size);

   return(0);

}
# 4284 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 4310); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "SPutSBuf(Region (%d), Pool (%d), " "Size (%ld), Data (0x%p))\n", rgSchCb[inst].rgSchInit.region, rgSchCb[inst].rgSchInit.pool, size, (U8 *) *data); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 4318 "../..//ltemac/rg_sch_utl.c"
   ret = SPutSBuf(rgSchCb[inst].rgSchInit.region,
                  rgSchCb[inst].rgSchInit.pool, (*data), size);

   if (ret != 0)
   {
      SLogError(rgSchCb[inst].rgSchInit.ent, rgSchCb[inst].rgSchInit.inst, rgSchCb[inst].rgSchInit.procId, (Txt *) "../..//ltemac/rg_sch_utl.c", (S32) 4324, (ErrCls) (0x4), (ErrCode) (((0 + 0) + 16)), (ErrVal) ((ErrVal) 0), (Txt *) "rgSCHUtlFreeSBuf failed.\n");
...

{
   ...
   pst->srcInst = schCb->rgSchInit.inst+1;
...
# 4781 "../..//ltemac/rg_sch_utl.c"
         }
# 4792 "../..//ltemac/rg_sch_utl.c"
         ...
         if(!(hqP->tbInfo[tbCnt].txCntr))
         {
            ...
            {
               tbInfo->schdDat[idx].lcId = hqP->tbInfo[tbCnt].lchSchdData[idx].lcId;

               tbInfo->schdDat[idx].numBytes = hqP->tbInfo[tbCnt].lchSchdData[idx].schdData;
# 4821 "../..//ltemac/rg_sch_utl.c"
            }
         ...
         ((((*tbLnk) = ((&sf->tbs)->crnt = ((&sf->tbs)->crnt ? (&sf->tbs)->crnt->next : (&sf->tbs)->first)))!= 0L) ? (*tbLnk)->node : 0L);
      }
    }
   return;
}
# 4861 "../..//ltemac/rg_sch_utl.c"
...
# 4928 "../..//ltemac/rg_sch_utl.c"
{
   ...
   if ((1<<3) & pdu->ceInfo.bitMask)
   {
      ...
      if ((ret = rgSCHUtlUpdBsrTrunc (cellCb, ueCb,
                  ...
                  (U8)(pdu->ceInfo.ces.bsr.truncBsr & 0x3F), err)) != 0)
         return(ret);
   }
   else
   {
      if ((1<<4) & pdu->ceInfo.bitMask)
      {
         ...
         if ((ret = rgSCHUtlUpdBsrShort (cellCb, ueCb,
                     ...
                     (U8)(pdu->ceInfo.ces.bsr.shortBsr & 0x3F), err)) != 0)
            return(ret);
      }
      else
      {
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5012); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlAddUeToCcchSduLst(): crnti = %u;" , ueCb->ueId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 5021 "../..//ltemac/rg_sch_utl.c"
   ueCb->ccchSduLnk.node = (U32)(ueCb);
   cmLListAdd2Tail(&(cell->ccchSduUeLst), &(ueCb->ccchSduLnk));

   return(0);
}
# 5041 "../..//ltemac/rg_sch_utl.c"
 S16 rgSCHUtlUpdtBo
(
RgSchCellCb *cell,
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5058); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlUpdtBo(): crnti = %u;" " bo = %ld\n", staRsp->u.rnti, (U32)staRsp->bo); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if ((ueCb = rgSCHDbmGetUeCb(cell, staRsp->u.rnti)) == 0L)
   {
      ...
      SLogError(rgSchCb[inst].rgSchInit.ent, rgSchCb[inst].rgSchInit.inst, rgSchCb[inst].rgSchInit.procId, (Txt *) "../..//ltemac/rg_sch_utl.c", (S32) 5068, (ErrCls) (0x2), (ErrCode) (((0 + 0) + 17)), (ErrVal) ((ErrVal)staRsp->u.rnti), (Txt *) "rgSCHUtlUpdtBo(): Invalid ue Id");
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5116); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlHndlCcchBoUpdt(): boRpt->u.rnti = %u\n", boRpt->u.rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5271); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlHndlBcchPcchBoUpdt(): lcId = %u,                   bo = %ld, timeToTx.sfn = %u, timeToTx.subframe = %u\n", boUpdt->lcId, boUpdt->bo, boUpdt->u.timeToTx.sfn, boUpdt->u.timeToTx.subframe); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 5280 "../..//ltemac/rg_sch_utl.c"
   dlLc = rgSCHDbmGetBcchOnBch(cell);
   if (dlLc == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5284); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHUtlHndlBcchPcchBoUpdt():               No Logical Channel. dlLc is NULLP \n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (boUpdt->lcId != dlLc->lcId)
   {
      ...
      {
         SLogError(rgSchCb[inst].rgSchInit.ent, rgSchCb[inst].rgSchInit.inst, rgSchCb[inst].rgSchInit.procId, (Txt *) "../..//ltemac/rg_sch_utl.c", (S32) 5293, (ErrCls) (0x2), (ErrCode) (((0 + 0) + 20)), (ErrVal) ((ErrVal)boUpdt->bo), (Txt *) "rgSCHUtlHndlBcchPcchBoUpdt(): bo = %d does not match               any valid TB Size.");
   ...
   if ((dlLc = rgSCHDbmGetCmnLcCb(cell, boUpdt->lcId)) == 0L)
   {
      ...
      SLogError(rgSchCb[inst].rgSchInit.ent, rgSchCb[inst].rgSchInit.inst, rgSchCb[inst].rgSchInit.procId, (Txt *) "../..//ltemac/rg_sch_utl.c", (S32) 5301, (ErrCls) (0x2), (ErrCode) (((0 + 0) + 21)), (ErrVal) ((ErrVal)boUpdt->lcId), (Txt *) "rgSCHUtlHndlBcchPcchBoUpdt(): Invalid Lc Id");
   ...
   if (((rgSCHUtlAllocSBuf(inst, (Data **)(&boRpt), sizeof(RgSchClcBoRpt))) ==1) ||
       (!boRpt))
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5309); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHUtlHndlBcchPcchBoUpdt(): Allocation                        of common bo report failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5368); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"rgSCHUtlRgrBndCfm: suId = %d; status = %d \n", suId, status); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };

   ret = RgUiRgrBndCfm(&rgSchCb[instId].rgrSap[suId].sapCfg.sapPst, rgSchCb[instId].rgrSap[suId].sapCfg.suId, status);
   if (ret != 0)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5373); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"rgSCHUtlRgrBndCfm: RgUiRgrBndCfm Failed \n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
      return(ret);
   }
   return(ret);
}
# 5397 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5420); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"rgSCHUtlRgrCfgCfm: transId  %s status  %d \n", prntTrans, status); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };

   if(RgUiRgrCfgCfm(&rgSchCb[instId].rgrSap[spId].sapCfg.sapPst,
                    rgSchCb[instId].rgrSap[spId].sapCfg.suId,
                    transId, status) != 0)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5426); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"rgSCHUtlRgrCfgCfm: RgUiRgrCfgCfm Failed \n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
      return(1);
   }
   return(0);
}
# 5451 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5467); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"rgSCHUtlRgrTtiInd: cellId = %d \n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };

   rgrSap = cell->rgrSap;

   if (rgrSap->sapSta.sapState != 2)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5475); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHUtlRgrTtiInd() Upper SAP not bound (%d) \n", rgrSap->sapSta.sapState); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 5528 "../..//ltemac/rg_sch_utl.c"
{
   ...
   if (raCb == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5542); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"\n rgSCHUtlProcMsg3() Received MSG3, unable to find raCb for rnti(%d)\n", rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5555); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHUtlProcMsg3() Processing failed in the RAM cellId (%d) \n", cellCb->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 5706 "../..//ltemac/rg_sch_utl.c"
   if((ret = RgLiTfuCntrlReq(&tfuSap->sapCfg.sapPst, tfuSap->sapCfg.spId,
                             cntrlReq)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5709); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHUtlTfuCntrlReq() Call to RgLiTfuCntrlReq() failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   }
   return(ret);
}
# 5735 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   tfuSap = &(rgSchCb[inst].tfuSap[sapId]);
# 5835 "../..//ltemac/rg_sch_utl.c"
   if((ret = RgLiTfuRecpReq(&tfuSap->sapCfg.sapPst, tfuSap->sapCfg.spId,
                            recpReq)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5838); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHUtlTfuRecpReq() Call to RgLiTfuRecpReq() failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   }
   return(ret);
}
# 5855 "../..//ltemac/rg_sch_utl.c"
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5872); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"Incorrect SuId"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5881); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"Incorrect SuId. Configured (%d) Recieved (%d)\n", tfuSap->sapCfg.suId, suId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }
   if (tfuSap->sapSta.sapState != 2)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5887); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"Lower SAP not enabled SuId (%d)\n", tfuSap->sapCfg.suId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }
   return(0);
}
# 5908 "../..//ltemac/rg_sch_utl.c"
...
# 5942 "../..//ltemac/rg_sch_utl.c"
   if(0 != cmAllocEvnt(memSize, 1500, &sMem, memPtr))
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 5944); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHUtlAllocEventMem(): cmAllocEvnt Failed.\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } }
      return(1);
   }
...
# 6321 "../..//ltemac/rg_sch_utl.c"
{
   ...
   ret = rgSCHUtlUlHoleDbInit(cell, sf->holeDb, (U8)(maxUePerSf + 1), sbStartIdx, numSb);
...

{
   ...
   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 8184); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"rgSCHUtlRgrSiCfgCfm: " "transId  %s status  %d \n", prntTrans, status); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
   ...
   if(RgUiRgrSiCfgCfm(&rgSchCb[instId].rgrSap[spId].sapCfg.sapPst,
                    ...
                    transId, status) != 0)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch_utl.c", 8191); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"rgSCHUtlRgrSiCfgCfm: " "RgUiRgrSiCfgCfm Failed \n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
...

{
   ...
   { if (0L != (cell->siCb.crntSiInfo.sib1)) { SPutMsg((cell->siCb.crntSiInfo.sib1)); cell->siCb.crntSiInfo.sib1 = 0L; } }
   ...
   { if (0L != (cell->siCb.newSiInfo.sib1)) { SPutMsg((cell->siCb.newSiInfo.sib1)); cell->siCb.newSiInfo.sib1 = 0L; } }
   for(idx=0; idx < sizeof(cell->siCb.newSiInfo.si)/
                     sizeof(cell->siCb.newSiInfo.si[0]); idx++)
   {
      { if (0L != (cell->siCb.newSiInfo.si[idx])) { SPutMsg((cell->siCb.newSiInfo.si[idx])); cell->siCb.newSiInfo.si[idx] = 0L; } }
   }

   return;
}
# 8607 "../..//ltemac/rg_sch_utl.c"
