...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 103 "../..//lteclpal/ys_init.c" 2
# 1 "../..//cm/cm5.h" 1
# 104 "../..//lteclpal/ys_init.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define STK_KEY_BASE 1234L

#define PERMS 0666

#define MAXQUES 4
# 114 "../..//lteclpal/ys_init.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 135 "../..//lteclpal/ys_init.c" 2
# 1 "../..//cm/cm5.x" 1
# 136 "../..//lteclpal/ys_init.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
extern Void osAdd2LList ( DLList **dlList, Txt *node);
...

{
   ...
   if((fp = (OsFile*)osFopen("ys_cfg.txt","r")) == (S32)0L)
   {
      ...
      SLogError(ysCb.ysInit.ent, ysCb.ysInit.inst, ysCb.ysInit.procId, "../..//lteclpal/ys_init.c", 228, 0x4, 0, (ErrVal)0, "FAILED to open the file ys_cfg.txt\n");;
      exit(0);
   }
   ...
   for (;;)
   {
      ...
      {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_init.c", 244); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_init.c", 244); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "End of File reached, ys_cfg.txt\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         break;
      }
      ...
      while ((lPtr = osGetWord(lPtr, word)) != 0L)
      {
         ...
         if (inToken)
         {
            ...
            for (idx = 0; idx < numParams; idx++)
            {
               ...
               if (idx == numParams)
               {
                  { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_init.c", 282); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_init.c", 282); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, " invalid configuration parameter \n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
                  if(fp) osFclose(fp);
                  return(1);
               }
            }
         ...
         else
         {
            ...
            switch(idx)
            {
               ...
               case 2:
               {
                  YS_PORT_ENB = (U16)osStrtol(word, ((void *)0), 10);
                  break;
               }
               case 3:
               {
                  YS_PORT_UE = (U16)osStrtol(word, ((void *)0), 10);
                  break;
               }
               case 4:
               {
                  YS_TTI_TMR_VAL_CFG = (U32)osStrtol(word, ((void *)0), 10);
                  break;
               }
               ...
               case 6:
               {
                  YS_CELL_ID = (U16)osStrtol(word, ((void *)0), 10);
                  break;
               }
...

{
   ...
   ysCb.tfuSap.spId = 0;
   ysCb.tfuSap.suId = 0;
   ysCb.tfuSap.sapState = 1;
   ysCb.tfuSap.sapPst.selector = 1;
   ysCb.tfuSap.sapPst.dstProcId = SFndProcId();
   ysCb.tfuSap.sapPst.srcProcId = SFndProcId();
   ysCb.tfuSap.sapPst.dstEnt = 0xd6;
   ysCb.tfuSap.sapPst.srcEnt = 0xd5;
   ...
   ysCb.schTfuSap.sapState = 1;
   ysCb.schTfuSap.sapPst.selector = 1;
   ysCb.schTfuSap.sapPst.dstProcId = SFndProcId();
   ysCb.schTfuSap.sapPst.srcProcId = SFndProcId();
   ysCb.schTfuSap.sapPst.dstEnt = 0xd6;
   ysCb.schTfuSap.sapPst.srcEnt = 0xd5;
   ...
   ysCb.cellCb.peerPst.dstProcId = 2;
   ysCb.cellCb.peerPst.srcProcId = SFndProcId();
   ysCb.cellCb.peerPst.dstEnt = 0xd5;
   ysCb.cellCb.peerPst.srcEnt = 0xd5;
   ysCb.cellCb.peerPst.region = region;
   ysCb.cellCb.peerPst.pool = ysCb.ysInit.pool;
   ysCb.cellCb.peerPst.selector = 0;
