...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//ltemac/rg_sch_pfs.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//ltemac/rg_sch_pfs.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
# 113 "../..//ltemac/rg_sch_pfs.c" 2
# 1 "../..//ltemac/rg_sch_pfs.h" 1
# 103 "../..//ltemac/rg_sch_pfs.h"
...
#define RG_SCH_PFS_DL_NUM_AMBR_QUEUES 8
#define RG_SCH_PFS_UL_NUM_QUEUES 8
...
#define RG_SCH_PFS_MAX_PRIO_VAL (RGR_PFS_PRIO_LVLS-1)


#define RG_SCH_PFS_GET_PFSCELLDL(cell) (RgSchPfsDlCell *)((RgSchCmnCell *)cell->sc.sch)->dl.schSpfc

#define RG_SCH_PFS_GET_PFSCELLUL(cell) (RgSchPfsUlCell *)((RgSchCmnCell *)cell->sc.sch)->ul.schSpfc

#define RG_SCH_PFS_GET_PFSUEDL(ue) (RgSchPfsDlUe *)((RgSchCmnUe *)ue->sch)->dl.schSpfc

#define RG_SCH_PFS_GET_PFSUEUL(ue) (RgSchPfsUlUe *)((RgSchCmnUe *)ue->sch)->ul.schSpfc

#define RG_SCH_PFS_GET_PFSPROCDL(proc) (RgSchPfsDlHqProc *)((RgSchCmnDlHqProc *)proc->sch)->schSpfc

#define RG_SCH_PFS_GET_PFSPROCUL(proc) (RgSchPfsUlHqProc *)((RgSchCmnUlHqProc *)proc->sch)->schSpfc

#define RG_SCH_PFS_GET_PFSDLLC(lc) (RgSchPfsDlLc *)((RgSchCmnDlSvc *)lc->sch)->schSpfc
# 114 "../..//ltemac/rg_sch_pfs.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//ltemac/rg_sch_pfs.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//ltemac/rg_sch_pfs.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 131 "../..//ltemac/rg_sch_pfs.c" 2
# 1 "../..//ltemac/rg_sch_pfs.x" 1
# 105 "../..//ltemac/rg_sch_pfs.x"
#define __RGPFSX__ 
...
# 132 "../..//ltemac/rg_sch_pfs.c" 2
# 145 "../..//ltemac/rg_sch_pfs.c"
static Void rgSCHPfsFillTbl ( U32 src[], U32 dst[], U16 numEntries, U32 *minVal, U32 *maxVal );
...
static Void rgSCHPfsFillRange ( RgSchPfsPrioRange *range, U32 minPrios[3], U32 maxPrios[3], U8 numQs );
# 161 "../..//ltemac/rg_sch_pfs.c"
...
static Void rgSCHPfsDlUeInactv ( RgSchCellCb *cell, RgSchUeCb *ue );
 ...
 Void rgSCHPfsDlCqiInd ( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *cqiInfo );




 Void rgSCHPfsDlSched ( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *alloc );
...
static Void rgSCHPfsDlNewTxInQ ( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *alloc, CmLListCp *txQ, CmLListCp *retxQ, Bool *isBwLeftRef );
...
# 349 "../..//ltemac/rg_sch_pfs.c"
static Void rgSCHPfsDlAddLcAllocToProc ( RgSchCellCb *cell, RgSchUeCb *ue, RgSchDlLcCb *lc, U32 bytes, RgSchDlHqTbCb *tbInfo );
# 358 "../..//ltemac/rg_sch_pfs.c"
static Void rgSCHPfsDlPrioAmbrSvcUpd ( RgSchPfsDlCell *pfsCell, RgSchUeCb *ue, U32 allocd );




static Void rgSCHPfsDlLcAddToSrbQ ( RgSchPfsDlCell *pfsCell, RgSchPfsDlUe *pfsUe, RgSchPfsDlLc *pfsLc );




static Void rgSCHPfsDlLcAddToDrb0Q ( RgSchPfsDlCell *pfsCell, RgSchPfsDlUe *pfsUe, RgSchPfsDlLc *pfsLc );




static Void rgSCHPfsDlLcAddToGbrQ ( RgSchPfsDlCell *pfsCell, RgSchPfsDlUe *pfsUe, RgSchPfsDlLc *pfsLc );




static Void rgSCHPfsDlLcAddToMbrQ ( RgSchPfsDlCell *pfsCell, RgSchPfsDlUe *pfsUe, RgSchPfsDlLc *pfsLc );
...
static Void rgSCHPfsDlLcAddToAmbrQ ( RgSchPfsDlCell *pfsCell, RgSchPfsDlUe *pfsUe, RgSchPfsDlLc *pfsLc, U32 allocd );





static Void rgSCHPfsDlLcAddToQ ( RgSchPfsDlUe *pfsUe, CmLListCp *cp, RgSchPfsDlLc *pfsLc );
...
static Void rgSCHPfsDlLcAmbrBoUpd ( RgSchPfsDlCell *pfsCell, RgSchUeCb *ue, RgSchDlLcCb *lc, U32 bo, U32 allocd );
...
static Void rgSCHPfsDlRemAmbrZero ( RgSchPfsDlCell *pfsCell, RgSchPfsDlUe *pfsUe );



static Void rgSCHPfsDlLcGbrBoUpd ( RgSchPfsDlCell *pfsCell, RgSchUeCb *ue, RgSchDlLcCb *lc, U32 bo, U32 allocd );
# 418 "../..//ltemac/rg_sch_pfs.c"
static Void rgSCHPfsDlLcAmbrActv ( RgSchPfsDlCell *pfsCell, RgSchUeCb *ue, RgSchDlLcCb *lc, U32 bo, U32 allocd );
...
static Void rgSCHPfsDlLcAmbrInactv ( RgSchPfsDlCell *pfsCell, RgSchUeCb *ue, RgSchDlLcCb *lc );




static Void rgSCHPfsDlLcInsInUeAmbrLst ( RgSchPfsDlUe *pfsUe, RgSchDlLcCb *lc );



static U8 rgSCHPfsDlGetQId ( RgSchPfsPrioRange *range, U32 prioVal, U8 maxQId );




static Void rgSCHPfsDlLcRmvFrmPrioQ ( RgSchPfsDlCell *pfsCell, RgSchPfsDlUe *pfsUe, RgSchPfsDlLc *pfsLc );
...
static U32 rgSchPfsDlGetSvcPrio ( RgSchPfsDlCell *pfsCell, U8 prio );



static U32 rgSCHPfsDlGetCqiPrio ( RgSchPfsDlCell *pfsCell, U8 cqi );



static S16 rgSCHPfsDlLcSched ( RgSchCellCb *cell, RgSchCmnDlRbAllocInfo *alloc, RgSchDlSf *sf, RgSchUeCb *ue, RgSchDlLcCb *lc, CmLListCp *retxQ, Bool *isBwLeftRef );
# 470 "../..//ltemac/rg_sch_pfs.c"
...
static Void rgSCHPfsDlUeSfResetTemp ( RgSchCellCb *cell, RgSchUeCb *ue );
...
static Void rgSCHPfsUlSchedContRes ( RgSchCellCb *cell, RgSchCmnUlRbAllocInfo *alloc, U8 *remUeRef );




static Void rgSCHPfsUlSchedSig ( RgSchCellCb *cell, RgSchCmnUlRbAllocInfo *alloc, U8 *remUeRef );




static Void rgSCHPfsUlSchedDat ( RgSchCellCb *cell, RgSchCmnUlRbAllocInfo *alloc, U8 *remUeRef );




static Void rgSCHPfsUlSchedUeForContRes ( RgSchCellCb *cell, RgSchCmnUlRbAllocInfo *alloc, RgSchUeCb *ue );




static S16 rgSCHPfsUlSchedUeForSigDat ( RgSchCellCb *cell, RgSchCmnUlRbAllocInfo *alloc, RgSchUeCb *ue );
...
static Void rgSCHPfsUlMngUeInQ ( RgSchCellCb *cell, RgSchUeCb *ue );
...
static Void rgSCHPfsUlAddUeToPfsQ ( RgSchCellCb *cell, RgSchUeCb *ue, U32 pfsPrio );
...
static Void rgSCHPfsUlRmvUeFrmQ ( RgSchPfsUlCell *pfsCell, RgSchPfsUlUe *pfsUe );



static Void rgSCHPfsUlAddUeToQ ( CmLListCp *cp, RgSchUeCb *ue );
...
# 658 "../..//ltemac/rg_sch_pfs.c"
static Void rgSCHPfsUlUeSfResetTemp ( RgSchCellCb *cell, RgSchUeCb *ue );




static U32 rgSCHPfsUlGetCqiPrio ( RgSchPfsUlCell *pfsCell, U8 cqi );



static U32 rgSCHPfsUlGetFracPrio ( RgSchPfsUlCell *pfsCell, U8 frac );



static U32 rgSCHPfsUlGetLcgPrio ( RgSchPfsUlCell *pfsCell, U8 lcgId );



static U32 rgSCHPfsUlGetQId ( RgSchPfsUlCell *pfsCell, U32 pfsPrio );
# 703 "../..//ltemac/rg_sch_pfs.c"
 Void rgSCHPfsDlInit
(
RgDlSchdApis *apis
)
...

{
   ...
   rgSCHPfsFillTbl(pfsCfg->cqiPrios, pfsCell->tbls.cqiPrios,
         17, &minCqiPrio, &maxCqiPrio);

   maxCqiPrio *= cell->numTxAntPorts;


   rgSCHPfsFillTbl(pfsCfg->fracPrios, pfsCell->tbls.fracPrios,
         17, &minFracPrio, &maxFracPrio);


   rgSCHPfsFillTbl(&pfsCfg->svcPrioPrios[1],
         &pfsCell->tbls.svcPrioPrios[1],
         2 +1 - 1,
         &minGbrPrio, &maxGbrPrio);


   rgSCHPfsFillTbl(&pfsCfg->svcPrioPrios[2 +1],
         &pfsCell->tbls.svcPrioPrios[2 +1],
         8 + 1 - (2 +1),
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_pfs.c", 829); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHPfsDlCellCfg(): Priority values are all zero\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_pfs.c", 843); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHPfsDlCellCfg(): Priority values too large\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   RgSchCmnDlUe *cmnUe = &(((RgSchCmnUe *)((ue)->sch))->dl);
   RgSchPfsDlUe *pfsUe;
   RgSchDlHqEnt *hqEnt;
   S16 ret;
   S16 idx;
...

{
   ...
   if ((hqEnt != 0L) && (hqEnt->sch != 0L))
   {
      ...
      rgSCHUtlFreeSBuf(cell->instIdx, (Data**)(&(hqEnt->sch)),
            (hqEnt->numHqPrcs * sizeof(RgSchPfsDlHqProc)));
   }
...
# 1292 "../..//ltemac/rg_sch_pfs.c"
{
   RgSchPfsDlCell *pfsCell = (RgSchPfsDlCell *)((RgSchCmnCell *)cell->sc.sch)->dl.schSpfc;
   RgSchPfsDlUe *pfsUe = (RgSchPfsDlUe *)((RgSchCmnUe *)ue->sch)->dl.schSpfc;
   ...
   pfsLc = (RgSchPfsDlLc *)((RgSchCmnDlSvc *)lc->sch)->schSpfc;
   pfsLc->schedSvcLnk.node = (U32)lc;
   ...
   if (((((RgSchCmnDlSvc*)(lc->sch))->prio >= 1) && (((RgSchCmnDlSvc*)(lc->sch))->prio <= 2)))
   {
...
# 1408 "../..//ltemac/rg_sch_pfs.c"
{
   RgSchCmnDlSvc *cmnLc = (RgSchCmnDlSvc *)lc->sch;
   RgSchPfsDlLc *pfsLc = (RgSchPfsDlLc *)((RgSchCmnDlSvc *)lc->sch)->schSpfc;
...

{
   ...
   cqiPrio = cqiPrio * cmnUe->mimoInfo.ri;
   ...
   for (lnk = pfsUe->cfgGbrLst.first; lnk; lnk = lnk->next)
   {
      ...
      if (pfsLc->prioLstCp)
      {
         if (pfsLc->remGbr)
         {
            ...
            rgSCHPfsDlLcAddToGbrQ(pfsCell, pfsUe, pfsLc);
         }
         else
         {

            rgSCHPfsDlLcAddToMbrQ(pfsCell, pfsUe, pfsLc);
         }
      }
   }
...
# 1802 "../..//ltemac/rg_sch_pfs.c"
 Void rgSCHPfsDlSched
(
RgSchCellCb *cell,
...

{
   ...
   {
      RgSchUeCb *ue = (RgSchUeCb *)lnk->node;
# 1889 "../..//ltemac/rg_sch_pfs.c"
      rgSCHPfsDlSchedTaForUe(cell, alloc, sf, ue);
...
# 1982 "../..//ltemac/rg_sch_pfs.c"
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_pfs.c", 1991); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHPfsDlSchedTaForUe(): Could not get HARQ proc for UE %d \n", ue->ueId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   rgSCHCmnDlAllocTxRb(cell, sf, ue, 2, &bytes, proc, alloc);
...

{
   ...
   for (idx = 8 -1; isBwLeft && (idx >= 0); --idx)
   {
      txQ = &txQs->gbrLst[idx];
      retxQ = &retxQs->gbrLst[idx];
      rgSCHPfsDlNewTxInQ(cell, alloc, txQ, retxQ, &isBwLeft);
   ...
   for (idx = 4 -1; isBwLeft && (idx >= 0); --idx)
   {
      txQ = &txQs->mbrLst[idx];
      retxQ = &retxQs->mbrLst[idx];
      rgSCHPfsDlNewTxInQ(cell, alloc, txQ, retxQ, &isBwLeft);
...
# 2221 "../..//ltemac/rg_sch_pfs.c"
{
   ...
   {
      RgSchDlLcCb *lc = (RgSchDlLcCb *)lnk->node;
# 2244 "../..//ltemac/rg_sch_pfs.c"
      if (!sf->remUeCnt && !lc->ue->dl.dlAllocCb.reqLnk.node)
      {
...
# 2284 "../..//ltemac/rg_sch_pfs.c"
static S16 rgSCHPfsDlLcSched
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *alloc,
RgSchDlSf *sf,
...
# 2331 "../..//ltemac/rg_sch_pfs.c"
   ...
   if (bytes == 0)
   {
      if (cmnProc->totBytes == 0)
      {
         ...
         {
            cmLListDelFrm(&alloc->dedAlloc.txUeLst, &ue->dl.dlAllocCb.reqLnk);
...

{
   ...
   if (rgSCHDhmGetAvlHqProc(ue, cmnCell->time, &proc) != 0)
   {
      return(0L);
   }
   cmnProc = (RgSchCmnDlHqProc *)proc->sch;
...

{
   ...
   for(idx = 0; idx < hqEnt->numHqPrcs; idx++)
   {
      ...
      if ((proc->tbInfo[0].subFrm != 0L) &&
          (proc->tbInfo[0].sfLnk.node != 0L))
      {
         ...
         rgSCHUtlDlHqPTbRmvFrmTx(proc->tbInfo[0].subFrm, proc, 0, 0);
      }
      if ((proc->tbInfo[1].subFrm != 0L) &&
               (proc->tbInfo[1].sfLnk.node != 0L))
      {
  ...
  if (proc->tbInfo[1].pdcch != proc->tbInfo[0].pdcch)
  {
         ...
         rgSCHUtlDlHqPTbRmvFrmTx(proc->tbInfo[1].subFrm, proc, 1, 0);
      }
...
# 2967 "../..//ltemac/rg_sch_pfs.c"
{
  ...
  U32 bytes;
   ...
   while(*node)
   {
      ...
      pfsLc = (RgSchPfsDlLc *)((RgSchCmnDlSvc *)lc->sch)->schSpfc;
      *node = (*node)->next;
      bytes = ((*effAlloc) <= (pfsLc->reqBytes) ? (*effAlloc) : (pfsLc->reqBytes));
   ...
   if ((*node == 0L) && (pfsLc) && (pfsLc->reqBytes == 0))
   {
...

{
   ...
   for (lnk = alloc->dedAlloc.schdTxRetxUeLst.first; lnk; )
   {
      RgSchUeCb *ue = (RgSchUeCb *)lnk->node;
      RgSchCmnDlUe *cmnUe = &(((RgSchCmnUe *)((ue)->sch))->dl);
      RgSchDlHqProcCb *proc = cmnUe->proc;

      lnk = lnk->next;
      pfsUe = (RgSchPfsDlUe *)((RgSchCmnUe *)ue->sch)->dl.schSpfc;
      ...
      rgSCHPfsDlSprTxTbDstn(cell, ue, newTxTbInfo, &remTbBytes, pfsUe->svcPriorLst.first);
      ...
      rgSCHPfsDlUeSfResetTemp(cell, ue);
   }
...

{
   ...
   if (remTb1Bytes){
      ...
      rgSCHPfsDlNewTxTbDstn(cell, ue, &cmnUe->proc->tbInfo[0], &remTb1Bytes, &node);
   ...
   if (remTb2Bytes){
      ...
      rgSCHPfsDlNewTxTbDstn(cell, ue, &cmnUe->proc->tbInfo[1], &remTb2Bytes, &node);
...
# 3772 "../..//ltemac/rg_sch_pfs.c"
   rgSCHPfsDlBoUpdInt(cell, ue, lc, lc->bo, 0);
   return;
}
# 3805 "../..//ltemac/rg_sch_pfs.c"
...
# 3822 "../..//ltemac/rg_sch_pfs.c"
{
   ...
   {
# 3870 "../..//ltemac/rg_sch_pfs.c"
      pfsLc->effBo = bo;
      rgSCHPfsDlLcAddToDrb0Q(pfsCell, pfsUe, pfsLc);
   }
   return;
}
# 3904 "../..//ltemac/rg_sch_pfs.c"
...

{
   ...
   if (cmnUe->ambrCfgd)
   {
      ...
      pfsLc->effBo = ((pfsLc->bo) <= (pfsUe->remAmbr) ? (pfsLc->bo) : (pfsUe->remAmbr));
      pfsLc->remRate = pfsUe->remAmbr * (17 -1) / cmnUe->ambrCfgd;
...

{
   ...
   else if(pfsLc->lcType == 1)
   {
      ...
      while(lnk)
      {
         ...
         pfsSvc = (RgSchPfsDlLc *)((RgSchCmnDlSvc *)lc->sch)->schSpfc;
         if(pfsSvc->lcType == 0)
         {
            lnk = lnk->next;
            continue;
...

{
   ...
   pfsLc->remRatePrio = pfsCell->tbls.fracPrios[pfsLc->remRate];


   pfsLc->pfsPrio = pfsLc->svccqiPrio * pfsLc->remRatePrio;

   qId = rgSCHPfsDlGetQId(&pfsCell->ranges.gbrRange,
         pfsLc->pfsPrio, 8 -1);
   if (pfsLc->prioLstCp && (pfsLc->qId == qId))
   {
      return;
   }
   rgSCHPfsDlLcRmvFrmPrioQ(pfsCell, pfsUe, pfsLc);
...
# 4272 "../..//ltemac/rg_sch_pfs.c"
   ...
   if (pfsLc->prioLstCp && (pfsLc->qId == qId) && (0 == allocd))
   {
...
# 4556 "../..//ltemac/rg_sch_pfs.c"
{
   ...
   if (pfsLc->remGbr)
   {
      effBo = ((bo) <= (pfsLc->remGbr) ? (bo) : (pfsLc->remGbr));

      pfsLc->remRate = pfsLc->remGbr * (17 -1) / pfsLc->gbr;
      rgSCHPfsDlLcAddToGbrQ(pfsCell, pfsUe, pfsLc);
   }
   else if (pfsLc->remDeltaMbr)
   {
      effBo = ((bo) <= (pfsLc->remDeltaMbr) ? (bo) : (pfsLc->remDeltaMbr));

      pfsLc->remRate = pfsLc->remDeltaMbr * (17 -1) / pfsLc->deltaMbr;
      rgSCHPfsDlLcAddToMbrQ(pfsCell, pfsUe, pfsLc);
   }
   else
   {
...

{
   ...
   for (lnk = cp->first; lnk; lnk = lnk->next)
   {
      ...
      RgSchPfsDlLc *tmpPfsLc = (RgSchPfsDlLc *)((RgSchCmnDlSvc *)tmpLc->sch)->schSpfc;
   ...
   if (cp->first->node == (U32)lc)
   {
      pfsUe->ambrSvc = lc;
   }
   return;
}
# 4879 "../..//ltemac/rg_sch_pfs.c"
...

{
   ...
   qId = (prioVal - range->min)/range->numElemPerQ;
...
# 5028 "../..//ltemac/rg_sch_pfs.c"
   ...
   for (; lnk; lnk = lnk->next)
   {
      ...
      if (pfsLc->bo)
      {
         ...
         pfsLc->remRate = pfsUe->remAmbr * (17 -1) /
                            cmnUe->ambrCfgd;
...

{
   ...
   return(pfsCell->tbls.svcPrioPrios[prio]);
}
# 5173 "../..//ltemac/rg_sch_pfs.c"
static U32 rgSCHPfsDlGetCqiPrio
(
RgSchPfsDlCell *pfsCell,
U8 cqi
)
...

{
   ...
   return(pfsCell->tbls.cqiPrios[cqi-1]);
}
# 5207 "../..//ltemac/rg_sch_pfs.c"
 Void rgSCHPfsUlInit
(
RgUlSchdApis *apis
)
...

{
   ...
   rgSCHPfsFillTbl(pfsCfg->cqiPrios, pfsCell->tbls.cqiPrios, 17,
         &minCqiPrio, &maxCqiPrio);
   rgSCHPfsFillTbl(pfsCfg->fracPrios, pfsCell->tbls.fracPrios, 17,
         &minFracPrio, &maxFracPrio);
   rgSCHPfsFillTbl(pfsCfg->lcgPrios, pfsCell->tbls.lcgPrios, 3,
         &minLcgPrio, &maxLcgPrio);


   if ((maxCqiPrio == 0) || (maxLcgPrio == 0) || (maxFracPrio == 0))
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_pfs.c", 5312); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHPfsDlCellCfg(): Priority values are all zero\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_pfs.c", 5326); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHPfsUlCellCfg(): Priority values too large\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   pfsUe = (RgSchPfsUlUe *)((RgSchCmnUe *)ue->sch)->ul.schSpfc;
...

{
   RgSchPfsUlCell *pfsCell = (RgSchPfsUlCell *)((RgSchCmnCell *)cell->sc.sch)->ul.schSpfc;
   RgSchCmnUlUe *cmnUe = &((RgSchCmnUe *)ue->sch)->ul;
   RgSchPfsUlUe *pfsUe = (RgSchPfsUlUe *)((RgSchCmnUe *)ue->sch)->ul.schSpfc;
...

{
   ...
   rgSCHPfsUlMngUeInQ(cell, ue);
   return;
}
# 5767 "../..//ltemac/rg_sch_pfs.c"
...

{
   ...
   ;;
# 5796 "../..//ltemac/rg_sch_pfs.c"
   rgSCHPfsUlMngUeInQ(cell, ue);
   return;
}
# 5816 "../..//ltemac/rg_sch_pfs.c"
...

{
   ...
   {
      RgSchUeCb *ue = (RgSchUeCb *)lnk->node;
# 5966 "../..//ltemac/rg_sch_pfs.c"
      rgSCHPfsUlSchedUeForContRes(cell, alloc, ue);
   }

   return;
}
# 5990 "../..//ltemac/rg_sch_pfs.c"
...

{
   ...
   {
      RgSchUeCb *ue = (RgSchUeCb *)lnk->node;
# 6028 "../..//ltemac/rg_sch_pfs.c"
      if (rgSCHPfsUlSchedUeForSigDat(cell, alloc, ue) == 0)
      {
         --*remUeRef;
      }
   }
...
# 6121 "../..//ltemac/rg_sch_pfs.c"
static Void rgSCHPfsUlSchedUeForContRes
(
RgSchCellCb *cell,
RgSchCmnUlRbAllocInfo *alloc,
RgSchUeCb *ue
...

{
   ...
   {
# 6201 "../..//ltemac/rg_sch_pfs.c"
      return(1);
   }

   cmnUe->alloc.reqBytes = cmnUe->effBsr;
...

{
   ...
   ;;
# 6265 "../..//ltemac/rg_sch_pfs.c"
   rgSCHPfsUlMngUeInQ(cell, ue);
   return;
}
# 6290 "../..//ltemac/rg_sch_pfs.c"
...
# 6494 "../..//ltemac/rg_sch_pfs.c"
   frac = cmnUe->effUeBR * (17 -1) / cmnUe->cfgdUeBR;
   fracPrio = rgSCHPfsUlGetFracPrio(pfsCell,(U8) frac);
   pfsUe->fracPrio = fracPrio;
   lcgPrio = rgSCHPfsUlGetLcgPrio(pfsCell, lcg->lcgId);
   pfsUe->lcgPrio = lcgPrio;
   pfsPrio = pfsUe->cqiPrio * lcgPrio * fracPrio;
# 6508 "../..//ltemac/rg_sch_pfs.c"
   rgSCHPfsUlAddUeToPfsQ(cell, ue, pfsPrio);

   return;
}
# 6532 "../..//ltemac/rg_sch_pfs.c"
...

{
   ...
   pfsPrio = pfsUe->lcgPrio * cqiPrio * pfsUe->fracPrio;
   rgSCHPfsUlAddUeToPfsQ(cell, ue, pfsPrio);

   return;
}
# 6731 "../..//ltemac/rg_sch_pfs.c"
...

{
   ...
   pfsUe->pfsPrio = pfsPrio;
   qId = rgSCHPfsUlGetQId(pfsCell, pfsPrio);
   if (pfsUe->lstCp)
   {
      if (pfsUe->lstCp == &pfsCell->txQueues.sigLst)
      {
      ...
      if ((qId == pfsUe->qId) && (!pfsUe->schedInCrntUlSf))
      {
# 6841 "../..//ltemac/rg_sch_pfs.c"
         return;
      }
# 6851 "../..//ltemac/rg_sch_pfs.c"
      rgSCHPfsUlRmvUeFrmQ(pfsCell, pfsUe);
   }
   pfsUe->qId = qId;
...
# 7228 "../..//ltemac/rg_sch_pfs.c"
   pfsUe->srRcvd = 0;
   return;
}
# 7246 "../..//ltemac/rg_sch_pfs.c"
static U32 rgSCHPfsUlGetCqiPrio
(
RgSchPfsUlCell *pfsCell,
U8 cqi
)
...

{
   ...
   return(pfsCell->tbls.cqiPrios[cqi]);
}
# 7277 "../..//ltemac/rg_sch_pfs.c"
static U32 rgSCHPfsUlGetFracPrio
(
RgSchPfsUlCell *pfsCell,
U8 frac
)
...

{
   ...
   return(pfsCell->tbls.fracPrios[frac]);
}
# 7308 "../..//ltemac/rg_sch_pfs.c"
static U32 rgSCHPfsUlGetLcgPrio
(
RgSchPfsUlCell *pfsCell,
U8 lcgId
)
...

{
   ...
   return(pfsCell->tbls.lcgPrios[lcgId-1]);
}
# 7339 "../..//ltemac/rg_sch_pfs.c"
...
{
   ;;
# 7359 "../..//ltemac/rg_sch_pfs.c"
   return((pfsPrio - pfsCell->range.min) / pfsCell->range.numElemPerQ);
}
# 7381 "../..//ltemac/rg_sch_pfs.c"
