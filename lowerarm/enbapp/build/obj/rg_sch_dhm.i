...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//ltemac/rg_sch_dhm.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//ltemac/rg_sch_dhm.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//ltemac/rg_sch_dhm.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//ltemac/rg_sch_dhm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 261 "../..//ltemac/rg_sch_dhm.c"
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 268); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHDhmHqEntInit():                    numHqPrcs=%d maxHqTx=%d",hqE->numHqPrcs,hqE->maxHqTx); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
# 278 "../..//ltemac/rg_sch_dhm.c"
   rgSCHDhmHqEntReset(hqE);




   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 285); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHDhmHqEntInit():            Harq Entity Initialized with free_cnt=%lu and inUse_cnt=%lu", hqE->free.count,hqE->inUse.count); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };



   return(hqE);
}
# 316 "../..//ltemac/rg_sch_dhm.c"
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 339); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"\n rgSCHDhmGetAvlHqProc():           UEID=%d,timingInfo sfn=%d,sf=%d,free hq cnt=%lu,used hq cnt=%lu", ue->ueId,timingInfo.sfn,timingInfo.subframe,ue->dl.hqEnt->free.count, ue->dl.hqEnt->inUse.count); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };




   ((((tmp) = ((&(ue->dl.hqEnt->free))->crnt = (&(ue->dl.hqEnt->free))->first)) != 0L) ? (tmp)->node : 0L);

   if (0L == tmp)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 345); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "No Free Harq Procs Available.\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }

   tmpHqProc = (RgSchDlHqProcCb *)(tmp->node);
# 379 "../..//ltemac/rg_sch_dhm.c"
...

{
   ...
   if (hqE->inUse.last == 0L)
   {
      return(0L);
   }
   return((RgSchDlHqProcCb *)hqE->inUse.last->node);
}
# 537 "../..//ltemac/rg_sch_dhm.c"
...

{
   ...
   if (hqP->hqE->ue != 0L)
   {
      ...
      do { if (tbs <= 9) hqRetxStats.dlCqiStat[(cqi - 1)].mcs = tbs; else if (tbs <= 15) hqRetxStats.dlCqiStat[(cqi - 1)].mcs = tbs + 1; else hqRetxStats.dlCqiStat[(cqi - 1)].mcs = tbs + 2;} while(0);
      ...
      hqRetxStats.dlCqiStat[(cqi - 1)].totalTx = hqRetxStats.dlCqiStat[(cqi - 1)].numOfHQ_1 + (hqRetxStats.dlCqiStat[(cqi - 1)].numOfHQ_2 * 2) + (hqRetxStats.dlCqiStat[(cqi - 1)].numOfHQ_3 * 3) + (hqRetxStats.dlCqiStat[(cqi - 1)].numOfHQ_4 * 4);
...

{
   ...
   if (hqP->hqE->ue != 0L)
   {
      ...
      cmLListDelFrm(&hqE->inUse, &hqP->lnk);
      cmLListAdd2Tail(&hqE->free, &hqP->lnk);
# 895 "../..//ltemac/rg_sch_dhm.c"
   return;
}
# 1045 "../..//ltemac/rg_sch_dhm.c"
...

{
   ...
   switch(fdbk)
   {
      case 1:
         ...
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 1078); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Ack Rcvd. Adding ue to TA " "timer list\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 0:
         ...
         if(1 == maxHqRetxReached)
         {
            ...
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 1092); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Nack Rcvd for TA. Max Tries" " Attempted\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 4:
         ...
         if(1 == maxHqRetxReached)
         {
            ...
            rgSCHUtlDlTARpt(cell, ueCb);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 1107); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "DTX Rcvd for TA. Max Tries" " Attempted\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      *tbStrtIdx = -1;
      for (tbCnt = 0; tbCnt < 2; tbCnt++)
      {
         if ((hqP->tbInfo[tbCnt].state == HQ_TB_WAITING) &&
             ((((hqP->tbInfo[tbCnt].timingInfo).sfn == (timeInfo).sfn) && ((hqP->tbInfo[tbCnt].timingInfo).subframe == (timeInfo).subframe))))
         {
...

{
   ...
   if (hqE->ue != 0L)
   {
      ...
      do { if (tbs <= 9) (hqFailStats.dlCqiStat[(dlUe->mimoInfo.cwInfo[0].cqi - 1)].mcs) = tbs; else if (tbs <= 15) (hqFailStats.dlCqiStat[(dlUe->mimoInfo.cwInfo[0].cqi - 1)].mcs) = tbs + 1; else (hqFailStats.dlCqiStat[(dlUe->mimoInfo.cwInfo[0].cqi - 1)].mcs) = tbs + 2;} while(0);
...
# 2325 "../..//ltemac/rg_sch_dhm.c"
{
   ...
   { if (timingInfo.sfn == 0) { if ((timingInfo.subframe - (4)) < 0) { timingInfo.sfn = 1024 - 1; } else { timingInfo.sfn = timingInfo.sfn; } } else { if ((timingInfo.subframe - (4)) < 0) { timingInfo.sfn = timingInfo.sfn - 1; } else timingInfo.sfn = timingInfo.sfn; } timingInfo.subframe = (10 + timingInfo.subframe - (4)) % (10); };

   if (cbType == 2)
   {
      raCb = (RgSchRaCb *)(cb);
      hqE = raCb->dlHqE;
      hqP = rgSCHDhmHqProcByTime(hqE, timingInfo, &isMsg4, &numTbs, &tbStrtIdx);
...
# 2394 "../..//ltemac/rg_sch_dhm.c"
   ...
   if (hqP == 0L)
   {
# 2456 "../..//ltemac/rg_sch_dhm.c"
      err->errType = ((0 + 1) + 1);
      err->errCause = (((0 + 1) + 2) + 3);
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 2466); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHDhmHqFdbkInd():               HqProcId=%d",hqP->procId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 2482); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHDhmHqFdbkInd():            tbCnt=%d , isAck=%d",tbCnt,isAck); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if (1 == isAck)
      {
         if (isMsg4 == 1)
         {
            ...
            { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 2532); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Ack Rcvd. FdbkInd for Msg4Done\n"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
            ...
            if (raCb != 0L)
            {
               ...
               if(raCb->ccchSduBo)
               {
                  ...
                  ue->dlCcchInfo.bo = raCb->ccchSduBo;
...
# 2573 "../..//ltemac/rg_sch_dhm.c"
      ...
      if(hqRls == 1)
      {
# 2597 "../..//ltemac/rg_sch_dhm.c"
         rlsHqBufs->ueHqInfo[rlsHqBufs->numUes].tbId[ rlsHqBufs->ueHqInfo[rlsHqBufs->numUes].numOfTBs] = tbCnt + 1;
...
# 2704 "../..//ltemac/rg_sch_dhm.c"
 Void rgSCHDhmRgrUeRecfg
(
RgSchCellCb *cell,
RgSchUeCb *ueCb,
RgrUeRecfg *ueCfg,
...

{
   ...
   if (ueCb->dl.hqEnt)
   {
      if ((ueCb->dl.hqEnt->raCb) &&
            (ueCb->dl.hqEnt == ueCb->dl.hqEnt->raCb->dlHqE))
      {
         ...
         rgSCHRamDelRaCb(ueCb->cell, ueCb->dl.hqEnt->raCb, 0);
      }
# 2957 "../..//ltemac/rg_sch_dhm.c"
      rgSCHUtlFreeSBuf(ueCb->cell->instIdx, (Data **)(&(ueCb->dl.hqEnt)),
            sizeof(RgSchDlHqEnt));
   }
...

{
   ...
   { if (timingInfo.sfn == 0) { if ((timingInfo.subframe - (4)) < 0) { frm.sfn = 1024 - 1; } else { frm.sfn = timingInfo.sfn; } } else { if ((timingInfo.subframe - (4)) < 0) { frm.sfn = timingInfo.sfn - 1; } else frm.sfn = timingInfo.sfn; } frm.subframe = (10 + timingInfo.subframe - (4)) % (10); };

   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 3477); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHDhmRlsDlsfHqProc():                  frm timing info sfn=%d subframe=%d",frm.sfn,frm.subframe); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   while (node)
   {
      ...
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_dhm.c", 3494); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf,"\n rgSCHDhmRlsDlsfHqProc():                    txCntr=%d tmpHqProc=%d",tbCb->txCntr,tmpHqProc->procId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   if (hqP->tbInfo[0].cntrRetxAllocFail == 10)
   {
      ...
      rlsHqInfo->ueHqInfo[rlsHqInfo->numUes].tbId[ rlsHqInfo->ueHqInfo[rlsHqInfo->numUes].numOfTBs] = 1;
   ...
   if (hqP->tbInfo[1].cntrRetxAllocFail == 10)
   {
      ...
      rlsHqInfo->ueHqInfo[rlsHqInfo->numUes].tbId[ rlsHqInfo->ueHqInfo[rlsHqInfo->numUes].numOfTBs] = 2;
   ...
   {
      if (cell->dlSchdType == 2)
      {
         rgSCHRrDlRmvProcFrmRetxLst(cell, hqP);
      }
      else if (cell->dlSchdType == 1)
      {
