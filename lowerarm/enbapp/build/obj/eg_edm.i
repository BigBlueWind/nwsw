...
# 103 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm5.h" 1
# 104 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm_err.h" 1
# 91 "../..//cm/cm_err.h"
#define __CMERRH__ 
# 105 "../..//cm/cm_err.h"
...
# 120 "../..//egtpu/eg_edm.c" 2




# 1 "../..//cm/gen.x" 1
# 125 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/ssi.x" 1
# 126 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 127 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 128 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 129 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm_mblk.x" 1
# 130 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm_llist.x" 1
# 91 "../..//cm/cm_llist.x"
#define __CMLLISTX__ 
...
# 131 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm5.x" 1
# 132 "../..//egtpu/eg_edm.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
# 150 "../..//egtpu/eg_edm.c" 2
# 168 "../..//egtpu/eg_edm.c"
static S16 egUEncodeGmHdr (EgUEvnt *evntMsg, Buffer *mBuf);

static S16 egUEncIeData (Buffer *mBuf, EgUIe *egIe);

static S16 egUEncIe (EgUIe *ie, Buffer *mBuf);
...
static S16 egUDecIeData (EgUEvnt *evntMsg, Buffer *mBuf, EgUIe *egIe, U16 ieLen);

static S16 egUDecIe (EgUEvnt *evntMsg, Buffer *mBuf,Bool *iePres,U8 *ieType);
...
static S16 egUValidateGmMsgIEs (EgUEvnt *evntMsg, Bool *iePres);

static S16 egUValidateIeLen (EgIeEntry *ieEntry, U8 msgType, U16 ieLen);

static S16 egUGetCRType (U8 extHdrType, U8 extHdrLen, Buffer *mBuf);
# 219 "../..//egtpu/eg_edm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",240); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
...
# 421 "../..//egtpu/eg_edm.c"
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",422); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
...

{
   ...
   MsgLen encLen = 0;
   EgUIe *tmpIe = 0L;
   EgIeEntry *ieEntry = 0L;
   EgUMsgEntry *gmEntry = 0L;
   MsgLen tPduSize = 0;
   U16 gmPosIdx = 0;
   U16 iePosIdx = 0;
   U16 tempLen = 0;
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",477); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if (!evntMsg)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",485); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncMsgReq: evntMsg is NULLP \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",486); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_MSG_UNABLE_TO_COMPLY); };
   }
   ...
   if (!evntMsg->egMsg)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",496); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncMsgReq: egMsg is NULLP \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };





      { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = 0; };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",502); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
...
# 522 "../..//egtpu/eg_edm.c"
   ...
   if(msgType == EGT_GTPU_MSG_GPDU)
   {
      ...
      if((evntMsg->maxTPduSize) && (tPduSize > evntMsg->maxTPduSize))
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",543); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncMsgReq: T-PDU size: %hd exceeds the maximum configured value: %d \n", tPduSize, evntMsg->maxTPduSize); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",551); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
      }
      ...
      evntMsg->egMsg->u.mBuf = 0L;

      EgUUtilDeAllocGmMsg(&(evntMsg->egMsg));
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",576); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
# 588 "../..//egtpu/eg_edm.c"
   else if((msgType != EGT_GTPU_MSG_ECHO_REQ) && (msgType != EGT_GTPU_MSG_ECHO_RSP) &&
         !(msgType == EGT_GTPU_MSG_ERROR_IND && evntMsg->errInd == 1) &&
         !(msgType == EGT_GTPU_MSG_SUPP_EXT_HDR_NTF && evntMsg->suppExtHdrNtf == 1))
   {



      cmMemset((Bool *)iePres, 0, sizeof(iePres));
      ...
      if(retVal != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",606); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncMsgReq: Message validation is failed \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




         { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = msgType; };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",611); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
      }
      ...
      for(cnt = 0; cnt < ieCnt; cnt++)
      {
         ...
         else
         {
            ...
            EgUUtilGmDelIe(evntMsg->egMsg, tmpIe->ieType, 1);
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",653); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIe(Deleted the Unknown IE(%d)\n", tmpIe->ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         if ( (ieEntry) && (ieEntry->dataType != tmpIe->dataType))
         {
            ...
            EgUUtilGmDelIe(evntMsg->egMsg, tmpIe->ieType, 1);
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",680); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIe(Deleted the IE(%d) with wrong datatype\n", tmpIe->ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         if((tmpIe->dataType == EG_IP_ADDR) &&
               ((tmpIe->t.ipAddr.addrType != 4) &&
                (tmpIe->t.ipAddr.addrType != 6)))
         {
            ...
            EgUUtilGmDelIe(evntMsg->egMsg, tmpIe->ieType, 1);
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",709); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIe(Deleted the IE(%d) with wrong data\n", tmpIe->ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         if((iePres[tmpIe->ieType] == 0) ||
               (tmpIe->ieType == 255))
         {
            iePres[tmpIe->ieType] = 1;
         }
         else
         {
            ...
            EgUUtilGmDelIe(evntMsg->egMsg, tmpIe->ieType, 2);
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",742); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIe(Deleted the duplicate IE(%d)\n", tmpIe->ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         if(!expIe)
         {
            ...
            EgUUtilGmDelIe(evntMsg->egMsg, tmpIe->ieType, 1);
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",783); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIe(Deleted the Unexpected IE(%d)\n", tmpIe->ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      if(retVal != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",803); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncMsgReq: IE validation is failed \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",804); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
      }
   }
   ...
   if(retVal != 0)
   {
      ...
      { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = msgType; };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",823); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   for(cnt = 0; cnt < evntMsg->egMsg->u.egIeList.count; cnt++)
   {
      ...
      if(retVal != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",849); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncMsgReq: IE encoding is failed \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


         if(retVal == EGT_ERR_INV_IE_VAL)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",854); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIe(IE(%d), resultType(%d)) \n", tmpIe->ieType, retVal); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         SPutMsg(mBuf);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",862); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
      }
      else
      {
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",906); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 924 "../..//egtpu/eg_edm.c"
static S16 egUEncIeData
(
   Buffer *mBuf,
   EgUIe *egIe
 )
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",937); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",941); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIeData(IE Type(%d), IE Data Type(%d)) \n", egIe->ieType, egIe->dataType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
   ...
   switch (egIe->dataType)
   {
      ...
      case EG_UNSIGNED_32:
         { U16 nwWord = 0; U8 data[0x02]; data[0] = 0; data[1] = 0; nwWord = (U16)((((U32)(egIe->t.valUnSgnd32) >> 16) & 0xffffL)); { data[0] = (U8)((((U16)(nwWord) >> 8) & 0xff)); data[1] = (U8)(((U16)(nwWord) & 0xff)); SAddPstMsgMult(data, 0x02, mBuf); }; nwWord = (U16)(((U32)(egIe->t.valUnSgnd32) & 0xffffL)); { data[0] = (U8)((((U16)(nwWord) >> 8) & 0xff)); data[1] = (U8)(((U16)(nwWord) & 0xff)); SAddPstMsgMult(data, 0x02, mBuf); }; };
         break;

      case EG_PVT_EXTN:
         { U8 nwByte[0x02]; nwByte[0] = (((U16)(egIe->t.pvtExt.entId) >> 8) & 0xff); nwByte[1] = ((U16)(egIe->t.pvtExt.entId) & 0xff); SAddPstMsgMult(nwByte, 0x02, mBuf); };
         SAddPstMsgMult(egIe->t.pvtExt.propVal.val,
               egIe->t.pvtExt.propVal.length, mBuf);
         break;

      case EG_IP_ADDR:
         if(egIe->t.ipAddr.addrType == 4)
         {
            { U16 nwWord = 0; U8 data[0x02]; data[0] = 0; data[1] = 0; nwWord = (U16)((((U32)(egIe->t.ipAddr.u.ipv4) >> 16) & 0xffffL)); { data[0] = (U8)((((U16)(nwWord) >> 8) & 0xff)); data[1] = (U8)(((U16)(nwWord) & 0xff)); SAddPstMsgMult(data, 0x02, mBuf); }; nwWord = (U16)(((U32)(egIe->t.ipAddr.u.ipv4) & 0xffffL)); { data[0] = (U8)((((U16)(nwWord) >> 8) & 0xff)); data[1] = (U8)(((U16)(nwWord) & 0xff)); SAddPstMsgMult(data, 0x02, mBuf); }; };
         }
      ...
      case EG_EXT_HDR_TYPE_LST:
         {
            U16 cnt = 0;
            if(egIe->t.extHdrTypeLst.noOfExtHdrs > 2)
            {
...
# 997 "../..//egtpu/eg_edm.c"
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",999); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 1017 "../..//egtpu/eg_edm.c"
static S16 egUEncIe
(
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1037); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   cmMemset((U8*)dumBytes, 0, 0x02);
   cmMemset((U8*)dumBytes1, 0, 0x01);
   ...
   {
      retVal = EGT_ERR_MSG_UNABLE_TO_COMPLY;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1048); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }




   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1055); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncIe(IE Type(%d) \n",ie->ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
   ...
   if(!ieEntry->tvType)
   {
      if(ie->ieType != 141)
      {
         SAddPstMsgMult((U8*)dumBytes, 0x02, mBuf);
      }
      else
      {
         SAddPstMsgMult((U8*)dumBytes1, 0x01, mBuf);
      }
   }
   ...
   if(retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1095); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUEncMsgReq: IE Data Encoding is failed \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1096); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   if(!ieEntry->tvType)
   {
      ...
      if(ie->ieType != 141)
      {
         ieLen = finLen - initLen - 0x03;
      }
      else
      {
         ieLen = finLen - initLen - 0x02;
      }
      ...
      if(ie->ieType != 141)
      {
         { U8 nwByte[0x02]; nwByte[0] = (U8)((((U16)(ieLen) >> 8) & 0xff)); nwByte[1] = (U8)(((U16)(ieLen) & 0xff)); SRepMsg(nwByte[0], mBuf, initLen++); SRepMsg(nwByte[1], mBuf, initLen++); };
      }
      else
      {
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1139); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 1157 "../..//egtpu/eg_edm.c"
 S16 egUDecMsgReq
(
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1197); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if (!evntMsg)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1205); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: evntMsg is NULLP \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1206); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_MSG_UNABLE_TO_COMPLY); };
   }
   ...
   {
      retVal = EGT_ERR_MSG_UNABLE_TO_COMPLY;
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1222); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: mBuf is NULLP \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


      { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = 0; };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1226); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_MSG_UNABLE_TO_COMPLY); };
   }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1243); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: Memory allocation failed for egMsg \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      SPutMsg(mBuf);
      mBuf = 0L;
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1253); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_MSG_UNABLE_TO_COMPLY); };
   }
   ...
   if(retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1263); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: Message header decoding is failed \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1270); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   if(evntMsg->egMsg->msgHdr.msgType != EGT_GTPU_MSG_GPDU)
   {
      ...
      while (msgLen)
      {
         ...
         if (retVal != 0)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1303); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: IE decoding is failed \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            SPutMsg(mBuf);
            evntMsg->resultType = retVal;
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1306); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
         }
         ...
         if(ieType < lastDecIeType)
         {
            ...
            SPutMsg(mBuf);
            mBuf = 0L;
            evntMsg->resultType = EGT_ERR_IE_NOT_ASCD_ORDER;
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1322); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_IE_NOT_ASCD_ORDER); };
         }
      ...
      for(cnt = 0; cnt < ieCnt; cnt++)
      {
         ...
         if(!expIe)
         {
            ...
            EgUUtilGmDelIe(evntMsg->egMsg, tmpIe->ieType, 1);
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1369); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecIe(Deleted the unexpected IE(%d)\n", tmpIe->ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      if(gmEntry->nmbMandIe)
      {
         ...
         if(retVal != 0)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1389); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecMsgReq: Message validation is failed \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
            ...
            mBuf = 0L;
            evntMsg->resultType = retVal;
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1397); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
         }
      }
   ...
   evntMsg->resultType = 100;
# 1428 "../..//egtpu/eg_edm.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1428); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 1446 "../..//egtpu/eg_edm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1468); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
...
# 1490 "../..//egtpu/eg_edm.c"
   ...
   if(version != 1)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1501); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Invalid Msg Version(%d),          resultType(%d) \n",version, retVal); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



      { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = 0; };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1504); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   if (!(tmpByte & 0x10))
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1515); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Invalid Protocol Type(%d),          resultType(%d) \n",0, retVal); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



      { evntMsg->resultType = retVal; evntMsg->failedIeType = 0; evntMsg->failedMsgType = 0; };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1518); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   { U8 nwByte[0x02]; U16 tmpU16 = 0; nwByte[0] = 0; nwByte[1] = 0; SRemPreMsg(&nwByte[0], mBuf); SRemPreMsg(&nwByte[1], mBuf); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); msgLen = tmpU16; };
...
# 1559 "../..//egtpu/eg_edm.c"
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1561); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }

   { U16 nwWord[0x02]; U32 tmpU32 = 0; nwWord[0] = 0; nwWord[1] = 0; { U16 decWord = 0; U8 nwByte[0x02]; S16 tmpRetBS = 0; nwByte[0] = 0; nwByte[1] = 0; tmpRetBS = SRemPreMsgMult(nwByte, 0x02, mBuf); decWord = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(decWord) & 0x00ff)); decWord = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(decWord) & 0xff00)); nwWord[0] = decWord; }; { U16 decWord = 0; U8 nwByte[0x02]; S16 tmpRetBS = 0; nwByte[0] = 0; nwByte[1] = 0; tmpRetBS = SRemPreMsgMult(nwByte, 0x02, mBuf); decWord = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(decWord) & 0x00ff)); decWord = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(decWord) & 0xff00)); nwWord[1] = decWord; }; tmpU32 = (U32) (((U32)(nwWord[0]) << 16) | ((U32)(tmpU32) & (U32)0x0000ffff)); tmpU32 = (U32) (((U32)(nwWord[1]) & 0xffff) | ((U32)(tmpU32) & (U32)0xffff0000)); evntMsg->egMsg->msgHdr.teId = tmpU32; };
   ...
   if ( tmpByte & 0x02 )
   {
      ...
      { U8 nwByte[0x02]; U16 tmpU16 = 0; nwByte[0] = 0; nwByte[1] = 0; SRemPreMsg(&nwByte[0], mBuf); SRemPreMsg(&nwByte[1], mBuf); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); evntMsg->egMsg->msgHdr.seqNumber.val = tmpU16; };
   }
   ...
   if(tmpByte & 0x04)
   {
      ...
      while(extHdrType)
      {
         ...
         switch (extHdrType)
         {
            ...
            case 64:
               ...
               if(extHdrLen == 0x01)
               {
                  ...
                  { U8 nwByte[0x02]; U16 tmpU16 = 0; nwByte[0] = 0; nwByte[1] = 0; SRemPreMsg(&nwByte[0], mBuf); SRemPreMsg(&nwByte[1], mBuf); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); evntMsg->egMsg->msgHdr.extHdr.udpPort.val = tmpU16; };
               }
               else
               {
                  ...
                  { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1637); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received Ext. Hdr :%d with wrong                      length : %d -- Actual length :%d\n", extHdrType, extHdrLen, 0x01); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
            ...
            case 192:
               ...
               if(extHdrLen == 0x01)
               {
                  ...
                  { U8 nwByte[0x02]; U16 tmpU16 = 0; nwByte[0] = 0; nwByte[1] = 0; SRemPreMsg(&nwByte[0], mBuf); SRemPreMsg(&nwByte[1], mBuf); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); evntMsg->egMsg->msgHdr.extHdr.pdcpNmb.val = tmpU16; };
               }
               else
               {
                  ...
                  retVal = egUGetCRType(extHdrType, extHdrLen, mBuf);
                  { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1660); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received Ext. Hdr :%d with wrong                      length : %d -- Actual length :%d\n", extHdrType, extHdrLen, 0x01); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         else if(retVal == 31 )
         {
            if(unKnownExtHdr == 1)
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1688); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received UnSupported Ext. Hdr :%d with                   Comprehension Required\n", extHdrType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
# 1695 "../..//egtpu/eg_edm.c"
               ...
               { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1704); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_UNSUPP_EXT_HDR); };
            }
            else
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1711); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecodeGmHdr(Received Supported Ext. Hdr :%d with                   Comprehension Required with Wrong length field\n", extHdrType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



               { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1712); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_WRONG_EXT_HDR); };
            }
         }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1745); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 1765 "../..//egtpu/eg_edm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1781); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }

      hdr = &evntMsg->egMsg->msgHdr;

   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1787); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr( Message Type (%d) \n", hdr->msgType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
   ...
   if(!gmPosIdx)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1799); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr(Invalid Message Type(%d) resultType(%d) \n", hdr->msgType, retValue); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


      { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1802); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retValue); };
   }
            ...
            (hdr->msgType == EGT_GTPU_MSG_ERROR_IND)) && (hdr->teId))
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1822); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr(Invalid teid(%ld) for this message\n", hdr->teId); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



      { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1827); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retValue); };
   ...
   if(evntMsg->isEnc)
   {
      ...
      if((hdr->msgType == EGT_GTPU_MSG_END_MARKER) && (!hdr->teId))
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1851); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr(Invalid teid(%ld) for this message\n", hdr->teId); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



         { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1856); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retValue); };
      }
# 1866 "../..//egtpu/eg_edm.c"
      if((hdr->msgType == EGT_GTPU_MSG_SUPP_EXT_HDR_NTF) || (hdr->msgType == EGT_GTPU_MSG_ERROR_IND))
      {
         if(!hdr->seqNumber.pres)
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1872); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr(Sequence number not present for message %d\n", hdr->msgType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1875); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retValue); };
         }
      }
...
# 1897 "../..//egtpu/eg_edm.c"
        if((evntMsg->intfType != EGT_INT_S1_U_ENB_GTP_U)&&
         ...
         {
            retValue = EGT_ERR_MSG_INV_TYPE;
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1910); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr(Invalid Message(%d) on this node \n", hdr->msgType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


            { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1913); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retValue); };
         }
      }
   }
   ...
   else
   {
      ...
      if((hdr->msgType == EGT_GTPU_MSG_ECHO_REQ) || (hdr->msgType == EGT_GTPU_MSG_ECHO_RSP))
      {
         ...
         {
            retValue = EGT_ERR_NO_SEQ;
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1931); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateGmHdr(Sequence number not present for message %d\n", hdr->msgType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            { evntMsg->resultType = retValue; evntMsg->failedIeType = 0; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1934); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retValue); };
         }
...
# 1961 "../..//egtpu/eg_edm.c"
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",1963); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retValue); };
}
# 1980 "../..//egtpu/eg_edm.c"
static S16 egUDecIe
(
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2005); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };




   cmMemset((U8*)&tmpIe, 0, sizeof(EgUIe));
   cmMemset((U8*)skipIe, 0, 255);
   ...
   if(msgLen == 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2020); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_MSG_INV_LEN); };
   }
   ...
   *ieType = tmpIe.ieType;
   ...
   if(!isTvType)
   {
      ...
      if(tmpIe.ieType != 141)
      {
         { U8 nwByte[0x02]; U16 tmpU16 = 0; nwByte[0] = 0; nwByte[1] = 0; SRemPreMsg(&nwByte[0], mBuf); SRemPreMsg(&nwByte[1], mBuf); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); tmpIeLen = tmpU16; };
         msgLen -= 0x02;
      }
      else
      {
   ...
   else
   {
      ...
      if(isTvType)
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2068); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecIe(IE(%d), resultType(%d)) \n", tmpIe.ieType, retVal); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


         { evntMsg->resultType = retVal; evntMsg->failedIeType = tmpIe.ieType; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2071); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
      }
      else
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2080); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
      }
   }
   ...
   if((iePres[tmpIe.ieType] == 1) && (tmpIe.ieType != 255))
   {
      ...
      SRemPreMsgMult(skipIe, tmpIeLen, mBuf);
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2099); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
   ...
   if(!isTvType)
   {
      ...
      if (retVal == EGT_ERR_MAN_IE_INV_LEN)
      {
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2120); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecIe(IE(%d), resultType(%d)) \n", tmpIe.ieType, retVal); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


         { evntMsg->resultType = retVal; evntMsg->failedIeType = tmpIe.ieType; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2123); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
      }
      ...
      else if( retVal == 30)
      {
         if (tmpIeLen > msgLen)
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2138); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecIe(IE(%d), resultType(%d)) \n", tmpIe.ieType, retVal); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


            { evntMsg->resultType = retVal; evntMsg->failedIeType = tmpIe.ieType; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2141); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
         }
         ...
         SRemPreMsgMult(skipIe, tmpIeLen, mBuf);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2148); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
      }
   }
   ...
   if( retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2164); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecIe(Unable to Decode IE: %d)\n",tmpIe.ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2165); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   if(retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2175); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecIe(Unable to Append IE :%d) \n",tmpIe.ieType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      if(retVal == 1)
      {
         ...
         egSendLmAlarm (4, 13,
               15, &dgn);
         { evntMsg->resultType = retVal; evntMsg->failedIeType = tmpIe.ieType; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2190); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
      }
      else
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2194); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
      }
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2203); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 2221 "../..//egtpu/eg_edm.c"
static S16 egUDecIeData
(
 EgUEvnt *evntMsg,
 Buffer *mBuf,
 EgUIe *egIe,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2239); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2243); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUDecIeData(IE Type(%d), IE Data Type(%d)) \n", egIe->ieType, egIe->dataType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
   ...
   switch (egIe->dataType)
   {
      ...
      case EG_UNSIGNED_32:
         { U16 nwWord[0x02]; U32 tmpU32 = 0; nwWord[0] = 0; nwWord[1] = 0; { U16 decWord = 0; U8 nwByte[0x02]; S16 tmpRetBS = 0; nwByte[0] = 0; nwByte[1] = 0; tmpRetBS = SRemPreMsgMult(nwByte, 0x02, mBuf); decWord = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(decWord) & 0x00ff)); decWord = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(decWord) & 0xff00)); nwWord[0] = decWord; }; { U16 decWord = 0; U8 nwByte[0x02]; S16 tmpRetBS = 0; nwByte[0] = 0; nwByte[1] = 0; tmpRetBS = SRemPreMsgMult(nwByte, 0x02, mBuf); decWord = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(decWord) & 0x00ff)); decWord = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(decWord) & 0xff00)); nwWord[1] = decWord; }; tmpU32 = (U32) (((U32)(nwWord[0]) << 16) | ((U32)(tmpU32) & (U32)0x0000ffff)); tmpU32 = (U32) (((U32)(nwWord[1]) & 0xffff) | ((U32)(tmpU32) & (U32)0xffff0000)); egIe->t.valUnSgnd32 = tmpU32; };
         break;
      ...
      case EG_PVT_EXTN:
         {
            ...
            U16 propValLen = 0;
            { U8 nwByte[0x02]; U16 tmpU16 = 0; nwByte[0] = 0; nwByte[1] = 0; SRemPreMsg(&nwByte[0], mBuf); SRemPreMsg(&nwByte[1], mBuf); tmpU16 = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(tmpU16) & 0x00ff)); tmpU16 = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(tmpU16) & 0xff00)); egIe->t.pvtExt.entId = tmpU16; };

            propValLen = ieLen - 0x02;
      ...
      case EG_IP_ADDR:
         ...
         if(ieLen == 0x04)
         {
            egIe->t.ipAddr.addrType = 0x04;
            { U16 nwWord[0x02]; U32 tmpU32 = 0; nwWord[0] = 0; nwWord[1] = 0; { U16 decWord = 0; U8 nwByte[0x02]; S16 tmpRetBS = 0; nwByte[0] = 0; nwByte[1] = 0; tmpRetBS = SRemPreMsgMult(nwByte, 0x02, mBuf); decWord = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(decWord) & 0x00ff)); decWord = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(decWord) & 0xff00)); nwWord[0] = decWord; }; { U16 decWord = 0; U8 nwByte[0x02]; S16 tmpRetBS = 0; nwByte[0] = 0; nwByte[1] = 0; tmpRetBS = SRemPreMsgMult(nwByte, 0x02, mBuf); decWord = (U16) (((U16)(nwByte[0]) << 8) | ((U16)(decWord) & 0x00ff)); decWord = (U16) (((U16)(nwByte[1]) & 0xff) | ((U16)(decWord) & 0xff00)); nwWord[1] = decWord; }; tmpU32 = (U32) (((U32)(nwWord[0]) << 16) | ((U32)(tmpU32) & (U32)0x0000ffff)); tmpU32 = (U32) (((U32)(nwWord[1]) & 0xffff) | ((U32)(tmpU32) & (U32)0xffff0000)); egIe->t.ipAddr.u.ipv4 = tmpU32; };
         }
      ...
      default:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2302); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(34); };
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2305); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 2323 "../..//egtpu/eg_edm.c"
static S16 egUValidateGmMsgIEs
(
   EgUEvnt *evntMsg,
   Bool *iePres
 )
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2347); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
   ...
   if(gmEntry->nmbMandIe)
   {
      ...
      {
         if((gmEntry->ieProperties[loopCnt].ieClass == 1) &&
               (! iePres[gmEntry->ieProperties[loopCnt].ieType]))
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2371); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egValidateGmMsgIEs(IE Type(%d), Msg Type (%d) -                mandatory element is missing, resulType(%d)) \n", gmEntry->ieProperties[loopCnt].ieType, msgType, retVal); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




            { evntMsg->resultType = retVal; evntMsg->failedIeType = gmEntry->ieProperties[loopCnt].ieType; evntMsg->failedMsgType = evntMsg->egMsg->msgHdr.msgType; };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2375); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
         }
      }
   }
   ...
   if((evntMsg->isEnc) && (evntMsg->egMsg->u.egIeList.count > 1))
   {
      ...
      tmpEgIe = (EgUIe* ) ((((tmpNode) = ((ieList)->crnt = (ieList)->first)) != 0L) ? (tmpNode)->node : 0L);
      ...
      while(tmpEgIe != 0L)
      {
         ...
         tmpEgIe = (EgUIe* ) ((((tmpNode) = ((ieList)->crnt = ((ieList)->crnt ? (ieList)->crnt->next : (ieList)->first)))!= 0L) ? (tmpNode)->node : 0L);
      }
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2433); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 2450 "../..//egtpu/eg_edm.c"
static S16 egUValidateIeLen
(
 EgIeEntry *ieEntry,
 U8 msgType,
 U16 ieLen
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2467); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
          ...
          ((ieLen != ieEntry->minLen) && (ieLen != ieEntry->maxLen))))
   {
      ...
      for(tmpCnt=0; tmpCnt < gmEntry->nmbIe; tmpCnt++)
      {
         if ((gmEntry->ieProperties[tmpCnt].ieType == ieEntry->ieCode) &&
               (gmEntry->ieProperties[tmpCnt].ieClass == 1))
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2493); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUValidateIeLen: :Length validation for Mandatory IE(%d) is failed) \n", ieEntry->ieCode); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };





            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2497); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(EGT_ERR_MAN_IE_INV_LEN); };
         }
      }
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2505); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(30); };
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2508); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 2525 "../..//egtpu/eg_edm.c"
static S16 egUGetCRType
(
U8 extHdrType,
U8 extHdrLen,
Buffer *mBuf
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2542); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };





   chValue = extHdrType >> 6;
   ...
   if(chValue == 3)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2555); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(31); };
   }
   else
   {
# 2567 "../..//egtpu/eg_edm.c"
      extHdrValLen = (0x04 * extHdrLen) - 0x02;




      SRemPreMsgMult(temp, extHdrValLen, mBuf);
      { if (egCb.init.dbgMask & ((0x00000100 << 3))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2574); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"INFO\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUGetCRType Deleted Extension Header :%d", extHdrType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_edm.c",2575); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(32); };
   }
