...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//ltemac/rg_sch_rr.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//ltemac/rg_sch_rr.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
# 113 "../..//ltemac/rg_sch_rr.c" 2
# 1 "../..//ltemac/rg_sch_rr.h" 1
# 102 "../..//ltemac/rg_sch_rr.h"
#define __RGSCHRRH__ 

#define RG_RR_MIN_DCCH_LCID 1
#define RG_RR_MAX_DCCH_LCID 2
#define RG_RR_CONTRES_GRNT 3
#define RG_RR_SR_GRNT 3
# 114 "../..//ltemac/rg_sch_rr.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//ltemac/rg_sch_rr.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//ltemac/rg_sch_rr.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 131 "../..//ltemac/rg_sch_rr.c" 2
# 1 "../..//ltemac/rg_sch_clist.x" 1
# 92 "../..//ltemac/rg_sch_clist.x"
...
# 132 "../..//ltemac/rg_sch_rr.c" 2
# 1 "../..//ltemac/rg_sch_rr.x" 1
# 105 "../..//ltemac/rg_sch_rr.x"
#define __RGRRX__ 
...
( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiRpt );
...
extern Void rgSCHRrDlRmvProcFrmRetxLst (RgSchCellCb *cell, RgSchDlHqProcCb *hqP);
# 133 "../..//ltemac/rg_sch_rr.c" 2



static Void rgSCHRrRlsDlHqProc ( RgSchDlHqProcCb *proc );
# 153 "../..//ltemac/rg_sch_rr.c"
...

{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 269); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      return(1);
   }
...
# 374 "../..//ltemac/rg_sch_rr.c"
static S16 rgSCHRrDlUeHqEntInit
(
RgSchCellCb *cell,
RgSchUeCb *ue
)
...

{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      ...
      (ue->dl.hqEnt->numHqPrcs * sizeof(RgSchRrDlHqProc))) != 0)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 390); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      return(1);
   }
   return(0);
}
# 411 "../..//ltemac/rg_sch_rr.c"
static Void rgSCHRrDlUeHqEntDel
(
RgSchCellCb *cell,
RgSchUeCb *ue
)
...

{
   ...
   if(ue->dl.hqEnt->sch)
   {
      ...
      rgSCHUtlFreeSBuf(cell->instIdx,
      (Data**)(&(ue->dl.hqEnt->sch)),
      (ue->dl.hqEnt->numHqPrcs * sizeof(RgSchRrDlHqProc)));
   }
   return;
}
# 456 "../..//ltemac/rg_sch_rr.c"
 S16 rgSCHRrDlUeCfg
(
RgSchCellCb *cell,
RgSchUeCb *ue,
...

{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 479); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      return(1);
   }
   ...
   if(rgSCHRrDlUeHqEntInit(cell, ue) != 0)
   {
...
# 516 "../..//ltemac/rg_sch_rr.c"
static Void rgSCHRrDlProcRmvFrmRetx
(
RgSchCellCb *cell,
RgSchDlHqProcCb *hqP
)
...

{
   ...
   RgSchRrDlHqProc *schRrDlHqProc =
      &((RgSchRrDlHqProc *)hqP->hqE->sch)[hqP->procId];
   RgSchDlRbAlloc *dlRbAlloc = &(hqP->hqE->ue->dl.dlAllocCb);
   ;;
...

{
   ...
   for(i = 0; i < ue->dl.hqEnt->numHqPrcs; i++)
   {
      ...
      for (j = 0; j < 2; j++)
      {
               ...
               (hqP->tbInfo[j].sfLnk.node != 0L))
         {
            ...
            rgSCHUtlDlHqPTbRmvFrmTx(hqP->tbInfo[j].subFrm, hqP, j, 0);
   ...
   rgSCHRrDlUeHqEntDel(cell, ue);
   return;
}
# 807 "../..//ltemac/rg_sch_rr.c"
 S16 rgSCHRrDlLcCfg
(
RgSchCellCb *cell,
RgSchUeCb *ue,
...
# 823 "../..//ltemac/rg_sch_rr.c"
{
   RgSchCmnDlSvc *schCmnDlLc = (RgSchCmnDlSvc *)(dlLc->sch);
   ;;

   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(schCmnDlLc->schSpfc), (sizeof(RgSchRrDlLc))) != 0)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 830); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      return(1);
   }
   return(0);
}
# 856 "../..//ltemac/rg_sch_rr.c"
...
# 872 "../..//ltemac/rg_sch_rr.c"
{
   ;;

   return(0);
}
# 897 "../..//ltemac/rg_sch_rr.c"
 Void rgSCHRrDlLcDel
(
RgSchCellCb *cell,
RgSchUeCb *ue,
...

{
   ...
   RgSchRrDlCell *rrDlCell = (RgSchRrDlCell *)(schCmnCell->dl.schSpfc);
   RgSchCmnUe *schCmnUe = (RgSchCmnUe *)(ue->sch);
   RgSchDlRbAlloc *dlRbAlloc = &(ue->dl.dlAllocCb);
   RgSchRrDlUe *rrDlUe = (RgSchRrDlUe *)(schCmnUe->dl.schSpfc);
   RgSchCmnDlSvc *schCmnDlLc = (RgSchCmnDlSvc *)(dlLc->sch);
   RgSchRrDlLc *rrDlLc = (RgSchRrDlLc *)(schCmnDlLc->schSpfc);
   ;;
...

{
   ...
   for(i = 0; i < ue->dl.hqEnt->numHqPrcs; i++)
   {
      ...
      if ((hqP->tbInfo[0].subFrm != 0L) &&
          (hqP->tbInfo[0].sfLnk.node != 0L))
      {
         ...
         rgSCHUtlDlHqPTbRmvFrmTx(hqP->tbInfo[0].subFrm, hqP, 0, 0);
      }
      if ((hqP->tbInfo[1].subFrm != 0L) &&
               (hqP->tbInfo[1].sfLnk.node != 0L))
         {
  if (hqP->tbInfo[1].pdcch != hqP->tbInfo[0].pdcch)
  {
         ...
         rgSCHUtlDlHqPTbRmvFrmTx(hqP->tbInfo[1].subFrm, hqP, 1, 0);
      }
   }
...
# 1235 "../..//ltemac/rg_sch_rr.c"
      ...
      if(dlRbAlloc->reqLnk.node != 0L)
      {

         continue;
      }
# 1258 "../..//ltemac/rg_sch_rr.c"
...
# 1615 "../..//ltemac/rg_sch_rr.c"
      ...
      cmnHqDl = ((RgSchCmnDlHqProc *)((schCmnUe->dl.proc)->sch));
      cmnHqDl->totBytes = 0;
      if(rgSCHCmnDlAllocTxRb(cell, allocInfo->dedAlloc.dedDlSf, ue,
               2, &allocBo, schCmnUe->dl.proc, allocInfo) != 0)
...

{
   ...
   U32 remUe = (schCmnCell->dl.maxUeNewTxPerTti < allocInfo->dedAlloc.dedDlSf->remUeCnt) ?
               schCmnCell->dl.maxUeNewTxPerTti:allocInfo->dedAlloc.dedDlSf->remUeCnt;
   ...
   if(rgSCHRrDlSchdTa(cell, allocInfo) != 0)
   {
      return;
   }

   numUes = (rrDlCell->ueTxLst.count < remUe) ?
               rrDlCell->ueTxLst.count : remUe;

   if(rrDlCell->ueTxLst.crnt == 0L || !numUes)
   {
      return;
   }
# 1745 "../..//ltemac/rg_sch_rr.c"
   node = rrDlCell->ueTxLst.crnt;
   do
   {
      ue = (RgSchUeCb *)(node->node);
      node = node->next;
# 1761 "../..//ltemac/rg_sch_rr.c"
      if((ue->dl.dlInactvMask)
      ...
      if(rgSCHRrDlSchdUe(cell, ue, allocInfo->dedAlloc.dedDlSf, allocInfo) != 0)
   ...
   allocInfo->dedAlloc.dedDlSf->remUeCnt = numUes;
   return;
}
# 1824 "../..//ltemac/rg_sch_rr.c"
 Void rgSCHRrDlSchd
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *allocInfo
...
# 1890 "../..//ltemac/rg_sch_rr.c"
{
   ...
   while((*node) && (*effAlloc > 0))
   {
      ...
      *node = (*node)->next;
      ...
      bo = ((rrDlLc->schdBo) <= (*effAlloc) ? (rrDlLc->schdBo) : (*effAlloc));
      ...
      rrDlLc->schdBo -= bo;
      (dlLc->bo <= bo-rrDlLc->rlcHdrEstmt)? (dlLc->bo = 0): (dlLc->bo -= bo-rrDlLc->rlcHdrEstmt);
      ...
      *effAlloc -= bo;
      ...
      if(rgSCHDhmAddLcData(cell->instIdx, &lchSchdData,
            tbInfo) != 0)
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 1954); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Failed to update DHM"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   while(lcLst->crnt)
   {
      ...
      *effAlloc -= bo;
      ...
      if(rgSCHDhmAddLcData(cell->instIdx, &lchSchdData,
            tbInfo) != 0)
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 2084); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Failed to update DHM"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   if (remTb1Bytes){
      ...
      rgSCHRrDlNewTxTbDstn(cell, ue, &schCmnUe->dl.proc->tbInfo[0], &remTb1Bytes, &node);
   ...
   if (remTb2Bytes){
      ...
      rgSCHRrDlNewTxTbDstn(cell, ue, &schCmnUe->dl.proc->tbInfo[1], &remTb2Bytes, &node);
...

{
   ...
   while(node)
   {
      ...
      rgSCHCmnFillHqPPdcch(cell, dlRbAlloc, schCmnUe->dl.proc);


      if ((schCmnUe->dl.proc->tbInfo[0].state != HQ_TB_NACKED) &&
            (schCmnUe->dl.proc->tbInfo[1].state != HQ_TB_NACKED))
      {
         rgSCHRrDlProcRmvFrmRetx(cell, schCmnUe->dl.proc);
      }
   ...
   while(node)
   {
      ...
      rgSCHDhmDlRetxAllocFail(ue, schCmnUe->dl.proc);
      rgSCHCmnDlUeResetTemp(ue);
   }
   return;
}
# 2291 "../..//ltemac/rg_sch_rr.c"
...

{
   ...
   while(node)
   {
      ...
      if(rgSCHRrDlUeAllocFnlz(cell, ue) == 0)
      {
         ...
         rgSCHCmnFillHqPPdcch(cell, &(ue->dl.dlAllocCb),
               schCmnUe->dl.proc);
      }
      else
      {
...

{
   ...
   while(node)
   {
      ...
      rgSCHRrDlSprTxTbDstn(cell, ue, newTxTbInfo, &remTbBytes, &rrDlUe->sigLst);

      rgSCHRrDlSprTxTbDstn(cell, ue, newTxTbInfo, &remTbBytes, &rrDlUe->dataLst);
...

{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 2707); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_rr.c", 2831); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      return(1);
   }

   return(0);
}
# 2857 "../..//ltemac/rg_sch_rr.c"
...
# 2968 "../..//ltemac/rg_sch_rr.c"
{
   ;;

   return(0);
}
# 2994 "../..//ltemac/rg_sch_rr.c"
...
# 3010 "../..//ltemac/rg_sch_rr.c"
{
   ;;

   return(0);
}
# 3033 "../..//ltemac/rg_sch_rr.c"
...

{
   ...
   if(rrUlCell->contResLst.crnt == 0L)
   {
      return;
   }
# 3474 "../..//ltemac/rg_sch_rr.c"
   node = rrUlCell->contResLst.crnt;
   do
   {
      ue = (RgSchUeCb *)(node->node);
      node = node->next;
# 3490 "../..//ltemac/rg_sch_rr.c"
...
# 3628 "../..//ltemac/rg_sch_rr.c"
      ...
      if((ue->ul.ulInactvMask) ||
         (((&(ue)->ul.hqEnt.hqProcCb[ ((RgSchCmnCell *)(ue->cell->sc.sch))->ul.schdHqProcIdx])->alloc)))
