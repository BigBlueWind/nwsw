...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//lteclpal/ys_pal_msg.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//lteclpal/ys_pal_msg.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 116 "../..//lteclpal/ys_pal_msg.c" 2
# 1 "../..//cm/cm5.x" 1
# 117 "../..//lteclpal/ys_pal_msg.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 158 "../..//lteclpal/ys_pal_msg.c"
DateTime startDt;
# 177 "../..//lteclpal/ys_pal_msg.c"
 Void ysPalHdlTtiInd
(
CmLteTimingInfo *timingInfo
)
...

{
   ...
   ;
# 247 "../..//lteclpal/ys_pal_msg.c"
   ttiInd = 0L;




   if ((0L != ysCb.cellCb.tfuSap) && (0L != ysCb.cellCb.schTfuSap))
   {

      if(SGetSBuf(ysCb.tfuSap.sapPst.region, ysCb.tfuSap.sapPst.pool,
                     (Data **)&ttiInd, sizeof(TfuTtiIndInfo)) != 0)
      {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 258); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 258); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to get static memory\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         return;
      }


      if(SGetSBuf(ysCb.schTfuSap.sapPst.region, ysCb.schTfuSap.sapPst.pool,
                     (Data **)&schTtiInd, sizeof(TfuTtiIndInfo)) != 0)
      {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 266); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 266); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to get static memory\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      ...
      *schTtiInd = *ttiInd;
      ...
      TfUiTfuTtiInd(&ysCb.tfuSap.sapPst, ysCb.tfuSap.suId, ttiInd);


      TfUiTfuSchTtiInd(&ysCb.schTfuSap.sapPst, ysCb.schTfuSap.suId, schTtiInd);
   }
   ysPalHdlDlMsg(timingInfo);

   return;
}
# 309 "../..//lteclpal/ys_pal_msg.c"
 Void ysPalHdlDlMsg
(
CmLteTimingInfo *timingInfo
)
...

{
   ...
   Buffer *mBuf;
# 331 "../..//lteclpal/ys_pal_msg.c"
   ;
# 341 "../..//lteclpal/ys_pal_msg.c"
...
# 426 "../..//lteclpal/ys_pal_msg.c"
            ...
            break;
# 590 "../..//lteclpal/ys_pal_msg.c"
            default:
               { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 591); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 591); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Unknown event %d\n", txMsgInfo->event); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         }
      }
...

{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 622); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 622); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg() failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if (SPkS16(spId, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 636); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 636); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)cntrlReq);
      SPutMsg(mBuf);
      return(0L);
   }
   ...
   if (SPkU8(pst->event, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 644); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 644); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)cntrlReq);
      SPutMsg(mBuf);
      return(0L);
   }
...

{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 673); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 673); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg() failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      SPutSBuf(pst->region, pst->pool, (Data *)datReq, sizeof(TfuDatReqInfo));
      return(0L);
   }
   if (pst->selector == 0) {
      if (cmPkTfuDatReqInfo(datReq, mBuf) != 0) {
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 679); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 679); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if (SPkS16(spId, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 687); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 687); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)datReq);
      SPutMsg(mBuf);
      return(0L);
   }
   ...
   if (SPkU8(pst->event, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 696); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 696); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)datReq);
      SPutMsg(mBuf);
      return(0L);
   }
...

{
   ...
   if (SGetMsg(pst->region, pst->pool, &mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 725); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 725); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "SGetMsg() failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   if (SPkS16(spId, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 739); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 739); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)recpReq);
      SPutMsg(mBuf);
      return(0L);
   }
   ...
   if (SPkU8(pst->event, mBuf) != 0) {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 748); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_msg.c", 748); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "packing failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      cmFreeMem((Ptr)recpReq);
      SPutMsg(mBuf);
      return(0L);
   }
