...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 124 "../..//lterlcpdcp/kw_pj_dlm.c" 2
# 1 "../..//cm/cm5.h" 1
# 125 "../..//lterlcpdcp/kw_pj_dlm.c" 2
# 1 "../..//cm/cm_lte.h" 1
# 91 "../..//cm/cm_lte.h"
#define __CM_LTE_H__ 
# 101 "../..//cm/cm_lte.h"
...
# 147 "../..//lterlcpdcp/kw_pj_dlm.c" 2
# 1 "../..//cm/cm5.x" 1
# 148 "../..//lterlcpdcp/kw_pj_dlm.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 159 "../..//lterlcpdcp/kw_pj_dlm.c" 2





static S16 pjDlmBldPdu(PjRbCb *pjRbCb,PjTxEnt *txEnt);
# 197 "../..//lterlcpdcp/kw_pj_dlm.c"
...
# 213 "../..//lterlcpdcp/kw_pj_dlm.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 224); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmProcessSdus(pjRbCb(%d), sdu, sduId(%ld),                     sn(%u), txHfn) \n)", pjRbCb->rbId, sduId, sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 231 "../..//lterlcpdcp/kw_pj_dlm.c"
   txEnt = 0L;
   count = 0;
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&txEnt, (Size) sizeof(PjTxEnt)) == 0) { cmMemset((U8 *)(txEnt), 0, sizeof(PjTxEnt)); } else { (txEnt) = 0L; } };
# 250 "../..//lterlcpdcp/kw_pj_dlm.c"
   ;

   { count = sn; txHfn = txHfn << (pjRbCb->snLen); count |= txHfn; };
   ...
   if ( discInt )
   {
      ...
      if ( tmrRunning == 0 && pjRbCb->dlCb.discTmrInt != -1 )
      {
         pjStartTmr((U32)pjRbCb, 0x10);
      }
   }
# 293 "../..//lterlcpdcp/kw_pj_dlm.c"
   if (pjRbCb->rbType == 0)
   {
   ...
   {
# 308 "../..//lterlcpdcp/kw_pj_dlm.c"
      ret = pjDlmProcDrb(pjRbCb, txEnt);
   }

   return(ret);
}
# 336 "../..//lterlcpdcp/kw_pj_dlm.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 356); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmBldPdu(pjRbCb, txEnt (%ld)) \n", txEnt->sduId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { Data _liByte; U16 _bytes; _bytes = 0; while (numBytes > _bytes ) { _liByte = (U8) (hdr >> (8*_bytes)); ret = SAddPreMsg((Data )_liByte, pdu); if ( ret != 0 ) { break; } _bytes++; } };
# 404 "../..//lterlcpdcp/kw_pj_dlm.c"
   return(ret);
}
# 424 "../..//lterlcpdcp/kw_pj_dlm.c"
 Void pjDlmReEstSrb
(
PjRbCb *pjRbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 437); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmReEstSrb(pjRbCb (%d)) \n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 447 "../..//lterlcpdcp/kw_pj_dlm.c"
   if (pjRbCb->dlCb.discTmr.tmrEvnt == 0x10)
   {
   ...
   { pjRbCb->dlCb.nxtTxSn = 0; pjRbCb->dlCb.txHfn = 0; pjRbCb->dlCb.nxtToSub = 0; pjRbCb->dlCb.cfmExp = 0; pjRbCb->dlCb.count = 0; };

   return;
}
# 485 "../..//lterlcpdcp/kw_pj_dlm.c"
 S16 pjDlmReEstDrbUm
(
PjRbCb *pjRbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 507); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmReEstDrbUm(pjRbCb (%d)) \n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 528 "../..//lterlcpdcp/kw_pj_dlm.c"
   ...
   { tmpTxBuf.datQ = pjRbCb->dlCb.txBuf.datQ; tmpTxBuf.numEntries = pjRbCb->dlCb.txBuf.numEntries; tmpTxBuf.numBins = pjRbCb->dlCb.txBuf.numBins; pjDbmBufInit(&pjRbCb->dlCb.txBuf,kwCb.pjGenCfg.nmbDlBins); if ( pjRbCb->dlCb.txBuf.datQ == 0L ) { ; ret = 1; } };
# 546 "../..//lterlcpdcp/kw_pj_dlm.c"
...
# 565 "../..//lterlcpdcp/kw_pj_dlm.c"
         ...
         { newCount = sn; txHfn = txHfn << (pjRbCb->snLen); newCount |= txHfn; };
         ...
         hashKey = (count % (&tmpTxBuf)->numBins);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 639); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmReEstDrbAm(pjRbCb (%d)) \n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 730); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmProcessCfm(pjRbCb(%d), pjDatCfm, cfmType (%d)) \n", pjRbCb->rbId, cfmType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   {
      { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (datCfm) = 0L; } };
...
# 758 "../..//lterlcpdcp/kw_pj_dlm.c"
   ...
   else
   {
      ...
      {
         { if (datCfm != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) datCfm, (Size) sizeof(PjuDatCfmInfo)); datCfm = 0L; } };
         { if (pdcpId != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) pdcpId, (Size) sizeof(CmLtePdcpId)); pdcpId = 0L; } };
      }
   }
   ...
   { U32 _curCount = dlCb->count; U32 _count = dlCb->cfmExp; PjTxEnt *_txEnt = 0L; while ( _count <= _curCount ) { _txEnt = (PjTxEnt *)pjDbmGetTxEnt(&(dlCb->txBuf), _count); if ( _txEnt != 0L ) { break; } _count++; } dlCb->cfmExp = _count; };

   if ( pjRbCb->dlCb.txBuf.numEntries == 0 )
   {
      if ((pjChkTmr((U32)pjRbCb, 0x10)) == 1)
      {
         pjStopTmr( (U32)pjRbCb, 0x10);
      }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 881); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmHndlStaRep(pjRbCb (%d), fms (%u), staPdu) \n", pjRbCb->rbId, fms); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   {
      { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (datCfm) = 0L; } };
# 907 "../..//lterlcpdcp/kw_pj_dlm.c"
   }



   { U32 _startCount = pjRbCb->dlCb.cfmExp; U32 _stopCount = pjRbCb->dlCb.cfmExp; PjTxEnt *_ent; _ent = (PjTxEnt *)pjDbmGetTxEntSn( &(pjRbCb->dlCb.txBuf), fms); if ( _ent != 0L ) { _stopCount = _ent->count; pjRbCb->dlCb.cfmExp = _ent->count; pjRbCb->dlCb.nxtToSub = _ent->count; } while ( _startCount < _stopCount ) { _ent = (PjTxEnt *)pjDbmGetTxEnt( &(pjRbCb->dlCb.txBuf), _startCount); if ( _ent != 0L ) { if ( pjRbCb->dlCb.cfmReqd) { datCfm->cfmSta[datCfm->numSdus].sduId = _ent->sduId; datCfm->cfmSta[datCfm->numSdus].status = 0; datCfm->numSdus++; } pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), _ent->count); } _startCount++; } };


   while ( bMapLen != 0 )
   {
      ret = SRemPreMsg(&byte,staPdu);
# 930 "../..//lterlcpdcp/kw_pj_dlm.c"
      for ( cnt = 0; cnt < 8; cnt++, bitPos++ )
      {
         sn = (fms + bitPos) % 256;
         txEnt = (PjTxEnt *)pjDbmGetTxEntSn( &(pjRbCb->dlCb.txBuf), sn );
         sduSta = (byte << cnt) & 0x80;
         if ( txEnt != 0L )
         {
            if ( sduSta )
            {
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1035); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmReEstHoDrbAm(pjRbCb (%d )) \n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&datFwdInd, (Size) sizeof(PjuDatFwdIndInfo)) == 0) { cmMemset((U8 *)(datFwdInd), 0, sizeof(PjuDatFwdIndInfo)); } else { (datFwdInd) = 0L; } };
# 1069 "../..//lterlcpdcp/kw_pj_dlm.c"
    numSdu = 0;
   ...
   if (numSdu == 0)
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1076); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmReEstHoDrbAm: No data available to forward"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&datFwdInd->datFwdInfo, (Size) (numSdu * sizeof(PjuDatFwdInfo))) == 0) { cmMemset((U8 *)(datFwdInd->datFwdInfo), 0, (numSdu * sizeof(PjuDatFwdInfo))); } else { (datFwdInd->datFwdInfo) = 0L; } };
# 1097 "../..//lterlcpdcp/kw_pj_dlm.c"
   curCount = pjRbCb->dlCb.count;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1173); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmHndlDatFwdReq(pjRbCb (%d),datFwdReq(%d)) \n", pjRbCb->rbId, datFwdReq->numSdus); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( sduCount > 0 )
   {
      ...
      { count = firstSn; hfn = hfn << (pjRbCb->snLen); count |= hfn; };
...
# 1221 "../..//lterlcpdcp/kw_pj_dlm.c"
      ...
      { txEnt->count = txEnt->sn; txHfn = txHfn << (pjRbCb->snLen); txEnt->count |= txHfn; };
      pjDbmInsTxEnt(&(pjRbCb->dlCb.txBuf), txEnt);
   }
   count = pjRbCb->dlCb.cfmExp;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1317); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmDeliverPdu(pjRbCb (%d), txEnt) \n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( txEnt->pdu == 0L )
   {
      ...
      {
         ret =(SAddMsgRef((txEnt->sdu), (kwCb.init.region), (kwCb.init.pool), (&(txEnt->pdu))));
# 1345 "../..//lterlcpdcp/kw_pj_dlm.c"
      }
      else
      {
         txEnt->pdu = txEnt->sdu;
   ...
   if ( ret != 0 )
   {
      ...
      if ( pjRbCb->dlCb.cfmReqd)
      {
         { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; KwPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(kwCb.pjuSap[0]); else _pjuSap = &(kwCb.pjuSap[1]); { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 1; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), txEnt->count); };
      }
      return(1);
   }
   txEnt->state = 0x05;
   ...
   if ( count == dlCb->nxtToSub )
   {
      ...
      U32 mCnt = ((count - dlCb->nxtToSub) + 16) % 16;
      U32 mDlCnt = ((dlCb->count - dlCb->nxtToSub) + 16) % 16;
   U32 loopCnt = 0;
   U32 maxTxEnts;
   ...
   if (count > dlCb->count)
      ...
      while (loopCnt < maxTxEnts)
      {
         ...
         if (txEnt != 0L )
         {
            if (txEnt->state == 0x05 )
            {
               ...
               if ( (pjRbCb->mode == 2
                  ...
                  (!(pjRbCb->dlCb.cfmReqd) && pjRbCb->rbType == 0))
               {
                  pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), txEnt->count);
               }
            }
         ...
         count++;
   loopCnt++;
         mCnt = ((count - dlCb->nxtToSub) + 16) % 16;
         txEnt = (PjTxEnt *)pjDbmGetTxEnt(&(pjRbCb->dlCb.txBuf), count);
      }
      dlCb->nxtToSub = count;
   }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1507); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmProcSrb(pjRbCb (%d), txEnt(%ld)) \n", pjRbCb->rbId, txEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1514 "../..//lterlcpdcp/kw_pj_dlm.c"
   pdu = txEnt->sdu;
   macI = 0;
   ret = 0;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1582); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmProcDrb(pjRbCb (%d), txEnt(%ld)) \n", pjRbCb->rbId, txEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1647); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmHdlIntProt(pjRbCb (%d), txEnt (%ld)) \n", pjRbCb->rbId, txEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1654 "../..//lterlcpdcp/kw_pj_dlm.c"
   pdu = txEnt->sdu;
   macI = 0;
   ret = 0;
   hdr = 0;
   ...
   if (pjRbCb->ueCb->secInfo.selSecAct == 1 &&
            pjRbCb->ueCb->secInfo.firstDl == 1 )
   {
      pjRbCb->firstDlMsg = 1;
      pjRbCb->firstSn = txEnt->sn;
      pjRbCb->ueCb->secInfo.firstDl = 0;
   }
   secInp.dir = 1;
...
# 1692 "../..//lterlcpdcp/kw_pj_dlm.c"
   ...
   if ( ret != 0 )
   {
      ...
      if ( pjRbCb->dlCb.cfmReqd)
      {
         { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; KwPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(kwCb.pjuSap[0]); else _pjuSap = &(kwCb.pjuSap[1]); { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 5; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), txEnt->count); };
      }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1796); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmHdlCmp(pjRbCb (%d), txEnt (%ld)) \n", pjRbCb->rbId, txEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1803 "../..//lterlcpdcp/kw_pj_dlm.c"
   ret = 0;
   opSdu = 0L;
   ...
   if ( pjRbCb->rohc.hdrCmpUsed )
   {
      ...
      if ( ret != 0 )
      {
         ...
         if ( pjRbCb->dlCb.cfmReqd)
         {
            { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; KwPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(kwCb.pjuSap[0]); else _pjuSap = &(kwCb.pjuSap[1]); { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 4; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), txEnt->count); };
         }
   ...
   if ( pjRbCb->ueCb->secInfo.secAct )
   {
# 1845 "../..//lterlcpdcp/kw_pj_dlm.c"
   }
   ret = pjDlmDeliverPdu(pjRbCb, txEnt);
   return(ret);
}
# 1872 "../..//lterlcpdcp/kw_pj_dlm.c"
 S16 pjDlmHdlCiph
(
PjRbCb *pjRbCb,
PjTxEnt *txEnt
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ ((((0x00000002 << 4) << 11) << 0) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1891); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmHdlCiph(pjRbCb (%d), txEnt (%ld)) \n", pjRbCb->rbId, txEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( ret != 0 )
   {
      ...
      if ( pjRbCb->dlCb.cfmReqd)
      {
         { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; KwPjuSapCb *_pjuSap; if (pjRbCb->rbType == 0) _pjuSap = &(kwCb.pjuSap[0]); else _pjuSap = &(kwCb.pjuSap[1]); { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_datCfm, (Size) sizeof(PjuDatCfmInfo)) == 0) { cmMemset((U8 *)(_datCfm), 0, sizeof(PjuDatCfmInfo)); } else { (_datCfm) = 0L; } }; { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(_pdcpId), 0, sizeof(CmLtePdcpId)); } else { (_pdcpId) = 0L; } }; if ( _datCfm != 0L && _pdcpId != 0L ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = 6; _datCfm->numSdus++; _pdcpId->rbId = pjRbCb->rbId; _pdcpId->rbType = pjRbCb->rbType; _pdcpId->ueId = pjRbCb->ueCb->key.ueId; _pdcpId->cellId = pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), txEnt->count); };
      }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 3) | (0x00000002 << 1) | (((0x00000002 << 4) << 11) << 2))) ^ (((0x00000002 << 4) << 3) | (0x00000002 << 1) | (((0x00000002 << 4) << 11) << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 1986); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmDiscTmrExp(pjRbCb (%d)) \n", pjRbCb->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   while ( count <= curCount )
   {
      if ( txEnt != 0L )
      {
         if ((txEnt->arrTime + (discInt )) <= curTime)
         {
            ...
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 3) | (0x00000002 << 1) | (((0x00000002 << 4) << 11) << 0))) ^ (((0x00000002 << 4) << 3) | (0x00000002 << 1) | (((0x00000002 << 4) << 11) << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dlm.c", 2047); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDlmDiscTmrExp(pjRbCb (%d)): discarded txEnt with               count (%ld) \n", pjRbCb->rbId, txEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
            ...
            if ( pjRbCb->dlCb.cfmReqd)
            {
               ...
               datCfm->cfmSta[numSdus++].status = 2;
            }
            numBuf--;
            if ( txEnt->pdu == txEnt->sdu )
            {
