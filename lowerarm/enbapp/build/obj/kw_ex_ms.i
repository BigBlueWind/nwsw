...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 103 "../..//lterlcpdcp/kw_ex_ms.c" 2
# 1 "../..//cm/cm5.h" 1
# 104 "../..//lterlcpdcp/kw_ex_ms.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
# 121 "../..//lterlcpdcp/kw_ex_ms.c" 2

# 1 "../..//lterlcpdcp/kw_pj_lib.h" 1
# 94 "../..//lterlcpdcp/kw_pj_lib.h"
#define __KW_PJ_LIB_H__ 
# 123 "../..//lterlcpdcp/kw_ex_ms.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 128 "../..//lterlcpdcp/kw_ex_ms.c" 2

# 1 "../..//cm/cm5.x" 1
# 130 "../..//lterlcpdcp/kw_ex_ms.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 148 "../..//lterlcpdcp/kw_ex_ms.c" 2


 S16 kwInitExt ( Void );
# 167 "../..//lterlcpdcp/kw_ex_ms.c"
 S16 kwInitExt
(
)
...

{
   ...
   { cmMemset((U8 *)&kwCb, (U8)0, sizeof(KwCb)); };


   kwCb.init.ent = ent;
   kwCb.init.inst = inst;
   kwCb.init.region = region;
   kwCb.init.pool = 0;
   kwCb.init.reason = reason;
   kwCb.init.cfgDone = 0;
   kwCb.init.acnt = 1;
   kwCb.init.usta = 1;
   kwCb.init.trc = 0;
...

{
   ...
   kwCb.pjInit.ent = ent;
   kwCb.pjInit.inst = inst;
   kwCb.pjInit.region = region;
   kwCb.pjInit.pool = 0;
   kwCb.pjInit.reason = reason;
   kwCb.pjInit.cfgDone = 0;
   kwCb.pjInit.acnt = 1;
   kwCb.pjInit.usta = 1;
   kwCb.pjInit.trc = 0;
   kwCb.pjInit.procId = SFndProcId();
# 615 "../..//lterlcpdcp/kw_ex_ms.c"
    kwCb.pjInit.logMask = 0x0;
   return(0);
}
# 638 "../..//lterlcpdcp/kw_ex_ms.c"
 S16 pjActvTsk
(
Pst *pst,
Buffer *mBuf
