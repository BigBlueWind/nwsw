...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 101 "../..//ltemac/rg_sch_maxci.c" 2
# 1 "../..//cm/cm5.h" 1
# 102 "../..//ltemac/rg_sch_maxci.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
# 114 "../..//ltemac/rg_sch_maxci.c" 2
# 1 "../..//ltemac/rg_sch_maxci.h" 1
# 103 "../..//ltemac/rg_sch_maxci.h"
#define __RGSCHMAXCIH__ 


#define RG_SCH_MAXCIUL_NUM_CQI_LVLS 16
#define RG_SCH_MAXCIDL_NUM_CQI_LVLS 16
...
#define RGSCHERR_MAXCI_MEMERR 1
...
#define RG_SCH_MAXCIDL_INIT_LNK(_lstLnk,_node) { (_lstLnk)->node = (PTR)_node; (_lstLnk)->prev = NULLP; (_lstLnk)->next = NULLP;}
# 115 "../..//ltemac/rg_sch_maxci.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 119 "../..//ltemac/rg_sch_maxci.c" 2
# 1 "../..//cm/cm5.x" 1
# 120 "../..//ltemac/rg_sch_maxci.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 132 "../..//ltemac/rg_sch_maxci.c" 2
# 1 "../..//ltemac/rg_sch_maxci.x" 1
# 105 "../..//ltemac/rg_sch_maxci.x"
#define __RGMAXCIX__ 
...
extern Void rgSCHMaxciDlCqiInd ( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *cqiInfo );
...
static Void rgSCHMaxciDlRstUeTmpVars ( RgSchCellCb *cell, RgSchUeCb *ue );
...

{
   ...
   apis->rgSCHDlSched = rgSCHMaxciDlSched;
...

{
   ...
   (cellCfg=cellCfg);
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 441); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Cell config for MAX C/I DL cell %d\n", cellCfg->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };


   if((ret = rgSCHUtlAllocSBuf(cell->instIdx,
               (Data**)&cmnDlCell->schSpfc, (sizeof(RgSchMaxciDlCell)))) != 0)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 448); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for MAX C/I DL cell %d\n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   if(cellCfg->numTxAntPorts == 1)
   {
      iTbs = (*(RgSchCmnCqiToTbs *)(cmnDlCell->cqiToTbsTbl[0]))[0];
      minEff = (*(RgSchCmnTbSzEff *)(cmnDlCell->cqiToEffTbl[0]))[iTbs];
      iTbs = (*(RgSchCmnCqiToTbs *)(cmnDlCell->cqiToTbsTbl[0]))[15];
      maxEff = (*(RgSchCmnTbSzEff *)(cmnDlCell->cqiToEffTbl[0]))[iTbs];
      priorEff = ((maxEff - minEff)/(16 -1));
   }
   else if(cellCfg->numTxAntPorts == 2)
   {
      iTbs = (*(RgSchCmnCqiToTbs *)(cmnDlCell->cqiToTbsTbl[0]))[0];
      minEff = (*(RgSchCmnTbSzEff *)(cmnDlCell->cqiToEffTbl[0]))[iTbs];
      iTbs = (*(RgSchCmnCqiToTbs *)(cmnDlCell->cqiToTbsTbl[0]))[15];
   ...
   else
   {
      iTbs = (*(RgSchCmnCqiToTbs *)(cmnDlCell->cqiToTbsTbl[0]))[0];
      minEff = (*(RgSchCmnTbSzEff *)(cmnDlCell->cqiToEffTbl[0]))[iTbs];
      iTbs = (*(RgSchCmnCqiToTbs *)(cmnDlCell->cqiToTbsTbl[1]))[15];
      maxEff = (*(RgSchCmnTbSzEff *)(cmnDlCell->cqiToEffTbl[1]))[iTbs];
      maxEff *= 2;
      priorEff = ((maxEff - minEff)/(16 -1));
   }
...

{
   ...
   if (maxciDlCell)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 574); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Cell delete for MAX C/I DL cell %d\n", cell->cellId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   RgSchDlHqEnt *dlHqEnt = 0L;
   RgSchMaxciDlUe *maxciDlUe;
   RgSchMaxciDlHqProc *maxciDlHqProc;
   ;;

   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 635); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "UE config for MAX C/I DL ue %d\n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };


   if((ret = rgSCHUtlAllocSBuf(cell->instIdx, (Data**)&(cmnDlUe->schSpfc),
               (sizeof(RgSchMaxciDlUe)))) != 0)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 642); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for MAX C/I DL UE %d\n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };


      err->errCause = 1;
      return(ret);
   }
   maxciDlUe = (RgSchMaxciDlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc;

   dlHqEnt = ue->dl.hqEnt;

   if ((ret = rgSCHUtlAllocSBuf(cell->instIdx,
               (Data**)&dlHqEnt->sch,
               (dlHqEnt->numHqPrcs * sizeof(RgSchMaxciDlHqProc)))) != 0)
   {
   ...
   {
      proc = &dlHqEnt->procs[hqProcIdx];
      cmnDlProc = (RgSchCmnDlHqProc *)proc->sch;
      cmnDlProc->schSpfc = &((RgSchMaxciDlHqProc *)dlHqEnt->sch)[hqProcIdx];
   ...
   {
      maxciDlUe->remAmbr = cmnDlUe->ambrCfgd;
   }
...

{
   ...
   RgSchMaxciDlUe *maxciDlUe = (RgSchMaxciDlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc;
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 740); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "UE re-config for MAX C/I DL ue %d\n", ue->ueId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };


   maxciDlUe->ambrPres = ueRecfg->ueQosRecfg.ambrPres;
# 753 "../..//ltemac/rg_sch_maxci.c"
...

{
   ...
   RgSchMaxciDlUe *maxciDlUe = (RgSchMaxciDlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc;
   RgSchCmnDlUe *cmnDlUe = &(((RgSchCmnUe *)((ue)->sch))->dl);
   RgSchDlHqEnt *dlHqEnt = ue->dl.hqEnt;
   U8 hqProcIdx = 0;
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 844); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "UE delete for MAX C/I DL ue %d\n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };


   for (hqProcIdx = 0; hqProcIdx < dlHqEnt->numHqPrcs; hqProcIdx++)
   {
      RgSchDlHqProcCb *hqP = &ue->dl.hqEnt->procs[hqProcIdx];
...
# 949 "../..//ltemac/rg_sch_maxci.c"
{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 961); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "LC Cfg for MAX C/I DL LC %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };


   if((ret = rgSCHUtlAllocSBuf(cell->instIdx, (Data**)&(cmnDlLc->schSpfc),
      (sizeof(RgSchMaxciDlLc)))) != 0)
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 968); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for MAX C/I DL LC %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   maxciDlLc = (RgSchMaxciDlLc *)((RgSchCmnDlSvc *)((dlLc)->sch))->schSpfc;


   maxciDlLc->isGbr = ((((RgSchCmnDlSvc*)(dlLc->sch))->prio >= 1) && (((RgSchCmnDlSvc*)(dlLc->sch))->prio <= 2));
   if (maxciDlLc->isGbr)
   {
...
# 1033 "../..//ltemac/rg_sch_maxci.c"
{
   RgSchMaxciDlLc *maxciDlLc = (RgSchMaxciDlLc *)((RgSchCmnDlSvc *)((dlLc)->sch))->schSpfc;
   RgSchCmnDlSvc *cmnDlLc = ((RgSchCmnDlSvc *)((dlLc)->sch));
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 1049); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "LC Recfg for MAX C/I DL LC %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };





   if (((((RgSchCmnDlSvc*)(dlLc->sch))->prio >= 1) && (((RgSchCmnDlSvc*)(dlLc->sch))->prio <= 2)))
   {
      maxciDlLc->mbr = cmnDlLc->mbr;
   }
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 1103); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "LC Delete for MAX C/I DL LC %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (maxciDlLc)
   {
      ...
      rgSCHUtlFreeSBuf(cell->instIdx, (Data**)(&(cmnDlLc->schSpfc)),
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 1183); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "DL Priority level updation for MAX C/I DL UE: ueId %d" "\n", ue->ueId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   if ((numLyr = cmnDlUe->mimoInfo.cwInfo[1].noLyr))
   {
...
# 1243 "../..//ltemac/rg_sch_maxci.c"
 Void rgSCHMaxciDlSched
(
RgSchCellCb *cell,
...

{
   ...
   rgSCHMaxciDlTaSchd(cell, allocInfo);


   rgSCHMaxciDlRetx(cell, allocInfo);


   rgSCHMaxciDlNewTx(cell, allocInfo);

   return;
}
# 1283 "../..//ltemac/rg_sch_maxci.c"
...
# 1315 "../..//ltemac/rg_sch_maxci.c"
      rgSCHMaxciDlTaSchdForUe(cell, alloc, dlSf, ue);
   }

   return;
}
# 1342 "../..//ltemac/rg_sch_maxci.c"
...

{
   ...
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 1373); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHMaxciDlTaSchdForUe(): Could not schedule TA since UE is" "inactive %d \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 1381); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "rgSCHMaxciDlTaSchdForUe(): Could not get HARQ proc for UE %d \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   for (lnk = alloc->dedAlloc.schdTxRetxUeLst.first; lnk;)
   {
      ...
      lnk = lnk->next;
      maxciUe = (RgSchMaxciDlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc;
      ...
      rgSCHMaxciDlSprTxTbDstn(cell, ue, newTxTbInfo, &remTbBytes, &node);
      ...
      rgSCHMaxciDlRstUeTmpVars(cell, ue);
   }
...

{
   ...
   for (lnk = alloc->dedAlloc.nonSchdTxUeLst.first; lnk;)
   {
      ...
      RgSchCmnDlUe *cmnUe = &(((RgSchCmnUe *)((ue)->sch))->dl);
      lnk = lnk->next;
      rgSCHMaxciDlRlsHqP(cmnUe->proc);
      rgSCHMaxciDlRstUeTmpVars(cell, ue);
   }

   return;
}
# 2023 "../..//ltemac/rg_sch_maxci.c"
...

{
   ...
   if (remTb1Bytes){
      ...
      rgSCHMaxciDlNewTxTbDstn(cell, ue, &cmnDlUe->proc->tbInfo[0], &remTb1Bytes, &node);
   ...
   if (remTb2Bytes){
      ...
      rgSCHMaxciDlNewTxTbDstn(cell, ue, &cmnDlUe->proc->tbInfo[1], &remTb2Bytes, &node);
   ...
   rgSCHCmnFillHqPPdcch(cell, &ue->dl.dlAllocCb, cmnDlUe->proc);
...
# 2452 "../..//ltemac/rg_sch_maxci.c"
{
   ...
   if ((dlLc->lcId == 1 || dlLc->lcId == 2))
   {
      ...
      { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 2470); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating bo for SRB %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
      ...
      if (!remBo)
      {
         ...
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 2479); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Removing UE %d from" "SRB transmitting list \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 2490); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating bo for DRB %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if ((!remBo) || (!allocLimit))
   {
      ...
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 2514); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Removing UE %d from" "UE transmitting list \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 2915); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating bo for SRB %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (bo)
   {
      ...
      if (!maxciDlLc->lcLst)
      {
         ...
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 2926); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Adding UE %d to SRB" "transmitting list \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (maxciDlLc->lcLst)
   {
      ...
      if (!maxciDlUe->srbLst.count)
      {
         { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 2941); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Removing UE %d from" "SRB transmitting list \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 3004); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Updating bo for DRB %d\n", dlLc->lcId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   if (bo && allocLimit)
   {
      ...
      if ((!maxciDlLc->lcLst))
      {
         ...
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 3024); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Adding UE %d to UE" "transmitting list \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
   ...
   else if (!bo)
   {
      ...
      if (maxciDlLc->lcLst)
      {
         ...
         if ((!maxciDlUe->gbrLst.count) && (!maxciDlUe->nongbrLst.count))
         {
            { if ((&rgSchCb[instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instIdx].rgSchInit)->ent, (&rgSchCb[instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 3038); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[instIdx].rgSchInit.prntBuf, "Removing UE %d from" "UE transmitting list \n", ue->ueId); SPrint((&rgSchCb[instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   for (hqProcIdx = 0; hqProcIdx < ue->dl.hqEnt->numHqPrcs; hqProcIdx++)
   {
      hqP = &ue->dl.hqEnt->procs[hqProcIdx];


      for (tbCnt = 0; tbCnt < 2; tbCnt++)
      {
         if ((hqP->tbInfo[tbCnt].subFrm != 0L) &&
               (hqP->tbInfo[tbCnt].sfLnk.node != 0L))
         {
            cmLListDelFrm(&hqP->tbInfo[tbCnt].subFrm->tbs, &hqP->tbInfo[tbCnt].sfLnk);
            cmLListDelFrm(&hqP->tbInfo[tbCnt].subFrm->pdcchInfo.pdcchs,
                  &hqP->tbInfo[tbCnt].pdcch->lnk);
            cmLListAdd2Tail(&cell->pdcchLst, &hqP->tbInfo[tbCnt].pdcch->lnk);
            hqP->tbInfo[tbCnt].sfLnk.node = 0L;
         }
...

{
   ...
   {
      maxciDlUe = (RgSchMaxciDlUe *)((RgSchCmnUe *)(((RgSchUeCb *)inactvUeLnk->node)->sch))->dl.schSpfc;
      if (maxciDlUe->txSrbLstPtr)
      {
         rgSCHMaxciDlDelUeFrmTxSrbLst(maxciDlUe);
      }
...
# 3406 "../..//ltemac/rg_sch_maxci.c"
   ...
   for (lnk = retxProcs->first; lnk; lnk = lnk->next)
   {
      ...
      RgSchMaxciDlUe *maxciUe = (RgSchMaxciDlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc;
      ...
      if ((maxciUe->srbLst.first!= 0L) || (maxciUe->gbrLst.first!= 0L) || (maxciUe->nongbrLst.first!= 0L))

      {
         ue->dl.dlAllocCb.mimoAllocInfo.hasNewTxData = 1;
      }

      if(rgSCHCmnDlAllocRetxRb(cell, dlSf, ue, 0, &ret, proc, alloc) != 0)
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 4180); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHMaxciUlCellCfg: CellId: %d \n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 4188); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for MAX-CI UL cell %d\n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 4331); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED for MAX-CI UL UE CB CellId = %d\n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   RgSchMaxciUlUe *maxciUe = (RgSchMaxciUlUe*)((RgSchCmnUe*)((ue)->sch))->ul.schSpfc;
...
# 4469 "../..//ltemac/rg_sch_maxci.c"
{
   ;;

   return(0);
}
# 4495 "../..//ltemac/rg_sch_maxci.c"
...
# 4511 "../..//ltemac/rg_sch_maxci.c"
{
   ;;

   return(0);
}
# 4534 "../..//ltemac/rg_sch_maxci.c"
...
# 4649 "../..//ltemac/rg_sch_maxci.c"
      cmnUe = &(((RgSchCmnUe *)((ue)->sch))->ul);
...
# 4807 "../..//ltemac/rg_sch_maxci.c"
         ...
         cmnUe = &(((RgSchCmnUe *)((ue)->sch))->ul);
         maxciUe = (RgSchMaxciUlUe*)((RgSchCmnUe*)((ue)->sch))->ul.schSpfc;
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 4877); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHMaxciUlUpdBsrShort: CellId: %d lcgId: %d Bsr:%d \n", cell->cellId, lcg->lcgId, bsr); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 4931); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHMaxciUlUpdBsrTrunc: CellId: %d lcgId: %d Bsr: %d\n", cell->cellId, lcg->lcgId, bsr); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_maxci.c", 4982); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHMaxciUlUpdBsrLong: CellId: %d \n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 5038 "../..//ltemac/rg_sch_maxci.c"
{
   ...
   if (cmnUe->effBsr || maxciUe->srRcvd)
   {
      if (lcg0->bs)
      {
      ...
      else
      {
         ...
         queue = &(maxciCell->ueLst[cmnUe->crntUlCqi[0] - 1]);
...

{
   ...
   {
      cmLListDelFrm(maxciUe->crntQ, &(maxciUe->prioLnk));
# 5214 "../..//ltemac/rg_sch_maxci.c"
      cmLListAdd2Tail(&(maxciCell->ueLst[cmnUe->crntUlCqi[0] - 1]),
            &maxciUe->prioLnk);
      maxciUe->crntQ = &(maxciCell->ueLst[cmnUe->crntUlCqi[0] - 1]);

   }
   return;
}
# 5239 "../..//ltemac/rg_sch_maxci.c"
...

{
   ...
   if (maxciUe->srRcvd || cmnUe->effBsr)
   {
       if (lcg0->bs)
         queue = &(maxciCell->srbLst);
       else
