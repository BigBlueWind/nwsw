...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//lteclpal/ys_ptui.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//lteclpal/ys_ptui.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 119 "../..//lteclpal/ys_ptui.c" 2
# 1 "../..//cm/cm5.x" 1
# 120 "../..//lteclpal/ys_ptui.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 132 "../..//lteclpal/ys_ptui.c" 2
# 149 "../..//lteclpal/ys_ptui.c"
#define PTYSUITFU 
...

{
   ...
   if(ret == 1)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ptui.c", 842); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ptui.c", 842); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Failed to allocate memory\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      return(1);
   }
   ...
   while (cmLstEnt != 0L)
   {
               ...
               (Ptr *)&crcInfo) != 0)
      {
         ...
         { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ptui.c", 859); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_ptui.c", 859); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "cmGetMem() failed\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
         return(1);
      }
