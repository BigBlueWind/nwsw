...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 112 "../..//lterlcpdcp/kw_pj_utl.c" 2
# 1 "../..//cm/cm5.h" 1
# 113 "../..//lterlcpdcp/kw_pj_utl.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 133 "../..//lterlcpdcp/kw_pj_utl.c" 2

# 1 "../..//cm/cm5.x" 1
# 135 "../..//lterlcpdcp/kw_pj_utl.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 149 "../..//lterlcpdcp/kw_pj_utl.c" 2
# 1 "../..//lterlcpdcp/kw_pj_lib.x" 1
# 91 "../..//lterlcpdcp/kw_pj_lib.x"
#define __KW_PJ_LIB_X__ 
# 228 "../..//lterlcpdcp/kw_pj_lib.x"
...
# 505 "../..//lterlcpdcp/kw_pj_lib.x"
extern S16 pjLibIntInitReq ( PjSecCxt secCxt, PjIntInfo intInfo, U32 *cxtId );





extern S16 pjLibCpInitReq ( PjSecCxt secCxt, U8 algoType, U8 *cpKey, U32 *cxtId );
...
extern S16 pjLibUpInitReq ( PjSecCxt secCxt, U8 algoType, U8 *upKey, U32 *cxtId );
...
extern S16 pjLibIntProtReq ( U32 intCxtId, PjSecInp secInp, Buffer *mBuf, U32 *macI );





extern S16 pjLibCipherReq ( U32 secCxtId, PjSecInp secInp, Buffer *mBuf, Buffer **opSdu );
...
extern S16 pjLibIntCloseReq ( U32 intCxtId );


extern S16 pjLibCipherCloseReq ( U32 cxtId );


extern S16 pjLibUpCloseReq ( U32 upCxtId );
# 576 "../..//lterlcpdcp/kw_pj_lib.x"
extern S16 pjLibPktAdmCtrl ( PjRbCb *pjRbCb, Buffer *pkt );
# 150 "../..//lterlcpdcp/kw_pj_utl.c" 2
# 1313 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlCmpInit
(
PjRbCb *pjRbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1326); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCmpInit(pjRbCb(%d,%d))\n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1336 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1384); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlIntInit(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1414 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1466); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCpInit(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1494 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1545); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlUpInit(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1573 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1616); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCmpReset(pjRbCb(%d,%d))\n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1681); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCmpReq(pjRbCb(%d,%d), count(%ld))\n", pjRbCb->rbId, pjRbCb->rbType, count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1703 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1830); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlIntProtReq(pjRbCb(%d,%d), secInp(count(%ld), dir(%d))\n", pjRbCb->rbId, pjRbCb->rbType, secInp.count, secInp.dir); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




   cxtId = pjRbCb->ueCb->secInfo.intCxtId;
# 1854 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 1986); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCipherReq(pjRbCb(%d,%d), secInp(count(%ld), dir(%d))\n", pjRbCb->rbId, pjRbCb->rbType, secInp.count, secInp.dir); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2076); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlDeCmpReq(pjRbCb(%d,%d), count(%ld))\n", pjRbCb->rbId, pjRbCb->rbType, count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2096 "../..//lterlcpdcp/kw_pj_utl.c"
   ret = pjLibDecmpReq(pjRbCb->cmpCxtId, mBuf, &feedback, opSdu);

   if(feedback != 0L)
   {
      { Data _hdr = 0; U8 _rbCfgStat = 0; U32 _count = 0; _hdr |= 0x0010; ret = SAddPreMsg((Data) _hdr, feedback); if ( ret != 0 ) { ; { if (feedback != 0L) { SPutMsg(feedback); } feedback = 0L; }; ret = 1; } if (pjRbCb->rbType == 0 ) { _rbCfgStat = pjRbCb->ueCb->srbCb[pjRbCb->rbId]->rbCfgStat; } else { _rbCfgStat = pjRbCb->ueCb->drbCb[pjRbCb->rbId]->rbCfgStat; } if ( !(_rbCfgStat & 1) ) { ; { if (feedback != 0L) { SPutMsg(feedback); } feedback = 0L; }; ret = 1; } if ( pjRbCb->mode == 2 ) { _count = pjRbCb->dlCb.nxtToSub - 1; } else { _count = pjRbCb->dlCb.cfmExp - 1; } if ( ret == 0 ) { kwUimDatReq(pjRbCb, _count, feedback); } };
   }
...
# 2212 "../..//lterlcpdcp/kw_pj_utl.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2228); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlIntVerReq(pjRbCb(%d,%d), secInp(count(%ld), dir(%d)), macI(%ld)\n", pjRbCb->rbId, pjRbCb->rbType, secInp.count, secInp.dir, macI); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




   cxtId = pjRbCb->ueCb->secInfo.intCxtId;
# 2251 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2382); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlDecipherReq(pjRbCb(%d,%d), secInp(count(%ld), dir(%d))\n", pjRbCb->rbId, pjRbCb->rbType, secInp.count, secInp.dir); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2458); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCmpReq(pjRbCb(%d,%d))\n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2471 "../..//lterlcpdcp/kw_pj_utl.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2510); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCmpClose(cmpCxtId(%ld))\n", cmpCxtId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2555); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlIntClose(cmpCxtId(%ld))\n", intCxtId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 2590 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlCipherClose
(
U32 cpCxtId
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2602); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlCipherClose(cpCxtId(%ld))\n", cpCxtId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2657); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlReEstSrb1(pjRbCb(%d,%d))\n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   pjRbCb->state = 2;
   for(rbId = 2; rbId < 3; rbId ++)
   {
      { RbCb **_rbCbLst; _rbCbLst = (0==0)?ueCb->srbCb:ueCb->drbCb; if (_rbCbLst[rbId] != 0L) { tRbCb = _rbCbLst[rbId]; } else { tRbCb = 0L; } };
   ...
   for(rbId = 0; rbId < 32; rbId ++)
   {
      { RbCb **_rbCbLst; _rbCbLst = (1==0)?ueCb->srbCb:ueCb->drbCb; if (_rbCbLst[rbId] != 0L) { tRbCb = _rbCbLst[rbId]; } else { tRbCb = 0L; } };
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2755); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlReEstStart(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   for(entIndex = 0; entIndex < numEnt; entIndex ++)
   {
      ...
      if(cfgEnt[entIndex].cfgType != 0x04)
      {
         continue;
      }


      { RbCb **_rbCbLst; _rbCbLst = (cfgEnt[entIndex].rbType==0)?ueCb->srbCb:ueCb->drbCb; if (_rbCbLst[cfgEnt[entIndex].rbId] != 0L) { tRbCb = _rbCbLst[cfgEnt[entIndex].rbId]; } else { tRbCb = 0L; } };
...
# 2823 "../..//lterlcpdcp/kw_pj_utl.c"
   ...
   if((ueCb->libInfo.numReEstDrbDl == 0) &&
      (ueCb->libInfo.numReEstDrbUl == 0))
   {
      pjUtlReEstReconfig(ueCb, 0);
   }

   return(0);

}
# 2860 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlReEstHOStart
(
KwUeCb *ueCb,
U32 transId
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 2885); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlReEstHOStart(ueCb(%d,%d), transId(%ld))\n", ueCb->key.ueId, ueCb->key.cellId, transId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&ueCb->hoInfo, (Size) sizeof(PjHoInfo)) == 0) { cmMemset((U8 *)(ueCb->hoInfo), 0, sizeof(PjHoInfo)); } else { (ueCb->hoInfo) = 0L; } };
# 2906 "../..//lterlcpdcp/kw_pj_utl.c"
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&ueCb->hoInfo->hoCfmInfo, (Size) sizeof(PjHoCfmInfo) * 32) == 0) { cmMemset((U8 *)(ueCb->hoInfo->hoCfmInfo), 0, sizeof(PjHoCfmInfo) * 32); } else { (ueCb->hoInfo->hoCfmInfo) = 0L; } };
# 2917 "../..//lterlcpdcp/kw_pj_utl.c"
...
# 3020 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlReEstReconfig
(
KwUeCb *ueCb,
U8 rbType
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3044); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlReEstReconfig(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3171); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlReEstDl(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 3266 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlSndReEstCfgCfm
(
KwUeCb *ueCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3285); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlSndReEstCfgCfm(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&cfgCfmInfo, (Size) sizeof(CpjCfgCfmInfo)) == 0) { cmMemset((U8 *)(cfgCfmInfo), 0, sizeof(CpjCfgCfmInfo)); } else { (cfgCfmInfo) = 0L; } };
   if(cfgCfmInfo == 0L)
   {
      ;
   ...
   { { if (ueCb->libInfo.asyncCfm[txIdx] != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb->libInfo.asyncCfm[txIdx], (Size) sizeof(PjAsyncCfm)); ueCb->libInfo.asyncCfm[txIdx] = 0L; } }; ueCb->libInfo.asyncCfm[txIdx]=0L; if(ueCb->libInfo.nxtAvlbTxId == 2) { ueCb->libInfo.nxtAvlbTxId = txIdx; } };

   PjUiCpjCfgCfm(&kwCb.cpjSap.pst, kwCb.cpjSap.suId, cfgCfmInfo);

   return(0);
}
# 3353 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlSaveCfmInfo
(
KwUeCb *ueCb,
U8 cfmType,
Bool startTmr,
...
# 3371 "../..//lterlcpdcp/kw_pj_utl.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3386); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlSaveCfmInfo(ueCb(%d,%d), cfmType(%d), startTmr(%d), entity(%d))\n", ueCb->key.ueId, ueCb->key.cellId, cfmType, startTmr, entity); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&ueCb->libInfo.asyncCfm[txId], (Size) sizeof(PjAsyncCfm)) == 0) { cmMemset((U8 *)(ueCb->libInfo.asyncCfm[txId]), 0, sizeof(PjAsyncCfm)); } else { (ueCb->libInfo.asyncCfm[txId]) = 0L; } };
   if(ueCb->libInfo.asyncCfm[txId]== 0L)
   {
      ;
...
# 3504 "../..//lterlcpdcp/kw_pj_utl.c"
   if(tAsyncCfm->startTmr == 1)
   {
      if((pjChkTmr((U32)ueCb, 0x15)) == 0)
      {
         pjStartTmr((U32)ueCb, 0x15);
...
# 3551 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlHdlObdInitCfm
(
KwUeCb *ueCb,
U16 txIdx,
U8 cfmType,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3577); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlHdlObdInitCfm(ueCb(%d,%d), txIdx(%d), cfmType(%d), maskVal(%d))\n", ueCb->key.ueId, ueCb->key.cellId, txIdx, cfmType, maskVal); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if(cfmType & 1)
   {
      ...
      {
         { U16 _idx; if(ueCb->libInfo.crntTmrTxId == txIdx) { pjStopTmr((U32)ueCb, 0x15); } if(pjChkTmr((U32)ueCb, 0x15) == 0) { for(_idx = 0; _idx < (2 - 1) ; _idx++) { ueCb->libInfo.crntTmrTxId = (ueCb->libInfo.crntTmrTxId + 1) % 2; if((ueCb->libInfo.asyncCfm[ueCb->libInfo.crntTmrTxId] != 0L) && (ueCb->libInfo.asyncCfm[ueCb->libInfo.crntTmrTxId]->startTmr == 1)) { pjStartTmr((U32)ueCb, 0x15); break; } } } };
         if(ueCb->libInfo.state == 1)
         {

            { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&secCfgCfm, (Size) sizeof(CpjSecCfgCfmInfo)) == 0) { cmMemset((U8 *)(secCfgCfm), 0, sizeof(CpjSecCfgCfmInfo)); } else { (secCfgCfm) = 0L; } };
# 3612 "../..//lterlcpdcp/kw_pj_utl.c"
         ...
         else if(ueCb->libInfo.state == 2)
         {
            ...
            { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&reEstCfm, (Size) sizeof(CpjReEstCfmInfo)) == 0) { cmMemset((U8 *)(reEstCfm), 0, sizeof(CpjReEstCfmInfo)); } else { (reEstCfm) = 0L; } };
# 3631 "../..//lterlcpdcp/kw_pj_utl.c"
   ...
   else if(cfmType & 2)
   {
      ...
      if(asyncCfm->cmpInitBitMask == 0)
      {
            ...
            !(asyncCfm->cfmType & 0x04))
         {
            ...
            { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&cfgCfm, (Size) sizeof(CpjCfgCfmInfo)) == 0) { cmMemset((U8 *)(cfgCfm), 0, sizeof(CpjCfgCfmInfo)); } else { (cfgCfm) = 0L; } };
# 3678 "../..//lterlcpdcp/kw_pj_utl.c"
...
# 3724 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlHdlInitObdTmrExp
(
KwUeCb *ueCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3750); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlHdlInitObdTmrExp(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 3813 "../..//lterlcpdcp/kw_pj_utl.c"
      ...
      { U16 _idx; if(ueCb->libInfo.crntTmrTxId == cfgIdx) { pjStopTmr((U32)ueCb, 0x15); } if(pjChkTmr((U32)ueCb, 0x15) == 0) { for(_idx = 0; _idx < (2 - 1) ; _idx++) { ueCb->libInfo.crntTmrTxId = (ueCb->libInfo.crntTmrTxId + 1) % 2; if((ueCb->libInfo.asyncCfm[ueCb->libInfo.crntTmrTxId] != 0L) && (ueCb->libInfo.asyncCfm[ueCb->libInfo.crntTmrTxId]->startTmr == 1)) { pjStartTmr((U32)ueCb, 0x15); break; } } } };
   ...
   else if(asyncCfm->cfmType & 0x08)
   {
      ...
      if((pjChkTmr((U32)ueCb, 0x15)) == 1)
      {
         pjStopTmr((U32)ueCb, 0x15);
      }
      ...
      if (ret != 0)
      {
         ...
         do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3861); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlHdlInitObdTmrExp: cmHashListDelete Failed for ueCb.\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 3877 "../..//lterlcpdcp/kw_pj_utl.c"
         ...
         for(idx = 0; idx < 2; idx++)
         {
            ...
            {
               { if (ueCb->libInfo.asyncCfm[idx] != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb->libInfo.asyncCfm[idx], (Size) sizeof(PjAsyncCfm)); ueCb->libInfo.asyncCfm[idx] = 0L; } };
               ueCb->libInfo.asyncCfm[idx] = 0L;
            }
         }

         { if (ueCb != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb, (Size) sizeof(KwUeCb)); ueCb = 0L; } };
         PjUiCpjCfgCfm(&(cpjSap->pst), cpjSap->suId, cfgCfm);
      }
      else if ( asyncCfm->entity == 0xd7 )
      {
         { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&kwCfgCfm, (Size) sizeof(CkwCfgCfmInfo)) == 0) { cmMemset((U8 *)(kwCfgCfm), 0, sizeof(CkwCfgCfmInfo)); } else { (kwCfgCfm) = 0L; } };
# 3913 "../..//lterlcpdcp/kw_pj_utl.c"
         for ( idx = 0; idx < asyncCfm->numEnt; idx++)
         {
...
# 3965 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlSndSduStaCfm
(
KwUeCb *ueCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 3982); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlSndSduStaCfm(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&cfmInfo, (Size) sizeof(CpjSduStaCfmInfo)) == 0) { cmMemset((U8 *)(cfmInfo), 0, sizeof(CpjSduStaCfmInfo)); } else { (cfmInfo) = 0L; } };
# 4009 "../..//lterlcpdcp/kw_pj_utl.c"
   { U8 _rbCnt; U8 _numRb = 0; PjHoCfmInfo *_hoCfmInfo; CpjSduStaInfo *_staInfo; cfmInfo->ueId = ueCb->key.ueId; cfmInfo->cellId = ueCb->key.cellId; cfmInfo->transId = ueCb->hoInfo->transId; for(_rbCnt = 0; _rbCnt < 32 && _numRb < 12; _rbCnt++) { _hoCfmInfo = &ueCb->hoInfo->hoCfmInfo[_rbCnt]; _staInfo = &cfmInfo->sduStaInfo[_numRb]; if(_hoCfmInfo->pres != 1) { continue; } _staInfo->rbId = _hoCfmInfo->rbId; _staInfo->dir = _hoCfmInfo->dir; _staInfo->ulSduStaInfo.numBits = _hoCfmInfo->ul.numBits; _staInfo->ulSduStaInfo.ulBitMap = _hoCfmInfo->ul.ulBitMap; _staInfo->ulSduStaInfo.count = _hoCfmInfo->ul.count; _staInfo->dlSduStaInfo.count = _hoCfmInfo->dl.count; _hoCfmInfo->ul.ulBitMap = 0L; _numRb++; } cfmInfo->numRb = _numRb; { if (ueCb->hoInfo->hoCfmInfo != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb->hoInfo->hoCfmInfo, (Size) (32 * sizeof(PjHoCfmInfo))); ueCb->hoInfo->hoCfmInfo = 0L; } } { if (ueCb->hoInfo != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb->hoInfo, (Size) sizeof(PjHoInfo)); ueCb->hoInfo = 0L; } }; }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 4054); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlShutdown()\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   while (cmHashListGetNext(&(kwCb.ueLstCp), (U32) prevUeCb, (U32 *)&ueCb) == 0)
   {
      if ( ueCb != 0L )
      {
         ...
         if (ueCb->hoInfo != 0L)
         {
            for (idx = 0; idx < 32; idx++)
            {
               ...
               {
                  { if (ueCb->hoInfo->hoCfmInfo[idx].ul.ulBitMap != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb->hoInfo->hoCfmInfo[idx].ul.ulBitMap, (Size) (ueCb->hoInfo->hoCfmInfo[idx].ul.numBits % 8)? ((ueCb->hoInfo->hoCfmInfo[idx].ul.numBits / 8) + 1): (ueCb->hoInfo->hoCfmInfo[idx].ul.numBits / 8 )); ueCb->hoInfo->hoCfmInfo[idx].ul.ulBitMap = 0L; } };
            ...
            { if (ueCb->hoInfo->hoCfmInfo != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb->hoInfo->hoCfmInfo, (Size) (32 * sizeof(PjHoCfmInfo))); ueCb->hoInfo->hoCfmInfo = 0L; } };

            { if (ueCb->hoInfo != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) ueCb->hoInfo, (Size) sizeof(PjHoInfo)); ueCb->hoInfo = 0L; } };
         }
      }
      prevUeCb = ueCb;
   }
# 4145 "../..//lterlcpdcp/kw_pj_utl.c"
   kwCb.init.cfgDone &= ~2;
   return(ret);
}
# 4172 "../..//lterlcpdcp/kw_pj_utl.c"
 Void pjUtlFreeRb
(
PjRbCb *pjRbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 4184); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlFreeRb()\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 4196 "../..//lterlcpdcp/kw_pj_utl.c"
   if (pjRbCb->dlCb.discTmr.tmrEvnt == 0x10)
   {
       pjStopTmr((U32)pjRbCb, 0x10);
   }
...
# 4228 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlSndDatFwdInd
(
PjRbCb *pjRbCb,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 4245); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlSndDatFwdInd()\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   pjuSap = &(kwCb.pjuSap[1]);

   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(pdcpId), 0, sizeof(CmLtePdcpId)); } else { (pdcpId) = 0L; } };
...
# 4585 "../..//lterlcpdcp/kw_pj_utl.c"
 Void pjUtlCalNxt2Sub
(
PjUlCb *ulCb
)
...
# 4623 "../..//lterlcpdcp/kw_pj_utl.c"
 Void pjUtlFillReEstCfgCfmInfo
(
...

{
   ...
   for (idx = 0; idx < asyncCfm->numEnt; idx++)
   {
      if (asyncCfm->cfmEnt[idx].cfgType == 0x04)
      {
         cfmInfo->cfmEnt[idx].status = 1;
         cfmInfo->cfmEnt[idx].reason = 0;
      }
      else
      {
      ...
      cfmInfo->cfmEnt[idx].rbType= asyncCfm->cfmEnt[idx].rbType;
   }
...
# 4667 "../..//lterlcpdcp/kw_pj_utl.c"
 S16 pjUtlSecUpdAndSndReestCfm
(
   KwUeCb *ueCb,
   PjRbCb *pjRbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_utl.c", 4692); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUtlReEstReconfig(ueCb(%d,%d))\n", ueCb->key.ueId, ueCb->key.cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   {
      if((ueCb->libInfo.asyncCfm[txIdx] != 0L) &&
            (ueCb->libInfo.asyncCfm[txIdx]->cfmType == 0x10))
      {
         ueCb->secInfo.secCxt.cfgTxId = txIdx;
         break;
      }
   ...
   onlySrb1 = 0;
   { RbCb **_rbCbLst; _rbCbLst = (0==0)?ueCb->srbCb:ueCb->drbCb; if (_rbCbLst[2] != 0L) { tRbCb = _rbCbLst[2]; } else { tRbCb = 0L; } };
   if(tRbCb != 0L && (tRbCb->rbCfgStat & 2) == 2)
   {
      onlySrb1 = 0;
   }
   if ( onlySrb1 == 0)
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&reEstCfm, (Size) sizeof(CpjReEstCfmInfo)) == 0) { cmMemset((U8 *)(reEstCfm), 0, sizeof(CpjReEstCfmInfo)); } else { (reEstCfm) = 0L; } };
# 4778 "../..//lterlcpdcp/kw_pj_utl.c"
   { reEstCfm->ueId = (ueCb->libInfo.asyncCfm[txIdx])->ueId; reEstCfm->cellId = (ueCb->libInfo.asyncCfm[txIdx])->cellId; reEstCfm->transId = (ueCb->libInfo.asyncCfm[txIdx])->transId; reEstCfm->status = 1; };
