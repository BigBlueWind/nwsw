		     ...
		     guint         len)
{
  ...
  _memcpy (g_array_elt_pos (array, array->len), data,
		      ...
		      guint          len)
{
  ...
  _memcpy (g_array_elt_pos (array, 0), data, g_array_elt_len (array, len));
		     ...
		     guint          len)
{
  ...
  _memcpy (g_array_elt_pos (array, index), data, g_array_elt_len (array, len));
			   ...
			   guint   index)
{
  ...
  if (index != array->len - 1)
    _memcpy (g_array_elt_pos (array, index),
