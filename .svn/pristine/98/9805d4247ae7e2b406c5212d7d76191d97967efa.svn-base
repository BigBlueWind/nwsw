...
#endif
{
  ...
  KW_DIAG_LVL0(0x0b190001, KW_DIAG_NA, SS_DIAG_INV_ARG,
               "Received BndReq from user, spId = %d, suId = %d",
                spId, suId, 0, 0)
...
#endif
{
  ...
  KW_DIAG_LVL0(0x0b190002, KW_DIAG_NA, SS_DIAG_INV_ARG,
               "Received UbndReq from RRC, spId = %d",
                spId, 0, 0, 0)
...
#endif
{
  ...
  KW_DIAG_LVL0(0x0b190003, KW_DIAG_UEID, cfg->ueId,
               "Received CfgReq from RRC, cellId = %d",
                cfg->cellId, 0, 0, 0)
...
#endif
{
  ...
  KW_DIAG_LVL0(0x0b190004, KW_DIAG_UEID, ueInfo->ueId,
               "Received UeId Change request at RLC from RRC, newUeId = %d, oldCellId = %d, newCellId = %d",
                newUeInfo->ueId, ueInfo->cellId, newUeInfo->cellId, 0)
...
/* MS FIX: UeIdChng request at PDCP will be processed, so dropping it here */  
...
#endif
{
  ...
  KW_DIAG_LVL0(0x0b190005, KW_DIAG_NA, SS_DIAG_INV_ARG,
               "Received BndReq from User, spId = %d, suId = %d",
                spId, suId, 0, 0)
...
#endif
{
  ...
  KW_DIAG_LVL0(0x0b190006, KW_DIAG_NA, SS_DIAG_INV_ARG,
               "Received UbndReq from User, spId = %d",
                spId, 0, 0, 0)
...
#endif
{
  ...
  KW_DIAG_LVL0(0x0b190007, KW_DIAG_UEID, datReq->rlcId.ueId,
               "Received DatReq from RRC/PDCP, RB Mode = %d",
                rbCb->mode, 0, 0, 0)
