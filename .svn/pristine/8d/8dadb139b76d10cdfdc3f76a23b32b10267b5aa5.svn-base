...
#define RG_MAX_NUM_DED_LC 10
#define RG_MAX_NUM_CMN_LC 5
...
#define RG_TQ_SIZE 10
#define RG_MAX_TIMER RG_MAX_LOWERSAP
#define RG_NMB_CELL_HASHBIN 10

#define RG_NMB_UE_HASHBIN 10

#define RG_BNDREQ_TMR 1
#define RG_MAX_BNDRETRY 2


#define RG_UE_TQ_SIZE 10

#define RG_INVALID_SCHD_TYPE 255
#define RG_MAX_UE_PER_CELL 0xFFFF

#define RG_MAX_UE_BIN_PER_CELL 128
#define RG_MIN_DL_BW 6
#define RG_MAX_DL_BW 110
#define RG_MIN_UL_BW 6
#define RG_MAX_UL_BW 110
#define RG_MIN_CFI_VAL 1
#define RG_MAX_CFI_VAL 3
#define RG_QM_BPSK 2
#define RG_QM_QPSK 4
#define RG_QM_64QAM 6
#define RG_MIN_SRS_SFCFG_IDX 0

#define RG_MAX_SRS_SFCFG_IDX 15

#define RG_MAX_SRS_TX_OFFSET 8

#define RG_MIN_MAC_RNTI 10
...
#define RG_MAX_GRP_PWR_FMT3_IDX 15
#define RG_MAX_GRP_PWR_FMT3A_IDX 31
...
#define RG_PUCCH_MAXVAL_CS 7
#define RG_PUCCH_MINVAL_DS 1
#define RG_PUCCH_MAXVAL_DS 3
...
#define RG_MAX_RA_PREAMBLE_FMT 3

#define RG_MAX_RA_WINSIZE 10

#define RG_MIN_RA_WINSIZE 2

#define RG_MIN_NUM_RA_PREAMBLE 4

#define RG_MAX_NUM_RA_PREAMBLE 64

#define RG_NUM_RA_RB 6

#define RG_MAX_RA_RSP_ALLOC 4
...
#define RG_CALC_SF_DIFF(_time1,_time2) (_time1.sfn*10+_time1.subframe) < (_time2.sfn*10+_time2.subframe)? ((_time1.sfn+RG_MAX_SFN)*10+_time1.subframe) - (_time2.sfn*10+_time2.subframe) : (_time1.sfn*10+_time1.subframe) - (_time2.sfn*10+_time2.subframe)





#define RGADDTOCRNTTIME(crntTime,toFill,incr) if ((crntTime.subframe + incr) > (RG_NUM_SUB_FRAMES - 1)) toFill.sfn = (crntTime.sfn + 1) % RG_MAX_SFN; else toFill.sfn = crntTime.sfn; toFill.subframe = (crntTime.subframe + incr) % RG_NUM_SUB_FRAMES;
...
#define RGDBGPRM(_args) DBGP(&rgCb.rgInit, RGLAYERNAME, DBGMASK_PRM, _args)

#define RGDBGERR(_args) DBGP(&rgCb.rgInit, RGLAYERNAME, DBGMASK_ERR, _args)

#define RGDBGINFO(_args) DBGP(&rgCb.rgInit, RGLAYERNAME, DBGMASK_INFO, _args)
# 343 "../..//ltemac/rg.h"
#define RG_FREE_MSG(_buf) { if (NULLP != (_buf)) { SPutMsg((_buf)); _buf = NULLP; } }
# 366 "../..//ltemac/rg.h"
#define RG_DROP_RGUDDATREQ_MBUF(_datReq) { U32 idx1,idx2,idx3; if (_datReq != NULLP) { for (idx1=0; idx1 < _datReq->nmbOfTbs; idx1++) { for (idx2=0; idx2 < _datReq->datReqTb[idx1].nmbLch; idx2++) { for (idx3=0; idx3 < _datReq->datReqTb[idx1].lchData[idx2].pdu.numPdu; idx3++) { RG_FREE_MSG(_datReq->datReqTb[idx1]. lchData[idx2].pdu.mBuf[idx3]); } } } }}
# 400 "../..//ltemac/rg.h"
#define RG_DROP_RGUCDATREQ_MBUF(_datReq) { if (_datReq != NULLP) { RG_FREE_MSG(_datReq->pdu); }}
# 410 "../..//ltemac/rg.h"
...
#define OffsetOf(type,field) (PTR) (&(((type *) NULLP)->field))
...
#define RG_DIAG_LVL0(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(rgCb.rgInit.logMask & SS_DIAG_LVL0) { ssDiagFix(_tknId, _splArgEnum, ENTRG, rgCb.rgInit.inst, SS_DIAG_LVL0, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 501 "../..//ltemac/rg.h"
#define RG_DIAG_LVL1(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(rgCb.rgInit.logMask & SS_DIAG_LVL1) { ssDiagFix(_tknId, _splArgEnum, ENTRG, rgCb.rgInit.inst, SS_DIAG_LVL1, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 512 "../..//ltemac/rg.h"
#define RG_DIAG_LVL2(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(rgCb.rgInit.logMask & SS_DIAG_LVL2) { ssDiagFix(_tknId, _splArgEnum, ENTRG, rgCb.rgInit.inst, SS_DIAG_LVL2, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 523 "../..//ltemac/rg.h"
#define RG_DIAG_LVL3(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(rgCb.rgInit.logMask & SS_DIAG_LVL3) { ssDiagFix(_tknId, _splArgEnum, ENTRG, rgCb.rgInit.inst, SS_DIAG_LVL3, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 534 "../..//ltemac/rg.h"
#define RG_DIAG_LVL4(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(rgCb.rgInit.logMask & SS_DIAG_LVL4) { ssDiagFix(_tknId, _splArgEnum, ENTRG, rgCb.rgInit.inst, SS_DIAG_LVL4, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 112 "../..//ltemac/rg_cfg.c" 2
# 1 "../..//ltemac/rg_err.h" 1
# 99 "../..//ltemac/rg_err.h"
#define __RGERRH__ 
...
#define RGLOGERROR(errCls,errCode,errVal,errDesc) SLogError(rgCb.rgInit.ent, rgCb.rgInit.inst, rgCb.rgInit.procId, (Txt *) __FILE__, (S32) __LINE__, (ErrCls) (errCls), (ErrCode) (errCode), (ErrVal) (errVal), (Txt *) errDesc)
# 115 "../..//ltemac/rg_err.h"
#define ERGBASE 0
...
#define ERG023 (ERRRG + 23)
#define ERG024 (ERRRG + 24)
#define ERG025 (ERRRG + 25)
#define ERG026 (ERRRG + 26)
#define ERG027 (ERRRG + 27)

#define ERG028 (ERRRG + 28)
#define ERG029 (ERRRG + 29)
#define ERG030 (ERRRG + 30)
#define ERG031 (ERRRG + 31)
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 117 "../..//ltemac/rg_cfg.c" 2
# 1 "../..//cm/cm5.x" 1
# 118 "../..//ltemac/rg_cfg.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
struct _rgCb
{
   ...
   CmTqType tmrTq[10];
   CmTimer tmrBlk[1];
   CmHashListCp cellLst;
   CmHashListCp inactvCellLst;
   RgCellCb *prevCell;
};
...
extern S16 rgLIMTfuBndReq ( SuId suId, SpId spId);



extern S16 rgLIMTfuUbndReq ( SuId suId, Reason reason);



extern S16 rgLIMTfuDatReq ( TfuDatReqInfo *datReq);




extern S16 rgTOMDatInd ( TfuDatIndInfo *datInd);


extern S16 rgTOMTtiInd ( TfuTtiIndInfo *ttiInd);

extern Void rgTOMRlsSf (RgDlSf *dlSf);
...
extern S16 rgLMMStartTmr (S16 tmrEvnt, U32 tmrVal, U32 cb);
extern S16 rgLMMStopTmr (S16 tmrEvnt, U32 cb);
extern S16 rgLMMTmrExpiry (U32 cb, S16 tmrEvnt);

extern S16 rgLMMStaInd (U16 category, U16 event, U16 cause, RgUstaDgn *dgn);


extern Void rgLMMTrcInd (Buffer *srcMbuf, U8 event);
...
extern S16 rgCFGVldtCrgCellCfg (CrgCellCfg *cellCfg, RgErrInfo *errInfo);
extern S16 rgCFGVldtCrgUeCfg (CrgUeCfg *ueCfg, RgCellCb **cell, RgErrInfo *errInfo);

extern S16 rgCFGVldtCrgLcCfg (CrgLchCfg *lcCfg, RgCellCb **cell, RgUeCb **ue, RgErrInfo *errInfo);

extern S16 rgCFGVldtCrgCellRecfg (CrgCellRecfg *cellRecfg, RgCellCb **cell, RgErrInfo *errInfo);

extern S16 rgCFGVldtCrgUeRecfg (CrgUeRecfg *ueRecfg, RgCellCb **cell, RgUeCb **ue, RgErrInfo *errInfo);

extern S16 rgCFGVldtCrgLcRecfg (CrgLchRecfg *lcRecfg, RgCellCb **cell, RgUeCb **ue, RgUlLcCb **ulLc, RgErrInfo *errInfo);

extern S16 rgCFGVldtCrgUeReset (CrgRst *reset,RgCellCb **cell,RgUeCb **ue, RgErrInfo *errInfo);


extern S16 rgCFGCrgCellCfg (CrgCellCfg *cellCfg, RgErrInfo *errInfo);
extern S16 rgCFGCrgUeCfg (RgCellCb *cell, CrgUeCfg *ueCfg, RgErrInfo *errInfo);

extern S16 rgCFGCrgLcCfg (RgCellCb *cell, RgUeCb *ue, CrgLchCfg *lcCfg, RgErrInfo *errInfo);

extern S16 rgCFGCrgCellRecfg (RgCellCb *cell, CrgCellRecfg *cellRecfg, RgErrInfo *errInfo);

extern S16 rgCFGCrgUeRecfg (RgCellCb *cell, RgUeCb *ue, CrgUeRecfg *ueRecfg, RgErrInfo *errInfo);

extern S16 rgCFGCrgLcRecfg (RgCellCb *cell, RgUeCb *ue, RgUlLcCb *ulLc, CrgLchRecfg *lcRecfg, RgErrInfo *errInfo);

extern S16 rgCFGCrgCellDel (CrgDel *cellDelInfo, RgErrInfo *errInfo);
extern S16 rgCFGCrgUeDel (CrgDel *ueDelInfo, RgErrInfo *errInfo);
extern S16 rgCFGCrgLcDel (CrgDel *lcDelInfo, RgErrInfo *errInfo);
...
extern S16 rgCOMCfgReq (CrgCfgTransId transId, CrgCfgReqInfo *cfgReqInfo);



extern S16 rgUIMRguBndCfm (SuId suId, U8 status);
extern S16 rgUIMSndDedStaInd (RgRguDedStaInd *staInd);
extern S16 rgUIMSndCmnStaInd (RgRguCmnStaInd *staInd);
extern S16 rgUIMSndDedDatInd (RgRguDedDatInd *datInd);
# 799 "../..//ltemac/rg.x"
extern S16 rgUIMSndCmnDatInd (RgRguCmnDatInd *datInd);
extern S16 rgUIMCrgBndCfm (SuId suId,U8 status);
extern S16 rgUIMCrgCfgCfm (CrgCfgTransId transId,U8 status);





extern S16 rgROMDedDatReq (RgRguDedDatReq *datReq);
extern S16 rgROMCmnDatReq (RgRguCmnDatReq *datReq);
extern S16 rgROMDedStaRsp (RgRguDedStaRsp *staRsp);
extern S16 rgROMCmnStaRsp (RgRguCmnStaRsp *staRsp);
# 820 "../..//ltemac/rg.x"
...
extern Void rgRAMFreeUeCb (RgUeCb *ueCb);
...
extern S16 rgDUXDemuxData (RgMacPdu *pdu, RgInfCeInfo *ceInfo, Buffer *mBuf, RgErrInfo *err);
...
# 908 "../..//ltemac/rg.x"
extern S16 rgDHMHqEntInit (RgDlHqEnt *hqE, U8 maxHqProcs);
extern Void rgDHMRlsHqProc (RgDlHqProcCb *hqP);
extern Void rgDHMUeReset (RgDlHqEnt *hqE);
extern S16 rgDHMRlsHqProcTB (RgDlHqProcCb *hqP,U8 tbIndex);
extern S16 rgDHMGetHqProcFrmId (RgUeCb *ue, U8 idx, RgDlHqProcCb **hqP);


extern S16 rgDHMSndDatReq (RgDlSf *dlSf, RgTfuDatReqInfo *datInfo, RgDlHqProcCb *hqProc, RgErrInfo *err);

extern S16 rgDHMHndlDedDatReq (RgDlHqProcCb *hqProc, RgRguDedDatReq *datReq, RgErrInfo *err);


extern S16 rgDHMHndlCmnDatReq (RgDlHqProcCb *hqProc, RgRguCmnDatReq *datReq, RgErrInfo *err);



extern S16 rgDHMSndStaInd (RgCellCb *cell, RgUeCb *ue, RgInfUeAlloc *allocInfo, CmLteTimingInfo timingInfo, RgDlHqProcCb *hqProc, RgErrInfo *err);



extern Void rgDHMFreeUe (RgDlHqEnt *hqE);
extern S16 rgSchMacRlsHqReq (Pst *pst, RgInfRlsHqInfo *rlshqUeInfo);




extern S16 rgMUXBldPdu (RgBldPduInfo *bldPdu, Buffer **txPdu, RgErrInfo *err);
...
extern S16 rgAllocSBuf (Data **pData, Size size);
extern S16 rgGetMsg (Buffer **mBuf);


extern Void rgFreeSBuf (Data **data, Size size);
extern Void rgFillDgnParams (RgUstaDgn *dgn,U8 dgnType);
extern Void rgUpdtRguDedSts (U8 stsType, RgRguDedDatReq *datReq);
extern Void rgUpdtRguCmnSts (U8 stsType);
extern Void rgUpdtCellCnt (U8 updtType);
extern Void rgUpdtUeCnt (U8 updtType);
extern Void rgGetPstToInst (Pst *pst, Inst schInst);
extern S16 rgAllocEventMem (Ptr *memPtr,Size memSize);
extern S16 rgGetEventMem (Ptr *ptr,Size len,Ptr memCp);
# 130 "../..//ltemac/rg_cfg.c" 2


 RgCb rgCb;


static S16 rgCFGVldtCrgDedLcCfg (CrgLchCfg *lcCfg, RgCellCb **cell, RgUeCb **ue, RgErrInfo *errInfo);

static S16 rgCFGVldtCrgCmnLcCfg (CrgLchCfg *lcCfg, RgCellCb **cell, RgErrInfo *errInfo);

static S16 rgCFGCrgDedLcCfg (RgCellCb *cell, RgUeCb *ue, CrgLchCfg *lcCfg, RgErrInfo *errInfo);

static S16 rgCFGCrgCmnLcCfg (RgCellCb *cell, CrgLchCfg *lcCfg, RgErrInfo *errInfo);


static Void rgCFGFreeUeCb (RgCellCb *cell, RgUeCb *ue);
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 197); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATE CRG CELL CONFIG: cellId %d\n", cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1;

   if ((rgDBMGetCellCb(cellCfg->cellId) != 0L)
         || rgDBMGetInactvCellCb(cellCfg->cellId) != 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 204); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell already exists %d\n",cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 213); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid Bandwidth configuration: ul %d dl %d", cellCfg->bwCfg.ulTotalBw, cellCfg->bwCfg.dlTotalBw); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }
   if (cellCfg->rachCfg.maxMsg3Tx < 1)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 219); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid RACH configuration: maxMsg3Tx %d", cellCfg->rachCfg.maxMsg3Tx); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }

   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 225); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG cell config validation done: cellId %d\n", cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 268); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATE CRG UE CONFIG: cellId %d ueId %d cell %p\n", ueCfg->cellId, ueCfg->crnti, (void*)*cell); SPrint((&rgCb.rgInit)->prntBuf); } };


   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 1;
# 280 "../..//ltemac/rg_cfg.c"
   if ((*cell = rgDBMGetCellCb(ueCfg->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 282); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Active Cell does not exist %d\n", ueCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   if (rgDBMGetUeCb(*cell, ueCfg->crnti) != 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 288); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue already exists %d\n", ueCfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   if (ueCfg->ueUlHqCfg.maxUlHqTx < 1)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 295); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid Uplink HARQ config for UE %d\n", ueCfg->ueUlHqCfg.maxUlHqTx); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 300); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG UE config validation done: cellId %d ueId %d\n", ueCfg->cellId, ueCfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 349); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATE CRG LC CONFIG: cellId %d ueId %d lcId %d            cell %p ue %p\n", lcCfg->cellId, lcCfg->crnti, lcCfg->lcId, (void*)*cell, (void*)*ue); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcCfg->lcType == 4 || lcCfg->lcType == 5)
   {
      ...
      if ((rgCFGVldtCrgDedLcCfg(lcCfg, cell, ue, errInfo)) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 356); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Validation for dedicated LC failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         return(1);
      }
   }
         ...
         || lcCfg->lcType == 3)
   {
      if ((rgCFGVldtCrgCmnLcCfg(lcCfg, cell, errInfo)) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 366); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Validation for common logical channels failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
         return(1);
      }
   }
   else
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 372); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid logical channel type %d\n", lcCfg->lcType); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
# 387 "../..//ltemac/rg_cfg.c"
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 389); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG LC config validation done: cellId %d ueId %d            lcId %d\n", lcCfg->cellId, lcCfg->crnti, lcCfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 435); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATE CRG CELL RECONFIG: cellId %d cell %p\n", cellRecfg->cellId, (void*)*cell); SPrint((&rgCb.rgInit)->prntBuf); } };


   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 4;

   if (((*cell = rgDBMGetCellCb(cellRecfg->cellId)) == 0L)
         && ((*cell = rgDBMGetInactvCellCb(cellRecfg->cellId)) == 0L))
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 442); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell does not exist %d\n",cellRecfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   if (cellRecfg->rachRecfg.maxMsg3Tx < 1)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 448); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid RACH configuration: maxMsg3Tx %d", cellRecfg->rachRecfg.maxMsg3Tx); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 453); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG Cell Reconfig validation done: cellId %d\n", cellRecfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 503); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATE CRG UE RECONFIG: cellId %d oldUeId %d            cell %p ue %p\n", ueRecfg->cellId, ueRecfg->oldCrnti, (void*)*cell, (void*)*ue); SPrint((&rgCb.rgInit)->prntBuf); } };



   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 5;
# 516 "../..//ltemac/rg_cfg.c"
   if ((*cell = rgDBMGetCellCb(ueRecfg->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 518); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Active Cell does not exist %d\n", ueRecfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 525); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Old Ue does not exist %d\n", ueRecfg->oldCrnti); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   if (ueRecfg->oldCrnti != ueRecfg->newCrnti)
   {
      if (rgDBMGetUeCb(*cell, ueRecfg->newCrnti) != 0L)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 533); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "New Ue already exists %d\n", ueRecfg->newCrnti); SPrint((&rgCb.rgInit)->prntBuf); } };
         return(1);
      }
   }
   if (ueRecfg->ueUlHqRecfg.maxUlHqTx < 1)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 540); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid Uplink HARQ config for UE %d\n", ueRecfg->ueUlHqRecfg.maxUlHqTx); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 545); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG Ue reconfig validation done: cellId %d oldUeId %d\n", ueRecfg->cellId, ueRecfg->oldCrnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 601); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATE CRG LC RECONFIG: cellId %d ueId %d             lcId %d cell %p ue %p ulLc %p",lcRecfg->cellId, lcRecfg->crnti,lcRecfg->lcId, (void*)*cell, (void*)*ue, (void*)*ulLc); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if ((*cell = rgDBMGetCellCb(lcRecfg->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 608); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Active Cell does not exist %d\n", lcRecfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 616); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue does not exist for dedicated logical channel %d\n", lcRecfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 623); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Dedicated UL LC does not exist %d\n", lcRecfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 630); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid lcgId for uplink logical channel: lcg %d               lc %d\n", lcRecfg->ulRecfg.lcgId, lcRecfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }

   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 636); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG Lc Reconfig validation done: cellId %d ueId %d            lcId %d\n", lcRecfg->cellId, lcRecfg->crnti,lcRecfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 682); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATE CRG UE RESET: cellId %d UeId %d\n", reset->cellId, reset->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };


   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 21;


   if ((*cell = rgDBMGetCellCb(reset->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 689); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Active Cell does not exist %d\n", reset->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 696); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "UE does not exist %d\n", reset->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 702); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG UE reset validation done: cellId %d UeId %d\n", reset->cellId, reset->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 748); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG CELL CONFIG: cellId %d\n", cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };


   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 9;


   if((ret = rgAllocSBuf((Data**)&cell, sizeof(RgCellCb))) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 756); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Memory allocation FAILED for cell %d", cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }
   if (cell == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 762); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Memory allocation FAILED for cell %d", cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 781); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "DBM initialization for cell %d failed\n", cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 801 "../..//ltemac/rg_cfg.c"
   rgUpdtCellCnt(1);
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 803); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG Cell configuration done %d\n",cellCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(0);
}
# 833 "../..//ltemac/rg_cfg.c"
 S16 rgCFGCrgUeCfg
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 851); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG UE CONFIG: cellId %d ueId %d cell %p\n", ueCfg->cellId, ueCfg->crnti, (void*)cell); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if ((ue = rgDBMGetUeCbFromRachLst(cell, ueCfg->crnti)) == 0L)
   {
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 861); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "UeCb creation failed for UE %d\n", ueCfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
         return(1);
      }

      if(rgDHMHqEntInit(&ue->dl.hqEnt, cell->maxDlHqProcPerUe) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 867); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"UeCb Harq Entity Initialization failed for HO UE %d \n", ueCfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
         return(1);
      }
   ...
   rgUpdtUeCnt(1);
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 891); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Crg Ue configuration done: cellId %d ueId %d\n", ueCfg->cellId, ueCfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 943); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG LC CONFIG: cellId %d ueId %d            lcId %d dir %d cell %p ue %p\n", lcCfg->cellId, lcCfg->crnti, lcCfg->lcId, lcCfg->dir, (void*)cell, (void*)ue); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcCfg->lcType == 4 || lcCfg->lcType == 5)
   {
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 951); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Dedicated logical channel configuration                  failed %d\n", lcCfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      if ((rgCFGCrgCmnLcCfg(cell, lcCfg, errInfo)) != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 960); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Common logical channel configuration failed %d\n", lcCfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 967); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG LC config done: cellId %d ueId %d lcId %d\n", lcCfg->cellId, lcCfg->crnti, lcCfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1008); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG CELL RECONFIG: cellId %d cell %p\n", cellRecfg->cellId, (void*)cell); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1014); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG Cell reconfiguration done %d\n", cellRecfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(0);
}
# 1046 "../..//ltemac/rg_cfg.c"
 S16 rgCFGCrgUeRecfg
(
RgCellCb *cell,
RgUeCb *ue,
...
{
   U32 cnt;
   RgUeCb *newCrntiUeCb=0L;
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1066); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG UE RECONFIG: cellId %d oldUeId %d            newUeId %d cell %p ue %p\n", ueRecfg->cellId, ueRecfg->oldCrnti, ueRecfg->newCrnti, (void*)cell, (void*)ue); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (ueRecfg->oldCrnti != ueRecfg->newCrnti)
   {
      ...
      if (newCrntiUeCb == 0L)
      {
          ...
          { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1081); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgDBMGetUeCbFromRachLst Failed. OldUeId %d" " newUeId %d, cell %d\n", ueRecfg->oldCrnti, ueRecfg->newCrnti, ueRecfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      rgDBMDelUeCbFromRachLst(cell, newCrntiUeCb);
   }
   ...
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1115); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue reconfigured: oldUeId %d newUeId %d cell %d\n", ueRecfg->oldCrnti, ueRecfg->newCrnti, ueRecfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

   return(0);
}
# 1145 "../..//ltemac/rg_cfg.c"
 S16 rgCFGCrgLcRecfg
(
RgCellCb *cell,
RgUeCb *ue,
...
# 1161 "../..//ltemac/rg_cfg.c"
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1166); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG LC RECONFIG: cellId %d ueId %d            lcId %d cell %p ue %p ulLc %p \n", lcRecfg->cellId, lcRecfg->crnti, lcRecfg->lcId, (void*)cell, (void*)ue, (void*)ulLc); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1175); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "LC %d of Ue %d of cell %d Reconfigured\n", lcRecfg->lcId, ue->ueId, cell->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

   return(0);
}
# 1199 "../..//ltemac/rg_cfg.c"
 S16 rgCFGCrgUeReset
(
RgCellCb *cell,
RgUeCb *ue,
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1216); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG UE RESET: cellId %d ueId %d\n", reset->cellId, reset->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1222); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "UE %d of cell %d Reset\n", ue->ueId, cell->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(0);
}
# 1247 "../..//ltemac/rg_cfg.c"
 S16 rgCFGCrgCellDel
(
CrgDel *cellDelInfo,
RgErrInfo *errInfo
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1263); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG CELL DELETE: cellId %d\n", cellDelInfo->u.cellDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };


   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 18;

   if ((cell = rgDBMGetCellCb(cellDelInfo->u.cellDel.cellId)) == 0L)
   {
      if ((cell = rgDBMGetInactvCellCb(cellDelInfo->u.cellDel.cellId))
            == 0L)
      {

         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1274); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell does not exist %d\n", cellDelInfo->u.cellDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      errInfo->errCause = 0;
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1285); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Inactive cell %d deleted\n", cellDelInfo->u.cellDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(0);
   }
   ...
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1302); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell %d deleted\n", cellDelInfo->u.cellDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(0);
}
# 1327 "../..//ltemac/rg_cfg.c"
 S16 rgCFGCrgUeDel
(
CrgDel *ueDelInfo,
RgErrInfo *errInfo
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1343); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG UE DELETE: cellId %d ueId %d\n", ueDelInfo->u.ueDel.cellId, ueDelInfo->u.ueDel.crnti); SPrint((&rgCb.rgInit)->prntBuf); } };


   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 19;

   if ((cell = rgDBMGetCellCb(ueDelInfo->u.ueDel.cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1349); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell does not exist %d\n",ueDelInfo->u.ueDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   if ((ue = rgDBMGetUeCb(cell, ueDelInfo->u.ueDel.crnti)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1354); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue does not exist %d\n",ueDelInfo->u.ueDel.crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ...
   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1366); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue %d deleted from cell %d \n", ueDelInfo->u.ueDel.crnti, ueDelInfo->u.ueDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

   return(0);
}
# 1391 "../..//ltemac/rg_cfg.c"
 S16 rgCFGCrgLcDel
(
CrgDel *lcDelInfo,
RgErrInfo *errInfo
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1412); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING CRG LC DELETE: cellId %d ueId %d            lcId %d dir %d\n", lcDelInfo->u.lchDel.cellId, lcDelInfo->u.lchDel.crnti, lcDelInfo->u.lchDel.lcId, lcDelInfo->u.lchDel.dir); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if ((cell = rgDBMGetCellCb(lcDelInfo->u.lchDel.cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1419); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell does not exist %d\n",lcDelInfo->u.lchDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1427); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue %d does not exist for dedicated logical channel\n", lcDelInfo->u.lchDel.crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcDelInfo->u.lchDel.dir & (1<<0))
   {
      if ((dlLc = rgDBMGetDlDedLcCb(ue, lcDelInfo->u.lchDel.lcId))
            == 0L)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1438); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "DL LC %d does not exist for UE %d\n", lcDelInfo->u.lchDel.lcId, lcDelInfo->u.lchDel.crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcDelInfo->u.lchDel.dir & (1<<1))
   {
      if ((ulLc = rgDBMGetUlDedLcCb(ue, lcDelInfo->u.lchDel.lcId))
            == 0L)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1452); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "UL LC %d does not exist for UE %d\n", lcDelInfo->u.lchDel.lcId, lcDelInfo->u.lchDel.crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (!dirVld)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1462); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid direction %d for LC Delete\n", lcDelInfo->u.lchDel.dir); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }

   errInfo->errCause = 0;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1469); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Logical channel %d deleted from Ue %d from cell %d\n", lcDelInfo->u.lchDel.lcId, lcDelInfo->u.lchDel.crnti, lcDelInfo->u.lchDel.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };


   return(0);
}
# 1490 "../..//ltemac/rg_cfg.c"
...

{
   U8 dirVld = 0;
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1507); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATING CRG DEDICATED LC CONFIG"); SPrint((&rgCb.rgInit)->prntBuf); } };

   errInfo->errCause = 0 + 3 + 1 + 2 + 1 + 6 + 1 + 1 + 1 + 6 + 1 + 2;


   if ((*cell = rgDBMGetCellCb(lcCfg->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1515); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Active Cell does not exist: Cell %d\n", lcCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1523); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue %d does not exist for dedicated logical               channel %d\n", lcCfg->crnti, lcCfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if ((lcCfg->lcId < 0x01)
            ||(lcCfg->lcId > 0x0A))
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1532); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid logical channel Id %d\n", lcCfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcCfg->dir & (1<<0))
   {
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1542); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Dedicated DL LC %d already configured for UE %d\n", lcCfg->lcId, lcCfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcCfg->dir & (1<<1))
   {
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1554); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid lcgId for uplink logical channel %d\n", lcCfg->ulInfo.lcgId); SPrint((&rgCb.rgInit)->prntBuf); } };

         return(1);
      }
      if (rgDBMGetUlDedLcCb((*ue), lcCfg->lcId) != 0L)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1560); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Dedicated UL LC %d already configured for UE %d\n", lcCfg->lcId, lcCfg->crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (!dirVld)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1568); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid Direction %d \n", lcCfg->dir); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1573); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Dedicated logical channel %d validated for ue %d            for cell %d\n", lcCfg->lcId, lcCfg->crnti, lcCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

   return(0);
}
# 1595 "../..//ltemac/rg_cfg.c"
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1611); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "VALIDATING COMMON LC CONFIG"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if ((*cell = rgDBMGetCellCb(lcCfg->cellId)) != 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1619); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Active Cell %d exists for common channels\n", lcCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

      return(1);
   }


   if ((*cell = rgDBMGetInactvCellCb(lcCfg->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1627); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Inactive Cell %d does not exist for common channels\n", lcCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcCfg->dir & (1<<0))
   {
      if (lcCfg->lcType == 1)
      {
         ...
         if (lcCfg->dlInfo.dlTrchType == 3)
         {
            ...
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1642); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "BCCH on DLSCH already configured for                        cell %d\n", (*cell)->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         else if (lcCfg->dlInfo.dlTrchType == 1)
         {
            ...
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1652); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "BCCH on BCH already configured for cell %d\n", (*cell)->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1659); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid transport channel %d for cell %d\n", lcCfg->dlInfo.dlTrchType, (*cell)->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      else if (lcCfg->lcType == 2)
      {
         ...
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1670); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "PCCH already configured for cell %d\n", (*cell)->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1677); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "DL CCCH already configured for cell %d\n", (*cell)->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (lcCfg->dir & (1<<1))
   {
      ...
      if (lcCfg->lcType != 3)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1690); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid UL common lcType %d for cell %d\n", lcCfg->lcType, (*cell)->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

         return(1);
      }
      if (((*cell)->ulCcchId != 255))
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1696); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "UL CCCH already configured for cell %d\n", (*cell)->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (!dirVld)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1705); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid Direction %d\n", lcCfg->dir); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1710); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Common logical channel %d validated for cell %d\n", lcCfg->lcId, lcCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

   return(0);
}
# 1732 "../..//ltemac/rg_cfg.c"
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1748); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING DEDICATED LC CONFIG"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1768); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Dedicated LC config done\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(0);
}
# 1791 "../..//ltemac/rg_cfg.c"
...
{
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1805); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "APPLYING COMMON LC CONFIG"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (cell->cellActvState == ((1<<0) | (1<<1) | (1<<2) | (1<<3) | (1<<4) | (1<<5)))
   {
      ...
      rgDBMInsCellCb(cell);
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1865); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell %d added to active list after common LC %d               config\n", cell->cellId, lcCfg->lcId); SPrint((&rgCb.rgInit)->prntBuf); } };

   }

   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1869); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Common LC config done: lcId %d cell %d\n", lcCfg->lcId, lcCfg->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };

   return(0);
}
# 1932 "../..//ltemac/rg_cfg.c"
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 1961); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell freed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };


  return;
}
# 1985 "../..//ltemac/rg_cfg.c"
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 2014); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell freed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };


  return;
}
# 2038 "../..//ltemac/rg_cfg.c"
static Void rgCFGFreeUeCb
(
RgCellCb *cell,
RgUeCb *ue
)
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 2062); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue freed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };


  return;
}
# 2085 "../..//ltemac/rg_cfg.c"
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 2098); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Common LC list of the cell %d freed\n", cell->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };


  return;
}
# 2122 "../..//ltemac/rg_cfg.c"
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_cfg.c", 2145); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue list of the cell %d freed\n", cell->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };


  return;
}
# 2219 "../..//ltemac/rg_cfg.c"
...

{
   ...
   if((cell = rgDBMGetCellCb(regReq->cellId)) == 0L)
   {
      return(1);
   }
