...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 121 "../..//ltemac/rg_sch_ram.c" 2
# 1 "../..//cm/cm5.x" 1
# 122 "../..//ltemac/rg_sch_ram.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
static Void rgSCHRamIndRntiRls2Mac ( RgSchCellCb *cell, RgSchRaCb *raCb);
# 176 "../..//ltemac/rg_sch_ram.c"
...
# 255 "../..//ltemac/rg_sch_ram.c"
   ;

   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 258); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamProcRaReq(): cellId = %u; " "raRnti = %u\n", cell->cellId, raRnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for (idx = 0; idx < raReqInd->numRaReqInfo; idx++)
   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 266); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamProcRaReq(): RaReq " "with invalid rapId=%u\n", raReqInd->raReqInfoArr[idx].rapId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


         continue;
      }
# 285 "../..//ltemac/rg_sch_ram.c"
      if((rgSCHUtlAllocSBuf(cell->instIdx, (Data **)(&raReqInfo),
                        sizeof(RgSchRaReqInfo))) == 1)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 289); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamProcRaReq(): Allocation" " of RaReq failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   if((rgSCHUtlAllocSBuf(inst, (Data **)(raCb),
                      sizeof(RgSchRaCb))) == 1)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 373); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamCreateRaCb(): Allocation of " "RaCb failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   else
   {
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 388); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamCreateRaCb(): Allocation of " "temporary RNTI failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if ((*raCb)->dlHqE == 0L)
   {
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 405); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamCreateRaCb(): Creation of" " DL HARQ failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 481); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamRgrUeCfg(): cellId = %u; " "ueId = %u; tmpCrnti = %u\n", cell->cellId, ue->ueId, raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 505 "../..//ltemac/rg_sch_ram.c"
   ...
   ue->dl.hqEnt->msg4Proc = raCb->dlHqE->msg4Proc;

   if(raCb->raState == RGSCH_RA_MSG4_PENDING)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 516); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamRgrUeCfg(): RaCb with " "rnti=%u is updated with Ue information\n", raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 594); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamContResCrnti(): cellId = %u; " "tmpCrnti = %u\n", cell->cellId, raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 602); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamContResCrnti():Indicate c-rnti" " based uplink grant to scheduler for UeId = %u\n", ue->ueId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 611 "../..//ltemac/rg_sch_ram.c"
...

{
   ...
   {
      if(cell->rachCfg.contResTmr - 8)
      {
         if ((cell->crntTime.subframe + ((cell->rachCfg.contResTmr - 8))) >= 10) expTime.sfn = (cell->crntTime.sfn + (cell->crntTime.subframe + ((cell->rachCfg.contResTmr - 8)))/10) % 1024; else expTime.sfn = cell->crntTime.sfn; expTime.subframe = (cell->crntTime.subframe + ((cell->rachCfg.contResTmr - 8))) % 10;;
...
# 737 "../..//ltemac/rg_sch_ram.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 744); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamProcMsg3(): cellId = %u; " "tmpCrnti = %u\n", cell->cellId, raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 803); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamUpdtBo(): tmpCrnti = %u;" " bo = %ld\n", raCb->tmpCrnti, (U32)staRsp->bo); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 931 "../..//ltemac/rg_sch_ram.c"
static Void rgSCHRamIndRntiRls2Mac
(
RgSchCellCb *cell,
RgSchRaCb *raCb
)
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 949); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamIndRntiRls2Mac(): cellId = %u; " "tmpCrnti = %u\n", cell->cellId, raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 997); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamMsg4Done(): cellId = %u; " "tmpCrnti = %u\n", cell->cellId, raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 1061); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamDelRaCb(): cellId = %u; " "tmpCrnti = %u\n", cell->cellId, raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (raCb->dlHqE )
   {
      if (raCb->dlHqE->msg4Proc != 0L)
      {
         ...
         if ((raCb->dlHqE->msg4Proc->tbInfo[0].subFrm != 0L) &&
             (raCb->dlHqE->msg4Proc->tbInfo[0].sfLnk.node != 0L))
         {
      ...
      if ((raCb->dlHqE->ue == 0L)
            || (raCb->dlHqE->ue->dl.hqEnt != raCb->dlHqE))
      {


         rgSCHUtlFreeSBuf(inst, (Data **)(&(raCb->dlHqE)),
               sizeof(RgSchDlHqEnt));
      }
   }
...

{
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 1215); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHRamTtiHndlr(): cellId = %u\n", cell->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 1233 "../..//ltemac/rg_sch_ram.c"
   ...
   { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 1250); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHRamTtiHndlr(): Flushing the " "previously enqueued raReqs for raRnti = %u\n", raRnti); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 1276 "../..//ltemac/rg_sch_ram.c"
   if ((crntSfn % 10) == 0)
   {
      ...
      for (idx = 0; idx < maxCnt; idx++)
      {
         ...
         if ((dist >= 10) && (raCb->dlHqE->msg4Proc == 0L) && (raCb->dlHqE->ue != 0L))
         {
            { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 1302); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHRamTtiHndlr(): Deleting" " raCb with rnti = %u\n", raCb->tmpCrnti); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 1360); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHRamFreeCell(): cellId = %u\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
# 1370 "../..//ltemac/rg_sch_ram.c"
   lstSz = 10;
...

{
   ...
   ;
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_ram.c", 1470); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHDhmProcContResGrdExp(): tmpCrnti = %u \n" , raCb->tmpCrnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   if ((cell->crntTime.subframe + ((8))) >= 10) expTime.sfn = (cell->crntTime.sfn + (cell->crntTime.subframe + ((8)))/10) % 1024; else expTime.sfn = cell->crntTime.sfn; expTime.subframe = (cell->crntTime.subframe + ((8))) % 10;;
   raCb->expiryTime = expTime;
   raCb->schdLnk.node = (U32)(raCb);
