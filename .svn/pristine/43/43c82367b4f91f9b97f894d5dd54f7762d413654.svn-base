...
void IcpuTxTask(PUNKNOWN data);
void IcpuRxTaskDirect(PUNKNOWN data);
RESULTCODE IcpuSendMsgDirect(U32 size, PUNKNOWN data);

void (*IcpuRxTask)(PUNKNOWN data) = IcpuRxTaskDirect;
RESULTCODE (*IcpuSendMsg)(U32 size, PUNKNOWN data) = IcpuSendMsgDirect;
