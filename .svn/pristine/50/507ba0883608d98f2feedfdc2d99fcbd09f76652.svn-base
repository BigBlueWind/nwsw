...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 108 "../..//lterlcpdcp/kw_pj_dbm.c" 2
# 1 "../..//cm/cm5.h" 1
# 109 "../..//lterlcpdcp/kw_pj_dbm.c" 2
# 1 "../..//cm/cm_lte.h" 1
# 91 "../..//cm/cm_lte.h"
#define __CM_LTE_H__ 
# 101 "../..//cm/cm_lte.h"
...
# 128 "../..//lterlcpdcp/kw_pj_dbm.c" 2
# 1 "../..//cm/cm5.x" 1
# 129 "../..//lterlcpdcp/kw_pj_dbm.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 140 "../..//lterlcpdcp/kw_pj_dbm.c" 2
# 182 "../..//lterlcpdcp/kw_pj_dbm.c"
 S16 pjDbmBufInit
(
PjBuf *buf,
U8 numBins
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 198); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmBufInit(buf, numBins(%d)\n", numBins); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&buf->datQ, (Size) (sizeof(CmLListCp) * numBins)) == 0) { cmMemset((U8 *)(buf->datQ), 0, (sizeof(CmLListCp) * numBins)); } else { (buf->datQ) = 0L; } };
# 211 "../..//lterlcpdcp/kw_pj_dbm.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 257); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmInsTxEnt(buf, txEnt(%ld)\n", txEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   hashKey = (txEnt->count % buf->numBins);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 308); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmGetTxEnt(buf, txEnt(%ld)\n", count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 368); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmGetTxEnt(buf, sn(%d)\n", sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   hashKey = (sn % buf->numBins);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 425); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmDelTxEnt(buf,  count(%ld)\n", count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   hashKey = (delEnt->count % buf->numBins);
   datQ = &buf->datQ[hashKey];
   ...
   { if (delEnt->pdu != 0L) { SPutMsg(delEnt->pdu); } delEnt->pdu = 0L; };
   { if (delEnt->sdu != 0L) { SPutMsg(delEnt->sdu); } delEnt->sdu = 0L; };
   { if (delEnt != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) delEnt, (Size) sizeof(PjTxEnt)); delEnt = 0L; } };
   buf->numEntries --;

   return(0);
}
# 475 "../..//lterlcpdcp/kw_pj_dbm.c"
 S16 pjDbmTxDelAll
(
PjBuf *buf
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 492); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmTxDelAll(buf)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   for(i = 0; i< buf->numBins; i++)
   {
      ...
      while(((datQ)->crnt = (datQ)->first) != 0L)
      {
         ...
         if(lstEnt != 0L)
         {
            ...
            { if (txEnt != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) txEnt, (Size) sizeof(PjTxEnt)); txEnt = 0L; } };
         }
      }
      cmLListInit(datQ);
   }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 547); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmTxDeInit(buf)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (buf->datQ != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) buf->datQ, (Size) (sizeof(CmLListCp) * buf->numBins)); buf->datQ = 0L; } };
   buf->numBins = 0L;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 601); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmInsRxEnt buf, rxEnt(%ld), dupFlag(%d)\n", rxEnt->count, dupFlag); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 608 "../..//lterlcpdcp/kw_pj_dbm.c"
   if(dupFlag)
   {
   ...
   hashKey = (rxEnt->count % buf->numBins);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 664); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmGetRxEnt(buf, count(%ld)\n", count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 725); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmDelRxEnt(buf, count(%ld)\n", count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (delEnt != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) delEnt, (Size) sizeof(PjRxEnt)); delEnt = 0L; } };
   buf->numEntries --;

   return(0);
}
# 767 "../..//lterlcpdcp/kw_pj_dbm.c"
 S16 pjDbmRxDelAll
(
PjBuf *buf
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 784); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmRxDelAll(buf)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 2) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_dbm.c", 833); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjDbmRxDeInit(buf)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
