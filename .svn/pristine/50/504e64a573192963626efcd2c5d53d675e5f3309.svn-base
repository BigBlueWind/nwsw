//-------------------------------------------------------------------------------------------
/** @file DOX_INTERNAL Ad361lte10.h
 *
 * @brief
...
const ADRADPROFILE Ad261Lte10Mhz[] = {
//************************************************************
...
//************************************************************
// FDD RX/TX Synth Frequency: 2535.000000,2655.000000 MHz
//************************************************************
//************************************************************
// Setup Synthesizer
//************************************************************
...
{SPIWR,0x242,0x0D},// Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
{SPIWR,0x238,0x30},// Set VCO Cal Offset[3:0]
...
{SPIWR,0x23B,0x10},// Set Rx Synth Loop filter Icp
//************************************************************
// Setup Synthesizer
//************************************************************
{SPIWR,0x27A,0x4A},// Set VCO Output level[3:0]
{SPIWR,0x279,0x80},// Set Init ALC Value[3:0] and VCO Caractor[3:0]
{SPIWR,0x282,0x0D},// Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
{SPIWR,0x278,0x30},// Set VCO Cal Offset[3:0]
...
{SPIWR,0x27E,0xF2},// Set Tx Synth Loop filter C2 and C1
{SPIWR,0x27B,0x0E},// Set Tx Synth Loop filter Icp
{SPIWR,0x233,0xF8},// Write Rx Synth Fractional Freq Word[7:0]
{SPIWR,0x234,0xFF},// Write Rx Synth Fractional Freq Word[15:8]
{SPIWR,0x235,0x3F},// Write Rx Synth Fractional Freq Word[22:16]
{SPIWR,0x232,0x00},// Write Rx Synth Integer Freq Word[10:8]
{SPIWR,0x231,0xFD},// Write Rx Synth Integer Freq Word[7:0]
{SPIWR,0x005,0x11},// Set LO divider setting
{SPIWR,0x273,0xF8},// Write Tx Synth Fractional Freq Word[7:0]
{SPIWR,0x274,0xFF},// Write Tx Synth Fractional Freq Word[15:8]
{SPIWR,0x275,0x3F},// Write Tx Synth Fractional Freq Word[22:16]
{SPIWR,0x272,0x01},// Write Tx Synth Integer Freq Word[10:8]
{SPIWR,0x271,0x09},// Write Tx Synth Integer Freq Word[7:0] (starts VCO cal)
{SPIWR,0x005,0x11},// Set LO divider setting
...
{WCALDONE,RXFILTER,2000},// Wait for RX filter to tune, Max Cal Time: 11.169 us
//************************************************************
...
{WCALDONE,TXFILTER,2000},// Max Cal Time: 5.778 us
