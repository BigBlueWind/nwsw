...
#undef KW_BG_DL_PROC
# 1 "../..//lterlcpdcp/kw_utl.c"
# 102 "../..//lterlcpdcp/kw_utl.c"
#define __GPX__ 
# 115 "../..//lterlcpdcp/kw_utl.c"
# 1 "../..//mt/envopt.h" 1
# 94 "../..//mt/envopt.h"
#define __ENVOPTH__ 
# 179 "../..//mt/envopt.h"
...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 121 "../..//lterlcpdcp/kw_utl.c" 2
# 1 "../..//cm/cm5.h" 1
# 122 "../..//lterlcpdcp/kw_utl.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 144 "../..//lterlcpdcp/kw_utl.c" 2

# 1 "../..//cm/cm5.x" 1
# 146 "../..//lterlcpdcp/kw_utl.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 163 "../..//lterlcpdcp/kw_utl.c" 2
# 198 "../..//lterlcpdcp/kw_utl.c"
 S16 kwUtlSndToLi
(
...

{
   ...
   S16 ret;
   U32 totNumPdu;
# 229 "../..//lterlcpdcp/kw_utl.c"
   ;

   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) )) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 232); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlSndToLi(staIndInfo)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&datReqInfo, (Size) sizeof(RguDDatReqInfo)) == 0) { cmMemset((U8 *)(datReqInfo), 0, sizeof(RguDDatReqInfo)); } else { (datReqInfo) = 0L; } };


   cmMemset( (U8 *)&datReq, 0, sizeof(KwDatReq) );
# 267 "../..//lterlcpdcp/kw_utl.c"
...
# 306 "../..//lterlcpdcp/kw_utl.c"
            }
            else if ( rbCb->mode == 3 )
            {
               ret = kwAmmProcessSdus(rbCb,&datReq);
# 321 "../..//lterlcpdcp/kw_utl.c"
            }
...
# 360 "../..//lterlcpdcp/kw_utl.c"
            cmMemset( (U8 *)&datReq, 0, sizeof(KwDatReq) );
         }
      }
      datReqTb->nmbLch = staIndTb->nmbLch;
# 384 "../..//lterlcpdcp/kw_utl.c"
   }
   if ( totNumPdu == 0 )
   {

      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1)| ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1)| ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 389); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf,"No data to send \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


      { if (datReqInfo != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) datReqInfo, (Size) sizeof(RguDDatReqInfo)); datReqInfo = 0L; } };
      return(0);
   }
...

{
   ...
   KwUeKey ueKey;
   S16 ret;
# 453 "../..//lterlcpdcp/kw_utl.c"
   ;

   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 456); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlRcvFrmLi(datIndInfo)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   for ( count = 0;count < datIndInfo->numLch; count++ )
   {
      ...
      if ( rbCb->mode == 2 )
      {
# 491 "../..//lterlcpdcp/kw_utl.c"
         ret = kwUmmProcessPdus(rbCb,pduInfo);
# 501 "../..//lterlcpdcp/kw_utl.c"
      }
      else if (rbCb->mode == 3 )
      {
# 514 "../..//lterlcpdcp/kw_utl.c"
         ret = kwAmmProcessPdus(rbCb,pduInfo);
# 524 "../..//lterlcpdcp/kw_utl.c"
         }
      }
   }
   return(0);
}
# 552 "../..//lterlcpdcp/kw_utl.c"
 S16 kwUtlSndDStaRsp
(
KwRbCb *rbCb,
S32 bo,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 573); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlSndDStaRsp(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&staRspInfo, (Size) sizeof(RguDStaRspInfo)) == 0) { cmMemset((U8 *)(staRspInfo), 0, sizeof(RguDStaRspInfo)); } else { (staRspInfo) = 0L; } };
# 584 "../..//lterlcpdcp/kw_utl.c"
   rguSap = &(kwCb.rguSap);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 666); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlEmptySduQ(sduQ)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 688 "../..//lterlcpdcp/kw_utl.c"
   ((((firstNode) = ((sduQ)->crnt = (sduQ)->first)) != 0L) ? (firstNode)->node : 0L);
   while(firstNode)
   {
      sdu = (KwSdu *)firstNode->node;
      { if(sdu->mBuf) { if (sdu->mBuf != 0L) { SPutMsg(sdu->mBuf); } sdu->mBuf = 0L;}; sdu->mBuf = 0L; cmLListDelFrm(sduQ,&sdu->lstEnt); { if (sdu != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) sdu, (Size) sizeof(KwSdu)); sdu = 0L; } };};
      ((((firstNode) = ((sduQ)->crnt = (sduQ)->first)) != 0L) ? (firstNode)->node : 0L);
   }
   return(0);
}
# 715 "../..//lterlcpdcp/kw_utl.c"
 S16 kwUtlEmptySduQInSlowPath
(
CmLListCp *sduQ,
U8 *numOfTxReTxCnt
)
...

{
   ...
   ((((firstNode) = ((sduQ)->crnt = (sduQ)->first)) != 0L) ? (firstNode)->node : 0L);
   while(firstNode && (*numOfTxReTxCnt < 1))
   {
      sdu = (KwSdu *)firstNode->node;
      { if(sdu->mBuf) { if (sdu->mBuf != 0L) { SPutMsg(sdu->mBuf); } sdu->mBuf = 0L;}; sdu->mBuf = 0L; cmLListDelFrm(sduQ,&sdu->lstEnt); { if (sdu != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) sdu, (Size) sizeof(KwSdu)); sdu = 0L; } };};
      ((((firstNode) = ((sduQ)->crnt = (sduQ)->first)) != 0L) ? (firstNode)->node : 0L);
...

{
   ...
   PjRbCb *pjRbCb = 0L;
# 779 "../..//lterlcpdcp/kw_utl.c"
   ;


   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 783); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlSndDatInd(rbCb,sdu)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 803 "../..//lterlcpdcp/kw_utl.c"
   if(kwCb.init.trc == 1)
   {

      kwLmmSendTrc(0x54, sdu);
   }
...
# 826 "../..//lterlcpdcp/kw_utl.c"
   return(0);
}
# 850 "../..//lterlcpdcp/kw_utl.c"
 S16 kwUtlCalcLiForSdu
(
U16 numLi,
MsgLen msgLen,
S16 *pduSz
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 866); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlCalcLiForSdu(rbCb, msgLen, pduSz)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 929); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlFreeRbCb(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( rbCb->mode == 2 )
   {
      ...
      if (rbCb->dir & 1)
      {
         ...
         rbCb->rbOp |= 0x08;
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 953); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlFreeRbCb:Count(%lu) in toBeReasmbldUmPduLst\n", pduListCnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         if (tmrRunning)
         {
            kwStopTmr((U32)&rbCb->m.um.umUl,1);
         }
         ...
         while ( curSn < windSz )
         {
            ...
            {
               if (umRecBuf[curSn] && (umRecBuf[curSn]->pdu != 0L))
               {



                  cmLListAdd2Tail(&rbCb->m.um.umUl.toBeReasmbldUmPduLst, &umRecBuf[curSn]->rlsUmPduLnk);
                  umRecBuf[curSn]->rlsUmPduLnk.node = (U32)umRecBuf[curSn];
                  umRecBuf[curSn] = 0L;
         ...
         { if (rbCb->m.um.umUl.recBuf != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) rbCb->m.um.umUl.recBuf, (Size) (windSz ) * sizeof(KwUmRecBuf*)); rbCb->m.um.umUl.recBuf = 0L; } };
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 1013); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlFreeRbCb:Count(%lu) in toBeReasmbldUmPduLst\n", rbCb->m.um.umUl.toBeReasmbldUmPduLst.count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   else if (rbCb->mode == 3)
   {
      ...
      pduListCnt = rbCb->m.am.amUl.toBeReasmbldAmPduLst.count;
      reasmblyRbListCnt = kwCb.reasmblyRbList.count;


      rbCb->rbOp |= 0x08;
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 1031); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlFreeRbCb:Count(%lu) in toBeReasmbldAmPduLst\n", pduListCnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



      windSz = 512 * 2;

      amRecBuf = rbCb->m.am.amUl.recBuf;





      kwUtlEmptySduQ(&rbCb->m.am.amDl.sduQ);
      ...
      while (mSn <= mVtS)
      {
         ...
         if (rbCb->m.am.amDl.txBuf[sn] && rbCb->m.am.amDl.txBuf[sn]->pdu)
         {
      ...
      { if (rbCb->m.am.amDl.txBuf != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) rbCb->m.am.amDl.txBuf, (Size) (512 * 2)* sizeof(KwTx*)); rbCb->m.am.amDl.txBuf = 0L; } };
      { CmLList *tmpNode; ((((tmpNode) = ((&(rbCb->m.am.amDl.retxLst))->crnt = (&(rbCb->m.am.amDl.retxLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) retx = (KwRetx *)tmpNode->node; else retx = 0L; };
...
# 1107 "../..//lterlcpdcp/kw_utl.c"
      ...
      while ( curSn < windSz )
      {
         if ( amRecBuf[curSn] != 0L )
         {
            ...
            cmLListAdd2Tail(&rbCb->m.am.amUl.toBeReasmbldAmPduLst,
                            &amRecBuf[curSn]->rlsAmPduLnk);
            amRecBuf[curSn]->rlsAmPduLnk.node = (U32)amRecBuf[curSn];
            amRecBuf[curSn] = 0L;
# 1148 "../..//lterlcpdcp/kw_utl.c"
         }
         curSn++;
      }
      { if (rbCb->m.am.amUl.recBuf != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) rbCb->m.am.amUl.recBuf, (Size) (windSz)* sizeof(KwAmRecBuf*)); rbCb->m.am.amUl.recBuf = 0L; } };




      if( (0 == pduListCnt) && (rbCb->m.am.amUl.toBeReasmbldAmPduLst.count > 0) )
      {
         cmLListAdd2Tail(&kwCb.reasmblyRbList, &rbCb->rlsReasmblyRbLnk);
         rbCb->rlsReasmblyRbLnk.node = (U32)rbCb;
      }
      ...
      if (0 == rbCb->m.am.amUl.toBeReasmbldAmPduLst.count)
      {
         rbCb->rbOp &= 0xf7;
      }
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 1) | ((0x00000002 << 4) << 3) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 1174); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlFreeRbCb:Count(%lu) in toBeReasmbldAmPduLst\n", rbCb->m.am.amUl.toBeReasmbldAmPduLst.count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   else
   {
      ...
      kwUtlEmptySduQ(&rbCb->m.tm.sduQ);

   }

   return;
}
# 2636 "../..//lterlcpdcp/kw_utl.c"
 Void kwUtlProcessSelfMsgUl
(
)
...

{
   ...
   ;;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 4) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 4) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 2654); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlProcessSelfMsgUl\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   while( (rbList->first) && (numSdus < 5) )
   {
      rbCb = (KwRbCb*) rbList->first->node;
      switch (rbCb->mode)
      {
         case 2:
            {
         ...
         case 3:
            {
               kwAmmProcessSelfMsgUl(rbCb, &numSdus);
               break;
            }
   ...
   if(((void *)0) != rbList->first)
   {

      core = 3;
      ;
      kwUtlPostSelfMsgUl(core);
      ;
   }
   else
   {
...

{
   ...
   if (1 != kwCb.kwLock)
   {
      ...
      kwCb.kwLock = 1;
         selfPstUl.srcInst = 0;
      ret = SPstTsk(&selfPstUl, kwCb.mBufUl);
      if(1 == ret)
      {
...
# 2777 "../..//lterlcpdcp/kw_utl.c"
 S16 kwUtlSendRbReEstCfm
(
KwRbCb *rbCb
)
...
{
   ;;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 4) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 4) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 2788); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlSendRbReEstCfm\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   ;;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 3) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 3) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_utl.c", 2851); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUtlRbDeletion\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if(0 == (rbCb->rbOp & 0x08) )
   {
# 2872 "../..//lterlcpdcp/kw_utl.c"
      if(0 == rbCb->rb->rbCfgStat)
      {
...
# 2932 "../..//lterlcpdcp/kw_utl.c"
   return(1);
}
# 2952 "../..//lterlcpdcp/kw_utl.c"
 Void kwUtlSetReestInProgress(KwUeCb *ueCb)
{
   U32 rbIdx;
   KwRbCb *rbCb;
   ...
   if(rbCb->rlcId.rbId != 1)
         {
            rbCb->reestInProgress = 1;
            kwUtlSndDStaRsp(rbCb, 0,
               rbCb->m.am.amDl.estHdrSz, rbCb->m.am.amDl.cntrlBo ? 1 : 0);
         }
      }
   }
   for(rbIdx = 0;rbIdx < 32;rbIdx++)
   {
      if(ueCb->drbCb[rbIdx] != 0L)
      {
         ...
         if(rbCb->mode == 3)
   {
            kwUtlSndDStaRsp(rbCb, 0, rbCb->m.am.amDl.estHdrSz, rbCb->m.am.amDl.cntrlBo ? 1 : 0);
         }
         else
   {
            kwUtlSndDStaRsp(rbCb, 0,rbCb->m.um.umDl.estHdrSz,0);
         }
      }
   }
}
