...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 121 "../..//ltemac/rg_ram.c" 2
# 1 "../..//cm/cm5.x" 1
# 122 "../..//ltemac/rg_ram.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...

{
   ...
   if (rgAllocSBuf((Data **)&ueCb, sizeof(*ueCb)) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_ram.c", 222); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Memory allocation FAILED for ue %d", tmpCrnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   for(idx1 = 0; idx1 < rarInfo->numRaRntis; idx1++)
   {
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_ram.c", 372); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgHndlRaResp(): Creation of RAR PDU for                  raRnti=%d failed \n", rarInfo->raRntiInfo[idx1].raRnti); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   if((cell = rgDBMGetCellCb(rlsRnti->cellId)) == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_ram.c", 424); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "rgHndlSchdUe(): " "No cellCb found with cellId = (%d)\n", rlsRnti->cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_ram.c", 431); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgHndlRlsUe(): No ueCb found in Rachlst" ": cellId (%d) rnti(%d) \n", rlsRnti->cellId, rlsRnti->rnti); SPrint((&rgCb.rgInit)->prntBuf); } };
