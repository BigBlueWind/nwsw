...
# 100 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 121 "../..//egtpu/eg_util.c" 2




# 1 "../..//cm/gen.x" 1
# 126 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/ssi.x" 1
# 127 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 128 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 129 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 130 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm_mblk.x" 1
# 131 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm_llist.x" 1
# 91 "../..//cm/cm_llist.x"
#define __CMLLISTX__ 
...
# 132 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm5.x" 1
# 133 "../..//egtpu/eg_util.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
static S16 egUUtilGetTrgtIe ( CmLListCp *ieList, U8 ieType, U8 occrCnt, EgUIe **egIe );
...
# 5759 "../..//egtpu/eg_util.c"
   return(0);
}
# 5778 "../..//egtpu/eg_util.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",5790); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 5800 "../..//egtpu/eg_util.c"
   if (!egMsg)
   {
      return(3);
   }
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",5854); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",5941); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 5951 "../..//egtpu/eg_util.c"
   if (!egMsg || !egIe)
   {
      return(3);
   }
...
# 5990 "../..//egtpu/eg_util.c"
static S16 egUUtilGetTrgtIe
(
   CmLListCp *ieList,
   U8 ieType,
   U8 occrCnt,
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6009); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 6019 "../..//egtpu/eg_util.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6084); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 6094 "../..//egtpu/eg_util.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6251); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 6261 "../..//egtpu/eg_util.c"
   if (!egMsg
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6358); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6494); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 6504 "../..//egtpu/eg_util.c"
   if (!ieList)
   {
      return(3);
   }
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6608); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 6618 "../..//egtpu/eg_util.c"
   if (!egIe)
   {
      return(3);
   }
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6759); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 6769 "../..//egtpu/eg_util.c"
   if (!egMsg || !occrCnt)
   {
      return(3);
   }
   ...
   if ( (retValue = egUUtilGetTrgtIe(&egMsg->u.egIeList, ieType, occrCnt, &egIe)) != 0)
   {
      {};
...

{
   ...
   *ieOccrCnt = 0;
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_util.c",6839); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
