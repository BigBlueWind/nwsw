...
#endif
               case EVTKWSELFMSGREEST:
                  {
                     kwUtlProcessSelfMsgReest();
                     break;
                  }
               case EVTKWSELFMSGDELETE:
                  {
                     kwUtlProcessSelfMsgDelete();
                     break;
                  }
               case EVTKWSELFMSGPJDELRB:
                  {
                     kwUtlProcessSelfMsgPjDelRb();
                     break;
                  }
            }
            break;
