...
/* sm_ex_ms_c_001.main_126: LTE eNodeB and LTE convergence layer release */
#ifdef UEH /* PWAV Chnaged the VE to UEH */
      case ENTUEH:
         smUehActvTsk(post, mBuf);
         break;
      case ENTUDH:
         smUdhActvTsk(post, mBuf);
         break;
#endif /* UEH */
...
#endif /* YS */
         /* ALL Configuration Messages from BSM to SM are to be handled here*/
#ifdef PWAV
      case ENT_BSM:
        bsmSmActvTsk(post, mBuf);
	  break;
      case ENT_LTH:
        lthSmActvTsk(post, mBuf);
	  break;
      case ENT_PMH:
        pmhSmActvTsk(post, mBuf);
        break;
#endif
