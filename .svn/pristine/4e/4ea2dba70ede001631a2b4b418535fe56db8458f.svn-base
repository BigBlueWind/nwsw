...
/* mt028.201: addition: multiple procs support related changes */
 ...
 #ifdef PWAV
  #define SS_MAX_PROCS                    10 /* Manu:17July: On this date, only 4 are needed. */
 #else
...
#ifdef PWAV
  #define SS_MAX_INST                  4 /* Manu:17July12: Performance Improvement: 2 are adequate (MAC).  */
#else
...
#define SS_MAX_STSKS                    30
  ...
  #ifdef PWAV
    #define SS_MAX_DRVRTSKS                 10 /* Manu: 17July12: SPstTsk() runs a loop over these. */
  #else
...
#ifndef SS_FAP
#define MT_BKT_0_NUMBLKS        10500 /* Modified from 3500 to 10500 */
#else
...
/*mt004.301-changed for FAP*/
#ifndef SS_FAP
#define MT_BKT_1_DSIZE          4096  /* Modified from 256 to 4096 */
