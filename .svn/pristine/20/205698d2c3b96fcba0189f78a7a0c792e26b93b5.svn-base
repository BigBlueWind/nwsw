...

#define PJU_SEL_LC         0
#define PJU_SEL_TC     1     /*!< Macro for Tight Coupling */
#define PJU_SEL_LWLC   2     /*!< Macro for Light Weight Loose Coupling */
...
#define EVTCTFDATREQ      0x49
/**Data Response event */
#define EVTCTFDATRSP      0x50
#endif
/***************SEC_CHANGE_END*****************/
/***************SEC_CHANGE_START*****************/
#ifdef CTF_AS_SEC_ENB
...
/* MAX values */
#define PJU_MAX_SDU_CFM    25     /*!< Maximum SDUs that can be 
