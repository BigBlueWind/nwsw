...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 121 "../..//ltemac/rg_uhm.c" 2
# 1 "../..//cm/cm5.x" 1
# 122 "../..//ltemac/rg_uhm.c" 2
# 1 "../..//cm/cm_lte.x" 1
# 91 "../..//cm/cm_lte.x"
#define __CM_LTE_X__ 
