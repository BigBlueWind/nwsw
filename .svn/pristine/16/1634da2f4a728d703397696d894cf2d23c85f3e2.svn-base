...
# 95 "../..//enbapp/lterrm/rm_ccm_ue.c" 2
# 114 "../..//enbapp/lterrm/rm_ccm_ue.c"
 S16 rmCcmProcUeStaInd(RrmWrUeStaIndInfo *ueStaIndPtr)
{
   RmCellCb *cellCbPtr;
   RmUeCb *ueCbPtr;


   cellCbPtr = rmUtlGetCellCb(ueStaIndPtr->cellId);
   if(0L == cellCbPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 124); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeStaInd: Failed to get CellCb" "(%u)", ueStaIndPtr->cellId); SPrint((&(rmCb.init))->prntBuf); } }; };

      return(1);
   }


   ueCbPtr = rmUtlGetUeCb(cellCbPtr, ueStaIndPtr->crnti);
   if(0L == ueCbPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 133); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeStaInd: Failed to get ueCb" "(%u)", ueStaIndPtr->crnti); SPrint((&(rmCb.init))->prntBuf); } }; };

      return(1);
   }
   if(0 != rmRcmUeStaUpd(ueCbPtr, ueStaIndPtr))
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 139); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeStaInd: Failed in RCM" "(%u)", ueStaIndPtr->crnti); SPrint((&(rmCb.init))->prntBuf); } }; };

      return(1);
   }
   return(0);
}
# 170 "../..//enbapp/lterrm/rm_ccm_ue.c"
 S16 rmCcmProcUeRecfg(RrmWrUeRecfgReqInfo *ueRecfgReqPtr)
{
   RrmWrUeRecfgRespInfo *ueRecfgRespPtr;
   RmCellCb *cellCbPtr;
   RmUeCb *ueCbPtr;
   S16 retVal = 0;


   { if (SGetSBuf(rmCb.init.region, rmCb.init.pool, (Data **)(&(ueRecfgRespPtr)), (sizeof(RrmWrUeRecfgRespInfo))) == 0) { { cmMemset((U8 *)((*(&(ueRecfgRespPtr)))), 0, ((sizeof(RrmWrUeRecfgRespInfo)))); }; } else { (*(&(ueRecfgRespPtr))) = 0L; } };
   if (0L == ueRecfgRespPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 182); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, " Failed to allocate memory for" "UE Re-config Response "); SPrint((&(rmCb.init))->prntBuf); } }; };

      return(1);
   }

   ueRecfgRespPtr->transId = ueRecfgReqPtr->transId;
   ueRecfgRespPtr->cellId = ueRecfgReqPtr->cellId;
   ueRecfgRespPtr->crnti = ueRecfgReqPtr->crnti;
   ueRecfgRespPtr->recfgType = 0;
   ueRecfgRespPtr->statusInfo.cause = RRM_WR_CAUSE_NOT_APP;
   ueRecfgRespPtr->statusInfo.status = RRM_WR_CFG_SUCCESS;

   cellCbPtr = rmUtlGetCellCb(ueRecfgReqPtr->cellId);
   if(0L == cellCbPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 197); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeRecfg: Failed to get CellCb" "(%u)", ueRecfgReqPtr->cellId); SPrint((&(rmCb.init))->prntBuf); } }; };

      ueRecfgRespPtr->statusInfo.cause = RRM_WR_CAUSE_CELLID_UNKNOWN;
      retVal = 1;
   }

   ueCbPtr = rmUtlGetUeCb(cellCbPtr, ueRecfgReqPtr->crnti);
   if(0L == ueCbPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 206); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeRecfg: Failed to get ueCb" "(%u)", ueRecfgReqPtr->crnti); SPrint((&(rmCb.init))->prntBuf); } }; };

      ueRecfgRespPtr->statusInfo.cause = RRM_WR_CAUSE_UEID_UNKNOWN;
      retVal = 1;
   }

   if (RRM_WR_CAUSE_NOT_APP == ueRecfgRespPtr->statusInfo.cause)
   {
      if (ueRecfgReqPtr->recfgType & 0x04)
      {
         ueCbPtr->ueId = ueRecfgReqPtr->newCrnti;
      }
      if(ueRecfgReqPtr->recfgType & 0x02)
      {
         retVal = rmRbcUeRecfg(ueCbPtr,
                               &ueRecfgReqPtr->ueERabCfg,
                               ueRecfgRespPtr);
         ueRecfgRespPtr->recfgType |= 0x02;
      }
      ...
      rmRcmUeRecfg(ueCbPtr, ueRecfgReqPtr,
                   &ueRecfgRespPtr->recfgType,
                   &ueRecfgRespPtr->ueRadioResCfg);

   }
   else
   {
      ueRecfgRespPtr->statusInfo.status = RRM_WR_CFG_FAILURE;
   }

   RmWrUeRecfgResp(ueRecfgRespPtr);
   return(retVal);
}

 S16 rmCcmSendUeRelResp
(
   CmLteCellId cellId,
   U16 ueId,
   RmWrStatusInfo *statusInfo,
...
{
   RrmWrUeRelRespInfo *ueRelRespPtr;


   { if (SGetSBuf(rmCb.init.region, rmCb.init.pool, (Data **)(&(ueRelRespPtr)), (sizeof(RrmWrUeRelRespInfo))) == 0) { { cmMemset((U8 *)((*(&(ueRelRespPtr)))), 0, ((sizeof(RrmWrUeRelRespInfo)))); }; } else { (*(&(ueRelRespPtr))) = 0L; } };
   if (0L == ueRelRespPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 259); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, " Failed to allocate memory for" "UE Release Response "); SPrint((&(rmCb.init))->prntBuf); } }; };

      return(1);
   }


   ueRelRespPtr->transId = transId;
   ueRelRespPtr->crnti = ueId;
   ueRelRespPtr->cellId = cellId;
   ueRelRespPtr->statusInfo = *statusInfo;


   RmWrUeRelResp(ueRelRespPtr);

   return(0);
}
# 295 "../..//enbapp/lterrm/rm_ccm_ue.c"
 S16 rmCcmProcUeRel(RrmWrUeRelReqInfo *ueRelReqPtr)
{
   RmCellCb *cellCbPtr;
   RmUeCb *ueCbPtr;
   RmWrStatusInfo relStatusInfo;

   relStatusInfo.cause = RRM_WR_CAUSE_NOT_APP;


   cellCbPtr = rmUtlGetCellCb(ueRelReqPtr->cellId);
   if(0L == cellCbPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 308); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeRel: Failed to get CellCb" "(%u)", ueRelReqPtr->cellId); SPrint((&(rmCb.init))->prntBuf); } }; };

      relStatusInfo.cause = RRM_WR_CAUSE_CELLID_UNKNOWN;
      relStatusInfo.status = RRM_WR_CFG_FAILURE;
      rmCcmSendUeRelResp(ueRelReqPtr->cellId, ueRelReqPtr->crnti,
                         &relStatusInfo, ueRelReqPtr->transId);
      return(1);
   }


   ueCbPtr = rmUtlGetUeCb(cellCbPtr, ueRelReqPtr->crnti);
   if(0L == ueCbPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 321); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeRel: Failed to get ueCb" "(%u)", ueRelReqPtr->crnti); SPrint((&(rmCb.init))->prntBuf); } }; };

      relStatusInfo.cause = RRM_WR_CAUSE_UEID_UNKNOWN;
      relStatusInfo.status = RRM_WR_CFG_FAILURE;
      rmCcmSendUeRelResp(ueRelReqPtr->cellId, ueRelReqPtr->crnti,
                         &relStatusInfo, ueRelReqPtr->transId);
      return(1);
   ...
   rmCacUeRel(ueCbPtr, ueRelReqPtr->transId);

   return(0);
}
# 351 "../..//enbapp/lterrm/rm_ccm_ue.c"
 S16 rmCcmProcUeAdmitReq(RrmWrUeAdmitReqInfo *ueAdmitReqPtr)
{
   RmCellCb tempCellCb;
   RmWrStatusInfo statusInfo;
   RmCellCb *cellCbPtr = 0L;


   cellCbPtr = rmUtlGetCellCb(ueAdmitReqPtr->cellId);
   if(0L == cellCbPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 362); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmProcUeAdmitReq: Failed to get CellCb" "(%u)", ueAdmitReqPtr->cellId); SPrint((&(rmCb.init))->prntBuf); } }; };

      tempCellCb.cellId = ueAdmitReqPtr->cellId;
      statusInfo.status = RRM_WR_CFG_FAILURE;
      statusInfo.cause = RRM_WR_CAUSE_CELLID_UNKNOWN;
      rmCcmSendUeAdmitResp(&tempCellCb,ueAdmitReqPtr->crnti,
                           &statusInfo,
                           ueAdmitReqPtr->transId);
      return(1);
   }

   if(0 != rmCacUeAdm(cellCbPtr, ueAdmitReqPtr->crnti,
                    ueAdmitReqPtr->transId,
                        ueAdmitReqPtr->conEstabCause))
   {
...
# 406 "../..//enbapp/lterrm/rm_ccm_ue.c"
 S16 rmCcmSendUeAdmitResp
(
   RmCellCb *cellCbPtr,
   U16 ueId,
   RmWrStatusInfo *statusInfo,
...
{
   RrmWrUeAdmitRespInfo *ueAdmitRespPtr;
   RmUeCb *ueCbPtr;


   { if (SGetSBuf(rmCb.init.region, rmCb.init.pool, (Data **)(&(ueAdmitRespPtr)), (sizeof(RrmWrUeAdmitRespInfo))) == 0) { { cmMemset((U8 *)((*(&(ueAdmitRespPtr)))), 0, ((sizeof(RrmWrUeAdmitRespInfo)))); }; } else { (*(&(ueAdmitRespPtr))) = 0L; } };
   if (0L == ueAdmitRespPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 422); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, " Failed to allocate memory for" "UE Admit Response "); SPrint((&(rmCb.init))->prntBuf); } }; };

      return(1);
   }
   ueAdmitRespPtr->cellId = cellCbPtr->cellId;
   ueAdmitRespPtr->crnti = ueId;
   ueAdmitRespPtr->transId = transId;
   ueAdmitRespPtr->statusInfo = *statusInfo;

   if(ueAdmitRespPtr->statusInfo.status == RRM_WR_CFG_SUCCESS)
   {
      ueCbPtr = rmUtlGetUeCb(cellCbPtr, ueId);
      if(0L == ueCbPtr)
      {
         { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 436); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "rmCcmSendUeAdmitResp: Failed to get ueCb" "(%u)", ueId); SPrint((&(rmCb.init))->prntBuf); } }; };
      ...
      rmRcmUeCfg(ueCbPtr, &ueAdmitRespPtr->ueRadioResCfg);
   ...
   RmWrUeAdmitResp(ueAdmitRespPtr);

   return(0);
}
# 479 "../..//enbapp/lterrm/rm_ccm_ue.c"
 S16 rmCcmSendUeRel
(
   RmUeCb *ueCbPtr,
   RrmWrCause cause
...
{
   RrmWrUeRelIndInfo *ueRelIndPtr;


   { if (SGetSBuf(rmCb.init.region, rmCb.init.pool, (Data **)(&(ueRelIndPtr)), (sizeof(RrmWrUeRelIndInfo))) == 0) { { cmMemset((U8 *)((*(&(ueRelIndPtr)))), 0, ((sizeof(RrmWrUeRelIndInfo)))); }; } else { (*(&(ueRelIndPtr))) = 0L; } };
   if (0L == ueRelIndPtr)
   {
      { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 492); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, " Failed to allocate memory for" "UE Release Indication "); SPrint((&(rmCb.init))->prntBuf); } }; };

      return(1);
   }

   ueRelIndPtr->cellId = ueCbPtr->cellCbPtr->cellId;
   ueRelIndPtr->crnti = ueCbPtr->ueId;
   ueRelIndPtr->relCause = cause;


   RmWrUeRelInd(ueRelIndPtr);

   return(0);
}
# 522 "../..//enbapp/lterrm/rm_ccm_ue.c"
 S16 rmCcmSendUeRecfg
(
   RrmWrUeRecfgIndInfo *ueRecfgInfo
)
{
  if(0 != RmWrUeRecfgInd(ueRecfgInfo))
  {
     { { if ((&(rmCb.init))->dbgMask & (1)) { sprintf((&(rmCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", (Txt *)"ENB RRM", (&(rmCb.init))->ent, (&(rmCb.init))->inst, "../..//enbapp/lterrm/rm_ccm_ue.c", 529); SPrint((&(rmCb.init))->prntBuf); sprintf (rmCb.init.prntBuf, "UE Reconfiguration is failed at FSM "); SPrint((&(rmCb.init))->prntBuf); } }; };
     return(1);
  }
  return(0);
}
