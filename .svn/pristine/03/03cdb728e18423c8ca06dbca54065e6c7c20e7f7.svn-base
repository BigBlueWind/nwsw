...
#SSI Files
SSOPTS=-DSS
RELFLAG=-DRELS_MS_0_1_6
CMFLAGS=-DSS_MT_TMR -DSS_FLOAT -ULTE_TDD -DMSPD -DLTEMAC_MIMO -DMSPD_MEMCPY -DLTEPHY_MSPD -DMSPD_DLHARQ_ENABLE -DRB_CHANNEL_SVSR -UCTF_VER3 -URGR_SI_SCH -DRGR_CQI_REPT -ULTE_L2_MEAS -DMAC_SCH_STATS -DPHY_ERROR_LOGING -USS_DIAG -DTENB_AS_SECURITY -DMS_MBUF_CORRUPTION
	#<---Insert cm specific defines here
SMFLAGS=-UHI -USB -UEG -UVE -DKW -DKW_PDCP -DPJ -USZ -DYS -DRG -DNH
MTFLAGS=-DBIT_64 -DSS_MT_TMR -DAPI_MAIN -DxSS_TICKS_SEC=10 #<---Insert mt specific defines here
YSFLAGS=-DTF -DYS -DYS_LTE_PAL -DLTE_PAL_ENB -UYS_PERF_MEAS -DLCCTF -DYS_MSPD\
	...
	-DLCYSMILYS -DLCLYS \
	-UYS_JMP_PHY_RUN_STE -DYS_MIB_WARND -DYS_PHY_STOP_AUTO -DYS_ALLOC_ON_NEED -ULTE_L2_MEAS\
	-UYS_MS_NO_TA -DLWLCYSUITFU -DNOFILESYS -DYSMS_RLF_DETCT -DDLHQ_RTT_OPT -DLOWLATENCY #L2Split
KWFLAGS= -DKW_PDCP -UNH -USM -DPTPJLIB -DLTE_HENB -DKW_BG_UL_PROC -DKW_BG_DL_PROC -DMSPD_RLC_MULTICORE -ULTE_L2_MEAS -DTENB_AS_SECURITY
RGFLAGS=-DTFU_VER_2 -UTFU_TDD -USM -ULTE_TDD -DTF -DSS_FLOAT -DSS_MT_TMR -DRGR_RRM_TICK -DLTEMAC_RGU_PAD -DSCH_STATS -ULTE_L2_MEAS -DLTEMAC_DLUE_TMGOPTMZ
C4GMXENBE2EOPTS= -DMX_ARM_ENABLED -DLOWERARM -DSCHEDULER -DUL_CEVA -DUSECEVA -DCM_PASN_DBG\
                 -DUSEFEC -DLTE -DLIST_BASED -D_MX_DEBUG -D_APP_ASSERT_HANDLER\
		  $(YSFLAGS) $(CMFLAGS) $(SMFLAGS) $(MTFLAGS) $(KWFLAGS) $(RELFLAG)\
                  $(RGFLAGS) -USS_4GMX_SSI_PORTING -USSI_INCORRECT_FREE -USS_HISTOGRAM_SUPPORT -URUN_ICPU_ONLY $(MTOPTS) -USS_CAVIUM \
		  -DCMFILE_REORG_1 -DNO_ERRCLS \
		  -DCMFIlE_REORG_2 -DSSINT2 -DCMKV2 -DSS_PERF -D SS_WL_REGION=1\
                  -DNOERRCHK -UCCPU_DEBUG_TRACE -DCCPU_MEAS_CPU -UDEBUGP -DTFU_UPGRADE -UYS_MS_NO_ULCQI \
	          -ULTE_START_UL_DL_DATA -DLCYSUICTF -DCCPU_MLOG -UMSPD_MLOG -DMSPD_MLOG_NEW -DRG_DL_CQI\
	          -UYS_ALL_PERF -URGR_SI_SCH -DRGR_V1 -DLTERRC_REL9 -DNHU_VER1 -DCL_MAC_LWLC -DMSPD_DBG_ENABLE -DRGR_V2 \
	          -UHARQ_STATISTICS -DRGR_CQI_REPT -DPWAV -DPWAV_HC -UPWAV_LARM_LOGS -ULTEMAC_DRX #L2Split
...
RGOPTS=-DRG -DRG_PHASE2_SCHED $(RGUOPTS) $(CRGOPTS) $(LRGOPTS) $(RGROPTS) $(TFUOPTS) -URG_DEBUG -UTTI_PROC -UPROC_DL -USCH_TTI_PROC -UTOM -UPAL_MAC_PROC -UUL_PROC_MAC -DRG_DL_DELTA_CHANGE -DRG_CMNCH_SCHDELTA_CHANGE -DRG_ULSCHED_AT_CRC -DTFU_RECPREQ_DELTA_CHANGE -DTFU_DL_DELTA_CHANGE -DTFU_UL_DELTA_CHANGE -DTFU_DLHQFBK_DELTA_CHANGE -UBUG_FIX -DLWLCRGLITFU -DLCSCH  -DLCRG -ULTE_L2_MEAS #-DLCRGLITFU L2Split
...
C4GMXENV=-DSUNOS -DSS -DSS_MT -DANSI -D_GNU_SOURCE -DSS_LINUX -D_REENTRANT -D__EXTENSIONS__ \
    -DDEBUGNOEXIT -DRB_DEBUG -DSS_4GMX_LCORE -DSS_DRVR_SUPPORT -URB_SINGLE_CORE -DSS_TTI_TMR  #Undefining RB_SINGLE_CORE for L2Split
...
C4GMXIOPTS =  \
             ...
             -I$(L_CORE_DIR)/T4KDev/SYSCORE/CEVA/DRIVERS \
             -I$(L_CORE_DIR)/T4KDev/SYSCORE/CEVA/REXSERV \
...
YSSRCS= \
    ...
    $(YS_DIR)/ys_ms_dl.c   \
    $(YS_DIR)/ys_ms_dft.c     \
    $(YS_DIR)/ys_ms_ex_ms.c   \
    $(YS_DIR)/ys_ms_siml.c   \
    $(YS_DIR)/ys_ms_spacc.c   \
    $(YS_DIR)/ys_ms_id.c
