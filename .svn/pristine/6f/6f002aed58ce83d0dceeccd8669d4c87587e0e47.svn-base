...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//lteclpal/ys_utl.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//lteclpal/ys_utl.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 120 "../..//lteclpal/ys_utl.c" 2
# 1 "../..//cm/cm5.x" 1
# 121 "../..//lteclpal/ys_utl.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 132 "../..//lteclpal/ys_utl.c" 2
# 152 "../..//lteclpal/ys_utl.c"
 Data * ysUtlMalloc
(
Size size
)
...
# 285 "../..//lteclpal/ys_utl.c"
   if(0 != cmAllocEvnt(memSize, 1500, &sMem, memPtr))
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 288); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 288); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Returning RFAILED form ysUtlAllocEventMem because                     cmAllocEvnt returned RFAILED\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...

{
   ...
   sMem.region = ysCb.ysInit.region;
   sMem.pool = ysCb.ysInit.pool;
# 325 "../..//lteclpal/ys_utl.c"
   if(0 != cmAllocEvnt(memSize, 1500, &sMem, memPtr))
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 328); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 328); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Returning RFAILED form ysUtlAllocEventMem because                     cmAllocEvnt returned RFAILED\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...
{
   ;
# 372 "../..//lteclpal/ys_utl.c"
   cmFreeMem(memPtr);

   return(0);
}
# 390 "../..//lteclpal/ys_utl.c"
...

{
   ...
   { if (ysCb.ysInit.dbgMask >= (3)) { { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 552); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Param : "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (3)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 552); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "ysUtlDelCellCfg(): cellId = %d \n", cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
   ...
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 561); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_utl.c", 561); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "Cell Configuration doesnt exist for cell (%d).                      ysUtlDelCellCfg Failed \n", cellId); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
...
{
   g_sockfd = socket(2, SOCK_DGRAM, 0);
   ...
   g_serv_addr.sin_family = 2;
   g_serv_addr.sin_port = htons(9999);
   g_serv_addr.sin_addr.s_addr = inet_addr(WIRESHARK_SRVR_IP_ADDR);
                 ...
                 U8 isPredefinedData, U8 retx, U8 crcStatus)
{
   ...
   memcpy(statBuffer+bufOffset, "mac-lte",
         strlen("mac-lte"));
   bufOffset += strlen("mac-lte");
   ...
   statBuffer[bufOffset++] = 0x02;
   tmp16 = htons(rnti);
   memcpy(statBuffer+bufOffset, &tmp16, 2);
   bufOffset+= 2;


   statBuffer[bufOffset++] = 0x03;
   tmp16 = htons(ueid);
   memcpy(statBuffer+bufOffset, &tmp16, 2);
   bufOffset+= 2;


   statBuffer[bufOffset++] = 0x04;
   tmp16 = htons(subframe);
   memcpy(statBuffer+bufOffset, &tmp16, 2);
   bufOffset+= 2;

   statBuffer[bufOffset++] = 0x07;
   statBuffer[bufOffset++] = crcStatus;



    if (!isPredefinedData) {
        statBuffer[bufOffset++] = 0x05;
        statBuffer[bufOffset++] = isPredefinedData;
    }

    if (retx != 0) {
        statBuffer[bufOffset++] = 0x06;
        statBuffer[bufOffset++] = retx;
    }


    statBuffer[bufOffset++] = 0x01;
