...
#endif
      SPutSBuf(pst->region, pst->pool, (Data *)ulCqiInd, sizeof(TfuUlCqiIndInfo));
      RETVALUE(RFAILED);
   }
   if (pst->selector == TFU_SEL_LC) {
...
#endif
      SPutSBuf(pst->region, pst->pool, (Data *)dlCqiInd, sizeof(TfuDlCqiIndInfo));
      RETVALUE(RFAILED);
   }
   if (pst->selector == TFU_SEL_LC) {
...
#endif
      SPutSBuf(pst->region, pst->pool, (Data *)rawCqiInd, sizeof(TfuRawCqiIndInfo));
      RETVALUE(RFAILED);
   }
...
#endif
      SPutSBuf(pst->region, pst->pool, (Data *)srsInd, sizeof(TfuSrsIndInfo));
      RETVALUE(RFAILED);
   }
...
#endif
      SPutSBuf(pst->region, pst->pool, (Data *)crcIndInfo, sizeof(TfuCrcIndInfo));
      RETVALUE(RFAILED);
   }
   if (pst->selector == TFU_SEL_LC) {
...
#endif
      SPutSBuf(pst->region, pst->pool, (Data *)timingAdvInd, sizeof(TfuTimingAdvIndInfo));
      RETVALUE(RFAILED);
   }
   if (pst->selector == TFU_SEL_LC) {
...
/*tfu_c_001.main_5 - Added support for SPS*/
#ifdef LTEMAC_SPS
/***********************************************************
*
*     Func : cmPkTfuDciformat1aRelPdcch
*
*
*     Desc : This structure contains Release PDCCH information for SPS UE
  * of DCI format 1A. 
  * @details Release PDCCH information contained in DCI format 1A
  * @sa TfuDciFormat1aRelPdcchInfo
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkTfuDciformat1aRelPdcch
(
Tfudciformat1aRelPdcch *param,
Buffer                 *mBuf
)
#else
PUBLIC S16 cmPkTfuDciformat1aRelPdcch(param, mBuf)
Tfudciformat1aRelPdcch *param;
Buffer                 *mBuf;
#endif
{

   TRC3(cmPkTfuDciformat1aRelPdcch)
   ...
   CMCHKPK(SPkU8, param->rv, mBuf);
   CMCHKPK(SPkU8, param->mcs, mBuf);
   CMCHKPK(SPkU32, param->alloc, mBuf);
   RETVALUE(ROK);
}
...
/***********************************************************
*
*     Func : cmUnpkTfuDciformat1aRelPdcch
*
*
*     Desc : This structure contains release pdcch information 
  * @details Release PDCCH information contained in DCI format 1A
  * @sa Tfudciformat1aRelPdcch
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkTfuDciformat1aRelPdcch
(
Tfudciformat1aRelPdcch *param,
Buffer                 *mBuf
)
#else
PUBLIC S16 cmUnpkTfuDciformat1aRelPdcch(param, mBuf)
Tfudciformat1aRelPdcch *param;
Buffer                 *mBuf;
#endif
{

   TRC3(cmUnpkTfuDciformat1aRelPdcch)

   CMCHKUNPK(SUnpkU32, &param->alloc, mBuf);
   CMCHKUNPK(SUnpkU8, &param->mcs, mBuf);
   CMCHKUNPK(SUnpkU8, &param->rv, mBuf);
...
#else
      switch(param->dciInfo) {
         case TFU_DCIFMT1A_PDSCHINFO:
            CMCHKPK(cmPkTfudciformat1aPdsch, &param->t.pdschInfo, mBuf);
            break;
         case TFU_DCIFMT1A_PDCCHORDER:
            CMCHKPK(cmPkTfuPdcchOrderInfo, &param->t.pdcchOrder, mBuf);
            break;
          case TFU_DCIFMT1A_REL:
            CMCHKPK(cmPkTfuDciformat1aRelPdcch, &param->t.relPdcchInfo, mBuf);
            break;
         default :
            RETVALUE(RFAILED);
      }
   CMCHKPK(SPkU8, param->dciInfo, mBuf);
...
#else
   CMCHKUNPK(SUnpkU8, &param->dciInfo, mBuf);
      switch(param->dciInfo) {
         case TFU_DCIFMT1A_PDCCHORDER:
            CMCHKUNPK(cmUnpkTfuPdcchOrderInfo, &param->t.pdcchOrder, mBuf);
            break;
         case TFU_DCIFMT1A_PDSCHINFO:
            ...
            break;
          case TFU_DCIFMT1A_REL:
            CMCHKUNPK(cmUnpkTfuDciformat1aRelPdcch, &param->t.relPdcchInfo, mBuf);
            break;
         default :
            RETVALUE(RFAILED);
      }
...
#ifndef LTEMAC_MIMO
   for (i=TFU_MAX_DL_SUBBAND-1; i >= 0; i--) {
      CMCHKPK(cmPkTfuSubbandMode22, &param->subbandArr[i], mBuf);
   }
...
#ifndef LTEMAC_MIMO
   for (i=0; i<TFU_MAX_DL_SUBBAND; i++) {
      CMCHKUNPK(cmUnpkTfuSubbandMode22, &param->subbandArr[i], mBuf);
   }
...
*
*
*     Desc : This structure contains a single MAC TB.
...
/* tfu_c_001.main_7. Added changes of TFU_UPGRADE */
#if (defined(TFU_UPGRADE ) && defined(LTEMAC_MIMO))
...
#else
   /* tfu_c_001.main_2: Un-Packing should consider nmbOfTBs.*/
...
#ifdef ANSI
PUBLIC S16 cmPkTfuSubbandMode22
(
TfuSubbandMode22 *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmPkTfuSubbandMode22(param, mBuf)
TfuSubbandMode22 *param;
Buffer *mBuf;
#endif
{

   TRC3(cmPkTfuSubbandMode22)
...
#ifdef ANSI
PUBLIC S16 cmUnpkTfuSubbandMode22
(
TfuSubbandMode22 *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmUnpkTfuSubbandMode22(param, mBuf)
TfuSubbandMode22 *param;
Buffer *mBuf;
#endif
{

   TRC3(cmUnpkTfuSubbandMode22)
