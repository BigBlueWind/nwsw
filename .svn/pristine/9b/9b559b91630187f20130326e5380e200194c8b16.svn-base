...
#if PWAV_MEM2
   /* tablePtr, name, maxElem */
   pmInitCircularList(&g_blockBufTable,  "block", 500);
   pmInitCircularList(&g_msgBufTable,    "msg",   5000);
   pmInitCircularList(&g_staticBufTable, "sbuf",  1000);
#endif
...
#ifndef PWAV /* MANU: Let us not create this thread and see */
   ret = ssdInitLog();
   if (ret != ROK)
   {
       /*ss012.301 : Fix log related issue to suite MT and NS implementations*/
