 ...
 * @file
 * 
 * @brief Programming data table for AD9361 Revision 2 when running band 7
 * 
 ...
 * @brief Programming data table for AD9361 Revision 2 when running band 7
 */
ADRADPROFILE Ad261Rev2Lte10Mhz_nmm[] = {
//************************************************************
...
{SPIWR,0x002,0x1E},// Setup Tx Digital Filters/ Channels
...
{SPIWR,0x007,0x00},// PPORT TX Delay (adjusts setup/hold FBCLK->Data)
//************************************************************
// Setup AuxDAC
//************************************************************
...
{WCALDONE,RXCP,1000},// Wait for CP cal to complete, Max RXCP Cal time: 460.800 (us)(Done when 0x244[7]==1)
{SPIWR,0x27D,0x04},// Start TX CP cal
{WCALDONE,TXCP,1000},// Wait for CP cal to complete, Max TXCP Cal time: 460.800 (us)(Done when 0x284[7]==1)
//************************************************************
// FDD RX/TX Synth Frequency: 2655.000000, 2655.000000 MHz
//************************************************************
//************************************************************
// Setup Synthesizer
//************************************************************
{SPIWR,0x23A,0x4A},// Set VCO Output level[3:0]
{SPIWR,0x239,0xC0},// Set Init ALC Value[3:0] and VCO Varactor[3:0]
{SPIWR,0x242,0x0D},// Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
{SPIWR,0x238,0x70},// Set VCO Cal Offset[3:0]
{SPIWR,0x245,0x00},// Set VCO Cal Ref Tcf[2:0]
{SPIWR,0x251,0x09},// Set VCO Varactor Reference[3:0]
{SPIWR,0x250,0x70},// Set VCO Varactor Ref Tcf[2:0] and VCO Varactor Ref[3:0]
{SPIWR,0x240,0x0D},// Set Rx Synth Loop filter R3
{SPIWR,0x23F,0xC5},// Set Rx Synth Loop filter R1 and C3
{SPIWR,0x23E,0xF6},// Set Rx Synth Loop filter C2 and C1
{SPIWR,0x23B,0x9a},// Set Rx Synth Loop filter Icp
//************************************************************
// Setup Synthesizer
//************************************************************
{SPIWR,0x27A,0x4A},// Set VCO Output level[3:0]
{SPIWR,0x279,0xC0},// Set Init ALC Value[3:0] and VCO Varactor[3:0]
{SPIWR,0x282,0x0D},// Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
{SPIWR,0x278,0x70},// Set VCO Cal Offset[3:0]
{SPIWR,0x285,0x00},// Set VCO Cal Ref Tcf[2:0]
{SPIWR,0x291,0x09},// Set VCO Varactor Reference[3:0]
{SPIWR,0x290,0x70},// Set VCO Varactor Ref Tcf[2:0] and VCO Varactor Ref[3:0]
{SPIWR,0x280,0x0D},// Set Tx Synth Loop filter R3
{SPIWR,0x27F,0xC5},// Set Tx Synth Loop filter R1 and C3
{SPIWR,0x27E,0xF6},// Set Tx Synth Loop filter C2 and C1
{SPIWR,0x27B,0x98},// Set Tx Synth Loop filter Icp
{SPIWR,0x233,0xF5},// Write Rx Synth Fractional Freq Word[7:0]
{SPIWR,0x234,0xFF},// Write Rx Synth Fractional Freq Word[15:8]
{SPIWR,0x235,0x5F},// Write Rx Synth Fractional Freq Word[22:16]
{SPIWR,0x232,0x00},// Write Rx Synth Integer Freq Word[10:8]
{SPIWR,0x231,0x84},// Write Rx Synth Integer Freq Word[7:0]
{SPIWR,0x005,0x11},// Set LO divider setting
{SPIWR,0x273,0xF5},// Write Tx Synth Fractional Freq Word[7:0]
{SPIWR,0x274,0xFF},// Write Tx Synth Fractional Freq Word[15:8]
{SPIWR,0x275,0x5F},// Write Tx Synth Fractional Freq Word[22:16]
{SPIWR,0x272,0x00},// Write Tx Synth Integer Freq Word[10:8]
{SPIWR,0x271,0x7E},// Write Tx Synth Integer Freq Word[7:0]
{SPIWR,0x005,0x11},// Set LO divider setting
...
{SPIWR,0x10C,0x18},// Rx2 Full/LMT Gain Index
...
{SPIWR,0x1F8,0x10},// Rx BBF Tune Divider[7:0]
...
//************************************************************
// TX1:
{SPIWR,0x073,0x28}, // LSB Original value: 0x28
{SPIWR,0x074,0x00}, // MSB Original value: 0x00
// TX2:
{SPIWR,0x075,0x28}, // LSB Original value: 0x28
{SPIWR,0x076,0x00}, // MSB Original value: 0x00
//************************************************************
...
{SPIWR,0x15C,0x69},// Power Measurement Duration
#ifdef SINGLE_ANTENNA
