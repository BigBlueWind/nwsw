...
#endif
{
   ...
   if((subAction != SAUSTA) && (subAction != SADBG) && (subAction != SATRC) && (subAction != SALOG))
   {
#if (ERRCLASS & ERRCLS_INT_PAR)
...
#ifdef PWAV
            SBDBGP(DBGMASK_MI, (sbGlobalCb.sbInit.prntBuf,
            "sbCntrlGen: DBG-Mask Value: %02x",sbGlobalCb.sbInit.dbgMask));
#endif
         }
#endif /* DEBUGP */
         break;
...
#ifdef PWAV
            SBDBGP(DBGMASK_MI, (sbGlobalCb.sbInit.prntBuf,
            "sbCntrlGen: DBG-Mask Value: %02x reset with ~%02x",sbGlobalCb.sbInit.dbgMask, cntrl->t.cntrl.dbgMask));
#endif
           sbGlobalCb.sbInit.dbgMask &= ~(cntrl->t.cntrl.dbgMask);
         }
#endif /* DEBUGP */
