...
extern "C" {
#endif
/*rg003.201: Added doxygen Comments */
/**
...
/*MS_FIX: start: Indicate UE deletion from MAC to Scheduler*/
/**
...
/*MS_FIX: end: Indicate UE deletion from MAC to Scheduler*/
...
typedef struct rgInfUlUeInfo
{
   ...
   U32                  totalUlAvailBw;   /*!< Total Uplink Bandwith available in
                                           this subframe */
}RgInfUlUeInfo;
#endif /*LTE_L2_MEAS */
/** 
...
typedef struct prbUsage
{
   ...
   U8                   prbUsage;   /*!<Prb Usage for this Qci */
}PrbUsage;
/**
...
/*MS_FIX: start:Indicate UE deletion at MAC to scheduler*/
/** 
...
/*MS_FIX: end:Indicate UE deletion at MAC to scheduler*/
/** 
