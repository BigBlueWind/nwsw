...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//ltemac/rg_sch_tom.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//ltemac/rg_sch_tom.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 119 "../..//ltemac/rg_sch_tom.c" 2
# 1 "../..//cm/cm5.x" 1
# 120 "../..//ltemac/rg_sch_tom.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 132 "../..//ltemac/rg_sch_tom.c" 2
# 142 "../..//ltemac/rg_sch_tom.c"
static S16 rgSCHTomUtlProcDlSf ( RgSchDlSf *dlSf, RgSchDlSf *ulSf, RgSchCellCb *cell, RgSchErrInfo *err);
# 161 "../..//ltemac/rg_sch_tom.c"
static S16 rgSCHTomUtlProcUlSf ( RgSchCellCb *cell, RgSchErrInfo *err);



static S16 rgSCHTomUtlFillPhich ( TfuCntrlReqInfo *cntrlInfo, RgSchDlSf *dlSf, RgSchErrInfo *err);
# 178 "../..//ltemac/rg_sch_tom.c"
static S16 rgSCHTomUtlFillDlPdcch ( TfuCntrlReqInfo *cntrlInfo, RgSchDlSf *dlSf, RgSchErrInfo *err);



static S16 rgSCHTomUtlFillUlPdcch ( TfuCntrlReqInfo *cntrlInfo, RgSchDlSf *ulSf, RgSchErrInfo *err);
...
# 198 "../..//ltemac/rg_sch_tom.c"
static S16 rgSCHTomUtlFillHqFdbkRecpReq ( TfuRecpReqInfo *recpReq, RgSchCellCb *cell, RgSchErrInfo *err);
# 436 "../..//ltemac/rg_sch_tom.c"
static S16 rgSCHTomUtlFillDatRecpReq ( TfuRecpReqInfo *recpReq, RgSchCellCb *cell, RgSchErrInfo *err);
# 538 "../..//ltemac/rg_sch_tom.c"
static Void rgSCHTomPrntDciInfo ( TfuPdcchInfo *datReq );
# 612 "../..//ltemac/rg_sch_tom.c"
static Void rgSCHTomPrntDciInfo(TfuPdcchInfo *datReq)
{
   TfuDciInfo dciInfo;
   Tfudciformat1aPdsch *pdschInfo;
...

{
   ...
   if(cell->cellId != raReqInd->cellId)
   {
      ...
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 722); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHTomRaReqInd(): No cell found with" " cellId = (%d) errorType (%d) errorCause(%d)\n", raReqInd->cellId, err.errType, err.errCause); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 737 "../..//ltemac/rg_sch_tom.c"
      ...
      {
         err.errType = (((0 + 1) + 4) + 1);
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 746); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHTomRaReqInd(): RAM processing " "failed RNTI(%d) errType(%d) errCause(%d)\n", raReqInd->rachInfoArr[raRntiCnt].raRnti, err.errType, err.errCause); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 797); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHTomUlCqiInd() Unable to get the cell with id(%d)\n", ulCqiInd->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 813 "../..//ltemac/rg_sch_tom.c"
      if((ue = rgSCHDbmGetUeCb(cell, ulCqiInfo->rnti)) == 0L)
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 817); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHTomUlCqiInd() Unable to get the ue for rnti (%d)\n", ulCqiInfo->rnti); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 872); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHTomPucchDeltaPwrInd() Unable to get the cell with id(%d)\n", pucchDeltaPwr->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for (;node; node=node->next)
   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 883); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomPucchDeltaPwrInd() Unable to get the ue for rnti (%d)\n", ueElem->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 939 "../..//ltemac/rg_sch_tom.c"
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 948); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomHarqAckInd() Unable to get" " the cell for cellId (%d)\n", harqAckInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 977 "../..//ltemac/rg_sch_tom.c"
      raCb = rgSCHDbmGetRaCb (cell, hqInfo->rnti);
      ue = rgSCHDbmGetUeCb (cell, hqInfo->rnti);
      if (ue == 0L && raCb != 0L)
      {
# 990 "../..//ltemac/rg_sch_tom.c"
         if ((rgSCHDhmHqFdbkInd (raCb, 2,
                     cell, harqAckInd->timingInfo, hqInfo, rlsHqBufs, &err)) != 0)
         {
            err.errType = ((((0 + 1) + 4) + 1) + 1);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 996); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomHarqAckInd() HARQ" " feedback processing failed errType(%d) errCause(%d).\n", err.errType, err.errCause); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


            continue;
         }
# 1014 "../..//ltemac/rg_sch_tom.c"
         continue;
      }
      ...
      else if (ue != 0L && raCb == 0L)
      {
         ...
         {
            err.errType = ((((0 + 1) + 4) + 1) + 1);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1026); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomHarqAckInd() HARQ feedback" " processing failed errType(%d) errCause(%d).\n", err.errType, err.errCause); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      else if (ue != 0L && raCb != 0L)
      {
         ...
         {
            err.errType = ((((0 + 1) + 4) + 1) + 1);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1038); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomHarqAckInd() HARQ" " feedback processing failed errType(%d) errCause(%d).\n", err.errType, err.errCause); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      else
      {
         ...
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1050); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomHarqAckInd() Unable to" " get the UE CB or RA CB for RNTI (%d) \n", hqInfo->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         err.errType = ((((0 + 1) + 4) + 1) + 1);
         continue;
# 1068 "../..//ltemac/rg_sch_tom.c"
      }
   }
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1076); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomHarqAckInd() Unable to Release" " Downlink subframe for cellId (%d))\n", harqAckInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1138); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomSrInd() Unable to get the cell" " for cellId (%d)\n", srInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for (;node; node=node->next)
   {
      ...
      if (ue == 0L)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1153); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomSrInd() Unable to get the UE" " CB for RNTI (%d) \n", srInfo->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      {
         err.errType = ((((0 + 1) + 4) + 1) + 2);
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1168); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomSrInd() Scheduler processing" " failed errType(%d) errCause(%d)\n", err.errType, err.errCause); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1222); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomDoaInd() Unable to get the" " cell for cellId (%d)\n", doaInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for (;node; node=node->next)
   {
      ...
      if (ue == 0L)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1235); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomDoaInd() Unable to get" " the UE CB for RNTI (%d) \n", doaInfo->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1287); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomDlCqiInd() Unable to get the" " cell for cellId (%d)\n", dlCqiInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for (;node; node=node->next)
   {
      ...
      if (ue == 0L)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 1300); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomDlCqiInd() Unable to get" " the UE CB for RNTI (%d) \n", dlCqiInfo->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 2261 "../..//ltemac/rg_sch_tom.c"
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2268); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomCrcInd() Unable to get the" " cell for cellId (%d)\n", crcInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      return(1);
   }
# 2285 "../..//ltemac/rg_sch_tom.c"
   ...
   for (;node; node=node->next)
   {
...

    {
       ...
       if (raCb == 0L)
       {
           { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2302); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHTomCrcInd():" "  Unable to get the UE CB for RNTI (%d) \n", crcInfo->rnti); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 2405 "../..//ltemac/rg_sch_tom.c"
   return(0);
}
# 2431 "../..//ltemac/rg_sch_tom.c"
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2454); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTimingAdvInd() Unable to get" " the cell for cellId (%d)\n", timingAdvInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for (;node; node=node->next)
   {
      ...
      if ((ue == 0L) || (ue->isReEstablishing))
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2472); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTimingAdvInd() Unable to" " get the UE CB for RNTI (%d) \n", timingAdvInfo->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2806); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTtiInd() Unable to get" " the cell for cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      err.errType = ((((0 + 1) + 4) + 1) + 7);
      err.errCause = ((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) );
      return(1);
   }
   ...
   cell->crntTime.sfn = ttiInd->timingInfo.sfn; cell->crntTime.subframe = ttiInd->timingInfo.subframe;;
         ...
         (ttiInd->timingInfo.subframe == 0))
   {
      ...
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2836); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHTomTtiInd() Unable to allocate memory for RGR TTI indication            for cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
      ...
      {
         { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2848); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "rgSCHTomTtiInd() Unable to Send RGR TTI indication to RRM            for cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 2874 "../..//ltemac/rg_sch_tom.c"
   if(cellUl->hqFdbkIdx != 0xff)
   {



      if ((cell->crntTime.subframe + ((4 - 2))) >= 10) crntFrm.sfn = (cell->crntTime.sfn + (cell->crntTime.subframe + ((4 - 2)))/10) % 1024; else crntFrm.sfn = cell->crntTime.sfn; crntFrm.subframe = (cell->crntTime.subframe + ((4 - 2))) % 10;;
      if ((ret = rgSCHUhmAppendPhich(cell, crntFrm))!= 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2883); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTtiInd() Unable to append" " PHICH cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if(cellUl->reTxIdx != 0xff)
   {
      rgSCHCmnRlsUlSf(cell);
   }
# 2906 "../..//ltemac/rg_sch_tom.c"
   { if (ttiInd->timingInfo.sfn == 0) { if ((ttiInd->timingInfo.subframe - (2)) < 0) { frm.sfn = 1024 - 1; } else { frm.sfn = ttiInd->timingInfo.sfn; } } else { if ((ttiInd->timingInfo.subframe - (2)) < 0) { frm.sfn = ttiInd->timingInfo.sfn - 1; } else frm.sfn = ttiInd->timingInfo.sfn; } frm.subframe = (10 + ttiInd->timingInfo.subframe - (2)) % (10); };


   if ((ret = rgSCHDhmRlsDlsfHqProc (cell, frm)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2912); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTtiInd() Unable to Release" " Downlink subframe for cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      err.errType = ((((0 + 1) + 4) + 1) + 7);
   }
# 2923 "../..//ltemac/rg_sch_tom.c"
   { if (ttiInd->timingInfo.sfn == 0) { if ((ttiInd->timingInfo.subframe - ((4 + 2))) < 0) { frm.sfn = 1024 - 1; } else { frm.sfn = ttiInd->timingInfo.sfn; } } else { if ((ttiInd->timingInfo.subframe - ((4 + 2))) < 0) { frm.sfn = ttiInd->timingInfo.sfn - 1; } else frm.sfn = ttiInd->timingInfo.sfn; } frm.subframe = (10 + ttiInd->timingInfo.subframe - ((4 + 2))) % (10); };




   rgSCHUtlDlRlsSubFrm(cell, frm);
# 2939 "../..//ltemac/rg_sch_tom.c"
   rgSCHCmnUpdVars(cell);
# 2952 "../..//ltemac/rg_sch_tom.c"
   rgSCHCmnUlTti(cell, &err);
# 2972 "../..//ltemac/rg_sch_tom.c"
   if ((ttiInd->timingInfo.subframe + (2)) >= 10) crntFrm.sfn = (ttiInd->timingInfo.sfn + (ttiInd->timingInfo.subframe + (2))/10) % 1024; else crntFrm.sfn = ttiInd->timingInfo.sfn; crntFrm.subframe = (ttiInd->timingInfo.subframe + (2)) % 10;;
   dlSf = rgSCHUtlSubFrmGet (cell, crntFrm);



   if ((ttiInd->timingInfo.subframe + ((4 - 2))) >= 10) crntFrm.sfn = (ttiInd->timingInfo.sfn + (ttiInd->timingInfo.subframe + ((4 - 2)))/10) % 1024; else crntFrm.sfn = ttiInd->timingInfo.sfn; crntFrm.subframe = (ttiInd->timingInfo.subframe + ((4 - 2))) % 10;;
   ulSf = rgSCHUtlSubFrmGet (cell, crntFrm);

   if (rgSCHTomUtlProcTA (cell) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2983); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTtiInd() Unable Process " "Timing Adjustment for cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if ((ret = rgSCHTomUtlProcDlSf (dlSf, ulSf, cell, &err)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 2992); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTtiInd() Unable to process" " downlink subframe for cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if ((ret = rgSCHTomUtlProcUlSf (cell, &err)) != 0)
   {

      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3002); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomTtiInd() Unable to process" " Uplink subframe for cellId (%d))\n", ttiInd->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      err.errType = ((((0 + 1) + 4) + 1) + 7);
   }
# 3013 "../..//ltemac/rg_sch_tom.c"
   ret = rgSCHUtlTti (cell, &err);
# 3023 "../..//ltemac/rg_sch_tom.c"
   rgSCHRamTtiHndlr(cell);
   rgSCHGomTtiHndlr(cell, suId);

   return(ret);
}
# 3050 "../..//ltemac/rg_sch_tom.c"
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3075); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcUlSf() Unable to " "Allocate TfuRecpReqInfo for cellId=%d \n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 3101 "../..//ltemac/rg_sch_tom.c"
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3109); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcUlSf() Unable to fill" " Data recption requests for cellId (%d))\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
 ...
 ret = rgSCHTomUtlFillHqFdbkRecpReq (recpReqInfo, cell, err);
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3124); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcUlSf() Unable to fill" " Harq Feedback reception requests for cellId (%d))\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

      cmFreeMem((Ptr)recpReqInfo);
      return(ret);
   }
# 3173 "../..//ltemac/rg_sch_tom.c"
   if (rgSCHUtlTfuRecpReq(inst, cell->tfuSap->sapCfg.suId, recpReqInfo) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3176); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcUlSf() Unable to send " "Cntrl info for cellId (%d)\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   }
   return(0);
}
# 3285 "../..//ltemac/rg_sch_tom.c"
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3311); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcDlSf() Unable to " "Allocate TfuCntrlReqInfo for cellId=%d \n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   else
   {
      ...
      if ((cell->crntTime.subframe + ((4 - 2))) >= 10) cntrlInfo->ulTiming.sfn = (cell->crntTime.sfn + (cell->crntTime.subframe + ((4 - 2)))/10) % 1024; else cntrlInfo->ulTiming.sfn = cell->crntTime.sfn; cntrlInfo->ulTiming.subframe = (cell->crntTime.subframe + ((4 - 2))) % 10;;



      if ((cell->crntTime.subframe + (2)) >= 10) cntrlInfo->dlTiming.sfn = (cell->crntTime.sfn + (cell->crntTime.subframe + (2))/10) % 1024; else cntrlInfo->dlTiming.sfn = cell->crntTime.sfn; cntrlInfo->dlTiming.subframe = (cell->crntTime.subframe + (2)) % 10;;
      ...
      if ((ret = rgSCHTomUtlFillPhich (cntrlInfo, ulSf, err)) != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3337); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcDlSf() Unable to " "send PHICH info for cellId (%d)\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if ((ret = rgSCHTomUtlFillDlPdcch (cntrlInfo, dlSf, err)) != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3348); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcDlSf() Unable to " "send PDCCH info for cellId (%d)\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         cmFreeMem((Ptr)cntrlInfo);
         return(ret);
      }

      if ((ret = rgSCHTomUtlFillUlPdcch (cntrlInfo, ulSf, err)) != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3356); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcDlSf() Unable to " "send PDCCH info for cellId (%d)\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if (rgSCHUtlTfuCntrlReq(inst, cell->tfuSap->sapCfg.suId, cntrlInfo) != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 3367); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlProcDlSf() Unable to" " send Cntrl info for cellId (%d)\n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if (cell->crntTime.sfn == 0) { if ((cell->crntTime.subframe - ((4 - 2))) < 0) { futTime.sfn = 1024 - 1; } else { futTime.sfn = cell->crntTime.sfn; } } else { if ((cell->crntTime.subframe - ((4 - 2))) < 0) { futTime.sfn = cell->crntTime.sfn - 1; } else futTime.sfn = cell->crntTime.sfn; } futTime.subframe = (10 + cell->crntTime.subframe - ((4 - 2))) % (10); };
...
# 4111 "../..//ltemac/rg_sch_tom.c"
         ...
         )
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 4126); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlFillHqFdbkRecpReq()" " Unable to Allocate TfuUeRecpReqInfo for cellId=%d \n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 4165 "../..//ltemac/rg_sch_tom.c"
      prvHqCb = hqCb;
# 4174 "../..//ltemac/rg_sch_tom.c"
      node = node->next;
   }
...
# 4223 "../..//ltemac/rg_sch_tom.c"
         if (hqCb != prvHqCb) {
            ret = rgSCHUtlGetEventMem((Ptr *)&pucchRecpInfo,
                        sizeof(TfuUeRecpReqInfo), &(recpReqInfo->memCp));
            if (ret != 0)
            {
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 4230); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlFillHqFdbkRecpReq()" " Unable to Allocate TfuUeRecpReqInfo for cellId=%d \n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 4275 "../..//ltemac/rg_sch_tom.c"
            pucchRecpInfo->t.pucchRecpReq.type = TFU_UCI_HARQ;
# 4311 "../..//ltemac/rg_sch_tom.c"
            cmLListAdd2Tail(&recpReqInfo->ueRecpReqLst, &(pucchRecpInfo->lnk));
            pucchRecpInfo->lnk.node = (U32)pucchRecpInfo;
...
# 4351 "../..//ltemac/rg_sch_tom.c"
   return(0);
}
# 4727 "../..//ltemac/rg_sch_tom.c"
...

{
   ...
   while(alloc)
   {
      ...
      if ((ret = rgSCHUtlGetEventMem((Ptr *)&datRecpInfo,
                                ...
                                &(recpReqInfo->memCp))) != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_tom.c", 4776); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomUtlFillDatRecpReq() Unable" " to Allocate TfuUeRecpReqInfo for cellId=%d \n", cell->cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
