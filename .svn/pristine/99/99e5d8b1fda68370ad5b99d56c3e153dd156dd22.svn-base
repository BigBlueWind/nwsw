	    ...
	    var divHeight;
 	    ...
 	    while(b2*x < a2*y)
  	    {     
		    ...
		    if(x==1 && y!=yp)
		    {
		        iHtml[iHtml.length]="<DIV style=\"position:relative;overflow:hidden;left:" + (xc+x) + "px;top:" + (yc+y) + "px;width:1px;height:1px;background-color:" + hexColor + "\"></DIV>";
		        iHtml[iHtml.length] = "<DIV style=\"position:relative;overflow:hidden;left:" + (xc + x) + "px;top:" + (yc - y) + "px;width:1px;height:1px;background-color:" + hexColor + "\"></DIV>";
		    }
      	    if(y!=yp)
      	    {
			    divWidth=x-xp;
			    iHtml[iHtml.length] = "<DIV style=\"position:relative;overflow:hidden;left:" + (xc + xp) + "px;top:" + (yc + yp - penWidth + 1) + "px;height:" + penWidth + "px;width:" + divWidth + "px;background-color:" + hexColor + "\"></DIV>";
			    iHtml[iHtml.length] = "<DIV style=\"position:relative;overflow:hidden;left:" + (xc - xp - divWidth + 1) + "px;top:" + (yc + yp - penWidth + 1) + "px;height:" + penWidth + "px;width:" + divWidth + "px;background-color:" + hexColor + "\"></DIV>";
			    iHtml[iHtml.length] = "<DIV style=\"position:relative;overflow:hidden;left:" + (xc + xp) + "px;top:" + (yc - yp) + "px;height:" + penWidth + "px;width:" + divWidth + "px;background-color:" + hexColor + "\"></DIV>";
			    iHtml[iHtml.length] = "<DIV style=\"position:relative;overflow:hidden;left:" + (xc - xp - divWidth + 1) + "px;top:" + (yc - yp) + "px;height:" + penWidth + "px;width:" + divWidth + "px;background-color:" + hexColor + "\"></DIV>";
  	    ...
  	    {     
		    ...
		    if(y+1<bi)
		    {
 			    if(y!=yp)
			    {
				    ...
				    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + xT + "px;top:" + (yc - yp) + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
				    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + xT + "px;top:" + (yc + yp) + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
			    ...
			    if(b2*x >= a2*y)
			    {
				    ...
				    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + xT + "px;top:" + (yc - y) + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
				    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + xT + "px;top:" + (yc + y) + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
		    ...
		    else
		    {
      		    ...
      		    {
      		        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;width:1px;height:1px;left:" + xc + "px;top:" + (yc + yp - 1) + "px;background-color:" + hexColor + "\"></DIV>";
      		        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;width:1px;height:1px;left:" + xc + "px;top:" + (yc - yp) + "px;background-color:" + hexColor + "\"></DIV>";      		
			    }
			    if(y!=yp)
			    {
			        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - x + 1) + "px;top:" + (yc - yp) + "px;width:" + (2 * (x - 1) + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
			        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - x + 1) + "px;top:" + (yc + yp) + "px;width:" + (2 * (x - 1) + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
				    yp=y;
			    }
			    ...
			    if(y==bi || y==0)
			    {
			        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - x) + "px;top:" + (yc - y) + "px;width:" + (2 * x + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
			        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - x) + "px;top:" + (yc + y) + "px;width:" + (2 * x + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
			    }
		    }
	    }
  		    ...
  		    if((b2*(x+0.5)*(x+0.5) + a2*y*y - a2*b2)<=0)   
			    ...
			    if(y+1<bi)
			    {
				    if(x!=xp || xArray[y]!=xpi)
				    {
					    ...
					    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + xT + "px;top:" + (yc - yp) + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
					    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + xT + "px;top:" + (yc + y + 1) + "px;width:" + divWidth + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
			    ...
			    else
			    {
				    ...
				    {
					    divHeight=yp-y;
					    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - xp) + "px;top:" + (yc - yp) + "px;width:" + (2 * xp + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
					    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - xp) + "px;top:" + (yc + y + 1) + "px;width:" + (2 * xp + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
				    ...
				    if(y==bi || y==0)
				    {
				        ...
				        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - x) + "px;top:" + (yc - yp) + "px;width:" + (2 * x + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
				        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - x) + "px;top:" + (yc + y) + "px;width:" + (2 * x + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
    ...
    function fillEllipse(color,center,width,height)
    {
	    ...
	    //Upper and Lower portion of the ellipse
 	    while(b2*x < a2*y)
  	    {     
		    ...
		    if(y!=yp)
		    {
		        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;height:1px;left:" + (xc - x + 1) + "px;top:" + (yc - yp) + "px;width:" + (2 * x - 1) + "px;background-color:" + hexColor + "\"></DIV>";
		        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;height:1px;left:" + (xc - x + 1) + "px;top:" + (yc + yp) + "px;width:" + (2 * x - 1) + "px;background-color:" + hexColor + "\"></DIV>";
		    ...
		    if(b2*x >= a2*y)
		    {
		        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;height:1px;left:" + (xc - x) + "px;top:" + (yc - yp) + "px;width:" + (2 * x + 1) + "px;background-color:" + hexColor + "\"></DIV>";
		        iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;height:1px;left:" + (xc - x) + "px;top:" + (yc + yp) + "px;width:" + (2 * x + 1) + "px;background-color:" + hexColor + "\"></DIV>";
		    }
	    }
	    ...
	    {     
		    ...
		    if(y==0)
		    {
			    ...
			    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - xp) + "px;top:" + (yc - yp) + "px;width:" + (2 * x + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
			    iHtml[iHtml.length] = "<DIV style=\"overflow:hidden;left:" + (xc - xp) + "px;top:" + (yc + y) + "px;width:" + (2 * x + 1) + "px;height:" + divHeight + "px;background-color:" + hexColor + "\"></DIV>";
		    }
 	    }
