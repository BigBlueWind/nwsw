...
#define TASKID_TX_CRC                            108
#define TASKID_TX_BCH                            109
#define TASKID_LTE_ENODEB_DL_START_ID            TASKID_FEC_TX
#define TASKID_LTE_ENODEB_DL_END_ID              TASKID_TX_BCH
...
// Tasks for Wrapper Functions. Needed so Ceva will compile code in
#define TASKID_RX_RIPRSSISUBFRAME                151
#define TASKID_RX_SIGNAL_POWER_CALC              152

#define TASKID_RX_FEC_MUX_RI_CQI_CNTL_WRAP       153
#define TASKID_RX_SDU_PRE_PROC                   154
#define TASKID_RX_VEC_PROC                       155

#define TASKID_LTE_ENODEB_UL_RX_START_ID         TASKID_RX_FFT
#define TASKID_LTE_ENODEB_UL_RX_END_ID           TASKID_RX_RIPRSSISUBFRAME
////////////////////////////////////////////
...
#define TASKID_API_ERROR_CHECK                   209
#define TASKID_UTIL_TASKS_START_ID               TASKID_COPY_DATA
#define TASKID_UTIL_TASKS_END_ID                 TASKID_API_ERROR_CHECK
...
#define SUBTASKID_RX_CHANEST_P1_EXTRACT                             416                                         // 0x01A0
...
#define SUBTASKID_RX_MULTICHAN_DEMODULATION_EXTRACT                 432                                         // 0x01B0
...
#define SUBTASKID_RX_DEMAPPER_EXTRACT                               448                                         // 0x01C0
...
#define SUBTASKID_RX_FEC_MUX_ACK_CNTL_EXTRACT                       464                                         // 0x01D0
...
#define SUBTASKID_RX_FEC_MUX_RI_CQI_CNTL_EXTRACT                    480                                         // 0x01E0
...
// SubTasks for PUCCH
#define SUBTASKID_RX_ULPILOT_PUCCH_EXTRACT                          496                                         // 0x01F0
...
#define SUBTASKID_RX_CHANEST_PUCCH_EXTRACT                          512                                         // 0x0200
...
#define SUBTASKID_RX_MULTICHAN_PUCCH_DEMODULATION_EXTRACT           528                                         // 0x0210
...
// SubTasks for SRS
#define SUBTASKID_RX_SRS_PILOTS_EXTRACT                             544                                         // 0x0220
...
#define SUBTASKID_RX_SRS_EXTRACT                                    560                                         // 0x0230
...
#define SUBTASKID_RX_SRS_SNR_EXTRACT                                576                                         // 0x0240
...
// SubTasks for PRACH
#define SUBTASKID_RX_PRACH_EXTRACT                                  592                                         // 0x0250
...
// SubTasks for RIPRSSISUBFRAME
#define SUBTASKID_RX_RIPRSSISUBFRAME_EXTRACT                        608                                         // 0x0260
#define SUBTASKID_RX_RIPRSSISUBFRAME_DMA_IN                         609
#define SUBTASKID_RX_RIPRSSISUBFRAME_RB_PWR_AVG                     610
#define SUBTASKID_RX_RIPRSSISUBFRAME_RIP_SUBFRAME                   611
#define SUBTASKID_RX_RIPRSSISUBFRAME_THERMAL_NOISE                  612
#define SUBTASKID_RX_RIPRSSISUBFRAME_RSSI_SUBFRAME                  613
#define SUBTASKID_RX_RIPRSSISUBFRAME_DMA_OUT                        614
#define SUBTASKID_RX_RIPRSSISUBFRAME_START                          SUBTASKID_RX_RIPRSSISUBFRAME_EXTRACT
#define SUBTASKID_RX_RIPRSSISUBFRAME_END                            SUBTASKID_RX_RIPRSSISUBFRAME_DMA_OUT
...
#define UMTSNMM_TASK_ID_START                                       700
#define TASK_ID_UMTS_NWL_FIRST                                      701
#define TCB_PSCH_TSKID                                              (TASK_ID_UMTS_NWL_FIRST+0)
#define TCB_SSCH_TSKID                                              (TASK_ID_UMTS_NWL_FIRST+1)
#define TCB_CPICH_TSKID                                             (TASK_ID_UMTS_NWL_FIRST+2)
#define TCB_PM_TSKID                                                (TASK_ID_UMTS_NWL_FIRST+3)
#define TCB_RSCP_TSKID                                              (TASK_ID_UMTS_NWL_FIRST+4)
#define TCB_GEN_PSC_TASKID                                          (TASK_ID_UMTS_NWL_FIRST+5)
#define TCB_FREQ_EST_TSKID                                          (TASK_ID_UMTS_NWL_FIRST+6)
#define TCB_DOWN_SAMPLE_TSKID                                       (TASK_ID_UMTS_NWL_FIRST+7)
#define TCB_AGC_TSKID                                               (TASK_ID_UMTS_NWL_FIRST+8)
#define TASK_PATH_SEARCH                                            (TASK_ID_UMTS_NWL_FIRST+9)
#define TASK_UPDATE_FRE_ERR                                         (TASK_ID_UMTS_NWL_FIRST+10)
#define TASK_CL_DEMODE                                              (TASK_ID_UMTS_NWL_FIRST+11)
#define TASK_CL_DECODE                                              (TASK_ID_UMTS_NWL_FIRST+12)
#define TASK_CL_INTERPOLATION                                       (TASK_ID_UMTS_NWL_FIRST+13)
#define TASK_CL_CHANESTCOM                                          (TASK_ID_UMTS_NWL_FIRST+14)

#define UMTSNMM_TASK_ID_END                                         (TASK_ID_UMTS_NWL_FIRST + 50)
...
#define TIME_RX_RIPRSSISUBFRAME                                     500
#define TIME_RX_ULPILOT                                             250
#define TIME_RX_CHANEST_P0                                          100
#define TIME_RX_CHANEST_P1                                          200
#define TIME_RX_MULTICHAN_DEMODULATION                              400
#define TIME_RX_DEMAPPER                                            300
...
#define TIME_RX_SIGNAL_POWER_CALC                                   700
#define TIME_RX_PRACH                                               2500

////////////////////////////////////////////
// LTE BS Tx (DL) FEC Task time limit
////////////////////////////////////////////
#define TIME_TX_FEC                                                 450
////////////////////////////////////////////
// LTE BS Rx (UL) FEC Task time limit
////////////////////////////////////////////
#define TIME_RX_FEC                                                 550
