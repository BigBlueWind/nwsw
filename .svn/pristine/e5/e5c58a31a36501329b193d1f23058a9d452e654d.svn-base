...
/* MS_FIX: If only TA is scheduled, use some dummy LCID */
...
#endif /*LTEMAC_DRX */
/*MS_FIX:Inform UE delete to scheduler*/
#define RG_MACUEDEL_INACTIVE        0x10  
/* MS_FIX : syed set UE inactive for scheduling if it is not completely 
 * initialized */
