...
# 105 "../..//s1ap/sz_msgfn.c" 2
# 1 "../..//cm/cm5.h" 1
# 106 "../..//s1ap/sz_msgfn.c" 2
# 1 "../..//cm/cm_err.h" 1
# 91 "../..//cm/cm_err.h"
#define __CMERRH__ 
# 105 "../..//cm/cm_err.h"
...
# 136 "../..//s1ap/sz_msgfn.c" 2
# 1 "../..//cm/cm5.x" 1
# 137 "../..//s1ap/sz_msgfn.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...

{
   ...
   if (ret == 1)
   {
      ...
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 332); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, " Encoding failed \n"); SPrint((&szCb.init)->prntBuf); } };


      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 335); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, szErrPrntArr[asnErr.errCode-1], asnErr.errCode); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   if (ret == 1)
   {
      ...
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 447); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, " Encoding failed \n"); SPrint((&szCb.init)->prntBuf); } };


      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 450); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, szErrPrntArr[asnErr.errCode-1], asnErr.errCode); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   if (ret != 0)
   {
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 519); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "Memory allocation failed in Decode \n"); SPrint((&szCb.init)->prntBuf); } };
   ...
   if ((ret == 1) || (err->errCode != 0))
   {
      ...
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 543); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, " Decoding failed \n"); SPrint((&szCb.init)->prntBuf); } };


      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 546); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, szErrPrntArr[err->errCode-1], err->errCode); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   if (ret != 0)
   {
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 622); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "Memory allocation failed in Decode \n"); SPrint((&szCb.init)->prntBuf); } };
   ...
   if (ret == 1)
   {
      ...
      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 664); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, " Decoding failed \n"); SPrint((&szCb.init)->prntBuf); } };


      { if ((&szCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_msgfn.c", 667); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, szErrPrntArr[err->errCode-1], err->errCode); SPrint((&szCb.init)->prntBuf); } };
