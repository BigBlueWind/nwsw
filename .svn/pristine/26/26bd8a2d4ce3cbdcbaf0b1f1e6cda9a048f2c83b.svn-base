...
# 132 "../..//tucl/hi_ptmi.c" 2
# 1 "../..//cm/cm5.h" 1
# 133 "../..//tucl/hi_ptmi.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 157 "../..//tucl/hi_ptmi.c" 2
# 1 "../..//cm/cm5.x" 1
# 158 "../..//tucl/hi_ptmi.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptmi.c", 450); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCfgCfm(pst, cfg (0x%p))\n", (Ptr)cfg); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptmi.c", 486); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiCntrlCfm(pst, cntrl (0x%p))\n", (Ptr)cntrl); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptmi.c", 522); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaInd(pst, usta (0x%p))\n", (Ptr)usta); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptmi.c", 558); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStaCfm(pst, sta (0x%p))\n", (Ptr)sta); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptmi.c", 594); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiStsCfm(pst, sts (0x%p))\n", (Ptr)sts); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000002)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptmi.c", 632); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiMiLhiTrcInd(pst, trc (0x%p))\n", (Ptr)trc); SPrint((&(hiCb.init))->prntBuf); } };
