...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 99 "../..//lterrc/nh_rhm.c" 2
# 1 "../..//cm/cm5.h" 1
# 100 "../..//lterrc/nh_rhm.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 119 "../..//lterrc/nh_rhm.c" 2
# 1 "../..//cm/cm5.x" 1
# 120 "../..//lterrc/nh_rhm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 186 "../..//lterrc/nh_rhm.c"
{
   ...
   if(1 == ret)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_rhm.c", 198); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "cmHashListInit failure.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

      dgn.type = 0;
      nhSendLmAlarm(4,(256 + 0),
                    16,&dgn);
      return(1);
   }
   return(0);
...

{
   ...
   if(0 != ret)
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_rhm.c", 253); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "cmHashListInsert failure.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (1 == ret)
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_rhm.c", 301); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "cmHashListDelete Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   return(cmHashListFind(hashListCp, key, keyLen, 0, data));
}
# 365 "../..//lterrc/nh_rhm.c"
 S16 nhHashListGetNext
(
CmHashListCp *hashListCp,
U32 prevEnt,
U32 *entry
...

{
   ...
   return(cmHashListGetNext(hashListCp, prevEnt, entry));
}
# 399 "../..//lterrc/nh_rhm.c"
 Void nhHashListDeInit
(
CmHashListCp *hashListCp
)
...

{
   ...
   if (1 == ret)
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_rhm.c", 419); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "cmHashListDeinit failure.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
