...
/**
 *@details This primitive is used by RLC to indicate the PDCP that RLC is done
 with sending all data during reestablishment of specific RB ID.

 This primitive is invoked as part of re-establishment configuration request
 processing for an RB. After completion of re-establishment procedure in RLC
 for an RB, before returning the confirmation, RLC indicates the
 re-establishment complete to PDCP through this primitive.
...
/main/4     kwu_x_001.main_3 ap 1.Added support for L2 Measurement.
*********************************************************************91*/
