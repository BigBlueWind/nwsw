...
#endif
{
   ...
   {
      CZ_DBG_ERROR((CZ_PRNT_BUF,
           "czNmmAllocPeerCb: Null Pointer as the Argument\n"));
      CZ_RETVALUE(RFAILED);
   }
#endif
   *peer = NULLP;
...
#endif
{
   ...
   {
      CZ_DBG_ERROR((CZ_PRNT_BUF,
           "czNmmAllocDynamPeerCb: Null pointer of peer passed\n"));
      CZ_RETVALUE(RFAILED);
   }
#endif
   *peer = NULLP;
...
#endif
{
   ...
   *peerAssoc  = NULLP;
   ...
   for (idx = 0; idx < dstAddrLst->nmb; idx++)
   {
      ...
      cmMemset((U8*)&peerAssocEntry, 0, sizeof(CzDynamPeerAssocEntry));
