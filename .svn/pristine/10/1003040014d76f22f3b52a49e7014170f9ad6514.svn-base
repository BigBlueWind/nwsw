...
/********************************************************************20**
     ...
     Sid:      egt.c@@/main/13 - Thu Sep 27 00:12:42 2012
...
#ifndef PWAV /* Moved this portion to right place and raised bug on CCPU */
      memInfo.region = pst->region;
      memInfo.pool = pst->pool;
#endif
      CMCHKUNPKLOG(cmUnpkSuId, &suId, mBuf, EEGTXXX, pst);
...
#endif
{
   ...
   {
      for (; cnt < pkStruct->noOfExtHdrs; cnt++)
      {
...
#endif
{
   ...
   for (cnt = unpkStruct->noOfExtHdrs - 1; cnt >= 0; cnt--)
   {
...
/********************************************************************30**
         ...
         End of file:     egt.c@@/main/13 - Thu Sep 27 00:12:42 2012
