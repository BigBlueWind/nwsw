...
#endif /* LTERRC_REL9 */
#ifdef PWAV
#define E_UTRAN_UE_EUTRACAP_DECODE         0
#define E_UTRAN_UE_RADACCCAPINFO_DECODE    1
#define E_UTRAN_UE_CAPINFO_DECODE          2
#define E_UTRAN_UE_CAPINFO_ENCODE          3
#define E_UTRAN_UE_RADACCCAPINFO_ENCODE    4
#endif
