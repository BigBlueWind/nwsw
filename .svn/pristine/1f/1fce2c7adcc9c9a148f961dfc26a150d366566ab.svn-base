...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 105 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm5.h" 1
# 106 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_llist.h" 1
# 90 "../..//cm/cm_llist.h"
#define __CMLLISTH__ 
...
# 112 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 113 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/hit.h" 1
# 91 "../..//cm/hit.h"
#define __HITH__ 
# 110 "../..//cm/hit.h"
...
# 1 "../..//cm/gen.x" 1
# 133 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/ssi.x" 1
# 134 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm5.x" 1
# 135 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 136 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_llist.x" 1
# 91 "../..//cm/cm_llist.x"
#define __CMLLISTX__ 
...
# 138 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 139 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_tpt.x" 1
# 95 "../..//cm/cm_tpt.x"
#define __CMTPTX__ 
...
# 140 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_mblk.x" 1
# 141 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_dns.x" 1
# 102 "../..//cm/cm_dns.x"
#define __CMDNSX__ 
...
# 142 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 143 "../..//egtpu/eg_ptli.c" 2
# 1 "../..//cm/hit.x" 1
# 91 "../..//cm/hit.x"
#define __HITX__ 
# 102 "../..//cm/hit.x"
...
static S16 PtLiHitServOpenReq (Pst *pst, SpId spId, UConnId servConId, CmTptAddr *servTAddr, CmTptParam *tPar, CmIcmpFilter *icmpFilter, U8 srvcType);
 ...
 S16 PtLiHitUbndReq (Pst *pst, SpId spId, Reason reason);



 S16 PtLiHitUDatReq (Pst *pst, SpId spId, UConnId spConId, CmTptAddr *remAddr, CmTptAddr *srcAddr, CmIpHdrParm *hdrParm, CmTptParam *tPar, Buffer *mBuf);
# 210 "../..//egtpu/eg_ptli.c"
 S16 PtLiHitDiscReq (Pst *pst, SpId spId, U8 choice, UConnId conId, Action action, CmTptParam *tPar);
# 225 "../..//egtpu/eg_ptli.c"
static HitBndReq EgLiHitBndReqMt[3] =
{
...
static HitUbndReq EgLiHitUbndReqMt[3] =
{
...
static HitServOpenReq EgLiHitServOpenReqMt[3] =
{
...
static HitUDatReq EgLiHitUDatReqMt[3] =
{
...
static HitDiscReq EgLiHitDiscReqMt[3] =
{
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",350); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 1))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",352); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, "[FLOW:]"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Src [%u] --""EVTHITBNDREQ""--> Dst [%u]\n", pst->srcEnt,pst->dstEnt); SPrint(egCb.init.prntBuf); }; } };

   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",354); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"suId(%d) spId(%d)", suId, spId); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",388); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 1))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",390); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, "[FLOW:]"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Src [%u] --""EVTHITUBNDREQ""--> Dst [%u]\n", pst->srcEnt,pst->dstEnt); SPrint(egCb.init.prntBuf); }; } };
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",391); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"spId(%d) reason(%d)", spId, reason); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
...
# 433 "../..//egtpu/eg_ptli.c"
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",434); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 1))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",436); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, "[FLOW:]"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Src [%u] --""EVTHITSRVOPENREQ""--> Dst [%u]\n", pst->srcEnt,pst->dstEnt); SPrint(egCb.init.prntBuf); }; } };




   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",441); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"spId(%d) servConId(%ld)", spId, servConId); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",445); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"srvcType(%d)", srvcType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",446); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "EG_DBG_CMTPTADDR" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_CMTPTADDR,(Void*) servTAddr, (S8 *)"servTAddr"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf," "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
...
{
# 521 "../..//egtpu/eg_ptli.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",521); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 1))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",523); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, "[FLOW:]"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Src [%u] --""EVTHITUDATREQ""--> Dst [%u]\n", pst->srcEnt,pst->dstEnt); SPrint(egCb.init.prntBuf); }; } };




   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",528); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"spId(%d) spConId(%ld)",spId, spConId); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",532); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "EG_DBG_CMTPTADDR" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_CMTPTADDR,(Void*) remAddr, (S8 *)"remAddr"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf," "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",533); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "EG_DBG_CMTPTADDR" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(EG_DBG_CMTPTADDR,(Void*) srcAddr, (S8 *)"srcAddr"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf," "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
# 596 "../..//egtpu/eg_ptli.c"
...
# 634 "../..//egtpu/eg_ptli.c"
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",635); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   { if (egCb.init.dbgMask & ((0x00000100 << 1))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",637); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, "[FLOW:]"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Src [%u] --""EVTHITDISCREQ""--> Dst [%u]\n", pst->srcEnt,pst->dstEnt); SPrint(egCb.init.prntBuf); }; } };




   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",642); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"spId(%d) choice(%d) conId(%ld)",spId, choice, conId); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



   { if (egCb.init.dbgMask & ((0x00000100 << 10))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",646); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"PARAM\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"action(%d)",action); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



   { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",650); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 3,(Void*)(Ptr)tPar, (U32)0 ); SPrint(egCb.init.prntBuf); }; } };
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",688); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ptli.c", 690, 0x4, ((0 + 0) + 4), (ErrVal)(ErrVal)0, (Txt *)"PtLiHitBndReq(): Invalid Selector");;
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",726); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ptli.c", 728, 0x4, ((0 + 0) + 5), (ErrVal)(ErrVal)0, (Txt *)"PtLiHitUBndReq(): Invalid Selector");;
...
# 772 "../..//egtpu/eg_ptli.c"
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",773); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ptli.c", 775, 0x4, ((0 + 0) + 6), (ErrVal)(ErrVal)0, (Txt *)"PtLiHitServOpenReq(): Invalid Selector");;
...
# 825 "../..//egtpu/eg_ptli.c"
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",826); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ptli.c", 828, 0x4, ((0 + 0) + 7), (ErrVal)(ErrVal)0, (Txt *)"PtLiHitUDatReq(): Invalid Selector");;
...
# 873 "../..//egtpu/eg_ptli.c"
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ptli.c",874); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };

   SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ptli.c", 876, 0x4, ((0 + 0) + 8), (ErrVal)(ErrVal)0, (Txt *)"PtLiHitDiscReq(): Invalid Selector");;
