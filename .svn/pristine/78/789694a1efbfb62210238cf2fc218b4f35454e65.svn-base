...
//#define ENTLAST     ENTOAMSTAT            /* last entity id */
//#else
//#define ENTLAST     ENTVB            /* last entity id */
#endif
#ifdef PWAV
 #define ENTUDH       ENTPX  //0xf9
 #define ENTDR        0xf1 /* TODO: Who needs this? */
 #define ENT_BSM      0xf2
#define ENT_PRM     0xf3
#define ENT_PMH     0xf4
 #define ENT_LTH      0xf5
...
/* last entity id: NOTE for merging: Do not take directly from CCPU code; use this */
#ifdef PWAV
 #define ENTLAST      ENTS1M
#else
 #ifdef ENTOAMSOCK
   #define ENTLAST     ENTOAMSTAT /*ENTOAMSOCK */
 #else 
...
#ifdef PWAV
#define SRegSecResTmr(ent,inst,period,fun)     SRegCfgTmr(ent,inst,period,SS_1000MS,fun)
#define SDeregSecResTmr(ent,inst,period,fun)   SDeregCfgTmr(ent,inst,period,SS_1000MS,fun)
#endif
/* ssi_h_001.main_131 */
#ifdef SS_MT_TMR
/* ssi_h_001.main_126 */
 ...
 */
  ...
  #define SGetSBuf(region, pool, bufPtr, size) \
    SGetSBufPwav(region, pool, bufPtr,size, __LINE__, (U8*)__FILE__)

  #define SPutSBuf(region, pool, buf, size) \
    SPutSBufPwav(region, pool, buf,   size, __LINE__, (U8*)__FILE__)

  #define SGetMsg(region, pool, mBufPtr) \
    SGetMsgPwav(region, pool, mBufPtr, __LINE__,  (U8*)__FILE__)

  #define SPutMsg(mBuf) \
    SPutMsgPwav(mBuf, __LINE__,  (U8*)__FILE__)

#else

#if defined(SS_HISTOGRAM_SUPPORT) 
...
/*#define PID_L2_PROCESSING    30999 */ /* Processing for all L2 tasks on CPU3 */
