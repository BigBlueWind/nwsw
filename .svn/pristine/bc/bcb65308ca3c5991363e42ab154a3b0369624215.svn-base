...
{
   U16 rnti;                /*!< RNTI */
   /*MS_FIX: Overcome race condition between MAC and Scheduler delete*/
...
/* rg008.201 - Removed dependency on MIMO compile-time flag */
   ...
   U32                  ySps[RGSCH_NUM_SUB_FRAMES]; /*!< 'Y' values calculated 
                                                     using SPS-C-RNTI and 
                                                     subframe no based on formula
                                                     present in sec 9.1.1 of 
                                                     3GPP 36.313*/
   /* Y value for SPS-C-RNTI*/
#ifdef LTE_TDD
...
EXTERN U32 rgSCHUtlGetYsps ARGS((RgSchUeCb *ue, U8 subFrm));
/*rg008.201 - Added support for SPS*/
