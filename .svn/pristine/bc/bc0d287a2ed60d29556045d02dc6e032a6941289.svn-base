...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 122 "../..//lterlcpdcp/kw_uim.c" 2
# 1 "../..//cm/cm5.h" 1
# 123 "../..//lterlcpdcp/kw_uim.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 143 "../..//lterlcpdcp/kw_uim.c" 2

# 1 "../..//cm/cm5.x" 1
# 145 "../..//lterlcpdcp/kw_uim.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 221); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwBndReq(pst, spId(%d), suId(%d))\n", spId, suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   ckwSap = &(kwCb.ckwSap);

  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x00410001, KW_DIAG_NA, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, spId, suId, 0, 0, "Received BndReq from user, spId = %d, suId = %d"); }}
   ...
   switch(ckwSap->state)
   {
      ...
      case 4:
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 0))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 249); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwBndReq: state (%d)\n", ckwSap->state); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 2:
      {
         ...
         if (ckwSap->pst.dstProcId != pst->srcProcId
               ...
               || ckwSap->suId != suId)
         {
            { kwLmmSendAlarm(2, (256 + 3), 13, spId, 0); };


            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 270); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwBndReq: SAP already bound -- state(%d)\n", ckwSap->state); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
     ...
     default:
      {
# 289 "../..//lterlcpdcp/kw_uim.c"
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 290); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwBndReq: CKW SAP State is Invalid during Bind Req"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 353); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwUbndReq(pst, spId(%d), reason(%d))\n", spId, reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x00410002, KW_DIAG_NA, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, spId, 0, 0, 0, "Received UbndReq from RRC, spId = %d"); }}
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 428); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if(ckwSap->state != 2) { ; { kwLmmSendAlarm(2, 1, 9, 0, 0); }; ret = 1; } };
   if (ret != 0)
   {
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&cfgCfm, (Size) sizeof(CkwCfgCfmInfo)) == 0) { cmMemset((U8 *)(cfgCfm), 0, sizeof(CkwCfgCfmInfo)); } else { (cfgCfm) = 0L; } };
# 462 "../..//lterlcpdcp/kw_uim.c"
  ...
  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x00410003, KW_DIAG_UEID, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, cfg->ueId, cfg->cellId, 0, 0, 0, "Received CfgReq from RRC, cellId = %d"); }}
         ...
         case 1:
            {
               ...
               if (kwCfgAddRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {

                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 487); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgAddRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->entCfg[idx].rbId, entCfgCfm->status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         case 2:
            {
               ...
               if (kwCfgReCfgRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {

                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 504); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgReCfgRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->entCfg[idx].rbId, entCfgCfm->status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         case 3:
            {
               ...
               if (kwCfgDelRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {

                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 521); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgDelRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->entCfg[idx].rbId, entCfgCfm->status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         case 4:
            {
               ...
               if (kwCfgReEstRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {

                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 542); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgReEstRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->entCfg[idx].rbId, entCfgCfm->status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         case 5:
            {
               ...
               if (kwCfgDelUe(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {


                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 563); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgDelUe Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->entCfg[idx].rbId, entCfgCfm->status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 575 "../..//lterlcpdcp/kw_uim.c"
               break;
            }
         case 6:
            {
               if ( kwCfgDelCell(cfg->cellId,entCfg,entCfgCfm) != 0 )
               {

                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 586); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgDelCell Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->entCfg[idx].rbId, entCfgCfm->status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         default:
            {
               ...
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 602); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwCfgReq(pst, cfg(ueId(%d),                  cellId(%d), cfgType(%d), rbId(%d)) Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->entCfg[idx].rbId, 15); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 650 "../..//lterlcpdcp/kw_uim.c"
   return(0);
}
# 666 "../..//lterlcpdcp/kw_uim.c"
...
# 682 "../..//lterlcpdcp/kw_uim.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 694); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwUeIdChgReq(pst, spId(%d), transId(%ld))\n", spId, transId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
  ...
  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x00410004, KW_DIAG_UEID, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, ueInfo->ueId, newUeInfo->ueId, ueInfo->cellId, newUeInfo->cellId, 0, "Received UeId Change request at RLC from RRC, newUeId = %d, oldCellId = %d, newCellId = %d"); }}
   ...
   if (kwCfgUeIdChng(ueInfo, newUeInfo, &status) != 0)

   {

      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 718); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiCkwUeIdChgReq(pst, oldUe(ueId(%d),         cellId(%d)), newUe(ueId(%d), cellId(%d))\n kwCfgUeIdChng Failed: reason (%d)\n", ueInfo->ueId, ueInfo->cellId, newUeInfo->ueId, newUeInfo->cellId, status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&tUeInfo, (Size) sizeof(CkwUeInfo)) == 0) { cmMemset((U8 *)(tUeInfo), 0, sizeof(CkwUeInfo)); } else { (tUeInfo) = 0L; } };
# 738 "../..//lterlcpdcp/kw_uim.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 797); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuBndReq(pst, spId(%d), suId(%d))\n", spId, suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x00410005, KW_DIAG_NA, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, spId, suId, 0, 0, "Received BndReq from User, spId = %d, suId = %d"); }}
...
# 826 "../..//lterlcpdcp/kw_uim.c"
   switch(kwuSap->state)
   {
      ...
      case 4:
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 0))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 843); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuBndReq: state (%d)\n", kwuSap->state); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 2:
      {
         ...
         if (kwuSap->pst.dstProcId != pst->srcProcId
               ...
               || kwuSap->suId != suId)
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 866); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuBndReq(pst, suId(%d)<>suId(%d),\n               pst->srcProcId(%d)<>kwuSap->pst.dstProcId(%d),\n                     pst->srcEnt(%d)<>kwuSap->pst.dstEnt(%d),\n                     pst->srcInst(%d)<>kwuSap->pst.dstInst(%d))\n", suId, kwuSap->suId, pst->srcProcId, kwuSap->pst.dstProcId, pst->srcEnt, kwuSap->pst.dstEnt, pst->srcInst, kwuSap->pst.dstInst); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 868 "../..//lterlcpdcp/kw_uim.c"
            { kwLmmSendAlarm(2, (256 + 2), 13, spId, 0); };
            ret = 1;
         }
         break;
      }
     ...
     default:
      {
# 884 "../..//lterlcpdcp/kw_uim.c"
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 885); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuBndReq: KWU SAP State is Invalid during Bind Req"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 947); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuUbndReq(pst, spId(%d), reason(%d))\n", spId, reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x00410006, KW_DIAG_NA, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, spId, 0, 0, 0, "Received UbndReq from User, spId = %d"); }}
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1018); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if(kwuSap->state != 2) { ; { kwLmmSendAlarm(2, 1, 9, 0, 0); }; ret = 1; } };
   if (ret != 0)
   {

      { if (datReq != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datReq, (Size) sizeof(KwuDatReqInfo)); datReq = 0L; } };
      { if (mBuf != 0L) { SPutMsg(mBuf); } mBuf = 0L;};
      return(1);
   }


   if (kwDbmFetchRbCbForUi(datReq->rlcId, &rbCb) != 0)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1038); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: RLCID not found ueId(%d), cellId(%d), rbId(%d)", datReq->rlcId.ueId, datReq->rlcId.cellId, datReq->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
  ...
  { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x00410007, KW_DIAG_UEID, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, datReq->rlcId.ueId, rbCb->mode, 0, 0, 0, "Received DatReq from RRC/PDCP, RB Mode = %d"); }}





   { if (!(rbCb->dir & 2)) { ; return(1); } };
   ...
   switch (rbCb->mode)
   {
      case 1:
         {
            ...
            if ( (rbCb->mode == 1) && (pst->srcEnt != 0xd9) )
            {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1076); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: kwTmmQSdu failed ueId(%d), cellId(%d), rbId(%d)", datReq->rlcId.ueId, datReq->rlcId.cellId, datReq->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 2:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1089); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: kwUmmQSdu failed ueId(%d), cellId(%d), rbId(%d)", datReq->rlcId.ueId, datReq->rlcId.cellId, datReq->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 3:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1104); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: kwAmmQSdu failed ueId(%d), cellId(%d), rbId(%d)", datReq->rlcId.ueId, datReq->rlcId.cellId, datReq->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      default:
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1116); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: wrong mode ueId(%d), cellId(%d), rbId(%d) mode(%d)", datReq->rlcId.ueId, datReq->rlcId.cellId, datReq->rlcId.rbId, rbCb->mode); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1174); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (ret != 0)
   {
      ...
      { if (discSdu != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) discSdu, (Size) sizeof(KwuDiscSduInfo)); discSdu = 0L; } };
      return(1);
   }


   if (kwDbmFetchRbCbForUi(discSdu->rlcId, &rbCb) != 0)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1193); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq: RLCID not found ueId(%d), cellId(%d), rbId(%d)", discSdu->rlcId.ueId, discSdu->rlcId.cellId, discSdu->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   switch (rbCb->mode)
   {
      case 2:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1213); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq: kwUmmDiscSdu failed ueId(%d), cellId(%d), rbId(%d)", discSdu->rlcId.ueId, discSdu->rlcId.cellId, discSdu->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 3:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1224); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq: kwAmmDiscSdu failed ueId(%d), cellId(%d), rbId(%d)", discSdu->rlcId.ueId, discSdu->rlcId.cellId, discSdu->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      default:
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1233); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq: mode wrong ueId(%d), cellId(%d), rbId(%d), mode(%d)", discSdu->rlcId.ueId, discSdu->rlcId.cellId, discSdu->rlcId.rbId, rbCb->mode); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   switch (rbCb->mode)
   {
      case 2:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1278); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq: kwUmmDiscSdu failed ueId(%d), cellId(%d), rbId(%d)", rbCb->rlcId.ueId, rbCb->rlcId.cellId, rbCb->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 3:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1289); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq: kwAmmDiscSdu failed ueId(%d), cellId(%d), rbId(%d)", rbCb->rlcId.ueId, rbCb->rlcId.cellId, rbCb->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      default:
         {
            ret = 1;
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1298); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDiscSduReq: mode wrong ueId(%d), cellId(%d), rbId(%d), mode(%d)", rbCb->rlcId.ueId, rbCb->rlcId.cellId, rbCb->rlcId.rbId, rbCb->mode); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   switch (rbCb->mode)
   {
      case 2:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1336); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: kwUmmQSdu failed ueId(%d), cellId(%d), rbId(%d)", rbCb->rlcId.ueId, rbCb->rlcId.cellId, rbCb->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 3:
         {
            ...
            if ( ret != 0 )
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1347); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: kwAmmQSdu failed ueId(%d), cellId(%d), rbId(%d)", rbCb->rlcId.ueId, rbCb->rlcId.cellId, rbCb->rlcId.rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      default:
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 7) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 7) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_uim.c", 1355); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "KwUiKwuDatReq: wrong mode ueId(%d), cellId(%d), rbId(%d) mode(%d)", rbCb->rlcId.ueId, rbCb->rlcId.cellId, rbCb->rlcId.rbId, rbCb->mode); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
