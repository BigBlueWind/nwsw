...
#endif
{
   ...
   /* ccpu00125923: removed klocwork fix */
   if (!localAddr)
   {
      EG_DBG_ERR(0,0, (egp,"\n localAddr: NULLP "));
		/* ccpu00125923 : klocwork fix , added memset here */
		cmMemset( (U8* )&sta, 0, sizeof(EgUsta));
   ...
   UNUSED(pst);
	...
	/* ccpu00125923: klocwork fix removed memset here */
   ...
   if (suConnId < egCb.genCfg.nmbSrvs)
   {
      ...
      {
         EG_DBG_ERR(0,0, (egp,"\n Invalid suConnId"));
			/* ccpu00125923:: klocwork fix : memset added here */
			cmMemset( (U8* )&sta, 0, sizeof(EgUsta));
...
/* eg004.201 Update stable state of TSAP when tpt server opened*/
			...
			/* ccpu00125923:: klocwork fix, setting flag */
            hwUpdFlag = TRUE;
#endif
         }
         break;
...
/main/3      eg009.201    asaurabh          1. Klocwrok fixes added here
 *********************************************************************91*/
