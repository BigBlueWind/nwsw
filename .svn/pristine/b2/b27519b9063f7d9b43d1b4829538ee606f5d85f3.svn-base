...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 123 "../..//lterlcpdcp/kw_pj_ulm.c" 2
# 1 "../..//cm/cm5.h" 1
# 124 "../..//lterlcpdcp/kw_pj_ulm.c" 2
# 1 "../..//cm/cm_lte.h" 1
# 91 "../..//cm/cm_lte.h"
#define __CM_LTE_H__ 
# 101 "../..//cm/cm_lte.h"
...
# 146 "../..//lterlcpdcp/kw_pj_ulm.c" 2
# 1 "../..//cm/cm5.x" 1
# 147 "../..//lterlcpdcp/kw_pj_ulm.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 158 "../..//lterlcpdcp/kw_pj_ulm.c" 2
# 201 "../..//lterlcpdcp/kw_pj_ulm.c"
 S16 pjUlmHdlSrbPkt
(
PjRbCb *pjRbCb,
Buffer *pdu
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 221); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmHdlSrbPkt(pjRbCb(%d,%d)) \n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 239 "../..//lterlcpdcp/kw_pj_ulm.c"
   res = (hdrByte >> 5);
   if(res != 0)
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 243); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Reserved Values Non-zero \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

      { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L; };
      { kwCb.pjGenSts.errorPdusRecv++; };
      return(1);
   }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 298); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmHdlDrbPkt(pjRbCb(%d,%d))\n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 308 "../..//lterlcpdcp/kw_pj_ulm.c"
   ret = SRemPreMsg(&hdrByte, pdu);
# 321 "../..//lterlcpdcp/kw_pj_ulm.c"
   if((hdrByte & 0x80) == 0x80)
   {
      ...
      else
      {
         ...
         if (res != 8)
         {
            do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 336); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Reserved Values Non-zero \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         sn = sn << 8;
         ret = SRemPreMsg(&hdrByte, pdu);
# 355 "../..//lterlcpdcp/kw_pj_ulm.c"
         sn |= hdrByte;
      }
# 370 "../..//lterlcpdcp/kw_pj_ulm.c"
      if(pjRbCb->mode == 3)
      {
...
# 399 "../..//lterlcpdcp/kw_pj_ulm.c"
      ...
      else if(pduType == 0x01)
      {
         ...
         if(res != 0)
         {
            do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 421); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Reserved values non-null \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      else
      {
         ...
         do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 433); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," Invalid PDU Type \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 492); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmProcessSrb(pjRbCb(%d,%d),sn(%d)) \n", pjRbCb->rbId, pjRbCb->rbType, sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if(sn < pjRbCb->ulCb.nxtRxSn) { pjRbCb->ulCb.rxHfn++; } pjRbCb->ulCb.nxtRxSn = (sn + 1) % (1 << pjRbCb->snLen); if(pjRbCb->ulCb.nxtRxSn == 0) { pjRbCb->ulCb.rxHfn ++; } };
   ;


   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&rxEnt, (Size) sizeof(PjRxEnt)) == 0) { cmMemset((U8 *)(rxEnt), 0, sizeof(PjRxEnt)); } else { (rxEnt) = 0L; } };
# 514 "../..//lterlcpdcp/kw_pj_ulm.c"
   rxEnt->count = count;
   rxEnt->state = 1;
   rxEnt->mBuf = pdu;

   ret = pjDbmInsRxEnt(&ulCb->recBuf, rxEnt, 0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 579); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmProcessDrbUm(pjRbCb(%d,%d),sn(%d)) \n", pjRbCb->rbId, pjRbCb->rbType, sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 1) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 676); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmProcessDrbAm(pjRbCb(%d,%d),sn(%d)) \n", pjRbCb->rbId, pjRbCb->rbType, sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&rxEnt, (Size) sizeof(PjRxEnt)) == 0) { cmMemset((U8 *)(rxEnt), 0, sizeof(PjRxEnt)); } else { (rxEnt) = 0L; } };
# 700 "../..//lterlcpdcp/kw_pj_ulm.c"
   if(( (((sn - (ulCb->lastSubCnt % (1 << 12 ))) % (1 << 12 )) > 2048) || ((((ulCb->lastSubCnt % (1 << 12 )) - sn) >= 0) && (((ulCb->lastSubCnt % (1 << 12 )) - sn) < 2048)) ))
   {
      rxEnt->discFlag = 1;
      if(sn > ulCb->nxtRxSn)
      {
   ...
   ;
   ret = pjDbmInsRxEnt(&ulCb->recBuf, rxEnt, 1);
   if(ret == 12)
   {
   ...
   if(dupEntry == 1)
   {
      ...
      { if (rxEnt != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) rxEnt, (Size) sizeof(PjRxEnt)); rxEnt = 0L; } };
   }
   else if(discFlag == 1)
   {
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 825); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmHdlDecipher(pjRbCb(%d,%d),rxEnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, rxEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 833 "../..//lterlcpdcp/kw_pj_ulm.c"
   ulCb = &pjRbCb->ulCb;


   if(pjRbCb->ueCb->secInfo.secAct == 1)
   {
      ...
      else
      {
         ...
         if( pjUtlDecipherReq(pjRbCb, inParam, rxEnt->mBuf, &mBuf) != 0)
         {
            ;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 954); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmHdlIntVer(pjRbCb(%d,%d),rxEnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, rxEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 962 "../..//lterlcpdcp/kw_pj_ulm.c"
   ulCb = &pjRbCb->ulCb;
...
# 991 "../..//lterlcpdcp/kw_pj_ulm.c"
      if( pjUtlIntVerReq(pjRbCb, inParam, rxEnt->mBuf, macI, &status) != 0)
      {
         ;
         ...
         pjUlmSndPjuStaInd(pjRbCb, rxEnt);
         pjDbmDelRxEnt(&ulCb->recBuf, rxEnt->count);
         { kwCb.pjGenSts.numIntgVrfFails++; };
         return(1);
      }


      ret = SRemPreMsg((Data *)&sn, rxEnt->mBuf);
# 1036 "../..//lterlcpdcp/kw_pj_ulm.c"
   }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1085); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmHdlDeCmp(pjRbCb(%d,%d),rxEnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, rxEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1093 "../..//lterlcpdcp/kw_pj_ulm.c"
   ulCb = &pjRbCb->ulCb;
   ...
   if(pjRbCb->rohc.hdrCmpUsed == 1)
   {
      ...
      if(pjUtlDeCmpReq(pjRbCb,rxEnt->count, rxEnt->mBuf, &mBuf) != 0)
      {
         ;
         ...
         pjUlmSndPjuStaInd(pjRbCb, rxEnt);
         pjDbmDelRxEnt(&ulCb->recBuf, rxEnt->count);
         { kwCb.pjGenSts.numDecmpFails++; };
         return(1);
      }
# 1117 "../..//lterlcpdcp/kw_pj_ulm.c"
      if(mBuf == 0L)
      {
         ;
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1194); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmDeliverSrb(pjRbCb(%d,%d),rxEnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, rxEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1206 "../..//lterlcpdcp/kw_pj_ulm.c"
   ulCb = &pjRbCb->ulCb;
   ...
   pjDbmDelRxEnt(&ulCb->recBuf, rxEnt->count);
# 1252 "../..//lterlcpdcp/kw_pj_ulm.c"
   return(0);
}
# 1282 "../..//lterlcpdcp/kw_pj_ulm.c"
...

{
   ...
   PjUlCb *ulCb;
# 1303 "../..//lterlcpdcp/kw_pj_ulm.c"
   ;

   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1307); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmDeliverDrbUm(pjRbCb(%d,%d),rxEnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, rxEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1315 "../..//lterlcpdcp/kw_pj_ulm.c"
   ulCb = &pjRbCb->ulCb;


   rxEnt->state = 7;
# 1328 "../..//lterlcpdcp/kw_pj_ulm.c"
   ;
# 1340 "../..//lterlcpdcp/kw_pj_ulm.c"
   pjUlmSndPjuDatInd(pjRbCb, rxEnt);


   pjDbmDelRxEnt(&ulCb->recBuf, rxEnt->count);
# 1400 "../..//lterlcpdcp/kw_pj_ulm.c"
   return(0);
}
# 1427 "../..//lterlcpdcp/kw_pj_ulm.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1449); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmDeliverDrbAm(pjRbCb(%d,%d),rxEnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, rxEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1457 "../..//lterlcpdcp/kw_pj_ulm.c"
   ret = 0;
   ulCb = &pjRbCb->ulCb;
...
# 1550 "../..//lterlcpdcp/kw_pj_ulm.c"
   return(ret);
}
# 1576 "../..//lterlcpdcp/kw_pj_ulm.c"
 S16 pjUlmReEstSrb
(
PjRbCb *pjRbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1588); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmReEstSrb(pjRbCb) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1645); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmReEstDrbAm(pjRbCb(%d,%d)) \n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 1679 "../..//lterlcpdcp/kw_pj_ulm.c"
         datFwdInd->dir = 1;
         datFwdInd->numSdus = ulCb->recBuf.numEntries;
         { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&datFwdInd->datFwdInfo, (Size) datFwdInd->numSdus * sizeof(PjuDatFwdInfo)) == 0) { cmMemset((U8 *)(datFwdInd->datFwdInfo), 0, datFwdInd->numSdus * sizeof(PjuDatFwdInfo)); } else { (datFwdInd->datFwdInfo) = 0L; } };
# 1692 "../..//lterlcpdcp/kw_pj_ulm.c"
      }
   }
   ...
   fms = (ulCb->lastSubCnt + 1) % (1 << pjRbCb->snLen);
   nxtRxCnt = (ulCb->rxHfn << 12) | ulCb->nxtRxSn;
   ...
   for(count = (ulCb->lastSubCnt + 2); count < nxtRxCnt; count ++)
   {
      ...
      if(tmpEnt != 0L)
      {
         ...
         if(pjRbCb->state == 3)
         {
            ...
            SCpyMsgMsg(tmpEnt->mBuf, 0L, 0L,
                  &datFwdInd->datFwdInfo[datFwdCnt].sdu);
            datFwdCnt++;
            { kwCb.pjGenSts.numPktsFrwd++; };
         }
      }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1808); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmBldStaRep(pjRbCb(%d,%d)) \n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if(pjRbCb->state == 3)
   {
      ...
      if(len != 0)
      {
         { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&sduSta, (Size) len) == 0) { cmMemset((U8 *)(sduSta), 0, len); } else { (sduSta) = 0L; } };
# 1830 "../..//lterlcpdcp/kw_pj_ulm.c"
         ret = SCpyMsgFix(staRep, 0, len, sduSta, &cCnt);
# 1841 "../..//lterlcpdcp/kw_pj_ulm.c"
      ...
      { fmsCnt = (fmsHfn << (pjRbCb->snLen)) | fms; };
      ...
      { if (staRep != 0L) { SPutMsg(staRep); } staRep = 0L; };
   }
   else
   {
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 1938); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmHdlDatFwdReq(pjRbCb(%d,%d), datFwdReq) \n", pjRbCb->rbId, pjRbCb->rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   for( sduIndex = 0; sduIndex < datFwdReq->numSdus; sduIndex++)
   {
      ...
      { kwCb.pjGenSts.numPktsRcvd++; };


      { if((pjRbCb->ulCb.nxtRxSn == 0) && (pjRbCb->ulCb.rxHfn == 0)) { { datFwdCnt = (0 << 12) | (info->sn); }; } else if((info->sn) >= pjRbCb->ulCb.nxtRxSn) { { datFwdCnt = ((pjRbCb->ulCb.rxHfn) << 12) | (info->sn); }; } else { { datFwdCnt = ((pjRbCb->ulCb.rxHfn + 1) << 12) | (info->sn); }; } };



      { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&rxEnt, (Size) sizeof(PjRxEnt)) == 0) { cmMemset((U8 *)(rxEnt), 0, sizeof(PjRxEnt)); } else { (rxEnt) = 0L; } };
# 1965 "../..//lterlcpdcp/kw_pj_ulm.c"
      rxEnt->count = datFwdCnt;
      rxEnt->state = 7;
      rxEnt->mBuf = info->sdu;


      pjDbmInsRxEnt(&ulCb->recBuf, rxEnt, 0);
   }

   return(0);
}
# 2000 "../..//lterlcpdcp/kw_pj_ulm.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 2023); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmSubmitForDecmp(pjRbCb(%d,%d),rxEnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, rxEnt->count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2031 "../..//lterlcpdcp/kw_pj_ulm.c"
   ulCb = &pjRbCb->ulCb;
   rxEnt->state = 5;
   ...
   if(pjUlmHdlDeCmp(pjRbCb, rxEnt) != 0)
   {
      return(1);
   }
# 2101 "../..//lterlcpdcp/kw_pj_ulm.c"
   return(0);

}
# 2236 "../..//lterlcpdcp/kw_pj_ulm.c"
...
{
# 2259 "../..//lterlcpdcp/kw_pj_ulm.c"
   ;;


   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) )) ^ ((((0x00000002 << 4) << 11) << 1) | (0x00000002 << 0) ))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_ulm.c", 2264); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "pjUlmHdlErrUpdates(pjRbCb(%d,%d),errCnt(%ld)) \n", pjRbCb->rbId, pjRbCb->rbType, errCnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2278 "../..//lterlcpdcp/kw_pj_ulm.c"
   ;
# 2407 "../..//lterlcpdcp/kw_pj_ulm.c"
   return;
}
# 2517 "../..//lterlcpdcp/kw_pj_ulm.c"
 Void pjUlmDeliverPdu
(
PjRbCb *pjRbCb,
PjRxEnt *rxEnt
)
...
# 2552 "../..//lterlcpdcp/kw_pj_ulm.c"
 Void pjUlmDeliverDrb
(
PjRbCb *pjRbCb,
PjRxEnt *rxEnt
)
...
# 2584 "../..//lterlcpdcp/kw_pj_ulm.c"
 Void pjUlmDecReEstCnt
(
PjRbCb *pjRbCb
)
...

{
   ...
   {
      if(pjRbCb->ueCb->libInfo.state == 2)
      {
         pjUtlReEstReconfig(pjRbCb->ueCb, pjRbCb->rbType);
      }
      else if(pjRbCb->ueCb->libInfo.state == 3)
      {
         pjUtlReEstDl(pjRbCb->ueCb);
      }
   }
}
# 2678 "../..//lterlcpdcp/kw_pj_ulm.c"
 Void pjUlmSndPjuDatInd
(
PjRbCb *pjRbCb,
PjRxEnt *rxEnt
)
...
# 2738 "../..//lterlcpdcp/kw_pj_ulm.c"
      { if (pjRbCb->rbType == 0) kwCb.pjuSap[0].sts.txSdus++; else kwCb.pjuSap[1].sts.txSdus++; };
   }
}
# 2752 "../..//lterlcpdcp/kw_pj_ulm.c"
 Void pjUlmSndPjuStaInd
(
PjRbCb *pjRbCb,
PjRxEnt *rxEnt
)
...

{
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&staInd, (Size) sizeof(PjuStaIndInfo)) == 0) { cmMemset((U8 *)(staInd), 0, sizeof(PjuStaIndInfo)); } else { (staInd) = 0L; } };
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&pdcpId, (Size) sizeof(CmLtePdcpId)) == 0) { cmMemset((U8 *)(pdcpId), 0, sizeof(CmLtePdcpId)); } else { (pdcpId) = 0L; } };
   if(staInd != 0L && pdcpId != 0L)
   {
      pdcpId->ueId = pjRbCb->ueCb->key.ueId;
      pdcpId->cellId = pjRbCb->ueCb->key.cellId;
      pdcpId->rbId = pjRbCb->rbId;
