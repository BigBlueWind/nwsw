...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 117 "../..//ltemac/rg_sch_gom.c" 2
# 1 "../..//cm/cm5.x" 1
# 118 "../..//ltemac/rg_sch_gom.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 199 "../..//ltemac/rg_sch_gom.c"
{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 212); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Handling RGR Config request: " "action %d cfgType %d\n", cfgReqInfo->action, cfgReqInfo->u.cfgInfo.cfgType); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };



   if (cfgReqInfo->action != 2)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 217); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Applying RGR cell" " Config/Delete \n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 225); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Action.Cofgig Type Error\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if(0L != instCb->rgrSap[spId].cell)
   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 237); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Cell with Id %d already exists " "on sap %d\n", instCb->rgrSap[spId].cell->cellId, spId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if (ret != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 250); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHGomHndlCfg: Enqueuing CfgReq " "Failed \n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 257); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR Config Request handling done\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(0);
   }
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 260); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "NO CELL!! RGR Config Request Failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   SPutSBuf(reg, pool, (Data *)cfgReqInfo, (Size)sizeof(*cfgReqInfo));
   rgSCHUtlRgrCfgCfm(instCb->rgSchInit.inst, spId, transId, cfmStatus);
   return(1);

}
# 294 "../..//ltemac/rg_sch_gom.c"
...
# 312 "../..//ltemac/rg_sch_gom.c"
{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 322); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Processing RGR Config request: " "action %d\n", cfgReqInfo->action); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch (cfgReqInfo->action)
   {
      ...
      default:
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 354); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid configuration " "action %d\n", cfgReqInfo->action); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   rgSCHUtlRgrCfgCfm(instCb->rgSchInit.inst, spId, transId, cfmStatus);
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 367); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR Configuration request processed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   return(ret);
}
# 401 "../..//ltemac/rg_sch_gom.c"
...
# 417 "../..//ltemac/rg_sch_gom.c"
{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 425); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Enqueuing RGR config request\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

   {
      ...
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 460); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid activation time for RGR " "config request: activation sfn %d activation subframe %d current " "sfn %d current subframe %d", actvTime.sfn, actvTime.subframe, cell->crntTime.sfn, cell->crntTime.subframe); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if (sfDiff > (20 * 10))
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 474); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid activation time for RGR" " config request: activation sfn %d activation subframe %d " "current sfn %d current subframe %d", actvTime.sfn, actvTime.subframe, cell->crntTime.sfn, cell->crntTime.subframe); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if (sfDiff)
      {
         ...
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 487); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Pending RGR Config Request" " Enqueued\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 496); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Current RGR Config Request " "Enqueued\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   return(0);
}
# 525 "../..//ltemac/rg_sch_gom.c"
...

{
   ...
   while ((cfgElem = rgSCHDbmGetNextCrntRgrCfgElem(cell, 0L)) != 0L)
   {
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 546); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Applying enqueued current RGR " "Configuration\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while((cfgElem = rgSCHDbmGetPndngRgrCfgElemByKey(cell, cell->crntTime)) != 0L)
   {
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 560); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Applying enqueued pending RGR " "Configuration\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 569); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR Configuration applied\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   return(0);
}
# 598 "../..//ltemac/rg_sch_gom.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 621); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Processing RGR Configuration request:" " configType %d\n", cfg->cfgType); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch (cfg->cfgType)
   {
      case 1:
      {
         ret = rgSCHCfgVldtRgrCellCfg(inst, &cfg->u.cellCfg, cell, errInfo);
            if (ret != 0)
            {
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 634); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Rgr Cell configuration " "validation FAILED: Cell %d\n", cfg->u.cellCfg.cellId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 2:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 646); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Ue configuration validation" " FAILED: Ue %d\n", cfg->u.ueCfg.crnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 658); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "LC configuration validation " "FAILED: LC %d\n", cfg->u.lchCfg.lcId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 4:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 670); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "LCG configuration validation " "FAILED: Lcg %d\n", cfg->u.lcgCfg.ulInfo.lcgId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 686); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR Configuration processed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   return(ret);
}
# 715 "../..//ltemac/rg_sch_gom.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 740); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Processing RGR Reconfiguration request:" "reconfigType %d\n", recfg->recfgType); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch (recfg->recfgType)
   {
      case 1:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 754); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Rgr Cell Recfg Validation " "FAILED\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      case 2:
      {
         ...
         if ( ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 765); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Ue Recfg Validation FAILED\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
            return(1);
         }
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 777); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Lc Recfg Validation FAILED\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
            return(1);
         }
      ...
      case 4:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 789); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Lcg Recfg Validation FAILED\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
            return(1);
         }
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 805); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR Reconfiguration processed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   return(ret);
}
# 831 "../..//ltemac/rg_sch_gom.c"
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 855); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Processing RGR UE Reset request:" "CellId %d UE Id %d \n", reset->cellId, reset->crnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 863); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Rgr UE Reset Validation FAILED\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 870); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Rgr UE Reset FAILED\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }

   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 874); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR Reset Request processed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   return(ret);
}
# 902 "../..//ltemac/rg_sch_gom.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 925); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Processing RGR Delete request:" "delType %d\n", del->delType); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 931); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Cell doesnt exist"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
...
# 967 "../..//ltemac/rg_sch_gom.c"
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 989); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR deletion processed \n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   return(ret);
}
# 1016 "../..//ltemac/rg_sch_gom.c"
      ...
      case 2:
         {
            ...
            else if (rgrCfgReq->u.recfgInfo.recfgType == 2)
            {
...
# 1116 "../..//ltemac/rg_sch_gom.c"
{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 1130); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Processing RGR SI Configuration" " request:"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };



   if (((U8 *)cell == 0L) || (cell->cellId != cfgReqInfo->cellId))
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 1136); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Cell Control block does not exist\n" ); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 1148); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Rgr SI configuration " "validation FAILED\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 1162 "../..//ltemac/rg_sch_gom.c"
   if ( RGR_SI_CFG_TYPE_MIB != cfgReqInfo->cfgType)
   {
      ...
      if ( tbSz != (msgLen*8) )
      {
         ...
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 1180); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Rgr SI configuration " "SGetSBuf failed for padding failed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         ...
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 1191); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Rgr SI configuration " "Failed to add padding bytes\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch(cfgReqInfo->cfgType)
   {
      case RGR_SI_CFG_TYPE_MIB:
         do{ if(0L == cell->siCb.crntSiInfo.mib) { cell->siCb.crntSiInfo.mib = cfgReqInfo->pdu; } else { if(0L != cell->siCb.newSiInfo.mib) { SPutMsg(cell->siCb.newSiInfo.mib); cell->siCb.newSiInfo.mib = 0L; } cell->siCb.newSiInfo.mib = cfgReqInfo->pdu; cell->siCb.siBitMask |= (1<<1); }}while(0);
      ...
      case RGR_SI_CFG_TYPE_SIB1:
         do{ if(0L == cell->siCb.crntSiInfo.sib1) { cell->siCb.crntSiInfo.sib1 = cfgReqInfo->pdu; } else { if(0L != cell->siCb.newSiInfo.sib1) { SPutMsg(cell->siCb.newSiInfo.sib1); cell->siCb.newSiInfo.sib1 = 0L; } cell->siCb.newSiInfo.sib1 = cfgReqInfo->pdu; cell->siCb.siBitMask |= (1<<2); }}while(0);
      ...
      case RGR_SI_CFG_TYPE_SI:
         do{ if(0L == cell->siCb.crntSiInfo.si[cfgReqInfo->siId-1]) { cell->siCb.crntSiInfo.si[cfgReqInfo->siId-1] = cfgReqInfo->pdu; } else { if(0L != cell->siCb.newSiInfo.si[cfgReqInfo->siId-1]) { SPutMsg(cell->siCb.newSiInfo.si[cfgReqInfo->siId-1]); cell->siCb.newSiInfo.si[cfgReqInfo->siId-1] = 0L; } cell->siCb.newSiInfo.si[cfgReqInfo->siId-1] = cfgReqInfo->pdu; cell->siCb.siBitMask |= (1<<3); }}while(0);
      ...
      default:
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 1227); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Invalid cfgType " "parameter value\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_gom.c", 1240); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RGR SI Configuration processed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
