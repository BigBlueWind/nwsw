...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 113 "../..//lterrc/nh_uim.c" 2
# 1 "../..//cm/cm5.x" 1
# 114 "../..//lterrc/nh_uim.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 122 "../..//lterrc/nh_uim.c" 2





 PCDFS16 nhUISMTbl[17] =
{
   0L,
   nhCPMHndlDlDirTx,
   nhCCMSecModCmdHndlr,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 197); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Received Bind Request from RRC user(suId(%d), spId(%d)) \n", suId, spId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   { (ret) = 0; if (nhCb.init.cfgDone != 1) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 202); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: General Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = 8; } if(((ret) == 0) && (nhCb.eNodeBCb.cfgDone != 1)) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 202); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: Protocol Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = (256); } };
   if( ret != 0)
   {
   ...
   if (ret == 1)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 222); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid SAP state(%d) while processing bind request from the RRC user", nhCb.uSapCb->state); SPrint((&nhCb.init)->prntBuf); } }; };


      dgn.type = 3;
      dgn.u.sapInfo.sapId = spId;
      dgn.u.sapInfo.sapElmId = 2;
   ...
   if (0 != NhUiNhuBndCfm(&lmPst, suId, 1))
   {
      event = 8;
   }
...

{
   ...
   (pst=pst);
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 305); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received Unbind Request from RRC user(spId(%d), reason(%d)) \n", spId, reason); SPrint((&nhCb.init)->prntBuf); } }; };



   { (ret) = 0; if (nhCb.init.cfgDone != 1) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 307); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: General Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = 8; } if(((ret) == 0) && (nhCb.eNodeBCb.cfgDone != 1)) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 307); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: Protocol Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = (256); } };
   if( ret != 0)
   {
   ...
   if (ret == 1)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 324); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid SAP state(%d) while processing Unbind request", nhCb.uSapCb->state); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 386); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received data response from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   msgChoice = 0;
   cellAndUeCb.ueCb = 0L;
   cellAndUeCb.cellCb = 0L;
   do { (Void)cmMemset((U8*)(&errInd), 0, (Size)(sizeof(NhuErrIndSdus))); } while(0);

   errInfo = &(errInd.sdu);



   if ((nhuDataRspSdus) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 404); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL nhuDataRspSdus\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   ...
   if(0 != ret)
   {
      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 416); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataRspSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      do { cmFreeMem((nhuDataRspSdus)); (nhuDataRspSdus) = 0L; } while(0);

      return(1);
   }


   if (1 == nhuDataRspSdus->sdu.isUeCfgPres)
   {
      if (0 != nhUTLValidateUeCfg(&(nhuDataRspSdus->sdu.ueCfg),
                                    cellAndUeCb.ueCb, errInfo))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 430); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Config in Data Response Validation                   Failed  (ErrorType(%d), ErrorCause(%d)) \n", errInfo->errType, errInfo->errCause); SPrint((&nhCb.init)->prntBuf); } }; };



         { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 432); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataRspSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
         do { cmFreeMem((nhuDataRspSdus)); (nhuDataRspSdus) = 0L; } while(0);
         return(1);
      }
   }

   datReqRspSdu.isDatReqSdu = 0;
   ...
   if (nhEvnt != 0)
   {
      ...
      if (0 != ret)
      {
         ...
         { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 449); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataRspSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
         do { cmFreeMem((nhuDataRspSdus)); (nhuDataRspSdus) = 0L; } while(0);
         return(ret);
      }
   }
...

{
   ...
   Bool createUeCtxt = 0;
   Bool reCfgUeCtxt = 0;
   NhuUeCfgInfo *cfgInfo = 0L;
   NhCellAndUeCb cellAndUeCb;
   NhuErrorInfo *errInfo;

   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 508); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received configuration request from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if ((nhuCfgReqSdu) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 522); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL nhuCfgReqSdu\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   ...
   if(0 != nhUTLValidateCfgReq(nhuCfgReqSdu, &ueCb, &cellCb, errInfo))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 536); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE Config request Validate failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 537); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuCfgReqSdu->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      do { cmFreeMem((nhuCfgReqSdu)); (nhuCfgReqSdu) = 0L; } while(0);
      return(1);
   }
   ...
   if (nhuCfgReqSdu->cfgInfo.ueCfgBitMsk & 0x08)
   {
      ...
      if(ueCb == 0L)
      {
         ...
         if (0 != ret)
       {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 556); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE CB creation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

            { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x26); };

            { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 559); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuCfgReqSdu->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
            do { cmFreeMem((nhuCfgReqSdu)); (nhuCfgReqSdu) = 0L; } while(0);
            return(ret);
         }
         createUeCtxt = 1;
         if(nhuCfgReqSdu->cfgInfo.conReCfgCause & 0x01)
         {
            ...
            ueCb->hoToEutraOrMobFrmEutra = 30;
         }
      }
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 591); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhCGMCfgReq: Could not create Trans block \n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      if(nhuCfgReqSdu->cfgInfo.conReCfgCause & 0x01 ||
               cellAndUeCb.ueCb->rbSecCfgBitMask & 0x04)
      {

         transCb->enblSelSecModeCfg = 0x00;
      }
      else
      {


         transCb->enblSelSecModeCfg = 0x01;
      }
   }
   ...
   if(createUeCtxt)
   {
      transCb->ordrdCfg.ueInfo.crntiCfgType = 0x01;
      transCb->ordrdCfg.ueInfo.u.newCrnti =
         nhuCfgReqSdu->cfgInfo.ueInfo.newCrnti;
   }
   else if(reCfgUeCtxt)
   {
      transCb->ordrdCfg.ueInfo.crntiCfgType = 0x02;
   ...
   if(retVal != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 644); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Lower layer config failed during UE config \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x0b); };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 664); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuCfgReqSdu->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
...

{
   ...
   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 715); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received cell configuration request from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if ((nhuCellCfgReqSdu) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 727); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL nhuCellCfgReqSdu\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   ...
   {
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x06); };

      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 737); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuCellCfgReqSdu->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      do { cmFreeMem((nhuCellCfgReqSdu)); (nhuCellCfgReqSdu) = 0L; } while(0);
      return(1);
   }
   ...
   if (0 != ret)
   {
      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 747); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuCellCfgReqSdu->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      do { cmFreeMem((nhuCellCfgReqSdu)); (nhuCellCfgReqSdu) = 0L; } while(0);
      return(1);
   }
   ...
   if (0 != ret)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 756); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell config failed for cell:%d \n", nhuCellCfgReqSdu->hdr.cellId); SPrint((&nhCb.init)->prntBuf); } }; };

      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 757); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuCellCfgReqSdu->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      do { cmFreeMem((nhuCellCfgReqSdu)); (nhuCellCfgReqSdu) = 0L; } while(0);
      return(0);
   }
...

{
   ...
   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 812); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received cancel UE  request from RRC User (spId(%d), cellId(%d))\n", spId, cellId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   do { (Void)cmMemset((U8*)(&hdr), 0, (Size)(sizeof(NhuHdr))); } while(0);

   errInfo = &(errInd.sdu);

   if (!cellId)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 826); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell Id is Zero \n"); SPrint((&nhCb.init)->prntBuf); } }; };

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x06); };

      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 830); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(1);
   }
   ...
   if(0L == cellCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 838); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NULL CELL CB %d \n", cellId); SPrint((&nhCb.init)->prntBuf); } }; };

      hdr.ueId = crnti;
      hdr.cellId = cellId;

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x05); (*errInfo).errCause = (0x02); };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 846); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(1);
   }


   if (0L == (ueCb = nhDBMGetUeCb(cellCb, crnti)))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 853); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NULL UE CB %d \n", crnti); SPrint((&nhCb.init)->prntBuf); } }; };


      hdr.ueId = crnti;
      hdr.cellId = cellId;

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x05); (*errInfo).errCause = (0x03); };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 862); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(1);
   }
...
# 908 "../..//lterrc/nh_uim.c"
{
   ...
   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 920); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received Delete Transaction request from RRC User (spId(%d),               cellId(%d))\n", spId, cellId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (!cellId)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 931); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell Id is Zero \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      hdr.cellId = cellId;
      hdr.ueId = crnti;
      hdr.transId = transId;
      ...
      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 938); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(1);
   }
   ...
   if(0L == cellCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 946); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NULL Cell CB %d \n", cellId); SPrint((&nhCb.init)->prntBuf); } }; };

      hdr.cellId = cellId;
      hdr.ueId = crnti;
      hdr.transId = transId;

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x04); (*errInfo).errCause = (0x02); };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 955); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(1);
   }

   if (0L == (ueCb = (NhActvUeCb *) nhDBMGetUeCb(cellCb, crnti)))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 961); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NULL UE CB %d \n", crnti); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x04); (*errInfo).errCause = (0x03); };

      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 970); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
         ...
         (transCb = (TransCb *)nhUTLGetTransCbFrmNxTransId(ueCb, transId)))
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 980); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NULL TRANS CB (%ld) \n", transId); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x04); (*errInfo).errCause = (0x0c); };

      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 992); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
...

{
   ...
   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1049); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received data request from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   cellAndUeCb.cellCb = 0L;
   msgTransId = 0;
   do { (Void)cmMemset((U8*)(&errIndSdus), 0, (Size)(sizeof(NhuErrIndSdus))); } while(0);
   errInfo = &(errIndSdus.sdu);


   if ((nhuDataReqSdus) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1066); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL nhuDataReqSdus\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   ...
   if (0 != nhUTLValidateDatReq(nhuDataReqSdus, &cellAndUeCb,
                               &msgTransId, errInfo, &event))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1081); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Data Request Validation Failed(ErrorType(%d), ErrorCause(%d)) \n", errInfo->errType, errInfo->errCause); SPrint((&nhCb.init)->prntBuf); } }; };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1082); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataReqSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      do { cmFreeMem((nhuDataReqSdus)); (nhuDataReqSdus) = 0L; } while(0);
      return(1);
   }


   if (1 == nhuDataReqSdus->sdu.isUeCfgPres)
   {
      if (0 != nhUTLValidateUeCfg(&(nhuDataReqSdus->sdu.ueCfg),
                                    cellAndUeCb.ueCb, errInfo))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1095); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Config in Data Request Validation                   Failed  (ErrorType(%d), ErrorCause(%d)) \n", errInfo->errType, errInfo->errCause); SPrint((&nhCb.init)->prntBuf); } }; };



         { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1097); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataReqSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
         do { cmFreeMem((nhuDataReqSdus)); (nhuDataReqSdus) = 0L; } while(0);
         return(1);
      }
   }
   ...
   if (!(nhuDataReqSdus->sdu.ueMsg.isMsgDed))
   {
      switch(nhuDataReqSdus->sdu.ueMsg.msg.cmnMsg.cmnMsgCategory)
      {
         ...
         default:
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1123); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Unknown common message category(%d) \n", nhuDataReqSdus->sdu.ueMsg.msg.cmnMsg.cmnMsgCategory); SPrint((&nhCb.init)->prntBuf); } }; };



            { (*errInfo).errPres = 1; (*errInfo).errType = (0x06); (*errInfo).errCause = (0x10); };

            { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1127); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataReqSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
            do { cmFreeMem((nhuDataReqSdus)); (nhuDataReqSdus) = 0L; } while(0);
            return(1);
         }
      }
   ...
   datReqRspSdu.isDatReqSdu = 1;
   datReqRspSdu.sdu.datReqSdu = nhuDataReqSdus;

   if( (1 == nhuDataReqSdus->sdu.ueMsg.isMsgDed) &&
       (1 == nhuDataReqSdus->sdu.ueMsg.msg.dedMsg.dlDcchMsg.isMsgEncoded) )
   {
      msgPduAndType.encBuf =
              nhuDataReqSdus->sdu.ueMsg.msg.dedMsg.dlDcchMsg.m.mBuf;
      msgPduAndType.type = 0x01;
      do { (Void)cmMemset((U8*)(&(datReqParam)), 0, (Size)(sizeof(NhDatReqParam))); } while(0);


      { (datReqParam.nhId).cellId = (nhuDataReqSdus)->hdr.cellId; (datReqParam.nhId).ueId = (nhuDataReqSdus)->hdr.ueId; if ((nhuDataReqSdus)->sdu.ueMsg.isMsgDed) { (datReqParam.nhId).isPdcpId = 1; (datReqParam.nhId).rbId = (nhuDataReqSdus)->sdu.ueMsg.msg.dedMsg.dlDcchMsg.pdcpId; } else { (datReqParam.nhId).isPdcpId = 0; (datReqParam.nhId).rbId = (nhuDataReqSdus)->sdu.ueMsg.msg.cmnMsg.cmnMsgInfo.rbId; } };
      datReqParam.isPdcpDatReq = 1;
      ...
      if(0 != ret)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1157); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1159); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataReqSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      }
      do { cmFreeMem((nhuDataReqSdus)); (nhuDataReqSdus) = 0L; } while(0);
      return(ret);
   }
   ...
   if (0 != ret)
   {
      ...
      { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1171); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDataReqSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      do { cmFreeMem((nhuDataReqSdus)); (nhuDataReqSdus) = 0L; } while(0);
      return(ret);
   }
...

{
   ...
   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1222); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Received Count request from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if ((countHdr) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1236); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL countHdr\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   ...
   if (0 != nhUTLValidateCountReq(countHdr, errInfo, &event))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1247); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Data Request Validation Failed(ErrorType(%d), ErrorCause(%d)) \n", errInfo->errType, errInfo->errCause); SPrint((&nhCb.init)->prntBuf); } }; };



      { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1249); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(*countHdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      { if ((countHdr) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1250, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((pst->region), (pst->pool), (Data *)(countHdr), (Size)(sizeof(NhuHdr))); (countHdr) = 0L; } };
      return(1);
   }
   ...
   if (0 != ret)
   {
      ...
      { if ((countHdr) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1265, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((pst->region), (pst->pool), (Data *)(countHdr), (Size)(sizeof(NhuHdr))); (countHdr) = 0L; } };

      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1269); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LIM Count Req handler Failed (ErrorType(%d), ErrorCause(%d)) \n", errInfo->errType, errInfo->errCause); SPrint((&nhCb.init)->prntBuf); } }; };



      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x12); };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1274); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(ret);
   }

   { if ((countHdr) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1278, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((pst->region), (pst->pool), (Data *)(countHdr), (Size)(sizeof(NhuHdr))); (countHdr) = 0L; } };

   return(0);
}
# 1308 "../..//lterrc/nh_uim.c"
 S16 NhUiNhuDecodeReq
(
Pst *pst,
SpId spId,
...
{
   NhuDecodeSduCfm *nhuDecodeSduCfm = 0L;
   NhuErrIndSdus errIndSdus;
   NhuErrorInfo *errInfo;
   Mem sMem;
   U16 ret;
   ...
   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1330); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Received Decode request from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };



   if ((nhuDecSduReq) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1335); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL nhuDecSduReq\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }

   if ((nhuDecSduReq->mbuf) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1341); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL mBuf in nhuDecSduReq\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      { if ((nhuDecSduReq) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1342, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((pst->region), (pst->pool), (Data *)(nhuDecSduReq), (Size)(sizeof(NhuDecodeSduReq))); (nhuDecSduReq) = 0L; } };
      return(1);
   }
   ...
   do { (*((Ptr *)&nhuDecodeSduCfm)) = 0L; (Void)cmAllocEvnt((Size)(sizeof(NhuDecodeSduCfm)), 3584, (&sMem), (Ptr *)((Ptr *)&nhuDecodeSduCfm)); } while(0);
   if(0L == nhuDecodeSduCfm)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1354); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhUiNhuDecodeReq: nhuDecodeSduCfm memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

      do{ if ((nhuDecSduReq->mbuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1355, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((nhuDecSduReq->mbuf)); (nhuDecSduReq->mbuf) = 0L; } }while(0);
      { if ((nhuDecSduReq) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1356, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((pst->region), (pst->pool), (Data *)(nhuDecSduReq), (Size)(sizeof(NhuDecodeSduReq))); (nhuDecSduReq) = 0L; } };
      return(1);
   }
   ...
   do { (Void)cmMemcpy((U8*)(&(nhuDecodeSduCfm->hdr)),(const U8*)(&(nhuDecSduReq->hdr)), (Size)(sizeof(NhuHdr)));} while(0);
   nhuDecodeSduCfm->sduType = nhuDecSduReq->sduType;
   nhuDecodeSduCfm->status = 0;

   switch(nhuDecSduReq->sduType)
   {
      case 0x0C:
            ret = nhEDMDecReq(0x0C,
                                 nhuDecSduReq->mbuf,
                                 nhuDecodeSduCfm,
      ...
      case 0x0D:
            ret = nhEDMDecReq(0x0D,
                                 nhuDecSduReq->mbuf,
                                 nhuDecodeSduCfm,
                                 (Void*)&nhuDecodeSduCfm->ie.nhuUTRAUECapOctStr.
                                 nhuUE_UTRAHovrInfo);
            if (ret == 0 && (nhuDecodeSduCfm->ie.nhuUTRAUECapOctStr.
                  nhuUE_UTRAHovrInfo.ue_CapCont.choice.val ==
                  1))
            {
               ret = nhEDMDecReq(0x0E,
                                 nhuDecSduReq->mbuf,
                                 nhuDecodeSduCfm,
                                 (Void*)&nhuDecodeSduCfm->ie.nhuUTRAUECapOctStr.
                                 nhuUE_UTRACap);
               if (ret != 0)
               {
                  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1397); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhUiNhuDecodeReq: Decoding UE Cap Octate string                           failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };


               }
               nhuDecodeSduCfm->ie.nhuUTRAUECapOctStr.containsUECap = 1;
            }
            else
            {
               nhuDecodeSduCfm->ie.nhuUTRAUECapOctStr.containsUECap = 0;
            }
            break;

      case 0x08:
            ret = nhEDMDecReq(0x08,
                                 nhuDecSduReq->mbuf,
                                 nhuDecodeSduCfm,
      ...
      default:
            do{ if ((nhuDecSduReq->mbuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1436, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((nhuDecSduReq->mbuf)); (nhuDecSduReq->mbuf) = 0L; } }while(0);

            { if ((nhuDecSduReq) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1439, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((pst->region), (pst->pool), (Data *)(nhuDecSduReq), (Size)(sizeof(NhuDecodeSduReq))); (nhuDecSduReq) = 0L; } };

            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1441); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhUiNhuDecodeReq: Invalid SDU type to decode\n"); SPrint((&nhCb.init)->prntBuf); } }; };

            { (*errInfo).errPres = 1; (*errInfo).errType = (0x08); (*errInfo).errCause = (0x28); };

            { NhuErrIndSdus *_errIndSdus=0L; if ((errIndSdus).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1444); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuDecodeSduCfm->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errIndSdus).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
            do { cmFreeMem((nhuDecodeSduCfm)); (nhuDecodeSduCfm) = 0L; } while(0);
            return(1);
   }
   ...
   if (ret != 0)
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1453); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhUiNhuDecodeReq: Deocde failed"); SPrint((&nhCb.init)->prntBuf); } }; };

      nhuDecodeSduCfm->status = 1;
   }


   do{ if ((nhuDecSduReq->mbuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1458, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((nhuDecSduReq->mbuf)); (nhuDecSduReq->mbuf) = 0L; } }while(0);
   { if ((nhuDecSduReq) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_uim.c", 1459, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((pst->region), (pst->pool), (Data *)(nhuDecSduReq), (Size)(sizeof(NhuDecodeSduReq))); (nhuDecSduReq) = 0L; } };
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1468); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhUiNhuDecodeReq: Decoded IE send failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 1511 "../..//lterrc/nh_uim.c"
 S16 NhUiNhuEncodeReq
(
Pst *pst,
SpId spId,
...

{
   ...
   Buffer *encBuf;
   Void *encPdu;
   NhuEncCfmSdus *nhuEncCfmSdus = 0L;
   NhuErrIndSdus errInd;
   NhuErrorInfo *errInfo;

   ;

   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1535); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Received Encode request from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };



   if ((nhuEncodeReqSdus) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1540); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL nhuEncodeReqSdus\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
...
# 1602 "../..//lterrc/nh_uim.c"
      ...
      default:
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1614); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Invalid message category for encode.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x07); (*errInfo).errCause = (0x10); };

         { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1617); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuEncodeReqSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
         do { cmFreeMem((nhuEncodeReqSdus)); (nhuEncodeReqSdus) = 0L; } while(0);
         return(1);
      }
   }

   do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&nhuEncCfmSdus), (sizeof(NhuEncCfmSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&nhuEncCfmSdus))), 0, (Size)((sizeof(NhuEncCfmSdus)))); } while(0); } else { (*(&nhuEncCfmSdus)) = 0L; } } while(0);
   if(0L == nhuEncCfmSdus)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1626); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhuEncCfmSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      do { cmFreeMem((nhuEncodeReqSdus)); (nhuEncodeReqSdus) = 0L; } while(0);
      return(1);
   }

   nhuEncCfmSdus->sdu.msgCategory = nhuEncodeReqSdus->sdu.msgCategory;
   nhuEncCfmSdus->sdu.status = 0;

   do { (Void)cmMemcpy((U8*)(&(nhuEncCfmSdus->hdr)),(const U8*)(&(nhuEncodeReqSdus->hdr)), (Size)(sizeof(NhuHdr)));} while(0);

   if (0 != nhEDMEncReq(encPdu, nhuEncodeReqSdus->sdu.msgCategory, &encBuf,
                           &bufLen))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1639); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Encoding failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      nhuEncCfmSdus->sdu.status = 1;
   }
   else
   {
...
# 1675 "../..//lterrc/nh_uim.c"
 S16 NhUiNhuPdcpSduStaReq
(
Pst *pst,
SpId spId,
NhuHdr nhuHeader
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1700); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PDCP SDU Status request from RRC User (spId(%d))\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (0L == cellCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1715); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell CB with cell Id %d not found \n",nhuHeader.cellId); SPrint((&nhCb.init)->prntBuf); } }; };


      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x02); };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1720); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuHeader)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(1);
   }
   ...
   if(0L == ueCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1729); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid UE ID in the header \n"); SPrint((&nhCb.init)->prntBuf); } }; };

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x07); };


      { NhuErrIndSdus *_errIndSdus=0L; if ((errInd).sdu.errPres) { do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&_errIndSdus), (sizeof(NhuErrIndSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&_errIndSdus))), 0, (Size)((sizeof(NhuErrIndSdus)))); } while(0); } else { (*(&_errIndSdus)) = 0L; } } while(0); if(0L == _errIndSdus) { { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1733); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuErrIndSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; }; } else { do { (Void)cmMemcpy((U8*)(&(_errIndSdus->hdr)),(const U8*)(&(nhuHeader)), (Size)(sizeof(NhuHdr)));} while(0); do { (Void)cmMemcpy((U8*)(&(_errIndSdus->sdu)),(const U8*)(&((errInd).sdu)), (Size)(sizeof(NhuErrorInfo)));} while(0); nhUIMSndErrInd(_errIndSdus); } } };
      return(1);
   }
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1745); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhUiNhuPdcpSduStaReq: Could not create Trans block \n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   transCb->rstTbl[0].status = 1;
   transCb->rstTbl[0].action = 0x08;


   retVal = nhLIMSendCfgMsg(&cellAndUeCb, transCb);
   if(retVal != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1773); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"LIM Send Cfg Faied\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(retVal);
   }

   return(0);
}
# 1798 "../..//lterrc/nh_uim.c"
 S16 nhUIMCellCfgHndlr
(
...

{
   ...
   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1815); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMCellCfgHndlr"); SPrint((&nhCb.init)->prntBuf); } }; };

   ret = 0;

   cellId = nhCellCfgSdu->hdr.cellId;

   if (0x01 == nhCellCfgSdu->sdu.cfgType)
   {

      ret = nhDBMCreateCellCb(cellId, &cellCb);
      if (0 != ret)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1828); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cannot create CELL CB %d\n", cellId); SPrint((&nhCb.init)->prntBuf); } }; };

         { (*errInfo).errPres = 1; (*errInfo).errType = (0x10); (*errInfo).errCause = (0x02); };

         return(ret);
      }
# 1841 "../..//lterrc/nh_uim.c"
   }
   ...
   if (0 != ret)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1849); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell(%d): Cannot send lower layer config \n", cellId); SPrint((&nhCb.init)->prntBuf); } }; };
            ...
            !cellCb->cellTransCb.numOfMacCfms)
      {
         ...
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1860); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhDBMDeleteCellCb failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
         }
      }

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x10); (*errInfo).errCause = (0x0b); };
...
# 1893 "../..//lterrc/nh_uim.c"
 S16 nhUIMSndCellCfgCfm
(
U8 cfgCfmStatus,
NhCellCb *cellCb,
U8 errCause
...
{
   NhuCellCfgCfmSdus *cfgCfm=0L;
   Pst pst;

   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1910); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMSndCellCfgCfm"); SPrint((&nhCb.init)->prntBuf); } }; };

   do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&cfgCfm), (sizeof(NhuCellCfgCfmSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&cfgCfm))), 0, (Size)((sizeof(NhuCellCfgCfmSdus)))); } while(0); } else { (*(&cfgCfm)) = 0L; } } while(0);
   if(0L == cfgCfm)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1916); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhuCellCfgCfmSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

      return(1);
   }
   do { (Void)cmMemset((U8*)(cfgCfm), 0, (Size)(sizeof(NhuCellCfgCfmSdus))); } while(0);

   cfgCfm->hdr.cellId = cellCb->cellId;
   cfgCfm->hdr.transId = cellCb->cellTransCb.nxTransId;

   { if ((cellCb->cellTransCb.cfgMask) & 0x01) { if (!((cfgCfmStatus) & 0x01 )) { (*cfgCfm).sdu.cfgError.errPres = 1; (*cfgCfm).sdu.cfgError.errType |= 0x01; } } if ((cellCb->cellTransCb.cfgMask) & 0x02) { if (!((cfgCfmStatus) & 0x02 )) { (*cfgCfm).sdu.cfgError.errPres = 1; (*cfgCfm).sdu.cfgError.errType |= 0x02; } } if ((cellCb->cellTransCb.cfgMask) & 0x04) { if (!((cfgCfmStatus) & 0x04 )) { (*cfgCfm).sdu.cfgError.errPres = 1; (*cfgCfm).sdu.cfgError.errType |= 0x04; } } if ((*cfgCfm).sdu.cfgError.errPres) { (*cfgCfm).sdu.isCfgSuccess = 0; (*cfgCfm).sdu.cfgError.errCause = errCause; } else { (*cfgCfm).sdu.isCfgSuccess = 1; } };


   pst = nhCb.uSapCb->pst;

   if (0 != NhUiNhuCellCfgCfm(&pst, nhCb.uSapCb->suId, cfgCfm))
   {
      return(1);
   }
...

{
   ...
   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 1967); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMDatInd"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 2005); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMSndStaInd"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 2043); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMSndDatCfm"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 2081); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMSndErrInd"); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 2130 "../..//lterrc/nh_uim.c"
{
   NhuCfgCfmSdus *cfgCfm=0L;
   Pst pst;

   ;
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 2135); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMSndCfgCfm"); SPrint((&nhCb.init)->prntBuf); } }; };

   do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&cfgCfm), (sizeof(NhuCfgCfmSdus))) == 0) { do { (Void)cmMemset((U8*)((*(&cfgCfm))), 0, (Size)((sizeof(NhuCfgCfmSdus)))); } while(0); } else { (*(&cfgCfm)) = 0L; } } while(0);
   if(0L == cfgCfm)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 2140); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhuCfgCfmSdus memory allocation failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   do { (Void)cmMemset((U8*)(cfgCfm), 0, (Size)(sizeof(NhuCfgCfmSdus))); } while(0);

   { (cfgCfm->hdr).cellId = (nhIdentity).cellId; (cfgCfm->hdr).ueId = (nhIdentity).ueId; };
   cfgCfm->hdr.transId = nxTransId;

   { if ((cfgMsk) & 0x01) { if (!((cfmStatus) & 0x01 )) { (*cfgCfm).sdu.cfgError.errPres = 1; (*cfgCfm).sdu.cfgError.errType |= 0x01; } } if ((cfgMsk) & 0x02) { if (!((cfmStatus) & 0x02 )) { (*cfgCfm).sdu.cfgError.errPres = 1; (*cfgCfm).sdu.cfgError.errType |= 0x02; } } if ((cfgMsk) & 0x04) { if (!((cfmStatus) & 0x04 )) { (*cfgCfm).sdu.cfgError.errPres = 1; (*cfgCfm).sdu.cfgError.errType |= 0x04; } } if ((*cfgCfm).sdu.cfgError.errPres) { (*cfgCfm).sdu.isCfgSuccess = 0; (*cfgCfm).sdu.cfgError.errCause = errCause; } else { (*cfgCfm).sdu.isCfgSuccess = 1; } };
   pst = nhCb.uSapCb->pst;

   if (0 != NhUiNhuCfgCfm(&pst, nhCb.uSapCb->suId, cfgCfm))
   {
      return(1);
   }
...
# 2182 "../..//lterrc/nh_uim.c"
 S16 nhUIMSndPdcpSduStaCfm
(
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 2201); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMSndPdcpSduStaCfm"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   { if ((cfgMsk) & 0x01) { if (!((cfmStatus) & 0x01 )) { pdcpCfgCfm->status |= 0x01; } } if ((cfgMsk) & 0x02) { if (!((cfmStatus) & 0x02 )) { pdcpCfgCfm->status |= 0x02; } } if ((cfgMsk) & 0x04) { if (!((cfmStatus) & 0x04 )) { pdcpCfgCfm->status |= 0x04; } } };
...
# 2238 "../..//lterrc/nh_uim.c"
 S16 nhUIMSndCountCfm
(
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_uim.c", 2252); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhUIMSndCountCfm"); SPrint((&nhCb.init)->prntBuf); } }; };
