...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 103 "../..//ltemac/rg_uim.c" 2
# 1 "../..//cm/cm5.h" 1
# 104 "../..//ltemac/rg_uim.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 122 "../..//ltemac/rg_uim.c" 2
# 1 "../..//cm/cm5.x" 1
# 123 "../..//ltemac/rg_uim.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 183); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguBndReq(): suId = %d; spId = %d;", suId, spId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if(spId == rgCb.rguSap.sapCfg.spId)
   {
      ...
      {
         case 0:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 204); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "SAP Not Configured\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            rgFillDgnParams(&dgn, 1);
            ret = rgLMMStaInd(2,0,
                  2, &dgn);
            ret = RgUiRguBndCfm(&tmpPst, suId, 2);
            break;
         case 1:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 211); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"SAP Not yet bound\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            rgCb.rguSap.sapSta.sapState = 2;
            rgCb.rguSap.sapCfg.suId = suId;

            ret = rgUIMRguBndCfm(suId, 1);

            rgFillDgnParams(&dgn, 1);
            ret = rgLMMStaInd(2,(256 + 0),
                  0, &dgn);
            break;
         case 2:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 222); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"SAP already bound\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            ret = rgUIMRguBndCfm(suId, 1);
            break;
         default:
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 279); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguUbndReq(): spId = %d; reason = %d;", spId, reason); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (spId == rgCb.rguSap.sapCfg.spId)
   {
      ...
      {
         case 2:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 287); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"SAP already bound\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 342); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMRguBndCfm(): suId = %d; status = %d;", suId, status); SPrint((&rgCb.rgInit)->prntBuf); } };

   ret = RgUiRguBndCfm(&rgCb.rguSap.sapCfg.sapPst, rgCb.rguSap.sapCfg.suId, status);
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 347); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguBndCfm Failed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(ret);
   }
   return(ret);
}
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 394); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguDDatReq(): spId = %d; datReq = %p;",spId, (void *)datReq); SPrint((&rgCb.rgInit)->prntBuf); } };
# 455 "../..//ltemac/rg_uim.c"
   ret = rgROMDedDatReq(datReq);
   if (ret == 1)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 458); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguDDatReq:processing Of Dat Req Failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      { U32 idx1,idx2,idx3; if (datReq != 0L) { for (idx1=0; idx1 < datReq->nmbOfTbs; idx1++) { for (idx2=0; idx2 < datReq->datReqTb[idx1].nmbLch; idx2++) { for (idx3=0; idx3 < datReq->datReqTb[idx1].lchData[idx2].pdu.numPdu; idx3++) { { if (0L != (datReq->datReqTb[idx1]. lchData[idx2].pdu.mBuf[idx3])) { SPutMsg((datReq->datReqTb[idx1]. lchData[idx2].pdu.mBuf[idx3])); datReq->datReqTb[idx1]. lchData[idx2].pdu.mBuf[idx3] = 0L; } }; } } } }};
   }
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 501); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguCDatReq(): spId = %d; datReq = %p;",spId, (void *)datReq); SPrint((&rgCb.rgInit)->prntBuf); } };
# 543 "../..//ltemac/rg_uim.c"
   ret = rgROMCmnDatReq(datReq);

   if(rgCb.rgInit.trc)
   {
      rgLMMTrcInd(datReq->pdu, 4);
   }
   if (ret == 1)
   {
...
# 633 "../..//ltemac/rg_uim.c"
   ...
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 636); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguDStaRsp : Processing Of Status Response Failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   }
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 684); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguCStaRsp(): spId = %d; staRsp = %p;",spId, (void *)staRsp); SPrint((&rgCb.rgInit)->prntBuf); } };
# 719 "../..//ltemac/rg_uim.c"
   ret = rgROMCmnStaRsp(staRsp);
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 722); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiRguCStaRsp : Processing Of Status Response Failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(ret);
   }
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 844); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndDedStaInd(): staInd = %p;", (void *)staInd); SPrint((&rgCb.rgInit)->prntBuf); } };

   ret = RgUiRguDStaInd(&rgCb.rguSap.sapCfg.sapPst, rgCb.rguSap.sapCfg.suId,
         staInd);
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 850); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndDedStaInd: RgUiRguDStaInd Failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(ret);
   }
   return(ret);
}
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 887); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndCmnStaInd(): staInd = %p", (void *)staInd); SPrint((&rgCb.rgInit)->prntBuf); } };

   ret = RgUiRguCStaInd(&rgCb.rguSap.sapCfg.sapPst, rgCb.rguSap.sapCfg.suId,
         staInd);
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 893); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndCmnStaInd: RgUiRguCStaInd Failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(ret);
   }
   return(ret);
}
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 930); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndDedDatInd(): staInd = %p;", (void *)datInd); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 941); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndDedDatInd: RgUiRguDdatInd Failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(ret);
   }
   return(ret);
}
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 978); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndCmnDatInd(): staInd = %p;", (void *)datInd); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 989); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMSndCmnDatInd: RgUiRguCDatInd Failed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(ret);
   }
   return(ret);
}
# 1015 "../..//ltemac/rg_uim.c"
 S16 RgUiCrgBndReq
(
Pst *pst,
SuId suId,
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1034); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiCrgBndReq(): suId = %d; spId = %d;", suId, spId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if(spId == rgCb.crgSap.sapCfg.spId)
   {
      ...
      {
         case 0:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1056); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "SAP Not Configured\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            rgFillDgnParams(&dgn, 1);
            ret = rgLMMStaInd(2,0,
                  2, &dgn);
            ...
            break;
         case 1:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1063); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"SAP Not yet bound\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            rgCb.crgSap.sapSta.sapState = 2;
            rgCb.crgSap.sapCfg.suId = suId;

            ret = rgUIMCrgBndCfm(suId, 1);

            rgFillDgnParams(&dgn, 1);
            ret = rgLMMStaInd(2,(256 + 1),
                  0, &dgn);
            break;
         case 2:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1074); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"SAP Is already Bound\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            ret = rgUIMCrgBndCfm(suId, 1);
            break;
         default:
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1132); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiCrgUbndReq(): spId = %d; reason = %d;", spId, reason); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (spId == rgCb.crgSap.sapCfg.spId)
   {
      switch(rgCb.crgSap.sapSta.sapState)
      {
         case 2:
            ...
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1141); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"SAP Is already Bound\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1194); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMCrgBndCfm(): suId = %d; status = %d;", suId, status); SPrint((&rgCb.rgInit)->prntBuf); } };

   if(RgUiCrgBndCfm(&rgCb.crgSap.sapCfg.sapPst, rgCb.crgSap.sapCfg.suId, status) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1198); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiCrgBndCfm Failed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   return(0);
}
# 1226 "../..//ltemac/rg_uim.c"
 S16 RgUiCrgCfgReq
(
Pst *pst,
SpId spId,
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1251); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiCrgCfgReq(): spId = %d; transId = %s;", spId, prntTrans); SPrint((&rgCb.rgInit)->prntBuf); } };


   if (cfgReqInfo == 0L)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1256); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"Input Param crgReqInfo is NULL \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if (spId == rgCb.crgSap.sapCfg.spId)
   {
      ...
      {
         case 2:
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1267); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"SAP Is already Bound\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            break;
         default:
   ...
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1300); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiCrgCfgReq:Configuration Request Handling Failed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1304); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"RgUiCrgCfgReq:Configuration Request Processed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(0);
}
# 1326 "../..//ltemac/rg_uim.c"
 S16 rgUIMCrgCfgCfm
(
CrgCfgTransId transId,
U8 status
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1346); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMCrgCfgCfm: transId = %s; status = %d\n", prntTrans, status); SPrint((&rgCb.rgInit)->prntBuf); } };

   ret = RgUiCrgCfgCfm(&rgCb.crgSap.sapCfg.sapPst, rgCb.crgSap.sapCfg.suId, transId, status);
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_uim.c", 1351); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf,"rgUIMCrgCfgCfm: RgUiCrgCfgCfm Failed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(ret);
   }
