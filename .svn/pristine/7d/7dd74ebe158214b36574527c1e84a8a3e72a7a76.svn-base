...
/* ss001.301: additions */
...
#ifdef MSPD
   {
      ...
      extern CmMmRegCfg *rbCMMRegCfg[];

      /* Catch invalid memory access */
      if ((U32)mBuf < (U32)rbCMMRegCfg[0]->vAddr
            || (U32)mBuf >= (U32)rbCMMRegCfg[0]->vAddr + \
                  (U32)rbCMMRegCfg[0]->size)
      {
         uart_printf("Invalid mem access: buf 0x%x caller 0x%x, aborting\n\r",
            mBuf, __return_address()-4);
         *(volatile int *)0xdeaddead = 1; /* abort */
      }
      syscoreinfo[MxGetCpuID()].caller[0] = __return_address();
   }
#endif
#if (ERRCLASS & ERRCLS_INT_PAR)
   if (mBuf == NULLP)
...
#ifdef MSPD_MLOG
   MLogTask(PID_SAddPreMsgMult, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
/* ss003.13: addition */
   ...
   MLogTask(PID_SAddPstMsgMult, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SRemPreMsgMult, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SRemPstMsgMult, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SGetDataFrmMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
...
#ifdef MSPD_MLOG
   MLogTask(PID_SSegMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SCpyFixMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   //MLogAddVariables(1, &var1, t);
   MLogTask(PID_SCpyMsgFix, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SCpyMsgMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SAddMsgRef, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
/* ss012.13: Addition */
...
#endif
{
   ...
   {
      extern CmMmRegCfg *rbCMMRegCfg[];
      if (region != 0 || (U32)buf < (U32)rbCMMRegCfg[region]->vAddr
            || (U32)buf >= (U32)rbCMMRegCfg[region]->vAddr + \
                  (U32)rbCMMRegCfg[region]->size)
      {
         uart_printf("Invalid mem access: reg %u buf 0x%x caller 0x%x, aborting\n\r",
            region, buf, __return_address()-4);
         *(volatile int *)0xdeaddead = 1; /* abort */
      }
   }
#endif
...
#ifdef MSPD_MLOG
   MLogTask(PID_SCatMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SCompressMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SGetPstMsgMult, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SSwapMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
/* ss004.301 : Cavium changes */
...
#ifdef MSPD_MLOG
   MLogTask(PID_SCpyPartMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SRepPartMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SMovPartMsg, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
...
#ifdef MSPD_MLOG
   MLogTask(PID_SPkMsgMult, RESOURCE_LARM, t, GetTIMETICK());
#endif
   RETVALUE(ROK);
}
