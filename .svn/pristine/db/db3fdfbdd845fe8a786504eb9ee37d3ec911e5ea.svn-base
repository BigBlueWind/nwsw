...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 127 "../..//lterlcpdcp/kw_pj_uim.c" 2
# 1 "../..//cm/cm5.h" 1
# 128 "../..//lterlcpdcp/kw_pj_uim.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 146 "../..//lterlcpdcp/kw_pj_uim.c" 2

# 1 "../..//cm/cm5.x" 1
# 148 "../..//lterlcpdcp/kw_pj_uim.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
# 167 "../..//lterlcpdcp/kw_pj_uim.c" 2
# 201 "../..//lterlcpdcp/kw_pj_uim.c"
 S16 PjUiCpjBndReq
(
Pst *pst,
SuId suId,
...

{
  ...
  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00380001, PJ_DIAG_NA, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, spId, suId, 0, 0, "Received BndReq from RRC, spId = %d, suId = %d"); } }




   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 3) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 3) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 226); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjBndReq(pst, spId(%d), suId(%d))\n", spId, suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   switch(cpjSap->state)
   {
      ...
      case 4:
      {
         ...
         do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 247); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjBndReq: state (%d)\n", cpjSap->state); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 2:
      {
         ...
         if (cpjSap->pst.dstProcId != pst->srcProcId
               ...
               || cpjSap->suId != suId)
         {
            { kwLmmSendAlarm(2, (256 + 4), 13, spId, 0); };

            do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 266); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjBndReq: SAP already bound -- state(%d)\n", cpjSap->state); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
     ...
     default:
      {
# 282 "../..//lterlcpdcp/kw_pj_uim.c"
         do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 283); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjBndReq: CPJ SAP State is Invalid during Bind Req"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 348); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjUbndReq(pst, spId(%d), reason(%d))\n", spId, reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00380002, PJ_DIAG_NA, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, spId, 0, 0, 0, "Receivd UnBnd Req from RRC, spId = %d"); } }
   ...
   cpjSap = &(kwCb.cpjSap);
# 371 "../..//lterlcpdcp/kw_pj_uim.c"
   cpjSap->state = 1;

   return(0);
}
# 403 "../..//lterlcpdcp/kw_pj_uim.c"
 S16 PjUiCpjCfgReq
(
Pst *pst,
SpId spId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 442); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuCfgReq(pst, spId(%d), TransId(%ld))\n", spId, cfg->transId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if(cpjSap->state != 2) { ; pjLmmSendAlarm(2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {
...
# 477 "../..//lterlcpdcp/kw_pj_uim.c"
  ...
  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00380003, PJ_DIAG_NA, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, entCfg->rbId, entCfg->rbType, 0, 0, "Received CfgReq from RRC, rbId = %d, rbType = %d"); } }
         ...
         case 0x01:
            {
               ...
               if (pjCfgAddRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {
                  do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 506); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgAddRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, entCfgCfm->reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




               }
# 518 "../..//lterlcpdcp/kw_pj_uim.c"
               break;
            }
         ...
         case 0x02:
            {
               ...
               if (pjCfgReCfgRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {
                  do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 531); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgReCfgRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, entCfgCfm->reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




               }
# 542 "../..//lterlcpdcp/kw_pj_uim.c"
               break;
            }
         ...
         case 0x03:
            {
               ...
               if (pjCfgDelRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {
                  do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 555); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgDelRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, entCfgCfm->reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         case 0x04:
            {
               ...
               if (pjCfgReEstRb(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {
                  do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 573); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgReEstRb Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, entCfgCfm->reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         case 0x05:
            {
               ...
               if (pjCfgDelUe(cfg->ueId, cfg->cellId, entCfg, entCfgCfm) != 0)

               {

                  do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 598); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuCfgReq(pst, cfg(ueId(%d),                     cellId(%d), cfgType(%d), rbId(%d))\n kwCfgDelUe Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, entCfgCfm->reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         default:
            {
               ...
               do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 619); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuCfgReq(pst, cfg(ueId(%d),                  cellId(%d), cfgType(%d), rbId(%d)) Failed: reason (%d)\n", cfg->ueId, cfg->cellId, entCfg->cfgType, cfg->cfgEnt[idx].rbId, 14); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
       ...
       (cfmWait == 1)))
   {
      ...
      pjUtlSaveCfmInfo(ueCb, cfmType, startTmr, 0xd8, (U32)cfgCfm, (U32)cfg);
      ...
      { if (cfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) cfg, (Size) sizeof(CpjCfgReqInfo)); cfg = 0L; } };
      { if (cfgCfm != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) cfgCfm, (Size) sizeof(CpjCfgCfmInfo)); cfgCfm = 0L; } };
   }
   else
   {
...
# 751 "../..//lterlcpdcp/kw_pj_uim.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 760); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjUeIdChgReq(pst, spId(%d), transId(%ld))\n", spId, transId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
  ...
  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00380004, PJ_DIAG_UEID, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, ueInfo->ueId, ueInfo->cellId, newUeInfo->ueId, newUeInfo->cellId, 0, "Received UE Id change req from RRC, oldCellId = %d, new UeId = %d, newCellid = %d"); } }
   ...
   if (pjCfgUeIdChng(ueInfo, newUeInfo, &status) != 0)
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 791); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjUeIdChgReq(pst, oldUe(ueId(%d),         cellId(%d)), newUe(ueId(%d), cellId(%d))\n kwCfgUeIdChng Failed: reason (%d)\n", ueInfo->ueId, ueInfo->cellId, newUeInfo->ueId, newUeInfo->cellId, status.reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&tUeInfo, (Size) sizeof(CpjUeInfo)) == 0) { cmMemset((U8 *)(tUeInfo), 0, sizeof(CpjUeInfo)); } else { (tUeInfo) = 0L; } };
# 810 "../..//lterlcpdcp/kw_pj_uim.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 866); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjSecCfgReq(pst, spId(%d), TransId(%ld))\n", spId, secCfg->transId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 873 "../..//lterlcpdcp/kw_pj_uim.c"
   ret = 0;
   cfgCfm = 0L;
   cpjSap = 0L;
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&cfgCfm, (Size) sizeof(CpjSecCfgCfmInfo)) == 0) { cmMemset((U8 *)(cfgCfm), 0, sizeof(CpjSecCfgCfmInfo)); } else { (cfgCfm) = 0L; } };

  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00380005, PJ_DIAG_UEID, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, secCfg->ueId, secCfg->cellId, cfgCfm->reason, 0, 0, "Received Security CfgReq from RRC, cellId = %d, reason = %d"); } }

# 902 "../..//lterlcpdcp/kw_pj_uim.c"
   if ( pjCfgPrcSecCfg(secCfg,cfgCfm) != 0 )
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 907); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjSecCfgReq(pst, cfg(ueId(%d),           cellId(%d) )\n pjCfgSecCfg Failed: reason (%d)\n", secCfg->ueId, secCfg->cellId, cfgCfm->reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




   }
# 923 "../..//lterlcpdcp/kw_pj_uim.c"
   PjUiCpjSecCfgCfm(&(cpjSap->pst), cpjSap->suId, cfgCfm);



   { if (secCfg != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) secCfg, (Size) sizeof(CpjSecCfgReqInfo)); secCfg = 0L; } };

   return(ret);
}
# 948 "../..//lterlcpdcp/kw_pj_uim.c"
 S16 PjUiCpjReEstReq
(
Pst *pst,
SpId spId,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 968); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjReEstReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 998 "../..//lterlcpdcp/kw_pj_uim.c"
  { if(kwCb.pjInit.logMask & 0x1) { ssDiagFix(0x00380006, PJ_DIAG_UEID, 0xd8, kwCb.pjInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, reEstReq->pdcpId.ueId, reEstReq->pdcpId.cellId, 0, 0, 0, "Received ReEstReq from RRC, cellId = %d"); } }




   if ( pjCfgReEstReq(reEstReq,reEstCfm) != 0 )
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1007); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjReEstReq(pst, cfg(ueId(%d),         cellId(%d) )\n pjCfgSecCfg Failed: reason (%u)\n", reEstReq->pdcpId.ueId, reEstReq->pdcpId.cellId, reEstCfm->status); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1055); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjCountReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&countCfm, (Size) sizeof(CpjCountCfmInfo)) == 0) { cmMemset((U8 *)(countCfm), 0, sizeof(CpjCountCfmInfo)); } else { (countCfm) = 0L; } };
# 1074 "../..//lterlcpdcp/kw_pj_uim.c"
   if ( pjCfgPrcCount(countReq, countCfm) != 0 )
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1079); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjCountReq(pst, cfg(ueId(%d),          cellId(%d) )\n pjCfgSecCfg Failed: reason (%d)\n", countReq->ueId, countReq->cellId, countCfm->reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1128); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjSduStaReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( pjCfgPrcSduSta(staReq) != 0 )
   {

      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | ((0x00000002 << 4) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1150); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiCpjSduStaReq(pst, cfg(ueId(%d),         cellId(%d) )\n pjCfgSecCfg Failed\n", staReq->ueId, staReq->cellId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1207); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuBndReq(pst, spId(%d), suId(%d))\n", spId, suId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 1232 "../..//lterlcpdcp/kw_pj_uim.c"
   switch(pjuSap->state)
   {
      ...
      case 4:
      {
         ...
         do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 0))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 0)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1249); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuBndReq: state (%d)\n", pjuSap->state); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      case 2:
      {
         ...
         if (pjuSap->pst.dstProcId != pst->srcProcId
               ...
               || pjuSap->suId != suId)
         {
            do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1272); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuBndReq(pst, suId(%d)<>suId(%d),\n               pst->srcProcId(%d)<>pjuSap->pst.dstProcId(%d),\n                     pst->srcEnt(%d)<>pjuSap->pst.dstEnt(%d),\n                     pst->srcInst(%d)<>pjuSap->pst.dstInst(%d))\n", suId, pjuSap->suId, pst->srcProcId, pjuSap->pst.dstProcId, pst->srcEnt, pjuSap->pst.dstEnt, pst->srcInst, pjuSap->pst.dstInst); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1274 "../..//lterlcpdcp/kw_pj_uim.c"
            { kwLmmSendAlarm(2, (256 + 5), 13, spId, 0); };
            ret = 1;
         }
         break;
      }
     ...
     default:
      {
# 1290 "../..//lterlcpdcp/kw_pj_uim.c"
         do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1291); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuBndReq: PJU SAP State is Invalid during Bind Req"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1356); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuUbndReq(pst, spId(%d), reason(%d))\n", spId, reason); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   pjuSap = &(kwCb.pjuSap[spId]);
   ret = 0;
# 1375 "../..//lterlcpdcp/kw_pj_uim.c"
   pjuSap->state = 1;

   return(0);
}
# 1398 "../..//lterlcpdcp/kw_pj_uim.c"
 S16 PjUiPjuDatReq
(
Pst *pst,
SpId spId,
...
# 1414 "../..//lterlcpdcp/kw_pj_uim.c"
{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1442); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuDatReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1456 "../..//lterlcpdcp/kw_pj_uim.c"
   if (kwDbmFetchUeCb(pdcpId->ueId, pdcpId->cellId, &ueCb) != 0)
   {

      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1460); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuDatReq: kwDbmFetchUeCb Failed.\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (pjRbCb == 0L)
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1472); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuDatReq: PDCP ID not found ueId(%d), cellId(%d), rbId(%d)", pdcpId->ueId, pdcpId->cellId, pdcpId->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1483); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuDatReq: PDCP pkt dropped for ueId(%d), cellId(%d), " "rbId(%d)", pdcpId->ueId, pdcpId->cellId, pdcpId->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 1531 "../..//lterlcpdcp/kw_pj_uim.c"
   { PjDlCb *_dlCb; U32 _maxTxSn; _dlCb = &pjRbCb->dlCb; sn = _dlCb->nxtTxSn; txHfn = _dlCb->txHfn; _maxTxSn = (1 << pjRbCb->snLen); if ( (++_dlCb->nxtTxSn) == _maxTxSn) { _dlCb->txHfn++; _dlCb->nxtTxSn = 0; } };
   ...
   { if (pjRbCb->rbType == 0) kwCb.pjuSap[0].sts.rxSdus++; else kwCb.pjuSap[1].sts.rxSdus++; };
   { if (pdcpId != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) pdcpId, (Size) sizeof(CmLtePdcpId)); pdcpId = 0L; } };
...

{
   ...
   do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1600); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuDatFwdReq(pst, spId(%d))\n", spId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   pjuSap = &(kwCb.pjuSap[spId]);

   { if(pjuSap->state != 2) { ; pjLmmSendAlarm(2, 1, 9, 0, 0); ret = 1; } };
   if (ret != 0)
   {
   ...
   if (kwDbmFetchUeCb(pdcpId->ueId, pdcpId->cellId, &ueCb) != 0)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 8) | (0x00000002 << 2))) ^ (((0x00000002 << 4) << 8) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1617); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuDatReq: kwDbmFetchUeCb Failed.\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (pjRbCb == 0L)
   {
      do { if (!((kwCb.init.dbgMask & ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2))) ^ ((((0x00000002 << 4) << 11) << 5) | (0x00000002 << 2)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[PDCP_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_pj_uim.c", 1630); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "PjUiPjuDatFwdReq: PDCP ID not found ueId(%d), cellId(%d), rbId(%d)", pdcpId->ueId, pdcpId->cellId, pdcpId->rbId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (pdcpId != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) pdcpId, (Size) sizeof(CmLtePdcpId)); pdcpId = 0L; } };
   { if (datFwdReq->datFwdInfo != 0L) { (Void) SPutSBuf(pst->region, pst->pool, (Data *) datFwdReq->datFwdInfo, (Size) (datFwdReq->numSdus * sizeof(PjuDatFwdReqInfo))); datFwdReq->datFwdInfo = 0L; } };
