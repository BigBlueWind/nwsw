...
#endif
{
   ...
   /*-- eg003.201: merge eg006.102 changes: Added RETVOID--*/
   RETVOID;
...
#endif
{
   ...
   if( ret == ROK && (gmMODBRERSPCb->ieProperties[ieCnt].groupedIe) != NULLP)
   {
     ...
     if( ret == ROK && *ieProperties != NULLP)
     {
       ...
       egMakeAppChildIeEntry((gmMODBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_BEARER_FLAGS_IETYPE,EG_IE_OPTIONAL,0,FALSE,
           0 );
     }
   }
   ieCnt++;
