...
# 100 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 1 "../..//cm/gen.x" 1
# 126 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/ssi.x" 1
# 127 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 128 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 129 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 130 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm_mblk.x" 1
# 131 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm_llist.x" 1
# 91 "../..//cm/cm_llist.x"
#define __CMLLISTX__ 
...
# 132 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm5.x" 1
# 133 "../..//egtpu/eg_ptui.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 540); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtBndCfm(pst, suId(%d), status(%d))\n", suId, status); SPrint((&(egCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 881); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtStaCfm(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 918); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtStaCfm(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 955); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtEguUStaInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 992); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtEguErrInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };
...
{
# 1041 "../..//egtpu/eg_ptui.c"
   ;;

   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 1044); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtEguDatInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };
...

{
   ...
   SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *) "../..//egtpu/eg_ptui.c", 1085, 0x4, ((0 + 0) + 15), 0, (Txt *)"PtUiEgtBndCfm: Invalid selector");;
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 1441); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtStaCfm(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };


   return(0);
}
# 1460 "../..//egtpu/eg_ptui.c"
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 1476); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "EgUiEgtStaCfm(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };


   return(0);
}
# 1495 "../..//egtpu/eg_ptui.c"
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 1511); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "PtUiEgtEguUStaInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };



   return(0);
}
# 1531 "../..//egtpu/eg_ptui.c"
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 1547); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "PtUiEgtEguErrInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };


   return(0);
}
# 1567 "../..//egtpu/eg_ptui.c"
...

{
   ...
   { if ((&(egCb.init))->dbgMask & (0x00000004)) { sprintf((&(egCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "Eg", (&(egCb.init))->ent, (&(egCb.init))->inst, "../..//egtpu/eg_ptui.c", 1583); SPrint((&(egCb.init))->prntBuf); sprintf (egCb.init.prntBuf, "PtUiEgtEguDatInd(pst, suId(%d) ...)\n", suId); SPrint((&(egCb.init))->prntBuf); } };
