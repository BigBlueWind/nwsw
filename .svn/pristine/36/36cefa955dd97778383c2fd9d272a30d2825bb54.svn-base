...
# 119 "../..//lterrc/nh_utl.c" 2
# 1 "../..//cm/nhu_asn.h" 1
# 120 "../..//lterrc/nh_utl.c" 2
# 1 "../..//cm/lnh.h" 1
# 90 "../..//cm/lnh.h"
#define __LNHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 126 "../..//lterrc/nh_utl.c" 2
# 1 "../..//cm/cm5.x" 1
# 127 "../..//lterrc/nh_utl.c" 2
...
# 144 "../..//lterrc/nh_utl.c" 2
# 1 "../..//cm/nhu_asn.x" 1
# 145 "../..//lterrc/nh_utl.c" 2
# 1 "../..//cm/lnh.x" 1
# 100 "../..//cm/lnh.x"
#define __LNHX__ 
# 121 "../..//cm/lnh.x"
...
# 169 "../..//lterrc/nh_utl.c"
static S16 nhUTLUpdNhCntr (U32 *nhCntr, Cause evntCause);

static S16 nhUTLValidateTransId (NhuDatReqSdus *datReqSdus, NhActvUeCb *ueCb, U8 *msgTransId, NhuErrorInfo *errInfo, U8 *event, U8 *mesgType);


static S16 nhUTLValidateRbOrPdcpId (NhId nhIdentity, NhCellAndUeCb *cellAndUeCb, NhuErrorInfo *errInfo);

static S16 nhUTLValidateLogChTrchMap (NhuCellCfgInfo *cellCfgInfo);

static S16 nhUTLValidateCfgTypeSetup (NhuCellCfgReqSdus *cellCfgReqSdus, NhCellCb *cellCb, NhuErrorInfo *errInfo);
# 215 "../..//lterrc/nh_utl.c"
 S16 nhUTLEncAndSnd
(
...
# 232 "../..//lterrc/nh_utl.c"
{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 240); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndSnd called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };


   if(datReqParam->isMsgEncoded == 1)
   {
   ...
   else
   {
      ...
      if (0 != retVal)
      {
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x07); (*errInfo).errCause = (0x00); };
         return(retVal);
      }
   }


   if(1 == datReqParam->isPdcpDatReq)
   {
      retVal = nhDBMAddMuiCb(cellAndUeCb->ueCb, &muiCb, nxTransId);
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 266); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhDBMAddMuiCb Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         do{ if ((nhEncBuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 268, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((nhEncBuf)); (nhEncBuf) = 0L; } }while(0);
         return(retVal);
      }
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 279); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhPIMSendUeMsg Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      if(1 == datReqParam->isPdcpDatReq)
      {
...
# 332 "../..//lterrc/nh_utl.c"
{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 339); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLEncAndStoreMsg called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&transCtrlBlk->lowerLyrParam), (sizeof(NhDatReqParam))) == 0) { do { (Void)cmMemset((U8*)((*(&transCtrlBlk->lowerLyrParam))), 0, (Size)((sizeof(NhDatReqParam)))); } while(0); } else { (*(&transCtrlBlk->lowerLyrParam)) = 0L; } } while(0);


   if(0L == transCtrlBlk->lowerLyrParam)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 361); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation failed for storing PIM information.\n"); SPrint((&nhCb.init)->prntBuf); } }; };


      transCtrlBlk->storedMsg = 0L;

      do{ if ((nhEncBuf) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 365, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((nhEncBuf)); (nhEncBuf) = 0L; } }while(0);
      return(4);
   }

   do { (Void)cmMemcpy((U8*)((U8 *)transCtrlBlk->lowerLyrParam),(const U8*)((U8 *) datReqParam), (Size)(sizeof(NhDatReqParam)));} while(0);


   return(0);
}
# 401 "../..//lterrc/nh_utl.c"
 S16 nhUTLSendStoredMsg
(
NhCellAndUeCb *cellAndUeCb,
TransCb *transCtrlBlk
)
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 418); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLSendStoredMsg called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };


   if(1 == transCtrlBlk->lowerLyrParam->isPdcpDatReq)
   {
      retVal = nhDBMAddMuiCb(cellAndUeCb->ueCb, &muiCb,
                             transCtrlBlk->nxTransId);
      if (0 != retVal)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 427); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhDBMAddMuiCb Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         do{ if ((transCtrlBlk->storedMsg) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 429, 0x2, 0, (ErrVal) 0, "Can't free the mBuf: GOT NULL PTR\n"); } else { (Void)SPutMsg((transCtrlBlk->storedMsg)); (transCtrlBlk->storedMsg) = 0L; } }while(0);
         { if ((transCtrlBlk->lowerLyrParam) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 431, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(transCtrlBlk->lowerLyrParam), (Size)(sizeof(NhDatReqParam))); (transCtrlBlk->lowerLyrParam) = 0L; } };
   ...
   if (0 != retVal)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 448); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhPIMSendUeMsg Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      { if ((transCtrlBlk->lowerLyrParam) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 457, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(transCtrlBlk->lowerLyrParam), (Size)(sizeof(NhDatReqParam))); (transCtrlBlk->lowerLyrParam) = 0L; } };
   ...
   {
      cellAndUeCb->ueCb->rbSecCfgBitMask |= 0x02;
   }



   if(5 == transCtrlBlk->cause ||
      14 == transCtrlBlk->cause)
   {
   ...
   { if ((transCtrlBlk->lowerLyrParam) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 486, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(transCtrlBlk->lowerLyrParam), (Size)(sizeof(NhDatReqParam))); (transCtrlBlk->lowerLyrParam) = 0L; } };


   return(0);
}
# 509 "../..//lterrc/nh_utl.c"
 TransCb *nhUTLGetTransCbFrmMsgTransId
(
NhActvUeCb *ueCb,
U32 msgTransKey
)
...

{
   ...
   ret = nhHashListFind(&ueCb->msgTransHlCp, key, sizeof(U32), (U32 *)&transCb);
...
# 557 "../..//lterrc/nh_utl.c"
 TransCb *nhUTLGetTransCbFrmNxTransId
(
NhActvUeCb *ueCb,
NhTransId transId
)
...

{
   ...
   ((((tmp) = ((&(ueCb->transCbLst))->crnt = (&(ueCb->transCbLst))->first)) != 0L) ? (tmp)->node : 0L);
   ...
   while(0L != tmp)
   {
      ...
      ((((tmp) = ((&(ueCb->transCbLst))->crnt = ((&(ueCb->transCbLst))->crnt ? (&(ueCb->transCbLst))->crnt->next : (&(ueCb->transCbLst))->first)))!= 0L) ? (tmp)->node : 0L);
   }
...

{
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 699); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Incorrect SDU type received"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
   return(0);
}
# 726 "../..//lterrc/nh_utl.c"
 S16 nhUTLGetMsgTypeAndEvntFrmSdu
(
U8 msgChoice,
NhSduType sduType,
U8 *nhMsgType,
   ...
   ;
      ...
      *nhMsgType = 0;
      switch(sduType)
      {
         ...
         default:
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 910); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Incorrect sdu type received \n"); SPrint((&nhCb.init)->prntBuf); } }; };
            return(1);
      }
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 955); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Updating the PDU Statistics \n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   switch(mesgType)
   {
      ...
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1054); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Invalid message type.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         break;
...
# 1080 "../..//lterrc/nh_utl.c"
static S16 nhUTLUpdNhCntr
(
U32 *nhCntr,
Cause evntCause
)
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1093); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLUpdNhCntr called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   switch(evntCause)
   {
      ...
      case 1:
      case 2:
          { if (*(nhCntr) == 0xFFFFFFFF) *(nhCntr) = 0; };
          (*nhCntr)++;
          break;

      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1106); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Invalid Cause.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         break;
...
# 1132 "../..//lterrc/nh_utl.c"
 S16 nhUTLUpdCellPduSts
(
NhCellCb *cellCb,
MsgType mesgType,
Cause evntCause
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1150); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Updating the Cell PDU Statistics.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   switch(mesgType)
   {
      ...
      case 25:
         ...
         break;
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1184); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Invalid Message Type.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         break;
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1222); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Updating the General Statistics.\n"); SPrint((&nhCb.init)->prntBuf); } }; };


   switch(stsType)
   {
      case 1:
         { if (*(&nhCb.genSts.numEstbCon) == 0xFFFFFFFF) *(&nhCb.genSts.numEstbCon) = 0; };
         nhCb.genSts.numEstbCon++;
         break;
      case 2:
         { if (*(&nhCb.genSts.numFailCon) == 0xFFFFFFFF) *(&nhCb.genSts.numFailCon) = 0; };
         nhCb.genSts.numFailCon++;
         break;
      case 3:
         { if (*(&nhCb.genSts.numReConfigSucc) == 0xFFFFFFFF) *(&nhCb.genSts.numReConfigSucc) = 0; };
         nhCb.genSts.numReConfigSucc++;
         break;
      case 4:
         { if (*(&nhCb.genSts.numReConfigFail) == 0xFFFFFFFF) *(&nhCb.genSts.numReConfigFail) = 0; };
         nhCb.genSts.numReConfigFail++;
         break;
      case 5:
         { if (*(&nhCb.genSts.numLwLyFail) == 0xFFFFFFFF) *(&nhCb.genSts.numLwLyFail) = 0; };
         nhCb.genSts.numLwLyFail++;
         break;
      case 6:
         { if (*(&nhCb.genSts.numDecErr) == 0xFFFFFFFF) *(&nhCb.genSts.numDecErr) = 0; };
         nhCb.genSts.numDecErr++;
         break;
      case 7:
         { if (*(&nhCb.genSts.numEncErr) == 0xFFFFFFFF) *(&nhCb.genSts.numEncErr) = 0; };
         nhCb.genSts.numEncErr++;
         break;
      case 8:
         { if (*(&nhCb.genSts.numPdcpErr) == 0xFFFFFFFF) *(&nhCb.genSts.numPdcpErr) = 0; };
         nhCb.genSts.numPdcpErr++;
         break;
      case 9:
         { if (*(&nhCb.genSts.numRlcErr) == 0xFFFFFFFF) *(&nhCb.genSts.numRlcErr) = 0; };
         nhCb.genSts.numRlcErr++;
         break;
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1264); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Invalid Statistics Type.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         break;
...
# 1302 "../..//lterrc/nh_utl.c"
static S16 nhUTLValidateTransId
(
...
# 1321 "../..//lterrc/nh_utl.c"
{
   ...
   if ((0L != transCb) && (transCb->status == 1))
   {

      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1336); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Duplicate NX transaction(Id:%ld) triggered from RRC user \n", datReqSdus->hdr.transId); SPrint((&nhCb.init)->prntBuf); } }; };
# 1343 "../..//lterrc/nh_utl.c"
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x08); };

      return(1);
   }

   if(1 == datReqSdus->sdu.ueMsg.msg.dedMsg.dlDcchMsg.isMsgEncoded)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1350); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Msg is already encoded by RRC user.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      if(1 == datReqSdus->sdu.isUeCfgPres)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1353); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"UE configuration info present.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x00); };
   ...
   if (0 != ret)
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1373); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid message type in the UE message"); SPrint((&nhCb.init)->prntBuf); } }; };

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0a); (*errInfo).errCause = (0x10); };
       ...
       (msgType == 10))
   {
      ...
      if (0 != ret)
      {
         ...
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1393); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid Message type in the UE message \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      (msgTransKey) = (((msgType) << 8) | (*msgTransId));;
      ...
      if (0L != transCb)
      {
          ...
          { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1408); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Duplicate message transaction(Id:%ld) triggered from RRC user \n", msgTransKey); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x09); };
...
# 1443 "../..//lterrc/nh_utl.c"
static S16 nhUTLValidateRbOrPdcpId
(
NhId nhIdentity,
NhCellAndUeCb *cellAndUeCb,
NhuErrorInfo *errInfo
...

{
   ...
   if(nhIdentity.isPdcpId)
   {
      ...
      ((((tmp) = ((rbCfgInfoList)->crnt = (rbCfgInfoList)->first)) != 0L) ? (tmp)->node : 0L);
      while(0L != tmp)
      {
         ...
         ((((tmp) = ((rbCfgInfoList)->crnt = ((rbCfgInfoList)->crnt ? (rbCfgInfoList)->crnt->next : (rbCfgInfoList)->first)))!= 0L) ? (tmp)->node : 0L);
      }


      if (tmp == 0L)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1484); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PDCP radio bearer with ID(%d) cannot be found\n", nhIdentity.rbId); SPrint((&nhCb.init)->prntBuf); } }; };



         { (*errInfo).errPres = 1; (*errInfo).errType = (0x06); (*errInfo).errCause = (0x19); };
   ...
   else
   {
      ...
      if (tmp == 0L)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1513); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "RLC entity with ID(%d) cannot be found \n", nhIdentity.rbId); SPrint((&nhCb.init)->prntBuf); } }; };


         { (*errInfo).errPres = 1; (*errInfo).errType = (0x06); (*errInfo).errCause = (0x01); };
...
# 1546 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateDatRsp
(
...
# 1563 "../..//lterrc/nh_utl.c"
{
   NhActvUeCb *ueCb;
   NhCellCb *cellCb;
   NhId nhIdentity;
   NhuDL_DCCH_MsgTyp *dlDcchMsg = 0L;
   MsgType msgType = 0;
   U16 crnti = 0;
   S16 ret;
   ...
   do { (Void)cmMemset((U8*)(&nhIdentity), 0, (Size)(sizeof(NhId))); } while(0);


   if (nhCb.eNodeBCb.numActUEs >= nhCb.eNodeBCb.protCfg.maxConn)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1583); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Maximum Limit of UE Connections Reached.\n"); SPrint((&nhCb.init)->prntBuf); } }; };



      { (*errInfo).errPres = 1; (*errInfo).errType = (0x11); (*errInfo).errCause = (0x00); };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1595); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CellId is Zero.\n"); SPrint((&nhCb.init)->prntBuf); } }; };


      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x1D); };
   ...
   if (0L == cellCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1607); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CellCb doesn't Exist with CellId (%d).\n", datRspSdus->hdr.cellId); SPrint((&nhCb.init)->prntBuf); } }; };



      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x02); };
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1621); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLValidateDatRsp: Validation for DLCCH Msg failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

      return(1);
   }

   else if(datRspSdus->sdu.msgCategory == 0x01)
   {
      dlDcchMsg = &(datRspSdus->sdu.m.dlDcchMsg.m.dcchMsg.message);
      if(dlDcchMsg && dlDcchMsg->choice.val == 0)
      {
         ...
         switch(dlDcchMsg->val.c1.choice.val)
         {
            case 0:
            {
               ...
               if(0L == ueCb)
               {
                  ...
                  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1642); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid UeId in Header %d\n", datRspSdus->hdr.ueId); SPrint((&nhCb.init)->prntBuf); } }; };

                  { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x07); };
   ...
   { (nhIdentity).cellId = (datRspSdus)->hdr.cellId; (nhIdentity).ueId = (crnti); if((datRspSdus)->sdu.msgCategory == 0x01) { (nhIdentity).isPdcpId = 1; (nhIdentity).rbId = (datRspSdus)->sdu.m.dlDcchMsg.pdcpId; } else { (nhIdentity).isPdcpId = 0; (nhIdentity).rbId = (datRspSdus)->sdu.m.dlCcchMsg.rbId; } };
# 1682 "../..//lterrc/nh_utl.c"
   if (0 != nhUTLValidateRbOrPdcpId(nhIdentity, cellAndUeCb, errInfo))
   {

      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1685); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "RbId is not Configured \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }

   return(0);
}
# 1714 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateCfgReq
(
...
{
   Bool bError;
   NhCellCb *tmpCellCb = 0L;
   NhActvUeCb *tmpUeCb = 0L;
   ...
   *cellCb = tmpCellCb;
   ...
   if(cfgReqSdus->cfgInfo.ueCfgBitMsk & 0x08)
   {
      tmpUeCb = nhDBMGetUeCb(tmpCellCb,
                          cfgReqSdus->cfgInfo.ueInfo.newCrnti);
      if(0L != tmpUeCb)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1756); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE ID already configured, but sent in UE ID cfg\n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x0d); };
   ...
   if(cfgReqSdus->hdr.ueId == 0)
   {
      if(!(cfgReqSdus->cfgInfo.ueCfgBitMsk & 0x08))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1769); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE ID config not present in UE Cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };

         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x1F); };
   ...
   else
   {
      ...
      if(0L == tmpUeCb)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1781); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid UE ID in the header \n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if(0L != tmpUeCb)
   {
      ...
      if (0 != nhUTLValidateUeCfg(&(cfgReqSdus->cfgInfo), tmpUeCb, errInfo))
      {
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x15); };
...
# 1827 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateDatReq
(
NhuDatReqSdus *datReqSdus,
NhCellAndUeCb *cellAndUeCb,
U8 *msgTransId,
...
# 1844 "../..//lterrc/nh_utl.c"
{
   ...
   if (1 == datReqSdus->sdu.ueMsg.isMsgDed)
   {
      ueCb = nhDBMGetUeCb(cellCb, datReqSdus->hdr.ueId);
      if (0L == ueCb)
      {

         { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x03); };
      ...
      if (0 != nhUTLValidateTransId(datReqSdus, ueCb, msgTransId,
   ...
   if(messageType == 8)
   {
      ...
      if(!(cellAndUeCb->ueCb->rbSecCfgBitMask & 0x01))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1895); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB1 is not configured.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x1A); };
   ...
   if(((messageType == 17) &&
      (datReqSdus->sdu.isUeCfgPres == 0)) &&
            !(ueCb->rbSecCfgBitMask & 0x04))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1910); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Security not yet configured, Can't send Sec Mode Command Message\n"); SPrint((&nhCb.init)->prntBuf); } }; };

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0e); (*errInfo).errCause = (0x1B); };

      return(1);
   }
# 1929 "../..//lterrc/nh_utl.c"
   { (nhIdentity).cellId = (datReqSdus)->hdr.cellId; (nhIdentity).ueId = (datReqSdus)->hdr.ueId; if ((datReqSdus)->sdu.ueMsg.isMsgDed) { (nhIdentity).isPdcpId = 1; (nhIdentity).rbId = (datReqSdus)->sdu.ueMsg.msg.dedMsg.dlDcchMsg.pdcpId; } else { (nhIdentity).isPdcpId = 0; (nhIdentity).rbId = (datReqSdus)->sdu.ueMsg.msg.cmnMsg.cmnMsgInfo.rbId; } };
   ...
   if (0 != nhUTLValidateRbOrPdcpId(nhIdentity, cellAndUeCb, errInfo))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1938); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLValidateRbOrPdcpId: conditional IE validation               failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 1965 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateUeCfg
(
NhuUeCfgInfo *ueCfg,
NhActvUeCb *ueCb,
NhuErrorInfo *errInfo
...

{
   ...
   if(0L == ueCb)
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 1990); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"ueCb does not exist.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(0);
   }

   do { (Void)cmMemset((U8*)(dirMsk), 0, (Size)(2*sizeof(U32))); } while(0);


   if(ueCfg->ueCfgBitMsk & 0x04)
   {
      if (!(ueCb->rbSecCfgBitMask & 0x01))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2002); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB1 Not yet configured, Can't initiate Security Activation\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      if(!(ueCb->rbSecCfgBitMask & 0x04))
      {
         if (!(ueCfg->secCfg.secCfgBitMsk & 0x01) ||
             !(ueCfg->secCfg.secCfgBitMsk & 0x02))
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2014); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Both intg and Cipher cfg must be provided for first sec cfg\n"); SPrint((&nhCb.init)->prntBuf); } }; };

            { (*errInfo).errPres = 1; (*errInfo).errType = (0x0f); (*errInfo).errCause = (0x2D); };
   ...
   if (ueCfg->ueCfgBitMsk & 0x01)
   {

      ret = nhUTLValidateUeCfgRbAdd(ueCfg, ueCb, errInfo);
      if (ret != 0)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2029); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Validation for RB Addition failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         return(1);
      }


      if (ueCfg->rbCfgAllList.rbCfgTypBitMsk & 0x02)
      {
         if (!(ueCb->crntCfg.bitMskPres & 0x0001))
         {
      ...
      if (ueCfg->rbCfgAllList.rbCfgTypBitMsk & 0x04)
      {
...
# 2128 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateCountReq
(
NhuHdr *countHdr,
NhuErrorInfo *errInfo,
U8 *event
...
# 2295 "../..//lterrc/nh_utl.c"
static S16 nhUTLValidateLogChTrchMap
(
NhuCellCfgInfo *cellCfgInfo
)
...

{
   ...
   do { (Void)cmMemset((U8*)(chkForRb), 0, (Size)(6*sizeof(Bool))); } while(0);
   ...
   for (rbId = 0; rbId < cellCfgInfo->rbToAddCfgList.numOfRbCfgInfo; rbId++)
   {
      ...
      if((rbCfgInfo->rbCfgBitMsk & 0x02) &&
         ...
         (rbCfgInfo->dlRbCfg.dlRlcMode.mode != 0x01))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2323); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Invalid RLC Mode\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         return(1);
      }

      if((rbCfgInfo->rbCfgBitMsk & 0x01) &&
         (rbCfgInfo->ulRbCfg.ulRbBitMsk & 0x02) &&
         (rbCfgInfo->ulRbCfg.ulRlcMode.mode != 0x01))
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2331); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Invalid RLC Mode\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         return(1);
      }

      if(rbCfgInfo->rbCfgBitMsk & 0x02 &&
         rbCfgInfo->dlRbCfg.dlRbBitMsk & 0x01)
      {
         ...
         if (lcType == 3 &&
             trChType == 3)
         {
            { if (1 == chkForRb[(0)]) { ret = 1; } else { chkForRb[(0)] = 1; ret = 0; } }

            if (ret != 0)
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2348); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Duplicate CCCH->DL_SCH mapping in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
               ...
               return(1);
                 ...
                 trChType == 1)
         {
            { if (1 == chkForRb[(2)]) { ret = 1; } else { chkForRb[(2)] = 1; ret = 0; } }

            if (ret != 0)
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2360); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Duplicate BCCH->BCH mapping in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
               ...
               return(1);
                  ...
                  trChType == 2)
         {
            { if (1 == chkForRb[(3)]) { ret = 1; } else { chkForRb[(3)] = 1; ret = 0; } }
            if (ret != 0)
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2371); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Duplicate PCCH->PCH mapping in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
                  ...
                  trChType == 3)
         {
            ...
            { if (1 == chkForRb[(4)]) { if ((1 == chkForRb[(4)+1]) || ((0xFF != bcchLcId) && (rbCfgInfo->lcId.lcId == bcchLcId))) { ret = 1; } else { chkForRb[(4)+1] = 1; ret = 0; } } else { chkForRb[(4)] = 1; bcchLcId = rbCfgInfo->lcId.lcId; ret = 0; } };


            if (0 != ret)
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2388); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Duplicate BCCH->DL_SCH mapping in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         {
             { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2395); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid LogCh to Trch mapping in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      if(rbCfgInfo->rbCfgBitMsk & 0x01 &&
         rbCfgInfo->ulRbCfg.ulRbBitMsk & 0x01)
      {
         lcType = rbCfgInfo->lcId.logChType;
         ...
         if(lcType == 3 &&
            trChType == 5)
         {
            { if (1 == chkForRb[(1)]) { ret = 1; } else { chkForRb[(1)] = 1; ret = 0; } }
            if (ret != 0)
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2412); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Duplicate CCCH->UL_SCH mapping in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         {
             { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2419); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid LogCh to Trch mapping in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 2446 "../..//lterrc/nh_utl.c"
static S16 nhUTLValidateCfgTypeSetup
(
...

{
   ...
   if (0L != cellCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2468); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell Setup: duplicate cell(id:%d) found \n", cellCfgReqSdus->hdr.cellId); SPrint((&nhCb.init)->prntBuf); } }; };


      { (*errInfo).errPres = 1; (*errInfo).errType = (0x09); (*errInfo).errCause = (0x1C); };

      return(1);
   }

   if (!((cellCfgInfo->cellCfgBitMsk & 0x01) &&
        (cellCfgInfo->cellCfgBitMsk & 0x08)))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2478); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if ((cellCfgInfo->cellCfgBitMsk & 0x01) &&
    ...
    (cellCfgInfo->rbToAddCfgList.numOfRbCfgInfo > 6)))
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2489); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid Add RB config in cell cfg \n"); SPrint((&nhCb.init)->prntBuf); } }; };

      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x15); };
   ...
   if (0 != (nhUTLValidateLogChTrchMap(cellCfgInfo)))
   {
      { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x15); };
...
# 2563 "../..//lterrc/nh_utl.c"
   return(0);

}
# 2586 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateCellCfgReq
(
NhuCellCfgReqSdus *cellCfgReqSdus,
NhCellCb *cellCb,
NhuErrorInfo *errInfo
...

{
   ...
   switch(cellCfgReqSdus->sdu.cfgType)
   {
      ...
      case 0x02:
      {
         ...
         if (0L == cellCb)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2628); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell Modify/Release: cell(id:%d) not found \n", cellCfgReqSdus->hdr.cellId); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         if (0x01 == cellCb->cellTransCb.status)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2641); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell Modify: cellId:%d has ongoing transaction\n", cellCfgReqSdus->hdr.cellId); SPrint((&nhCb.init)->prntBuf); } }; };


            { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x05); };

            return(1);
         }

         if (!((cellReCfgInfo->cellCfgBitMsk & 0x08)
         ...
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2656); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid cell config bitmask(%d) in cell cfg \n", cellReCfgInfo->cellCfgBitMsk); SPrint((&nhCb.init)->prntBuf); } }; };


            { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x0e); };

            return(1);
         }
# 2679 "../..//lterrc/nh_utl.c"
      }
      break;
      case 0x04:
      {
         if (0L == cellCb)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2687); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell Release: cell(id:%d) not found \n", cellCfgReqSdus->hdr.cellId); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         if (0x01 == cellCb->cellTransCb.status)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2700); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Cell Modify/Release: cellId:%d has ongoing transaction\n", cellCfgReqSdus->hdr.cellId); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      default:
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2711); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid config type(cfgType: %d) in cell cfg \n", cellCfgReqSdus->sdu.cfgType); SPrint((&nhCb.init)->prntBuf); } }; };


         { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x12); };
...
# 2737 "../..//lterrc/nh_utl.c"
 NhLSapCb* nhUTLFindLlyrSapFrmSuId
(
U8 sapType,
SuId lSapId
)
...

{
   ...
   {
      case 3:
# 2768 "../..//lterrc/nh_utl.c"
         lSapCb = *(nhCb.kwuSapCbLst + lSapId);
         break;

      case 4:
# 2784 "../..//lterrc/nh_utl.c"
         lSapCb = *(nhCb.ckwSapCbLst + lSapId);
         break;

      case 5:
# 2800 "../..//lterrc/nh_utl.c"
         lSapCb = *(nhCb.crgSapCbLst + lSapId);
         break;

      case 6:
# 2816 "../..//lterrc/nh_utl.c"
         lSapCb = *(nhCb.cpjSapCbLst + lSapId);
         break;

      case 7:
# 2832 "../..//lterrc/nh_utl.c"
         lSapCb = *(nhCb.pjuSapCbLst + lSapId);
         break;
# 2853 "../..//lterrc/nh_utl.c"
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2855); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLFindLlyrSapFrmSuId: Invalid sapType \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 2884 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateSRBforMsgRx
(
NhActvUeCb *ueCb,
U8 rbId,
U8 msgType
...

{
   ...
   switch(msgType)
   {
      ...
      case 1:
         if((1 != rbId) && (2 != rbId))
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2907); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB validation failed for message:%d \n", msgType); SPrint((&nhCb.init)->prntBuf); } }; };


            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2909); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received in RB ID: %d.\n", rbId); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      case 12:
         ...
         if(1 != rbId)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2932); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "SRB validation failed for message:%d \n", msgType); SPrint((&nhCb.init)->prntBuf); } }; };


            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2935); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "received in RB ID: %d\n", rbId); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         break;
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 2940); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"Unknown message received.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         return(1);
   }

   return(0);
}
# 2963 "../..//lterrc/nh_utl.c"
 S16 nhUTLFillDfltConfig
(
NhCellAndUeCb *cellAndUeCb,
NhuUeCfgInfo *ueCfg
)
...

{
   ...
   (cellAndUeCb=cellAndUeCb);


   if (ueCfg->ueCfgBitMsk & 0x01)
   {
      if (ueCfg->rbCfgAllList.rbCfgTypBitMsk & 0x01)
      {
               ...
               cnt++)
         {
            ...
            if((rbCfgInfo->rbId.rbId == 1) ||
                  (rbCfgInfo->rbId.rbId == 2))
            {
               ...
               if((rbCfgInfo->rbCfgBitMsk & 0x01) &&
                     ...
                     (rbCfgInfo->ulRbCfg.ulRlcMode.rlcCfgType ==
                                          0x04))
               {
                  rbCfgInfo->ulRbCfg.ulRlcMode.mode = 0x03;
               ...
               if((rbCfgInfo->rbCfgBitMsk & 0x02) &&
                     ...
                     (rbCfgInfo->dlRbCfg.dlRlcMode.rlcCfgType ==
                      0x04))
               {
                  rbCfgInfo->dlRbCfg.dlRlcMode.mode = 0x03;
   ...
   if (ueCfg->ueCfgBitMsk & 0x02 &&
       ueCfg->trChCfg.trChCfgType == 0x04)
   {
      ueCfg->trChCfg.trChBitMsk |= 0x01;
      ueCfg->trChCfg.ulHarqCfg.ulMaxHarqTx = NHU_MAX_HARQ_TX_N5;
   }
# 3182 "../..//lterrc/nh_utl.c"
   return(0);
}
# 3485 "../..//lterrc/nh_utl.c"
 S16 nhUTLGetRbToRestb
(
TransCb *transCtrlBlk,
...
{
   NhRbCfgList *rbCfgList = 0L;
   NhuRbCfgInfo *rbInfo = 0L;
   CmLList *tmpNode = 0L;
   CmLList *crntRbInf = 0L;
   Bool found;
   U8 i;

   ;;

   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 3505); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"nhUTLGetRbToRestb called.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

   rbCfgList = &transCtrlBlk->ordrdCfg.rbToRestbCfgList;

   ((((crntRbInf) = ((&crntRbCfgList.rbCfgInfoList)->crnt = (&crntRbCfgList.rbCfgInfoList)->first)) != 0L) ? (crntRbInf)->node : 0L);
   while(0L != crntRbInf)
   {

       if(1 == ((NhuRbCfgInfo *) crntRbInf->node)->rbId.rbId &&
          0 == ((NhuRbCfgInfo *) crntRbInf->node)->rbId.rbTyp)
       {
          ((((crntRbInf) = ((&crntRbCfgList.rbCfgInfoList)->crnt = ((&crntRbCfgList.rbCfgInfoList)->crnt ? (&crntRbCfgList.rbCfgInfoList)->crnt->next : (&crntRbCfgList.rbCfgInfoList)->first)))!= 0L) ? (crntRbInf)->node : 0L);
          continue;
       }
       found = 0;
       ...
       if(found == 0)
       {
          ...
          do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&tmpNode), (sizeof(CmLList))) == 0) { do { (Void)cmMemset((U8*)((*(&tmpNode))), 0, (Size)((sizeof(CmLList)))); } while(0); } else { (*(&tmpNode)) = 0L; } } while(0);
          if(0L == tmpNode)
          {
             { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 3560); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation failed for adding radio bearer.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

             return(4);
          }
          do { if (SGetSBuf((nhCb.init.region), (nhCb.init.pool), (Data **)(&rbInfo), (sizeof(NhuRbCfgInfo))) == 0) { do { (Void)cmMemset((U8*)((*(&rbInfo))), 0, (Size)((sizeof(NhuRbCfgInfo)))); } while(0); } else { (*(&rbInfo)) = 0L; } } while(0);
          if(0L == rbInfo)
          {
             { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 3567); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation failed for adding radio bearer.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

             { if ((tmpNode) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 3568, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(tmpNode), (Size)(sizeof(CmLList))); (tmpNode) = 0L; } };
             return(4);
          }
         if(0 == ((NhuRbCfgInfo *) crntRbInf->node)->rbId.rbTyp)
         {
         ...
         else
         {
          ...
          do { (Void)cmMemcpy((U8*)((U8*)rbInfo),(const U8*)((U8*)crntRbInf->node), (Size)(sizeof(NhuRbCfgInfo)));} while(0);
          tmpNode->node = (U32)rbInfo;
...
# 3620 "../..//lterrc/nh_utl.c"
 S16 nhUTLFreeUlBitMapFrmCrntRbCfg
(
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 3635); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLFreeUlBitMapFrmCrntRbCfg called  \n"); SPrint((&nhCb.init)->prntBuf); } }; };

   ((((tmpNode) = ((&crntCfgInfo->rbCfgList.rbCfgInfoList)->crnt = (&crntCfgInfo->rbCfgList.rbCfgInfoList)->first)) != 0L) ? (tmpNode)->node : 0L);

   while(0L != tmpNode)
   {
      hoPdcpSduStaInfo = &(((NhuRbCfgInfo *) tmpNode->node)->pdcpCfg. hoPdcpSduStaInfo);



      { ulBitMapSize = hoPdcpSduStaInfo->numBits / 8; if(hoPdcpSduStaInfo->numBits % 8) { ulBitMapSize++; } };

      if((0L != hoPdcpSduStaInfo->ulBitMap) && (ulBitMapSize > 0))
      {
         { if ((hoPdcpSduStaInfo->ulBitMap) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 3649, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(hoPdcpSduStaInfo->ulBitMap), (Size)(ulBitMapSize)); (hoPdcpSduStaInfo->ulBitMap) = 0L; } };
      }
      ((((tmpNode) = ((&crntCfgInfo->rbCfgList.rbCfgInfoList)->crnt = ((&crntCfgInfo->rbCfgList.rbCfgInfoList)->crnt ? (&crntCfgInfo->rbCfgList.rbCfgInfoList)->crnt->next : (&crntCfgInfo->rbCfgList.rbCfgInfoList)->first)))!= 0L) ? (tmpNode)->node : 0L);
   }
   return(0);
}
# 3673 "../..//lterrc/nh_utl.c"
 S16 nhUTLFreeUlBitMapFrmOrdCfg
(
TransCb *transCtrlBlk,
U8 numRbs
)
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 3691); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLFreeUlBitMapFrmOrdCfg called  \n"); SPrint((&nhCb.init)->prntBuf); } }; };

   for(rbCnt = 0; rbCnt < numRbs; rbCnt++)
   {
      pdcpCfgBitMsk = transCtrlBlk->ordrdCfg.rbToModCfgList. rbCfgInfoList[rbCnt].pdcpCfg.pdcpCfgBitMsk;

      if (pdcpCfgBitMsk & 0x20)
      {
         hoPdcpSduStaInfo = &transCtrlBlk->ordrdCfg.rbToModCfgList. rbCfgInfoList[rbCnt].pdcpCfg.hoPdcpSduStaInfo;

         if( (0x01 & hoPdcpSduStaInfo->isHoPres) &&
             (hoPdcpSduStaInfo->numBits > 0) )
         {
            ...
            { if ((hoPdcpSduStaInfo->ulBitMap) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_utl.c", 3709, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(hoPdcpSduStaInfo->ulBitMap), (Size)(ulBitMapSize)); (hoPdcpSduStaInfo->ulBitMap) = 0L; } };
...
# 5567 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateLSapSuId
(
U16 elmntId,
SuId suId
)
...

{
   ...
   switch(elmntId)
   {
      ...
      case 7:
         ...
         break;
# 5627 "../..//lterrc/nh_utl.c"
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5629); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhUTLValidateLSapSuId: Invalid sapType \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 5654 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateDatRspDlCChMsg
(
NhuDatRspSdus *datRspSdus,
NhCellAndUeCb *cellAndUeCb,
NhuErrorInfo *errInfo,
...
# 5675 "../..//lterrc/nh_utl.c"
{
   NhuDL_CCCH_MsgTyp *dlCcchMsg = 0L;
   NhActvUeCb *ueCb;
   NhCellCb *cellCb = 0L;
   ...
   *mesgType = 0;
   ...
   if(datRspSdus->sdu.msgCategory == 0x03)
   {
      dlCcchMsg = &(datRspSdus->sdu.m.dlCcchMsg.ccchMsg.message);
      if(dlCcchMsg && dlCcchMsg->choice.val == 0)
      {
         ...
         switch(dlCcchMsg->val.c1.choice.val)
         {
            case 3:
            {
               if(0 == datRspSdus->sdu.m.dlCcchMsg.tmpCrnti)
               {
                  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5698); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Temporary Crnti is not present.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
               ...
               if(datRspSdus->hdr.ueId == 0)
               {
                  if((1 == datRspSdus->sdu.isUeCfgPres) &&
                     !(datRspSdus->sdu.ueCfg.ueCfgBitMsk &
                                                      0x08))
                  {
                     { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5711); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE ID config not present in the UE CFG.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

                     { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x1F); };

                     return(1);
                  }
                  else if((1 == datRspSdus->sdu.isUeCfgPres) &&
                        (datRspSdus->sdu.ueCfg.ueCfgBitMsk &
                                            0x08) &&
                        (datRspSdus->sdu.ueCfg.ueInfo.newCrnti !=
                            datRspSdus->sdu.m.dlCcchMsg.tmpCrnti))
                  {
                     { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5723); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE ID mismatch in config and message SDU.\n"); SPrint((&nhCb.init)->prntBuf); } }; };

                     { (*errInfo).errPres = 1; (*errInfo).errType = (0x0b); (*errInfo).errCause = (0x20); };
               ...
               else
               {
                  ...
                  if(0L == ueCb)
                  {
                     ...
                     { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5737); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid UeId in Header %d\n", datRspSdus->hdr.ueId); SPrint((&nhCb.init)->prntBuf); } }; };
                  ...
                  if((1 == datRspSdus->sdu.isUeCfgPres) &&
                     ...
                     (datRspSdus->sdu.ueCfg.ueInfo.newCrnti !=
                                         datRspSdus->sdu.m.dlCcchMsg.tmpCrnti))
                  {
                     { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5756); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE ID mismatch in config and message SDU %d.\n", datRspSdus->sdu.m.dlCcchMsg.tmpCrnti ); SPrint((&nhCb.init)->prntBuf); } }; };
            ...
            case 0:
            {
               ...
               if(0L == ueCb)
               {
                  ...
                  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5780); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid UeId in Header %d\n", datRspSdus->hdr.ueId); SPrint((&nhCb.init)->prntBuf); } }; };
               ...
               if((1 == datRspSdus->sdu.isUeCfgPres) && (
                 ((datRspSdus->sdu.ueCfg.ueCfgBitMsk & 0x08)
                                                                     == 0) ||
                 ((datRspSdus->sdu.ueCfg.ueCfgBitMsk & 0x04)
                                                                     == 0)))
               {
                  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5798); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid Configuration Info %d\n", datRspSdus->hdr.ueId); SPrint((&nhCb.init)->prntBuf); } }; };
                  ...
                  return(1);
                     ...
                     (datRspSdus->sdu.ueCfg.ueCfgBitMsk & 0x08) &&
                      (datRspSdus->sdu.ueCfg.ueInfo.newCrnti !=
                                          datRspSdus->sdu.m.dlCcchMsg.tmpCrnti))
               {
                  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5810); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE ID mismatch in config and                   message SDU %d.\n", datRspSdus->sdu.m.dlCcchMsg.tmpCrnti ); SPrint((&nhCb.init)->prntBuf); } }; };
...
# 5850 "../..//lterrc/nh_utl.c"
 S16 nhUTLValidateUeCfgRbAdd
(
NhuUeCfgInfo *ueCfg,
NhActvUeCb *ueCb,
NhuErrorInfo *errInfo
...

{
   ...
   do { (Void)cmMemset((U8*)(ddirMsk), 0, (Size)(2 * sizeof(U32))); } while(0);
   do { (Void)cmMemset((U8*)(sdirMsk), 0, (Size)(2 * sizeof(U32))); } while(0);

   if ((ueCfg->rbCfgAllList.rbCfgTypBitMsk & 0x01)
         && (ueCb->crntCfg.bitMskPres & 0x0001))
   {
      ...
      for(i=0; i<(rbToAddList->numOfRbCfgInfo); i++)
      {
         ...
         if(rbCfgInfo->rbId.rbTyp == 0)
         {
             { U32 _tmpSrb = 0, _tmpSlc = 0; U8 _srbId, _slcId; _srbId = rbCfgInfo->rbId.rbId; _tmpSrb = (1 << (_srbId - 1)); _slcId = rbCfgInfo->lcId.lcId; _tmpSlc = (1 << (_slcId - 1)); if((srbMsk) & _tmpSrb) (ret) = 1; else (srbMsk) |= _tmpSrb; if((slcMsk) & _tmpSlc) { if(((rbCfgInfo)->rbCfgBitMsk & 0x02) && (sdirMsk[0] & _tmpSlc)) (ret) = 1; else sdirMsk[0] |= _tmpSlc; if(((rbCfgInfo)->rbCfgBitMsk & 0x01) && (sdirMsk[1] & _tmpSlc)) (ret) = 1; else sdirMsk[1] |= _tmpSlc; } else { (slcMsk) |= _tmpSlc; if((rbCfgInfo)->rbCfgBitMsk & 0x02) sdirMsk[0] |= _tmpSlc; if((rbCfgInfo)->rbCfgBitMsk & 0x01) sdirMsk[1] |= _tmpSlc; } };

         }
         else
         {
             { U32 _tmpDrb = 0, _tmpDlc = 0; U8 _drbId, _dlcId; _drbId = rbCfgInfo->rbId.rbId; _tmpDrb = (1 << (_drbId - 1)); _dlcId = rbCfgInfo->lcId.lcId; _tmpDlc = (1 << (_dlcId - 1)); if((drbMsk) & _tmpDrb) (ret) = 1; else (drbMsk) |= _tmpDrb; if((dlcMsk) & _tmpDlc) { if(((rbCfgInfo)->rbCfgBitMsk & 0x02) && (ddirMsk[0] & _tmpDlc)) (ret) = 1; else ddirMsk[0] |= _tmpDlc; if(((rbCfgInfo)->rbCfgBitMsk & 0x01) && (ddirMsk[1] & _tmpDlc)) (ret) = 1; else ddirMsk[1] |= _tmpDlc; } else { (dlcMsk) |= _tmpDlc; if((rbCfgInfo)->rbCfgBitMsk & 0x02) ddirMsk[0] |= _tmpDlc; if((rbCfgInfo)->rbCfgBitMsk & 0x01) ddirMsk[1] |= _tmpDlc; } };

         }
         if(1 == ret)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5905); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Logical channel Configuration with Invalid                                                   Ul/Dl BitMask \n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         if (rbCfgInfo->rbCfgBitMsk & 0x04)
         {
            if (!((rbCfgInfo->rbCfgBitMsk & 0x01) ||
                 (rbCfgInfo->rbCfgBitMsk & 0x02)))
            {
               { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5920); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "RB(PDCP) Configuration with                          Invalid Ul/Dl(RLC) BitMask \n"); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         { if (rbCfgInfo->rbId.rbTyp == 0) { if ((rbCfgInfo->rbId.rbId == 1) || (rbCfgInfo->rbId.rbId == 2)) ret = 0; else ret = 1; } };
         if(1 == ret)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_utl.c", 5933); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "RB type and RB Id mismatch \n"); SPrint((&nhCb.init)->prntBuf); } }; };
