...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 104 "../..//s1ap/sz_mgmt.c" 2
# 1 "../..//cm/cm5.h" 1
# 105 "../..//s1ap/sz_mgmt.c" 2
# 1 "../..//cm/cm_llist.h" 1
# 90 "../..//cm/cm_llist.h"
#define __CMLLISTH__ 
...
# 110 "../..//s1ap/sz_mgmt.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 111 "../..//s1ap/sz_mgmt.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 140 "../..//s1ap/sz_mgmt.c" 2
# 1 "../..//cm/cm5.x" 1
# 141 "../..//s1ap/sz_mgmt.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 147 "../..//s1ap/sz_mgmt.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 148 "../..//s1ap/sz_mgmt.c" 2
...
# 174 "../..//s1ap/sz_mgmt.c" 2
# 189 "../..//s1ap/sz_mgmt.c"
static Bool szMgmtChkConnLst ( SztResetTyp *tknIE, S1apPdu *pdu );
# 207 "../..//s1ap/sz_mgmt.c"
...

{
   ...
   if(peerCb->skipUeSm == 0)
   {
      ...
      if (peerCb->state == 1)
      {
         ...
         if ((ret = szMgmtChkConnLst(((SztResetTyp *)tknIE), peerCb->resetPdu)) == 1)
         {
            uDatEvnt.transId.pres = 0;
            uDatEvnt.peerId.pres = 1;
            uDatEvnt.peerId.val = peerCb->peerId;
            ...
            szDbFillResetAck(pdu, &rstAckPdu, mem);
   ...
   if(peerCb->skipUeSm == 0)
   {
      ...
      else
      {
         ...
         for (idx = 0; idx < nmbConns; idx++)
         {
            ...
            if (((SztResetTyp *)tknIE)->val.partOfS1_Intf.member[idx].value.u. sztUE_assocLogS1_ConItem.pres.pres != 0)

            {

               {

                  if (((SztResetTyp *)tknIE)->val.partOfS1_Intf.member[idx]. value.u.sztUE_assocLogS1_ConItem.eNB_UE_S1AP_ID.pres != 0)

                  {
                     conRefNo = ((SztResetTyp *)tknIE)->val.partOfS1_Intf.member[idx]. value.u.sztUE_assocLogS1_ConItem.eNB_UE_S1AP_ID.val;


                     conRefType = 1;
                  }
                  else if (((SztResetTyp *)tknIE)->val.partOfS1_Intf.member[idx]. value.u.sztUE_assocLogS1_ConItem.mME_UE_S1AP_ID.pres != 0)

                  {
                     conRefNo = ((SztResetTyp *)tknIE)->val.partOfS1_Intf.member[idx]. value.u.sztUE_assocLogS1_ConItem.mME_UE_S1AP_ID.val;
...

{
   ...
   for (i = 0; i < nmbConns; i++)
   {
      ...
      else
      {
         ...
         { if ((&szCb.init)->dbgMask & (0x00000100)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mgmt.c", 1337); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szMgmtChkConnLst: S1 Connection is empty \n"); SPrint((&szCb.init)->prntBuf); } };
