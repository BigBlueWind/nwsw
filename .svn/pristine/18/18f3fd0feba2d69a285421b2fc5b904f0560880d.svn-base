...
# 142 "../..//sctp/sb_bdy1.c" 2
# 1 "../..//cm/cm5.h" 1
# 143 "../..//sctp/sb_bdy1.c" 2
# 1 "../..//cm/cm_tpt.h" 1
# 90 "../..//cm/cm_tpt.h"
#define __CMTPTH__ 
...
# 163 "../..//sctp/sb_bdy1.c" 2
# 1 "../..//cm/cm5.x" 1
# 164 "../..//sctp/sb_bdy1.c" 2
# 1 "../..//cm/cm_tpt.x" 1
# 95 "../..//cm/cm_tpt.x"
#define __CMTPTX__ 
...
# 246 "../..//sctp/sb_bdy1.c"
{
   ...
   ;
# 306 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 308); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbActvInit(Ent(%d), Inst(%d), Region(%d), Reason(%d))\n", entity, inst, region, reason); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };





   cmMemset((U8 *)&sbGlobalCb, 0, sizeof(sbGlobalCb));;

   sbGlobalCb.sbInit.ent = entity;
   sbGlobalCb.sbInit.inst = inst;
   sbGlobalCb.sbInit.region = region;
   sbGlobalCb.sbInit.reason = reason;
   sbGlobalCb.sbInit.cfgDone = 0;
   ...
   sbGlobalCb.sbInit.acnt = 0;
   sbGlobalCb.sbInit.usta = 1;
   sbGlobalCb.sbInit.trc = 0;


   sbGlobalCb.sbTqCp.nxtEnt = 0;
   sbGlobalCb.sbTqCp.tmrLen = 201;

   for (idx = 0; idx < 201; idx++)
   {
      sbGlobalCb.sbTq[idx].first = 0L;
   }
...

{
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 0))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 460); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "sbTmrEvnt(Evnt(%d))\n", evnt); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   switch (evnt)
   {
      ...
      case 0xa:
         ...
         { U16 _wait; CmTmrArg _arg; _wait = 36000; if (_wait != 0) { _arg.tq = &(sbGlobalCb.sbTq[0]); _arg.tqCp = &(sbGlobalCb.sbTqCp); _arg.timers = &(sbGlobalCb.mtuIncTmr); _arg.cb = (U32)&(sbGlobalCb.mtuCp); _arg.evnt = 0xa; _arg.wait = _wait; _arg.tNum = 0; _arg.max = 1; cmPlcCbTq(&_arg); } }

         break;
      case 0xb:
         err = sbMtuIncMtuUpper((SbMtuCp *)cb);
         { U16 _wait; CmTmrArg _arg; _wait = 6000; if (_wait != 0) { _arg.tq = &(sbGlobalCb.sbTq[0]); _arg.tqCp = &(sbGlobalCb.sbTqCp); _arg.timers = &(sbGlobalCb.mtuIncTmrUp); _arg.cb = (U32)&(sbGlobalCb.mtuCp); _arg.evnt = 0xb; _arg.wait = _wait; _arg.tNum = 0; _arg.max = 1; cmPlcCbTq(&_arg); } }
...

{
   ...
   ;
# 627 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 628); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCfgReq(pst, elmnt(%d))\n", cfg->hdr.elmId.elmnt); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   cmMemset((U8 *)&cfmMsg, 0, sizeof(SbMgmt));;


   if ( (hdr->elmId.elmnt != 1) &&
        (sbGlobalCb.sbInit.cfgDone == 0) )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 641); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCfgReq: general configuration not done yet\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      sbLmSendCfm(pst, 1, hdr, 1, 8,
                  &cfmMsg);
      return(1);
   }
   ...
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 652); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCfgReq: currently servicing a layer manager request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      sbLmSendCfm(pst, 1, hdr, 1, (256 + 4),
                  &cfmMsg);
      return(1);
   }
...
# 685 "../..//sctp/sb_bdy1.c"
   ...
   if (ret != 0)
   {
      sbLmSendCfm(pst, 1, hdr, 1, ret,
                  &cfmMsg);
      return(1);
   }

   sbLmSendCfm(pst, 1, hdr, 0, 0,
               &cfmMsg);
   return(0);
}
# 733 "../..//sctp/sb_bdy1.c"
...

{
   ...
   ;
# 768 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 769); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCntrlReq(pst, elmnt(%d))\n", cntrl->hdr.elmId.elmnt); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   hdr = &(cntrl->hdr);
    ...
    { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&cfmMsg, sizeof(SbMgmt)); if ( ret == 0 ) { cmMemset((U8*)cfmMsg, 0, sizeof(SbMgmt)); sbGlobalCb.genSta.memAlloc += (sizeof(SbMgmt)); } };
    if ( ret != 0 )
    {
        { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 783); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCntrlReq: could not allocate memory for Response Structure\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( (sbGlobalCb.sbInit.cfgDone == 0) && (hdr->elmId.elmnt != 1) )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 798); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCntrlReq: general configuration not done yet\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      sbLmSendCfm(pst, 2, hdr, 1, 8,
                  cfmMsg);

      { if (cfmMsg == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 803); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)cfmMsg, sizeof(SbMgmt)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbMgmt)); cfmMsg = 0L; } };
      return(1);
   }
   ...
   if ( sbGlobalCb.sbMgmt.hdr.elmId.elmnt != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 811); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbCntrlReq: currently servicing a layer manager request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      sbLmSendCfm(pst, 2, hdr, 1, (256 + 4),
                  cfmMsg);

      { if (cfmMsg == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 816); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)cfmMsg, sizeof(SbMgmt)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbMgmt)); cfmMsg = 0L; } };
      return(1);
   }
   ...
   switch(hdr->elmId.elmnt)
   {
      ...
      case 2:
         ret = sbCntrlSctSap(cntrl);
         break;

      case 3:
         if ( cntrl->t.cntrl.action == 21 )
         {
...
# 862 "../..//sctp/sb_bdy1.c"
   ...
   if (ret != 0)
   {
      cmMemset((U8 *)&(sbGlobalCb.sbMgmt), 0, sizeof(SbMgmt));;
      sbLmSendCfm(pst, 2, hdr, 1, ret, cfmMsg);

      { if (cfmMsg == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 881); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)cfmMsg, sizeof(SbMgmt)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbMgmt)); cfmMsg = 0L; } };
      return(1);
   }



   if ( (hdr->elmId.elmnt == 3) && (cntrl->t.cntrl.action == 21) )
   {
      tSap = sbGlobalCb.tSaps[cntrl->t.cntrl.sapId];
      if (tSap->sapState != 1)
      {
         sbLmSendCfm(pst, 2, hdr, 2, 0,
                     cfmMsg);
      }

      { if (cfmMsg == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 896); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)cfmMsg, sizeof(SbMgmt)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbMgmt)); cfmMsg = 0L; } };
      return(0);
   }

   sbLmSendCfm(pst, 2, hdr, 0, 0,
               cfmMsg);


   { if (cfmMsg == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 904); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)cfmMsg, sizeof(SbMgmt)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbMgmt)); cfmMsg = 0L; } };
...

{
   ...
   ;;
# 1334 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1335); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStaReq(pst, elmnt(%d))\n", sta->hdr.elmId.elmnt); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( (sbGlobalCb.sbInit.cfgDone == 0) )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1351); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStaReq: general configuration not done yet\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      sbLmSendCfm(pst, 4, hdr, 1, 8,
                  &cfmMsg);
      return(1);
   }
   ...
   if ( sbGlobalCb.sbMgmt.hdr.elmId.elmnt != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1362); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStaReq: currently servicing a layer manager request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

      sbLmSendCfm(pst, 4, hdr, 1, (256 + 4),
                  &cfmMsg);
      return(1);
   }
   ...
   switch (hdr->elmId.elmnt)
   {
      ...
      case 1:
      {
         ...
         {
            if ( sbGlobalCb.endpCb[i] != (SbSctEndpCb *) 0L )
            {
...
# 1570 "../..//sctp/sb_bdy1.c"
   ...
   if (ret != 0)
   {
      sbLmSendCfm(pst, 4, hdr, 1, ret, &cfmMsg);
      return(1);
   }

   sbLmSendCfm(pst, 4, hdr, 0, 0, &cfmMsg);
   return(0);
}
# 1621 "../..//sctp/sb_bdy1.c"
 S16 SbMiLsbStsReq
...

{
   ...
   ;
# 1660 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1662); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStsReq(pst, action(%d), elmnt(%d))\n", action, sts->hdr.elmId.elmnt); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   cmMemset((U8 *)&lastTime, 0, sizeof(DateTime));;

   cmMemset((U8 *)&currentTime, 0, sizeof(DateTime));;


   if ( (sbGlobalCb.sbInit.cfgDone == 0) )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1682); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStsReq: general configuration not done yet\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


      sbLmSendCfm(pst, 3, hdr, 1, 8,
                  &cfmMsg);
      return(1);
   }
   ...
   if ( sbGlobalCb.sbMgmt.hdr.elmId.elmnt != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1693); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStsReq: currently servicing a layer manager request\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

      sbLmSendCfm(pst, 3, hdr, 1, (256 + 4),
                  &cfmMsg);
      return(1);
   }
   ...
   switch (hdr->elmId.elmnt)
   {
      case 1:
         ...
         if (action == 0)
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1719); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStsReq: statistics counters cleared\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


            cmMemset((U8 *)&sbGlobalCb.genSts, 0, sizeof(SbGenSts));;
      ...
      case 2:
      {
         ...
         if (action == 0)
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1767); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStsReq: statistics counters cleared\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


            cmMemset((U8 *)&sctSap->sctSts, 0, sizeof(SbSctSapSts));;
       ...
       case 3:
         ...
         if (action == 0)
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000002)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1819); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbMiLsbStsReq: statistics counters cleared\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


            cmMemset((U8 *)&(tSap->tSts), 0, sizeof(SbTSapSts));;
   ...
   if (ret != 0)
   {
      sbLmSendCfm(pst, 3, hdr, 1, ret, &cfmMsg);
      return(1);
   }


   sbLmSendCfm(pst, 3, hdr, 0, 0, &cfmMsg);
...

{
   ...
   ;
# 1924 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 1925); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctBndReq(pst, suId(%d), spId(%d))\n", suId, spId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
        ...
        (spId < 0) )
   {
      ...
      { sbLmGenAlarm((U16)2, (U16)1, (U16)3, spId, 1); };



      ret = 1;
   }
   else if ( sbGlobalCb.sctSaps[spId] == (SbSctSapCb *) 0L )
   {

      { sbLmGenAlarm((U16)2, (U16)1, (U16)2, spId, 1); };
   ...
   if ( ret != 0 )
   {
      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy1.c", 1956, (ErrCls)0x2, (ErrCode)(0 + 22), (ErrVal)(ErrVal)spId, "SbUiSctBndReq: Invalid spId");
...
# 2017 "../..//sctp/sb_bdy1.c"
   ...
   (Void) SbUiSctBndCfm(&(sctSap->sctPst), suId, 1);

   return(0);
}
# 2078 "../..//sctp/sb_bdy1.c"
 S16 SbUiSctEndpOpenReq
(
Pst *pst,
SpId spId,
UConnId suEndpId,
...
# 2123 "../..//sctp/sb_bdy1.c"
   ;
# 2159 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2161); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq(pst, spId(%d), suEndpId(%ld), port(%d), intfNAddrType(%d))\n", spId, suEndpId, port, intfNAddr->type); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 2212 "../..//sctp/sb_bdy1.c"
   if (intfNAddr->type == 4 )
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2220); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: Undefined SCT_ENDP_MULTI_IPADDR, intfNAddr = %lx\n", intfNAddr->u.ipv4NetAddr); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { ret = 0; if ( (spId >= (SpId) sbGlobalCb.genCfg.maxNmbSctSaps) || (spId < 0) ) { { sbLmGenAlarm((U16)2, (U16)1, (U16)3, spId, 1); }; ret = 1; } else if ( sbGlobalCb.sctSaps[spId] == (SbSctSapCb *) 0L ) { { sbLmGenAlarm((U16)2, (U16)1, (U16)2, spId, 1); }; ret = 1; } else if ( sbGlobalCb.sctSaps[spId]->sapState == 0 ) { { sbLmGenAlarm((U16)2, (U16)1, (U16)2, spId, 1); }; ret = 1; } };
   if(ret != 0)
   {
...
# 2309 "../..//sctp/sb_bdy1.c"
   ...
   for ( i = 0; i < sbGlobalCb.genCfg.maxNmbEndp; i++ )
   {
      if ( sbGlobalCb.endpCb[i] != (SbSctEndpCb *) 0L )
      {
         ...
         else
         {
            ...
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2332); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: endpoint exists for suEndpId(%ld) and spId(%d)\n", suEndpId, spId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



            spEndpId = i;
            i = sbGlobalCb.genCfg.maxNmbEndp;
         }
      }
   }
   ...
   if ( endpCb == (SbSctEndpCb *) 0L )
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2344); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: suEndpId not used\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2359); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: endpoint config. max reached\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&endpCb, sizeof(SbSctEndpCb)); if ( ret == 0 ) { cmMemset((U8*)endpCb, 0, sizeof(SbSctEndpCb)); sbGlobalCb.genSta.memAlloc += (sizeof(SbSctEndpCb)); } };
      if ( ret != 0 )
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2370); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: could not allocate new endpoint\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 2419 "../..//sctp/sb_bdy1.c"
      ...
      { S16 _i; cmMemset((U8 *)(&(endpCb->localAddrLst.nAddr[0])), 0, sizeof(CmNetAddr));; if ((intfNAddr) == (CmNetAddr *)0L) { (&(endpCb->localAddrLst.nAddr[0]))->type = 4; (&(endpCb->localAddrLst.nAddr[0]))->u.ipv4NetAddr = 0; } else { if ((intfNAddr)->type == 4) { (&(endpCb->localAddrLst.nAddr[0]))->type = 4; (&(endpCb->localAddrLst.nAddr[0]))->u.ipv4NetAddr = (intfNAddr)->u.ipv4NetAddr; } else if ((intfNAddr)->type == 6) { (&(endpCb->localAddrLst.nAddr[0]))->type = 6; for (_i = 0; _i < 16; _i++) { (&(endpCb->localAddrLst.nAddr[0]))->u.ipv6NetAddr[_i] = (intfNAddr)->u.ipv6NetAddr[_i]; } } else { (&(endpCb->localAddrLst.nAddr[0]))->type = 4; (&(endpCb->localAddrLst.nAddr[0]))->u.ipv4NetAddr = 0; } } };
# 2430 "../..//sctp/sb_bdy1.c"
      if (endpCb->localAddrLst.nAddr[0].type == 4 )
      {
         ...
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2438); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: endpCb->localAddrLst.nAddr[0] = %lx\n",endpCb->localAddrLst.nAddr[0].u.ipv4NetAddr); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 2532 "../..//sctp/sb_bdy1.c"
         { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&addrPortCb, sizeof(SbAddrPortCb)); if ( ret == 0 ) { cmMemset((U8*)addrPortCb, 0, sizeof(SbAddrPortCb)); sbGlobalCb.genSta.memAlloc += (sizeof(SbAddrPortCb)); } };
         if ( ret != 0 )
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2536); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: could not allocate new SbAddrPortCb\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         { S16 _i; cmMemset((U8 *)(&(addrPortCb->sbAddrPortEntry.localAddr)), 0, sizeof(CmNetAddr));; if ((&(endpCb->localAddrLst.nAddr[i])) == (CmNetAddr *)0L) { (&(addrPortCb->sbAddrPortEntry.localAddr))->type = 4; (&(addrPortCb->sbAddrPortEntry.localAddr))->u.ipv4NetAddr = 0; } else { if ((&(endpCb->localAddrLst.nAddr[i]))->type == 4) { (&(addrPortCb->sbAddrPortEntry.localAddr))->type = 4; (&(addrPortCb->sbAddrPortEntry.localAddr))->u.ipv4NetAddr = (&(endpCb->localAddrLst.nAddr[i]))->u.ipv4NetAddr; } else if ((&(endpCb->localAddrLst.nAddr[i]))->type == 6) { (&(addrPortCb->sbAddrPortEntry.localAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(addrPortCb->sbAddrPortEntry.localAddr))->u.ipv6NetAddr[_i] = (&(endpCb->localAddrLst.nAddr[i]))->u.ipv6NetAddr[_i]; } } else { (&(addrPortCb->sbAddrPortEntry.localAddr))->type = 4; (&(addrPortCb->sbAddrPortEntry.localAddr))->u.ipv4NetAddr = 0; } } };
         ret = cmHashListInsert(&(sbGlobalCb.addrPortHl), (U32) addrPortCb,
                                (U8 *) &(addrPortCb->sbAddrPortEntry),
                                sizeof(SbAddrPortEntry));
# 2648 "../..//sctp/sb_bdy1.c"
      }
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2650); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpOpenReq: inserted addr/port entry into HL\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 2663 "../..//sctp/sb_bdy1.c"
      SbUiSctEndpOpenCfm( &(sctSap->sctPst), sctSap->suId, suEndpId,
                          spEndpId, 0, 0);
   ...
   {
      Bool duplicateAddr = 0;
# 2692 "../..//sctp/sb_bdy1.c"
      { S16 _i; cmMemset((U8 *)(&(tmpAddr)), 0, sizeof(CmNetAddr));; if ((intfNAddr) == (CmNetAddr *)0L) { (&(tmpAddr))->type = 4; (&(tmpAddr))->u.ipv4NetAddr = 0; } else { if ((intfNAddr)->type == 4) { (&(tmpAddr))->type = 4; (&(tmpAddr))->u.ipv4NetAddr = (intfNAddr)->u.ipv4NetAddr; } else if ((intfNAddr)->type == 6) { (&(tmpAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(tmpAddr))->u.ipv6NetAddr[_i] = (intfNAddr)->u.ipv6NetAddr[_i]; } } else { (&(tmpAddr))->type = 4; (&(tmpAddr))->u.ipv4NetAddr = 0; } } };
...

{
   ...
   ;
# 2803 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2805); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpCloseReq(pst, spId(%d), endpId(%ld), endpIdType(%d))\n", spId, endpId, endpIdType); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( endpIdType == 2 )
   {
      ...
      { ret = 0; if ( endpId >= sbGlobalCb.genCfg.maxNmbEndp ) { ret = 1; } else if ( sbGlobalCb.endpCb[endpId] == (SbSctEndpCb *) 0L ) { ret = 1; } }
      if ( ret !=0 )
      {
   ...
   else
   {
      ...
      for ( i = 0; (i < sbGlobalCb.genCfg.maxNmbEndp) && (endpFound == 0); i++ )
      {
         if ( sbGlobalCb.endpCb[i] != (SbSctEndpCb *) 0L )
         {
            endpCb = sbGlobalCb.endpCb[i];
            if ( (endpCb->suEndpId == endpId) && (endpCb->spId == spId) )
            {
               ...
               { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2894); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpCloseReq: endpoint exists for suEndpId(%ld) and spId(%d)\n", endpId, spId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   for ( i = 0; i < sbGlobalCb.genCfg.maxNmbAssoc; i++ )
   {
      ...
      if ( assocCb != (SbSctAssocCb *) 0L )
      {
         if ( assocCb->endpId == endpId )
         {
            ...
            sbGlobalCb.assocCb[i] = (SbSctAssocCb *) 0L;
            { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2928); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };

            if ( ret != 0 )
            {

               { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 2934); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctEndpCloseReq: could not send ABORT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if (endpCb != (SbSctEndpCb *)0L)
   {
      ...
      for ( i = 0; i < endpCb->localAddrLst.nmb; i++ )
      {
         SbAddrPortCb *tmpAddrPortCb=0L;
         SbAddrPortEntry tmpAddrPortEntry;


         cmMemset((U8 *)&tmpAddrPortEntry, 0, sizeof(SbAddrPortEntry));
         tmpAddrPortEntry.port = endpCb->port;
         { S16 _i; cmMemset((U8 *)(&(tmpAddrPortEntry.localAddr)), 0, sizeof(CmNetAddr));; if ((&(endpCb->localAddrLst.nAddr[i])) == (CmNetAddr *)0L) { (&(tmpAddrPortEntry.localAddr))->type = 4; (&(tmpAddrPortEntry.localAddr))->u.ipv4NetAddr = 0; } else { if ((&(endpCb->localAddrLst.nAddr[i]))->type == 4) { (&(tmpAddrPortEntry.localAddr))->type = 4; (&(tmpAddrPortEntry.localAddr))->u.ipv4NetAddr = (&(endpCb->localAddrLst.nAddr[i]))->u.ipv4NetAddr; } else if ((&(endpCb->localAddrLst.nAddr[i]))->type == 6) { (&(tmpAddrPortEntry.localAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(tmpAddrPortEntry.localAddr))->u.ipv6NetAddr[_i] = (&(endpCb->localAddrLst.nAddr[i]))->u.ipv6NetAddr[_i]; } } else { (&(tmpAddrPortEntry.localAddr))->type = 4; (&(tmpAddrPortEntry.localAddr))->u.ipv4NetAddr = 0; } } };
         ...
         ret = cmHashListFind(&(sbGlobalCb.addrPortHl),
                              ...
                              (U32 *) &tmpAddrPortCb);
# 2981 "../..//sctp/sb_bdy1.c"
         if (tmpAddrPortCb != (SbAddrPortCb *)0L)
         {
# 3022 "../..//sctp/sb_bdy1.c"
            ret = cmHashListDelete(&(sbGlobalCb.addrPortHl), (U32) tmpAddrPortCb);
         }
# 3037 "../..//sctp/sb_bdy1.c"
         { if (tmpAddrPortCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3037); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)tmpAddrPortCb, sizeof(SbAddrPortCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbAddrPortCb)); tmpAddrPortCb = 0L; } };
      }
   }


   sbGlobalCb.endpCb[endpIndex] = (SbSctEndpCb *) 0L;
   { if (endpCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3043); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)endpCb, sizeof(SbSctEndpCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctEndpCb)); endpCb = 0L; } };
...
# 3178 "../..//sctp/sb_bdy1.c"
   ;
# 3206 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3210); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq(pst, spId(%d), spEndpId(%ld), suAssocId(%ld),           priDstNAddr, dstPort(%d), outStrms(%d), dstNAddrLst, srcNAddrLst,           sInfo)\n", spId, spEndpId, suAssocId, dstPort, outStrms); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { if ( vsInfo != (Buffer *) 0L ) { (Void) SPutMsg(vsInfo); vsInfo = (Buffer *)0L; } };
   ...
   { ret = 0; if ( spEndpId >= sbGlobalCb.genCfg.maxNmbEndp ) { ret = 1; } else if ( sbGlobalCb.endpCb[spEndpId] == (SbSctEndpCb *) 0L ) { ret = 1; } }
   if ( ret != 0 )
   {
...
# 3286 "../..//sctp/sb_bdy1.c"
   ...
   for ( i = 0; i < sbGlobalCb.genCfg.maxNmbAssoc; i++ )
   {
      ...
      if ( assocCb != (SbSctAssocCb *) 0L )
      {
         ...
         {
# 3324 "../..//sctp/sb_bdy1.c"
            SbUiSctStaInd(&(sctSap->sctPst), sctSap->suId, assocCb->suAssocId, assocCb->spAssocId, priDstNAddr, 0x0e, 0, (Buffer *) 0L);
   ...
   { SbAssocMapCb _assocMap; SbAssocMapCb *_tmpAssocMap; cmMemset((U8 *)&(_assocMap), 0, sizeof(SbAssocMapCb));; _assocMap.sbAssocEntry.spEndpId = spEndpId; { S16 _i; cmMemset((U8 *)(&(_assocMap.sbAssocEntry.peerAddr)), 0, sizeof(CmNetAddr));; if ((priDstNAddr) == (CmNetAddr *)0L) { (&(_assocMap.sbAssocEntry.peerAddr))->type = 4; (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv4NetAddr = 0; } else { if ((priDstNAddr)->type == 4) { (&(_assocMap.sbAssocEntry.peerAddr))->type = 4; (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv4NetAddr = (priDstNAddr)->u.ipv4NetAddr; } else if ((priDstNAddr)->type == 6) { (&(_assocMap.sbAssocEntry.peerAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv6NetAddr[_i] = (priDstNAddr)->u.ipv6NetAddr[_i]; } } else { (&(_assocMap.sbAssocEntry.peerAddr))->type = 4; (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv4NetAddr = 0; } } }; _assocMap.sbAssocEntry.port = dstPort; ret = cmHashListFind(&(sbGlobalCb.assocMapHl), (U8 *) &(_assocMap.sbAssocEntry), sizeof(SbAssocMapEntry), 0, (U32 *) &_tmpAssocMap); };
   if ( ret == 0 )
   {
   ...
   {
      { SbAssocMapCb _assocMap; SbAssocMapCb *_tmpAssocMap; cmMemset((U8 *)&(_assocMap), 0, sizeof(SbAssocMapCb));; _assocMap.sbAssocEntry.spEndpId = spEndpId; { S16 _i; cmMemset((U8 *)(&(_assocMap.sbAssocEntry.peerAddr)), 0, sizeof(CmNetAddr));; if ((&(dstNAddrLst->nAddr[i])) == (CmNetAddr *)0L) { (&(_assocMap.sbAssocEntry.peerAddr))->type = 4; (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv4NetAddr = 0; } else { if ((&(dstNAddrLst->nAddr[i]))->type == 4) { (&(_assocMap.sbAssocEntry.peerAddr))->type = 4; (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv4NetAddr = (&(dstNAddrLst->nAddr[i]))->u.ipv4NetAddr; } else if ((&(dstNAddrLst->nAddr[i]))->type == 6) { (&(_assocMap.sbAssocEntry.peerAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv6NetAddr[_i] = (&(dstNAddrLst->nAddr[i]))->u.ipv6NetAddr[_i]; } } else { (&(_assocMap.sbAssocEntry.peerAddr))->type = 4; (&(_assocMap.sbAssocEntry.peerAddr))->u.ipv4NetAddr = 0; } } }; _assocMap.sbAssocEntry.port = dstPort; ret = cmHashListFind(&(sbGlobalCb.assocMapHl), (U8 *) &(_assocMap.sbAssocEntry), sizeof(SbAssocMapEntry), 0, (U32 *) &_tmpAssocMap); };
      if ( ret == 0 )
      {
   ...
   if ( spAssocId == sbGlobalCb.genCfg.maxNmbAssoc )
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3385); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq: config. max reached for number of assocs\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 3415 "../..//sctp/sb_bdy1.c"
   ...
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3419); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq: could not allocate new association\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3446); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq: assocCb->ownInitTag=%lu\n", assocCb->ownInitTag); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { SbSctEndpCb *tmpEndpCb; CmNetAddr _tmpAddr; tmpEndpCb = sbGlobalCb.endpCb[spEndpId]; if ( tmpEndpCb == (SbSctEndpCb *) 0L ) { assocCb->localConn = (SbLocalAddrCb *) 0L; ret = 1; } else { U8 _k; for (_k = 0; (_k < tmpEndpCb->localAddrLst.nmb); _k++ ) { { S16 _i; cmMemset((U8 *)(&(_tmpAddr)), 0, sizeof(CmNetAddr));; if ((&(tmpEndpCb->localAddrLst.nAddr[_k])) == (CmNetAddr *)0L) { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = 0; } else { if ((&(tmpEndpCb->localAddrLst.nAddr[_k]))->type == 4) { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = (&(tmpEndpCb->localAddrLst.nAddr[_k]))->u.ipv4NetAddr; } else if ((&(tmpEndpCb->localAddrLst.nAddr[_k]))->type == 6) { (&(_tmpAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(_tmpAddr))->u.ipv6NetAddr[_i] = (&(tmpEndpCb->localAddrLst.nAddr[_k]))->u.ipv6NetAddr[_i]; } } else { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = 0; } } }; ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *) &(_tmpAddr), (U16) sizeof(CmNetAddr), 0, (U32 *) &(assocCb->localConn)); if ( ret == 0 ) { if ( assocCb->localConn->connected ) break; ret = 1; } } if (ret == 1) { cmMemset((U8 *)(U8 *) &_tmpAddr, 0, sizeof(CmNetAddr)); _tmpAddr.type = tmpEndpCb->localAddrLst.nAddr[0].type; ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *) &(_tmpAddr), (U16) sizeof(CmNetAddr), 0, (U32 *) &(assocCb->localConn)); } } };

   if ( ret != 0 )
   {
      { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3463); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
   ...
   assocCb->sbSqCb.inStreamSeqNum = (SctStrmId *) 0L;
   assocCb->sbSqCb.outStreamSeqNum = (SctStrmId *) 0L;
...
# 3525 "../..//sctp/sb_bdy1.c"
   ...
   if (( srcNAddrLst->nmb == 0) || (( srcNAddrLst->nmb == 1) && (tSap->ipv4_any == 1)))
   {



      if ( (endpCb->localAddrLst.nmb == 1 ) &&
           (endpCb->localAddrLst.nAddr[0].type == 4) &&
         ...
         else
         {
            ...
            for(addrCount=0; addrCount < tSap->tSapCfg.srcNAddrLst.nmb; addrCount++)
            {
               if(tSap->tSapCfg.srcNAddrLst.nAddr[addrCount].type == 4)
               {
                   ...
                   { S16 _i; cmMemset((U8 *)(&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb])), 0, sizeof(CmNetAddr));; if ((&(tSap->tSapCfg.srcNAddrLst.nAddr[addrCount])) == (CmNetAddr *)0L) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv4NetAddr = 0; } else { if ((&(tSap->tSapCfg.srcNAddrLst.nAddr[addrCount]))->type == 4) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv4NetAddr = (&(tSap->tSapCfg.srcNAddrLst.nAddr[addrCount]))->u.ipv4NetAddr; } else if ((&(tSap->tSapCfg.srcNAddrLst.nAddr[addrCount]))->type == 6) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 6; for (_i = 0; _i < 16; _i++) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv6NetAddr[_i] = (&(tSap->tSapCfg.srcNAddrLst.nAddr[addrCount]))->u.ipv6NetAddr[_i]; } } else { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv4NetAddr = 0; } } };
...
# 3644 "../..//sctp/sb_bdy1.c"
      else
      {
         ...
         { S16 _j; cmMemset((U8 *)(&(assocCb->sbAsCb.localAddrLst)), 0, sizeof(SctNetAddrLst)); (&(assocCb->sbAsCb.localAddrLst))->nmb = (&(endpCb->localAddrLst))->nmb; for (_j = 0; _j < (&(endpCb->localAddrLst))->nmb; _j++) { { S16 _i; cmMemset((U8 *)(&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j])), 0, sizeof(CmNetAddr));; if ((&((&(endpCb->localAddrLst))->nAddr[_j])) == (CmNetAddr *)0L) { (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->type = 4; (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->u.ipv4NetAddr = 0; } else { if ((&((&(endpCb->localAddrLst))->nAddr[_j]))->type == 4) { (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->type = 4; (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->u.ipv4NetAddr = (&((&(endpCb->localAddrLst))->nAddr[_j]))->u.ipv4NetAddr; } else if ((&((&(endpCb->localAddrLst))->nAddr[_j]))->type == 6) { (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->type = 6; for (_i = 0; _i < 16; _i++) { (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->u.ipv6NetAddr[_i] = (&((&(endpCb->localAddrLst))->nAddr[_j]))->u.ipv6NetAddr[_i]; } } else { (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->type = 4; (&((&(assocCb->sbAsCb.localAddrLst))->nAddr[_j]))->u.ipv4NetAddr = 0; } } } } };
      }
   }
   else
   {
      ...
      { S16 _i; cmMemset((U8 *)(&(assocCb->sbAsCb.localAddrLst.nAddr[0])), 0, sizeof(CmNetAddr));; if ((&(assocCb->localConn->ownAddr)) == (CmNetAddr *)0L) { (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->u.ipv4NetAddr = 0; } else { if ((&(assocCb->localConn->ownAddr))->type == 4) { (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->u.ipv4NetAddr = (&(assocCb->localConn->ownAddr))->u.ipv4NetAddr; } else if ((&(assocCb->localConn->ownAddr))->type == 6) { (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->type = 6; for (_i = 0; _i < 16; _i++) { (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->u.ipv6NetAddr[_i] = (&(assocCb->localConn->ownAddr))->u.ipv6NetAddr[_i]; } } else { (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[0]))->u.ipv4NetAddr = 0; } } };
      assocCb->sbAsCb.localAddrLst.nmb++;
      ...
      for ( i = 0; i < srcNAddrLst->nmb; i++)
      {
            ...
            {
             { S16 _i; cmMemset((U8 *)(&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb])), 0, sizeof(CmNetAddr));; if ((&(srcNAddrLst->nAddr[i])) == (CmNetAddr *)0L) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv4NetAddr = 0; } else { if ((&(srcNAddrLst->nAddr[i]))->type == 4) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv4NetAddr = (&(srcNAddrLst->nAddr[i]))->u.ipv4NetAddr; } else if ((&(srcNAddrLst->nAddr[i]))->type == 6) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 6; for (_i = 0; _i < 16; _i++) { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv6NetAddr[_i] = (&(srcNAddrLst->nAddr[i]))->u.ipv6NetAddr[_i]; } } else { (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->type = 4; (&(assocCb->sbAsCb.localAddrLst.nAddr[assocCb->sbAsCb.localAddrLst.nmb]))->u.ipv4NetAddr = 0; } } };
             assocCb->sbAsCb.localAddrLst.nmb++;
...
# 3710 "../..//sctp/sb_bdy1.c"
   ...
   assocCb->sbDbCb.sequencedQ = (CmLListCp *) 0L;

   assocCb->sbDbCb.newPkt = 0L;
   ...
   if ( addrCb == 0L )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3732); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq: Failure from sbPmAddAddr, Terminating Assoc\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



      sbGlobalCb.assocCb[spAssocId] = (SbSctAssocCb *) 0L;
      { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3736); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };

      SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy1.c", 3739, (ErrCls)0x4, (ErrCode)(0 + 44), (ErrVal)(ErrVal)0, "SbUiSctAssocReq: Failure returned from function sbPmAddAddr\n ");
   ...
   for ( i = 0; i < dstNAddrLst->nmb; i++ )
   {
      ...
      if (sbPmCompNAddr(priDstNAddr,(CmNetAddr *) &(dstNAddrLst->nAddr[i])) == 0)
         continue;
      ...
      if ( addrCb == 0L )
      {
         ...
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3761); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq: Failure from sbPmAddAddr, Terminating Assoc\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



         sbGlobalCb.assocCb[spAssocId] = (SbSctAssocCb *) 0L;
         { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3765); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };

         SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy1.c", 3768, (ErrCls)0x4, (ErrCode)(0 + 45), (ErrVal)(ErrVal)0, "SbUiSctAssocReq: Failure returned from function sbPmAddAddr\n ");
   ...
   {
      assocCb->sbAcCb.pAddrScrnFlg = 0;
   }
   else
   {
      assocCb->sbAcCb.pAddrScrnFlg = 1;
   }
# 3803 "../..//sctp/sb_bdy1.c"
   ...
   if ( ret != 0 )
   {
      ...
      sbGlobalCb.assocCb[spAssocId] = (SbSctAssocCb *) 0L;
      { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3814); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };

      if ( ret == 1 )
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3819); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq: could not send INIT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 3828); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocReq: could not build INIT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 3971 "../..//sctp/sb_bdy1.c"
   ...
   ;
# 3999 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4001); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp(pst, spId(%d), spEndpId(%ld))\n", spId, spEndpId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4058 "../..//sctp/sb_bdy1.c"
   ...
   { SbSctEndpCb *tmpEndpCb; CmNetAddr _tmpAddr; tmpEndpCb = sbGlobalCb.endpCb[spEndpId]; if ( tmpEndpCb == (SbSctEndpCb *) 0L ) { localAddrCb = (SbLocalAddrCb *) 0L; ret = 1; } else { U8 _k; for (_k = 0; (_k < tmpEndpCb->localAddrLst.nmb); _k++ ) { { S16 _i; cmMemset((U8 *)(&(_tmpAddr)), 0, sizeof(CmNetAddr));; if ((&(tmpEndpCb->localAddrLst.nAddr[_k])) == (CmNetAddr *)0L) { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = 0; } else { if ((&(tmpEndpCb->localAddrLst.nAddr[_k]))->type == 4) { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = (&(tmpEndpCb->localAddrLst.nAddr[_k]))->u.ipv4NetAddr; } else if ((&(tmpEndpCb->localAddrLst.nAddr[_k]))->type == 6) { (&(_tmpAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(_tmpAddr))->u.ipv6NetAddr[_i] = (&(tmpEndpCb->localAddrLst.nAddr[_k]))->u.ipv6NetAddr[_i]; } } else { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = 0; } } }; ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *) &(_tmpAddr), (U16) sizeof(CmNetAddr), 0, (U32 *) &(localAddrCb)); if ( ret == 0 ) { if ( localAddrCb->connected ) break; ret = 1; } } if (ret == 1) { cmMemset((U8 *)(U8 *) &_tmpAddr, 0, sizeof(CmNetAddr)); _tmpAddr.type = tmpEndpCb->localAddrLst.nAddr[0].type; ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *) &(_tmpAddr), (U16) sizeof(CmNetAddr), 0, (U32 *) &(localAddrCb)); } } };
   ...
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4090); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: assocIndParams->type = SCT_ASSOC_IND_INIT\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



      cmMemset((U8 *)&(temp), 0, sizeof(CmNetAddr));;
      { S16 _i; cmMemset((U8 *)(&temp), 0, sizeof(CmNetAddr));; if ((&(assocIndParams->t.initParams.localAddrLst.nAddr[0])) == (CmNetAddr *)0L) { (&temp)->type = 4; (&temp)->u.ipv4NetAddr = 0; } else { if ((&(assocIndParams->t.initParams.localAddrLst.nAddr[0]))->type == 4) { (&temp)->type = 4; (&temp)->u.ipv4NetAddr = (&(assocIndParams->t.initParams.localAddrLst.nAddr[0]))->u.ipv4NetAddr; } else if ((&(assocIndParams->t.initParams.localAddrLst.nAddr[0]))->type == 6) { (&temp)->type = 6; for (_i = 0; _i < 16; _i++) { (&temp)->u.ipv6NetAddr[_i] = (&(assocIndParams->t.initParams.localAddrLst.nAddr[0]))->u.ipv6NetAddr[_i]; } } else { (&temp)->type = 4; (&temp)->u.ipv4NetAddr = 0; } } };




      { ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *)&temp, (U16) sizeof(CmNetAddr), 0, (U32 *) &(localAddrCb)); if ( ret == 0 ) { if ( !localAddrCb->connected ) { ret = 1; } } if (ret == 1) { CmNetAddr _tmpAddr; cmMemset((U8 *)(U8 *) &_tmpAddr, 0, sizeof(CmNetAddr)); _tmpAddr.type = (&temp)->type; ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *) &(_tmpAddr), (U16) sizeof(CmNetAddr), 0, (U32 *) &(localAddrCb)); } };
...
# 4134 "../..//sctp/sb_bdy1.c"
         ret = sbAsSendUserAbort(assocIndParams->t.initParams.iTag, localAddrCb,
               ...
               assocIndParams->t.initParams.peerPort, 0, 0,
               checksumType);


         if ( ret == 4 )
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4144); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: could not build ABORT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4158); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: could not send ABORT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4201 "../..//sctp/sb_bdy1.c"
         ...
         ret = sbAsSendInitAck(spId, assocIndParams, &tcb, localAddrCb,
                               checksumType, (Buffer *)0L);

         if ( ret != 0 )
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4224); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: could not build/send INIT ACK chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4240); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: assocIndParams->type = SCT_ASSOC_IND_COOKIE\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };



      { ret = 0; if ( assocIndParams->t.cookieParams.spAssocId >= sbGlobalCb.genCfg.maxNmbAssoc ) { ret = 1; } else if ( sbGlobalCb.assocCb[assocIndParams->t.cookieParams.spAssocId] == (SbSctAssocCb *) 0L ) { ret = 1; } };
      if ( ret != 0 )
      {
      ...
      {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4265); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: Abort chunk bundled after COOIKE-ECHO chunk \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      if ( result != 0 )
      {
         ...
         ret = sbAsSendUserAbort(assocCb->peerInitTag, assocCb->localConn,
               ...
               assocCb->localPort,assocCb->peerPort,0,0,
         ...
         if ( ret != 0 )
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4287); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: could not build ABORT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         sbGlobalCb.assocCb[assocIndParams->t.cookieParams.spAssocId] =
               (SbSctAssocCb *) 0L;
         { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4306); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
      ...
      else
      {
         ...
         else
         {
            ...
            for ( i = 0; i < assocIndParams->t.cookieParams.peerAddrLst.nmb; i++ )

            {
               addrCb = sbPmGetAddrCb(assocCb, &(assocIndParams-> t.cookieParams.peerAddrLst.nAddr[i]));
...
# 4381 "../..//sctp/sb_bdy1.c"
         ...
         if ( ret != 0 )
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4393); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: could not send COOKIE ACK chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
     ...
     (Buffer *) 0L);
         ...
         for ( i = 0; i < assocCb->sbSqCb.nmbInStreams; i++ )
         {
            ...
            while ( chunk != (SbQueuedChunk *) 0L )
            {
               ...
               ret = sbSqInSendUp(assocCb, chunk, 6);
               if ( ret != 0 )
               {
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4434); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: could not send chunks to user\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         if(( assocCb->sbAcCb.sinceSack > 0 ) && (assocCb->sbAcCb.firstDataRcvd == 1))
...
# 4479 "../..//sctp/sb_bdy1.c"
        ...
        {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4513); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp: Enabling HeartBeat By Default \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4539 "../..//sctp/sb_bdy1.c"
               ...
               {
# 4550 "../..//sctp/sb_bdy1.c"
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 7))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4552); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp:  Srcaddr.type(%d), Srcaddr.u.ipv4(%08lX)\n", addrCb->addr.type, addrCb->addr.u.ipv4NetAddr); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


                  { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 7))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4555); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctAssocRsp:  Destaddr.type(%d), Destaddr.u.ipv4(%08lX)\n", addrCb->localConn->ownAddr.type, addrCb->localConn->ownAddr.u.ipv4NetAddr); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4636 "../..//sctp/sb_bdy1.c"
{
   ...
   ;
# 4670 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4673); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq(pst, spId(%d), assocId(%ld), assocIdType(%d),        abortFlg(%d))\n", spId, assocId, assocIdType, abortFlg); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4733 "../..//sctp/sb_bdy1.c"
               ret = sbAsSendUserAbort(assocCb->peerInitTag,assocCb->sbAcCb.pri->localConn,
                                       ...
                                       assocCb->peerPort,0,0, assocCb->checksumType);

               if ( ret != 0 )
               {

                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4741); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq: could not send ABORT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
               ...
               sbGlobalCb.assocCb[i] = (SbSctAssocCb *) 0L;
               { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4756); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
      ...
      if (i == sbGlobalCb.genCfg.maxNmbAssoc)
      {
         ...
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4772); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "Association not found. Still send TermCfm to Upper layer\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4787 "../..//sctp/sb_bdy1.c"
   ...
   if ( assocIdType == 2 )
   {
      ...
      { ret = 0; if ( assocId >= sbGlobalCb.genCfg.maxNmbAssoc ) { ret = 1; } else if ( sbGlobalCb.assocCb[assocId] == (SbSctAssocCb *) 0L ) { ret = 1; } };
      if ( ret != 0 )
      {
         ...
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4803); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "Association not found. Still send TermCfm to Upper layer\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 4846 "../..//sctp/sb_bdy1.c"
               ...
               if ( ret != 0 )
               {
                  ...
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4854); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq: could not send ABORT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
            ...
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4870); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq: completed assoc Abort\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
            ...
            sbGlobalCb.assocCb[assocId] = (SbSctAssocCb *) 0L;
            { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4879); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
         ...
         else
         {
            ...
            if ( (assocCb->sbAcCb.cumTsn + 1) == assocCb->sbAcCb.nextLocalTsn )
            {
               ...
               if ( ret == 4 )
               {
                  ...
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4897); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq: could not build SHUTDOWN\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
               ...
               else if ( ret == 1 )
               {
                  ...
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4908); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq: could not send SHUTDOWN\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4923); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq: assoc. state not ESTABLISHED, aborting instead\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 4935 "../..//sctp/sb_bdy1.c"
               ret = sbAsSendUserAbort(assocCb->peerInitTag,assocCb->sbAcCb.pri->localConn,
                                       &(assocCb->sbAcCb.pri->addr),assocCb->localPort,
                                       assocCb->peerPort,0,0, assocCb->checksumType);
               ...
               if ( ret != 0 )
               {
                  ...
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4943); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctTermReq: could not send ABORT chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         sbGlobalCb.assocCb[assocId] = (SbSctAssocCb *) 0L;
         { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 4961); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
...
# 5016 "../..//sctp/sb_bdy1.c"
   ;
# 5040 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5042); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctSetPriReq(pst, spId(%d), spAssocId(%ld), dstNAddr)\n", spId, spAssocId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   { ret = 0; if ( spAssocId >= sbGlobalCb.genCfg.maxNmbAssoc ) { ret = 1; } else if ( sbGlobalCb.assocCb[spAssocId] == (SbSctAssocCb *) 0L ) { ret = 1; } };
   if ( ret != 0 )
   {
...
# 5112 "../..//sctp/sb_bdy1.c"
   if((assocCb->sbAcCb.pri->addr.type == 4) && (addrCb->addr.type == 4) && (dstNAddr->type == 4))
   {
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5124); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctSetPriReq: Old = %lu, New = %lu, requested = %lu\n", assocCb->sbAcCb.pri->addr.u.ipv4NetAddr, addrCb->addr.u.ipv4NetAddr, dstNAddr->u.ipv4NetAddr); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 5189 "../..//sctp/sb_bdy1.c"
{
   ...
   ;
# 5227 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5230); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctHBeatReq(pst, spId(%d), spAssocId(%ld), dstNAddr,           intervalTime(%d), status(%d))\n", spId, spAssocId, intervalTime, status); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 5425 "../..//sctp/sb_bdy1.c"
{
   ...
   ;
# 5469 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5472); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq(pst, spId(%d), spAssocId(%ld), dstNAddr, strmId(%d),        unorderFlg(%d), nobundleFlg(%d), lifeTime(%d), protId(%ld), mBuf)\n", spId, spAssocId, strmId, unorderFlg, nobundleFlg, lifeTime, protId); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 5514 "../..//sctp/sb_bdy1.c"
   ...
   assocCb = sbGlobalCb.assocCb[spAssocId];
# 5578 "../..//sctp/sb_bdy1.c"
   if ( ((dstNAddr == (CmNetAddr *)0L ) ||
        ((dstNAddr != (CmNetAddr *)0L) &&
        (dstNAddr->type == 0))) &&
        (assocCb->sbAcCb.pri->active == 1) &&
        (assocCb->sbAcCb.pri->sndTo == 1) &&
        (assocCb->sbAcCb.pri->rtxCnt == 0) &&

        (assocCb->sbAcCb.pri->confirmed == 1) &&
        (assocCb->sbAcCb.pri->localConn != (SbLocalAddrCb *)0L) &&
        (assocCb->sbAcCb.pri->localConn->connected == 1) )
   {
   ...
   if((dstNAddr->type == 4) && (addrCb->addr.type == 4))
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5612); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: requestedAddr = %lu, selectedAddress = %lu, type = %d\n", dstNAddr->u.ipv4NetAddr, addrCb->addr.u.ipv4NetAddr, dstNAddr->type); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 5678 "../..//sctp/sb_bdy1.c"
   if (assocCb->assocState != 0x3)
   {
       ...
       {
          { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5687); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: SHUTDOWN in progress\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
    ...
    if ( (assocCb->assocState == 0x0) ||
      (assocCb->assocState == 0x1) ||
      (assocCb->assocState == 0x2))
       {
          { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5706); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: Invalid state\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5748); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: Find length message failed\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 5782 "../..//sctp/sb_bdy1.c"
   ...
   if ( (numChunks + sbGlobalCb.txChunks) >= sbGlobalCb.genCfg.maxNmbTxChunks )
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5788); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: queues are full, flow control dropping\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( nmbQPkt >= sctSap->sctSapCfg.reConfig.flcUpThr )
   {
      ...
      if ( assocCb->flcFlg == 0 )
      {
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5811); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: flow control started\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( ret != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5827); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: could not alloc. mem. for new chunk\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( ret != 0 )
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & ((0x00000100 << 5))) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5876); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctDatReq: Could not send chunk to Sequ. Deliv.\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 5921 "../..//sctp/sb_bdy1.c"
{
   ...
   ;
# 5956 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 5958); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbUiSctStaReq(pst, spId(%d), spAssocId(%lu), dstNAddr, staType(%d))\n", spId, spAssocId, staType); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   cmMemset((U8 *)&staInfo, 0, sizeof(SctStaInfo));;
...
# 6023 "../..//sctp/sb_bdy1.c"
   switch ( staType )
   {
      ...
      case 4:
      {
         ...
         { S16 _i; cmMemset((U8 *)(&(staInfo.u.assocInfo.priDstAddr)), 0, sizeof(CmNetAddr));; if ((&(assocCb->priOrig->addr)) == (CmNetAddr *)0L) { (&(staInfo.u.assocInfo.priDstAddr))->type = 4; (&(staInfo.u.assocInfo.priDstAddr))->u.ipv4NetAddr = 0; } else { if ((&(assocCb->priOrig->addr))->type == 4) { (&(staInfo.u.assocInfo.priDstAddr))->type = 4; (&(staInfo.u.assocInfo.priDstAddr))->u.ipv4NetAddr = (&(assocCb->priOrig->addr))->u.ipv4NetAddr; } else if ((&(assocCb->priOrig->addr))->type == 6) { (&(staInfo.u.assocInfo.priDstAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(staInfo.u.assocInfo.priDstAddr))->u.ipv6NetAddr[_i] = (&(assocCb->priOrig->addr))->u.ipv6NetAddr[_i]; } } else { (&(staInfo.u.assocInfo.priDstAddr))->type = 4; (&(staInfo.u.assocInfo.priDstAddr))->u.ipv4NetAddr = 0; } } };
         ...
         destAddrCount = (U8)((((l)->count))/srcAddrCount);
         for (i = 0; i < destAddrCount; i++ )
         {
            addrCb = (SbAddrCb *)(n->node);
            { S16 _i; cmMemset((U8 *)(&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb])), 0, sizeof(CmNetAddr));; if ((&(addrCb->addr)) == (CmNetAddr *)0L) { (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->type = 4; (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->u.ipv4NetAddr = 0; } else { if ((&(addrCb->addr))->type == 4) { (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->type = 4; (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->u.ipv4NetAddr = (&(addrCb->addr))->u.ipv4NetAddr; } else if ((&(addrCb->addr))->type == 6) { (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->type = 6; for (_i = 0; _i < 16; _i++) { (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->u.ipv6NetAddr[_i] = (&(addrCb->addr))->u.ipv6NetAddr[_i]; } } else { (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->type = 4; (&(staInfo.u.assocInfo.dstAddrLst.nAddr [staInfo.u.assocInfo.dstAddrLst.nmb]))->u.ipv4NetAddr = 0; } } };
      ...
      case 6:
      {
         ...
         staInfo.u.rtrvInfo.nmbUnsentDgms =
            (U16)sbDbQPackets(assocCb, 0x0);
         staInfo.u.rtrvInfo.nmbUnackDgms =
            (U16)sbDbQPackets(assocCb, 0x1);
         staInfo.u.rtrvInfo.nmbUndelDgms =
            (U16)( sbDbQPackets(assocCb, 0x3) +
...
# 6187 "../..//sctp/sb_bdy1.c"
   ...
   ;
# 6224 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6226); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitConCfm(pst, suId(%d), suConId(%ld), spConId(%ld), localAddr)\n", suId, suConId, spConId ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 6245 "../..//sctp/sb_bdy1.c"
   tSap = *(sbGlobalCb.tSaps + suId);
# 6320 "../..//sctp/sb_bdy1.c"
   cmMemset((U8 *)&addr, 0, sizeof(CmNetAddr));;

   if ( localAddr == (CmTptAddr *)0L )
   {
      addr.type = 4;
   }
   else
...
# 6415 "../..//sctp/sb_bdy1.c"
...

   {
      ...
      if ( localAddrCb != (SbLocalAddrCb *)0L )
      {
         ...
         {
# 6440 "../..//sctp/sb_bdy1.c"
            if (localAddrCb->connected == 0)
            {
               if (localAddrCb->ownAddr.type == 4)
               {
                  if (((tSap->ipv4_any == 1) &&
               ...
               else if (localAddrCb->ownAddr.type == 6)
               {
                  Bool isAny;
                  { U16 _i; *(&isAny) = 1; for (_i = 0; _i < 16; _i++) { if ((localAddrCb->ownAddr.u.ipv6NetAddr)[_i] != 0) { *(&isAny) = 0; break; } } }

                  if (((tSap->ipv6_any == 1) && (isAny == 1)) ||
                     (tSap->ipv6_any == 0))
                  {
                     cnt++;
                  }
...
# 6500 "../..//sctp/sb_bdy1.c"
   if ( ((tSap->tSapCfg.reConfig.sbDnsCfg.useDnsLib == 1) &&
...

    {
       ...
       { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6514); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitConCfm: Connection Cfm Received for DNS Server\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


       sbGlobalCb.dnsInfo.spConId = spConId;
       sbGlobalCb.dnsInfo.dnsState = 1;


         { err = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&sbGlobalCb.dnsInfo.dnsCb, sizeof(CmDnsCb)); if ( err == 0 ) { cmMemset((U8*)sbGlobalCb.dnsInfo.dnsCb, 0, sizeof(CmDnsCb)); sbGlobalCb.genSta.memAlloc += (sizeof(CmDnsCb)); } }
         cmDnsDeInitDnsCb(sbGlobalCb.dnsInfo.dnsCb);

         if( err != 0 )
         {
           SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy1.c", 6526, (ErrCls)0x2, (ErrCode)(0 + 82), (ErrVal)(ErrVal) 0, "SbLiHitConCfm(): Memory Allocation Failure for DNSCB");


           { sbLmGenAlarm(4, 13, 15, suId, 1); };
         ...
         err = sbInitDnsCb(sbGlobalCb.dnsInfo.dnsCb, 1024,
                   &sMem, &tSap->tSapCfg.reConfig.sbDnsCfg.dnsAddr);
         if(err != 0)
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6541); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitConCfm: Failure returned from sbInitDnsCb \n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      if (tSap->timer.tmrEvnt != -1)
      {
         { CmTmrArg _arg; _arg.tq = &(sbGlobalCb.sbTq[0]); _arg.tqCp = &(sbGlobalCb.sbTqCp); _arg.timers = &(tSap->timer); _arg.cb = 0L; _arg.evnt = 0; _arg.wait = 0; _arg.tNum = 0; _arg.max = 1; cmRmvCbTq(&_arg); };
      }

      if ( sbGlobalCb.sbMgmt.hdr.elmId.elmnt == 3 )
      {
         ...
         if ( ret != 0 )
         {
            { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000004)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6567); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitConCfm: could not allocate memory for Response Structure\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6578); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitConCfm: sending CntrlCfm\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
# 6587 "../..//sctp/sb_bdy1.c"
         sbLmSendCfm(&(sbGlobalCb.genCfg.smPst), 2,
                     &(sbGlobalCb.sbMgmt.hdr), 0,
                     0, cfmMsg);



          { if (cfmMsg == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6593); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)cfmMsg, sizeof(SbMgmt)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbMgmt)); cfmMsg = 0L; } };
   ...
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6601); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitConCfm: Returning ROK\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 6687 "../..//sctp/sb_bdy1.c"
   ;;
# 6710 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6712); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitUDatInd(pst, suId(%d), suConId(%ld))\n", suId, suConId ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( sbGlobalCb.sbInit.cfgDone == 0 )
   {
        { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6719); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitUDatInd: General configuration not done\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 6746 "../..//sctp/sb_bdy1.c"
   if (hdrParm->type == 4)
   {
      if ( (hdrParm->u.hdrParmIpv4.proto.pres == 1) &&
           (sbGlobalCb.genCfg.performMtu == 1) )
      {
         if ( (hdrParm->u.hdrParmIpv4.proto.val == IPPROTO_ICMP) &&
              (sbGlobalCb.genCfg.performMtu == 1) )
         {
            if (srcAddr->type == 4)
            {
            ...
            {
               ver = 0;
               SLogError(sbGlobalCb.sbInit.ent, sbGlobalCb.sbInit.inst, sbGlobalCb.sbInit.procId, "../..//sctp/sb_bdy1.c", 6766, (ErrCls)0x2, (ErrCode)(0 + 84), (ErrVal)(ErrVal) srcAddr->type, "SbLiHitUDatInd: Incorrect address type");
...
# 6817 "../..//sctp/sb_bdy1.c"
   if (sbGlobalCb.sbInit.trc == 1)
   {

      sbTrcBuf(suId, 1, mBuf, srcAddr, dstAddr);
   }
# 6841 "../..//sctp/sb_bdy1.c"
   tSap = *(sbGlobalCb.tSaps + suId);
   ...
   if ( tSap == (SbTSapCb *)0L )
   {
      ...
      { sbLmGenAlarm((U16)2, (U16)2, (U16)2, suId, 1); };
...
# 6941 "../..//sctp/sb_bdy1.c"
   cmMemset((U8 *)&srcNetAddr, 0, sizeof(CmNetAddr));;
...
# 6974 "../..//sctp/sb_bdy1.c"
   ...
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 6979); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiHitUDatInd: Dns Response Received From Server" ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   cmMemset((U8 *)&dstNetAddr, 0, sizeof(CmNetAddr));;




   if( sbGlobalCb.genCfg.serviceType == 0)
   {
      S16 i;
      SbLocalAddrCb *localConn;
...

      {
         ...
         if( (localConn != (SbLocalAddrCb *)0L ) &&
             ( localConn->connected == 1) &&
             ( localConn->suId == suId ) &&
             ( localConn->suConId == suConId ) )
         {
            if(localConn->ownAddr.type == 4)
            {
              dstAddr->type = 4;
              ...
              dstAddr->u.ipv4TptAddr.port = 9899;
            ...
            else
            {
              ...
              dstAddr->u.ipv6TptAddr.port = 9899;
...
# 7080 "../..//sctp/sb_bdy1.c"
   ...
   if ( err != 0 )
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7085); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiHitUDatInd: message validation failed\n" ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

   }

   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7089); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiHitUDatInd: RETVALUE( ROK )\n" ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 7129 "../..//sctp/sb_bdy1.c"
{
   ...
   ;;
# 7172 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7174); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitDiscInd(pst, suId(%d), choice(%d), conId(%ld), reason(%d))\n", suId, choice, conId, reason ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 7222 "../..//sctp/sb_bdy1.c"
   ...
   if ( localAddrCb != (SbLocalAddrCb *)0L )
   {
...

         {
             ...
             for ( i = 0; i < sbGlobalCb.genCfg.maxNmbAssoc; i++ )
             {
                 ...
                 if ( assocCb != (SbSctAssocCb *) 0L )
                 {
                    if ( assocCb->localConn == localAddrCb )
                    {
                       ...
                       { SbSctEndpCb *tmpEndpCb; CmNetAddr _tmpAddr; tmpEndpCb = sbGlobalCb.endpCb[assocCb->endpId]; if ( tmpEndpCb == (SbSctEndpCb *) 0L ) { assocCb->localConn = (SbLocalAddrCb *) 0L; ret = 1; } else { U8 _k; for (_k = 0; (_k < tmpEndpCb->localAddrLst.nmb); _k++ ) { { S16 _i; cmMemset((U8 *)(&(_tmpAddr)), 0, sizeof(CmNetAddr));; if ((&(tmpEndpCb->localAddrLst.nAddr[_k])) == (CmNetAddr *)0L) { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = 0; } else { if ((&(tmpEndpCb->localAddrLst.nAddr[_k]))->type == 4) { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = (&(tmpEndpCb->localAddrLst.nAddr[_k]))->u.ipv4NetAddr; } else if ((&(tmpEndpCb->localAddrLst.nAddr[_k]))->type == 6) { (&(_tmpAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(_tmpAddr))->u.ipv6NetAddr[_i] = (&(tmpEndpCb->localAddrLst.nAddr[_k]))->u.ipv6NetAddr[_i]; } } else { (&(_tmpAddr))->type = 4; (&(_tmpAddr))->u.ipv4NetAddr = 0; } } }; ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *) &(_tmpAddr), (U16) sizeof(CmNetAddr), 0, (U32 *) &(assocCb->localConn)); if ( ret == 0 ) { if ( assocCb->localConn->connected ) break; ret = 1; } } if (ret == 1) { cmMemset((U8 *)(U8 *) &_tmpAddr, 0, sizeof(CmNetAddr)); _tmpAddr.type = tmpEndpCb->localAddrLst.nAddr[0].type; ret = cmHashListFind(&(sbGlobalCb.localAddrHl), (U8 *) &(_tmpAddr), (U16) sizeof(CmNetAddr), 0, (U32 *) &(assocCb->localConn)); } } };
                       if ( ret != 0 )
                       {
                          ...
                          if ( sctSap != (SbSctSapCb *)0L)
           {
                             ...
                             if (sctSap -> sctSapCfg.reConfig.freezeTm == 0 )
                             {
                                ...
                                { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7336); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
                             }
      ...
      if (localAddrCb->connected == 0)
      {
         if (localAddrCb->conRetryAttempt < 1)
         {
            if ((ret = sbLiOpenServer(tSap, localAddrCb)) != 0)
            {
                 { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7366); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndCfm: could not open server\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
         ...
         else
         {
            ...
            { sbLmGenAlarm(2, (256 + 13), (256 + 1), tSap->tSapCfg.suId, 1); };
# 7405 "../..//sctp/sb_bdy1.c"
         }
      }
   }
...
# 7461 "../..//sctp/sb_bdy1.c"
{
   ...
   ;;
# 7501 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7503); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "SbLiHitDiscCfm(pst, suId(%d), choice(%d), conId(%ld), action(%d))\n", suId, choice, conId, action ); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 7517 "../..//sctp/sb_bdy1.c"
   if (sbGlobalCb.sbInit.cfgDone == 0)
   {
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7520); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf ( sbGlobalCb.sbInit.prntBuf, "sbLiHitDiscCfm: General configuration not done\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 7568 "../..//sctp/sb_bdy1.c"
   ...
   if ( localAddrCb != (SbLocalAddrCb *)0L )
   {
                  ...
                  if ( ret != 0 )
                  {
                     ...
                     if ( sctSap != (SbSctSapCb *)0L)
                     {
                        ...
                        if (sctSap -> sctSapCfg.reConfig.freezeTm == 0 )
                        {
                           (Void) sbAsAbortAssoc (assocCb, 0);
                           sbGlobalCb.assocCb[i] = (SbSctAssocCb *) 0L;
                           { if (assocCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7687); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)assocCb, sizeof(SbSctAssocCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbSctAssocCb)); assocCb = 0L; } };
                        }
      ...
      {
# 7737 "../..//sctp/sb_bdy1.c"
         sbGlobalCb.localAddrCb[localAddrCb->suConId] = (SbLocalAddrCb *)0L;
         (Void) cmHashListDelete(&(sbGlobalCb.localAddrHl), (U32)localAddrCb);

         { if (localAddrCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7740); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)localAddrCb, sizeof(SbLocalAddrCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbLocalAddrCb)); localAddrCb = 0L; } };
...

{
   ...
   ;
# 7819 "../..//sctp/sb_bdy1.c"
   { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7820); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndCfm(pst, suId(%d), status(%d))\n", suId, status); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
   ...
   if ( status == 1 )
   {
      ...
      for ( i = 0; i < tSap->tSapCfg.srcNAddrLst.nmb; i++ )
      {
         ...
         ret = cmHashListFind(&(sbGlobalCb.localAddrHl),
                             ...
                             sizeof(CmNetAddr), 0, (U32 *) &localAddrCb);
# 7884 "../..//sctp/sb_bdy1.c"
         for ( j = 0; j < sbGlobalCb.genCfg.maxNmbSrcAddr; j++)
         {
            if ( sbGlobalCb.localAddrCb[j] == (SbLocalAddrCb *) 0L )
            {
         ...
         else
         {
            ...
            { ret = SGetSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data**)&localAddrCb, sizeof(SbLocalAddrCb)); if ( ret == 0 ) { cmMemset((U8*)localAddrCb, 0, sizeof(SbLocalAddrCb)); sbGlobalCb.genSta.memAlloc += (sizeof(SbLocalAddrCb)); } };
            if ( ret != 0 )
            {
               { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7908); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndCfm: could not alloc mem for localAddrCb\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };

            }
            else
            {

               { S16 _i; cmMemset((U8 *)(&(localAddrCb->ownAddr)), 0, sizeof(CmNetAddr));; if ((&(tSap->tSapCfg.srcNAddrLst.nAddr[i])) == (CmNetAddr *)0L) { (&(localAddrCb->ownAddr))->type = 4; (&(localAddrCb->ownAddr))->u.ipv4NetAddr = 0; } else { if ((&(tSap->tSapCfg.srcNAddrLst.nAddr[i]))->type == 4) { (&(localAddrCb->ownAddr))->type = 4; (&(localAddrCb->ownAddr))->u.ipv4NetAddr = (&(tSap->tSapCfg.srcNAddrLst.nAddr[i]))->u.ipv4NetAddr; } else if ((&(tSap->tSapCfg.srcNAddrLst.nAddr[i]))->type == 6) { (&(localAddrCb->ownAddr))->type = 6; for (_i = 0; _i < 16; _i++) { (&(localAddrCb->ownAddr))->u.ipv6NetAddr[_i] = (&(tSap->tSapCfg.srcNAddrLst.nAddr[i]))->u.ipv6NetAddr[_i]; } } else { (&(localAddrCb->ownAddr))->type = 4; (&(localAddrCb->ownAddr))->u.ipv4NetAddr = 0; } } };
               ...
               if ( ret != 0 )
               {
                  ...
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7932); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndCfm: could not insert localAddrCb into HL\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };


                  { if (localAddrCb == 0L) { { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000001)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7934); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "************* NULL DBUFF **********\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } }; } else { (Void) SPutSBuf(sbGlobalCb.sbInit.region, sbGlobalCb.sbInit.pool, (Data*)localAddrCb, sizeof(SbLocalAddrCb)); sbGlobalCb.genSta.memAlloc -= (sizeof(SbLocalAddrCb)); localAddrCb = 0L; } };
                  return(1);
               }
               ...
               if ((ret = sbLiOpenServer(tSap, localAddrCb)) != 0)
               {
                  { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7944); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndCfm: could not open server\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
     ...
     if(tSap->tSapCfg.reConfig.sbDnsCfg.useDnsLib == 1)
     {
        ...
        if(ret != 0)
        {
           { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7968); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndCfm: could not open  DNS Server\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
...
# 7993 "../..//sctp/sb_bdy1.c"
   ...
   else
   {
      ...
      { if ((&(sbGlobalCb.sbInit))->dbgMask & (0x00000008)) { sprintf((&(sbGlobalCb.sbInit))->prntBuf, "[%s 0x%x:%x] %s:%d ", "SCTP_LAYER", (&(sbGlobalCb.sbInit))->ent, (&(sbGlobalCb.sbInit))->inst, "../..//sctp/sb_bdy1.c", 7998); SPrint((&(sbGlobalCb.sbInit))->prntBuf); sprintf (sbGlobalCb.sbInit.prntBuf, "SbLiHitBndCfm: bind was unsuccessful\n"); SPrint((&(sbGlobalCb.sbInit))->prntBuf); } };
      ...
      if ( sbGlobalCb.sbMgmt.hdr.elmId.elmnt == 2 )

      {
         ...
         sbGlobalCb.sbMgmt.cfm.status = 1;
         sbGlobalCb.sbMgmt.cfm.reason = 16;
