...
{
   U8   measType;            /*!< Type of measurement */
...
PUBLIC S16 sendPdcpMsgToPrm(
    Event   event,
    U16     len,
    U8     *data
    );
void sendPdcpStartIndToPrm(void);
void sendPdcpHelloAckToPrm(Buffer  *mBuf);
void procRcvdPdcpExitMsg(void);    
#endif /*PWAV */
#endif /* __LPJ_X__ */
...
/main/2 lpj_x_001.main_1 ap 1. Added support for L2 Measurement.
*********************************************************************91*/
