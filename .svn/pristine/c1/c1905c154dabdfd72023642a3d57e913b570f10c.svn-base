...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 119 "../..//ltemac/rg_lmm.c" 2
# 1 "../..//cm/cm5.x" 1
# 120 "../..//ltemac/rg_lmm.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
static U16 rgLMMGenCfg ( RgCfg *cfg );



static U16 rgLMMSapCfg ( RgCfg *cfg, Elmnt sapType );




static Void rgLMMShutdown (Void );
...

{
   ...
   rgCb.tfuSap.sapSta.sapState = 0;
   rgCb.rguSap.sapSta.sapState = 0;
   rgCb.crgSap.sapSta.sapState = 0;
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 283); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCfgReq(): pst->srcEnt=%d, pst->srcInst=%d", pst->srcEnt, pst->srcInst); SPrint((&rgCb.rgInit)->prntBuf); } };


  { if(rgCb.rgInit.logMask & 0x1) { ssDiagFix(0x00620001, RG_DIAG_NA, 0xd6, rgCb.rgInit.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, pst->srcEnt, pst->srcInst, 0, 0, "Received CfgReq for MAC layer, Entity = %d, Instance = %d"); } };
   ...
   switch(cfg->hdr.elmId.elmnt)
   {
      case 1:
         ...
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 307); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCfgReq(): Gen Cfg done with reason=%d.",reason); SPrint((&rgCb.rgInit)->prntBuf); } };
         break;
      case 186:
      case 1 + 1:
      case 1 + 4:
         ...
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 315); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCfgReq(): SAP(Elmnt=%d) Cfg done with reason=%d.", cfg->hdr.elmId.elmnt, reason); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      default:
         ...
         ret = 1;
         reason = 5;
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 321); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCfgReq(): Invalid Elmnt=%d", cfg->hdr.elmId.elmnt); SPrint((&rgCb.rgInit)->prntBuf); } };
         break;
   }
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 376); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgStsReq(): stsReq for elmnt= %d pst->srcEnt=%d, action=%d", sts->hdr.elmId.elmnt, pst->srcEnt, sts->t.sts.action); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if(rgCb.rgInit.cfgDone != 1)
   {
      cfm.cfm.status = 1;
      cfm.cfm.reason = 8;
      RgMiLrgStsCfm(&cfmPst,&cfm);
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 398); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgStsReq(): Gen Cfg not done"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(0);
   }
   ...
   switch(sts->hdr.elmId.elmnt)
   {
      case 1:
         {
...

            {
               ...
               for(cqi=0; cqi <= 14; cqi++)
               {
                  ...
                  genSts->nackAckStats.dlCqiStat[cqi].mcs = hqFailStats.dlCqiStat[cqi].mcs;

                  genSts->nackAckStats.dlCqiStat[cqi].numOfNacks = hqFailStats.dlCqiStat[cqi].numOfNacks;

                  genSts->nackAckStats.dlCqiStat[cqi].numOfAcks =
                     hqFailStats.dlCqiStat[cqi].numOfAcks;


                  genSts->nackAckStats.ulCqiStat[cqi].mcs = hqFailStats.ulCqiStat[cqi].mcs;

                  genSts->nackAckStats.ulCqiStat[cqi].numOfNacks = hqFailStats.ulCqiStat[cqi].numOfNacks;

                  genSts->nackAckStats.ulCqiStat[cqi].numOfAcks = hqFailStats.ulCqiStat[cqi].numOfAcks;



                  genSts->hqRetxStats.dlCqiStat[cqi].mcs = hqRetxStats.dlCqiStat[cqi].mcs;

                  genSts->hqRetxStats.dlCqiStat[cqi].numOfHQ_1 = hqRetxStats.dlCqiStat[cqi].numOfHQ_1;

                  genSts->hqRetxStats.dlCqiStat[cqi].numOfHQ_2 = hqRetxStats.dlCqiStat[cqi].numOfHQ_2;

                  genSts->hqRetxStats.dlCqiStat[cqi].numOfHQ_3 = hqRetxStats.dlCqiStat[cqi].numOfHQ_3;

                  genSts->hqRetxStats.dlCqiStat[cqi].numOfHQ_4 = hqRetxStats.dlCqiStat[cqi].numOfHQ_4;

                  genSts->hqRetxStats.dlCqiStat[cqi].totalTx = hqRetxStats.dlCqiStat[cqi].totalTx;



                  genSts->hqRetxStats.ulCqiStat[cqi].mcs = hqRetxStats.ulCqiStat[cqi].mcs;

                  genSts->hqRetxStats.ulCqiStat[cqi].numOfHQ_1 = hqRetxStats.ulCqiStat[cqi].numOfHQ_1;

                  genSts->hqRetxStats.ulCqiStat[cqi].numOfHQ_2 = hqRetxStats.ulCqiStat[cqi].numOfHQ_2;

                  genSts->hqRetxStats.ulCqiStat[cqi].numOfHQ_3 = hqRetxStats.ulCqiStat[cqi].numOfHQ_3;

                  genSts->hqRetxStats.ulCqiStat[cqi].numOfHQ_4 = hqRetxStats.ulCqiStat[cqi].numOfHQ_4;

                  genSts->hqRetxStats.ulCqiStat[cqi].totalTx = hqRetxStats.ulCqiStat[cqi].totalTx;

               }

               if(sts->t.sts.action == 0)
               {
         ...
         break;
      case 186:
         cmMemcpy((U8 *)&(cfm.t.sts.s.rguSts), (U8 *)&rgCb.rguSap.sapSts,
                  sizeof(RgSapSts));


         if(sts->t.sts.action == 4)
            cmMemset((U8 *)&rgCb.rguSap.sapSts, 0, sizeof(RgSapSts));
      ...
      default:
         cfm.cfm.status = 1;
         cfm.cfm.reason = 5;
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 509); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgStsReq(): Invalid Elmnt = %d",sts->hdr.elmId.elmnt); SPrint((&rgCb.rgInit)->prntBuf); } };
         break;
   }
   RgMiLrgStsCfm(&cfmPst,&cfm);
   return(0);
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 553); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgStaReq(): staReq for elmnt= %d pst->srcEnt=%d", sta->hdr.elmId.elmnt, pst->srcEnt); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if(rgCb.rgInit.cfgDone != 1)
   {
      ...
      if (SGetSBuf(cfmPst.region, cfmPst.pool,
         ...
         != 0)
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 578); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCntrlReq(): Memory Unavailable                   for Confirmation"); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 587); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgStaReq(): Gen Cfg not done"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(0);
   }
   ...
   switch(sta->hdr.elmId.elmnt)
   {
      case 1:
         ...
         if (SGetSBuf(cfmPst.region, cfmPst.pool,
            ...
            != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 600); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCntrlReq(): Memory Unavailable                      for Confirmation"); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      case 186:
         ...
         cfm.cfm.reason = 0;
         SGetDateTime(&cfm.t.ssta.dt);
         cmMemcpy((U8 *)&(cfm.t.ssta.s.rguSapSta), (U8 *)&rgCb.rguSap.sapSta,
         sizeof(RgSapSta));
         RgMiLrgStaCfm(&cfmPst, &cfm);
         break;
      case 1 + 1:
      ...
      default:
         ...
         cfm.cfm.reason = 5;
         RgMiLrgStaCfm(&cfmPst, &cfm);
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 637); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgStaReq(): Invalid elmnt=%d", sta->hdr.elmId.elmnt); SPrint((&rgCb.rgInit)->prntBuf); } };
         break;
   }
   return(0);
}
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 683); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCntrlReq():cntrlReq for elmnt= %d,action=%d,subaction=%d", cntrl->hdr.elmId.elmnt, cntrl->t.cntrl.action, cntrl->t.cntrl.subAction); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   if(rgCb.rgInit.cfgDone != 1)
   {
      ...
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 703); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCntrlReq(): Gen Cfg not done."); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(0);
   }
   ...
   switch(cntrl->hdr.elmId.elmnt)
   {
      ...
      default:
         ...
         cfm.cfm.reason = 13;
         RgMiLrgCntrlCfm(&cfmPst, &cfm);
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 723); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nRgMiLrgCntrlReq(): invalid elmnt=%d", cntrl->hdr.elmId.elmnt); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 766); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCfg(): SAP Config Requested for sapType=%d", sapType); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      case 186:
         if ((cfg->s.rguSap.selector != 1) &&
             (cfg->s.rguSap.selector != 0))
         {
            ret = 13;
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 778); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCfg(): unsupported Selector value for RGU."); SPrint((&rgCb.rgInit)->prntBuf); } };
            break;
         }
         if(rgCb.rguSap.sapSta.sapState == 0)
         {
            rgCb.rguSap.sapSta.sapState = 1;
         }
         upSapCfg = &rgCb.rguSap.sapCfg;
      ...
      case 1 + 1:
         ...
         {
            ret = 13;
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 807); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCfg(): unsupported Selector value for CRG."); SPrint((&rgCb.rgInit)->prntBuf); } };
            break;
         }
         if(rgCb.crgSap.sapSta.sapState == 0)
         {
            rgCb.crgSap.sapSta.sapState = 1;
         }
      ...
      case 1 + 4:
         ...
         {
            ret = 13;
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 837); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCfg(): unsupported Selector value for TFU."); SPrint((&rgCb.rgInit)->prntBuf); } };
            break;
         }

         if (rgCb.tfuSap.sapSta.sapState == 0)
         {
            rgCb.tfuSap.sapSta.sapState = 1;
         }
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 904); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMGenCfg(): General Configuration Request"); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 913); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCfg(): unsupported Selector value for RGU."); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(13);
   }
   ...
   cmInitTimers(rgCb.tmrBlk, 1);

   cmMemset((U8 *)&rgCb.tmrTq, 0, sizeof(CmTqType)*10);

   cmMemset((U8 *)&rgCb.tmrTqCp, 0, sizeof(CmTqCp));
   rgCb.tmrTqCp.tmrLen = 10;

   if (SRegCfgTmrMt(rgCb.rgInit.ent,rgCb.rgInit.inst,(S16)rgCb.genCfg.tmrRes,10,rgActvTmr) != 0)

   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 943); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgGenCfg(): Failed to register timer."); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(4);
   }

   if (rgDBMInitCellLst(10) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 949); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMGenCfg(): rgCb.cellLst Initialization failed"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(4);
   }


   if (rgDBMInitInactvCellLst(10) != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 956); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMGenCfg(): rgCb.inactvCellLst Initialization failed"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(4);
   }

   rgCb.prevCell = 0L;

   rgCb.rgInit.cfgDone = 1;
...
{
   RgCellCb *cellCbPrev = 0L;
   RgCellCb *cellCbCurr = 0L;
   U8 idx;

   ;

   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 998); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMShutdown(): Layer Shutdown Requested"); SPrint((&rgCb.rgInit)->prntBuf); } };


   if(rgCb.tfuSap.sapSta.sapState == 3)
   {
      rgLIMTfuUbndReq(rgCb.tfuSap.sapCfg.spId, 1);
      if (rgCb.tfuSap.sapCfg.bndTmr.enb == 1)
      {
         rgLMMStopTmr(1, (U32)&rgCb.tfuSap);
      }
      rgCb.tfuSap.sapSta.sapState = 1;
   }
   if(rgCb.tfuSap.sapSta.sapState == 2)
   {
      rgLIMTfuUbndReq(rgCb.tfuSap.sapCfg.spId, 1);
      rgCb.tfuSap.sapSta.sapState = 1;
   }
   ...
   while (0L != (cellCbCurr = rgDBMGetNextCellCb(cellCbPrev)))
   {
   ...
   cellCbPrev = 0L;
   while (0L != (cellCbCurr = rgDBMGetNextInactvCellCb(cellCbPrev)))
   {
   ...
   (Void) SDeregCfgTmrMt(rgCb.rgInit.ent,rgCb.rgInit.inst,(S16)rgCb.genCfg.tmrRes,10,rgActvTmr);
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1083); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMGenCntrl(): Control Req for STGEN"); SPrint((&rgCb.rgInit)->prntBuf); } };
   cfm->cfm.status = 0;
   cfm->cfm.reason = 0;
   ...
   switch(cntrl->t.cntrl.action)
   {
      case 1:
         ...
         switch(cntrl->t.cntrl.subAction)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1126); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMGenCntrl(): invalid subaction=%d", cntrl->t.cntrl.subAction); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      case 2:
         ...
         switch(cntrl->t.cntrl.subAction)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1156); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMGenCntrl(): invalid subaction=%d", cntrl->t.cntrl.subAction); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      default:
         cfm->cfm.status = 1;
         cfm->cfm.reason = 13;
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1168); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMGenCntrl(): invalid action=%d", cntrl->t.cntrl.action); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1207); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCntrl(): Control Req for SAP (%d)", cntrl->hdr.elmId.elmnt); SPrint((&rgCb.rgInit)->prntBuf); } };
         ...
         switch(cntrl->t.cntrl.action)
         {
            case 30:
               ...
               else
               {
                  if (rgCb.tfuSap.sapCfg.bndTmr.enb == 1)
                  {
                     rgLMMStartTmr(1, rgCb.tfuSap.sapCfg.bndTmr.val,
                     (U32)&rgCb.tfuSap);
                  }

                  rgCb.tfuSap.sapSta.sapState = 3;
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1290); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCntrl(): invalid action=%d", cntrl->t.cntrl.action); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      case 186:
         switch(cntrl->t.cntrl.action)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1307); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCntrl(): invalid action=%d", cntrl->t.cntrl.action); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      case 1 + 1:
         switch(cntrl->t.cntrl.action)
         {
            ...
            default:
               cfm->cfm.status = 1;
               cfm->cfm.reason = 13;
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1324); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMSapCntrl(): invalid action=%d", cntrl->t.cntrl.action); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1424); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMStartTmr(): Timer start request for tmrEvnt=%d, tmrVal=%ld", tmrEvnt, tmrVal); SPrint((&rgCb.rgInit)->prntBuf); } };
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1484); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMStopTmr(): Timer stop request for tmrEvnt=%d",tmrEvnt); SPrint((&rgCb.rgInit)->prntBuf); } };
   ret = 1;
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1511); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMStopTmr(): tmrEvnt=%d search result is ret=%d",tmrEvnt,ret); SPrint((&rgCb.rgInit)->prntBuf); } };

   return(ret);
}
# 1534 "../..//ltemac/rg_lmm.c"
 S16 rgLMMTmrExpiry
(
U32 cb,
S16 tmrEvnt
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1550); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTmrExpiry(): Timer Expired for tmrEvnt=%d",tmrEvnt); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   switch(tmrEvnt)
   {
      case 1:
         ...
         if(tfuSap->numBndRetries > 2)
         {
            rgLMMStaInd(2, 8,
                        10, 0L);
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1560); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTmrExpiry(): Max Bind Retries Exceeded."); SPrint((&rgCb.rgInit)->prntBuf); } };
         }
         else
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1564); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTmrExpiry(): Retry Bind"); SPrint((&rgCb.rgInit)->prntBuf); } };

            if (tfuSap->sapCfg.bndTmr.enb == 1)
            {
               ret = rgLMMStartTmr(1, tfuSap->sapCfg.bndTmr.val,
               cb);
            }
         ...
         break;
      default:
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1577); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTmrExpiry(): Invalid tmrEvnt=%d", tmrEvnt); SPrint((&rgCb.rgInit)->prntBuf); } };
         ret = 1;
         break;
   }
   return(ret);
}
# 1604 "../..//ltemac/rg_lmm.c"
 S16 rgLMMStaInd
(
U16 category,
U16 event,
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1624); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMStaInd(): category=%d, event=%d, cause=%d", category, event, cause); SPrint((&rgCb.rgInit)->prntBuf); } };

   if(rgCb.rgInit.usta == 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1627); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTmrExpiry(): USTA Ind Disabled."); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(0);
   }
   ...
   return(RgMiLrgStaInd(&rgCb.rgInit.lmPst, &usta));
}
# 1668 "../..//ltemac/rg_lmm.c"
 Void rgLMMTrcInd
(
Buffer *srcMbuf,
U8 event
...

{
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1689); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): Trace for event=%d, rgCb.trcLen=%d",event, rgCb.trcLen); SPrint((&rgCb.rgInit)->prntBuf); } };


   if ((rgCb.trcLen == 0) || (srcMbuf == 0L))
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1693); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): Trace Disabled."); SPrint((&rgCb.rgInit)->prntBuf); } };
      return;
   }
   ...
   if(rgCb.trcLen == -1)
   {
         ...
         != 0)
      {
         ...
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1717); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): SCpyMsgMsg Failed."); SPrint((&rgCb.rgInit)->prntBuf); } };
         return;
      }
      trc.cfm.status = 0;
      trc.cfm.reason = 0;
   ...
   else if(rgCb.trcLen > 0)
   {
      ...
      {
         { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1733); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): SFndLenMsg Failed."); SPrint((&rgCb.rgInit)->prntBuf); } };
         return;
      }
      ...
      if(bufLen < rgCb.trcLen)
      {
         ...
         if (SCpyMsgMsg(srcMbuf, pst.region, pst.pool, &dstMbuf)
            != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1744); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): SCpyMsgMsg Failed."); SPrint((&rgCb.rgInit)->prntBuf); } };
            return;
         }
      ...
      if(bufLen >= rgCb.trcLen)
      {
         ...
         if (rgAllocSBuf(&tempBuf, rgCb.trcLen) != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1761); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): rgAllocSBuf Failed."); SPrint((&rgCb.rgInit)->prntBuf); } };
            return;
         }


         if (SCpyMsgFix(srcMbuf,0,rgCb.trcLen,tempBuf,&tempCnt) != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1768); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): SCpyMsgFix Failed."); SPrint((&rgCb.rgInit)->prntBuf); } };
            return;
         }

         if (SGetMsg(pst.region, pst.pool, &dstMbuf) != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1774); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): dstMbuf Allocation Failed."); SPrint((&rgCb.rgInit)->prntBuf); } };
            return;
         }

         if (SCpyFixMsg(tempBuf,dstMbuf,0,rgCb.trcLen,&tempCnt) != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1780); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMTrcInd(): SCpyFixMsg Failed."); SPrint((&rgCb.rgInit)->prntBuf); } };
            return;
         }
...

{
   ...
   (pst=pst);
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1843); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMBndCfm(): suId=%d, status=%d, sapState=%d", suId, status, rgCb.tfuSap.sapSta.sapState); SPrint((&rgCb.rgInit)->prntBuf); } };



   if(rgCb.tfuSap.sapCfg.suId != suId)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1848); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMBndCfm(): Invalid SuId"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ...
   switch(status)
   {
      case 1:
         ...
         if (rgCb.tfuSap.sapCfg.bndTmr.enb == 1)
         {
            ret = rgLMMStopTmr(1, (U32)&rgCb.tfuSap);
         }
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_lmm.c", 1905); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "\nrgLMMBndCfm(): RgMiLrgCntrlCfm  ret=%d.",ret); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(ret);
}
# 1924 "../..//ltemac/rg_lmm.c"
 S16 rgActvTmr
(
 Ent ent,
 Inst inst
