...
# 130 "../..//tucl/hi_ptui.c" 2
# 1 "../..//cm/cm5.h" 1
# 131 "../..//tucl/hi_ptui.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 100 "../..//cm/cm_inet.h"
#define __CMINETH__ 
...
# 159 "../..//tucl/hi_ptui.c" 2
# 1 "../..//cm/cm5.x" 1
# 160 "../..//tucl/hi_ptui.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 104 "../..//cm/cm_inet.x"
#define __CMINETX__ 
# 158 "../..//cm/cm_inet.x"
...
# 3460 "../..//tucl/hi_ptui.c"
{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 3467); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConInd(pst, suId(%d), servConId(%ld)), spConId(%ld),            peerAddr(%p)\n", suId, servConId, spConId, (Ptr)peerAddr); SPrint((&(hiCb.init))->prntBuf); } };
# 3478 "../..//tucl/hi_ptui.c"
   switch(pst->dstEnt)
   {
# 3490 "../..//tucl/hi_ptui.c"
...
# 3535 "../..//tucl/hi_ptui.c"
{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 3542); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitConCfm(pst, suId(%d), suConId(%ld)), spConId(%ld),      localAddr(%p)\n", suId, suConId, spConId, (Ptr)localAddr); SPrint((&(hiCb.init))->prntBuf); } };
# 3549 "../..//tucl/hi_ptui.c"
   switch(pst->dstEnt)
   {
# 3560 "../..//tucl/hi_ptui.c"
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 3665); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitBndCfm(pst, suId(%d), status(%d)\n", suId, status); SPrint((&(hiCb.init))->prntBuf); } };
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 3723); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDatInd(pst, suId(%d), suConId(%ld), mBuf(%p))\n", suId, suConId, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } };
# 3730 "../..//tucl/hi_ptui.c"
   switch(pst->dstEnt)
   {
# 3740 "../..//tucl/hi_ptui.c"
...
# 3814 "../..//tucl/hi_ptui.c"
{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 3821); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitUDatInd(pst, suId(%d), suConId(%ld), srcAddr(%p),           mBuf(%p))\n", suId, suConId, (Ptr)srcAddr, (Ptr)mBuf); SPrint((&(hiCb.init))->prntBuf); } };
# 3828 "../..//tucl/hi_ptui.c"
   switch(pst->dstEnt)
   {
# 3846 "../..//tucl/hi_ptui.c"
...
# 3902 "../..//tucl/hi_ptui.c"
{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 3909); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDiscInd(pst, suId(%d), choice(%d), conId(%ld),           reason(%d))\n", suId, choice, conId, reason); SPrint((&(hiCb.init))->prntBuf); } };
# 3916 "../..//tucl/hi_ptui.c"
   switch(pst->dstEnt)
   {
# 3927 "../..//tucl/hi_ptui.c"
...
# 3973 "../..//tucl/hi_ptui.c"
{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 3980); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitDiscCfm(pst, suId(%d), choice(%d), conId(%ld),           action(%d))\n", suId, choice, conId, action); SPrint((&(hiCb.init))->prntBuf); } };
# 3987 "../..//tucl/hi_ptui.c"
   switch(pst->dstEnt)
   {
# 3998 "../..//tucl/hi_ptui.c"
...

{
   ...
   { if ((&(hiCb.init))->dbgMask & (0x00000004)) { sprintf((&(hiCb.init))->prntBuf, "[%s 0x%x:%x] %s:%d ", "TCP_UDP_CONVERGENCE_LAYER", (&(hiCb.init))->ent, (&(hiCb.init))->inst, "../..//tucl/hi_ptui.c", 4044); SPrint((&(hiCb.init))->prntBuf); sprintf (hiCb.init.prntBuf, "HiUiHitFlcInd(pst, suId(%d), reason(%d))\n", suId, reason); SPrint((&(hiCb.init))->prntBuf); } };
