...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,"NhMiLnhStaInd \n"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,"NhMiLnhStaCfm \n"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,"NhMiLnhStsCfm \n"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,"NhMiLnhTrcInd \n"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,"NhMiLnhCfgCfm \n"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_INFO((NH_PRNT_BUF,"NhMiLnhCntrlCfm \n"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtMiLnhStaInd() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtMiLnhStaCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtMiLnhStsCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtMiLnhTrcInd() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtMiLnhCfgCfm() called"));
...
#endif /* ANSI */
{
   ...
   NH_DBG_ERROR((NH_PRNT_BUF, "PtMiLnhCntrlCfm() called"));
...
/**
* @details DESCRIPTION
* This function creates a post structure and fills the PWAV Msg as a payload to POST structure
* PWAV IPC message is the payload for SSI Message.
*/

inline PUBLIC S16 sendRrcMsgToPrm (Event event, MsgLen len, U8 *data) { return sendEventToOam (ENTNH, ENT_PRM, event, len, data); }
//inline PUBLIC void sendRrcHelloAckToPrm (void) { sendRrcMsgToPrm (EVT_HELLO_ACK, 0, NULL); }
void sendRrcStartIndToPrm(void)
{
  U32 version = getSvnVersion(MODID_RRC);
  logInfo ("RRC svn version : %d", version);
  printf  ("RRC svn version : %d\n", version);
  /*send start indication to PRM indicating successful startup*/
  if( sendRrcMsgToPrm(EVT_START_IND, sizeof(U32), &version ) == ROK)
  {
    logMsgOut("%s", "Sent EVT_START_IND from RRC to PRM" );
  }
}

void sendRrcHelloAckToPrm(
    Buffer  *mBuf
    )
{
  MsgLen              cCnt;
  ...
  if( sendRrcMsgToPrm(EVT_HELLO_ACK, sizeof(MsgModPrmHelloAck), (U8*)&helloAck) == ROK)
  {
    logMsgOut("%s", "Sent EVT_HELLO_ACK from RRC to PRM" );
  }
}


void procRcvdRrcExitMsg(void)
{
