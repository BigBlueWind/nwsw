...
#
#       Sid:      rg.mak.04@@/main/2 - Sat Jul 30 02:21:22 2011
#
#       Prg:   st
#
#********************************************************************21*/
...
#----------------- MAC product options --------------------------
# 
FLAGS_ADDED=-DLTEMAC_MIMO -DLTEMAC_SPS -DxTFU_UPGRADE -DxLTE_L2_MEAS -DLTEMAC_DRX -DLTEMAC_R9 -DRGR_CQI_REPT -DLTEMAC_RGU_PAD -DLRG_V1 -DRGR_V2 -DMT_TMR_CHANGES -DCMIET_LARGE_MAX_UDPRAW_SIZE -DLONG_MSG      

PRDOPTS=-DxLTE_TDD -DxTFU_TDD -DLTEMAC_MIMO -DLTEMAC_SPS -DxTFU_UPGRADE -DxLTE_L2_MEAS -DLTEMAC_HDFDD -DLTEMAC_DRX -DLTEMAC_R9 -DRGR_SI_SCH -DRGR_CQI_REPT -DLTEMAC_RGU_PAD -DRGR_V1 -DLRG_V1 -DRGR_V2 -DRG -DCMFILE_REORG_1 -DCMFILE_REORG_2 -DSS_MT_TMR -DMT_TMR_CHANGES -UDEBUGP -URG_DEBUG -DCM_INET2 -DSS_FLOAT -DCMIET_LARGE_MAX_UDPRAW_SIZE -DLONG_MSG -DxRG_ULSCHED_AT_CRC -DxLTEMAC_DLUE_TMGOPTMZ 

#PRDOPTS=$(FLAGS_ADDED) -DRG -DRG_PHASE2_SCHED -DRG -DKW -DLCKWLIRGU -DLCRGU -DLCRGUIRGU -DCCPU_OPT -DLCNHLICRG -DLCCRG -DLCRGUICRG -DLCSMMILRG -DLCLRG -DSM -DRG -DLCRGMILRG -DRG -DLCWRLIRGR -DLCRGR -DLWLCWRLIRGR -DLCRGUIRGR -DTFU_VER_2 -DLCTFU -DLCRGLITFU  -DENB  -DCMINET_BSDCOMPAT -DSS_TICKS_SEC=1000 -DCMFILE_REORG_1 -DCM_INET2 -DCMFILE_REORG_2 -DSSINT2 -DCMKV2 -DHI_MULTI_THREADED  -DSS_PERF -DSS_WL_REGION=1 -DNO_ERRCLS -DNOERRCHK -DFP_RELEASE6 -DCCPU_DEBUG_TRACE -DCCPU_MEAS_CPU -DDEBUGP -DREL_850 -DSS_FLOAT -DRGR_RRM_TICK -DLTE_ENB_PAL -DSLES9_PLUS -DTA_NEW -DSI_NEW -DRGR_SI_SCH -DRGR_V1 -DLTE_HO_SUPPORT -DRS -DKW_BG_DL_PROC -DKW_BG_UL_PROC -DWR_SB_SCTP -DLTERRC_REL9 -DMME_LDBAL -DSZ_ENB -DEGTP_U_REL_9 -DLEGV2 -DTFU_VER_2 -DTF  -DSS_MT_TMR
...
PRDACCOPTS=$(PRDOPTS) -DRG -DKW -DNH -DNX -DTF -DSM $(CMD_LINE) -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE  -ULCSCH -ULCRG -DLCTFU -DLCCRG -DLCRGU -DLCRGR -DLCLRG -DLCRGMILRG -DLCRGUIRGU -DLCRGUICRG -DLCRGUIRGR -DLCRGLITFU -DLCSMLILRG -DLCNHLICRG -DLCNXLIRGR -DLCKWLIRGU -DLCTFUITFU -DRG_PHASE2_SCHED -DLONG_MSG
...
MTOSOPTS=-DSS_MT -DSS -DCMFILE_REORG_1 -DSS_MT_TMR -DMT_TMR_CHANGES -DSS_SINGLE_THREADED -D_REENTRANT -DDEBUGNOEXIT -DSS_DRVR_SUPPORT -DLONG_MSG
...
#
# For ANSI Compilation
LNXENV="-DSUNOS -DANSI -DSS_LINUX -DSSI_DEBUG_LEVEL1 -UNO_ERRCLS -DNOCONAVL -UUSE_PURE"
...
# Product Upper Interface - CRG, RGR and RGU includes 
RG_U_INC=$(CM_DIR)/crg.h $(CM_DIR)/crg.x $(CM_DIR)/rgr.h $(CM_DIR)/rgr.x $(CM_DIR)/rgu.h $(CM_DIR)/rgu.x 
