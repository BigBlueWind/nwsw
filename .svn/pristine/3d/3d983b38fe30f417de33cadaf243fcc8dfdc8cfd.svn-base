...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//ltemac/rg_sch_sc1.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//ltemac/rg_sch_sc1.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
# 113 "../..//ltemac/rg_sch_sc1.c" 2
# 1 "../..//ltemac/rg_sch_sc1.h" 1
# 90 "../..//ltemac/rg_sch_sc1.h"
#define __RGSCHSC1H__ 
# 102 "../..//ltemac/rg_sch_sc1.h"
#define RG_GET_SC1_CELL_UL(cell) ((RgSchSc1UlCell *)((RgSchCmnCell*)((cell)->sc.sch))->ul.schSpfc)

#define RG_GET_SC1_CELL_DL(cell) ((RgSchSc1DlCell *)((RgSchCmnCell*)((cell)->sc.sch))->dl.schSpfc)


#define RG_GET_SC1_UE_DL(ue) ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc)

#define RG_GET_SC1_UE_UL(ue) ((RgSchSc1UlUe *)((RgSchCmnUe *)((ue)->sch))->ul.schSpfc)


#define RG_GET_SC1_SVC_DL(dlLc) ((RgSchSc1DlSvc *)((RgSchCmnDlSvc *)((dlLc)->sch))->schSpfc)

#define RG_GET_SC1_HQP_DL(hqP) ((RgSchSc1DlHqProc *)((RgSchCmnDlHqProc *)((hqP)->sch))->schSpfc)


#define RG_SC1_SVC_HAS_DATA(svc) (((RgSchSc1DlSvc *)(((RgSchCmnDlSvc *)((svc)->sch))->schSpfc))->effMbr != 0)
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//ltemac/rg_sch_sc1.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//ltemac/rg_sch_sc1.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 131 "../..//ltemac/rg_sch_sc1.c" 2
# 1 "../..//ltemac/rg_sch_sc1.x" 1
# 105 "../..//ltemac/rg_sch_sc1.x"
...
extern Void rgSCHSc1DlCqiInd ( RgSchCellCb *cell, RgSchUeCb *ue, TfuDlCqiRpt *dlCqiRpt );
...
static Void rgSCHSc1DlProcRmvFrmUeRetx ( RgSchUeCb *ue, RgSchDlHqProcCb *hqP );
...
static Void rgSCHSc1DlAdd2UeLcsWithData ( RgSchUeCb *ue, RgSchDlLcCb *svc );



static Void rgSCHSc1DlRmFrmUeLcsWithData ( RgSchUeCb *ue, RgSchDlLcCb *svc );
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 276); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlUeReset\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   rgSCHSc1DlSuspendUe(cell, ue);

   return;
}
# 300 "../..//ltemac/rg_sch_sc1.c"
...
{
   RgSchSc1DlUe *ueDl = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
   CmLListCp *lst;
   CmLList *node;
   RgSchDlHqProcCb *hqP;
   RgSchDlLcCb *svc;
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 321); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlActvtUe\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
{
   RgSchSc1DlUe *ueDl = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
   RgSchCmnDlUe *ueCmnDl = &(((RgSchCmnUe *)((ue)->sch))->dl);
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 393); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlUeRefresh\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while (node != 0L)
   {
      ...
      svcSc1 = ((RgSchSc1DlSvc *)((RgSchCmnDlSvc *)((svc)->sch))->schSpfc);
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 465); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlProcRmvFrmCellRetx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   if (hqProcDl->retxLnk.node != 0L)
   {
      cmLListDelFrm(&cellDl->retxLst[((RgSchSc1DlHqProc *) (hqProcDl->schSpfc))->prio], &(hqProcDl->retxLnk));

      hqProcDl->retxLnk.node = 0L;
   }
   return;
}
# 494 "../..//ltemac/rg_sch_sc1.c"
...
{
   RgSchSc1DlUe *sc1Ue = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 512); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlProcRmvFrmUeRetx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 560); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlProcAddToUeRetx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 605); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlProcAddToCellRetx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   cmLListAdd2Tail(&sc1CellDl->retxLst[((RgSchSc1DlHqProc *) (cmnHqDl->schSpfc))->prio], &(cmnHqDl->retxLnk));

   cmnHqDl->retxLnk.node = (U32)hqP;
   return;
}
# 637 "../..//ltemac/rg_sch_sc1.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 674); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlRetxAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   do { if ((schdTime.subframe += (2 + 1)) > 9) { schdTime.sfn = ((schdTime.sfn) + 1) & 0x03ff; schdTime.subframe -= 10; }} while(0);
...
# 722 "../..//ltemac/rg_sch_sc1.c"
         cmnUeDl = &(((RgSchCmnUe *)((ue)->sch))->dl);
# 732 "../..//ltemac/rg_sch_sc1.c"
         if ((ue->dl.dlAllocCb.reqLnk.node != 0L))
         {
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 735); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHSc1DlRetxAlloc():                      UE is transmitting."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         ...
         sc1DlUe = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
         if (sc1DlUe->lcsWithData.first != 0L)
         {
            ue->dl.dlAllocCb.mimoAllocInfo.hasNewTxData = 1;
         }

         if (rgSCHCmnDlAllocRetxRb(cell, subFrm, ue, 0, &effBo, hqP, allocInfo) != 0)
...
# 851 "../..//ltemac/rg_sch_sc1.c"
{
   ...
   Inst inst = cell->instIdx;
# 872 "../..//ltemac/rg_sch_sc1.c"
   S16 ret;

   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 875); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlDedSvcAlloc\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };


   ue = svc->ue;
# 889 "../..//ltemac/rg_sch_sc1.c"
   ueDl = &(((RgSchCmnUe *)((ue)->sch))->dl);
# 905 "../..//ltemac/rg_sch_sc1.c"
   if ((ue->dl.dlAllocCb.reqLnk.node != 0L))
   {
      proc = (RgSchDlHqProcCb *)(ueDl->proc);


      if (((proc->tbInfo[0].txCntr | proc->tbInfo[1].txCntr)))
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 913); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nnrgSCHSc1DlDedSvcAlloc():                   Ue retransmitting."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   {
      if (rgSCHDhmGetAvlHqProc(ue, cmnCellDl->time, &proc) != 0)
      {
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 929); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nnrgSCHSc1DlDedSvcAlloc():                   No Hq Proc Avl."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if ((ret != 0) || (effBo == 0))
   {
      ...
      if (cmnHqDl->totBytes == 0)
      {
         ...
         if(ue->dl.dlAllocCb.reqLnk.node != (U32)0L)
         {
            cmLListDelFrm(&allocInfo->dedAlloc.txUeLst, &ue->dl.dlAllocCb.reqLnk);
            ue->dl.dlAllocCb.reqLnk.node = (U32)0L;
         }
...
{
   RgSchSc1DlSvc *svcSc1 = ((RgSchSc1DlSvc *)((RgSchCmnDlSvc *)((svc)->sch))->schSpfc);
   RgSchSc1DlUe *ueSc1 = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);

   Inst inst = ue->cell->instIdx;

   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1018); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlAdd2UeSchdSvcs\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1079); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlDedTx\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for(i = 2 + 1; i < 8 + 1; i++)
   {
      ...
      while(node != 0L)
      {
         ...
         ueDl = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
         node = node->next;
...
# 1157 "../..//ltemac/rg_sch_sc1.c"
static Void rgSCHSc1DlDed
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *allocInfo
)
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1173); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlDed\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1226); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSvcAddToSchd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (svcCmn->prio <= 2)
   {
      if (!(((RgSchSc1DlSvc *)(((RgSchCmnDlSvc *)((svc)->sch))->schSpfc))->effMbr != 0))
         return;
      ...
      while(node)
      {
         ...
         lSvcSc1 = ((RgSchSc1DlSvc *)((RgSchCmnDlSvc *)((lSvc)->sch))->schSpfc);
         if (((svcSc1->effGbr > 0) &&
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1332); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlUeRmvFrmSchd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1384); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSvcRmvFrmUeAmbrLst\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1433); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSvcAddToUeAmbrLst\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
{
   RgSchSc1DlCell *cellDl = ((RgSchSc1DlCell *)((RgSchCmnCell*)((cell)->sc.sch))->dl.schSpfc);
   RgSchSc1DlSvc *svcDl = ((RgSchSc1DlSvc *)((RgSchCmnDlSvc *)((svc)->sch))->schSpfc);
   RgSchCmnDlSvc *svcCmn = ((RgSchCmnDlSvc *)((svc)->sch));
   CmLListCp *lst;
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1501); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSvcRmvFrmSchd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1556); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSvcAdd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   (cfg=cfg);

   if (((((RgSchCmnDlSvc*)(svc->sch))->prio >= 1) && (((RgSchCmnDlSvc*)(svc->sch))->prio <= 2)))
   {
      svcSc1->gbr = svcCmn->gbr;
      svcSc1->mbr = svcCmn->mbr;
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1610); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlLcRmv\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   else if (((((RgSchCmnDlSvc*)(svc->sch))->prio >= 1) && (((RgSchCmnDlSvc*)(svc->sch))->prio <= 2)))
   {
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1694); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSvcMod\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1742); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlUeAddToSchd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while(node)
   {
      lueDl = ((RgSchSc1DlUe *)((RgSchCmnUe *)(((RgSchUeCb *)(node->node))->sch))->dl.schSpfc);
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1824); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlMngAmbrSvcPosn\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1926); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlLcBoUpd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 1983); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2036); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlMngGbrSvcPosn\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2087); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   (cellDl->svcMngFunc[svcCmn->prio])(cell, ue, svc);
   return;
}
# 2118 "../..//ltemac/rg_sch_sc1.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2138); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1RgrDlCellCfg\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   if((ret = rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(((RgSchCmnCell*)((cell)->sc.sch))->dl.schSpfc), (sizeof(RgSchSc1DlCell)))) != 0)

   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2145); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   if (((RgSchSc1DlCell *)((RgSchCmnCell*)((cell)->sc.sch))->dl.schSpfc) == 0L)
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2279); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      err->errCause = ((((((((((((((((0 + 1) + 4) + 1) + 7) + 1) + 2) + 1) ) + 1) + 2) + 1) + 1) + 1) + 16) + 1) + 10);
      return(1);
   }
   ...
   if (rgSCHUtlAllocSBuf(cell->instIdx,
            ...
            (ue->dl.hqEnt->numHqPrcs * sizeof(RgSchSc1DlHqProc))) != 0)
   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2307); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
   ...
   for(cnt = 0; cnt < ue->dl.hqEnt->numHqPrcs; cnt++)
   {
      ...
      ((RgSchCmnDlHqProc *)((hqP)->sch))->schSpfc = hqSpcSch++;

   }

   return(0);
}
# 2342 "../..//ltemac/rg_sch_sc1.c"
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2363); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1RgrDlUeRecfg\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2458); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlRmvUeFrmPrioQs\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   sc1Ue = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2514); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlInactvtUe\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2582); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSuspendUe\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   for(i = 0; i < ue->dl.hqEnt->numHqPrcs; i++)
   {
      ...
      for (j = 0; j < 2; j++)
      {
         if ((hqP->tbInfo[j].subFrm != 0L) &&
               (hqP->tbInfo[j].sfLnk.node != 0L))
         {
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2655); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlUeDel\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   if (((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc) == 0L)
   {
      return;
   }
...
# 2719 "../..//ltemac/rg_sch_sc1.c"
{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2725); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1RgrLcCfg\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   ret = rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&((RgSchCmnDlSvc *)((dlLc)->sch))->schSpfc, (sizeof(RgSchSc1DlSvc)));

   if (ret != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2733); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgSCHSc1CrgLcCfg():       SCH struct alloc failed."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 2782 "../..//ltemac/rg_sch_sc1.c"
{

   Inst inst = cell->instIdx;

   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2787); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1RgrLcRecfg\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2877); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlTaCmd\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 2896 "../..//ltemac/rg_sch_sc1.c"
      ...
      if (rgSCHDhmGetAvlHqProc(ue, cellCmnDl->time, &proc) != 0)
      {
         continue;
      }
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 2983); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlHndlInActUes\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 3018 "../..//ltemac/rg_sch_sc1.c"
 Void rgSCHSc1DlSched
(
RgSchCellCb *cell,
RgSchCmnDlRbAllocInfo *allocInfo
)
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 3033); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlSched\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 3197); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlRetxAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while((*node) && (*effAlloc > 0))
   {
      ...
      *node = (*node)->next;
      ...
      if (((((RgSchCmnDlSvc*)(svc->sch))->prio >= 1) && (((RgSchCmnDlSvc*)(svc->sch))->prio <= 2)))
      {
         ...
         (svcSc1->bo <= bytes-rlcHdrEstmt)? (svcSc1->bo = 0): (svcSc1->bo -= bytes-rlcHdrEstmt);
      ...
      else if(((((RgSchCmnDlSvc*)(svc->sch))->prio > 2) && (((RgSchCmnDlSvc*)(svc->sch))->prio <= 8)))
      {
   ...
   while((*node) && (*effAlloc > 0))
   {
      ...
      *node = (*node)->next;
      ...
      else
      {
         ...
         (svcSc1->bo <= bytes-svcSc1->hdrEstimate)? (svcSc1->bo = 0): (svcSc1->bo -= bytes-svcSc1->hdrEstimate);
...

{
   CmLList *node;
   RgSchSc1DlUe *ueDl = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
   RgSchCmnDlUe *cmnUeDl = &(((RgSchCmnUe *)((ue)->sch))->dl);
   ...
   if (remTb1Bytes){
      ...
      rgSCHSc1DlNewTxTbDstn(cell, ue, &cmnUeDl->proc->tbInfo[0], &remTb1Bytes, &node);
   ...
   if (remTb2Bytes){
      ...
      rgSCHSc1DlNewTxTbDstn(cell, ue, &cmnUeDl->proc->tbInfo[1], &remTb2Bytes, &node);
   ...
   if ( remTb2Bytes && ( tb2Bytes == remTb2Bytes) )
   {
      ...
      ue->dl.dlAllocCb.tbInfo[1].schdlngForTb = 0;
      ue->dl.dlAllocCb.tbInfo[1].isDisabled = 1;
   }
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 3638); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlNewTxAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 3730); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlRetxNewTxAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while(node)
   {
      ...
      rgSCHSc1DlSprTxTbDstn(cell, ue, newTxTbInfo, &remTbBytes, &(sc1DlUe->lcsWithData.first));
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 3822); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   RgSchSc1DlSvc *sc1DlSvc = ((RgSchSc1DlSvc *)((RgSchCmnDlSvc *)((svc)->sch))->schSpfc);
   RgSchSc1DlUe *sc1DlUe = ((RgSchSc1DlUe *)((RgSchCmnUe *)((ue)->sch))->dl.schSpfc);
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 3920); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlAdd2UeLcsWithData\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 3989); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1DlRmFrmUeLcsWithData\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

   cmLListDelFrm(&(sc1DlUe->lcsWithData), &sc1DlSvc->lcWithDataLnk);
   sc1DlSvc->lcWithDataLnk.node = 0L;
   return;
}
# 4024 "../..//ltemac/rg_sch_sc1.c"
 Void rgSCHSc1UlInit
(
...

{
   ...
   if(rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(((RgSchCmnUe *)((ue)->sch))->ul.schSpfc), (sizeof(RgSchSc1UlUe))) != 0)

   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 4101); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...

{
   ...
   RgSchSc1UlUe *ueUl = ((RgSchSc1UlUe *)((RgSchCmnUe *)((ue)->sch))->ul.schSpfc);
...

{
   ...
   if((rgSCHUtlAllocSBuf(cell->instIdx,
      (Data**)&(((RgSchCmnCell*)((cell)->sc.sch))->ul.schSpfc), (sizeof(RgSchSc1UlCell))) != 0))

   {
      { if ((&rgSchCb[cell->instIdx].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[cell->instIdx].rgSchInit)->ent, (&rgSchCb[cell->instIdx].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 4285); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); sprintf (rgSchCb[cell->instIdx].rgSchInit.prntBuf, "Memory allocation FAILED"); SPrint((&rgSchCb[cell->instIdx].rgSchInit)->prntBuf); } };
...
# 4406 "../..//ltemac/rg_sch_sc1.c"
{
   ;;
   return(0);
}
# 4434 "../..//ltemac/rg_sch_sc1.c"
...
# 4450 "../..//ltemac/rg_sch_sc1.c"
{
   ;;
   return(0);
}
# 4470 "../..//ltemac/rg_sch_sc1.c"
 Void rgSCHSc1LcgDel
(
RgSchCellCb *cell,
RgSchUeCb *ue,
...

{
   ...
   RgSchSc1UlUe *ulUe = ((RgSchSc1UlUe *)((RgSchCmnUe *)((ue)->sch))->ul.schSpfc);

   ;;

   if(ulUe->srRcvd == 1)
   {
      cmnUlUe->alloc.reqBytes = ((1) >= (cmnUlUe->effBsr) ? (1) : (cmnUlUe->effBsr));
...

{
   ...
   while ((node) && (*remUe))
   {
      ue = (RgSchUeCb *)node->node;
      node = node->next;
# 4639 "../..//ltemac/rg_sch_sc1.c"
      if (((&(ue)->ul.hqEnt.hqProcCb[ ((RgSchCmnCell *)(ue->cell->sc.sch))->ul.schdHqProcIdx])->alloc))
      {


         continue;
      }
# 4654 "../..//ltemac/rg_sch_sc1.c"
      rgSCHSc1UlSchdUe(ue);
...

{
   ...
   {
      ue = (RgSchUeCb *)node->node;
      cmnUlUe = &(((RgSchCmnUe *)((ue)->sch))->ul);
      node = node->next;
# 4720 "../..//ltemac/rg_sch_sc1.c"
      if (((&(ue)->ul.hqEnt.hqProcCb[ ((RgSchCmnCell *)(ue->cell->sc.sch))->ul.schdHqProcIdx])->alloc))
      {
...
{
   RgSchCmnUlUe *cmnUeUl = &(((RgSchCmnUe *)((ue)->sch))->ul);
   RgSchSc1UlUe *ueUl = ((RgSchSc1UlUe *)((RgSchCmnUe *)((ue)->sch))->ul.schSpfc);
   RgSchUeCb *lUe;
   ...
   while(node)
   {
      ...
      lcmnUeUl = &(((RgSchCmnUe *)((lUe)->sch))->ul);
...

{
   ...
   if ((cmnUlUe->effBsr > 0) || (ueUl->srRcvd == 1))
   {
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 5273); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1UlDatTransAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   while(node)
   {
      ue = (RgSchUeCb *)node->node;
      node = node->next;
      ueUl = ((RgSchSc1UlUe *)((RgSchCmnUe *)((ue)->sch))->ul.schSpfc);
# 5305 "../..//ltemac/rg_sch_sc1.c"
      ueUl->srRcvd = 0;
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 5371); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1UlContResAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   ;;
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch_sc1.c", 5439); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgSCHSc1UlAllocFnlz\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   while (node)
   {
      ue = (RgSchUeCb *)node->node;
      node = node->next;
      ulUe = ((RgSchSc1UlUe *)((RgSchCmnUe *)((ue)->sch))->ul.schSpfc);
      if(ulUe->txLnk.node)
      {
