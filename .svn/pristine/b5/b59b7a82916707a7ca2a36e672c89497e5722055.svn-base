...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//ltemac/rg_com.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//ltemac/rg_com.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 131 "../..//ltemac/rg_com.c" 2


static S16 rgCOMHndlCfgReq (CrgCfg *cfg, RgErrInfo *errInfo);
static S16 rgCOMHndlRecfgReq (CrgRecfg *recfg, RgErrInfo *errInfo);
static S16 rgCOMHndlDelReq (CrgDel *del, RgErrInfo *errInfo);
static S16 rgCOMHndlResetReq (CrgRst *reset,RgErrInfo *errInfo);
# 169 "../..//ltemac/rg_com.c"
 S16 rgCOMCfgReq
(
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 186); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Processing CRG Config request: action %d\n", crgCfgReq->action); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   switch (crgCfgReq->action)
   {
      ...
      default:
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 216); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Invalid configuration action %d\n", crgCfgReq->action); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 229); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG Configuration request processed\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(ret);
}
# 257 "../..//ltemac/rg_com.c"
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 274); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Processing CRG Configuration request: configType %d\n", cfg->cfgType); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   switch (cfg->cfgType)
   {
      case 1:
      {
         ret = rgCFGVldtCrgCellCfg(&cfg->u.cellCfg,errInfo);
            if (ret != 0)
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 287); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell configuration validation FAILED: Cell %d\n", cfg->u.cellCfg.cellId); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      case 2:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 299); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue configuration validation FAILED: Ue %d\n", cfg->u.ueCfg.crnti); SPrint((&rgCb.rgInit)->prntBuf); } };
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 311); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "LC configuration validation FAILED: Lc %d\n", cfg->u.lchCfg.lcId); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 326); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG configuration processed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(ret);
}
# 356 "../..//ltemac/rg_com.c"
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 374); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Processing CRG Reconfiguration request:            reconfigType %d\n", recfg->recfgType); SPrint((&rgCb.rgInit)->prntBuf); } };
   ...
   switch (recfg->recfgType)
   {
      case 1:
      {
         ret = rgCFGVldtCrgCellRecfg(&recfg->u.cellRecfg, &cell, errInfo);
            if (ret != 0)
            {
               { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 386); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Cell Recfg Validation FAILED\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
               return(1);
            }
      ...
      case 2:
      {
         ...
         if ( ret != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 397); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Ue Recfg Validation FAILED\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            return(1);
         }
      ...
      case 3:
      {
         ...
         if (ret != 0)
         {
            { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 409); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Lc Recfg Validation FAILED\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
            return(1);
         }
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 426); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG reconfiguration processed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(ret);
}
# 452 "../..//ltemac/rg_com.c"
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 468); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Processing CRG UE Reset request:\n"); SPrint((&rgCb.rgInit)->prntBuf); } };

   errInfo->errType = (((((((((0 + 11) + 1) + 1) + 1) + 3) + 1) + 6) + 1) + 3);


   ret = rgCFGVldtCrgUeReset(reset, &cell, &ue, errInfo);
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 476); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "UE Reset Validation FAILED\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }
   ret = rgCFGCrgUeReset(cell, ue, reset, errInfo);
   if (ret != 0)
   {
      { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 482); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "UE Reset FAILED\n"); SPrint((&rgCb.rgInit)->prntBuf); } };
      return(1);
   }

   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 486); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG UE Reset processed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(ret);
}
# 512 "../..//ltemac/rg_com.c"
...

{
   ...
   ;;
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 528); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "Processing CRG Delete request: delType %d\n", del->delType); SPrint((&rgCb.rgInit)->prntBuf); } };
...
# 551 "../..//ltemac/rg_com.c"
   ...
   { if ((&rgCb.rgInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgCb.rgInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC", (&rgCb.rgInit)->ent, (&rgCb.rgInit)->inst, "../..//ltemac/rg_com.c", 576); SPrint((&rgCb.rgInit)->prntBuf); sprintf (rgCb.rgInit.prntBuf, "CRG deletion processed \n"); SPrint((&rgCb.rgInit)->prntBuf); } };
   return(ret);
}
