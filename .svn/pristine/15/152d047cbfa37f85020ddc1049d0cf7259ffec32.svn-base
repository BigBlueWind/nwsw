...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 115 "../..//ltemac/rg_sch.c" 2
# 1 "../..//cm/cm5.x" 1
# 116 "../..//ltemac/rg_sch.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 172); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nRgMiLrgSchCfgReq(): pst->srcEnt=%d, pst->srcInst=%d", pst->srcEnt, pst->srcInst); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if(pst->dstInst < 1)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 179); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nRgMiLrgSchCfgReq(): Invalid inst ID"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(0);
   }
...
# 194 "../..//ltemac/rg_sch.c"
   ...
   switch(cfg->hdr.elmId.elmnt)
   {
      case 1 + 5:
         ...
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 208); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nRgMiLrgSchCfgReq(): Scheduler instance                    configuration is done with reason=%d.", reason); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };

         break;
      default:
         ret = 1;
         reason = 5;
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 213); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nRgMiLrgSchCfgReq(): Invalid Elmnt=%d", cfg->hdr.elmId.elmnt); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
         break;
   }
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 273); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nRgMiLrgSchCntrlReq():cntrlReq for elmnt= %d,action=%d,subaction=%d", cntrl->hdr.elmId.elmnt, cntrl->t.cntrl.action, cntrl->t.cntrl.subAction); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 287 "../..//ltemac/rg_sch.c"
   ...
   if(rgSchCb[inst].rgSchInit.cfgDone != 1)
   {
      ...
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 306); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nRgMiLrgSchCntrlReq(): Gen Cfg not done."); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   switch(cntrl->hdr.elmId.elmnt)
   {
      ...
      default:
         ...
         cfm.cfm.reason = 13;
         RgMiLrgSchCntrlCfm(&cfmPst, &cfm);
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 327); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nRgMiLrgSchCntrlReq(): invalid elmnt=%d", cntrl->hdr.elmId.elmnt); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   S16 ret = 0;
   Pst tmpPst;
   Inst instId = pst->dstInst-1;
   RgUstaDgn dgn;

   ;

   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 502); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"RgUiRgrBndReq: suId = %d; spId = %d\n", suId, spId); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
   ...
   tmpPst.srcInst = rgSchCb[instId].rgSchInit.inst + 1;
   tmpPst.event = 0x00;
   ...
   if(spId < rgSchCb[instId].numSaps)
   {
      ...
      switch (rgSchCb[instId].rgrSap[spId].sapSta.sapState)
      {
         ...
         case 1:
            { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 525); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"SAP Not yet bound\n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
            ...
            break;
         case 2:
            { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 536); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"SAP Is already Bound\n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
            ret = rgSCHUtlRgrBndCfm(instId, suId, 1);
            break;
         default:
...

{
   ...
   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 598); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"RgUiRgrUbndReq: spId = %d; reason = %d \n", spId, reason); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
   ...
   if (spId < rgSchCb[instId].numSaps)
   {
      switch(rgSchCb[instId].rgrSap[spId].sapSta.sapState)
      {
         case 2:
            ...
            { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 607); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"SAP Is already Bound\n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 679); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"RgUiRgrCfgReq(): spId = %d; transId = %s;", spId, prntTrans); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };


   if (cfgReqInfo == 0L)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 683); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"Input Message Buffer is NULL\n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
   ...
   if (spId < rgSchCb[instId].numSaps)
   {
      ...
      {
         case 2:
            { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 693); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"SAP Is already Bound\n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
            break;
         default:
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 726); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"RgUiRgrCfgReq:Configuration Request Handling Failed \n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 783); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"RgUiRgrSiCfgReq(): " "spId = %d; transId = %s;", spId, prntTrans); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };


   if (cfgReqInfo == 0L)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 788); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"Input Message Buffer " "is NULL\n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
   ...
   if (ret != 0)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 828); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"RgUiRgrSiCfgReq:" "Configuration Request Handling Failed \n"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 874); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "rgMacSchDedBoUpdtReq():" " boRpt->cellId = %u; boRpt->rnti = %u," " boRpt->lcId = %u\n",boRpt->cellId, boRpt->rnti, boRpt->lcId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...
# 909 "../..//ltemac/rg_sch.c"
   ...
   { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 917); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "\nrgMacSchDedBoUpdtReq(): Invalid UE(%d) or Lc Id(%d)", boRpt->rnti, boRpt->lcId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      SLogError(rgSchCb[inst].rgSchInit.ent, rgSchCb[inst].rgSchInit.inst, rgSchCb[inst].rgSchInit.procId, (Txt *) "../..//ltemac/rg_sch.c", (S32) 963, (ErrCls) (0x2), (ErrCode) (((0 + 0) + 10)), (ErrVal) ((ErrVal)boRpt->cellId), (Txt *) "RgMacSchCmnBoUpdtReq(): Invalid cell Id");
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 0))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 971); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf, "RgMacSchCmnBoUpdtReq():                  BO update for CCCH\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   while((0L != tmp) && ((RgInfUeDatInd *)tmp->node != 0L))
   {
      ...
      rnti = datInd->rnti;
# 1052 "../..//ltemac/rg_sch.c"
      if (datInd->ceInfo.bitMask & (1<<1))
      {
         if (datInd->ceInfo.bitMask & (1<<0))
         {
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1058); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"\nrgSCHTomDatInd() Received MSG3 with CRNTI and also CCCH (%d)\n", datInd->ceInfo.ces.cRnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
 ...
 {
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1071); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"\nrgSCHTomDatInd() Received MSG3 with CRNTI, unable to find ueCb for rnti(%d)\n", datInd->ceInfo.ces.cRnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
               ...
               rnti, datInd, &err)) != 0)
         {
            ...
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1083); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"\nrgSCHTomDatInd() Processing for MSG3 failed for rnti(%d)\n", datInd->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      else if (datInd->ceInfo.bitMask & (1<<0))
      {
               ...
               rnti, datInd, &err)) != 0)
         {
            ...
            cmFreeMem(subfrmInfo);
            err.errType = ((((0 + 1) + 4) + 1) + 4);
            { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1100); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"\nrgSCHTomDatInd() Processing for MSG3 failed for rnti(%d)\n", datInd->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if (ue == 0L)
      {
         ...
         if (ue == 0L)
         {
...

            {
               ...
               cmFreeMem(subfrmInfo);
               err.errType = ((((0 + 1) + 4) + 1) + 4);
               { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1121); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomDatInd() Unable to get the UE CB for RNTI (%d) \n", datInd->rnti); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      ...
      if ((ret = rgSCHUtlUpdSch (subfrmInfo, cell, ue, datInd, &err)) != 0)
      {
         ...
         cmFreeMem(subfrmInfo);
         err.errType = ((((0 + 1) + 4) + 1) + 4);
         { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1136); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"rgSCHTomDatInd() Unable to handle Data" " Indication\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
...

{
   ...
   { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 2))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1365); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"RgLiTfuSchBndCfm SuId(%d), Status(%d)\n", suId, status); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };


   if(suId >= rgSchCb[instId].numSaps)
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1369); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"Incorrect SuId"); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
      return(1);
   }
   ...
   {
      { if ((&rgSchCb[instId].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[instId].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[instId].rgSchInit)->ent, (&rgSchCb[instId].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1378); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); sprintf (rgSchCb[instId].rgSchInit.prntBuf,"Incorrect SuId. Configured (%d)            Recieved (%d)\n", tfuSap->sapCfg.suId, suId); SPrint((&rgSchCb[instId].rgSchInit)->prntBuf); } };
...

{
   ...
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1424); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuRaReqInd() SAP Validation failed SuId(%d).\n", suId); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if(raReqInd == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1433); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"Invalid input pointer for raReqInd:RgLiTfuRaReqInd Failed"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }

   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1439); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuRaReqInd()No cell exists\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1489); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuUlCqiInd() SAP Validation failed.\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1497); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuUlCqiInd()No cell exists\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1544); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuPucchDeltaPwrInd() SAP Validation failed.\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1552); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuPucchDeltaPwrInd()No cell exists\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1723); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuDlCqiInd() SAP Validation failed.\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 1731); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuDlCqiInd()No cell exists\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   if ((ret = rgSCHUtlValidateTfuSap (inst, suId)) != 0)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 2016); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuTimingAdvInd() SAP Validation failed.\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
   ...
   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 2024); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuTimingAdvInd()No cell exists\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
...

{
   ...
   ;;
# 2084 "../..//ltemac/rg_sch.c"
   if (rgSchCb[inst].tfuSap[suId].cell == 0L)
   {
      { if ((&rgSchCb[inst].rgSchInit)->dbgMask & ((0x00000100 << 1))) { sprintf((&rgSchCb[inst].rgSchInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "MAC Scheduler", (&rgSchCb[inst].rgSchInit)->ent, (&rgSchCb[inst].rgSchInit)->inst, "../..//ltemac/rg_sch.c", 2086); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); sprintf (rgSchCb[inst].rgSchInit.prntBuf,"RgLiTfuTtiInd()No cell exists\n"); SPrint((&rgSchCb[inst].rgSchInit)->prntBuf); } };
      return(1);
   }
