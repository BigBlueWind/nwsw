...
# 100 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 101 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/hit.h" 1
# 91 "../..//cm/hit.h"
#define __HITH__ 
# 110 "../..//cm/hit.h"
...
# 115 "../..//egtpu/eg_cpm.c" 2




# 1 "../..//cm/gen.x" 1
# 120 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/ssi.x" 1
# 121 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//mt/ss_diag.h" 1
# 90 "../..//mt/ss_diag.h"
...
# 122 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm5.x" 1
# 123 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 124 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm_llist.x" 1
# 91 "../..//cm/cm_llist.x"
#define __CMLLISTX__ 
...
# 126 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 127 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm_tpt.x" 1
# 95 "../..//cm/cm_tpt.x"
#define __CMTPTX__ 
...
# 128 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm_mblk.x" 1
# 129 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 130 "../..//egtpu/eg_cpm.c" 2
# 1 "../..//cm/hit.x" 1
# 91 "../..//cm/hit.x"
#define __HITX__ 
# 102 "../..//cm/hit.x"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",329); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 342 "../..//egtpu/eg_cpm.c"
   egTptDeInit();
# 352 "../..//egtpu/eg_cpm.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",352); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
}
# 1135 "../..//egtpu/eg_cpm.c"
 Void egUCpmProcEguDatReq
(
EgtUEvnt *egtUEvnt,
EgUSapCb *usap,
Pst *pst
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1148); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };



   egTunProcEguDatReq(egtUEvnt, usap, pst);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1153); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 1169 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1182); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };



   egTunProcEguStaReq(egtUEvnt, usap);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1187); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 1203 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1215); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };



   egTunProcEguTnlMgmtReq(egtUEvnt, usap);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1220); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 1236 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1247); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }




   if ( (retValue = SGetSBuf(egCb.init.region, egCb.init.pool, (Data **)newEvent, sizeof(EgUEvnt))) != 0)

   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1256); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egUCmCreateEvent: Unable to allocate mem for evntMsg \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1288); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",1989); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
      ...
      case EG_DBG_TSAP:
         {
            ...
            { sprintf (egCb.init.prntBuf, " tSap (%d) state(%d)", tSapCb->suId , tSapCb->state); SPrint(egCb.init.prntBuf); };
      ...
      case EG_DBG_CMTPTADDR:
         {
            ...
            { sprintf (egCb.init.prntBuf, "%s: type(%d) port(%d) address(%s)", name, tptaddr->type, port, addr); SPrint(egCb.init.prntBuf); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2178); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
# 2204 "../..//egtpu/eg_cpm.c"
   for(;;)
   {
      ...
      else
      {
         ...
         if((egCb.egUCb.echoReqCntr) <= egCb.genCfg.nmbRetries )
         {
            ...
            if(ret != 0)
            {
               ...
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2227); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUHndlT3N3TmrExpiry:Failed to retransmit                         echo request for sequence No (%ld)\n",echoReq->seqNo); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         else
         {
            ...
            if(egUUtilCmpTptAddr(&echoReq->srcAddr, &echoReq->destAddr, &port) == 0)
            {
               ...
               { if (echoReq->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2242); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoReq->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoReq->echoReqBuff); echoReq->echoReqBuff = 0L; } };
               { if (echoReq != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2243); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)echoReq, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) echoReq, (Size) sizeof(EgUEchoReqCb)); (echoReq) = 0L; }}
            ...
            else
            {
               ...
               if(ret != 0)
               {
                  { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2266); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUHndlT3N3TmrExpiry:Destination                            IP address not configured"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
               ...
               { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtUStaEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtUStaEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2272); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtUStaEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtUStaEvnt) = 0L; {}; } };
               if (egtUStaEvnt == 0L)
               {
                  { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2276); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egUHndlT3N3TmrExpiry:Failed to Allocate the                            memory for egtUStaEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
               ...
               cmHashListDelete(&(egCb.egUCb.echoReqHashList), (U32)echoReq);
               { if (echoReq->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2292); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoReq->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoReq->echoReqBuff); echoReq->echoReqBuff = 0L; } };
               { if (echoReq != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2293); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)echoReq, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) echoReq, (Size) sizeof(EgUEchoReqCb)); (echoReq) = 0L; }};

               egtUStaEvnt->u.uStaInd.cfmStatus.status = 1;
               egtUStaEvnt->u.uStaInd.cfmStatus.reason = 3;

               { if(egCb.init.logMask & 0x1) { ssDiagFix(0x00120001, EG_DIAG_NA, 0xd3, egCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, egtUStaEvnt->u.uStaInd.dstAddr.u.ipv4TptAddr.address, 0, 0, 0, "EGTP Path Down, IP Address = 0x%x"); } };
   ...
   if( egCb.egUCb.echoReqCntr <= egCb.genCfg.nmbRetries)
   {
      ...
      if (ret != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2322); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUHndlT3N3TmrExpiry: Starting of N3T3 Timer Failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2323); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      } { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2324); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2327); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2373); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
      ...
      for(;;)
      {
         ...
         else
         {
            ...
            if(ret != 0)
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2422); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\negUSendEchoReqOnLclPort: Send failed\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
               continue;
            }
            else
            {
               ...
               { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &echoReqCb, (Size) sizeof(EgUEchoReqCb)) == 0) { cmMemset((U8 *)(*&echoReqCb), 0, sizeof(EgUEchoReqCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2432); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&echoReqCb, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&echoReqCb) = 0L; {}; } };
               if (echoReqCb == 0L)
               {
                  { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2436); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egUSendEchoReqOnLclPort:Failed to Allocate the                            memory for echoReqCb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
               ...
               if (ret != 0)
               {
                  { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2450); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReqOnLclPort:Failed to copy the mBuf to echoReqCb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
               ...
               if (ret != 0)
               {
                  { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2468); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReqOnLclPort:Failed to                            insert the echoReqCb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

                  { if (echoEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2469); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoEvnt->mBuf); echoEvnt->mBuf = 0L; } };
                  { if (echoReqCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2470); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)echoReqCb, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) echoReqCb, (Size) sizeof(EgUEchoReqCb)); (echoReqCb) = 0L; }};
                  continue;
               }
            }
         }
   ...
   { if (echoEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2482); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoEvnt->mBuf); echoEvnt->mBuf = 0L; } };
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2483); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
}
# 2504 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2523); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2542); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egMakeEchoReq:Transport server is not configures                for default port"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2543); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2562); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egMakeEchoReq:Failed to insert private extension IE"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2563); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2565); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
}
# 2586 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2601); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }





   { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &echoReqCb, (Size) sizeof(EgUEchoReqCb)) == 0) { cmMemset((U8 *)(*&echoReqCb), 0, sizeof(EgUEchoReqCb)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2607); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&echoReqCb, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&echoReqCb) = 0L; {}; } };
   if (echoReqCb == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2611); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egInsertEchoReqCb:Failed to Allocate the                         memory for echoReqCb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2629); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egInsertEchoReqCb:Failed to copy the mBuf to echoReqCb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2630); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
   }
   echoReqCb->tptServerCb = echoEvnt->srvCb;
   egCpyCmTptAddr(&(echoReqCb->srcAddr),&(echoEvnt->localAddr));
   egCpyCmTptAddr(&(echoReqCb->destAddr),&(echoEvnt->remAddr));
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2641); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egInsertEchoReqCb:Failed to insert the echoReqCb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (echoReqCb->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2642); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoReqCb->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoReqCb->echoReqBuff); echoReqCb->echoReqBuff = 0L; } };
      { if (echoReqCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2643); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)echoReqCb, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) echoReqCb, (Size) sizeof(EgUEchoReqCb)); (echoReqCb) = 0L; }};
      return(1);
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2646); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
}
# 2671 "../..//egtpu/eg_cpm.c"
 S16 egUSendEchoReq
(
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2699); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
...
# 2729 "../..//egtpu/eg_cpm.c"
                              ...
                              (U32*)&nextEchoReq))== 0);prevEchoReq=0L, nextEchoReq = 0L)
   {
       ...
       if(egUUtilCmpTptAddr(&nextEchoReq->srcAddr, &nextEchoReq->destAddr, &port) == 0)
       {
          ...
          { if (nextEchoReq->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2741); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)nextEchoReq->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(nextEchoReq->echoReqBuff); nextEchoReq->echoReqBuff = 0L; } };
          cmHashListDelete(&(egCb.egUCb.echoReqHashList), (U32)nextEchoReq);
          { if (nextEchoReq != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2743); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)nextEchoReq, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) nextEchoReq, (Size) sizeof(EgUEchoReqCb)); (nextEchoReq) = 0L; }}
       ...
       else
       {
           ...
           if(ret != 0)
           {
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2766); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUHndlT3N3TmrExpiry:Destination                         IP address not configured"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
               ...
               { if (nextEchoReq->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2778); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)nextEchoReq->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(nextEchoReq->echoReqBuff); nextEchoReq->echoReqBuff = 0L; } };
               cmHashListDelete(&(egCb.egUCb.echoReqHashList), (U32)nextEchoReq);
               { if (nextEchoReq != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2780); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)nextEchoReq, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) nextEchoReq, (Size) sizeof(EgUEchoReqCb)); (nextEchoReq) = 0L; }};
           ...
           ipCb = nextEchoReq->tptServerCb->ipCbPtr;
            ...
            destAddr->destReachable = 0;
            cmHashListDelete(&(egCb.egUCb.echoReqHashList), (U32)nextEchoReq);
            { if (nextEchoReq->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2793); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)nextEchoReq->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(nextEchoReq->echoReqBuff); nextEchoReq->echoReqBuff = 0L; } };
            { if (nextEchoReq != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2794); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)nextEchoReq, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) nextEchoReq, (Size) sizeof(EgUEchoReqCb)); (nextEchoReq) = 0L; }};
   ...
   { (*&echoEvnt) = 0L; { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2824); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 1,(Void*)&echoEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; egUCmCreateEvent(&echoEvnt); };
   ...
   for(sapId=0;sapId < egCb.genCfg.nmbUSaps; sapId++)
   {
      ...
      if(egUSap != 0L && (egUSap->cfg.flag == 1))
      {
         ...
         for(;0 ==(ret = cmHashListGetNext(&(egUSap->ipCbHashList), prevSrcAddr, &nextSrcAddr));)
         {
            ...
            if (ret != 0)
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2863); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n egUSendEchoReq:Memory allocation                        for egMsg failed "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };





               { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2868); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
            }
                        ...
                        case 4:
                           {
                              ...
                              {
                                 { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2907); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReq:egMakeEchoReq failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
                                 continue;
                              }
                           }
                           break;
# 2933 "../..//egtpu/eg_cpm.c"
                        default:
                           {
                              { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2936); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReq:Invalid Destination                                        IP address type"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
                     ...
                     if(!ipCb->encEchoAvail)
                     {
                        ...
                        if(ret != 0)
                        {
                           { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2954); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReq:Encoding failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
                           continue;
                        }
                     ...
                     if(ret != 0)
                     {
                        { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2978); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReq:Send failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
                        continue;
                     }
                     else
                     {
                        ...
                        if (ret != 0)
                        {
                           { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",2992); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReq:Failed to insert the                                     echoReqCb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
            ...
            if(echoEvnt->mBuf == ((void *)0))
            {
               { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3006); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReq:mbuff is NULL since no                         message sent out to respective remote peer"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
            ...
            else
            {
               ...
               if(egCb.genCfg.lclEchoSup == 1)
               {
                  ...
                  egUSendEchoReqOnLclPort(ipCb, echoEvnt, echoReqCb, &echoSeqNo);
               }
               else
               {
                  ...
                  { if (echoEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3028); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoEvnt->mBuf); echoEvnt->mBuf = 0L; } };
               }
   ...
   egCb.egUCb.echoReqCntr++;
   { egUCmFreeEvent((echoEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3047); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 2,(Void*)echoEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (echoEvnt) = 0L; };
   ...
   if(egCb.genCfg.eguT3Timer.enb)
   {
      ...
      if (ret != 0)
      {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3058); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUSendEchoReq:Starting of N3T3 Timer Failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3059); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
   }
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3069); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n  egUSendEchoReq:Starting of Echo Timer Failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3070); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3072); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 3089 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3102); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3119); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 3138 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3150); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
...
# 3179 "../..//egtpu/eg_cpm.c"
   retVal=EgUUtilGmAppendIe(eguEvnt->egMsg, &egUIe);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3180); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3211); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
   ...
   retVal = EgUUtilGmAppendIe(eguEvnt->egMsg, &egUIe);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3230); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3262); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
...
# 3278 "../..//egtpu/eg_cpm.c"
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3282); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n egUCpmBuildSuppHeadNot:Memory                              allocation for egMsg failed "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3286); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3308); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n egUCpmBuildSuppHeadNot:Failed to insert extension header              type list ie"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3309); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3311); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 3335 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3348); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
    ...
    if((eguEvnt->srvCb->ipCbPtr->ipAddrInfo.echoReqPvtExtVal.length))
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3377); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
         break;
    ...
    if((eguEvnt->srvCb->ipCbPtr->ipAddrInfo.echoRspPvtExtVal.length))
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3388); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
         break;
    ...
    if((eguEvnt->srvCb->ipCbPtr->ipAddrInfo.errIndPvtExtVal.length))
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3399); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
         break;
      default:
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3402); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\negUMakeAndAddPrivateExtensionIe:Invalid Message type "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3403); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   ...
   retVal = EgUUtilGmAppendIe(eguEvnt->egMsg, &egUIe);
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3411); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
# 3429 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3441); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3455); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3489); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3514); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Multicast Addredd Destination,               Error Indication should not be sent "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3515); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3529); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n egUCpmBuildErrInd:Memory allocation for                              egMsg failed "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };





      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3534); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
...
# 3564 "../..//egtpu/eg_cpm.c"
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3572); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUCpmBuildErrInd:Failed to insert TEID IE"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3574); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };

   }
   if( 0 != (egUMakeAndAddPeerAddrIe(eguEvnt)))
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3580); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUCpmBuildErrInd:Failed to insert                           GTPU PEER ADDRESS IE"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3582); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };

   }
   if( 0 != (egUMakeAndAddPrivateExtensionIe(eguEvnt)))
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3588); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUCpmBuildErrInd:Failed to insert                           private extension IE"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3590); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3592); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 3613 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3630); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
   ...
   { (*&outeguEvnt) = 0L; { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3651); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 1,(Void*)&outeguEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; egUCmCreateEvent(&outeguEvnt); };
   ...
   if (outeguEvnt == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3658); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n egUProcessEchoReq:Allocation of event failed "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };



      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3662); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
# 3673 "../..//egtpu/eg_cpm.c"
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3692); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n egUProcessEchoReq:Memory                              allocation for egMsg failed "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };





      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3697); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3717); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoReq:Failed to insert recovery IE"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      EgUUtilDeAllocGmMsg(&(outeguEvnt->egMsg));
      { egUCmFreeEvent((outeguEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3719); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 2,(Void*)outeguEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (outeguEvnt) = 0L; };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3721); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };

   }
   if( 0 != (egUMakeAndAddPrivateExtensionIe(outeguEvnt)))
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3726); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoReq:Failed to insert private extension IE"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      EgUUtilDeAllocGmMsg(&(outeguEvnt->egMsg));
      { egUCmFreeEvent((outeguEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3728); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 2,(Void*)outeguEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (outeguEvnt) = 0L; };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3730); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if((EgUUtilGmGetIeOccrCnt(eguEvnt->egMsg,&ieType,&count) == 0))
   {
      if(count >= 1)
      {
    { if (SGetSBuf(eguEvnt->region, eguEvnt->pool, (Data **) &egtUiMsg, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtUiMsg), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3741); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtUiMsg, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { EgUsta _dgn; (*&egtUiMsg) = 0L; { _dgn.dgn.dgnVal[0].type = 2; _dgn.dgn.dgnVal[0].t.mem.region = eguEvnt->region; _dgn.dgn.dgnVal[0].t.mem.pool = eguEvnt->pool; egSendLmAlarm (4, 13, 15,(EgUstaDgn *)&_dgn.dgn); }; } };

    if (egtUiMsg == 0L)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3746); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egUProcessEchoReq:Failed to Allocate the memory for egtUEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

       EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      EgUUtilDeAllocGmMsg(&(outeguEvnt->egMsg));
      { egUCmFreeEvent((outeguEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3749); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 2,(Void*)outeguEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (outeguEvnt) = 0L; };
       { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3750); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
    }
   ...
   if(ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3778); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoReq:Encoding failed\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      EgUUtilDeAllocGmMsg(&(outeguEvnt->egMsg));
      { egUCmFreeEvent((outeguEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3780); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 2,(Void*)outeguEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (outeguEvnt) = 0L; };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3781); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   if(ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3791); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoReq:Send Failed\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




      { if (outeguEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3796); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)outeguEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(outeguEvnt->mBuf); outeguEvnt->mBuf = 0L; } };

      EgUUtilDeAllocGmMsg(&(outeguEvnt->egMsg));
      { egUCmFreeEvent((outeguEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3799); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 2,(Void*)outeguEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (outeguEvnt) = 0L; };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3800); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   { if (outeguEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3802); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)outeguEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(outeguEvnt->mBuf); outeguEvnt->mBuf = 0L; } };
   ...
   { egUCmFreeEvent((outeguEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3809); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 1, 2,(Void*)outeguEvnt, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (outeguEvnt) = 0L; };
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3810); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 3836 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3858); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
   ...
   if(ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3884); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoResp:Echo response for non                          existing sequence no received"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3886); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   else
   {
      ...
      if(ret != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3903); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoResp:Echo response for non                   configured IP received"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3905); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }

      if(egUUtilCmpTptAddr(&echoReqCb->destAddr, &eguEvnt->remAddr, &port) != 0)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3911); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoResp:Echo response for non                   configured destination Address"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3913); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
      ...
      if(egUUtilCmpTptAddr(&echoReqCb->srcAddr, &echoReqCb->destAddr, &port) == 0)
      {
         ...
         if(ret != 0)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3927); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoResp:Echo response on non                      configured local port received"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3929); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
         }

         EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
         { if (echoReqCb->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3933); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoReqCb->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoReqCb->echoReqBuff); echoReqCb->echoReqBuff = 0L; } };
         srvCb->portStatus = 1;
         ...
         { if (echoReqCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3942); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)echoReqCb, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) echoReqCb, (Size) sizeof(EgUEchoReqCb)); (echoReqCb) = 0L; }};
      }
      else
      {
    ...
    if(ret != 0)
    {
       { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3956); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n egUProcessEchoResp:Echo response for non                            existing destination IP address received"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

       EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
       { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3958); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
    }
    ...
    if (destAddr->destReachable == 0)
    {
       ...
       egSendLmAlarm(2, 1,
         ...
         { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtUStaEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtUStaEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3992); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtUStaEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtUStaEvnt) = 0L; {}; } };
         if (egtUStaEvnt == 0L)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3996); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",3997); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
         }
    ...
    cmHashListDelete(&(egCb.egUCb.echoReqHashList), (U32)echoReqCb);
    { if (echoReqCb->echoReqBuff != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4020); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)echoReqCb->echoReqBuff, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(echoReqCb->echoReqBuff); echoReqCb->echoReqBuff = 0L; } };
    { if (echoReqCb != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4021); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)echoReqCb, (U32)sizeof(EgUEchoReqCb) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) echoReqCb, (Size) sizeof(EgUEchoReqCb)); (echoReqCb) = 0L; }};
    ...
    if((EgUUtilGmGetIeOccrCnt(eguEvnt->egMsg, &ieType,&count) == 0))
    {
       if(count >= 1)
       {
          { if (SGetSBuf(eguEvnt->region, eguEvnt->pool, (Data **) &egtUiMsg, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtUiMsg), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4031); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtUiMsg, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { EgUsta _dgn; (*&egtUiMsg) = 0L; { _dgn.dgn.dgnVal[0].type = 2; _dgn.dgn.dgnVal[0].t.mem.region = eguEvnt->region; _dgn.dgn.dgnVal[0].t.mem.pool = eguEvnt->pool; egSendLmAlarm (4, 13, 15,(EgUstaDgn *)&_dgn.dgn); }; } };

          if (egtUiMsg == 0L)
          {
             { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4037); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"egUProcessEchoResp:Failed to Allocate the memory                     for egtUEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };


             EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
             { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4039); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
          }
          egtUiMsg->u.egMsg = eguEvnt->egMsg;
          egCpyCmTptAddr(&(egtUiMsg->u.egMsg->srcAddr), &(eguEvnt->localAddr));
          egCpyCmTptAddr(&(egtUiMsg->u.egMsg->remAddr), &(eguEvnt->remAddr));
          ...
          EgUiEgtEguDatInd(&(srvCb->uSapCb->pst), srvCb->uSapCb->suId,
           egtUiMsg);
          { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4053); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
       }
    }
      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      }
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4059); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4090); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4101); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
}
# 4124 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4136); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4146); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Building Supported Header Notification failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4147); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }
   ...
   if(ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4164); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Encoding Supported Header Notification failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4166); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }
   ...
   if(ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4179); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "Building Supported Header Notification failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4180); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }



   { if (eguEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4185); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)eguEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(eguEvnt->mBuf); eguEvnt->mBuf = 0L; } };
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4186); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 4204 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4216); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(ret !=0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4228); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failure in building Error Indication"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };





      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4234); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4244); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Encoding Error Indication failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4251); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }
   ...
   if (ret != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4264); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Encoding Error Indication failed"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      { if (eguEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4265); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)eguEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(eguEvnt->mBuf); eguEvnt->mBuf = 0L; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4266); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }



   { if (eguEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4271); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)eguEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(eguEvnt->mBuf); eguEvnt->mBuf = 0L; } };




   { if (SGetSBuf(eguEvnt->region, eguEvnt->pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4276); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { EgUsta _dgn; (*&egtErrEvnt) = 0L; { _dgn.dgn.dgnVal[0].type = 2; _dgn.dgn.dgnVal[0].t.mem.region = eguEvnt->region; _dgn.dgn.dgnVal[0].t.mem.pool = eguEvnt->pool; egSendLmAlarm (4, 13, 15,(EgUstaDgn *)&_dgn.dgn); }; } };

   if (egtErrEvnt == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4281); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtUEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4287); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }
   ...
   EgUiEgtEguErrInd (&(eguEvnt->srvCb->uSapCb->pst), eguEvnt->srvCb->uSapCb->suId,
         egtErrEvnt);
# 4310 "../..//egtpu/eg_cpm.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4310); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 4329 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4339); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 4352 "../..//egtpu/eg_cpm.c"
   switch(eguEvnt->resultType)
   {
      ...
      case EGT_ERR_MSG_INV_VERSION:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4365); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_MSG_INV_PTTYPE:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4372); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_MSG_UNABLE_TO_COMPLY:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4379); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_MSG_INV_LEN:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4386); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_IE_NOT_ASCD_ORDER:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4393); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_IE_INV_LEN:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4400); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_UNKNOWN_TV:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4407); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_MAN_IE_INV_LEN:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4414); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_MSG_MISS_MAND_IE:
         ...
         { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4427); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
         if (egtErrEvnt == 0L)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4431); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"failed to allocate the memory for egtevnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4432); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
         }
         egtErrEvnt->u.errInd.errCause = EGT_ERR_MSG_MISS_MAND_IE;
         egCpyCmTptAddr(&(egtErrEvnt->u.errInd.dstAddr), &(eguEvnt->remAddr));
         egCpyCmTptAddr(&(egtErrEvnt->u.errInd.srcAddr), &(eguEvnt->localAddr));
    ...
    egCb.genSts.numErrInd++;
         EgUiEgtEguErrInd (&(eguEvnt->srvCb->uSapCb->pst), eguEvnt->srvCb->uSapCb->suId,
               egtErrEvnt);
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4443); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_WRONG_EXT_HDR:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4450); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_MSG_INV_TYPE:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4457); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_INV_TEID:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4464); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_NO_SEQ:
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4471); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      case EGT_ERR_UNSUPP_EXT_HDR:
...

         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4487); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
         }
      default:
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4491); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Invalid Error Type(%d)\n", eguEvnt->resultType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

         break;
   }
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4494); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 4518 "../..//egtpu/eg_cpm.c"
static S16 egUCpmProcLiMsg
(
EgUEvnt *eguEvnt,
Pst *pst
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4533); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(eguEvnt->errInd)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4550); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
# 4566 "../..//egtpu/eg_cpm.c"
   ...
   if (ret != 0)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4572); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Message decoding failed: message Type(%d)\n", eguEvnt->msgType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      EgUUtilDeAllocGmMsg(&(eguEvnt->egMsg));

      egUCpmHdlDecErr(eguEvnt);
# 4588 "../..//egtpu/eg_cpm.c"
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4588); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
         ...
         (eguEvnt->msgType == EGT_GTPU_MSG_ECHO_RSP))
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4600); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
   ...
   { if (SGetSBuf(eguEvnt->region, eguEvnt->pool, (Data **) &egtUiMsg, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtUiMsg), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4607); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtUiMsg, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { EgUsta _dgn; (*&egtUiMsg) = 0L; { _dgn.dgn.dgnVal[0].type = 2; _dgn.dgn.dgnVal[0].t.mem.region = eguEvnt->region; _dgn.dgn.dgnVal[0].t.mem.pool = eguEvnt->pool; egSendLmAlarm (4, 13, 15,(EgUstaDgn *)&_dgn.dgn); }; } };

   if (egtUiMsg == 0L)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4612); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtUEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4619); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
   egtUiMsg->u.egMsg = eguEvnt->egMsg;
   egCpyCmTptAddr(&(egtUiMsg->u.egMsg->srcAddr), &(eguEvnt->localAddr));
   egCpyCmTptAddr(&(egtUiMsg->u.egMsg->remAddr), &(eguEvnt->remAddr));
   ...
   if(eguEvnt->msgType == EGT_GTPU_MSG_GPDU)
   {
      if((eguEvnt->teIdCb->reOrdering == 1) && (eguEvnt->egMsg->msgHdr.seqNumber.pres == 1))
      {
               ...
               || (eguEvnt->teIdCb->seqInfo->reOrder == 1))
         {
            ...
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4655); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
         }
         eguEvnt->teIdCb->seqInfo->expSeqNmb = (++eguEvnt->teIdCb->seqInfo->expSeqNmb % 65536);
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4699); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
}
# 4717 "../..//egtpu/eg_cpm.c"
static Void egUCpmProcUiMsg
(
EgUEvnt *eguEvnt,
Pst *pst
)
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4732); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if (ret != 0)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4750); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Encoding Failure"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (SGetSBuf(eguEvnt->region, eguEvnt->pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4753); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { EgUsta _dgn; (*&egtErrEvnt) = 0L; { _dgn.dgn.dgnVal[0].type = 2; _dgn.dgn.dgnVal[0].t.mem.region = eguEvnt->region; _dgn.dgn.dgnVal[0].t.mem.pool = eguEvnt->pool; egSendLmAlarm (4, 13, 15,(EgUstaDgn *)&_dgn.dgn); }; } };


      if (egtErrEvnt == 0L)
      {
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4758); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Failed to Allocate the memory for egtEvnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4764); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
      }
...
# 4789 "../..//egtpu/eg_cpm.c"
      switch(eguEvnt->resultType)
      {
         ...
         default:
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4858); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"Invalid Error Type(%d)\n", eguEvnt->resultType); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4873); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4886); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 4906 "../..//egtpu/eg_cpm.c"
 Void egUCpmProcMsg
(
...
{
# 4940 "../..//egtpu/eg_cpm.c"
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4940); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4957); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return; };
}
# 4973 "../..//egtpu/eg_cpm.c"
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",4986); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   { keyAddr.type = evnt->remAddr.type; if(evnt->remAddr.type == 4) { keyAddr.u.ipv4TptAddr.address = evnt->remAddr.u.ipv4TptAddr.address; } };
   ...
   cmHashListFind(&(evnt->srvCb->ipCbPtr->destAddrCbLst),
         (U8*)(&keyAddr),
         sizeof(CmTptAddr), 0, (U32 *)&(dstAddrCb));
   ...
   if(dstAddrCb == 0L)
   {
      ...
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5011); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n Destination IP not configured "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };




      { if (evnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5016); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)evnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(evnt->mBuf); evnt->mBuf = 0L; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5017); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
   ...
   {
# 5040 "../..//egtpu/eg_cpm.c"
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5040); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n TEID not configured (%ld)",evnt->teid); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
      ...
      { if (evnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5053); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)evnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(evnt->mBuf); evnt->mBuf = 0L; } };
      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5054); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5064); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 5154 "../..//egtpu/eg_cpm.c"
 S16 egUCpmHdlTeid
(
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5166); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
   ...
   if(retVal != 0)
   {
      { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5178); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Unable to retreive Teid Cb"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5179); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
   }
   ...
   if(eguEvnt->teIdCb != 0L)
   {
      ...
      {
# 5194 "../..//egtpu/eg_cpm.c"
         { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5195); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"\n End Marker received for this TEID (%ld)", eguEvnt->teid); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
         ...
         { if (SGetSBuf(egCb.init.region, egCb.init.pool, (Data **) &egtErrEvnt, (Size) sizeof(EgtUEvnt)) == 0) { cmMemset((U8 *)(*&egtErrEvnt), 0, sizeof(EgtUEvnt)); { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5201); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 1,(Void*)&egtErrEvnt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; } else { (*&egtErrEvnt) = 0L; {}; } };
         if (egtErrEvnt == 0L)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5205); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf,"failed to allocate the memory for egtevnt"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            { if (eguEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5206); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)eguEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(eguEvnt->mBuf); eguEvnt->mBuf = 0L; } };
            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5207); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
         }
    ...
    egCb.genSts.numErrInd++;
         ...
         { if (eguEvnt->mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5217); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)eguEvnt->mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(eguEvnt->mBuf); eguEvnt->mBuf = 0L; } };
         { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5218); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
      }
# 5239 "../..//egtpu/eg_cpm.c"
   eguEvnt->teIdCb->totalMsgsRx++;
   }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5242); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
# 5265 "../..//egtpu/eg_cpm.c"
 S16 egUCpmHdlEvt
(
...
# 5285 "../..//egtpu/eg_cpm.c"
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5287); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 5609 "../..//egtpu/eg_cpm.c"
   if(eguEvnt->eventType == 0)
   {
            ...
            (eguEvnt->msgType == EGT_GTPU_MSG_END_MARKER))
      {
         ...
         if(ret != 0)
         {
            { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5623); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n Cannot proceed with Teid processing "); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

            { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5624); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
         }
      }
   }
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",5632); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(ret); };
}
# 6118 "../..//egtpu/eg_cpm.c"
...

{
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6140); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
         ...
         ((drift = rcvdSeqNmb + 65536 - expSeqNmb) >= egCb.genCfg.pduWindSize))))
  {
    ...
    { if (egtuEvt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6162); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtuEvt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtuEvt, (Size) sizeof(EgtUEvnt)); (egtuEvt) = 0L; }};
    return(1);
  }
  ...
  if(teidCb->reordAlgo == 1)
  {
    ...
    if ((teidCb->seqInfo->pduArray[idx]) != 0L)
    {
      ...
      EgUUtilDeAllocGmMsg(&(egtuEvt->u.egMsg));
      { if (egtuEvt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6184); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtuEvt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtuEvt, (Size) sizeof(EgtUEvnt)); (egtuEvt) = 0L; }};
      return(1);
    }
...
# 6262 "../..//egtpu/eg_cpm.c"
  ...
  else
  {
    ...
    if ((teidCb->seqInfo->pduArray[drift]) != 0L)
    {
      ...
      EgUUtilDeAllocGmMsg(&(egtuEvt->u.egMsg));
      { if (egtuEvt != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6290); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)egtuEvt, (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) egtuEvt, (Size) sizeof(EgtUEvnt)); (egtuEvt) = 0L; }};
      return(1);
    }
...

{
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6386); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
  ...
  {
    { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6394); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, " egFlushAllPackets: TEID is NULL \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };

    return(0);
  }
  if(teidCb->seqInfo->reOrder == 0 )
  {
    { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6400); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "egFlushAllPackets:Nothing to flush from Reordering buffer\n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
  ...
  while(teidCb->seqInfo->pduArray[tmpCnt] == 0L)
  {
    idx++;
    if(teidCb->reordAlgo == 1)
    {
  ...
  if(teidCb->seqInfo->pduArray[tmpCnt] != 0L && idx < pduWindSize)
  {
  ...
  for(idx = idx+1; idx <= drift; idx++)
  {
    ...
    if(teidCb->seqInfo->pduArray[tmpCnt] != 0L)
    {
      ...
      { if (teidCb->seqInfo->pduArray[tmpCnt] != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6488); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb->seqInfo->pduArray[tmpCnt], (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb->seqInfo->pduArray[tmpCnt], (Size) sizeof(EgtUEvnt)); (teidCb->seqInfo->pduArray[tmpCnt]) = 0L; }};
      teidCb->seqInfo->pduArray[tmpCnt] = (EgtUEvnt *)0L;
    }
  }
...

{
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6543); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
  ...
  if((teidCb == 0L) || (teidCb->seqInfo == 0L))
  {
    { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6551); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, " egFlushTillHole: TEID is NULL \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
  ...
  while(teidCb->seqInfo->pduArray[tmpCnt] != 0L && idx < pduWindSize)
  {
    ...
    { if (teidCb->seqInfo->pduArray[tmpCnt] != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6584); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb->seqInfo->pduArray[tmpCnt], (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb->seqInfo->pduArray[tmpCnt], (Size) sizeof(EgtUEvnt)); (teidCb->seqInfo->pduArray[tmpCnt]) = 0L; }};
    teidCb->seqInfo->pduArray[tmpCnt] = (EgtUEvnt *)0L;
...

{
  ...
  { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6666); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
  ...
  if((teidCb == 0L) || (teidCb->seqInfo == 0L))
  {
    { if (egCb.init.dbgMask & ((0x00000100 << 6))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6674); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [" "\"ERROR\"" " : " "0" "]" ); SPrint(egCb.init.prntBuf); }; egCmPrntDbg(0,(Void*) 0, (S8 *)"0"); { sprintf (egCb.init.prntBuf, ":"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, " egFlushReordRcvdGtpuPdus: TEID is NULL \n"); SPrint(egCb.init.prntBuf); }; { sprintf (egCb.init.prntBuf, "\n"); SPrint(egCb.init.prntBuf); }; } };
  ...
  for(idx = idx+1; idx <= drift; idx++)
  {
    ...
    if(teidCb->seqInfo->pduArray[tmpCnt] != 0L)
    {
      ...
      { if (teidCb->seqInfo->pduArray[tmpCnt] != 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6758); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 3, 2,(Void*)teidCb->seqInfo->pduArray[tmpCnt], (U32)sizeof(EgtUEvnt) ); SPrint(egCb.init.prntBuf); }; } }; (Void) SPutSBuf(egCb.init.region, egCb.init.pool, (Data *) teidCb->seqInfo->pduArray[tmpCnt], (Size) sizeof(EgtUEvnt)); (teidCb->seqInfo->pduArray[tmpCnt]) = 0L; }};
      teidCb->seqInfo->pduArray[tmpCnt] = (EgtUEvnt *)0L;
    }
  }
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",6914); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }
...
{
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",7016); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; }

   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_cpm.c",7018); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(0); };
}
