...
# 412 "../..//s1ap/sz_mi.c"
   { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 413); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzMiLszCfgReq (pst, elmId (%d))\n", cfg->hdr.elmId.elmnt); SPrint((&szCb.init)->prntBuf); } };
...
# 547 "../..//s1ap/sz_mi.c"
   { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 548); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzMiLszCntrlReq (pst, elmId (%d))\n", cntrl->hdr.elmId.elmnt); SPrint((&szCb.init)->prntBuf); } };
# 569 "../..//s1ap/sz_mi.c"
...
# 682 "../..//s1ap/sz_mi.c"
   { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 684); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzMiLszStsReq (pst, action(%d), elmId (%d)) \n", action, sts->hdr.elmId.elmnt); SPrint((&szCb.init)->prntBuf); } };
# 705 "../..//s1ap/sz_mi.c"
...
# 822 "../..//s1ap/sz_mi.c"
   { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 823); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzMiLszStaReq (pst, elmId (%d)) \n", sta->hdr.elmId.elmnt); SPrint((&szCb.init)->prntBuf); } };
# 842 "../..//s1ap/sz_mi.c"
...

{
   ...
   {
      case 1:
         { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 1148); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szSendLmCfm: sent SzMiLszCfgCfm (cfmType: %d) \n", type); SPrint((&szCb.init)->prntBuf); } };
      ...
      case 2:
         { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 1155); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szSendLmCfm: sent SzMiLszCntrlCfm (cfmType: %d) \n", type); SPrint((&szCb.init)->prntBuf); } };
      ...
      case 3:
         { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 1162); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szSendLmCfm: sent SzMiLszStsCfm (cfmType: %d) \n", type); SPrint((&szCb.init)->prntBuf); } };
      ...
      case 4:
         { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 1169); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szSendLmCfm: sent SzMiLszStaCfm (cfmType: %d) \n", type); SPrint((&szCb.init)->prntBuf); } };
...

{
  ...
  { if(szCb.init.logMask & 0x1) { ssDiagFix(0x00a30001, SZ_DIAG_NA, 0xd1, szCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, 1, 0, 0, 0, "In the prot configuration %d"); } };
...

{
   ...
   if (szCb.shutdown)
   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 2395); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szShutdown: Layer already SHUT DOWN) \n"); SPrint((&szCb.init)->prntBuf); } };
   ...
   SDeregCfgTmr(szCb.init.ent,szCb.init.inst,(S16)szCb.genCfg.timeRes,10,(PFS16)szActvTmr);
...

{
       ...
       sctSapCb->state == 3)
   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 2951); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szEnaSctSap: SAP is already bound / waiting for bind confirm \n"); SPrint((&szCb.init)->prntBuf); } };
...

{
       ...
       sctSapCb->state == 1)
   {
     ...
     { if ((&szCb.init)->dbgMask & (0x00000002)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_mi.c", 3010); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szUbndSctSap: SAP already unbound \n"); SPrint((&szCb.init)->prntBuf); } };
