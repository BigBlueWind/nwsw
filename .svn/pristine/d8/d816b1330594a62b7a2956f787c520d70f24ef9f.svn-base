...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000100)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ndb.c", 202); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szNdbAllocConCb\n"); SPrint((&szCb.init)->prntBuf); } };
   ...
   *conCb = (SzConCb *)0L;
   ...
   if (locConCb == 0L)
   {
      ...
      { SzUstaDgn _dgn; SLogError(szCb.init.ent, szCb.init.inst, szCb.init.procId, "../..//s1ap/sz_ndb.c", 211, 0x2, (0 + 107), (ErrVal)0, "szNdbAllocConCb"": Unable to allocate resources"); _dgn.type = 2; _dgn.u.mem.region = peer->sztSapCb->pst.region; _dgn.u.mem.pool = peer->sztSapCb->pst.pool; szSendLmAlarm (4, 13, 15, &_dgn); return(1); };
   }
   ...
   szUtilsAllocConId(&locConCb->lclConRefNo);
      ...
      if (ret != 0)
      {
         ...
         szCb.genSts.nmbFailConn++;
         { SzUstaDgn _dgn; SLogError(szCb.init.ent, szCb.init.inst, szCb.init.procId, "../..//s1ap/sz_ndb.c", 234, 0x2, (0 + 108), (ErrVal)0, "szNdbAllocConCb"": Unable to allocate resources"); _dgn.type = 2; _dgn.u.mem.region = peer->sztSapCb->pst.region; _dgn.u.mem.pool = peer->sztSapCb->pst.pool; szSendLmAlarm (4, 13, 15, &_dgn); return(1); };
      }
      ...
      if (ret != 0)
      {
         ...
         { if (locConCb != 0L) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)locConCb, sizeof(SzConCb)); szCb.genSta.memAlloc -= (sizeof(SzConCb)); locConCb = 0L; } };
         szCb.genSts.nmbFailConn++;
         { SzUstaDgn _dgn; SLogError(szCb.init.ent, szCb.init.inst, szCb.init.procId, "../..//s1ap/sz_ndb.c", 245, 0x2, (0 + 109), (ErrVal)0, "szNdbAllocConCb"": Unable to allocate resources"); _dgn.type = 2; _dgn.u.mem.region = peer->sztSapCb->pst.region; _dgn.u.mem.pool = peer->sztSapCb->pst.pool; szSendLmAlarm (4, 13, 15, &_dgn); return(1); };
      }
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000100)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ndb.c", 304); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szNdbGetConCb(conId = %ld)\n", conId); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000100)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ndb.c", 355); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szNdbDeallocConCb(conRef=%ld)\n", conRef); SPrint((&szCb.init)->prntBuf); } };
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000100)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ndb.c", 485); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szCmGetStream(peerId=%ld)\n", peerCb->peerId); SPrint((&szCb.init)->prntBuf); } };
   ...
   *strmId = ((peerCb->nextStreamId) % peerCb->assocCb->assocCfg->locOutStrms);
   ...
   { if ((&szCb.init)->dbgMask & (0x00000100)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ndb.c", 500); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "szCmGetStream(*strmId = %d)\n", *strmId); SPrint((&szCb.init)->prntBuf); } };



   peerCb->nextStreamId = ((*strmId + 1) % peerCb->assocCb->assocCfg->locOutStrms);
