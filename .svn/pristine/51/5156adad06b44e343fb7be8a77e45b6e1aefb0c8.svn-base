...
CCveFLAGS=-DVE_RELAY -DEU_DAT_APP -DEGTP_U -DNX -DPX -DUZ -DEU -DKW_PDCP -DKW -UPTNXLIPJU -UPTVELIRGR -DDEBUGP -UTFU_TDD -DTFU_VER_2 -DLCEGUIEGT -DLCVELICTF -DLCVELINHU -DLCPJUIPJU -DLCVELIRGR -ULTE_TDD -DTA_NEW -DSI_NEW -DRGR_SI_SCH -UVE_SM_LOG_TO_FILE
endif
endif
endif
...
$(OUT_DIR)/ve_emm.$(OBJ): $(IN_DIR)/ve_emm.c $(ALL_INC)
	$(CC) -c -I$(SS_DIR)  $(COPTS) $(IOPTS) $(POPTS) $(CCveFLAGS) -DLCSMYSMILYS -DLCYSMILYS -DLCLYS $(IN_DIR)/ve_emm.c -o \
	$(OUT_DIR)/ve_emm.$(OBJ)
