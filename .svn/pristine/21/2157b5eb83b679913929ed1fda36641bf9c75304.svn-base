...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 98 "../..//lterrc/nh_lmm.c" 2
# 1 "../..//cm/cm5.h" 1
# 99 "../..//lterrc/nh_lmm.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 118 "../..//lterrc/nh_lmm.c" 2
# 1 "../..//cm/cm5.x" 1
# 119 "../..//lterrc/nh_lmm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 281); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhMiLnhCfgReq(elementId (%d))\n", cfg->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };

  { if(nhCb.init.logMask & 0x1) { ssDiagFix(0x00500001, NH_DIAG_NA, 0xd9, nhCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, cfg->hdr.elmId.elmnt, 0, 0, 0, "Received CfgReq from SM element = %d"); } };
   ...
   if ((cfg) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 289); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL cfg\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }
...

{
   ...
   ;;
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 359); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhMiLnhCntrlReq ( elementId (%d))\n", cntrl->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };


  { if(nhCb.init.logMask & 0x1) { ssDiagFix(0x00500002, NH_DIAG_NA, 0xd9, nhCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, cntrl->hdr.elmId.elmnt, 0, 0, 0, "Received CntrlReq from SM element = %d"); } };
   ...
   if ((cntrl) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 367); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL cntrl\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }


   { (ret) = 0; if (nhCb.init.cfgDone != 1) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 372); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: General Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = 8; } if(((ret) == 0) && (nhCb.eNodeBCb.cfgDone != 1)) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 372); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: Protocol Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = (256); } };
...
# 437 "../..//lterrc/nh_lmm.c"
      default:
      {
         ...
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 442); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid Element in control request %d\n", cntrl->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 526); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhMiLnhStsReq(action(%d), elmnt(%d)) \n", action, sts->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };



  { if(nhCb.init.logMask & 0x1) { ssDiagFix(0x00500003, NH_DIAG_NA, 0xd9, nhCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, action, sts->hdr.elmId.elmnt, 0, 0, "Received StsReq from SM action = %d, element = %d"); } };
   ...
   if ((sts) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 536); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL sts\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }


   { (ret) = 0; if (nhCb.init.cfgDone != 1) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 541); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: General Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = 8; } if(((ret) == 0) && (nhCb.eNodeBCb.cfgDone != 1)) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 541); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: Protocol Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = (256); } };
   ...
   switch (sts->hdr.elmId.elmnt)
   {
      ...
      case 10:
         ...
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 566); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CELL Does not exist. Element = %d \n", sts->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
         ...
         if(((ueCb = nhDBMGetUeCb(cellCb,
                                  sts->u.sts.u.ueSts.crnti))) ==
                                                       (NhActvUeCb *)0L)
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 579); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE Does not exist. Element = %d \n", sts->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      case 11:
         ...
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 594); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CELL Does not exist. Element = %d \n", sts->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 608); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid element. Element = %d \n", sts->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 706); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "NhMiLnhStaReq(pst, elmnt(%d))\n", sta->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };


  { if(nhCb.init.logMask & 0x1) { ssDiagFix(0x00500004, NH_DIAG_NA, 0xd9, nhCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, 0xffffffff, sta->hdr.elmId.elmnt, 0, 0, 0, "Received StaReq from SM element = %d"); } };
   ...
   if ((sta) == 0L)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 716); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "GOT NULL sta\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      return(1);
   }


   { (ret) = 0; if (nhCb.init.cfgDone != 1) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 721); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: General Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = 8; } if(((ret) == 0) && (nhCb.eNodeBCb.cfgDone != 1)) { { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 721); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "_fn: Protocol Configuration not done"); SPrint((&nhCb.init)->prntBuf); } }; }; (ret) = (256); } };
   ...
   switch (sta->hdr.elmId.elmnt)
   {
      ...
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 781); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid Element. Element = %d \n", sta->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 834); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Configuration Received. ElmId(%d)\n", cfg->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 842); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "General configuration not done.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   switch (cfg->hdr.elmId.elmnt)
   {
      ...
      default:
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 888); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid element. Element = %d \n", cfg->hdr.elmId.elmnt); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 943); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhValidateGenCfg: timer enabled but wait is 0 \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 990); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "General Configuration Received\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 997); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "General configuration Invalid Parameters.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (0L == nhCb.uSapCb)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1030); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for uSap.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1038); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for Lower Sap.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if ((ret = SRegCfgTmr(nhCb.init.ent,nhCb.init.inst,(S16)nhCb.genCfg.msecTmrRes,10,(PFS16)nhActvTmr))!= 0)

   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1074); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Timer Registration Failed\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1126); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for KWU sap(s).\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   else
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1137); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "KWU Sap(s) Initialized\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1147); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for CKW sap(s).\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   else
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1157); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CKW SAP(s) Initialized\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1167); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for CRG sap(s).\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   else
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1177); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CRG SAP(s) Initialized\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1187); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for PJU sap(s).\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   else
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1197); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PJU SAP(s) Initialized\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1207); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for CPJ sap(s).\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   else
   {
      ...
      { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1217); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CPJ SAP(s) Initialized\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      *numLSaps += gen->nmbCpjSaps;
   }
# 1243 "../..//lterrc/nh_lmm.c"
   return(0);
}
# 1261 "../..//lterrc/nh_lmm.c"
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1311); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Protocol Configuration Received\n"); SPrint((&nhCb.init)->prntBuf); } }; };


   ret = nhValidateProtCfg(prot);
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1317); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Protocol Configuration Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1417); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Upper SAP Configuration Received\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1426); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "USap configuration Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 1)) { Txt prntBuf[10]; sprintf(prntBuf, "[debug]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 1))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1487); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "nhValidateLSapCfg: In nhValidateLSapCfg\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1510); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, " nhValidateLSapCfg: timer enabled but wait is 0\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1550); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Lower SAP Configuration Received\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1561); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LSAP configuration Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   switch(elmntId)
   {
      ...
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1590); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid SAP ElmId.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         status->status = 1;
         return(1);
   }
   ...
   else
   {
      ...
      if (0L == lSapCb)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 4)) { Txt prntBuf[10]; sprintf(prntBuf, "[fatal]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 4))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1614); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Memory Allocation Failed for lower SAP.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
      ...
      switch(elmntId)
      {
         ...
         default:
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1642); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid SAP ElmId.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
            status->status = 1;
            return(1);
      }
   }
   ...
   switch (cntrl->action)
   {
      case 1:
      {
         switch (cntrl->subAction)
         {
            ...
            case 5:
               nhCb.init.dbgMask = cntrl->u.dbg.dbgMsk;
            ...
            case 3:
               ...
               break;
            case 6:
               nhCb.init.logMask = cntrl->u.logMask;
               break;
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 1869); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "USap Control Request Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2111); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LSap Control Request Failed for KWU.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2165); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LSap Control Request Failed for CKW.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2218); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LSap Control Request Failed Failed for CRG.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2271); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LSap Control Request Failed for PJU.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2324); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LSap Control Request Failed for CPJ.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2467); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid Action for statistics.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2522); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "UE statistics validation Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2580); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "CELL statistics validation Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   switch (elmntId)
   {
      ...
      default:
         {
            { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2705); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid SAP ElmId.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2716); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "LSAP Status Request validation Failed.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (ret != 0)
   {
      { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2801); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "USap Status Request validation Failed \n"); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   switch (type)
   {
      ...
      case 4:
         ...
         break;
      default:
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 2890); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Invalid msgType.\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         break;
   }
   return(0);
}
# 2910 "../..//lterrc/nh_lmm.c"
 Void nhSendLmAlarm
(
U16 category,
U16 event,
...

{
   ...
   SDeregCfgTmr(nhCb.init.ent,nhCb.init.inst,(S16)nhCb.genCfg.msecTmrRes,10,(PFS16)nhActvTmr);
...

{
   ...
   if (nhCb.uSapCb != 0L)
   {
      { if ((nhCb.uSapCb) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3065, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.uSapCb), (Size)(sizeof(NhUSapCb))); (nhCb.uSapCb) = 0L; } };
   ...
   for(i = 0; i < nhCb.genCfg.nmbKwuSaps; i++)
   {
      ...
      if (lSapCb != 0L)
      {
        { if ((lSapCb) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3076, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(lSapCb), (Size)(sizeof(NhLSapCb ))); (lSapCb) = 0L; } };
   ...
   {
      { if ((nhCb.kwuSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3083, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.kwuSapCbLst), (Size)(sizeof(NhLSapCb *) * nhCb.genCfg.nmbKwuSaps)); (nhCb.kwuSapCbLst) = 0L; } };
   ...
   for(i = 0; i < nhCb.genCfg.nmbCkwSaps; i++)
   {
      ...
      if (lSapCb != 0L)
      {
        { if ((lSapCb) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3093, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(lSapCb), (Size)(sizeof(NhLSapCb ))); (lSapCb) = 0L; } };
   ...
   {
      { if ((nhCb.ckwSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3100, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.ckwSapCbLst), (Size)(sizeof(NhLSapCb *) * nhCb.genCfg.nmbCkwSaps)); (nhCb.ckwSapCbLst) = 0L; } };
   ...
   for(i = 0; i < nhCb.genCfg.nmbCrgSaps; i++)
   {
      ...
      if (lSapCb != 0L)
      {
        { if ((lSapCb) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3110, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(lSapCb), (Size)(sizeof(NhLSapCb ))); (lSapCb) = 0L; } };
   ...
   {
      { if ((nhCb.crgSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3117, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.crgSapCbLst), (Size)(sizeof(NhLSapCb *) * nhCb.genCfg.nmbCrgSaps)); (nhCb.crgSapCbLst) = 0L; } };
   ...
   for(i = 0; i < nhCb.genCfg.nmbCpjSaps; i++)
   {
      ...
      if (lSapCb != 0L)
      {
        { if ((lSapCb) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3127, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(lSapCb), (Size)(sizeof(NhLSapCb ))); (lSapCb) = 0L; } };
   ...
   {
      { if ((nhCb.cpjSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3134, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.cpjSapCbLst), (Size)(sizeof(NhLSapCb *) * nhCb.genCfg.nmbCpjSaps)); (nhCb.cpjSapCbLst) = 0L; } };
   ...
   for(i = 0; i < nhCb.genCfg.nmbPjuSaps; i++)
   {
      ...
      if (lSapCb != 0L)
      {
        { if ((lSapCb) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3144, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(lSapCb), (Size)(sizeof(NhLSapCb ))); (lSapCb) = 0L; } };
   ...
   {
      { if ((nhCb.pjuSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3151, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.pjuSapCbLst), (Size)(sizeof(NhLSapCb *) * nhCb.genCfg.nmbPjuSaps)); (nhCb.pjuSapCbLst) = 0L; } };

   }
# 3173 "../..//lterrc/nh_lmm.c"
   return(0);
}
# 3193 "../..//lterrc/nh_lmm.c"
...

{
   ...
   while(0L != tmpNode)
   {
      if (0L == tmpNode->node)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 3212); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NULL logChCb\n"); SPrint((&nhCb.init)->prntBuf); } }; };
         return(1);
      }
      ...
      if (cbRetVal != 0)
      {
         { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_lmm.c", 3221); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "Deleting CELL Control Block Failed "); SPrint((&nhCb.init)->prntBuf); } }; };
...

{
   ...
   if (nhCb.uSapCb != 0L)
   {
      { if ((nhCb.uSapCb) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3264, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.uSapCb), (Size)(sizeof(NhUSapCb))); (nhCb.uSapCb) = 0L; } };

      nhCb.uSapCb = 0L;
   }
   if (nhCb.kwuSapCbLst != 0L)
   {
      { if ((nhCb.kwuSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3270, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.kwuSapCbLst), (Size)(sizeof(NhLSapCb *) * gen->nmbKwuSaps)); (nhCb.kwuSapCbLst) = 0L; } };

   }
   if (nhCb.ckwSapCbLst != 0L)
   {
      { if ((nhCb.ckwSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3275, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.ckwSapCbLst), (Size)(sizeof(NhLSapCb *) * gen->nmbCkwSaps)); (nhCb.ckwSapCbLst) = 0L; } };

   }
   if (nhCb.crgSapCbLst != 0L)
   {
      { if ((nhCb.crgSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3280, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.crgSapCbLst), (Size)(sizeof(NhLSapCb *) * gen->nmbCrgSaps)); (nhCb.crgSapCbLst) = 0L; } };

   }
   if (nhCb.pjuSapCbLst != 0L)
   {
      { if ((nhCb.pjuSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3285, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.pjuSapCbLst), (Size)(sizeof(NhLSapCb *) * gen->nmbPjuSaps)); (nhCb.pjuSapCbLst) = 0L; } };

   }
   if (nhCb.cpjSapCbLst != 0L)
   {
      { if ((nhCb.cpjSapCbLst) == 0L) { SLogError(nhCb.init.ent, nhCb.init.inst, nhCb.init.procId, "../..//lterrc/nh_lmm.c", 3290, 0x2, 0, (ErrVal) 0, "Can't free the memory: GOT NULL PTR\n"); } else { (Void) SPutSBuf((nhCb.init.region), (nhCb.init.pool), (Data *)(nhCb.cpjSapCbLst), (Size)((sizeof(NhLSapCb *) * gen->nmbCpjSaps))); (nhCb.cpjSapCbLst) = 0L; } };

   }
# 3301 "../..//lterrc/nh_lmm.c"
   if ((status->reason != 7) &&
       (status->reason != 13))
   {
      status->status = 1;
