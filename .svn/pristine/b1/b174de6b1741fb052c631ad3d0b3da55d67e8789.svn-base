/* $Id: globals.h,v 1.6 2011/06/23 19:17:18 nedosis Exp $
 * --------------------------------------------------------------------------
 *
 *           //=====   //===== ===//=== //===//  //       //   //===//
 *          //        //         //    //    // //       //   //    //
...
#define Current_error_log_ ERROR_WARNING    /* Defines the level up to which the errors are printed.
...
#define event_log(x,y)        if (Current_event_log_ >= x) uart_printf("\r\n%s\r\n", y)
#define event_logi(x,y,z)	  if (Current_event_log_ >= x) { char t[1000];  sprintf(t, y, z);  uart_printf("\r\n %s \r\n", t);} 
#define event_logii(x,y,z,i)	  if (Current_event_log_ >= x){ char t[1000];  sprintf(t, (y), (z), (i));  uart_printf("\r\n %s \r\n", t);}
#define event_logiii(x,y,z,i,j)	  if (Current_event_log_ >= x) { char t[1000];  sprintf(t, (y), (z), (i), (j));  uart_printf("\r\n %s \r\n", t);}
#define event_logiiii(x,y,z,i,j,k)	  if (Current_event_log_ >= x) { char t[1000];  sprintf(t, (y), (z), (i), (j), (k));  uart_printf("\r\n %s \r\n", t);}
#define event_logiiiii(x,y,z,i,j,k,l)	  if (Current_event_log_ >= x) { char t[1000];  sprintf(t, (y), (z), (i), (j), (k), (l));  uart_printf("\r\n %s \r\n", t);}
#define event_logiiiiiiii(x,y,z,i,j,k,l,m,n,o)	  if (Current_event_log_ >= x) event_log1((x), __FILE__, (y), (z), (i), (j),(k),(l),(m),(n),(o))


#define error_log(x,y)        if (Current_error_log_ >= x) uart_printf("\r\n%s\r\n", y)
#define error_logi(x,y,z)        if (Current_error_log_ >= x) { char t[1000];  sprintf(t, y, z);  uart_printf("\r\n %s \r\n", t);}
#define error_logii(x,y,z,i)        if (Current_error_log_ >= x) { char t[1000];  sprintf(t, (y), (z), (i));  uart_printf("\r\n %s \r\n", t);}
#define error_logiii(x,y,z,i,j)        if (Current_error_log_ >= x) { char t[1000];  sprintf(t, (y), (z), (i), (j));  uart_printf("\r\n %s \r\n", t);}
#define error_logiiii(x,y,z,i,j,k)        if (Current_error_log_ >= x) { char t[1000];  sprintf(t, (y), (z), (i), (j), (k));  uart_printf("\r\n %s \r\n", t);} 
#define error_log_sys(x,y)    uart_printf("%SYS:s[%i]: %s", __FILE__, (x), (y))
...
#define sock2ip(X)   (((sockaddr_in *)(X))->sin_addr.s_addr)
#ifdef HAVE_IPV6
