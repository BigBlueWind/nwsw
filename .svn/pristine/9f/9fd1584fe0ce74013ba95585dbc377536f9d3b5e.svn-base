...
/**********************************************************************
     ...
     File:     ve_sm_sz_exms.c

     Sid:      ve_sm_sz_exms.c@@/main/2 - Wed Dec  1 08:44:38 2010
...
#endif
{
   ...
   switch(pst->event)
   {
      ...
      default:
         ...
         ret = RFAILED;
#ifdef DEBUGP
       VEDBGP(DBGMASK_SM, (smCb.init.prntBuf, "smSzActvTsk : Received\
invalid event %d\n", pst->event));
#endif
         break;
   }
...
/********************************************************************30**
         ...
         End of file:     ve_sm_sz_exms.c@@/main/2 - Wed Dec  1 08:44:38 2010
