...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 118 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//cm/cm5.h" 1
# 119 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//cm/cm_llist.h" 1
# 90 "../..//cm/cm_llist.h"
#define __CMLLISTH__ 
...
# 125 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 126 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//cm/sct.h" 1
# 91 "../..//cm/sct.h"
#define __SCTH__ 
# 145 "../..//cm/sct.h"
...
# 128 "../..//s1ap/sz_ptli.c" 2
# 137 "../..//s1ap/sz_ptli.c"
# 1 "../..//cm/lsz.h" 1
# 90 "../..//cm/lsz.h"
#define __LSZH__ 
# 109 "../..//cm/lsz.h"
#define EVTLSZCFGREQ 1
#define EVTLSZCFGCFM 2
#define EVTLSZCNTRLREQ 3
#define EVTLSZCNTRLCFM 4
#define EVTLSZSTAREQ 5
#define EVTLSZSTACFM 6
#define EVTLSZSTSREQ 7
#define EVTLSZSTSCFM 8
#define EVTLSZSTAIND 9
#define EVTLSZTRCIND 10
...
#define LSZ_NODE_MME 1
#define LSZ_NODE_ENB 2
#define LSZ_NODE_GW 3





#define LSZ_SAP_CFG 1
#define LSZ_SAP_ISBOUND 2
#define LSZ_SAP_BINDING 3
#define LSZ_SAP_UBND 4
...
#define LSZ_SEL_LC 0
#define LSZ_SEL_LWLC 1

#define LSZ_SEL_TC_UZ 2
#define LSZ_SEL_TC_SB 1

#define LSZ_SEL_TC_SM 1
...
#define LSZ_MAX_TRC_LEN 256

#define LSZ_TRC_PNODE 1
#define LSZ_TRC_LSAP_IN 2
#define LSZ_TRC_LSAP_OUT 4
#define LSZ_TRC_PNODE_IN 8
#define LSZ_TRC_PNODE_OUT 16




#define LSZ_USTA_DGNVAL_NONE 1
#define LSZ_USTA_DGNVAL_MEM 2
#define LSZ_USTA_DGNVAL_SAPID 3
#define LSZ_USTA_DGNVAL_DATA 4
#define LSZ_USTA_DGNVAL_PEER 5
#define LSZ_USTA_DGNVAL_CONID 6
#define LSZ_USTA_MAX_DGNVAL 256
...
#define LSZ_ZEROSTS 0
#define LSZ_NOZEROSTS 1

#define LSZ_MAX_PLMN_SIZE 3
#define LSZ_MME_GROUP 2
#define LSZ_MME_CODE 1
#define LSZ_MAX_NUM_OF_PEERS 16000

#define LSZ_PART_NUM_STR_LEN 32
...
#define ERRLSZ 0
#define ELSZ042 ERRLSZ


#define ELSZ001 (ERRLSZ + 1)
#define ELSZ002 (ERRLSZ + 2)
#define ELSZ003 (ERRLSZ + 3)
#define ELSZ004 (ERRLSZ + 4)
#define ELSZ005 (ERRLSZ + 5)
#define ELSZ006 (ERRLSZ + 6)
#define ELSZ007 (ERRLSZ + 7)
#define ELSZ008 (ERRLSZ + 8)
#define ELSZ009 (ERRLSZ + 9)
#define ELSZ010 (ERRLSZ + 10)
#define ELSZ011 (ERRLSZ + 11)
#define ELSZ012 (ERRLSZ + 12)
#define ELSZ013 (ERRLSZ + 13)
#define ELSZ014 (ERRLSZ + 14)
#define ELSZ015 (ERRLSZ + 15)
#define ELSZ016 (ERRLSZ + 16)
#define ELSZ017 (ERRLSZ + 17)
#define ELSZ018 (ERRLSZ + 18)
#define ELSZ019 (ERRLSZ + 19)
#define ELSZ020 (ERRLSZ + 20)
#define ELSZ021 (ERRLSZ + 21)
#define ELSZ022 (ERRLSZ + 22)
#define ELSZ023 (ERRLSZ + 23)
#define ELSZ024 (ERRLSZ + 24)
#define ELSZ025 (ERRLSZ + 25)
#define ELSZ026 (ERRLSZ + 26)
#define ELSZ027 (ERRLSZ + 27)
#define ELSZ028 (ERRLSZ + 28)
#define ELSZ029 (ERRLSZ + 29)
#define ELSZ030 (ERRLSZ + 30)
#define ELSZ031 (ERRLSZ + 31)
#define ELSZ032 (ERRLSZ + 32)
#define ELSZ033 (ERRLSZ + 33)
#define ELSZ034 (ERRLSZ + 34)
#define ELSZ035 (ERRLSZ + 35)
#define ELSZ036 (ERRLSZ + 36)
#define ELSZ037 (ERRLSZ + 37)
#define ELSZ038 (ERRLSZ + 38)
#define ELSZ039 (ERRLSZ + 39)
#define ELSZ040 (ERRLSZ + 40)
#define ELSZ041 (ERRLSZ + 41)
# 138 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//s1ap/sz.h" 1
# 88 "../..//s1ap/sz.h"
#define __SZH__ 
...
# 129 "../..//s1ap/sz.h"
#define SZ_INFO_SUCONNID 1
#define SZ_INFO_SPCONNID 2
#define SZ_INFO_TRANSID 3
#define SZ_INFO_NONE 4
...
#define SZDBGP(_msgClass,_arg) DBGP(&szCb.init, szCb.nodeDbg, _msgClass, _arg)
# 212 "../..//s1ap/sz.h"
...
#define SZ_MAX_PROTOCOL_ERRS_HANDLD 6
...
#define SZ_GET_PEER_FRM_PEERID(_id,peer) if( _id >= szCb.genCfg.nmbPeer) { peer = NULLP; } else { peer = (szCb.peerLst[(_id )]->peer); }
# 247 "../..//s1ap/sz.h"
#define SZ_ALLOC(_datPtr,_size) { SGetSBuf(szCb.init.region, szCb.init.pool, (Data**)&_datPtr, _size); if (_datPtr != NULLP) { cmMemset((U8*)_datPtr, 0, _size); szCb.genSta.memAlloc += SBUFSIZE(_size); } else { SzUstaDgn _dgn; _datPtr = NULLP; _dgn.type = LSZ_USTA_DGNVAL_MEM; _dgn.u.mem.region = szCb.init.region; _dgn.u.mem.pool = szCb.init.pool; szSendLmAlarm (LCM_CATEGORY_RESOURCE, LCM_EVENT_SMEM_ALLOC_FAIL, LCM_CAUSE_MEM_ALLOC_FAIL, &_dgn); szCb.genSts.nmbFailConn++; } }
# 272 "../..//s1ap/sz.h"
#define SZ_FREE(_datPtr,_size) { if (_datPtr != NULLP) { (Void)SPutSBuf(szCb.init.region, szCb.init.pool, (Data*)_datPtr, _size); szCb.genSta.memAlloc -= SBUFSIZE(_size); _datPtr = NULLP; } }
# 287 "../..//s1ap/sz.h"
#define SZ_FREE_STA(_datPtr,_size,_region,_pool) { if(_datPtr != NULLP) { (Void)SPutSBuf(_region, _pool, (Data*)_datPtr, _size); } }
# 296 "../..//s1ap/sz.h"
#define SZ_FREE_SDU(_sdu) { if (_sdu != NULLP) { cmFreeMem ((Ptr)(_sdu)); _sdu = NULLP; } }
# 305 "../..//s1ap/sz.h"
#define SZ_FREE_BUF(_buf) { if (_buf != NULLP) { SPutMsg (_buf); _buf = NULLP; } }
# 314 "../..//s1ap/sz.h"
#define SZ_SEND_LCL_ERR_IND(_iType,_iVal,_sap,_cType,_cVal) { SztLclErrInd _errInd; cmMemset ((U8 *)&_errInd, 0, sizeof (SztLclErrInd)); _errInd.causeType = (U8) _cType; _errInd.causeValue = (U8)_cVal; _errInd.transId.pres = _iType; _errInd.transId.val = _iVal; SzUiSztErrInd (&_sap->pst, _sap->suId, &_errInd); }
# 328 "../..//s1ap/sz.h"
#define SZ_INITTIMER(_tmr) cmInitTimers((_tmr), 1)


#define SZ_SND_LM_ALARM(_errCode,_fn,_region,_pool) { SzUstaDgn _dgn; SZLOGERROR(ERRCLS_INT_PAR, _errCode, (ErrVal)0, _fn": Unable to allocate resources"); _dgn.type = LSZ_USTA_DGNVAL_MEM; _dgn.u.mem.region = _region; _dgn.u.mem.pool = _pool; szSendLmAlarm (LCM_CATEGORY_RESOURCE, LCM_EVENT_DMEM_ALLOC_FAIL, LCM_CAUSE_MEM_ALLOC_FAIL, &_dgn); RETVALUE (RFAILED); }
# 346 "../..//s1ap/sz.h"
#define SZ_SEND_SAPID_ALARM(_sapId,_evnt,_cause) { SzUstaDgn dgn; cmMemset((U8*)&dgn, 0, sizeof(SzUstaDgn)); dgn.type = LSZ_USTA_DGNVAL_SAPID; dgn.u.sapId = _sapId; szSendLmAlarm(LCM_CATEGORY_INTERFACE, _evnt, _cause, &dgn); }
# 356 "../..//s1ap/sz.h"
#define SZ_SEND_PEER_ALARM(_peerId,_evnt,_cause) { SzUstaDgn dgn; cmMemset((U8*)&dgn, 0, sizeof(SzUstaDgn)); dgn.type = LSZ_USTA_DGNVAL_PEER; dgn.u.peerId.pres = TRUE; dgn.u.peerId.val = _peerId; szSendLmAlarm(LCM_CATEGORY_PROTOCOL, _evnt, _cause, &dgn); }
# 368 "../..//s1ap/sz.h"
#define SZ_STS_INC_DATA_TX_SCT(_peer,_evntPdu,_conCb) { U8 _msgIdx; SzPduSts *_p; Cntr *_ptr; szUtilsGetMsgIdx(&_msgIdx, _evntPdu); if(_msgIdx < SZ_MAX_MSG_ID) { _p = &_peer->peerSts.cfm.pdu; _ptr = (Cntr *)(((SzCntr *)_p) + _msgIdx); *_ptr = (*_ptr) + 1; _p = &_peer->sctSapCb->sts.cfm.pdu; _ptr = (Cntr *)(((SzCntr *)_p) + _msgIdx); *_ptr = (*_ptr) + 1; } if (_conCb != NULLP) { _peer->peerSts.cfm.szDedProcSts.tx++; _peer->sctSapCb->sts.cfm.szDedProcSts.tx++; } else { _peer->peerSts.cfm.szComProcSts.tx++; _peer->sctSapCb->sts.cfm.szComProcSts.tx++; } }
# 400 "../..//s1ap/sz.h"
#define SZ_STS_INC_DATA_RX_SZT(_peer,_evntPdu,_conCb) { if (_conCb != NULLP) { _peer->peerSts.cfm.szDedProcSts.rx++; _peer->sctSapCb->sts.cfm.szDedProcSts.rx++; } else { _peer->peerSts.cfm.szComProcSts.rx++; _peer->sctSapCb->sts.cfm.szComProcSts.rx++; } }
# 416 "../..//s1ap/sz.h"
#define SZ_STS_INC_DATA_RX_PDU(_peer,_msgIdx) { SzPduSts *_p; Cntr *_ptr; if(_msgIdx < SZ_MAX_MSG_ID) { _p = &_peer->peerSts.cfm.pdu; _ptr = (((Cntr *)(((SzCntr *)_p) + _msgIdx)) + 1); *_ptr = (*_ptr) + 1; _p = &_peer->sctSapCb->sts.cfm.pdu; _ptr = (((Cntr *)(((SzCntr *)_p) + _msgIdx)) + 1); *_ptr = (*_ptr) + 1; } }
# 433 "../..//s1ap/sz.h"
#define SZ_ZERO(_pVal,_count) { cmMemset((U8*)_pVal, 0, _count); }
# 442 "../..//s1ap/sz.h"
typedef enum
{
   SZ_DIAG_PEERID,
...
#define SZ_DIAG_LVL0(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(szCb.init.logMask & SS_DIAG_LVL0) { ssDiagFix(_tknId, _splArgEnum, ENTSZ, szCb.init.inst, SS_DIAG_LVL0, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 463 "../..//s1ap/sz.h"
#define SZ_DIAG_LVL1(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(szCb.init.logMask & SS_DIAG_LVL1) { ssDiagFix(_tknId, _splArgEnum, ENTSZ, szCb.init.inst, SS_DIAG_LVL1, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 474 "../..//s1ap/sz.h"
#define SZ_DIAG_LVL2(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(szCb.init.logMask & SS_DIAG_LVL2) { ssDiagFix(_tknId, _splArgEnum, ENTSZ, szCb.init.inst, SS_DIAG_LVL2, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 485 "../..//s1ap/sz.h"
#define SZ_DIAG_LVL3(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(szCb.init.logMask & SS_DIAG_LVL3) { ssDiagFix(_tknId, _splArgEnum, ENTSZ, szCb.init.inst, SS_DIAG_LVL3, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 496 "../..//s1ap/sz.h"
#define SZ_DIAG_LVL4(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(szCb.init.logMask & SS_DIAG_LVL4) { ssDiagFix(_tknId, _splArgEnum, ENTSZ, szCb.init.inst, SS_DIAG_LVL4, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 507 "../..//s1ap/sz.h"
#define SZ_DIAG_MSG(_mBuf,_str) { if(szCb.init.logMask & SS_DIAG_MSG) { Buffer *_newBuf; SAddMsgRef(_mBuf, szCb.init.region, szCb.init.pool, &_newBuf); ssDiagFix(0, SZ_DIAG_NA, ENTSZ, szCb.init.inst, SS_DIAG_MSG, SS_DIAG_MSG_TYPE_HEXDUMP, _newBuf, 0, 0, 0,0, _str); } }
# 520 "../..//s1ap/sz.h"
#define SZ_DIAG_VAR(_tknId,_splArgEnum,_splArg,_string,_stringPtr) { if(szCb.init.logMask & SS_DIAG_VAR) { ssDiagFix(_tknId, _splArgEnum, ENTSZ, szCb.init.inst, SS_DIAG_VAR, SS_DIAG_MSG_TYPE_FIXED, _splArg, 0, 0, 0, 0, _string); ssDiagVarible(ENTSZ, szCb.init.inst, SS_DIAG_VAR, SS_DIAG_MSG_TYPE_VAR, _tknId, _splArg, _stringPtr); } }
# 139 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//s1ap/sz_err.h" 1
# 90 "../..//s1ap/sz_err.h"
#define __SZERRH__ 
...
# 128 "../..//s1ap/sz_err.h"
#define SZLOGERROR(errCls,errCode,errVal,errDesc) SLogError(szCb.init.ent, szCb.init.inst, szCb.init.procId, __FILE__, __LINE__, errCls, errCode, errVal, errDesc)
# 137 "../..//s1ap/sz_err.h"
...
#define ESZ001 (ERRSZ + 1)
#define ESZ002 (ERRSZ + 2)
#define ESZ003 (ERRSZ + 3)
#define ESZ004 (ERRSZ + 4)
#define ESZ005 (ERRSZ + 5)
#define ESZ006 (ERRSZ + 6)

#define ESZ007 (ERRSZ + 7)
#define ESZ008 (ERRSZ + 8)
#define ESZ009 (ERRSZ + 9)
#define ESZ010 (ERRSZ + 10)
#define ESZ011 (ERRSZ + 11)
#define ESZ012 (ERRSZ + 12)
#define ESZ013 (ERRSZ + 13)
#define ESZ014 (ERRSZ + 14)
#define ESZ015 (ERRSZ + 15)
#define ESZ016 (ERRSZ + 16)
#define ESZ017 (ERRSZ + 17)
#define ESZ018 (ERRSZ + 18)
#define ESZ019 (ERRSZ + 19)
#define ESZ020 (ERRSZ + 20)
#define ESZ021 (ERRSZ + 21)
#define ESZ022 (ERRSZ + 22)
#define ESZ023 (ERRSZ + 23)
#define ESZ024 (ERRSZ + 24)
#define ESZ025 (ERRSZ + 25)
#define ESZ026 (ERRSZ + 26)
#define ESZ027 (ERRSZ + 27)
#define ESZ028 (ERRSZ + 28)
#define ESZ029 (ERRSZ + 29)
#define ESZ030 (ERRSZ + 30)
#define ESZ031 (ERRSZ + 31)
#define ESZ032 (ERRSZ + 32)
#define ESZ033 (ERRSZ + 33)
#define ESZ034 (ERRSZ + 34)
#define ESZ035 (ERRSZ + 35)
#define ESZ036 (ERRSZ + 36)
#define ESZ037 (ERRSZ + 37)
#define ESZ038 (ERRSZ + 38)
#define ESZ039 (ERRSZ + 39)
#define ESZ040 (ERRSZ + 40)
#define ESZ041 (ERRSZ + 41)
#define ESZ042 (ERRSZ + 42)
#define ESZ043 (ERRSZ + 43)
#define ESZ044 (ERRSZ + 44)
#define ESZ045 (ERRSZ + 45)
#define ESZ046 (ERRSZ + 46)
#define ESZ047 (ERRSZ + 47)
#define ESZ048 (ERRSZ + 48)
#define ESZ049 (ERRSZ + 49)
#define ESZ050 (ERRSZ + 50)
#define ESZ051 (ERRSZ + 51)
#define ESZ052 (ERRSZ + 52)
#define ESZ053 (ERRSZ + 53)
#define ESZ054 (ERRSZ + 54)
#define ESZ055 (ERRSZ + 55)
#define ESZ056 (ERRSZ + 56)
#define ESZ057 (ERRSZ + 57)
#define ESZ058 (ERRSZ + 58)
#define ESZ059 (ERRSZ + 59)
#define ESZ060 (ERRSZ + 60)
#define ESZ061 (ERRSZ + 61)
#define ESZ062 (ERRSZ + 62)
#define ESZ063 (ERRSZ + 63)
#define ESZ064 (ERRSZ + 64)

#define ESZ065 (ERRSZ + 65)
#define ESZ066 (ERRSZ + 66)
#define ESZ067 (ERRSZ + 67)
#define ESZ068 (ERRSZ + 68)
#define ESZ069 (ERRSZ + 69)
#define ESZ070 (ERRSZ + 70)
#define ESZ071 (ERRSZ + 71)
#define ESZ072 (ERRSZ + 72)
#define ESZ073 (ERRSZ + 73)
#define ESZ074 (ERRSZ + 74)

#define ESZ075 (ERRSZ + 75)
#define ESZ076 (ERRSZ + 76)
#define ESZ077 (ERRSZ + 77)
#define ESZ078 (ERRSZ + 78)
#define ESZ079 (ERRSZ + 79)
#define ESZ080 (ERRSZ + 80)
#define ESZ081 (ERRSZ + 81)
#define ESZ082 (ERRSZ + 82)
#define ESZ083 (ERRSZ + 83)
#define ESZ084 (ERRSZ + 84)
#define ESZ085 (ERRSZ + 85)
#define ESZ086 (ERRSZ + 86)
#define ESZ087 (ERRSZ + 87)
#define ESZ088 (ERRSZ + 88)
#define ESZ089 (ERRSZ + 89)
#define ESZ090 (ERRSZ + 90)
#define ESZ091 (ERRSZ + 91)
#define ESZ092 (ERRSZ + 92)
#define ESZ093 (ERRSZ + 93)
#define ESZ094 (ERRSZ + 94)
#define ESZ095 (ERRSZ + 95)
#define ESZ096 (ERRSZ + 96)
#define ESZ097 (ERRSZ + 97)
#define ESZ098 (ERRSZ + 98)
#define ESZ099 (ERRSZ + 99)
#define ESZ100 (ERRSZ + 100)
#define ESZ101 (ERRSZ + 101)
#define ESZ102 (ERRSZ + 102)
#define ESZ103 (ERRSZ + 103)
#define ESZ104 (ERRSZ + 104)
#define ESZ105 (ERRSZ + 105)

#define ESZ106 (ERRSZ + 106)

#define ESZ107 (ERRSZ + 107)
#define ESZ108 (ERRSZ + 108)
#define ESZ109 (ERRSZ + 109)
#define ESZ110 (ERRSZ + 110)
#define ESZ111 (ERRSZ + 111)
#define ESZ112 (ERRSZ + 112)
#define ESZ113 (ERRSZ + 113)
#define ESZ114 (ERRSZ + 114)
#define ESZ115 (ERRSZ + 115)
#define ESZ116 (ERRSZ + 116)
#define ESZ117 (ERRSZ + 117)
#define ESZ118 (ERRSZ + 118)

#define ESZ119 (ERRSZ + 119)

#define ESZ120 (ERRSZ + 120)
#define ESZ121 (ERRSZ + 121)
#define ESZ122 (ERRSZ + 122)
#define ESZ123 (ERRSZ + 123)
#define ESZ124 (ERRSZ + 124)
#define ESZ125 (ERRSZ + 125)

#define ESZ126 (ERRSZ + 126)
#define ESZ127 (ERRSZ + 127)
#define ESZ128 (ERRSZ + 128)
#define ESZ129 (ERRSZ + 129)
#define ESZ130 (ERRSZ + 130)
#define ESZ131 (ERRSZ + 131)
#define ESZ132 (ERRSZ + 132)
#define ESZ133 (ERRSZ + 133)
#define ESZ134 (ERRSZ + 134)
#define ESZ135 (ERRSZ + 135)
#define ESZ136 (ERRSZ + 136)
#define ESZ137 (ERRSZ + 137)
#define ESZ138 (ERRSZ + 138)

#define ESZ139 (ERRSZ + 139)
#define ESZ140 (ERRSZ + 140)
#define ESZ141 (ERRSZ + 141)
#define ESZ142 (ERRSZ + 142)
#define ESZ143 (ERRSZ + 143)
#define ESZ144 (ERRSZ + 144)
#define ESZ145 (ERRSZ + 145)
#define ESZ146 (ERRSZ + 146)
#define ESZ147 (ERRSZ + 147)
#define ESZ148 (ERRSZ + 148)
#define ESZ149 (ERRSZ + 149)
#define ESZ150 (ERRSZ + 150)
#define ESZ151 (ERRSZ + 151)
#define ESZ152 (ERRSZ + 152)
#define ESZ153 (ERRSZ + 153)
#define ESZ154 (ERRSZ + 154)
#define ESZ155 (ERRSZ + 155)
#define ESZ156 (ERRSZ + 156)
#define ESZ157 (ERRSZ + 157)

#define ESZ158 (ERRSZ + 158)
#define ESZ159 (ERRSZ + 159)

#define ESZ160 (ERRSZ + 160)
#define ESZ161 (ERRSZ + 161)

#define ESZ162 (ERRSZ + 162)

#define ESZ163 (ERRSZ + 163)
#define ESZ164 (ERRSZ + 164)
#define ESZ165 (ERRSZ + 165)

#define ESZ166 (ERRSZ + 166)
#define ESZ167 (ERRSZ + 167)
#define ESZ168 (ERRSZ + 168)
#define ESZ169 (ERRSZ + 169)
#define ESZ170 (ERRSZ + 170)
#define ESZ171 (ERRSZ + 171)
#define ESZ172 (ERRSZ + 172)
#define ESZ173 (ERRSZ + 173)
#define ESZ174 (ERRSZ + 174)
#define ESZ175 (ERRSZ + 175)
#define ESZ176 (ERRSZ + 176)
#define ESZ177 (ERRSZ + 177)
#define ESZ178 (ERRSZ + 178)
#define ESZ179 (ERRSZ + 179)
#define ESZ180 (ERRSZ + 180)
#define ESZ181 (ERRSZ + 181)
#define ESZ182 (ERRSZ + 182)
#define ESZ183 (ERRSZ + 183)
#define ESZ184 (ERRSZ + 184)
#define ESZ185 (ERRSZ + 185)
#define ESZ186 (ERRSZ + 186)
#define ESZ187 (ERRSZ + 187)
#define ESZ188 (ERRSZ + 188)
#define ESZ189 (ERRSZ + 189)
#define ESZ190 (ERRSZ + 190)
# 140 "../..//s1ap/sz_ptli.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 151 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//cm/cm5.x" 1
# 152 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...
# 158 "../..//s1ap/sz_ptli.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 159 "../..//s1ap/sz_ptli.c" 2
...
extern S16 szDbFillResetAck (S1apPdu *pdu, S1apPdu **rstAckPdu, Mem mem);
...

{
   ...
   { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ptli.c", 623); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctBndReq(pst, suId: %d, spId: %d)\n", suId, spId); SPrint((&szCb.init)->prntBuf); } };
...
# 686 "../..//s1ap/sz_ptli.c"
{
...

   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ptli.c", 694); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctEndpOpenReq(pst, spId: %d, suEndpId: %ld, port: %d )\n", spId, suEndpId, port); SPrint((&szCb.init)->prntBuf); } };
...

{
...

   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ptli.c", 755); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctEndpCloseReq(pst, spId: %d, endpId: %ld, " "endpIdType: %d)\n", spId, endpId, endpIdType); SPrint((&szCb.init)->prntBuf); } };
# 762 "../..//s1ap/sz_ptli.c"
   }
...
# 849 "../..//s1ap/sz_ptli.c"
{
...

   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ptli.c", 860); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctAssocReq(pst, spId: %d, spEndpId: %ld, " "suAssocId: %ld, dstPort: %d, outStrms: %d)\n", spId, spEndpId, suAssocId, dstPort, outStrms); SPrint((&szCb.init)->prntBuf); } };
# 867 "../..//s1ap/sz_ptli.c"
   }
# 878 "../..//s1ap/sz_ptli.c"
...
# 1097 "../..//s1ap/sz_ptli.c"
{
...

   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ptli.c", 1106); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctTermReq(pst, spId: %d, assocId: %ld, " "assocIdType: %d, abrtFlg: %d)\n", spId, assocId, assocIdType, abrtFlg); SPrint((&szCb.init)->prntBuf); } };
# 1113 "../..//s1ap/sz_ptli.c"
   }
...
# 1225 "../..//s1ap/sz_ptli.c"
{
...

   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ptli.c", 1238); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctDatReq(pst, spId: %d, spAssocId: %ld, " "strmId: %d, unorderFlg: %d, nobundleFlg: %d, " "lifetime: %d, protId: %ld)\n", spId, spAssocId, strmId, unorderFlg, nobundleFlg, lifetime, protId); SPrint((&szCb.init)->prntBuf); } };
# 1247 "../..//s1ap/sz_ptli.c"
   }
...
# 1293 "../..//s1ap/sz_ptli.c"
{
...

   {
      ...
      { if ((&szCb.init)->dbgMask & (0x00000008)) { sprintf((&szCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", szCb.nodeDbg, (&szCb.init)->ent, (&szCb.init)->inst, "../..//s1ap/sz_ptli.c", 1304); SPrint((&szCb.init)->prntBuf); sprintf (szCb.init.prntBuf, "SzLiSctStaReq(pst, spId: %d, spAssocId: %ld, " "staType: %d)\n", spId, spAssocId, staType); SPrint((&szCb.init)->prntBuf); } };
# 1311 "../..//s1ap/sz_ptli.c"
   }
