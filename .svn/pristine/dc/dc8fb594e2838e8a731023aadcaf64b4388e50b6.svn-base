...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 100 "../..//lteclpal/ys_pal_utl.c" 2
# 1 "../..//cm/cm5.h" 1
# 101 "../..//lteclpal/ys_pal_utl.c" 2
# 1 "../..//cm/cm_hash.h" 1
# 91 "../..//cm/cm_hash.h"
#define __CMHASHH__ 
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 116 "../..//lteclpal/ys_pal_utl.c" 2
# 1 "../..//cm/cm5.x" 1
# 117 "../..//lteclpal/ys_pal_utl.c" 2
# 1 "../..//cm/cm_hash.x" 1
# 92 "../..//cm/cm_hash.x"
#define __CMHASHX__ 
# 102 "../..//cm/cm_hash.x"
...
# 127 "../..//lteclpal/ys_pal_utl.c" 2
# 144 "../..//lteclpal/ys_pal_utl.c"
...

{
   ...
   if(txMsgArr->num >= 10)
   {
      { if (ysCb.ysInit.dbgMask >= (2)) { { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_utl.c", 169); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "%s", "Failed: "); SPrint((&ysCb.ysInit)->prntBuf); } }; { if ((&ysCb.ysInit)->dbgMask & (2)) { sprintf((&ysCb.ysInit)->prntBuf, "[%s 0x%x:%x] %s:%d ", "Ys", (&ysCb.ysInit)->ent, (&ysCb.ysInit)->inst, "../..//lteclpal/ys_pal_utl.c", 169); SPrint((&ysCb.ysInit)->prntBuf); sprintf (ysCb.apb, "can't queue msg\n"); SPrint((&ysCb.ysInit)->prntBuf); } }; } };
      return(1);
   }
