...
void printCtfCellCfg(CtfCellCfgInfo *cellCfg)
{
  ...
  MSPD_DBG("cellCfg->puschCfg.puschBasicCfg = %d\n", cellCfg->puschCfg.puschBasicCfg);
...
void printSchCellCfg(RgrCellCfg *rgrCellCfg)
{
  ...
  MSPD_DBG("rgrCellCfg->pwrCfg.pucchPwrFmt3 = %d\n", rgrCellCfg->pwrCfg.pucchPwrFmt3);
  MSPD_DBG("rgrCellCfg->pwrCfg.pucchPwrFmt3a = %d\n", rgrCellCfg->pwrCfg.pucchPwrFmt3a);
  MSPD_DBG("rgrCellCfg->pwrCfg.puschPwrFmt3 = %d\n", rgrCellCfg->pwrCfg.puschPwrFmt3);
  MSPD_DBG("rgrCellCfg->pwrCfg.puschPwrFmt3a = %d\n", rgrCellCfg->pwrCfg.puschPwrFmt3a);
...
#endif
#ifdef TFU_UPGRADE
  MSPD_DBG("rgrUeCfg->uePdschDedCfg.uepAfg.pA = %d\n", rgrUeCfg->uePdschDedCfg.uepAfg.pA);
  MSPD_DBG("rgrUeCfg->uePdschDedCfg.uepAfg.pAPrsnt = %d\n", rgrUeCfg->uePdschDedCfg.uepAfg.pAPrsnt);
#endif
  MSPD_DBG("\n");
}
