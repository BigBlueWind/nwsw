...
/**********************************************************************
     ...
     File:     ve_sm_nh_exms.c

     Sid:      ve_sm_nh_exms.c@@/main/2 - Wed Dec  1 08:44:35 2010
...
#endif
{
   ...
   switch(pst->event)
   {
      ...
      default:
         ...
         ret = RFAILED;
#ifdef DEBUGP
       VEDBGP(DBGMASK_SM, (smCb.init.prntBuf, "smNhActvTsk : Received\
         invalid event\n"));
#endif
         break;
   }
...
/********************************************************************30**
         ...
         End of file:     ve_sm_nh_exms.c@@/main/2 - Wed Dec  1 08:44:35 2010
