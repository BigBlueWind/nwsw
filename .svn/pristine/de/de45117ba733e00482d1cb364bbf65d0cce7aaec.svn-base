...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 108 "../..//lterrc/nh_ptli.c" 2
# 1 "../..//cm/cm5.h" 1
# 109 "../..//lterrc/nh_ptli.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 132 "../..//lterrc/nh_ptli.c" 2

# 1 "../..//cm/cm5.x" 1
# 134 "../..//lterrc/nh_ptli.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
#define PTNHLIKWU 1
# 174 "../..//lterrc/nh_ptli.c"
#define PTNHLICKW 1
# 183 "../..//lterrc/nh_ptli.c"
#define PTNHLICRG 1
# 192 "../..//lterrc/nh_ptli.c"
#define PTNHLICPJ 1
# 212 "../..//lterrc/nh_ptli.c"
#define PTNHLIPJU 1
# 222 "../..//lterrc/nh_ptli.c"
static S16 PtLiKwuBndReq (Pst *post, SuId suId, SpId spId);
static S16 PtLiKwuUbndReq (Pst *post, SpId spId, Reason reason);
static S16 PtLiKwuDatReq (Pst *post, SpId spId, KwuDatReqInfo *datReq, Buffer *datBuf);





static S16 PtLiCkwBndReq (Pst *post, SuId suId, SpId spId);
static S16 PtLiCkwUbndReq (Pst *post, SpId spId, Reason reason);
static S16 PtLiCkwCfgReq (Pst *post, SpId spId, CkwCfgInfo *cfgInfo );
static S16 PtLiCkwUeIdChgReq (Pst *post, SpId spId,U32 transId, CkwUeInfo *oldUeInfo, CkwUeInfo *newUeInfo);
...
static S16 PtLiCrgBndReq (Pst *post, SuId suId, SpId spId);
static S16 PtLiCrgUbndReq (Pst *post, SpId spId, Reason reason);
static S16 PtLiCrgCfgReq (Pst *post, SpId spId, CrgCfgTransId transId, CrgCfgReqInfo *cmacCfg);





static S16 PtLiCpjBndReq (Pst *post, SuId suId, SpId spId);
static S16 PtLiCpjUbndReq (Pst *post, SpId spId, Reason reason);
static S16 PtLiCpjCfgReq (Pst *post, SpId spId, CpjCfgReqInfo *pdCfgReq);
static S16 PtLiCpjUeIdChgReq (Pst *post, SpId spId,U32 transId, CpjUeInfo *oldUeInfo, CpjUeInfo *newUeInfo);



static S16 PtLiCpjSecCfgReq (Pst *post, SpId spId, CpjSecCfgReqInfo *pdcpSecCfgReq);

static S16 PtLiCpjCountReq (Pst *post, SpId spId, CpjCountReqInfo *pdcpCountReq);

static S16 PtLiCpjReEstReq ( Pst *post, SpId spId, CpjReEstReqInfo *restbInfo);

static S16 PtLiCpjSduStaReq ( Pst *post, SpId spId, CpjSduStaReqInfo *statReqInfo);
# 284 "../..//lterrc/nh_ptli.c"
static S16 PtLiPjuBndReq (Pst *post, SuId suId, SpId spId);
static S16 PtLiPjuUbndReq (Pst *post, SpId spId, Reason reason);
static S16 PtLiPjuDatReq (Pst *post, SpId spId, CmLtePdcpId *pdcpId, PjuSduId sduId, Buffer *mBuf);
# 315 "../..//lterrc/nh_ptli.c"
static const KwuBndReq NhLiKwuBndReqMt [3] =
{
...
static const KwuUbndReq NhLiKwuUbndReqMt [3] =
{
...
static const KwuDatReq NhLiKwuDatReqMt [3] =
{
...
static const CkwBndReq NhLiCkwBndReqMt [3] =
{
...
static const CkwUbndReq NhLiCkwUbndReqMt [3] =
{
...
static const CkwCfgReq NhLiCkwCfgReqMt [3] =
{
...
static const CkwUeIdChgReq NhLiCkwUeIdChgReqMt [3] =
{
...
static const CrgBndReq NhLiCrgBndReqMt [3] =
{
...
static const CrgUbndReq NhLiCrgUbndReqMt [3] =
{
...
static const CrgCfgReq NhLiCrgCfgReqMt[3] =
{
...
static const CpjBndReq NhLiCpjBndReqMt [3] =
{
...
static const CpjUbndReq NhLiCpjUbndReqMt [3] =
{
...
static const CpjCfgReq NhLiCpjCfgReqMt [3] =
{
...
static const CpjUeIdChgReq NhLiCpjUeIdChgReqMt [3] =
{
...
static const CpjSecCfgReq NhLiCpjSecCfgReqMt [3] =
{
...
static const CpjCountReq NhLiCpjCountReqMt [3] =
{
...
static const CpjSduStaReq NhLiCpjSduStaReqMt [3] =
{
...
# 755 "../..//lterrc/nh_ptli.c"
static const CpjReEstReq NhLiCpjReEstReqMt [3] =
{
...
static const PjuBndReq NhLiPjuBndReqMt [3] =
{
...
static const PjuUbndReq NhLiPjuUbndReqMt [3] =
{
...
static const PjuDatReq NhLiPjuDatReqMt [3] =
{
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 879); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiKwuBndReq: suId(%d), spId(%d)\n", suId, spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiKwuBndReqMt[post->selector])(post, suId, spId));

}
# 895 "../..//lterrc/nh_ptli.c"
 S16 NhLiKwuUbndReq
(
Pst *post,
SpId spId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 912); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiKwuUbndReq: spId(%d), reason(%d)\n", spId, reason); SPrint((&nhCb.init)->prntBuf); } }; };


   return((*NhLiKwuUbndReqMt[post->selector])(post, spId, reason));

}
# 926 "../..//lterrc/nh_ptli.c"
 S16 NhLiKwuDatReq
(
Pst *post,
SpId spId,
KwuDatReqInfo *datReqParam,
Buffer *datBuf
)
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 944); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiKwuDatReq: spId(%d)\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiKwuDatReqMt[post->selector])(post, spId, datReqParam, datBuf));


}
# 970 "../..//lterrc/nh_ptli.c"
 S16 NhLiCkwBndReq
(
Pst *post,
SuId suId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 986); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCkwBndReq: suId(%d), spId(%d)\n", suId, spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiCkwBndReqMt[post->selector])(post, suId, spId));

}
# 1003 "../..//lterrc/nh_ptli.c"
 S16 NhLiCkwUbndReq
(
Pst *post,
SpId spId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1020); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCkwUbndReq: spId(%d), reason(%d)\n", spId, reason); SPrint((&nhCb.init)->prntBuf); } }; };


   return((*NhLiCkwUbndReqMt[post->selector])(post, spId, reason));

}
# 1034 "../..//lterrc/nh_ptli.c"
 S16 NhLiCkwCfgReq
(
Pst *post,
SpId spId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1049); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCkwCfgReq: spId(%d) \n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiCkwCfgReqMt[post->selector])(post, spId, cfgInfo));

}
# 1062 "../..//lterrc/nh_ptli.c"
 S16 NhLiCkwUeIdChgReq
(
Pst *post,
SpId spId,
U32 transId,
...
# 1078 "../..//lterrc/nh_ptli.c"
{
  ;;

  { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1081); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCkwUeIdChgReq: spId(%d) \n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

  return((*NhLiCkwUeIdChgReqMt[post->selector])(post, spId, transId, (CkwUeInfo *)oldUeInfo, (CkwUeInfo *)newUeInfo ));


}
# 1105 "../..//lterrc/nh_ptli.c"
 S16 NhLiCrgBndReq
(
Pst *post,
SuId suId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1121); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCrgBndReq: suId(%d), spId(%d)\n", suId, spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiCrgBndReqMt[post->selector])(post, suId, spId));

}
# 1137 "../..//lterrc/nh_ptli.c"
 S16 NhLiCrgUbndReq
(
Pst *post,
SpId spId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1154); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCrgUbndReq: spId(%d), reason(%d)\n", spId, reason); SPrint((&nhCb.init)->prntBuf); } }; };


   return((*NhLiCrgUbndReqMt[post->selector])(post, spId, reason));

}
# 1167 "../..//lterrc/nh_ptli.c"
 S16 NhLiCrgCfgReq
(
Pst *post,
SpId spId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1185); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCrgCfgReq: spId(%d)\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiCrgCfgReqMt[post->selector])(post, spId, transId, cmacCfg));

}
# 1209 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjBndReq
(
Pst *post,
SuId suId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1225); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjBndReq: suId(%d), spId(%d)\n", suId, spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiCpjBndReqMt[post->selector])(post, suId, spId));

}
# 1241 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjUbndReq
(
Pst *post,
SpId spId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1258); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjUbndReq: spId(%d), reason(%d)\n", spId, reason); SPrint((&nhCb.init)->prntBuf); } }; };


   return((*NhLiCpjUbndReqMt[post->selector])(post, spId, reason));

}
# 1275 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjCfgReq
(
Pst *post,
SpId spId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1291); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjCfgReq: spId(%d)\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

  return((*NhLiCpjCfgReqMt[post->selector])(post, spId, pdCfgReq));

}
# 1304 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjUeIdChgReq
(
Pst *post,
SpId spId,
U32 transId,
...
# 1320 "../..//lterrc/nh_ptli.c"
{
  ;;

  { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1323); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjUeIdChgReq: spId(%d) \n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

  return((*NhLiCpjUeIdChgReqMt[post->selector])(post, spId, transId, (CpjUeInfo *)oldUeInfo, (CpjUeInfo *)newUeInfo ));


}
# 1340 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjSecCfgReq
(
Pst *post,
SpId spId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1356); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjSecCfgReq: spId(%d)\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

  return((*NhLiCpjSecCfgReqMt[post->selector])(post, spId, cpjSecConfigReqInfo));


}
# 1371 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjCountReq
(
Pst *post,
SpId spId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1387); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjCountReq: spId(%d)\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

  return((*NhLiCpjCountReqMt[post->selector])(post, spId, pdcpCountReq));

}
# 1402 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjSduStaReq
(
Pst *post,
SpId spId,
CpjSduStaReqInfo *pdcpSduStaReq
)
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1418); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjSduStaReq: spId(%d)\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

  return((*NhLiCpjSduStaReqMt[post->selector])(post, spId, pdcpSduStaReq));

}
# 1432 "../..//lterrc/nh_ptli.c"
 S16 NhLiCpjReEstReq
(
Pst *post,
SpId spId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1447); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiCpjReEstReq: spId(%d) \n", spId); SPrint((&nhCb.init)->prntBuf); } }; };

  return((*NhLiCpjReEstReqMt[post->selector])(post, spId, restbInfo));

}
# 1655 "../..//lterrc/nh_ptli.c"
 S16 NhLiPjuBndReq
(
Pst *post,
SuId suId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1671); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiPjuBndReq: suId(%d), spId(%d)\n", suId, spId); SPrint((&nhCb.init)->prntBuf); } }; };

   return((*NhLiPjuBndReqMt[post->selector])(post, suId, spId));

}
# 1695 "../..//lterrc/nh_ptli.c"
 S16 NhLiPjuUbndReq
(
Pst *post,
SpId spId,
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1712); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiPjuUbndReq: spId(%d), reason(%d)\n", spId, reason); SPrint((&nhCb.init)->prntBuf); } }; };


   return((*NhLiPjuUbndReqMt[post->selector])(post, spId, reason));

}
# 1738 "../..//lterrc/nh_ptli.c"
 S16 NhLiPjuDatReq
(
Pst *post,
SpId spId,
...
# 1754 "../..//lterrc/nh_ptli.c"
{

   ;;

   { if (nhCb.init.dbgMask & (0x00000100 << 0)) { Txt prntBuf[10]; sprintf(prntBuf, "[info]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 0))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1758); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf,"NhLiPjuDatReq: spId(%d)\n", spId); SPrint((&nhCb.init)->prntBuf); } }; };


   return((*NhLiPjuDatReqMt[post->selector])(post, spId, pdcpId, sduId, mBuf));


}
# 1782 "../..//lterrc/nh_ptli.c"
static S16 PtLiKwuBndReq
(
Pst *post,
SuId suId,
SpId spId
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1802); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiKwuBndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 1815 "../..//lterrc/nh_ptli.c"
static S16 PtLiKwuUbndReq
(
Pst *post,
SpId spId,
Reason reason
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1835); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiKwuUbndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 1859 "../..//lterrc/nh_ptli.c"
static S16 PtLiKwuDatReq
(
Pst *post,
SpId spId,
KwuDatReqInfo *rlDatReqParam,
Buffer *datBuf
)
...

{
   ...
   (post=post);
   (spId=spId);
   (rlDatReqParam=rlDatReqParam);
   (datBuf=datBuf);

   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1882); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiKwuDatReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 1909 "../..//lterrc/nh_ptli.c"
static S16 PtLiCkwBndReq
(
Pst *post,
SuId suId,
SpId spId
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1929); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCkwBndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 1950 "../..//lterrc/nh_ptli.c"
static S16 PtLiCkwUbndReq
(
Pst *post,
SpId spId,
Reason reason
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 1969); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCkwUbndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 1990 "../..//lterrc/nh_ptli.c"
static S16 PtLiCkwCfgReq
(
Pst *post,
SpId spId,
CkwCfgInfo *cfgInfo
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2009); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCkwCfgReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2029 "../..//lterrc/nh_ptli.c"
static S16 PtLiCkwUeIdChgReq
(
Pst *post,
SpId spId,
U32 transId,
...
# 2045 "../..//lterrc/nh_ptli.c"
{
  ...
  (newUeInfo=newUeInfo);
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2054); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCkwUeIdChgReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2080 "../..//lterrc/nh_ptli.c"
static S16 PtLiCrgBndReq
(
Pst *post,
SuId suId,
SpId spId
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2100); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCrgBndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 2121 "../..//lterrc/nh_ptli.c"
static S16 PtLiCrgUbndReq
(
Pst *post,
SpId spId,
Reason reason
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2141); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCrgUbndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 2162 "../..//lterrc/nh_ptli.c"
static S16 PtLiCrgCfgReq
(
Pst *post,
SpId spId,
CrgCfgTransId transId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2185); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCrgCfgReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2212 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjBndReq
(
Pst *post,
SuId suId,
SpId spId
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2232); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjBndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 2253 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjUbndReq
(
Pst *post,
SpId spId,
Reason reason
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2273); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjUbndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 2294 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjCfgReq
(
Pst *post,
SpId spId,
CpjCfgReqInfo *pdCfgReq
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2314); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjCfgReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 2334 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjUeIdChgReq
(
Pst *post,
SpId spId,
U32 transId,
...
# 2350 "../..//lterrc/nh_ptli.c"
{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2359); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjUeIdChgReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2379 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjSecCfgReq
(
Pst *post,
SpId spId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2398); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjSecCfgReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2418 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjCountReq
(
Pst *post,
SpId spId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2437); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjCountReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2457 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjSduStaReq
(
Pst *post,
SpId spId,
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2476); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjSduStaReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2497 "../..//lterrc/nh_ptli.c"
static S16 PtLiCpjReEstReq
(
Pst *post,
SpId spId,
CpjReEstReqInfo *restbInfo
...

{
  ...
  { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2516); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiCpjReEstReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

  return(0);

}
# 2724 "../..//lterrc/nh_ptli.c"
static S16 PtLiPjuBndReq
(
Pst *post,
SuId suId,
SpId spId
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2743); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiPjuBndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);


}
# 2762 "../..//lterrc/nh_ptli.c"
static S16 PtLiPjuUbndReq
(
Pst *post,
SpId spId,
Reason reason
...

{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2782); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiPjuUbndReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };

   return(0);

}
# 2798 "../..//lterrc/nh_ptli.c"
static S16 PtLiPjuDatReq
(
Pst *post,
SpId spId,
CmLtePdcpId *pdcpId,
...
# 2814 "../..//lterrc/nh_ptli.c"
{
   ...
   { if (nhCb.init.dbgMask & (0x00000100 << 3)) { Txt prntBuf[10]; sprintf(prntBuf, "[error]"); SPrint(prntBuf); } { if ((&nhCb.init)->dbgMask & ((0x00000100 << 3))) { sprintf((&nhCb.init)->prntBuf, "[%s 0x%x:%x] %s:%d ", "LTE-RRC", (&nhCb.init)->ent, (&nhCb.init)->inst, "../..//lterrc/nh_ptli.c", 2824); SPrint((&nhCb.init)->prntBuf); sprintf (nhCb.init.prntBuf, "PtLiPjuDatReq() called"); SPrint((&nhCb.init)->prntBuf); } }; };
