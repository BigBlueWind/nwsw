...
# 96 "../..//enbapp/lterrm/rm_rcm.c" 2
# 115 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmInit
(
   Void
)
{
   RmRcmDlRbBpMap *dlRbBpMapPtr = 0L;
   RmRcmCqiIdxPrdctyMap *cqiIdxPrdMapPtr = 0L;
   RmRcmRiIdxMriMap *riIdxMriMapPtr = 0L;




   dlRbBpMapPtr = &rmCb.enbCb.rcmEnbCb.refTbls.dlRbBpMap[0];

   dlRbBpMapPtr[0].dlbw = RRM_WR_BANDWIDTH_6;
   dlRbBpMapPtr[0].numRb = (U8)6;
   dlRbBpMapPtr[0].subbandSize = (U8)0;
   dlRbBpMapPtr[0].numBwPart = (U8)0;
   dlRbBpMapPtr[0].numSbPerBp = (U8)0;

   dlRbBpMapPtr[1].dlbw = RRM_WR_BANDWIDTH_15;
   dlRbBpMapPtr[1].numRb = (U8)15;
   dlRbBpMapPtr[1].subbandSize = (U8)4;
   dlRbBpMapPtr[1].numBwPart = (U8)2;
   dlRbBpMapPtr[1].numSbPerBp = (U8)2;

   dlRbBpMapPtr[2].dlbw = RRM_WR_BANDWIDTH_25;
   dlRbBpMapPtr[2].numRb = (U8)25;
   dlRbBpMapPtr[2].subbandSize = (U8)4;
   dlRbBpMapPtr[2].numBwPart = (U8)2;
   dlRbBpMapPtr[2].numSbPerBp = (U8)4;

   dlRbBpMapPtr[3].dlbw = RRM_WR_BANDWIDTH_50;
   dlRbBpMapPtr[3].numRb = (U8)50;
   dlRbBpMapPtr[3].subbandSize = (U8)6;
   dlRbBpMapPtr[3].numBwPart = (U8)3;
   dlRbBpMapPtr[3].numSbPerBp = (U8)3;

   dlRbBpMapPtr[4].dlbw = RRM_WR_BANDWIDTH_75;
   dlRbBpMapPtr[4].numRb = (U8)50;
   dlRbBpMapPtr[4].subbandSize = (U8)8;
   dlRbBpMapPtr[4].numBwPart = (U8)4;
   dlRbBpMapPtr[4].numSbPerBp = (U8)3;

   dlRbBpMapPtr[5].dlbw = RRM_WR_BANDWIDTH_100;
   dlRbBpMapPtr[5].numRb = (U8)100;
   dlRbBpMapPtr[5].subbandSize = (U8)8;
   dlRbBpMapPtr[5].numBwPart = (U8)4;
   dlRbBpMapPtr[5].numSbPerBp = (U8)4;




   cqiIdxPrdMapPtr = &rmCb.enbCb.rcmEnbCb.refTbls.cqiIdxPrdMap[0];

   cqiIdxPrdMapPtr[0].cqiCfgIdxStart = (U16)0;
   cqiIdxPrdMapPtr[0].cqiCfgIdxEnd = (U16)1;
   cqiIdxPrdMapPtr[0].periodicity = (U8)2;

   cqiIdxPrdMapPtr[1].cqiCfgIdxStart = (U16)2;
   cqiIdxPrdMapPtr[1].cqiCfgIdxEnd = (U16)6;
   cqiIdxPrdMapPtr[1].periodicity = (U8)5;

   cqiIdxPrdMapPtr[2].cqiCfgIdxStart = (U16)7;
   cqiIdxPrdMapPtr[2].cqiCfgIdxEnd = (U16)16;
   cqiIdxPrdMapPtr[2].periodicity = (U8)10;

   cqiIdxPrdMapPtr[3].cqiCfgIdxStart = (U16)17;
   cqiIdxPrdMapPtr[3].cqiCfgIdxEnd = (U16)36;
   cqiIdxPrdMapPtr[3].periodicity = (U8)20;

   cqiIdxPrdMapPtr[4].cqiCfgIdxStart = (U16)37;
   cqiIdxPrdMapPtr[4].cqiCfgIdxEnd = (U16)76;
   cqiIdxPrdMapPtr[4].periodicity = (U8)40;

   cqiIdxPrdMapPtr[5].cqiCfgIdxStart = (U16)77;
   cqiIdxPrdMapPtr[5].cqiCfgIdxEnd = (U16)156;
   cqiIdxPrdMapPtr[5].periodicity = (U8)80;

   cqiIdxPrdMapPtr[6].cqiCfgIdxStart = (U16)157;
   cqiIdxPrdMapPtr[6].cqiCfgIdxEnd = (U16)316;
   cqiIdxPrdMapPtr[6].periodicity = (U8)160;




   riIdxMriMapPtr = &rmCb.enbCb.rcmEnbCb.refTbls.riIdxMriMap[0];

   riIdxMriMapPtr[0].riIdxStart = (U16)0;
   riIdxMriMapPtr[0].riIdxEnd = (U16)160;
   riIdxMriMapPtr[0].mRi = (U8)1;

   riIdxMriMapPtr[1].riIdxStart = (U16)161;
   riIdxMriMapPtr[1].riIdxEnd = (U16)321;
   riIdxMriMapPtr[1].mRi = (U8)2;

   riIdxMriMapPtr[2].riIdxStart = (U16)322;
   riIdxMriMapPtr[2].riIdxEnd = (U16)482;
   riIdxMriMapPtr[2].mRi = (U8)4;

   riIdxMriMapPtr[3].riIdxStart = (U16)483;
   riIdxMriMapPtr[3].riIdxEnd = (U16)643;
   riIdxMriMapPtr[3].mRi = (U8)8;

   riIdxMriMapPtr[4].riIdxStart = (U16)644;
   riIdxMriMapPtr[4].riIdxEnd = (U16)804;
   riIdxMriMapPtr[4].mRi = (U8)16;

   riIdxMriMapPtr[5].riIdxStart = (U16)805;
   riIdxMriMapPtr[5].riIdxEnd = (U16)965;
   riIdxMriMapPtr[5].mRi = (U8)32;

   return(0);
}
# 257 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmAddCellCfg
(
   RmCellCb *cellCbPtr,
   RrmWrCause *cause
)
{
   ...
   retVal = rmRcmInitCqiStaticInfo(&cellCbPtr->rcmCellCb, &cellCbPtr->cellCfg);

   if( 0 == retVal)
   {
      *cause = RRM_WR_CAUSE_NOT_APP;
   }

   return(retVal);

}
# 294 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmModCellCfg
(
   RmCellCb *cellCbPtr,
   U32 rcmMask
...
# 321 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmDelCellCfg
(
   RmCellCb *cellCbPtr
)
{
   rmRcmDeInitCqiStaticInfo(&cellCbPtr->rcmCellCb);

   return(0);
}
# 359 "../..//enbapp/lterrm/rm_rcm.c"
static S16 rmRcmUeCfgRadioRes
(
   RmUeCb *ueCbPtr,
   RrmWrUeRadioResCfg *ueRadioResCfgPtr
)
...
# 389 "../..//enbapp/lterrm/rm_rcm.c"
static Void rmRcmPcqiInitUeStats
(
   RmUeCb *ueCbPtr
)
{
   RmRcmPcqiUeStats *pcqiUeStatsPtr = 0L;

   pcqiUeStatsPtr = &(ueCbPtr->rcmUeCb.cqiUeStats);

   pcqiUeStatsPtr->dopEst = (U8)75;
   pcqiUeStatsPtr->qciLvl = (U8)1;
   pcqiUeStatsPtr->prdctyLvl = (U8)1;
   pcqiUeStatsPtr->wCqi = (U8)5;
   pcqiUeStatsPtr->sbCqiMax = (U8)8;

   if(pcqiUeStatsPtr->sbCqiMax > pcqiUeStatsPtr->wCqi)
   {
      pcqiUeStatsPtr->diffWbSbCqi = pcqiUeStatsPtr->sbCqiMax - pcqiUeStatsPtr->wCqi;
   }
   else
   {
      pcqiUeStatsPtr->diffWbSbCqi = pcqiUeStatsPtr->wCqi - pcqiUeStatsPtr->sbCqiMax;
   }

   ueCbPtr->rcmUeCb.cqiUeStats.totalGbr = 0;

   { RmRcmPcqiWcqiLvlMap *cqiLvlMapPtr; cqiLvlMapPtr = (&(ueCbPtr->cellCbPtr->rcmCellCb))->pcqi.pcqiStaticInfo.wCqiLvlMap; if((pcqiUeStatsPtr->diffWbSbCqi) < 15) { (pcqiUeStatsPtr->cqiLvl) = cqiLvlMapPtr[(pcqiUeStatsPtr->diffWbSbCqi)].wCqiLevel; } else { (pcqiUeStatsPtr->cqiLvl) = cqiLvlMapPtr[0].wCqiLevel; } };

   { U8 lvlMapIdx = 0; RmRcmPcqiGbrLvlMap *gbrLvlMapPtr; gbrLvlMapPtr = (&(ueCbPtr->cellCbPtr->rcmCellCb))->pcqi.pcqiStaticInfo.gbrLvlMap; while(lvlMapIdx < 4) { if((ueCbPtr->rcmUeCb.cqiUeStats.totalGbr) <= gbrLvlMapPtr[lvlMapIdx].gbrEnd) { (pcqiUeStatsPtr->gbrLvl) = gbrLvlMapPtr[lvlMapIdx].gbrLevel; break; } lvlMapIdx++; } };

   { U8 lvlMapIdx = 0; RmRcmPcqiSpdLvlMap *spdLvlMapPtr; spdLvlMapPtr = (&(ueCbPtr->cellCbPtr->rcmCellCb))->pcqi.pcqiStaticInfo.spdLvlMap; while(lvlMapIdx < 4) { if((pcqiUeStatsPtr->dopEst) <= spdLvlMapPtr[lvlMapIdx].dopEstEnd) { (pcqiUeStatsPtr->ueSpdLvl) = spdLvlMapPtr[lvlMapIdx].spdLevel; break; } lvlMapIdx++; } };


   return;
}
# 454 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmUeCfg
(
   RmUeCb *ueCbPtr,
   RrmWrUeRadioResCfg *ueRadioResCfgPtr
)
{
   ...
   rmRcmPcqiInitUeStats(ueCbPtr);

   retVal = rmRcmUeCfgRadioRes(ueCbPtr, ueRadioResCfgPtr);

   return(retVal);
}
# 504 "../..//enbapp/lterrm/rm_rcm.c"
static S16 rmRcmProcUeRecfg
(
   RmUeCb *ueCbPtr,
   U8 reCfgBitMap,
   U8 *respRecfgTypePtr,
...
{
   S16 retVal = 0;
   RmCellCb *cellCbPtr = ueCbPtr->cellCbPtr;

   ueRadioResCfgPtr->phyCfgDedResBitMap = 0;


   if(reCfgBitMap & 0x02)
   {
      retVal = rmRcmReCfgPcqi(&cellCbPtr->rcmCellCb, &ueCbPtr->rcmUeCb,
                              &ueRadioResCfgPtr->phyCfgDed.cqiRepCfg);
      if(retVal == 0)
      {
         ueRadioResCfgPtr->phyCfgDedResBitMap |= 0x02;
      }
   }
   else if(reCfgBitMap & 0x10)
   {
      retVal = rmRcmReCfgRi(&cellCbPtr->rcmCellCb, &ueCbPtr->rcmUeCb,
                              &ueRadioResCfgPtr->phyCfgDed.cqiRepCfg);
      if(retVal == 0)
      {
         ueRadioResCfgPtr->phyCfgDedResBitMap |= 0x02;
   ...
   if(ueRadioResCfgPtr->phyCfgDedResBitMap)
   {
      *respRecfgTypePtr |= 0x01;
   }

   return(retVal);
}
# 617 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmUeRecfg
(
   RmUeCb *ueCbPtr,
   RrmWrUeRecfgReqInfo *ueRecfgReqPtr,
...
)
{
   ...
   if(ueRecfgReqPtr->recfgType & 0x02)
   {
      ...
      highPriQci = rmRbcGetUeHighestPriorQci(ueCbPtr);

      { RmRcmPcqiQciLvlMap *qciLvlMapPtr; qciLvlMapPtr = (&(cellCbPtr->rcmCellCb))->pcqi.pcqiStaticInfo.qciLvlMap; if((highPriQci) < 9) { (qciLvl) = qciLvlMapPtr[((highPriQci) - 1)].qciLevel; } else { (qciLvl) = qciLvlMapPtr[(9 - 1)].qciLevel; } };




      if(qciLvl != ueCbPtr->rcmUeCb.cqiUeStats.qciLvl)
      {
         ueCbPtr->rcmUeCb.cqiUeStats.qciLvl = qciLvl;

         reCfgMask |= 0x02;
      }


      totalGbr = rmRbcGetTotalGbr(ueCbPtr);


      { U8 lvlMapIdx = 0; RmRcmPcqiGbrLvlMap *gbrLvlMapPtr; gbrLvlMapPtr = (&(cellCbPtr->rcmCellCb))->pcqi.pcqiStaticInfo.gbrLvlMap; while(lvlMapIdx < 4) { if((totalGbr) <= gbrLvlMapPtr[lvlMapIdx].gbrEnd) { (gbrLevel) = gbrLvlMapPtr[lvlMapIdx].gbrLevel; break; } lvlMapIdx++; } };




      if(gbrLevel != ueCbPtr->rcmUeCb.cqiUeStats.gbrLvl)
      {
         ueCbPtr->rcmUeCb.cqiUeStats.gbrLvl = gbrLevel;
   ...
   if(ueRecfgReqPtr->recfgType & 0x01)
   {
      if(ueCbPtr->rcmUeCb.cqiUeStats.txnMode != ueRecfgReqPtr->txMode)
      {
         ueCbPtr->rcmUeCb.cqiUeStats.txnMode = ueRecfgReqPtr->txMode;
   ...
   if(reCfgMask)
   {
      retVal = rmRcmProcUeRecfg(ueCbPtr, reCfgMask,
                                 respRecfgTypePtr, ueRadioResCfgPtr);
   }

   return(retVal);
}
# 727 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmUeStaUpd
(
   RmUeCb *ueCbPtr,
   RrmWrUeStaIndInfo *rcmUeStaIndtPtr
)
{
   ...
   U32 ueSpdLvl = 0;
   U32 ueCqiLvl = 0;
   RrmWrUeRecfgIndInfo ueReCfgIndInfo;
   RmRcmPcqiUeStats *pcqiUeStatsPtr = &(ueCbPtr->rcmUeCb.cqiUeStats);
   RmCellCb *cellCbPtr = ueCbPtr->cellCbPtr;

   if(rcmUeStaIndtPtr->staType == RRM_WR_UESTATYPE_DOPEST)
   {
      pcqiUeStatsPtr->dopEst = rcmUeStaIndtPtr->dopplerEst;

      { U8 lvlMapIdx = 0; RmRcmPcqiSpdLvlMap *spdLvlMapPtr; spdLvlMapPtr = (&(cellCbPtr->rcmCellCb))->pcqi.pcqiStaticInfo.spdLvlMap; while(lvlMapIdx < 4) { if((pcqiUeStatsPtr->dopEst) <= spdLvlMapPtr[lvlMapIdx].dopEstEnd) { (ueSpdLvl) = spdLvlMapPtr[lvlMapIdx].spdLevel; break; } lvlMapIdx++; } };


      if(ueSpdLvl != pcqiUeStatsPtr->ueSpdLvl)
      {
         pcqiUeStatsPtr->ueSpdLvl = ueSpdLvl;

         reCfgMask |= (U8)0x02;
      }
   }

   if(rcmUeStaIndtPtr->staType == RRM_WR_UESTATYPE_WIDEBANDCQI)
   {
      if(rcmUeStaIndtPtr->widebandCqi != pcqiUeStatsPtr->wCqi)
      {
         if(pcqiUeStatsPtr->sbCqiMax > rcmUeStaIndtPtr->widebandCqi)
         {
            pcqiUeStatsPtr->diffWbSbCqi = pcqiUeStatsPtr->sbCqiMax -
                                                rcmUeStaIndtPtr->widebandCqi;
         }
         else
         {
            pcqiUeStatsPtr->diffWbSbCqi = rcmUeStaIndtPtr->widebandCqi -
                                       pcqiUeStatsPtr->sbCqiMax;
         }

         { RmRcmPcqiWcqiLvlMap *cqiLvlMapPtr; cqiLvlMapPtr = (&(cellCbPtr->rcmCellCb))->pcqi.pcqiStaticInfo.wCqiLvlMap; if((pcqiUeStatsPtr->diffWbSbCqi) < 15) { (ueCqiLvl) = cqiLvlMapPtr[(pcqiUeStatsPtr->diffWbSbCqi)].wCqiLevel; } else { (ueCqiLvl) = cqiLvlMapPtr[0].wCqiLevel; } };


         if(ueCqiLvl != pcqiUeStatsPtr->cqiLvl)
         {
            pcqiUeStatsPtr->cqiLvl = ueCqiLvl;
   ...
   retVal = rmRcmProcUeRecfg(ueCbPtr, reCfgMask, &ueReCfgIndInfo.recfgType,
                                 &(ueReCfgIndInfo.ueRadioResCfg));

   if(retVal == 0)
   {
      ueReCfgIndInfo.cellId = cellCbPtr->cellId;
      ueReCfgIndInfo.transId = 0;
      ueReCfgIndInfo.crnti = ueCbPtr->ueId;
   }


   rmCcmSendUeRecfg(&ueReCfgIndInfo);


   return(retVal);

}
# 833 "../..//enbapp/lterrm/rm_rcm.c"
 S16 rmRcmUeRel
(
   RmUeCb *ueCbPtr
)
{
   ...
   if(ueCbPtr->rcmUeCb.resTypeAllocted & 0x02)
   {
      rmRcmUeRelPcqiRes(&cellCbPtr->rcmCellCb, &ueCbPtr->rcmUeCb);
   }
