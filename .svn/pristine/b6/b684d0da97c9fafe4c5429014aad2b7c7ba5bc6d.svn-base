...
/* rg004.201 : Renamed structures to start with rgSch instead of rr. */
/**
...
typedef struct rgSchRrDlUe
{
   ...
   Bool              isUeSkipped; /*!< Flag to check whether the UE got skipped during its inactive time */
} RgSchRrDlUe;
...
{
   RgSchRrCListCp         ueTxLst;    /*!< Queue for UEs corresponding to new tx*/
...
EXTERN Void rgSCHRrDlRmvProcFrmRetxLst ARGS((RgSchCellCb *cell, RgSchDlHqProcCb *hqP));
