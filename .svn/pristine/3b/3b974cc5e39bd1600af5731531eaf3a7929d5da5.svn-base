...
#Compiler macros             
#-------------------------------------------------------------#
$(OUT_DIR)/eg_dbs11.$(OBJ): $(IN_DIR)/eg_dbs11.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/eg_dbs11.$(OBJ) $(COPTS) $(IOPTS) $(POPTS) $(CCegFLAGS) \
	$(IN_DIR)/eg_dbs11.$(SRC)
$(OUT_DIR)/eg_dbs5.$(OBJ): $(IN_DIR)/eg_dbs5.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/eg_dbs5.$(OBJ) $(COPTS) $(IOPTS) $(POPTS) $(CCegFLAGS) \
	$(IN_DIR)/eg_dbs5.$(SRC)
$(OUT_DIR)/eg_dbutl.$(OBJ): $(IN_DIR)/eg_dbutl.$(SRC) $(ALL_INC)
	$(CC)  -o$(OUT_DIR)/eg_dbutl.$(OBJ) $(COPTS) $(IOPTS) $(POPTS) $(CCegFLAGS) \
	$(IN_DIR)/eg_dbutl.$(SRC)
