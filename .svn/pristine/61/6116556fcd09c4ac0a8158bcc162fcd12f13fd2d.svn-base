...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 115 "../..//ltemac/rg_sch_dbm.c" 2
# 1 "../..//cm/cm5.x" 1
# 116 "../..//ltemac/rg_sch_dbm.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 94 "../..//cm/cm_lib.x"
#define __CMLIBX__ 
...

{
   ...
   return(cmHashListInit(&cellCb->ueLst, numBins, (U16)((U32)&(ue.ueLstEnt) - (U32)&ue), 0, 5, rgSchCb[cellCb->instIdx].rgSchInit.region, rgSchCb[cellCb->instIdx].rgSchInit.pool));




}
# 274 "../..//ltemac/rg_sch_dbm.c"
