...
CCcmFLAGS=-DSS_MT_TMR -DSS_FLOAT -ULTE_TDD -DRGR_V1 -DLSZV1  #<---Insert cm specific defines here
else
ifeq (${BLDENV},lnx_ms_withoutdiag)
CCcmFLAGS=-DSS_MT_TMR -DSS_FLOAT -ULTE_TDD -DRGR_V1 -DLSZV1  #<---Insert cm specific defines here
else
CCcmFLAGS=-DSS_MT_TMR -DSS_FLOAT -ULTE_TDD -DRGR_V1 -DLSZV1 -DVE_SB_SCTP#<---Insert cm specific defines here
endif
endif

ifeq (${BLDENV}, lnx_e2e_ms)
CCsmFLAGS=-DHI -DSB -DEG -DWR -DKW -DKW_PDCP -DPJ -DSZ -DYS -DRG -DNH -UWR_SM_LOG_TO_FILE -DRGR_SI_SCH -UTA_NEW -DSI_NEW -DCZ
else
ifeq (${BLDENV},lnx_ms_withoutdiag)
CCsmFLAGS=-DHI -DSB -DEG -DWR -DKW -DKW_PDCP -DPJ -DSZ -DYS -DRG -DNH -UWR_SM_LOG_TO_FILE -DRGR_SI_SCH -UTA_NEW -DSI_NEW -DCZ
else
CCsmFLAGS=-DHI -DSB -DEG -DWR -DKW -DKW_PDCP -DPJ -DSZ -DYS -DRG -DNH -UVE_SM_LOG_TO_FILE -DRGR_SI_SCH -DTA_NEW -DSI_NEW -DCZ
endif
endif
#-------------------------------------------------------------#
#File/Obj macros             
