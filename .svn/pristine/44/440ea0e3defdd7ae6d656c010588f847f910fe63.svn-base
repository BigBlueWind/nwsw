...
$(OUT_DIR)/hi_bdy2.$(OBJ): $(IN_DIR)/hi_bdy2.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CChiFLAGS) $(IN_DIR)/hi_bdy2.$(SRC) -o \
	$(OUT_DIR)/hi_bdy2.$(OBJ)
$(OUT_DIR)/hi_bdy3.$(OBJ): $(IN_DIR)/hi_bdy3.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CChiFLAGS) $(IN_DIR)/hi_bdy3.$(SRC) -o \
	$(OUT_DIR)/hi_bdy3.$(OBJ)
$(OUT_DIR)/hi_ex_ms.$(OBJ): $(IN_DIR)/hi_ex_ms.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CChiFLAGS) $(IN_DIR)/hi_ex_ms.$(SRC) -o \
	$(OUT_DIR)/hi_ex_ms.$(OBJ)
$(OUT_DIR)/hi_id.$(OBJ): $(IN_DIR)/hi_id.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CChiFLAGS) $(IN_DIR)/hi_id.$(SRC) -o \
	$(OUT_DIR)/hi_id.$(OBJ)
$(OUT_DIR)/hi_ptmi.$(OBJ): $(IN_DIR)/hi_ptmi.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CChiFLAGS) $(IN_DIR)/hi_ptmi.$(SRC) -o \
	$(OUT_DIR)/hi_ptmi.$(OBJ)
$(OUT_DIR)/hi_ptui.$(OBJ): $(IN_DIR)/hi_ptui.$(SRC) $(ALL_INC)
	$(CC)  $(COPTS) $(IOPTS) $(POPTS) $(CChiFLAGS) $(IN_DIR)/hi_ptui.$(SRC) -o \
	$(OUT_DIR)/hi_ptui.$(OBJ)
