...
#endif
{
   ...
   RGSCHDBGPRM(cell->instIdx, (rgSchPBuf(cell->instIdx), "rgSCHTmrStartTmr(): "
        "Starting timer for TmrEvnt(%d)\n", tmrEvnt));
  ...
  /* rg006.201: [ccpu00112398] Added periodic BSR timer */
      ...
      default:
         ...
         MSPD_ERR("Incorrect Timer event\n");
         RETVOID;
   }
...
#endif
{
   ...
   RGSCHDBGPRM(cell->instIdx, (rgSchPBuf(cell->instIdx), "rgSCHTmrStopTmr(): "
           "Stopping timer for TmrEvnt(%d)\n", tmrEvnt));
...
#endif
{
   ...
   /* rg003.201: Ciorrected function name in TRC2*/
...
#endif
      default:
         RGSCHDBGERR(ue->cell->instIdx, (rgSchPBuf(ue->cell->instIdx), 
