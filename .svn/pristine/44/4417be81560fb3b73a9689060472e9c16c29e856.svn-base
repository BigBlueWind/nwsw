...
/***********************************************************
*
*     Func : cmPkLteEgtpTunCfm 
*
*
*     Desc : Egtp Tunnel Confirm
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkLteEgtpTunCfm
(
CmLteEgtpTunCfm *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmPkLteEgtpTunCfm(param, mBuf)
CmLteEgtpTunCfm *param;
Buffer *mBuf;
#endif
{

   TRC3(cmPkLteEgtpTunCfm);
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnPkLteEgtpTunCfm
(
CmLteEgtpTunCfm *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmUnPkLteEgtpTunCfm(param, mBuf)
CmLteEgtpTunCfm *param;
Buffer *mBuf;
#endif
{

   TRC3(cmUnPkLteEgtpTunCfm);
