...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 99 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm5.h" 1
# 100 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_llist.h" 1
# 90 "../..//cm/cm_llist.h"
#define __CMLLISTH__ 
...
# 106 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_inet.h" 1
# 107 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/hit.h" 1
# 91 "../..//cm/hit.h"
#define __HITH__ 
# 110 "../..//cm/hit.h"
...
# 1 "../..//cm/gen.x" 1
# 127 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/ssi.x" 1
# 128 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm5.x" 1
# 129 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_lib.x" 1
# 130 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_llist.x" 1
# 91 "../..//cm/cm_llist.x"
#define __CMLLISTX__ 
...
# 132 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 133 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_tpt.x" 1
# 95 "../..//cm/cm_tpt.x"
#define __CMTPTX__ 
...
# 135 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_mblk.x" 1
# 136 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/cm_inet.x" 1
# 137 "../..//egtpu/eg_ex_ms.c" 2
# 1 "../..//cm/hit.x" 1
# 91 "../..//cm/hit.x"
#define __HITX__ 
# 102 "../..//cm/hit.x"
...
# 151 "../..//egtpu/eg_ex_ms.c" 2
# 175 "../..//egtpu/eg_ex_ms.c"
 S16 egActvTsk
(
Pst *pst,
Buffer *mBuf
...

{
   ...
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ex_ms.c",195); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf," Entering\n"); SPrint(egCb.init.prntBuf); }; } ;; };
# 212 "../..//egtpu/eg_ex_ms.c"
   ...
   if(mBuf == 0L)
   {
      SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ex_ms.c", 221, 0x4, ((0 + 0) + 95), (ErrVal)pst->event, (Txt *)"egActvTsk: received mBuf is NULLP");;

      { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ex_ms.c",222); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(1); };
   }
...
# 418 "../..//egtpu/eg_ex_ms.c"
      ...
      case 0x0E:
      {
         switch(pst->event)
         {
            ...
            {
               { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ex_ms.c",477); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
               SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ex_ms.c", 478, 0x4, ((0 + 0) + 98), (ErrVal)pst->event, (Txt *)"egActvTsk: Invalid event");;
               retVal = 1;
               break;
            }
...
# 541 "../..//egtpu/eg_ex_ms.c"
      ...
      switch (pst->event)
      {
         ...
         default:
               ...
               { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ex_ms.c",553); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
               SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ex_ms.c", 555, 0x4, ((0 + 0) + 101), (ErrVal)pst->event, (Txt *)"egActvTsk: Invalid event");;


            break;
      }
      break;
# 569 "../..//egtpu/eg_ex_ms.c"
      default:
      {
         SLogError(egCb.init.ent, egCb.init.inst, egCb.init.procId, (Txt *)"../..//egtpu/eg_ex_ms.c", 572, 0x4, ((0 + 0) + 101), (ErrVal)pst->event, (Txt *)"egActvTsk: Invalid event");;

         { if (mBuf != (Buffer*) 0L) { { if (egCb.init.dbgMask & ((0x00000100 << 8))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ex_ms.c",573); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " [ MEM  : %d %d %p %ld]\n", 2, 2,(Void*)mBuf, (U32)0 ); SPrint(egCb.init.prntBuf); }; } }; (Void)SPutMsg(mBuf); mBuf = 0L; } };
         retVal = 1;
         break;
      }
   }
   ...
   SExitTsk();
   { if (egCb.init.dbgMask & ((0x00000100 << 4))) { { { sprintf (egCb.init.prntBuf, " [%s 0x%x:%x]", "Eg", egCb.init.ent,egCb.init.inst); SPrint(egCb.init.prntBuf); }; } { { sprintf (egCb.init.prntBuf, " [%s:%d]","../..//egtpu/eg_ex_ms.c",580); SPrint(egCb.init.prntBuf); }; } { sprintf (egCb.init.prntBuf, " Exiting\n"); SPrint(egCb.init.prntBuf); }; } return(retVal); };
}
