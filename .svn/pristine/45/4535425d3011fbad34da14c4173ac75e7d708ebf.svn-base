...
# 2207 "../..//cm/ssi.h"
#define PID_STK(h) (h)
# 106 "../..//lterlcpdcp/kw_amm.c" 2
# 1 "../..//cm/cm5.h" 1
# 107 "../..//lterlcpdcp/kw_amm.c" 2
# 1 "../..//cm/cm_tkns.h" 1
# 91 "../..//cm/cm_tkns.h"
#define __CMTKNSH 
# 115 "../..//cm/cm_tkns.h"
...
# 115 "../..//lterlcpdcp/kw_amm.c" 2
# 1 "../..//cm/rgu.h" 1
# 91 "../..//cm/rgu.h"
#define __RGUH__ 
# 106 "../..//cm/rgu.h"
#define RGU_MAX_PDU 5

#define RGU_RESID_SIZE 6

#define RGU_MAX_TB 2


#define RGU_MAX_LC 10


#define EVTRGUBNDREQ 1
#define EVTRGUUBNDREQ 2
#define EVTRGUBNDCFM 3
#define EVTRGUCDATREQ 4
#define EVTRGUCDATIND 5
#define EVTRGUDDATREQ 6
#define EVTRGUDDATIND 7
#define EVTRGUCSTARSP 8
#define EVTRGUCSTAIND 9
#define EVTRGUDSTARSP 10
#define EVTRGUDSTAIND 11
# 136 "../..//cm/rgu.h"
#define RGU_SEL_TC 1
#define RGU_SEL_LC 0
...
#define ERGU001 (ERRRGU + 1)
#define ERGU002 (ERRRGU + 2)
#define ERGU003 (ERRRGU + 3)
#define ERGU004 (ERRRGU + 4)
#define ERGU005 (ERRRGU + 5)
#define ERGU006 (ERRRGU + 6)
#define ERGU007 (ERRRGU + 7)
#define ERGU008 (ERRRGU + 8)
#define ERGU009 (ERRRGU + 9)
#define ERGU010 (ERRRGU + 10)
#define ERGU011 (ERRRGU + 11)
#define ERGU012 (ERRRGU + 12)
#define ERGU013 (ERRRGU + 13)
#define ERGU014 (ERRRGU + 14)
#define ERGU015 (ERRRGU + 15)
#define ERGU016 (ERRRGU + 16)
#define ERGU017 (ERRRGU + 17)
#define ERGU018 (ERRRGU + 18)
#define ERGU019 (ERRRGU + 19)
#define ERGU020 (ERRRGU + 20)
#define ERGU021 (ERRRGU + 21)
#define ERGU022 (ERRRGU + 22)

#define ERGU023 (ERRRGU + 23)
#define ERGU024 (ERRRGU + 24)
#define ERGU025 (ERRRGU + 25)
#define ERGU026 (ERRRGU + 26)
#define ERGU027 (ERRRGU + 27)
#define ERGU028 (ERRRGU + 28)
#define ERGU029 (ERRRGU + 29)
#define ERGU030 (ERRRGU + 30)
#define ERGU031 (ERRRGU + 31)
#define ERGU032 (ERRRGU + 32)
#define ERGU033 (ERRRGU + 33)
#define ERGU034 (ERRRGU + 34)
#define ERGU035 (ERRRGU + 35)
#define ERGU036 (ERRRGU + 36)
#define ERGU037 (ERRRGU + 37)
#define ERGU038 (ERRRGU + 38)
#define ERGU039 (ERRRGU + 39)
#define ERGU040 (ERRRGU + 40)
#define ERGU041 (ERRRGU + 41)
#define ERGU042 (ERRRGU + 42)
#define ERGU043 (ERRRGU + 43)
#define ERGU044 (ERRRGU + 44)
#define ERGU045 (ERRRGU + 45)
#define ERGU046 (ERRRGU + 46)
#define ERGU047 (ERRRGU + 47)
#define ERGU048 (ERRRGU + 48)
#define ERGU049 (ERRRGU + 49)
#define ERGU050 (ERRRGU + 50)
#define ERGU051 (ERRRGU + 51)
#define ERGU052 (ERRRGU + 52)
#define ERGU053 (ERRRGU + 53)
#define ERGU054 (ERRRGU + 54)
#define ERGU055 (ERRRGU + 55)
#define ERGU056 (ERRRGU + 56)
#define ERGU057 (ERRRGU + 57)
#define ERGU058 (ERRRGU + 58)
#define ERGU059 (ERRRGU + 59)
#define ERGU060 (ERRRGU + 60)
#define ERGU061 (ERRRGU + 61)
#define ERGU062 (ERRRGU + 62)
#define ERGU063 (ERRRGU + 63)
#define ERGU064 (ERRRGU + 64)
#define ERGU065 (ERRRGU + 65)
#define ERGU066 (ERRRGU + 66)
#define ERGU067 (ERRRGU + 67)
#define ERGU068 (ERRRGU + 68)
#define ERGU069 (ERRRGU + 69)
#define ERGU070 (ERRRGU + 70)
#define ERGU071 (ERRRGU + 71)
#define ERGU072 (ERRRGU + 72)
#define ERGU073 (ERRRGU + 73)
#define ERGU074 (ERRRGU + 74)
#define ERGU075 (ERRRGU + 75)
#define ERGU076 (ERRRGU + 76)
#define ERGU077 (ERRRGU + 77)
#define ERGU078 (ERRRGU + 78)
#define ERGU079 (ERRRGU + 79)
#define ERGU080 (ERRRGU + 80)
#define ERGU081 (ERRRGU + 81)
#define ERGU082 (ERRRGU + 82)
#define ERGU083 (ERRRGU + 83)
# 116 "../..//lterlcpdcp/kw_amm.c" 2
# 1 "../..//lterlcpdcp/kw_err.h" 1
# 94 "../..//lterlcpdcp/kw_err.h"
#define __KW_ERR_H__ 
# 123 "../..//lterlcpdcp/kw_err.h"
#define KW_GET_AND_VALIDATE_KWUSAP(_spId,_kwuSap,_errCode,_fn) _kwuSap = kwCb.kwuSap + _spId;

#define KWLOGERROR(errCls,errCode,errVal,errDesc) 
# 186 "../..//lterlcpdcp/kw_err.h"
#define PJLOGERROR(errCls,errCode,errVal,errDesc) 
...
#define EKW001 (ERRKW + 1)
#define EKW002 (ERRKW + 2)
#define EKW003 (ERRKW + 3)
#define EKW004 (ERRKW + 4)
#define EKW005 (ERRKW + 5)
#define EKW006 (ERRKW + 6)
#define EKW007 (ERRKW + 7)
#define EKW008 (ERRKW + 8)
#define EKW009 (ERRKW + 9)
#define EKW010 (ERRKW + 10)
#define EKW011 (ERRKW + 11)
#define EKW012 (ERRKW + 12)
#define EKW013 (ERRKW + 13)
#define EKW014 (ERRKW + 14)
#define EKW015 (ERRKW + 15)
#define EKW016 (ERRKW + 16)
#define EKW017 (ERRKW + 17)
#define EKW018 (ERRKW + 18)

#define EKW019 (ERRKW + 19)
#define EKW020 (ERRKW + 20)
#define EKW021 (ERRKW + 21)
#define EKW022 (ERRKW + 22)

#define EKW023 (ERRKW + 23)
#define EKW024 (ERRKW + 24)
#define EKW025 (ERRKW + 25)
#define EKW026 (ERRKW + 26)
#define EKW027 (ERRKW + 27)
#define EKW028 (ERRKW + 28)

#define EKW029 (ERRKW + 29)
#define EKW030 (ERRKW + 30)
#define EKW031 (ERRKW + 31)
#define EKW032 (ERRKW + 32)
#define EKW033 (ERRKW + 33)
#define EKW034 (ERRKW + 34)
#define EKW035 (ERRKW + 35)
#define EKW036 (ERRKW + 36)
#define EKW037 (ERRKW + 37)
#define EKW038 (ERRKW + 38)
#define EKW039 (ERRKW + 39)

#define EKW040 (ERRKW + 40)
#define EKW041 (ERRKW + 41)

#define EKW042 (ERRKW + 42)
#define EKW043 (ERRKW + 43)
#define EKW044 (ERRKW + 44)
#define EKW045 (ERRKW + 45)
#define EKW046 (ERRKW + 46)
#define EKW047 (ERRKW + 47)
#define EKW048 (ERRKW + 48)

#define EKW049 (ERRKW + 49)
#define EKW050 (ERRKW + 50)

#define EKW051 (ERRKW + 51)
#define EKW052 (ERRKW + 52)

#define EKW053 (ERRKW + 53)
#define EKW054 (ERRKW + 54)
#define EKW055 (ERRKW + 55)
#define EKW056 (ERRKW + 56)
#define EKW057 (ERRKW + 57)
#define EKW058 (ERRKW + 58)
#define EKW059 (ERRKW + 59)
#define EKW060 (ERRKW + 60)
#define EKW061 (ERRKW + 61)
#define EKW062 (ERRKW + 62)
#define EKW063 (ERRKW + 63)
#define EKW064 (ERRKW + 64)
#define EKW065 (ERRKW + 65)
#define EKW066 (ERRKW + 66)
#define EKW067 (ERRKW + 67)
#define EKW068 (ERRKW + 68)
#define EKW069 (ERRKW + 69)
#define EKW070 (ERRKW + 70)
#define EKW071 (ERRKW + 71)
#define EKW072 (ERRKW + 72)
#define EKW073 (ERRKW + 73)
#define EKW074 (ERRKW + 74)
#define EKW075 (ERRKW + 75)
#define EKW076 (ERRKW + 76)
#define EKW077 (ERRKW + 77)

#define EKW078 (ERRKW + 78)
#define EKW079 (ERRKW + 79)
#define EKW080 (ERRKW + 80)

#define EKW081 (ERRKW + 81)
#define EKW082 (ERRKW + 82)
#define EKW083 (ERRKW + 83)
#define EKW084 (ERRKW + 84)
#define EKW085 (ERRKW + 85)
#define EKW086 (ERRKW + 86)
#define EKW087 (ERRKW + 87)
#define EKW088 (ERRKW + 88)
#define EKW089 (ERRKW + 89)
#define EKW090 (ERRKW + 90)
#define EKW091 (ERRKW + 91)
#define EKW092 (ERRKW + 92)
#define EKW093 (ERRKW + 93)

#define EKW094 (ERRKW + 94)
#define EKW095 (ERRKW + 95)
#define EKW096 (ERRKW + 96)
#define EKW097 (ERRKW + 97)
#define EKW098 (ERRKW + 98)
#define EKW099 (ERRKW + 99)
#define EKW100 (ERRKW + 100)
#define EKW101 (ERRKW + 101)
#define EKW102 (ERRKW + 102)
#define EKW103 (ERRKW + 103)
#define EKW104 (ERRKW + 104)
#define EKW105 (ERRKW + 105)
#define EKW106 (ERRKW + 106)

#define EKW107 (ERRKW + 107)
#define EKW108 (ERRKW + 108)
#define EKW109 (ERRKW + 109)
#define EKW110 (ERRKW + 110)
#define EKW111 (ERRKW + 111)
#define EKW112 (ERRKW + 112)
#define EKW113 (ERRKW + 113)
#define EKW114 (ERRKW + 114)
#define EKW115 (ERRKW + 115)

#define EKW116 (ERRKW + 116)
#define EKW117 (ERRKW + 117)
#define EKW118 (ERRKW + 118)
#define EKW119 (ERRKW + 119)
#define EKW120 (ERRKW + 120)
#define EKW121 (ERRKW + 121)
#define EKW122 (ERRKW + 122)
#define EKW123 (ERRKW + 123)
#define EKW124 (ERRKW + 124)
#define EKW125 (ERRKW + 125)
#define EKW126 (ERRKW + 126)
#define EKW127 (ERRKW + 127)
#define EKW128 (ERRKW + 128)
#define EKW129 (ERRKW + 129)
#define EKW130 (ERRKW + 130)
#define EKW131 (ERRKW + 131)
#define EKW132 (ERRKW + 132)
#define EKW133 (ERRKW + 133)
#define EKW134 (ERRKW + 134)
#define EKW135 (ERRKW + 135)
#define EKW136 (ERRKW + 136)
#define EKW137 (ERRKW + 137)
#define EKW138 (ERRKW + 138)
#define EKW139 (ERRKW + 139)
#define EKW140 (ERRKW + 140)
#define EKW141 (ERRKW + 141)
#define EKW142 (ERRKW + 142)
#define EKW143 (ERRKW + 143)
#define EKW144 (ERRKW + 144)
#define EKW145 (ERRKW + 145)
#define EKW146 (ERRKW + 146)
#define EKW147 (ERRKW + 147)
#define EKW148 (ERRKW + 148)
#define EKW149 (ERRKW + 149)
#define EKW150 (ERRKW + 150)
#define EKW151 (ERRKW + 151)
#define EKW152 (ERRKW + 152)
#define EKW153 (ERRKW + 153)

#define EKW154 (ERRKW + 154)
#define EKW155 (ERRKW + 155)
#define EKW156 (ERRKW + 156)
#define EKW157 (ERRKW + 157)
#define EKW158 (ERRKW + 158)
#define EKW159 (ERRKW + 159)
#define EKW160 (ERRKW + 160)
#define EKW161 (ERRKW + 161)
#define EKW162 (ERRKW + 162)
#define EKW163 (ERRKW + 163)
#define EKW164 (ERRKW + 164)
#define EKW165 (ERRKW + 165)
#define EKW166 (ERRKW + 166)
#define EKW167 (ERRKW + 167)
#define EKW168 (ERRKW + 168)
#define EKW169 (ERRKW + 169)
#define EKW170 (ERRKW + 170)
#define EKW171 (ERRKW + 171)
#define EKW172 (ERRKW + 172)
#define EKW173 (ERRKW + 173)
#define EKW174 (ERRKW + 174)
#define EKW175 (ERRKW + 175)
#define EKW176 (ERRKW + 176)
#define EKW177 (ERRKW + 177)
#define EKW178 (ERRKW + 178)
#define EKW179 (ERRKW + 179)
#define EKW180 (ERRKW + 180)
#define EKW181 (ERRKW + 181)
#define EKW182 (ERRKW + 182)
#define EKW183 (ERRKW + 183)
#define EKW184 (ERRKW + 184)
#define EKW185 (ERRKW + 185)
#define EKW186 (ERRKW + 186)
#define EKW187 (ERRKW + 187)
#define EKW188 (ERRKW + 188)
#define EKW189 (ERRKW + 189)
#define EKW190 (ERRKW + 190)
#define EKW191 (ERRKW + 191)

#define EKW192 (ERRKW + 192)
#define EKW193 (ERRKW + 193)
#define EKW194 (ERRKW + 194)
#define EKW195 (ERRKW + 195)
#define EKW196 (ERRKW + 196)
#define EKW197 (ERRKW + 197)
#define EKW198 (ERRKW + 198)
#define EKW199 (ERRKW + 199)

#define EKW200 (ERRKW + 200)
#define EKW201 (ERRKW + 201)
#define EKW202 (ERRKW + 202)
#define EKW203 (ERRKW + 203)

#define EKW204 (ERRKW + 204)
#define EKW205 (ERRKW + 205)
#define EKW206 (ERRKW + 206)

#define EKW207 (ERRKW + 207)
#define EKW208 (ERRKW + 208)
#define EKW209 (ERRKW + 209)
#define EKW210 (ERRKW + 210)
#define EKW211 (ERRKW + 211)
#define EKW212 (ERRKW + 212)
#define EKW213 (ERRKW + 213)

#define EKW214 (ERRKW + 214)
#define EKW215 (ERRKW + 215)
#define EKW216 (ERRKW + 216)

#define EKW217 (ERRKW + 217)
#define EKW218 (ERRKW + 218)
#define EKW219 (ERRKW + 219)
#define EKW220 (ERRKW + 220)
#define EKW221 (ERRKW + 221)
#define EKW222 (ERRKW + 222)
#define EKW223 (ERRKW + 223)
#define EKW224 (ERRKW + 224)
#define EKW225 (ERRKW + 225)
#define EKW226 (ERRKW + 226)
#define EKW227 (ERRKW + 227)
# 117 "../..//lterlcpdcp/kw_amm.c" 2
# 1 "../..//lterlcpdcp/kw_env.h" 1
# 97 "../..//lterlcpdcp/kw_env.h"
#define __KWENVH__ 

#define KW_MAXIMUM_LI 60
...
#define KW_AM_UM_MAX_UL_SDUS 5
# 118 "../..//lterlcpdcp/kw_amm.c" 2
...
#define KW_SAP_NOT_CFG 0
#define KW_SAP_CFG 1
#define KW_SAP_BND 2
#define KW_SAP_BINDING 3
#define KW_SAP_UBND 4

#define KW_MAX_SAP_BND_RETRY 3

#define KW_MAX_UE 0xffffffff
#define KW_MAX_KWUSAPS 2
#define KW_MAX_CKWSAPS 1
#define KW_MAX_RGUSAPS 1


#define PJ_MAX_CPJSAPS 1
#define PJ_MAX_PJUSAPS 2

#define KW_LMM_GENCFG_DONE 1
#define PJ_LMM_GENCFG_DONE 2


#define KW_MAX_RGUSAP_TMR 1
...
#define KW_MAX_SDU_FAIL 10
#define KW_MAX_PDU_MAP 30
...
#define KW_ALLOC(_buf,_size) { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_buf, (Size) _size) == ROK) { cmMemset((U8 *)(_buf), 0, _size); } else { (_buf) = NULLP; } }
# 165 "../..//lterlcpdcp/kw.h"
#define KW_FREE(_buf,_size) { if (_buf != NULLP) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) _buf, (Size) _size); _buf = NULLP; } }
# 175 "../..//lterlcpdcp/kw.h"
#define KW_PST_FREE(_region,_pool,_buf,_size) { if (_buf != NULLP) { (Void) SPutSBuf(_region, _pool, (Data *) _buf, (Size) _size); _buf = NULLP; } }
# 185 "../..//lterlcpdcp/kw.h"
#define KW_FREE_BUF(_buf) { if (_buf != NULLP) { SPutMsg(_buf); } _buf = NULLP;}
# 194 "../..//lterlcpdcp/kw.h"
...
#define KW_SET_KWU_SAP_CB(_cb,_size) { _cb.kwuSap = (KwKwuSapCb *) rlAlloc (_size); }




#define KW_RMV_SDU(_sduQ,_sdu) { if(_sdu->mBuf) KW_FREE_BUF(_sdu->mBuf); _sdu->mBuf = NULLP; cmLListDelFrm(_sduQ,&_sdu->lstEnt); KW_FREE(_sdu, sizeof(KwSdu));}
# 235 "../..//lterlcpdcp/kw.h"
#define KW_RMV_SDU_UM(_sduQ,_sdu) { KW_RMV_SDU(_sduQ,_sdu); if (kwCb.numDlUmSdus == 0) { printf("ERROR: kwCb.numDlUmSdus is zero!\n"); } --kwCb.numDlUmSdus; }
# 246 "../..//lterlcpdcp/kw.h"
#define KW_ADD_PRE_MSG(_pduPtr,_liValue,_liSize) { Data liByte; U16 size; size = 0; while (_liSize > size ) { liByte = (U8) (_liValue >> (8*size)); SAddPreMsg((Data )liByte, _pduPtr); size++; }}
# 259 "../..//lterlcpdcp/kw.h"
#define KW_ADD_PRE_MSG_AM(_pduPtr,_hdr,_liSize) { Data liByte; S16 size; size = _liSize - 1; while (size >= 0 ) { liByte = (U8) (_hdr[size]); SAddPreMsg((Data )liByte, _pduPtr); size--; }}
# 285 "../..//lterlcpdcp/kw.h"
#define KW_SEND_SAPID_ALARM(_sapId,_evnt,_cause) { kwLmmSendAlarm(LCM_CATEGORY_INTERFACE, _evnt, _cause, _sapId, 0); }



#define KW_SEND_UEID_ALARM(_ueId,_evnt,_cause) { kwLmmSendAlarm(LCM_CATEGORY_INTERFACE, _evnt, _cause, 0, _ueId); }
...
#define KW_SET_USTA_FLAG(_kwCb,_value) { _kwCb.init.usta = _value; }
...
#define KW_VALIDATE_DIR_DL(_dir) { if (!(_dir & KW_DIR_DL)) { KWLOGERROR(ERRCLS_DEBUG, EKWxxx, (ErrVal) RFAILED, "KwUiCkwCfgReq: Sap Id Validation Failed."); RETVALUE(RFAILED); } }
# 345 "../..//lterlcpdcp/kw.h"
#define KW_VALIDATE_DIR_UL(_dir) { if (!(_dir & KW_DIR_UL)) { KWLOGERROR(ERRCLS_DEBUG, EKWxxx, (ErrVal) RFAILED, "KwUiCkwCfgReq: Sap Id Validation Failed."); RETVALUE(RFAILED); } }
# 356 "../..//lterlcpdcp/kw.h"
#define KW_CFG_FILL_CFG_CFM(_entCfm,_rbId,_rbType,_status,_reason) { _entCfm->rbId = _rbId; _entCfm->rbType = _rbType; _entCfm->status.status = _status; _entCfm->status.reason = _reason; }
# 367 "../..//lterlcpdcp/kw.h"
#define KW_SDU_ADD 1
...
# 395 "../..//lterlcpdcp/kw.h"
#define KW_VALDATE_SAP(_chkSpId,_sap,_ret) { if(_sap->state != KW_SAP_BND) { KWLOGERROR(ERRCLS_INT_PAR, EKWXXX, (ErrVal) RFAILED, "Sap State Invalid."); KW_SEND_SAPID_ALARM(0, LCM_EVENT_UI_INV_EVT, LCM_CAUSE_INV_STATE); _ret = RFAILED; } }
# 408 "../..//lterlcpdcp/kw.h"
#define KW_VALIDATE_LCHID(_LChId) { if (_LChId <= 0) { KW_CFG_FILL_CFG_CFM(entCfm, rbId, rbType, CKW_CFG_CFM_NOK, CKW_CFG_REAS_INVALID_LCHID); RETVALUE(RFAILED); } }
# 420 "../..//lterlcpdcp/kw.h"
...
#define UMDL rbCb->m.um.umDl
#define UMUL rbCb->m.um.umUl
...
#define KW_RMV_MAC_HDR_SZ(pduSz) { if (pduSz > 127) pduSz -= 3; else pduSz -= 2;}
...
#define KW_RMV_RLC_HDR_SZ(pduSz,snLen) { if ( snLen == 1 ) pduSz -= 1; else if ( snLen == 2 ) pduSz -= 2; }
...
#define KW_CREATE_UM_PDU(_rbCb,_pdu,_fi,_pduInfo,_ret) { MsgLen bytesSent = 0; _ret = kwUmmCreatePdu(_rbCb,&(_pdu),_fi); if (_ret == ROK ) { SFndLenMsg(pdu, &bytesSent); _pduInfo->mBuf[(_pduInfo->numPdu)++] = _pdu; kwCb.genSts.bytesSent += bytesSent; _pdu = NULLP; }}
# 487 "../..//lterlcpdcp/kw.h"
#define KW_UM_CHK_DUP_PDU(_rbCb,_curSn,_ret) { KwSn winSz = _rbCb->m.um.umUl.umWinSz << 1; KwSn _umReOrdWinSz = _rbCb->m.um.umUl.umWinSz; KwSn _vrUh = _rbCb->m.um.umUl.vrUh; KwSn _vrUr = _rbCb->m.um.umUl.vrUr; KwSn ur = KW_UM_GET_VALUE(_vrUr,_vrUh,_umReOrdWinSz,winSz); KwSn uh = KW_UM_GET_VALUE(_vrUh,_vrUh,_umReOrdWinSz,winSz); KwSn sn = KW_UM_GET_VALUE(_curSn,_vrUh,_umReOrdWinSz,winSz); if ( ((ur < sn) && (sn < uh) && (_rbCb->m.um.umUl.recBuf[_curSn] != NULLP)) || (sn < ur)) { _ret = TRUE; } else { _ret = FALSE; }}
# 509 "../..//lterlcpdcp/kw.h"
#define KW_UM_GET_VALUE(_val,_uh,_umReOrdWinSz,_umWinSz) ((_val-(_uh - (_umReOrdWinSz)) + _umWinSz) % (_umWinSz))


#define KW_CHK_SN_IN_REORD_WIN(_curSn,_rbCb,_ret) { KwSn _umWinSz = _rbCb->m.um.umUl.umWinSz << 1; KwSn _vrUh = _rbCb->m.um.umUl.vrUh; KwSn _umReOrdWinSz = _rbCb->m.um.umUl.umWinSz; if ((KW_UM_GET_VALUE(_curSn,_vrUh,_umReOrdWinSz,_umWinSz) < KW_UM_GET_VALUE (_vrUh,_vrUh,_umReOrdWinSz,_umWinSz))) { _ret = TRUE; } else { _ret = FALSE; }}
# 527 "../..//lterlcpdcp/kw.h"
#define KW_UM_FIND_NEXT_VRUR(_umUl,_prevVrUr,_vrUr) { KwUmRecBuf **umRecBuf = _umUl->recBuf; KwSn _umWinSz = _umUl->umWinSz << 1; KwSn _vrUh = _umUl->vrUh; KwSn _umReOrdWinSz = _umUl->umWinSz; KwSn ur = KW_UM_GET_VALUE(_vrUr,_vrUh,_umReOrdWinSz,_umWinSz); KwSn prvUr = KW_UM_GET_VALUE(_prevVrUr,_vrUh,_umReOrdWinSz,_umWinSz); while (ur < prvUr ) { if ( umRecBuf[_prevVrUr] == NULLP ) { _vrUr = _prevVrUr; break; } _prevVrUr = (_prevVrUr + 1) % _umWinSz; prvUr = KW_UM_GET_VALUE(_prevVrUr,_vrUh,_umReOrdWinSz,_umWinSz); }}
# 547 "../..//lterlcpdcp/kw.h"
#define KW_UEID rbCb->rlcId.ueId
#define KW_RBTYPE rbCb->rlcId.rbType
#define KW_RBID rbCb->rlcId.rbId

#define KW_UM_CHK_REORD_TMR(_rbCb) TRUE


#define AMDL rbCb->m.am.amDl
#define AMUL rbCb->m.am.amUl

#define KW_POLL_SET 0x20
#define KW_POLL_UNSET 0xdf
...
#define KW_LLIST_FIRST_SDU(lstCp,nod) { CmLList *tmpNode; CM_LLIST_FIRST_NODE(&(lstCp), tmpNode); if (tmpNode != NULLP) nod = (KwSdu *)tmpNode->node; else nod = NULLP; }
# 607 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_FIRST_SEG(lstCp,nod) { CmLList *tmpNode; CM_LLIST_FIRST_NODE(&(lstCp), tmpNode); if (tmpNode != NULLP) nod = (KwSeg *)tmpNode->node; else nod = NULLP; }
# 617 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_FIRST_RETX(lstCp,nod) { CmLList *tmpNode; CM_LLIST_FIRST_NODE(&(lstCp), tmpNode); if (tmpNode != NULLP) nod = (KwRetx *)tmpNode->node; else nod = NULLP; }
# 627 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_NEXT_SDU(lstCp,nod) { CmLList *tmpNode = NULLP; CM_LLIST_NEXT_NODE(&(lstCp), tmpNode); if (tmpNode != NULLP) nod = (KwSdu *)tmpNode->node; else nod = NULLP; }
# 637 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_NEXT_SEG(lstCp,nod) { CmLList *tmpNode; (lstCp).crnt = &((nod)->lstEnt); CM_LLIST_NEXT_NODE(&(lstCp), tmpNode); if (tmpNode != NULLP) nod = (KwSeg *)tmpNode->node; else nod = NULLP; }
# 648 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_NEXT_RETX(lstCp,nod) { CmLList *tmpNode; CM_LLIST_NEXT_NODE(&(lstCp), tmpNode); if (tmpNode != NULLP) nod = (KwRetx *)tmpNode->node; else nod = NULLP; }
# 658 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_LAST_RETX(lstCp,nod) { CmLList *tempNode = NULLP; cmLListLast(&lstCp); tempNode = cmLListCrnt(&lstCp); if (tempNode != NULLP) nod = (KwRetx *)tempNode->node; else nod = NULLP; }
# 669 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_LAST_SEG(lstCp,nod) { CmLList *tempNode = NULLP; cmLListLast(&lstCp); tempNode = cmLListCrnt(&lstCp); if (tempNode != NULLP) nod = (KwSeg *)tempNode->node; else nod = NULLP; }
# 680 "../..//lterlcpdcp/kw.h"
#define KW_LLIST_LAST_SDU(lstCp,nod) { CmLList *tempNode = NULLP; cmLListLast(&lstCp); tempNode = cmLListCrnt(&lstCp); if (tempNode != NULLP) nod = (KwSdu *)tempNode->node; else nod = NULLP; }
# 691 "../..//lterlcpdcp/kw.h"
#define CM_LLIST_INS_AFT_CRNT(lstCp,nod) { CmLList *nodeToIns = &nod->lstEnt; nodeToIns->node = (PTR) nod; cmLListInsAfterCrnt(&lstCp, nodeToIns); }
...
#define CM_LLIST_INS_BEF_CRNT(lstCp,nod) { CmLList *nodeToIns = &nod->lstEnt; nodeToIns->node = (PTR) nod; cmLListInsCrnt(&lstCp, nodeToIns); }
...
#define KW_LLIST_DEL_RECBUF(_recBuf) { KwSeg *_seg = NULLP; KW_LLIST_FIRST_SEG(_recBuf->segLst, _seg); while (_seg) { cmLListDelFrm(&_recBuf->segLst, &_seg->lstEnt); KW_FREE(_seg, sizeof(KwSeg)); KW_LLIST_NEXT_SEG(_recBuf->segLst, _seg); } }
# 718 "../..//lterlcpdcp/kw.h"
#define MODAMT(x,y,z) { y = ((x - z) + 1024) % 1024; }




#define MODAMR(x,y,z) { y = ((x - z) + 1024) % 1024; }





#define KW_UPD_AMBO(_amDl,_bo) { Bool winStall = FALSE; KwAmDl *tamDl = NULLP; tamDl = &_amDl; if (_amDl.bo < 0) _amDl.bo = 0; if (_amDl.cntrlBo < 0) _amDl.cntrlBo = 0; if (_amDl.retxBo < 0) _amDl.retxBo = 0; KW_AM_CHK_WINDOW_STALL(tamDl->vtS, tamDl, winStall); if (!winStall) { _bo = _amDl.bo + _amDl.cntrlBo + _amDl.retxBo; } else { _bo = _amDl.cntrlBo + _amDl.retxBo; } }
# 749 "../..//lterlcpdcp/kw.h"
#define KW_FILL_CNTRL_INFO(cntrlInfo,_val,_len,_idx,_eb) { cntrlInfo.val = _val; cntrlInfo.len = _len; cntrlInfo.idx = _idx; cntrlInfo.emtBits = _eb; }
...
#define KW_FILL_PREV_IDX(cntrlInfo,_e1Idx,_e2Idx,_e1eb,_idx,_eb) { _e1Idx = cntrlInfo.e1Idx; _e2Idx = cntrlInfo.e2Idx; _e1eb = cntrlInfo.e1eb; _idx = cntrlInfo.idx; _eb = cntrlInfo.emtBits;}
# 765 "../..//lterlcpdcp/kw.h"
#define KW_FILL_HDR_ARGS(hdrInfo,_val,_len) { hdrInfo.val = _val; hdrInfo.len = _len;}





#define KW_COPY_STAPDU(_i,_j) { U16 tmpPdu; tmpPdu = staPdu[_i]; cntrlPdu[_j++] = (U8)(tmpPdu >> KW_BYTE_LEN); cntrlPdu[_j++] = (U8)staPdu[_i]; }
# 782 "../..//lterlcpdcp/kw.h"
#define KW_AM_EXTN_HDRSZ(_numLi,_eHdrSz) { if ((_numLi - 1) % 2) { _eHdrSz = ((3 * (_numLi - 2)) >> 1) + 2; } else { _eHdrSz = (3 * (_numLi - 1)) >> 1; }}
# 794 "../..//lterlcpdcp/kw.h"
#define KW_DBG_SUB_MASK DBGMASK_MI
#define KW_DBGMASK_DETAIL (KW_DBG_SUB_MASK << 0)

#define KW_DBGMASK_BRIEF (KW_DBG_SUB_MASK << 1)


#define KW_DBGMASK_ERROR (KW_DBG_SUB_MASK << 2)
#define KW_DBGMASK_FATAL (KW_DBG_SUB_MASK << 3)


#define KW_DBG_MDL_MASK (KW_DBG_SUB_MASK << 4)

#define KW_DBGMASK_TM (KW_DBG_MDL_MASK << 0)
#define KW_DBGMASK_UM (KW_DBG_MDL_MASK << 1)
#define KW_DBGMASK_AM (KW_DBG_MDL_MASK << 2)
#define KW_DBGMASK_DL (KW_DBG_MDL_MASK << 3)
#define KW_DBGMASK_UL (KW_DBG_MDL_MASK << 4)
#define KW_DBGMASK_CFG (KW_DBG_MDL_MASK << 5)
#define KW_DBGMASK_LMM (KW_DBG_MDL_MASK << 6)
#define KW_DBGMASK_INF (KW_DBG_MDL_MASK << 7)
#define KW_DBGMASK_DUT (KW_DBG_MDL_MASK << 8)
#define KW_DBGMASK_MBUF_PRNT (KW_DBG_MDL_MASK << 9)

#define KW_DBGMASK_MEM_INFO (KW_DBG_MDL_MASK << 10)

#define KW_PJ_DBG_MDL_MASK (KW_DBG_MDL_MASK << 11)

#define KW_PJ_DBGMASK_DLM (KW_PJ_DBG_MDL_MASK << 0)
#define KW_PJ_DBGMASK_ULM (KW_PJ_DBG_MDL_MASK << 1)
#define KW_PJ_DBGMASK_UTL (KW_PJ_DBG_MDL_MASK << 2)
#define KW_PJ_DBGMASK_CFG (KW_PJ_DBG_MDL_MASK << 3)
#define KW_PJ_DBGMASK_LIB (KW_PJ_DBG_MDL_MASK << 4)

#define KW_PJ_DBGMASK_INF (KW_PJ_DBG_MDL_MASK << 5)
#define KW_PJ_DBGMASK_LMM (KW_PJ_DBG_MDL_MASK << 6)


#define _kwPBuf kwCb.init.prntBuf

#define KW_PRNT_BORDER do { KW_PRNT((_kwPBuf, "\n==========================\n")); }while(0)





#define KW_PRNT_HLINE(_pMsg) { sprintf(_kwPBuf, "[RLC_LAYER: %s:%d]::", __FILE__, __LINE__); SPrint(_kwPBuf); KW_PRNT_TSTAMP; sprintf(_kwPBuf, _pMsg); SPrint(_kwPBuf); }
# 849 "../..//lterlcpdcp/kw.h"
#define KW_PRNT(_prntbuf) { sprintf _prntbuf; SPrint(_kwPBuf); }
...
#define KW_PRNT_TSTAMP { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); KW_PRNT((_kwPBuf, "[%s]", _buf)); }
# 868 "../..//lterlcpdcp/kw.h"
#define KW_PRNT_MBUF(_mBufPtr) do { if(kwCb.init.dbgMask & (KW_DBGMASK_MBUF_PRNT)) { KW_PRNT_HLINE(("\nMessage Buffer Contents:\n")); SPrntMsg ((Buffer *)_mBufPtr, 0, 0); } }while(0)
# 878 "../..//lterlcpdcp/kw.h"
#define KW_PRNT_MEMINFO do { U32 _memInfo; if(kwCb.init.dbgMask & (KW_DBGMASK_MEM_INFO)) { KW_PRNT_HLINE(("\nMemory Information:\n")); SRegInfoShow(0, &_memInfo); } }while(0)
# 889 "../..//lterlcpdcp/kw.h"
#define KWDBGP(_mask,_arg) do { if (!((kwCb.init.dbgMask & _mask) ^ _mask)) { KW_PRNT_BORDER; KW_PRNT_HLINE(("\nDebug Log:\n")); KW_PRNT(_arg); KW_PRNT_BORDER; } }while(0)
# 912 "../..//lterlcpdcp/kw.h"
#define KW_PJ_PRNT_HLINE(_pMsg) { sprintf(_kwPBuf, "[PDCP_LAYER: %s:%d]::", __FILE__, __LINE__); SPrint(_kwPBuf); KW_PRNT_TSTAMP; sprintf(_kwPBuf, _pMsg); SPrint(_kwPBuf); }
# 921 "../..//lterlcpdcp/kw.h"
#define PJDBGP(_mask,_arg) do { if (!((kwCb.init.dbgMask & _mask) ^ _mask)) { KW_PRNT_BORDER; KW_PJ_PRNT_HLINE(("\nDebug Log:\n")); KW_PRNT(_arg); KW_PRNT_BORDER; } }while(0)
# 937 "../..//lterlcpdcp/kw.h"
...
#define KW_UPD_POLL_BIT(_retx,_poll) { U8 fHdr = 0x00; if (_poll != _retx->amHdr.p) { SRemPreMsg ((Data *)&fHdr, _retx->seg); if (_poll == TRUE) { fHdr = fHdr | KW_POLL_SET; } else { fHdr = fHdr & KW_POLL_UNSET; } SAddPreMsg ((Data)fHdr, _retx->seg); } _retx->amHdr.p = _poll; }
# 965 "../..//lterlcpdcp/kw.h"
#define KW_AM_ELIMINATE_EXTN_HDR(_pduSz,_sduSz,_numLi) { if ( (_pduSz > _sduSz) && (_sduSz < 2048) ) { _pduSz -= (_numLi % 2) ? 1 : 2; } }
# 974 "../..//lterlcpdcp/kw.h"
#define KW_AM_CHK_SN_IN_WINDOW(sn,amUl,snInWin) { if (amUl->vrR > amUl->vrMr) { if ((sn >= amUl->vrR) || (sn < amUl->vrMr)) { snInWin = TRUE; } } else { if ((sn >= amUl->vrR) && (sn < amUl->vrMr)) { snInWin = TRUE; } } }
# 993 "../..//lterlcpdcp/kw.h"
#define KW_AM_CHK_WINDOW_STALL(_sn,_amDl,_winStall) { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; _winStall = FALSE; MODAMT(_amDl->vtA, _vtA, _amDl->vtA); MODAMT(_sn, _mSn, _amDl->vtA); MODAMT(_amDl->vtMs, _vtMs, _amDl->vtA); if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { _winStall = TRUE; } }
# 1010 "../..//lterlcpdcp/kw.h"
#define KW_CHK_FOR_POLLSN(_rbCb,_mAckSn) { KwSn _mSn = 0; KwSn _mVtA = 0; MODAMT(_rbCb->m.am.amDl.pollSn, mSn, _rbCb->m.am.amDl.vtA); MODAMT(_rbCb->m.am.amDl.vtA, _mVtA, _rbCb->m.am.amDl.vtA); if ( (_mSn >= _mVtA) && (_mSn <= _mAckSn) ) { Bool _tmrRunning = FALSE; _tmrRunning = kwChkTmr((PTR)_rbCb, KW_EVT_AMDL_POLL_RETX_TMR); if (_tmrRunning) { kwStopTmr((PTR)_rbCb, KW_EVT_AMDL_POLL_RETX_TMR); } } }
# 1031 "../..//lterlcpdcp/kw.h"
#define KW_POWER(x,y) x << (y-1);


#define KW_DBM_FETCH_RBCB(_rbId,_rbType,_ueCb,_rbCb) { RbCb **_rbCbLst; _rbCbLst = (_rbType==CM_LTE_SRB)?_ueCb->srbCb:_ueCb->drbCb; if (_rbCbLst[_rbId] != NULLP) { _rbCb = _rbCbLst[_rbId]; } else { _rbCb = NULLP; } }
# 1048 "../..//lterlcpdcp/kw.h"
#define KW_DBM_FETCH_CELL_RBCB(_rbId,_rbCbLst,_rbCb) { if (_rbCbLst[_rbId] != NULLP) { _rbCb = _rbCbLst[_rbId]; } else { _rbCb = NULLP; } }
# 1158 "../..//lterlcpdcp/kw.h"
#define KW_DBM_CREATE_RBCB(_rbId,_rbType,_ueCb,_rbCb) { RbCb **_rbCbLst; KW_ALLOC(_rbCb, sizeof(RbCb)); if ( rbCb == NULLP) { KW_CFG_FILL_CFG_CFM(entCfm, _rbId, _rbType, CKW_CFG_CFM_NOK, CKW_CFG_REAS_RB_CREAT_FAIL); KWDBGP((KW_DBGMASK_CFG | KW_DBGMASK_ERROR), (_kwPBuf, "kwCfgAddRb -- kwDbmCreateRbCb Failed, rbId(%d)\n", rbId)); RETVALUE(RFAILED); } _rbCb->kwRbCb.rlcId.rbId = _rbId; _rbCbLst = (_rbType==CM_LTE_SRB)?_ueCb->srbCb:_ueCb->drbCb; _rbCbLst[_rbId] = (_rbCb); KW_LMM_RB_STS_INC() }
# 1183 "../..//lterlcpdcp/kw.h"
#define KW_DBM_CREATE_CELL_RBCB(_rbId,_rbCbLst,_rbCb) { KW_ALLOC(_rbCb, sizeof(RbCb)); if ( rbCb == NULLP) { KW_CFG_FILL_CFG_CFM(entCfm, rbId, CM_LTE_SRB, CKW_CFG_CFM_NOK, CKW_CFG_REAS_RB_CREAT_FAIL); KWDBGP((KW_DBGMASK_CFG | KW_DBGMASK_ERROR), (_kwPBuf, "kwCfgAddRb -- kwDbmCreateRbCb Failed, rbId(%d)\n", rbId)); RETVALUE(RFAILED); } _rbCb->kwRbCb.rlcId.rbId = _rbId; _rbCbLst[_rbId] = (_rbCb); KW_LMM_RB_STS_INC() }
# 1244 "../..//lterlcpdcp/kw.h"
#define KW_DBM_DELETE_RBCB(_rbCb) { if(0 == (_rbCb->kwRbCb.rbOp & 0x0c) ) { KW_FREE(_rbCb, sizeof(RbCb)); } else { _rbCb = NULLP; } KW_LMM_RB_STS_DEC(); }
# 1266 "../..//lterlcpdcp/kw.h"
#define kwCpyMsg(x,y) (SAddMsgRef((x), KW_GET_MEM_REGION(kwCb), KW_GET_MEM_POOL(kwCb), (y)))



#define KW_VALIDATE_RBID(_ueId,_rbId,_rbType,_ret) { _ret = ROK; if (_ueId == 0) { if (_rbId >= KW_MAX_RB_PER_CELL) { _ret = RFAILED; } } else { if ((_rbType != CM_LTE_SRB) && (_rbType != CM_LTE_DRB)) { _ret = RFAILED; } else if (_rbType == CM_LTE_SRB &&_rbId >= KW_MAX_SRB_PER_UE) { _ret = RFAILED; } else if (_rbType == CM_LTE_DRB &&_rbId >= KW_MAX_DRB_PER_UE) { _ret = RFAILED; } } }
# 1298 "../..//lterlcpdcp/kw.h"
#define KW_LMM_RB_STS_INC() { kwCb.genSts.numOfRb++; }




#define KW_LMM_RB_STS_DEC() { kwCb.genSts.numOfRb--; }




#define KW_FREE_DAT_IND_BUF(_datIndInfo) { U8 pduCount = 0; U8 lchCount = 0; RguPduInfo _pduInfo; U8 numLch = _datIndInfo->numLch; for( lchCount = 0; lchCount < numLch; lchCount++ ) { _pduInfo = _datIndInfo->lchData[lchCount].pdu; for ( pduCount = 0;pduCount < _pduInfo.numPdu; pduCount++) { KW_FREE_BUF(_pduInfo.mBuf[pduCount]); } } }
# 1357 "../..//lterlcpdcp/kw.h"
...
#define PJ_SAP_NOT_CFG 0
#define PJ_SAP_CFG 1
#define PJ_SAP_BND 2
#define PJ_SAP_BINDING 3
#define PJ_SAP_UBND 4


#define PJ_RB_MAX_TIMERS 1
#define PJ_MAX_OBD_TMR 3
#define PJ_MAX_DISC_TMR 1
#define PJ_EVT_DISC_TMR 0x10
...
# 1453 "../..//lterlcpdcp/kw.h"
#define KW_PJ_ASYNC_WIN 16
# 1525 "../..//lterlcpdcp/kw.h"
...
# 1587 "../..//lterlcpdcp/kw.h"
#define PJ_VALDATE_SAP(_chkSpId,_sap,_ret) { if(_sap->state != PJ_SAP_BND) { PJLOGERROR(ERRCLS_INT_PAR, EKWXXX, (ErrVal) RFAILED, "Sap State Invalid."); pjLmmSendAlarm(LCM_CATEGORY_INTERFACE, LCM_EVENT_UI_INV_EVT, LCM_CAUSE_INV_STATE, 0, 0); _ret = RFAILED; } }
# 1602 "../..//lterlcpdcp/kw.h"
#define KW_PJDBM_CREATE_RBCB(_rbCb,_rbCbLst,_rbId,_rbType) { KW_ALLOC(_rbCb, sizeof(RbCb)); if ( rbCb != NULLP) { _rbCbLst[_rbId] = (_rbCb); _rbCb->kwRbCb.rlcId.rbId = _rbId; } }
# 1615 "../..//lterlcpdcp/kw.h"
#define PJ_CFG_FILL_CFG_CFM(_entCfm,_rbId,_rbType,_status,_reason) { _entCfm->rbId = _rbId; _entCfm->rbType = _rbType; _entCfm->status = _status; _entCfm->reason = _reason; }
...
#define PJ_CFG_FILL_SECCFG_CFM(_entCfm,_ueId,_cellId,_transId,_status,_reason) { _entCfm->ueId = _ueId; _entCfm->cellId = _cellId; _entCfm->transId = _transId; _entCfm->status = _status; _entCfm->reason = _reason; }
# 1632 "../..//lterlcpdcp/kw.h"
#define PJ_CFG_FILL_SDUSTA_CFM(_entCfm,_ueId,_cellId,_transId,_status,_reason) { _entCfm->ueId = _ueId; _entCfm->cellId = _cellId; _entCfm->transId = _transId; _entCfm->status = _status; _entCfm->reason = _reason; }
# 1641 "../..//lterlcpdcp/kw.h"
#define PJ_CFG_FILL_REESTREQ_CFM(_entCfm,_ueId,_cellId,_transId,_status) { _entCfm->ueId = _ueId; _entCfm->cellId = _cellId; _entCfm->transId = _transId; _entCfm->status = _status; }
...
#define PJ_UPD_COUNT(_pjRbCb,_sn,_txHfn,_count) { _count = _sn; _txHfn = _txHfn << (_pjRbCb->snLen); _count |= _txHfn; }
...
#define PJ_ADD_PRE_MSG(_pdu,_hdr,_numBytes,_ret) { Data _liByte; U16 _bytes; _bytes = 0; while (_numBytes > _bytes ) { _liByte = (U8) (_hdr >> (8*_bytes)); _ret = SAddPreMsg((Data )_liByte, _pdu); if ( _ret != ROK ) { break; } _bytes++; } }
# 1673 "../..//lterlcpdcp/kw.h"
#define PJ_RESET_ALL_VAR(_pjRbCb) { _pjRbCb->dlCb.nxtTxSn = 0; _pjRbCb->dlCb.txHfn = 0; _pjRbCb->dlCb.nxtToSub = 0; _pjRbCb->dlCb.cfmExp = 0; _pjRbCb->dlCb.count = 0; }
# 1682 "../..//lterlcpdcp/kw.h"
#define PJ_ALLOC(_buf,_size) { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&_buf, (Size) _size) == ROK) { cmMemset((U8 *)(_buf), 0, _size); } else { (_buf) = NULLP; } }
# 1695 "../..//lterlcpdcp/kw.h"
#define PJ_ALLOC_BUF(_buf) { if (SGetMsg(kwCb.init.region, kwCb.init.pool, (Buffer **)&_buf) != ROK) { (_buf) = NULLP; } }
...
#define PJ_FREE_BUF(_buf) { if (_buf != NULLP) { SPutMsg(_buf); } _buf = NULLP; }
# 1712 "../..//lterlcpdcp/kw.h"
#define PJ_FREE(_buf,_size) { if (_buf != NULLP) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) _buf, (Size) _size); _buf = NULLP; } }
# 1722 "../..//lterlcpdcp/kw.h"
#define PJ_PST_FREE(_region,_pool,_buf,_size) { if (_buf != NULLP) { (Void) SPutSBuf(_region, _pool, (Data *) _buf, (Size) _size); _buf = NULLP; } }
# 1732 "../..//lterlcpdcp/kw.h"
#define PJ_CPY_MSG(_x,_y,_ret) _ret =(SAddMsgRef((_x), KW_GET_MEM_REGION(kwCb), KW_GET_MEM_POOL(kwCb), (_y)))

#define PJ_MEM_CPY(_dst,_src,_size) { cmMemcpy((U8*)_dst, (U8 *)_src, _size); }




#define PJ_DLM_UPD_VAR(_pjRbCb,_sn,_txHfn) { PjDlCb *_dlCb; U32 _maxTxSn; _dlCb = &_pjRbCb->dlCb; _sn = _dlCb->nxtTxSn; _txHfn = _dlCb->txHfn; _maxTxSn = (1 << _pjRbCb->snLen); if ( (++_dlCb->nxtTxSn) == _maxTxSn) { _dlCb->txHfn++; _dlCb->nxtTxSn = 0; } }
# 1755 "../..//lterlcpdcp/kw.h"
#define PJ_FILL_CFM_OK(_pjRbCb,_fms,_datCfm) { U32 _startCount = _pjRbCb->dlCb.cfmExp; U32 _stopCount = _pjRbCb->dlCb.cfmExp; PjTxEnt *_ent; _ent = (PjTxEnt *)pjDbmGetTxEntSn( &(_pjRbCb->dlCb.txBuf), _fms); if ( _ent != NULLP ) { _stopCount = _ent->count; _pjRbCb->dlCb.cfmExp = _ent->count; _pjRbCb->dlCb.nxtToSub = _ent->count; } while ( _startCount < _stopCount ) { _ent = (PjTxEnt *)pjDbmGetTxEnt( &(_pjRbCb->dlCb.txBuf), _startCount); if ( _ent != NULLP ) { if ( _pjRbCb->dlCb.cfmReqd) { _datCfm->cfmSta[_datCfm->numSdus].sduId = _ent->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = PJ_CFM_OK; _datCfm->numSdus++; } pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), _ent->count); } _startCount++; } }
# 1784 "../..//lterlcpdcp/kw.h"
#define PJ_UPD_CFM_EXP(_dlCb) { U32 _curCount = _dlCb->count; U32 _count = _dlCb->cfmExp; PjTxEnt *_txEnt = NULLP; while ( _count <= _curCount ) { _txEnt = (PjTxEnt *)pjDbmGetTxEnt(&(_dlCb->txBuf), _count); if ( _txEnt != NULLP ) { break; } _count++; } _dlCb->cfmExp = _count; }
# 1800 "../..//lterlcpdcp/kw.h"
#define PJ_SND_CFM(_pjRbCb,_txEnt,_cause) { PjuDatCfmInfo *_datCfm; CmLtePdcpId *_pdcpId; KwPjuSapCb *_pjuSap; if (_pjRbCb->rbType == PJ_SRB) _pjuSap = &(kwCb.pjuSap[PJ_SRB_SAP]); else _pjuSap = &(kwCb.pjuSap[PJ_DRB_SAP]); PJ_ALLOC( _datCfm, sizeof(PjuDatCfmInfo)); PJ_ALLOC( _pdcpId, sizeof(CmLtePdcpId)); if ( _datCfm != NULLP && _pdcpId != NULLP ) { _datCfm->cfmSta[_datCfm->numSdus].sduId = _txEnt->sduId; _datCfm->cfmSta[_datCfm->numSdus].status = _cause; _datCfm->numSdus++; _pdcpId->rbId = _pjRbCb->rbId; _pdcpId->rbType = _pjRbCb->rbType; _pdcpId->ueId = _pjRbCb->ueCb->key.ueId; _pdcpId->cellId = _pjRbCb->ueCb->key.cellId; PjUiPjuDatCfm(&(_pjuSap->pst), _pjuSap->suId, _pdcpId, _datCfm); } pjDbmDelTxEnt( &(pjRbCb->dlCb.txBuf), _txEnt->count); }
# 1826 "../..//lterlcpdcp/kw.h"
#define PJ_UPD_DL_VAR(_pjRbCb,_curCnt) { U32 _count = _curCnt + 1; if ( _pjRbCb->dlCb.nxtToSub == _curCnt ) { _pjRbCb->dlCb.nxtToSub = _count; } if ( _pjRbCb->dlCb.cfmExp == _curCnt ) { _pjRbCb->dlCb.cfmExp = _count; } }
# 1839 "../..//lterlcpdcp/kw.h"
#define PJ_CREATE_NEW_LIST(_pjRbCb,_tmpTxBuf,_ret) { _tmpTxBuf.datQ = _pjRbCb->dlCb.txBuf.datQ; _tmpTxBuf.numEntries = pjRbCb->dlCb.txBuf.numEntries; _tmpTxBuf.numBins = pjRbCb->dlCb.txBuf.numBins; pjDbmBufInit(&pjRbCb->dlCb.txBuf,kwCb.pjGenCfg.nmbDlBins); if ( _pjRbCb->dlCb.txBuf.datQ == NULLP ) { PJLOGERROR(ERRCLS_ADD_RES, EKWXXX, (ErrVal) RFAILED, "PJ_CREATE_NEW_LIST: PJ_ALLOC Failed."); _ret = RFAILED; } }
# 1853 "../..//lterlcpdcp/kw.h"
#define PJ_SND_ROHC_FDB(_pjRbCb,_rohcFdbPdu,_ret) { Data _hdr = 0; U8 _rbCfgStat = 0; U32 _count = 0; _hdr |= PJ_ROHC_FEEDBACK_HDR; _ret = SAddPreMsg((Data) _hdr, _rohcFdbPdu); if ( _ret != ROK ) { PJLOGERROR(ERRCLS_ADD_RES, EKWXXX, (ErrVal)0, "PJ_SND__ROHC_FDB: SAddPreMsg failed for pdu \n"); PJ_FREE_BUF(_rohcFdbPdu); _ret = RFAILED; } if (_pjRbCb->rbType == CM_LTE_SRB ) { _rbCfgStat = _pjRbCb->ueCb->srbCb[pjRbCb->rbId]->rbCfgStat; } else { _rbCfgStat = _pjRbCb->ueCb->drbCb[pjRbCb->rbId]->rbCfgStat; } if ( !(_rbCfgStat & PJ_CFG_RLC) ) { PJLOGERROR(ERRCLS_ADD_RES, EKWXXX, (ErrVal)0, "PJ_SND__ROHC_FDB: RLC is not configured \n"); PJ_FREE_BUF(_rohcFdbPdu); _ret = RFAILED; } if ( _pjRbCb->mode == PJ_DRB_UM ) { _count = _pjRbCb->dlCb.nxtToSub - 1; } else { _count = _pjRbCb->dlCb.cfmExp - 1; } if ( _ret == ROK ) { kwUimDatReq(_pjRbCb, _count, _rohcFdbPdu); } }
# 1897 "../..//lterlcpdcp/kw.h"
...
#define PJ_CHK_RESTART_OBD_TIMER(_ueCb,_cfgTxId) { U16 _idx; if(_ueCb->libInfo.crntTmrTxId == _cfgTxId) { pjStopTmr((PTR)_ueCb, PJ_EVT_OBD_WAIT_TMR); } if(pjChkTmr((PTR)_ueCb, PJ_EVT_OBD_WAIT_TMR) == FALSE) { for(_idx = 0; _idx < (PJ_MAX_ASYNC_CFM - 1) ; _idx++) { _ueCb->libInfo.crntTmrTxId = (_ueCb->libInfo.crntTmrTxId + 1) % PJ_MAX_ASYNC_CFM; if((_ueCb->libInfo.asyncCfm[_ueCb->libInfo.crntTmrTxId] != NULLP) && (_ueCb->libInfo.asyncCfm[_ueCb->libInfo.crntTmrTxId]->startTmr == TRUE)) { pjStartTmr((PTR)_ueCb, PJ_EVT_OBD_WAIT_TMR); break; } } } }
# 1971 "../..//lterlcpdcp/kw.h"
#define PJ_CLEAN_AND_UPD_ASYNCINFO(_ueCb,_txIdx) { PJ_FREE(_ueCb->libInfo.asyncCfm[_txIdx], sizeof(PjAsyncCfm)); _ueCb->libInfo.asyncCfm[_txIdx]=NULLP; if(_ueCb->libInfo.nxtAvlbTxId == PJ_MAX_ASYNC_CFM) { _ueCb->libInfo.nxtAvlbTxId = _txIdx; } }
# 1981 "../..//lterlcpdcp/kw.h"
#define PJ_FILL_TIMEOUT_CFG_CFM_INFO(_cfgCfm,_asyncCfm) { U16 _idx; PJ_ALLOC(_cfgCfm, sizeof(CpjCfgCfmInfo)); if (_cfgCfm != NULLP) { for ( _idx = 0; _idx < _asyncCfm->numEnt ; _idx++) { if ( _asyncCfm->cmpInitBitMask & (1 << (_asyncCfm->cfmEnt[_idx].rbId - 1))) { _cfgCfm->cfmEnt[_idx].status = CPJ_CFG_CFM_NOK; _cfgCfm->cfmEnt[_idx].reason = CPJ_CFG_REAS_OBD_TIMEOUT; } else { _cfgCfm->cfmEnt[_idx].status = _asyncCfm->cfmEnt[_idx].status; _cfgCfm->cfmEnt[_idx].reason = _asyncCfm->cfmEnt[_idx].reason; } _cfgCfm->cfmEnt[_idx].rbId = _asyncCfm->cfmEnt[_idx].rbId; _cfgCfm->cfmEnt[_idx].rbType = _asyncCfm->cfmEnt[_idx].rbType; } _cfgCfm->ueId = _asyncCfm->ueId; _cfgCfm->cellId = _asyncCfm->cellId; _cfgCfm->transId = _asyncCfm->transId; _cfgCfm->numEnt = _asyncCfm->numEnt; } }
# 2014 "../..//lterlcpdcp/kw.h"
#define PJ_ULM_UPD_NXT2DCOMP(_ulCb,_snLen,_sn,_oldRxCnt) { if(_oldRxCnt == _ulCb->nxtSubDeCmp) { PJ_GET_COUNT(_ulCb->nxtSubCnt, _snLen, _sn, _ulCb->rxHfn); } }
# 2058 "../..//lterlcpdcp/kw.h"
#define PJ_ULM_UPD_NXT2SUB(_ulCb,_cnt) 
#define PJ_INC_OBD_COUNT(_pjRbCb,_count) 
#define PJ_DEC_OBD_COUNT(_pjRbCb,_count) 


#define PJ_ULM_UPD_RX_VAR(_sn,_pjRbCb) { if(_sn < _pjRbCb->ulCb.nxtRxSn) { _pjRbCb->ulCb.rxHfn++; } _pjRbCb->ulCb.nxtRxSn = (_sn + 1) % (1 << _pjRbCb->snLen); if(_pjRbCb->ulCb.nxtRxSn == 0) { _pjRbCb->ulCb.rxHfn ++; } }
# 2077 "../..//lterlcpdcp/kw.h"
#define PJ_INC_SN(_sn,_snLen) ((++_sn) % (1 << _snLen))

#define PJ_GET_SN_HFN(_count,_snLen,_sn,_hfn) { _sn = _count % (1 << _snLen); _hfn = (_count >> _snLen); }
...
#define PJ_ULM_REEST_DRB_AM(_pjRbCb) { _pjRbCb->frstReEstCnt = _pjRbCb->lastSubCnt + 1; _pjRbCb->obdCnt = 0; }
...
#define PJ_ULM_UPD_HFN(_sn,_pjRbCb,_ulCb,_hfn) { if(_sn < _pjRbCb->ulCb.nxtRxSn) { _hfn = (_ulCb->rxHfn + 1 ); } else { _hfn = _ulCb->rxHfn; } }
# 2106 "../..//lterlcpdcp/kw.h"
#define PJ_ULM_SRB_UPD_COUNT(_sn,_pjRbCb,_ulCb,_count) { if(_sn < _ulCb->nxtRxSn) { _count = ((_ulCb->rxHfn + 1 ) << _pjRbCb->snLen) | _sn; } else { _count = (_ulCb->rxHfn << _pjRbCb->snLen) | _sn; } }
# 2119 "../..//lterlcpdcp/kw.h"
#define PJ_ULM_UPD_RXHFN(_ulCb,_sn) { if(_sn < _ulCb->nxtRxSn) ulCb->rxHfn ++; }
...
#define PJ_FILL_SDU_CFM_INFO(_cfmInfo,_ueCb) { U8 _rbCnt; U8 _numRb = 0; PjHoCfmInfo *_hoCfmInfo; CpjSduStaInfo *_staInfo; _cfmInfo->ueId = _ueCb->key.ueId; _cfmInfo->cellId = _ueCb->key.cellId; _cfmInfo->transId = _ueCb->hoInfo->transId; for(_rbCnt = 0; _rbCnt < KW_MAX_DRB_PER_UE && _numRb < CPJ_MAX_DRB; _rbCnt++) { _hoCfmInfo = &_ueCb->hoInfo->hoCfmInfo[_rbCnt]; _staInfo = &_cfmInfo->sduStaInfo[_numRb]; if(_hoCfmInfo->pres != TRUE) { continue; } _staInfo->rbId = _hoCfmInfo->rbId; _staInfo->dir = _hoCfmInfo->dir; _staInfo->ulSduStaInfo.numBits = _hoCfmInfo->ul.numBits; _staInfo->ulSduStaInfo.ulBitMap = _hoCfmInfo->ul.ulBitMap; _staInfo->ulSduStaInfo.count = _hoCfmInfo->ul.count; _staInfo->dlSduStaInfo.count = _hoCfmInfo->dl.count; _hoCfmInfo->ul.ulBitMap = NULLP; _numRb++; } _cfmInfo->numRb = _numRb; PJ_FREE(_ueCb->hoInfo->hoCfmInfo, (KW_MAX_DRB_PER_UE * sizeof(PjHoCfmInfo))) PJ_FREE(_ueCb->hoInfo, sizeof(PjHoInfo)); }
# 2159 "../..//lterlcpdcp/kw.h"
#define PJ_FILL_REEST_CFM_INFO(_reEstCfm,_asyncCfm,_status) { _reEstCfm->ueId = _asyncCfm->ueId; _reEstCfm->cellId = _asyncCfm->cellId; _reEstCfm->transId = _asyncCfm->transId; _reEstCfm->status = _status; }
...
#define PJ_FILL_SEC_CFM_INFO(_secCfgCfm,_asyncCfm) { _secCfgCfm->ueId = _asyncCfm->ueId; _secCfgCfm->cellId = _asyncCfm->cellId; _secCfgCfm->transId = _asyncCfm->transId; _secCfgCfm->status = CPJ_CFG_CFM_OK; _secCfgCfm->reason = CPJ_CFG_REAS_NONE; }
# 2176 "../..//lterlcpdcp/kw.h"
#define PJ_GET_COUNT(_count,_snLen,_sn,_hfn) { _count = (_hfn << _snLen) | _sn; }




#define PJ_GET_DATFWD_CNT(_pjRbCb,_datFwdSn,_count) { if((_pjRbCb->ulCb.nxtRxSn == 0) && (_pjRbCb->ulCb.rxHfn == 0)) { PJ_GET_COUNT(_count, PJ_DRBAM_SN_LEN, _datFwdSn, 0); } else if(_datFwdSn >= _pjRbCb->ulCb.nxtRxSn) { PJ_GET_COUNT(_count, PJ_DRBAM_SN_LEN, _datFwdSn, (_pjRbCb->ulCb.rxHfn)); } else { PJ_GET_COUNT(_count, PJ_DRBAM_SN_LEN, _datFwdSn, (_pjRbCb->ulCb.rxHfn + 1)); } }
# 2199 "../..//lterlcpdcp/kw.h"
#define PJ_ULM_DRBUM_REEST(_pjRbCb) { _pjRbCb->ulCb.nxtRxSn = 0; _pjRbCb->ulCb.rxHfn = 0; pjUlmDecReEstCnt(_pjRbCb); }
...
#define PJ_CHK_SN_OUTSIDE_WIN(_ulCb,_sn) ( (((_sn - (_ulCb->lastSubCnt % (1 << PJ_DRBAM_SN_LEN ))) % (1 << PJ_DRBAM_SN_LEN )) > PJ_DRB_AM_WINSIZE) || ((((_ulCb->lastSubCnt % (1 << PJ_DRBAM_SN_LEN )) - _sn) >= 0) && (((_ulCb->lastSubCnt % (1 << PJ_DRBAM_SN_LEN )) - _sn) < PJ_DRB_AM_WINSIZE)) )
# 2219 "../..//lterlcpdcp/kw.h"
#define PJ_DRBAM_ALL_PDU_RECVD(_pjRbCb) ((pjRbCb->rbType == PJ_DRB) && (pjRbCb->mode == PJ_DRB_AM) && (ulCb->lastSubCnt == ulCb->obdPdu))





#define PJ_STS_INC_GEN_CNT(_cntr) { kwCb.pjGenSts._cntr++; }




#define PJ_STS_INC_PJU_CNT(_rbType,_cntr) { if (_rbType == PJ_SRB) kwCb.pjuSap[PJ_SRB_SAP].sts._cntr++; else kwCb.pjuSap[PJ_DRB_SAP].sts._cntr++; }
...
#define PJ_PK_U8(_msg,_val,_ret) { (_ret) = SAddPstMsg((Data) (_val), (_msg)); }




#define PJ_PK_U16(_msg,_val,_ret) { PJ_PK_U8(_msg, (U8) GetHiByte(_val), _ret) if ((_ret) == ROK) PJ_PK_U8(_msg, (U8) GetLoByte(_val), _ret) }
...
#define PJ_PK_U32(_msg,_val,_ret) { U16 _tmp16; _tmp16 = (U16) GetHiWord(_val); PJ_PK_U16(_msg, _tmp16, _ret) if ((_ret) == ROK) { _tmp16 = (U16) GetLoWord(_val); PJ_PK_U16(_msg, _tmp16, _ret) } }
# 2262 "../..//lterlcpdcp/kw.h"
#define PJ_PACK_MACI(_mBuf,_macI) { U16 _tmp; Data _pkArray[4]; _tmp = (U16) GetHiWord(_macI); _pkArray[0] = (Data) GetHiByte(_tmp); _pkArray[1] = (Data) GetLoByte(_tmp); _tmp = (U16) GetLoWord(_macI); _pkArray[2] = (Data) GetHiByte(_tmp); _pkArray[3] = (Data) GetLoByte(_tmp); SAddPstMsgMult(_pkArray, (MsgLen) 4, _mBuf); }
# 2275 "../..//lterlcpdcp/kw.h"
#define PJ_UNPK_MACI(_mBuf,_macI) { U16 _tmp16 = 0; Data _unPkArray[4] = {0}; SRemPstMsgMult(_unPkArray, (MsgLen)4, _mBuf); _tmp16 = (U16) PutHiByte(_tmp16, (U8) _unPkArray[3]); _tmp16 = (U16) PutLoByte(_tmp16, (U8) _unPkArray[2]); _macI = (U32) PutHiWord(_macI, (U16) _tmp16); _tmp16 = (U16) PutHiByte(_tmp16, (U8) _unPkArray[1]); _tmp16 = (U16) PutLoByte(_tmp16, (U8) _unPkArray[0]); _macI = (U32) PutLoWord(_macI, (U16) _tmp16); }
# 2314 "../..//lterlcpdcp/kw.h"
typedef enum
{
   PJ_DIAG_UEID,
   PJ_DIAG_NA
...
#define PJ_DIAG_LVL0(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.pjInit.logMask & SS_DIAG_LVL0) { ssDiagFix(_tknId, _splArgEnum, ENTPJ, kwCb.pjInit.inst, SS_DIAG_LVL0, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2332 "../..//lterlcpdcp/kw.h"
#define PJ_DIAG_LVL1(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.pjInit.logMask & SS_DIAG_LVL1) { ssDiagFix(_tknId, _splArgEnum, ENTPJ, kwCb.pjInit.inst, SS_DIAG_LVL1, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2343 "../..//lterlcpdcp/kw.h"
#define PJ_DIAG_LVL2(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.pjInit.logMask & SS_DIAG_LVL2) { ssDiagFix(_tknId, _splArgEnum, ENTPJ, kwCb.pjInit.inst, SS_DIAG_LVL2, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2354 "../..//lterlcpdcp/kw.h"
#define PJ_DIAG_LVL3(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.pjInit.logMask & SS_DIAG_LVL3) { ssDiagFix(_tknId, _splArgEnum, ENTPJ, kwCb.pjInit.inst, SS_DIAG_LVL3, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2365 "../..//lterlcpdcp/kw.h"
#define PJ_DIAG_LVL4(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.pjInit.logMask & SS_DIAG_LVL4) { ssDiagFix(_tknId, _splArgEnum, ENTPJ, kwCb.pjInit.inst, SS_DIAG_LVL4, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2414 "../..//lterlcpdcp/kw.h"
typedef enum
{
   KW_DIAG_UEID,
   KW_DIAG_CRNTI,
...
#define KW_DIAG_LVL0(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.init.logMask & SS_DIAG_LVL0) { ssDiagFix(_tknId, _splArgEnum, ENTKW, kwCb.init.inst, SS_DIAG_LVL0, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); }}
# 2433 "../..//lterlcpdcp/kw.h"
#define KW_DIAG_LVL1(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.init.logMask & SS_DIAG_LVL1) { ssDiagFix(_tknId, _splArgEnum, ENTKW, kwCb.init.inst, SS_DIAG_LVL1, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2444 "../..//lterlcpdcp/kw.h"
#define KW_DIAG_LVL2(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.init.logMask & SS_DIAG_LVL2) { ssDiagFix(_tknId, _splArgEnum, ENTKW, kwCb.init.inst, SS_DIAG_LVL2, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2455 "../..//lterlcpdcp/kw.h"
#define KW_DIAG_LVL3(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.init.logMask & SS_DIAG_LVL3) { ssDiagFix(_tknId, _splArgEnum, ENTKW, kwCb.init.inst, SS_DIAG_LVL3, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 2466 "../..//lterlcpdcp/kw.h"
#define KW_DIAG_LVL4(_tknId,_splArgEnum,_splArg,_string,_arg1,_arg2,_arg3,_arg4) { if(kwCb.init.logMask & SS_DIAG_LVL4) { ssDiagFix(_tknId, _splArgEnum, ENTKW, kwCb.init.inst, SS_DIAG_LVL4, SS_DIAG_MSG_TYPE_FIXED, _splArg, _arg1, _arg2, _arg3, _arg4, _string); } }
# 125 "../..//lterlcpdcp/kw_amm.c" 2
...
#define MSPD_LOG(...) 
#define MSPD_ERR(...) 
# 129 "../..//lterlcpdcp/kw_amm.c" 2

# 1 "../..//cm/cm5.x" 1
# 131 "../..//lterlcpdcp/kw_amm.c" 2
# 1 "../..//cm/cm_tkns.x" 1
# 91 "../..//cm/cm_tkns.x"
#define __CMTKNSX 
# 121 "../..//cm/cm_tkns.x"
...
typedef struct kwUmUl
{
   ...
   CmLListCp toBeReasmbldUmPduLst;
...
typedef struct kwAmUl
{
   ...
   CmLListCp toBeReasmbldAmPduLst;
...
struct pjRbCb
{
   ...
   PjSn firstSn;
# 1097 "../..//lterlcpdcp/kw.x"
   PjDlCb dlCb;
   PjUlCb ulCb;
   KwUeCb *ueCb;
};
# 1129 "../..//lterlcpdcp/kw.x"
typedef struct rbCb
{
   KwRbCb kwRbCb;
...
typedef struct _kwCb
{
   ...
   KwPjuSapCb pjuSap[2];
   PjGenSts pjGenSts;
# 1298 "../..//lterlcpdcp/kw.x"
   CmLListCp reasmblyRbList;
   Buffer *mBufUl;
...
extern S16 pjUtlSecUpdAndSndReestCfm (KwUeCb *ueCb, PjRbCb *pjRbCb);
extern S16 kwGetSId (SystemId *s);

extern S16 kwTmmQSdu (KwRbCb *rbCb,KwuDatReqInfo *datReqInfo, Buffer *mBuf);

extern S16 kwTmmSndToLi (KwRbCb *rbCb,RguCStaIndInfo *staInd);

extern S16 kwTmmRcvFrmLi (KwRbCb *rbCb,CmLteRnti tCrnti, Buffer *pdu);




extern S16 kwTmmReEstablish (KwRbCb *rbCb);


extern S16 kwUmmQSdu (KwRbCb *rbCb,U32 sduId,Buffer *mBuf);
extern S16 kwUmmProcessSdus (KwRbCb *rbCb, KwDatReq *datReq);
# 1353 "../..//lterlcpdcp/kw.x"
extern S16 kwUmmProcessPdus ( KwRbCb *rbCb,KwPduInfo *pduInfo);

extern S16 kwUmmReEstablish (CmLteRlcId rlcId, KwRbCb *rbCb);
extern S16 kwUmmDiscSdu (KwRbCb *rbCb,U32 sduId);
extern S16 kwUmmReOrdTmrExp (KwRbCb *rbCb);


extern Void kwUmmProcessSelfMsgUl (KwRbCb *rbCb, U16 *numPdus);
extern Void kwUmmChkReasmblyLstSz (KwRbCb *rbCb);



extern S16 kwUtlRmvSdu (CmLListCp *sduQ,KwSdu *sdu, CmLList *firstNode);

extern S16 kwUtlSndDatInd (KwRbCb *rbCb, Buffer *sdu);




extern S16 kwUtlEmptySduQ (CmLListCp *sduQ);

extern S16 kwUtlEmptySduQInSlowPath (CmLListCp *sduQ, U8 *numOfTxReTxCnt);
extern S16 kwUtlSndDStaRsp (KwRbCb *rbCb,S32 bo,S32 estHdrSz, Bool staPduPrsnt);

extern S16 kwUtlSndCStaRsp (KwRbCb *rbCb,S32 bo);
extern S16 kwUtlSndToLi (KwDStaIndInfo *staIndInfo);
extern S16 kwUtlRcvFrmLi (KwDatIndInfo *datIndInfo);
extern S16 kwUtlShutDown (void);
extern S16 kwUtlCalcLiForSdu (U16 numLi,MsgLen msgLen,S16 *pduSz);
extern Void kwUtlFreeRbCb ( KwRbCb *rbCb);
# 1413 "../..//lterlcpdcp/kw.x"
extern Void kwUtlProcessSelfMsgUl (void);
extern Void kwUtlPostSelfMsgUl (U8 coreId);


extern S16 kwUtlSendRbReEstCfm (KwRbCb *rbCb);
extern S16 kwUtlRbDeletion (KwRbCb *rbCb);

extern Void kwUtlSetReestInProgress(KwUeCb *ueCb);

extern S16 kwStartTmr ( U32 cb, S16 tmrEvnt );
extern S16 kwStopTmr ( U32 cb, U8 tmrType );
extern S16 kwTmrExpiry ( U32 cb, S16 tmrEvnt );
extern Bool kwChkTmr ( U32 cb, S16 tmrEvnt );


extern S16 kwAmmQSdu ( KwRbCb *rbCb, Buffer *mBuf, U32 sduId );
extern S16 kwAmmProcessSdus ( KwRbCb *rbCb, KwDatReq *kwDatReq );
# 1439 "../..//lterlcpdcp/kw.x"
extern S16 kwAmmProcessPdus ( KwRbCb *rbCb, KwPduInfo *pduInfo);

extern S16 kwAmmDiscSdu ( KwRbCb *rbCb, U32 sduId);
extern S16 kwAmmReEstablish ( CmLteRlcId rlcId, KwRbCb *rbCb);
extern Void kwAmmReOrdTmrExp ( KwRbCb *rbCb);
extern Void kwAmmStaProTmrExp ( KwRbCb *rbCb);
extern Void kwAmmPollRetxTmrExp ( KwRbCb *rbCb);
# 1457 "../..//lterlcpdcp/kw.x"
extern Void kwAmmProcessSelfMsgUl (KwRbCb *rbCb, U16 *numPdus);
extern Void kwAmmChkReasmblyLstSz (KwRbCb *rbCb);


extern S16 kwCfgAddRb ( CmLteRnti ueId, CmLteCellId cellId, CkwEntCfgInfo *entCfg, CkwEntCfgCfmInfo *entCfm);

extern S16 kwCfgReCfgRb ( CmLteRnti ueId, CmLteCellId cellId, CkwEntCfgInfo *entCfg, CkwEntCfgCfmInfo *entCfm);

extern S16 kwCfgDelRb ( CmLteRnti ueId, CmLteCellId cellId, CkwEntCfgInfo *entCfg, CkwEntCfgCfmInfo *entCfm);

extern S16 kwCfgDelUe ( CmLteRnti ueId, CmLteCellId cellId, CkwEntCfgInfo *entCfg, CkwEntCfgCfmInfo *entCfm);

extern S16 kwCfgReEstRb ( CmLteRnti ueId, CmLteCellId cellId, CkwEntCfgInfo *entCfg, CkwEntCfgCfmInfo *entCfm);

extern S16 kwCfgDelCell ( CmLteCellId cellId, CkwEntCfgInfo *entCfg, CkwEntCfgCfmInfo *entCfm);

extern S16 kwCfgUeIdChng ( CkwUeInfo *ueInfo, CkwUeInfo *newUeInfo, CmStatus *status);
# 1483 "../..//lterlcpdcp/kw.x"
extern Void kwLmmSendAlarm ( U16 category, U16 event, U16 cause, SuId suId, U32 ueId);


extern S16 kwLmmSendTrc ( Event event, Buffer *mBuf);


extern S16 kwDbmInit (void);

extern S16 kwDbmDeInit (void);

extern S16 kwDbmCreateUeCb ( CmLteRnti ueId, CmLteCellId cellId, KwUeCb **ueCb );





extern S16 kwDbmFetchUeCb ( CmLteRnti ueId, CmLteCellId cellId, KwUeCb **ueCb );





extern S16 kwDbmDelUeCb ( KwUeCb *ueCb, Bool abortFlag );




extern S16 kwDbmDelAllUe (void);

extern S16 kwDbmCreateCellCb ( CmLteCellId cellId, KwCellCb **cellCb );




extern S16 kwDbmFetchCellCb ( CmLteCellId cellId, KwCellCb **cellCb );




extern S16 kwDbmDelCellCb ( KwCellCb *cellCb );



extern S16 kwDbmDelAllCell (void);

extern S16 kwDbmFetchRbCbForUi ( CmLteRlcId rlcId, KwRbCb **rbCb );




extern S16 kwDbmFetchRbCbForLi ( CmLteRnti ueId, CmLteCellId cellId, CmLteLcId lcId, U8 dir, KwRbCb **rbCb );
...
extern S16 kwDbmDelAllRb ( RbCb **rbCbLst, U8 numRbCb );




extern S16 kwDbmShutdown (void);
...
extern S16 kwActvInit ( Ent ent, Inst inst, Region region, Reason reason );
...
extern S16 kwActvTsk ( Pst *pst, Buffer *mBuf );
...
extern S16 pjActvInit ( Ent ent, Inst inst, Region region, Reason reason );
...
extern S16 pjActvTsk ( Pst *pst, Buffer *mBuf );





extern S16 pjCfgAddRb ( CmLteRnti ueId, CmLteCellId cellId, CpjCfgEnt *entCfg, CpjCfmEnt *entCfm );
...
extern S16 pjCfgReCfgRb ( CmLteRnti ueId, CmLteCellId cellId, CpjCfgEnt *entCfg, CpjCfmEnt *entCfm );
...
extern S16 pjCfgDelRb ( CmLteRnti ueId, CmLteCellId cellId, CpjCfgEnt *entCfg, CpjCfmEnt *entCfm );
...
extern S16 pjCfgReEstRb ( CmLteRnti ueId, CmLteCellId cellId, CpjCfgEnt *entCfg, CpjCfmEnt *entCfm );
...
extern S16 pjCfgDelUe ( CmLteRnti ueId, CmLteCellId cellId, CpjCfgEnt *entCfg, CpjCfmEnt *entCfm );
...
extern S16 pjCfgPrcSecCfg ( CpjSecCfgReqInfo *secCfg, CpjSecCfgCfmInfo *cfgCfm );




extern S16 pjCfgUeIdChng ( CpjUeInfo *ueInfo, CpjUeInfo *newUeInfo, CmStatus *status );





extern S16 pjCfgPrcCount ( CpjCountReqInfo *countReq, CpjCountCfmInfo *countCfm );




extern S16 pjCfgPrcSduSta ( CpjSduStaReqInfo *staReq );




extern S16 pjCfgDelPjRBCb ( KwUeCb *ueCb, RbCb *rbCb );




extern S16 pjCfgReEstReq ( CpjReEstReqInfo *reEstReq, CpjReEstCfmInfo *reEstCfm );





extern S16 pjDlmProcessSdus ( PjRbCb *pjRbCb, Buffer *sdu, U32 sduId, PjSn sn, U32 txHfn );
...
extern S16 pjDlmProcDrb ( PjRbCb *pjRbCb, PjTxEnt *txEnt );



extern S16 pjDlmProcSrb ( PjRbCb *pjRbCb, PjTxEnt *txEnt );



extern Void pjDlmReEstSrb ( PjRbCb *pjRbCb );



extern S16 pjDlmReEstDrbUm ( PjRbCb *pjRbCb );



extern S16 pjDlmReEstDrbAm ( PjRbCb *pjRbCb );


extern S16 pjDlmProcessCfm ( PjRbCb *pjRbCb, PjDatCfm *pjDatCfm, U8 cfmType );




extern S16 pjDlmHndlStaRep ( PjRbCb *pjRbCb, PjSn fms, Buffer *staPdu );




extern S16 pjDlmReEstHoDrbAm ( PjRbCb *pjRbCb );


extern S16 pjDlmHndlDatFwdReq ( PjRbCb *pjRbCb, PjuDatFwdReqInfo *datFwdReq );



extern S16 pjDlmDeliverPdu ( PjRbCb *pjRbCb, PjTxEnt *txEnt );



extern S16 pjDlmObdTmrExp ( PjRbCb *pjRbCb );


extern S16 pjDlmHdlIntProt ( PjRbCb *pjRbCb, PjTxEnt *txEnt );



extern S16 pjDlmHdlCmp ( PjRbCb *pjRbCb, PjTxEnt *txEnt );



extern S16 pjDlmHdlCiph ( PjRbCb *pjRbCb, PjTxEnt *txEnt );



extern S16 pjDlmDiscTmrExp ( PjRbCb *pjRbCb );




extern S16 pjUlmHdlSrbPkt ( PjRbCb *pjRbCb, Buffer *pdu );



extern S16 pjUlmHdlDrbPkt ( PjRbCb *pjRbCb, Buffer *pdu );



extern S16 pjUlmProcessSrb ( PjRbCb *pjRbCb, PjSn sn, Buffer *pdu );




extern S16 pjUlmProcessDrbUm ( PjRbCb *pjRbCb, PjSn sn, Buffer *pdu );




extern S16 pjUlmProcessDrbAm ( PjRbCb *pjRbCb, PjSn sn, Buffer *pdu );




extern S16 pjUlmHdlDecipher ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern S16 pjUlmHdlIntVer ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern S16 pjUlmHdlDeCmp ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern S16 pjUlmDeliverSrb ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern S16 pjUlmDeliverDrbUm ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern S16 pjUlmDeliverDrbAm ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern S16 pjUlmReEstSrb ( PjRbCb *pjRbCb );


extern S16 pjUlmReEstDrbAm ( PjRbCb *pjRbCb );


extern S16 pjUlmBldStaRep ( PjRbCb *pjRbCb, PjSn fms, Buffer *staRep );




extern S16 pjUlmHdlDatFwdReq ( PjRbCb *pjRbCb, PjuDatFwdReqInfo *datFwdReq );



extern S16 pjUlmSubmitForDecmp ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );





extern Void pjUlmGetSubCnt ( PjRbCb *pjRbCb, U32 *subPdu );



extern Void pjUlmGetDrbAmSubCnt ( PjRbCb *pjRbCb, U32 *nxtSubCnt );



extern Void pjUlmDeliverPdu ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );




extern Void pjUlmDeliverDrb ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern Void pjUlmDecReEstCnt ( PjRbCb *pjRbCb );


extern Void pjUlmChkRdyToDeliver ( PjRbCb *pjRbCb );


extern Void pjUlmSndPjuDatInd ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern Void pjUlmSndPjuStaInd ( PjRbCb *pjRbCb, PjRxEnt *rxEnt );



extern S16 pjUtlSaveCfmInfo ( KwUeCb *ueCb, U8 cfmType, Bool startTmr, U8 entity, U32 cfmPtr, U32 cfgPtr );
...
extern S16 pjUtlHdlObdInitCfm ( KwUeCb *ueCb, U16 txIdx, U8 cfmType, U8 maskVal );





extern S16 pjUtlHdlInitObdTmrExp ( KwUeCb *ueCb );
# 1847 "../..//lterlcpdcp/kw.x"
extern Void pjUtlPerfErrUpd ( PjRbCb *pjRbCb, U32 count );



extern Void pjUtlCalNxt2Sub ( PjUlCb *ulCb );


extern Void pjUtlFillReEstCfgCfmInfo ( CpjCfgCfmInfo *cfmInfo, PjAsyncCfm *asyncCfm );
# 1863 "../..//lterlcpdcp/kw.x"
extern Void pjUlmHdlErrUpdates ( PjRbCb *pjRbCb, U32 errCnt );





extern S16 pjDbmInsTxEnt ( PjBuf *buf, PjTxEnt *txEnt );



extern S16 pjDbmBufInit ( PjBuf *buf, U8 numBins );



extern PjTxEnt* pjDbmGetTxEnt ( PjBuf *buf, U32 count );



extern PjTxEnt* pjDbmGetTxEntSn ( PjBuf *buf, U16 sn );



extern S16 pjDbmDelTxEnt ( PjBuf *buf, U32 count );



extern S16 pjDbmTxDelAll ( PjBuf *buf );


extern S16 pjDbmTxDeInit ( PjBuf *buf );


extern S16 pjDbmInsRxEnt ( PjBuf *buf, PjRxEnt *rxEnt, Bool dupFlag );




extern PjRxEnt* pjDbmGetRxEnt ( PjBuf *buf, U32 count );



extern S16 pjDbmDelRxEnt ( PjBuf *buf, U32 count );



extern S16 pjDbmRxDelAll ( PjBuf *buf );


extern S16 pjDbmRxDeInit ( PjBuf *buf );




extern S16 pjStartTmr ( U32 cb, S16 tmrEvnt );




extern S16 pjStopTmr ( U32 cb, U8 tmrType );




extern Bool pjChkTmr ( U32 cb, S16 tmrEvnt );
...
extern S16 pjUtlCmpInit ( PjRbCb *pjRbCb );


extern S16 pjUtlIntInit ( KwUeCb *ueCb );


extern S16 pjUtlCpInit ( KwUeCb *ueCb );


extern S16 pjUtlUpInit ( KwUeCb *ueCb );


extern S16 pjUtlCmpReset ( PjRbCb *pjRbCb );


extern S16 pjUtlCmpReq ( PjRbCb *pjRbCb, Buffer *mBuf, Buffer **opSdu, U32 count );





extern S16 pjUtlIntProtReq ( PjRbCb *pjRbCb, PjSecInp secInp , Buffer *mBuf, U32 *macI );





extern S16 pjUtlCipherReq ( PjRbCb *pjRbCb, PjSecInp secInp , Buffer *mBuf, Buffer **opSdu );





extern S16 pjUtlDeCmpReq ( PjRbCb *pjRbCb, U32 count, Buffer *mBuf, Buffer **opSdu );





extern S16 pjUtlIntVerReq ( PjRbCb *pjRbCb, PjSecInp secInp , Buffer *mBuf, U32 macI, Status *status );
...
extern S16 pjUtlDecipherReq ( PjRbCb *pjRbCb, PjSecInp secInp, Buffer *mBuf, Buffer **opSdu );





extern S16 pjUtlSndFeedback ( PjRbCb *pjRbCb, Buffer *feedback );



extern S16 pjUtlCmpClose ( U32 cmpCxtId );


extern S16 pjUtlIntClose ( U32 intCxtId );


extern S16 pjUtlCipherClose ( U32 cpCxtId );


extern S16 pjUtlReEstSrb1 ( PjRbCb *pjRbCb );


extern S16 pjUtlReEstStart ( KwUeCb *ueCb, CpjCfgReqInfo *cfgReq );



extern S16 pjUtlReEstHOStart ( KwUeCb *ueCb, U32 transId );




extern S16 pjUtlReEstReconfig ( KwUeCb *ueCb, U8 rbType );




extern S16 pjUtlReEstDl ( KwUeCb *ueCb );


extern S16 pjUtlSndReEstCfgCfm ( KwUeCb *ueCb );


extern S16 pjUtlSndSduStaCfm ( KwUeCb *ueCb );


extern S16 pjUtlShutdown ( void );


extern Void pjUtlFreeRb ( PjRbCb *pjRbCb );



extern S16 pjUtlSndDatFwdInd ( PjRbCb *pjRbCb, PjuDatFwdIndInfo *datFwdInd );




extern Void pjLimDatInd ( PjRbCb *pjRbCb, Buffer *mBuf );




extern Void pjLimDatCfm ( PjRbCb *pjRbCb, PjDatCfm *datCfm );




extern Void pjLimStaInd ( PjRbCb *pjRbCb, PjDatCfm *staInd );




extern Void pjLimReEstCmpInd ( PjRbCb *pjRbCb );
# 2071 "../..//lterlcpdcp/kw.x"
extern S16 kwUimDatReq ( PjRbCb *pjRbCb, U32 sduId, Buffer *mBuf );





extern S16 kwUimDiscSdu ( PjRbCb *pjRbCb, U32 sduId );




extern RbCb* kwDbmCreateRbCb ( U8 rbId, U8 rbType, KwUeCb *ueCb, U8 rb );





extern S16 kwDbmFetchPjRbCb ( KwUeCb *ueCb, U8 rbId, U8 rbType, PjRbCb **pjRbCb );





extern S16 kwDbmDelRbCb ( U8 rbId, U8 rbType, RbCb **rbCb, U8 rb );
# 2106 "../..//lterlcpdcp/kw.x"
extern Void pjLmmSendAlarm ( U16 category, U16 event, U16 cause, SuId suId, U32 ueId);


extern S16 pjLmmSendTrc ( Event event, Buffer *mBuf);
# 148 "../..//lterlcpdcp/kw_amm.c" 2
# 1 "../..//mt/ss_diag.h" 1
# 90 "../..//mt/ss_diag.h"
...
# 149 "../..//lterlcpdcp/kw_amm.c" 2
# 162 "../..//lterlcpdcp/kw_amm.c"
...
#define KW_AM_SUC_RETX_PDU(_rbCb,_retx) do { kwAmChkSduMap((_rbCb), (_retx)->amHdr.sn, (_retx)->sduMap, (_retx)->numSdu); kwRemRetxPdu((_rbCb), (_retx));} while(0)





#define KW_AM_RMV_HDR(_rbCb,_retx) do { if ((_retx)->yetToConst == FALSE) { Buffer *_tSeg; SSegMsg ((_retx)->seg, (_retx)->hdrSz, &_tSeg); KW_FREE_BUF((_retx)->seg); (_retx)->seg = _tSeg; } (_rbCb)->m.am.amDl.estHdrSz -= retx->hdrSz;} while(0)
# 209 "../..//lterlcpdcp/kw_amm.c"
#define KW_AM_SND_DSTA_RSP() do { U32 _bo; KW_UPD_AMBO(AMDL, _bo); kwUtlSndDStaRsp(rbCb, _bo, AMDL.estHdrSz, AMDL.cntrlBo ? TRUE : FALSE); } while(0)
...
#define KW_ADD_BUF_TO_PDU(_pdu,_buf) do { if (_pdu == NULLP) {_pdu = _buf; _buf = NULLP;} else {SCatMsg(_pdu, _buf, M1M2); SPutMsg(_buf); _buf = NULLP;}} while(0)




#define KW_AM_ADD_SDU_TO_SDUMAP(_sdu,_size) do { (_sdu)->mode.am.pduMap[(_sdu)->mode.am.numPdu++].sn = amHdr.sn; sduMap[numSdu].sduId = (_sdu)->mode.am.sduId; sduMap[numSdu].sduSz = (_size); sduMap[numSdu].actSz = (_size); sduMap[numSdu++].isSegmented = (_sdu)->mode.am.isSegmented; } while(0)
# 232 "../..//lterlcpdcp/kw_amm.c"
static S16 kwAssembleCntrlInfo (KwRbCb *rbCb, KwDatReq *kwDatReq);
static S16 kwResegRetxPdus (KwRbCb *rbCb, KwDatReq *kwDatReq);
# 245 "../..//lterlcpdcp/kw_amm.c"
static S16 kwAssembleSdus (KwRbCb *rbCb, KwDatReq *kwDatReq);
static Bool kwChkandSetPoll (KwRbCb *rbCb, Bool newPdu, MsgLen bufSz);
static Bool kwCreatePdu (KwRbCb *rbCb, KwAmHdr *amHdr, Buffer *pdu);
static S16 kwExtractHdr (KwRbCb *rbCb, Buffer *pdu, KwAmHdr *amHdr, U8 *fByte);

static S16 kwHndlStaRsp (KwRbCb *rbCb, Buffer *cntrlPdu, U8 *fByte);
static Bool kwPlcPduInRecBuf (Buffer *pdu, KwRbCb *rbCb, KwAmHdr *amHdr);

static Void kwTriggerStatus (KwRbCb *rbCb, KwSn sn, Bool discFlg);
static Void kwUpdCntrlBo (KwAmUl *amUl);

static S16 kwReassembleSdus (KwRbCb *rbCb, KwAmRecBuf **recBuf, U16 *numSdu);
static Void kwAmmProcPdu (KwRbCb *rbCb, KwAmHdr *amHdr, Buffer *pdu, KwAmRecBuf **recBuf, U16 *numSdu);
static Void kwAmmProcSeg (KwRbCb *rbCb, KwAmHdr *amHdr, Buffer *pdu, KwSeg *seg, U16 *numSdu);
static Void kwAmmReasmbleOnReEst (KwRbCb *rbCb, U16 *numSdus);




static Void kwAmmEstHdrSz (KwAmDl *amDl, U8 type);
static S16 kwAmmSndStaInd (KwRbCb *rbCb, KwRetx *retx);
static S16 kwAmmSndDatCfm (KwRbCb *rbCb, U32 sduId);
static S16 kwGetNxtRetx (KwAmDl *amDl, KwRetx **retx);
static Void kwAmmUpdExpByteSeg (KwAmUl *amUl, KwSeg* newSeg);
static Void kwFormCntrlBits (KwCntrlInfo *cntrlInfo, U16 *staPdu, KwDatReq *kwDatReq, U32 *pduSzInBits, U16 *staPduSzInBits);


static Void kwConstructAmHdr (KwAmHdr *amHdr, Bool isSeg, U8 *hdr, U16 *idx);

static Void kwFormBits (KwHdrInfo *hdrInfo);
static Void kwExtractElmnt (Buffer *pdu, KwExtHdr *hdrInfo);
static Void kwUpdRemPduAck (KwRbCb *rbCb, KwSn mAckSn, CmLList *retx);
static S16 kwUpdFrmTxtoRetx (KwAmDl *amDl, KwRetx **retx, KwSn sn);
static Void kwAmChkSduMap (KwRbCb *rbCb, KwSn sn, KwSduMap *sduLst, U8 numSdu);
# 348 "../..//lterlcpdcp/kw_amm.c"
 S16 kwAmmQSdu
(
KwRbCb *rbCb,
Buffer *mBuf,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 367); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmQSdu(rbCb, mBuf, sduId) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&sdu, (Size) sizeof(KwSdu)) == 0) { cmMemset((U8 *)(sdu), 0, sizeof(KwSdu)); } else { (sdu) = 0L; } };
# 382 "../..//lterlcpdcp/kw_amm.c"
   SFndLenMsg(mBuf, &sdu->sduSz);

   sdu->mBuf = mBuf;
   sdu->mode.am.sduId = sduId;
   sdu->actSz = sdu->sduSz;
# 397 "../..//lterlcpdcp/kw_amm.c"
   if (rbCb->m.am.amDl.nxtTx == 0L)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 401); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmQSdu: Update received sdu as the next one                        to be transmitted \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


      rbCb->m.am.amDl.nxtTx = sdu;
   }


   cmLListAdd2Tail(&rbCb->m.am.amDl.sduQ, &sdu->lstEnt);
   sdu->lstEnt.node = (U32)sdu;
   rbCb->m.am.amDl.numSduPdu = 1;
   rbCb->m.am.amDl.numSeg = 0;


   rbCb->m.am.amDl.bo = rbCb->m.am.amDl.bo + sdu->sduSz;
   rbCb->m.am.amDl.estHdrSz += 2;
# 425 "../..//lterlcpdcp/kw_amm.c"
   if(rbCb->reestInProgress == 0)
   {
      do { U32 _bo; { Bool winStall = 0; KwAmDl *tamDl = 0L; tamDl = &rbCb->m.am.amDl; if (rbCb->m.am.amDl.bo < 0) rbCb->m.am.amDl.bo = 0; if (rbCb->m.am.amDl.cntrlBo < 0) rbCb->m.am.amDl.cntrlBo = 0; if (rbCb->m.am.amDl.retxBo < 0) rbCb->m.am.amDl.retxBo = 0; { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; winStall = 0; { _vtA = ((tamDl->vtA - tamDl->vtA) + 1024) % 1024; }; { _mSn = ((tamDl->vtS - tamDl->vtA) + 1024) % 1024; }; { _vtMs = ((tamDl->vtMs - tamDl->vtA) + 1024) % 1024; }; if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { winStall = 1; } }; if (!winStall) { _bo = rbCb->m.am.amDl.bo + rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } else { _bo = rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } }; kwUtlSndDStaRsp(rbCb, _bo, rbCb->m.am.amDl.estHdrSz, rbCb->m.am.amDl.cntrlBo ? 1 : 0); } while(0);
   }
...
# 466 "../..//lterlcpdcp/kw_amm.c"
 S16 kwAmmProcessSdus
(
KwRbCb *rbCb,
KwDatReq *kwDatReq
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 486); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSdus(rbCb, kwDatReq) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 494 "../..//lterlcpdcp/kw_amm.c"
   if (rbCb->m.am.amDl.cntrlBo != 0)
   {
      kwDatReq->boRep.staPduPrsnt = 1;
      kwAssembleCntrlInfo (rbCb, kwDatReq);
      rbCb->m.am.amDl.cntrlBo = rbCb->m.am.amUl.cntrlBo= 0;
   }
# 514 "../..//lterlcpdcp/kw_amm.c"
   rbCb->m.am.amDl.numSeg = 0;
   rbCb->m.am.amDl.numSduPdu = 0;


   if ( (kwDatReq->pduSz > 0) && (rbCb->m.am.amDl.nxtRetx != 0L) )
   {
   ...
   if ( (kwDatReq->pduSz > 0) && (rbCb->m.am.amDl.nxtTx != 0) )
   {
      ret = kwAssembleSdus(rbCb, kwDatReq);
   ...
   { Bool winStall = 0; KwAmDl *tamDl = 0L; tamDl = &rbCb->m.am.amDl; if (rbCb->m.am.amDl.bo < 0) rbCb->m.am.amDl.bo = 0; if (rbCb->m.am.amDl.cntrlBo < 0) rbCb->m.am.amDl.cntrlBo = 0; if (rbCb->m.am.amDl.retxBo < 0) rbCb->m.am.amDl.retxBo = 0; { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; winStall = 0; { _vtA = ((tamDl->vtA - tamDl->vtA) + 1024) % 1024; }; { _mSn = ((tamDl->vtS - tamDl->vtA) + 1024) % 1024; }; { _vtMs = ((tamDl->vtMs - tamDl->vtA) + 1024) % 1024; }; if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { winStall = 1; } }; if (!winStall) { kwDatReq->boRep.bo = rbCb->m.am.amDl.bo + rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } else { kwDatReq->boRep.bo = rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } };
# 562 "../..//lterlcpdcp/kw_amm.c"
   kwAmmEstHdrSz (&rbCb->m.am.amDl, 2);
   kwDatReq->boRep.estHdrSz = rbCb->m.am.amDl.estHdrSz;

   return(0);
}
# 593 "../..//lterlcpdcp/kw_amm.c"
static S16 kwAssembleCntrlInfo
(
KwRbCb *rbCb,
KwDatReq *kwDatReq
)
...

{
   ...
   U32 pduSzInBits = 0;
   U16 staPduSzInBits = 8 * 100;

   Bool notEnoughSpace = 0;


   ;

   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 639); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleCntrlInfo(rbCb, kwDatReq) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   sn = rbCb->m.am.amUl.vrR;
   { mSn = ((sn - rbCb->m.am.amUl.vrR) + 1024) % 1024; };
   { vrMs = ((rbCb->m.am.amUl.vrMs - rbCb->m.am.amUl.vrR) + 1024) % 1024; };





   while ((pduSzInBits >= 12) && (staPduSzInBits >= 12) && (mSn < vrMs ))
   {
      ...
      if (rbCb->m.am.amUl.recBuf[sn] == 0L)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 696); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleCntrlInfo: Missing PDU's SN = %d\n", sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         kwFormCntrlBits(&cntrlInfo, staPdu, kwDatReq, &pduSzInBits, &staPduSzInBits);
         { e1Idx = cntrlInfo.e1Idx; e2Idx = cntrlInfo.e2Idx; e1eb = cntrlInfo.e1eb; idx = cntrlInfo.idx; emtBits = cntrlInfo.emtBits;};
      }
      else
      {
         if ( (rbCb->m.am.amUl.recBuf[sn]->pdu == 0L) &&
              (rbCb->m.am.amUl.recBuf[sn]->segLst.count > 0) )
         {
            ...
            seqSo = 0;
            { CmLList *tmpNode; ((((tmpNode) = ((&(rbCb->m.am.amUl.recBuf[sn]->segLst))->crnt = (&(rbCb->m.am.amUl.recBuf[sn]->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
            ...
            while (seg != 0L)
            {
               ...
               if( (pduSzInBits < (12 + 15 + 15)) ||
                   (staPduSzInBits < (12 + 15 + 15)) )
               {
                  notEnoughSpace = 1;
                  break;
               }
               ...
               if (seg->amHdr.so != seqSo)
               {
                  ...
                  partSeg = 1;
                  do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 775); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleCntrlInfo: Missing byte segment's" " SN, soStart and soEnd = %d, %d, %d \n", sn, soStart, soEnd); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



               }
               seqSo = seg->soEnd + 1;
               { CmLList *tmpNode; (rbCb->m.am.amUl.recBuf[sn]->segLst).crnt = &((seg)->lstEnt); ((((tmpNode) = ((&(rbCb->m.am.amUl.recBuf[sn]->segLst))->crnt = ((&(rbCb->m.am.amUl.recBuf[sn]->segLst))->crnt ? (&(rbCb->m.am.amUl.recBuf[sn]->segLst))->crnt->next : (&(rbCb->m.am.amUl.recBuf[sn]->segLst))->first)))!= 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
            }
            ...
            { CmLList *tempNode = 0L; ((&rbCb->m.am.amUl.recBuf[sn]->segLst)->crnt = (&rbCb->m.am.amUl.recBuf[sn]->segLst)->last); tempNode = ((&rbCb->m.am.amUl.recBuf[sn]->segLst)->crnt); if (tempNode != 0L) seg = (KwSeg *)tempNode->node; else seg = 0L; };
            if( (seg != 0L) && (seg->amHdr.lsf != 1) )
            {
               ...
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 843); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleCntrlInfo: Missing (last) byte " "segment's SN, soStart and soEnd = %d, %d, %d \n", sn, soStart, soEnd); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   else
   {
      while(mSn < vrMs )
      {
         ...
         else if( (rbCb->m.am.amUl.recBuf[sn]->pdu == 0L) &&
               (rbCb->m.am.amUl.recBuf[sn]->segLst.count > 0) )
         {
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 930); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleCntrlInfo: ACK PDU's SN = %d\n", ack_sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   for (i = 0, j = 0; ((i <= idx) && (j < 100)); i++)
   {
      { U16 tmpPdu; tmpPdu = staPdu[i]; cntrlPdu[j++] = (U8)(tmpPdu >> 8); cntrlPdu[j++] = (U8)staPdu[i]; };
   }
   ...
   kwDatReq->pduSz -= (cntrlPduSz - 2);

   SAddPstMsgMult (cntrlPdu, cntrlPduSz, mBuf);

   kwStartTmr((U32)rbCb, 3);
   kwChkTmr((U32)rbCb, 3);
   rbCb->m.am.amUl.staTrg = 0;
...
# 984 "../..//lterlcpdcp/kw_amm.c"
static S16 kwSplitPdu
(
KwRbCb *rbCb,
KwRetx *crnt,
KwRetx *next,
...

{
   ...
   next->sduMap[0].isSegmented = crnt->sduMap[0].isSegmented = 1;;
   ...
   next->hdrSz += 4;
   rbCb->m.am.amDl.estHdrSz += next->hdrSz;


   rbCb->m.am.amDl.retxLst.crnt = &crnt->lstEnt;
   { CmLList *nodeToIns = &next->lstEnt; nodeToIns->node = (U32) next; cmLListInsAfterCrnt(&rbCb->m.am.amDl.retxLst, nodeToIns); };
   rbCb->m.am.amDl.nxtRetx = next;
   return(0);
}
# 1074 "../..//lterlcpdcp/kw_amm.c"
static S16 kwSplitPduWithLi
(
KwRbCb *rbCb,
KwRetx *crnt,
KwRetx *next,
...

{
   ...
   {
       do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1109); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwSplitPduWithLi: numLi of in PDU = %d \n", crnt->amHdr.numLi); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (tSz && (liCnt < oldHdr->numLi))
   {
      ...
      oldHdr->li[liCnt] = tSz;
      crnt->sduMap[liCnt].isSegmented = 1;
...
# 1233 "../..//lterlcpdcp/kw_amm.c"
static S16 kwResegRetxPdus
(
KwRbCb *rbCb,
KwDatReq *kwDatReq
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1257); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwResegRetxPdus(rbCb, kwDatReq) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   while ((*pduSz > 0) && (amDl->nxtRetx != 0L) && (kwDatReq->pduInfo.numPdu < 5))

   {
      ...
      tmpSz = ((retx->segSz + retx->hdrSz)) < (*pduSz) ? ((retx->segSz + retx->hdrSz)) : (*pduSz);
      (*pduSz) -= (tmpSz <= 128) ? 2 : 3;
      ...
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1288); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwResegRetxPdus: Send retx buf without                  segmentation \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         if (retx->yetToConst)
         {
            ...
            { Data liByte; S16 size; size = idx + 1 - 1; while (size >= 0 ) { liByte = (U8) (hdr[size]); SAddPreMsg((Data )liByte, retx->seg); size--; }};
            retx->yetToConst = 0;
         }



         pollBit = kwChkandSetPoll(rbCb, 0, 0);
         { U8 fHdr = 0x00; if (pollBit != retx->amHdr.p) { SRemPreMsg ((Data *)&fHdr, retx->seg); if (pollBit == 1) { fHdr = fHdr | 0x20; } else { fHdr = fHdr & 0xdf; } SAddPreMsg ((Data)fHdr, retx->seg); } retx->amHdr.p = pollBit; };

         *pduSz -= retx->hdrSz;
         *pduSz -= retx->segSz;
         rbCb->m.am.amDl.estHdrSz -= retx->hdrSz;
      }
      else
      {


         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1312); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwResegRetxPdus: Segment retx buf \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         *pduSz -= 4;
         ...
         { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&tNode, (Size) sizeof(KwRetx)) == 0) { cmMemset((U8 *)(tNode), 0, sizeof(KwRetx)); } else { (tNode) = 0L; } };
# 1334 "../..//lterlcpdcp/kw_amm.c"
         do { if ((retx)->yetToConst == 0) { Buffer *_tSeg; SSegMsg ((retx)->seg, (retx)->hdrSz, &_tSeg); { if ((retx)->seg != 0L) { SPutMsg((retx)->seg); } (retx)->seg = 0L;}; (retx)->seg = _tSeg; } (rbCb)->m.am.amDl.estHdrSz -= retx->hdrSz;} while(0);


         if ((retx->amHdr.numLi - 1) == 0)
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1340); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwResegRetxPdus: No LI for segmentation \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1348); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwResegRetxPdus: LIs for segmentation \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         { U8 fHdr = 0x00; if (0 != retx->amHdr.p) { SRemPreMsg ((Data *)&fHdr, retx->seg); if (0 == 1) { fHdr = fHdr | 0x20; } else { fHdr = fHdr & 0xdf; } SAddPreMsg ((Data)fHdr, retx->seg); } retx->amHdr.p = 0; };
         retx->yetToConst = 0;
         *pduSz = 0;
      }

      (SAddMsgRef((retx->seg), (kwCb.init.region), (kwCb.init.pool), (&pdu)));
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1386); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwResegRetxPdus: retxBo after resegmentation = %ld \n", amDl->retxBo); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1393 "../..//lterlcpdcp/kw_amm.c"
   amDl->numSduPdu = 0;
   amDl->numSeg = 0;

   return(0);
}
# 1854 "../..//lterlcpdcp/kw_amm.c"
static S16 kwAssembleSdus
(
KwRbCb *rbCb,
KwDatReq *kwDatReq
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1886); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleSdus(rbCb, kwDatReq) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
          ...
          (kwDatReq->pduInfo.numPdu < 5))
   {
      ...
      { if ( (pduSz > sduSz) && (sduSz < 2048) ) { pduSz -= (amHdr.numLi % 2) ? 1 : 2; } };
      ...
      if (pduSz == sduSz)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1955); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleSdus: PduSz matches SduSz for                  sduId = %ld \n", sdu->mode.am.sduId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 1965 "../..//lterlcpdcp/kw_amm.c"
         if (pdu == 0L)
         {
            pdu = sdu->mBuf;
            sdu->mBuf = 0L;
      ...
      else if (pduSz > sduSz)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 1995); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleSdus: Concatenation for                  sduId = %ld \n", sdu->mode.am.sduId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2005 "../..//lterlcpdcp/kw_amm.c"
         if (pdu == 0L)
         {
            pdu = sdu->mBuf;
            sdu->mBuf = 0L;
      ...
      else
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2045); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleSdus: Segmentation for                  sduId = %ld \n", sdu->mode.am.sduId); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2055 "../..//lterlcpdcp/kw_amm.c"
      ...
      pduSz -= sduSz;
# 2126 "../..//lterlcpdcp/kw_amm.c"
      { CmLList *tmpNode = 0L; ((((tmpNode) = ((&(amDl->sduQ))->crnt = ((&(amDl->sduQ))->crnt ? (&(amDl->sduQ))->crnt->next : (&(amDl->sduQ))->first)))!= 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) sdu = (KwSdu *)tmpNode->node; else sdu = 0L; };
   }
# 2137 "../..//lterlcpdcp/kw_amm.c"
   if (!nxtTxUpd)
      amDl->nxtTx = sdu;
...
# 2177 "../..//lterlcpdcp/kw_amm.c"
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2191); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAssembleSdus: BO after assembly = %ld \n", amDl->bo); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2199 "../..//lterlcpdcp/kw_amm.c"
   return(0);
}
# 2225 "../..//lterlcpdcp/kw_amm.c"
static Bool kwChkandSetPoll
(
KwRbCb *rbCb,
Bool newPdu,
MsgLen bufSz
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2247); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwChkandSetPoll(rbCb, newPdu, bufSz) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { vtA = ((amDl->vtA - amDl->vtA) + 1024) % 1024; };
   { mSn = ((amDl->vtS - amDl->vtA) + 1024) % 1024; };
   { vtMs = ((amDl->vtMs - amDl->vtA) + 1024) % 1024; };
   ...
   if (pollBit)
   {
      ...
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2282); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwChkandSetPoll: Poll SN = %d \n", amDl->pollSn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if( 1 == kwChkTmr((U32)rbCb,4) )
      {
         kwStopTmr((U32)rbCb, 4);
      }

      kwStartTmr((U32)rbCb, 4);
   }

   return(pollBit);
}
# 2318 "../..//lterlcpdcp/kw_amm.c"
static Bool kwCreatePdu
(
KwRbCb *rbCb,
KwAmHdr *amHdr,
Buffer *pdu
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2342); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCreatePdu(rbCb, amHdr, pdu) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   amHdr->p = kwChkandSetPoll(rbCb, 1, pduSz);


   kwConstructAmHdr(amHdr, segFlg, hdr, &idx);


   { Data liByte; S16 size; size = idx+1 - 1; while (size >= 0 ) { liByte = (U8) (hdr[size]); SAddPreMsg((Data )liByte, pdu); size--; }};



   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&txBuf, (Size) sizeof(KwTx)) == 0) { cmMemset((U8 *)(txBuf), 0, sizeof(KwTx)); } else { (txBuf) = 0L; } };
# 2375 "../..//lterlcpdcp/kw_amm.c"
   amDl->txBuf[amHdr->sn] = txBuf;

   (SAddMsgRef((pdu), (kwCb.init.region), (kwCb.init.pool), (&(txBuf->pdu))));
   txBuf->pduSz = pduSz;
   txBuf->hdrSz = idx+1;

   kwCb.genSts.bytesSent += pduSz;

   { cmMemcpy((U8*)&txBuf->amHdr, (U8 *)amHdr, sizeof(KwAmHdr)); };

   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2386); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwCreatePdu: Created PDU with SN = %d \n", amHdr->sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 2394 "../..//lterlcpdcp/kw_amm.c"
   return(1);
}
# 2548 "../..//lterlcpdcp/kw_amm.c"
 S16 kwAmmProcessPdus
(
KwRbCb *rbCb,
KwPduInfo *pduInfo
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2588); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus(rbCb, pduInfo) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   reasmblyRbListCnt = kwCb.reasmblyRbList.count;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2598); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus Count(%lu) in toBeReasmbldAmPduLst\n", pduListCnt); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
          ...
          (numPdu < 5))
   {
      ...
      if ( ret != 0 )
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2618); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus: Failed to extract hdr \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if (amHdr.dc == 0)
      {
         ...
         ret = kwHndlStaRsp(rbCb, pdu, &fByte);
         { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L;};
         if(ret != 0)
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2632); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus: Staus Pdu processing returned failure\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      if ( ret == 1)
      {
         ...
         KwSn tVrMr = 0;
         KwSn mVrH = 0;
# 2662 "../..//lterlcpdcp/kw_amm.c"
         { mSn = ((sn - amUl->vrR) + 1024) % 1024; };
         { mVrH = ((amUl->vrH - amUl->vrR) + 1024) % 1024; };
         if (mSn >= mVrH)
         {
            amUl->vrH = (sn + 1) % 1024;

            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2670); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus: Updated vrH = %d \n", amUl->vrH); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


         }

         { tVrMr = ((amUl->vrMr - amUl->vrR) + 1024) % 1024; };
         ...
         if (sn == amUl->vrMs)
         {
            ...
            if (amUl->recBuf[sn]->allRcvd)
            {
               ...
               { mSn = ((tSn - amUl->vrR) + 1024) % 1024; };
               while (mSn <= tVrMr)
               {
                 if ((amUl->recBuf[tSn] == 0L) ||
                     (!amUl->recBuf[tSn]->allRcvd))
                 {
                    do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2692); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus: Updated vrMs = %d \n", tSn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
       ...
       ;
                     cmLListAdd2Tail(&amUl->toBeReasmbldAmPduLst, &amUl->recBuf[tSn]->rlsAmPduLnk);
                     amUl->recBuf[tSn]->rlsAmPduLnk.node = (U32)amUl->recBuf[tSn];

                     if(0L == rbCb->rlsReasmblyRbLnk.node)
                     {
                        cmLListAdd2Tail(&kwCb.reasmblyRbList, &rbCb->rlsReasmblyRbLnk);
                        rbCb->rlsReasmblyRbLnk.node = (U32)rbCb;
                     }
                     if(amUl->toBeReasmbldAmPduLst.count > 300)
                     {
       ...
       ;
         ...
         tmrRunning = kwChkTmr((U32)rbCb, 2);
         if (tmrRunning)
         {
            Bool snInWin = 0;
            { if (amUl->vrR > amUl->vrMr) { if ((amUl->vrX >= amUl->vrR) || (amUl->vrX < amUl->vrMr)) { snInWin = 1; } } else { if ((amUl->vrX >= amUl->vrR) && (amUl->vrX < amUl->vrMr)) { snInWin = 1; } } };
         ...
         if (!tmrRunning)
         {
            ...
            {
               kwStartTmr((U32)rbCb, 2);
               amUl->vrX = amUl->vrH;

               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2796); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus: Updated vrX = %d \n", amUl->vrX); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   coreId = 2;
   ;
   kwUtlPostSelfMsgUl(coreId);
   ;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2825); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessPdus Count(%lu) in toBeReasmbldAmPduLst\n", amUl->toBeReasmbldAmPduLst.count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (amUl->cntrlBo)
   {
      rbCb->m.am.amDl.cntrlBo = amUl->cntrlBo;
      do { U32 _bo; { Bool winStall = 0; KwAmDl *tamDl = 0L; tamDl = &rbCb->m.am.amDl; if (rbCb->m.am.amDl.bo < 0) rbCb->m.am.amDl.bo = 0; if (rbCb->m.am.amDl.cntrlBo < 0) rbCb->m.am.amDl.cntrlBo = 0; if (rbCb->m.am.amDl.retxBo < 0) rbCb->m.am.amDl.retxBo = 0; { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; winStall = 0; { _vtA = ((tamDl->vtA - tamDl->vtA) + 1024) % 1024; }; { _mSn = ((tamDl->vtS - tamDl->vtA) + 1024) % 1024; }; { _vtMs = ((tamDl->vtMs - tamDl->vtA) + 1024) % 1024; }; if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { winStall = 1; } }; if (!winStall) { _bo = rbCb->m.am.amDl.bo + rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } else { _bo = rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } }; kwUtlSndDStaRsp(rbCb, _bo, rbCb->m.am.amDl.estHdrSz, rbCb->m.am.amDl.cntrlBo ? 1 : 0); } while(0);
   }
...
# 2861 "../..//lterlcpdcp/kw_amm.c"
static S16 kwExtractHdr
(
KwRbCb *rbCb,
Buffer *pdu,
KwAmHdr *amHdr,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2891); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwExtractHdr(rbCb, pdu, amHdr, fByte) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   amHdr->rf = (*fByte & 0x40) ? 1: 0;
   amHdr->p = (*fByte & 0x20) ? 1:0;
   amHdr->fi = (*fByte & 0x18) >> 3;
   e = amHdr->e = (*fByte & 0x04)? 1:0;
   ...
   while (e && pdu && (liCnt < 60))
   {
      ...
      if ( pdu )
      {
         ...
         if (li == 0)
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2945); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwExtractHdr: Received LI with 0 \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if(e && pdu && (liCnt >= 60))
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2963); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf," liCount exceeded the maximum count \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if ( totalSz >= pduSz )
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 2) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 2984); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwExtractHdr: Corrupted PDU received from the lower              layer \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   if( rbCb->m.am.amDl.retxLst.count == 0)
   {
      rbCb->m.am.amDl.nxtRetx = 0L;
   }

   if (retx->wtForAck == 0)
   {
      rbCb->m.am.amDl.retxBo -= retx->segSz;
      rbCb->m.am.amDl.estHdrSz -= retx->hdrSz;
   }

   { if (retx->seg != 0L) { SPutMsg(retx->seg); } retx->seg = 0L;};
   { if (retx != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) retx, (Size) sizeof(KwRetx)); retx = 0L; } };

   return;
}
# 3063 "../..//lterlcpdcp/kw_amm.c"
static Void kwMrkRetxPdu
(
KwRbCb *rbCb,
KwRetx *retx
)
...
{
   ;
   if (rbCb->m.am.amDl.isRbstalled == 1)
   {
      return;
   }
   if (retx->wtForAck == 1)
   {
      if (++retx->retxCnt > rbCb->m.am.amDl.maxRetx)
      {
         { if(kwCb.init.logMask & 0x1) { ssDiagFix(0x002a0001, KW_DIAG_UEID, 0xd7, kwCb.init.inst, 0x1, SS_DIAG_MSG_TYPE_FIXED, rbCb->rlcId.ueId, rbCb->rlcId.rbId, rbCb->rlcId.rbType, 0, 0, "Reached Maximum Retry for a SDU, RAB-Id = %d, RAB-Type = %d"); }};

# 3096 "../..//lterlcpdcp/kw_amm.c"
      if (1 != rbCb->m.am.amDl.isRbstalled)
      {
          rbCb->m.am.amDl.isRbstalled = 1;
         rbCb->m.am.amDl.bo = 0;
         rbCb->m.am.amDl.cntrlBo = 0;
         rbCb->m.am.amDl.retxBo = 0;

            do { U32 _bo; { Bool winStall = 0; KwAmDl *tamDl = 0L; tamDl = &rbCb->m.am.amDl; if (rbCb->m.am.amDl.bo < 0) rbCb->m.am.amDl.bo = 0; if (rbCb->m.am.amDl.cntrlBo < 0) rbCb->m.am.amDl.cntrlBo = 0; if (rbCb->m.am.amDl.retxBo < 0) rbCb->m.am.amDl.retxBo = 0; { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; winStall = 0; { _vtA = ((tamDl->vtA - tamDl->vtA) + 1024) % 1024; }; { _mSn = ((tamDl->vtS - tamDl->vtA) + 1024) % 1024; }; { _vtMs = ((tamDl->vtMs - tamDl->vtA) + 1024) % 1024; }; if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { winStall = 1; } }; if (!winStall) { _bo = rbCb->m.am.amDl.bo + rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } else { _bo = rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } }; kwUtlSndDStaRsp(rbCb, _bo, rbCb->m.am.amDl.estHdrSz, rbCb->m.am.amDl.cntrlBo ? 1 : 0); } while(0);
   kwAmmSndStaInd(rbCb, retx);
      }

         kwRemRetxPdu(rbCb, retx);
      ...
      if (rbCb->m.am.amDl.nxtRetx == 0L)
      {
         rbCb->m.am.amDl.nxtRetx = retx;
      }
...

{
   ...
   for (i = 0; i < numSdu; i++)
   {
      ...
      { CmLList *tmpNode; ((((tmpNode) = ((&(rbCb->m.am.amDl.sduQ))->crnt = (&(rbCb->m.am.amDl.sduQ))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) sdu = (KwSdu *)tmpNode->node; else sdu = 0L; };
      while ( (sdu != 0L) && (sdu->mode.am.sduId != sduId) )
      {
         { CmLList *tmpNode = 0L; ((((tmpNode) = ((&(rbCb->m.am.amDl.sduQ))->crnt = ((&(rbCb->m.am.amDl.sduQ))->crnt ? (&(rbCb->m.am.amDl.sduQ))->crnt->next : (&(rbCb->m.am.amDl.sduQ))->first)))!= 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) sdu = (KwSdu *)tmpNode->node; else sdu = 0L; };
      }
      if (sdu != 0L)
      {
         ...
         if (!notRcvd)
         {
            ...
            kwAmmSndDatCfm(rbCb, sduId);



            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 3225); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmChkSduMap:DatCfm sent to PDCP for rbId %d rbType %d\n", rbCb->rlcId.rbId, rbCb->rlcId.rbType); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



            tNode = &sdu->lstEnt;
            { if(sdu->mBuf) { if (sdu->mBuf != 0L) { SPutMsg(sdu->mBuf); } sdu->mBuf = 0L;}; sdu->mBuf = 0L; cmLListDelFrm(&rbCb->m.am.amDl.sduQ,&sdu->lstEnt); { if (sdu != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) sdu, (Size) sizeof(KwSdu)); sdu = 0L; } };};
         }
         else
         {
            notRcvd = 0;
...
# 3817 "../..//lterlcpdcp/kw_amm.c"
static Void kwAmmSucTxPdu
(
KwRbCb *rbCb,
KwSn sn
)
...
{
   ;
# 3851 "../..//lterlcpdcp/kw_amm.c"
   kwAmChkSduMap(rbCb, sn, rbCb->m.am.amDl.txBuf[(sn)]->sduMap, rbCb->m.am.amDl.txBuf[(sn)]->numSdu);
   { if (rbCb->m.am.amDl.txBuf[(sn)]->pdu != 0L) { SPutMsg(rbCb->m.am.amDl.txBuf[(sn)]->pdu); } rbCb->m.am.amDl.txBuf[(sn)]->pdu = 0L;};
   { if (rbCb->m.am.amDl.txBuf[sn] != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) rbCb->m.am.amDl.txBuf[sn], (Size) sizeof(KwTx)); rbCb->m.am.amDl.txBuf[sn] = 0L; } };



   return;
}
# 3930 "../..//lterlcpdcp/kw_amm.c"
static S16 kwHndlStaRsp
(
KwRbCb *rbCb,
Buffer *cntrlPdu,
U8 *fByte
...
# 3962 "../..//lterlcpdcp/kw_amm.c"
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 3970); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp(rbCb, cntrlPdu, fByte) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if (hdrInfo.hdr & 0xE0)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 3987); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: Reserved value for CPT,              discarded cntrlPDU) \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   kwExtractElmnt(cntrlPdu, &hdrInfo);
   e1 = (U8)hdrInfo.val;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4002); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: ACK SN = %d \n", ackSn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);





   { mAckSn = ((ackSn - rbCb->m.am.amDl.vtA) + 1024) % 1024; };
   { mTxSn = ((rbCb->m.am.amDl.txSn - rbCb->m.am.amDl.vtA) + 1024) % 1024; };
   { mVts = ((rbCb->m.am.amDl.vtS - rbCb->m.am.amDl.vtA) + 1024) % 1024; };
# 4023 "../..//lterlcpdcp/kw_amm.c"
   if (mAckSn > mVts)
   {
   ...
   { KwSn _mSn = 0; KwSn _mVtA = 0; { mSn = ((rbCb->m.am.amDl.pollSn - rbCb->m.am.amDl.vtA) + 1024) % 1024; }; { _mVtA = ((rbCb->m.am.amDl.vtA - rbCb->m.am.amDl.vtA) + 1024) % 1024; }; if ( (_mSn >= _mVtA) && (_mSn <= mAckSn) ) { Bool _tmrRunning = 0; _tmrRunning = kwChkTmr((U32)rbCb, 4); if (_tmrRunning) { kwStopTmr((U32)rbCb, 4); } } };


   retxNode = rbCb->m.am.amDl.retxLst.first;
# 4045 "../..//lterlcpdcp/kw_amm.c"
   if (e1)
   {
      U8 e2 = 0;
      Bool first = 1;
      ...
      while (e1)
      {
         ...
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4076); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: NACK SN = %d \n", nackSn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         if (e2)
         {
            ...
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4092); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: soStart and soEnd = %d %d \n", soStart, soEnd); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


         }
# 4102 "../..//lterlcpdcp/kw_amm.c"
         sn = rbCb->m.am.amDl.txSn;
         rbCb->m.am.amDl.txSn = (nackSn + 1)%1024;;
         { mNackSn = ((nackSn - rbCb->m.am.amDl.vtA) + 1024) % 1024; };
         ...
         while (retxNode)
         {
            ...
            { mSn = ((retx->amHdr.sn - rbCb->m.am.amDl.vtA) + 1024) % 1024; };
# 4126 "../..//lterlcpdcp/kw_amm.c"
            if (mSn < mNackSn)
            {
               ...
               do { kwAmChkSduMap((rbCb), (retx)->amHdr.sn, (retx)->sduMap, (retx)->numSdu); kwRemRetxPdu((rbCb), (retx));} while(0);
         ...
         { mSn = ((sn - rbCb->m.am.amDl.vtA) + 1024) % 1024; };
         while (mSn < mNackSn)
         {
            if ((mSn >= mTxSn) && (rbCb->m.am.amDl.txBuf[sn] != 0L))
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4150); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: Handle ACK for PDU with sn =                        %d\n", sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         if (rbCb->m.am.amDl.txBuf[nackSn] != 0L)
         {
            KwAmDl *amDl = &(rbCb->m.am.amDl);

            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4166); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: Move PDU from txBuf to                       retxLst \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
            ...
            if(ret != 0)
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4173); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: kwUpdFrmTxtoRetx returned failure\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
         ...
         while (retxNode)
         {
            ...
            {
               do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4191); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: Handle ACK for byte                                segment, Its sn, soStart and soEnd = %d, %d,                               %d\n", sn, retx->amHdr.so, retx->soEnd); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);




               retxNode = retxNode->next;
# 4203 "../..//lterlcpdcp/kw_amm.c"
               do { kwAmChkSduMap((rbCb), (retx)->amHdr.sn, (retx)->sduMap, (retx)->numSdu); kwRemRetxPdu((rbCb), (retx));} while(0);
      ...
      rbCb->m.am.amDl.vtA = vtA;
      rbCb->m.am.amDl.vtMs = (rbCb->m.am.amDl.vtA + 512) % 1024;
   }
   else
   {

      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4234); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwHndlStaRsp: Received All ACKS \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



      kwUpdRemPduAck(rbCb, mAckSn, retxNode);
      rbCb->m.am.amDl.vtA = ackSn;
      rbCb->m.am.amDl.vtMs = (rbCb->m.am.amDl.vtA + 512) % 1024;
   }
# 4249 "../..//lterlcpdcp/kw_amm.c"
   { CmLList *tmpNode; ((((tmpNode) = ((&(rbCb->m.am.amDl.retxLst))->crnt = (&(rbCb->m.am.amDl.retxLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) rbCb->m.am.amDl.nxtRetx = (KwRetx *)tmpNode->node; else rbCb->m.am.amDl.nxtRetx = 0L; };



   rbCb->m.am.amDl.txSn = ackSn;


   if (retxBo != rbCb->m.am.amDl.retxBo)
   {
      do { U32 _bo; { Bool winStall = 0; KwAmDl *tamDl = 0L; tamDl = &rbCb->m.am.amDl; if (rbCb->m.am.amDl.bo < 0) rbCb->m.am.amDl.bo = 0; if (rbCb->m.am.amDl.cntrlBo < 0) rbCb->m.am.amDl.cntrlBo = 0; if (rbCb->m.am.amDl.retxBo < 0) rbCb->m.am.amDl.retxBo = 0; { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; winStall = 0; { _vtA = ((tamDl->vtA - tamDl->vtA) + 1024) % 1024; }; { _mSn = ((tamDl->vtS - tamDl->vtA) + 1024) % 1024; }; { _vtMs = ((tamDl->vtMs - tamDl->vtA) + 1024) % 1024; }; if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { winStall = 1; } }; if (!winStall) { _bo = rbCb->m.am.amDl.bo + rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } else { _bo = rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } }; kwUtlSndDStaRsp(rbCb, _bo, rbCb->m.am.amDl.estHdrSz, rbCb->m.am.amDl.cntrlBo ? 1 : 0); } while(0);
   }
# 4289 "../..//lterlcpdcp/kw_amm.c"
   return(0);
}
# 4306 "../..//lterlcpdcp/kw_amm.c"
static Void kwAmmRlsAllSegs
(
KwAmRecBuf *recBuf
)
...

{
   ...
   { CmLList *tmpNode; ((((tmpNode) = ((&(recBuf->segLst))->crnt = (&(recBuf->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
   while (seg != 0L)
   {
      { if (seg->seg != 0L) { SPutMsg(seg->seg); } seg->seg = 0L;};
      cmLListDelFrm(&(recBuf->segLst),&(seg->lstEnt));
      { if (seg != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) seg, (Size) sizeof(KwSeg)); seg = 0L; } };
      { CmLList *tmpNode; ((((tmpNode) = ((&(recBuf->segLst))->crnt = (&(recBuf->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
   }

   return;
}
# 4352 "../..//lterlcpdcp/kw_amm.c"
...

{
   ...
   if (rbCb->m.am.amUl.recBuf[amHdr->sn] == 0L)
   {

      { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&recBuf, (Size) sizeof(KwAmRecBuf)) == 0) { cmMemset((U8 *)(recBuf), 0, sizeof(KwAmRecBuf)); } else { (recBuf) = 0L; } };
# 4390 "../..//lterlcpdcp/kw_amm.c"
      rbCb->m.am.amUl.recBuf[amHdr->sn] = recBuf;
   }
   else
   {
      recBuf = rbCb->m.am.amUl.recBuf[amHdr->sn];
   }
   if (recBuf->allRcvd == 1)
   {
      { if (pdu != 0L) { SPutMsg(pdu); } pdu = 0L;};
   ...
   while ((seg != 0L) && (seg->amHdr.so < amHdr->so))
   {
      ...
      { CmLList *tmpNode; (recBuf->segLst).crnt = &((seg)->lstEnt); ((((tmpNode) = ((&(recBuf->segLst))->crnt = ((&(recBuf->segLst))->crnt ? (&(recBuf->segLst))->crnt->next : (&(recBuf->segLst))->first)))!= 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
   }
...
# 4453 "../..//lterlcpdcp/kw_amm.c"
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&tseg, (Size) sizeof(KwSeg)) == 0) { cmMemset((U8 *)(tseg), 0, sizeof(KwSeg)); } else { (tseg) = 0L; } };
# 4464 "../..//lterlcpdcp/kw_amm.c"
   tseg->seg = pdu;
   tseg->segSz = pduSz;
   ...
   kwAmmUpdExpByteSeg(&rbCb->m.am.amUl,tseg);

   return(1);
}
# 4503 "../..//lterlcpdcp/kw_amm.c"
static Bool kwPlcPduInRecBuf
(
Buffer *pdu,
KwRbCb *rbCb,
KwAmHdr *amHdr
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4524); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwPlcPduInRecBuf(pdu, rbCb, amHdr)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (amUl->vrR > amUl->vrMr) { if ((sn >= amUl->vrR) || (sn < amUl->vrMr)) { snInWin = 1; } } else { if ((sn >= amUl->vrR) && (sn < amUl->vrMr)) { snInWin = 1; } } };

   if (!snInWin)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4538); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwPlcPduInRecBuf: SN  %d falls outside the window \n", sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 4582 "../..//lterlcpdcp/kw_amm.c"
   if (amHdr->rf == 0)
   {
      ...
      {
         { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&recBuf, (Size) sizeof(KwAmRecBuf)) == 0) { cmMemset((U8 *)(recBuf), 0, sizeof(KwAmRecBuf)); } else { (recBuf) = 0L; } };
# 4601 "../..//lterlcpdcp/kw_amm.c"
         amUl->recBuf[sn] = recBuf;
      }
      else if (amUl->recBuf[amHdr->sn]->allRcvd != 1)
      {
         kwAmmRlsAllSegs(amUl->recBuf[amHdr->sn]);
   ...
   else
   {
      ...
      return(kwAmmAddRcvdSeg(rbCb, amHdr, pdu, pduSz));
   }
}
# 4651 "../..//lterlcpdcp/kw_amm.c"
static Void kwTriggerStatus
(
KwRbCb *rbCb,
KwSn sn,
Bool discFlg
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4671); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwTriggerStatus(rbCb, sn, discFlg)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   { tVrMr = ((amUl->vrMr - amUl->vrR) + 1024) % 1024; };
   { tVrMs = ((amUl->vrMs - amUl->vrR) + 1024) % 1024; };
   { tSn = ((sn - amUl->vrR) + 1024) % 1024; };



   if ((discFlg) || (tSn < tVrMs) || (tSn >= tVrMr))
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4682); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwTriggerStatus: Set Status Trigger \n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


      amUl->staTrg = 1;


      tmrRunning = kwChkTmr((U32) rbCb, 3);
...
# 4712 "../..//lterlcpdcp/kw_amm.c"
static Void kwUpdCntrlBo
(
KwAmUl *amUl
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4731); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUpdCntrlBo(amUl)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { mSn = ((sn - amUl->vrR) + 1024) % 1024; };
   { mvrMs = ((amUl->vrMs - amUl->vrR) + 1024) % 1024; };
   while (mSn < mvrMs)
   {
      ...
      else
      {
         ...
         { CmLList *tmpNode; ((((tmpNode) = ((&(amUl->recBuf[sn]->segLst))->crnt = (&(amUl->recBuf[sn]->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
         while (seg != 0L)
         {
            ...
            seqSo = seg->soEnd + 1;
            { CmLList *tmpNode; (amUl->recBuf[sn]->segLst).crnt = &((seg)->lstEnt); ((((tmpNode) = ((&(amUl->recBuf[sn]->segLst))->crnt = ((&(amUl->recBuf[sn]->segLst))->crnt ? (&(amUl->recBuf[sn]->segLst))->crnt->next : (&(amUl->recBuf[sn]->segLst))->first)))!= 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
         }


         { CmLList *tempNode = 0L; ((&amUl->recBuf[sn]->segLst)->crnt = (&amUl->recBuf[sn]->segLst)->last); tempNode = ((&amUl->recBuf[sn]->segLst)->crnt); if (tempNode != 0L) seg = (KwSeg *)tempNode->node; else seg = 0L; };
         if ( (seg != 0L) && (seg->amHdr.lsf != 1) )
         {
            cntrlBo += 2;
         }
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 4791); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUpdCntrlBo: Updated cntrlBo = %ld\n", cntrlBo); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 4818 "../..//lterlcpdcp/kw_amm.c"
static S16 kwAmmGetSdu
(
U16 *liCnt,
KwAmHdr *amHdr,
Buffer **pdu,
...
# 4878 "../..//lterlcpdcp/kw_amm.c"
static Void kwAmmProcPdu
(
KwRbCb *rbCb,
KwAmHdr *amHdr,
Buffer *pdu,
...
# 4894 "../..//lterlcpdcp/kw_amm.c"
{
   ...
   if ((rbCb->m.am.amUl.expSn != amHdr->sn) || (rbCb->m.am.amUl.expSo != amHdr->so))
   {


      { if (rbCb->m.am.amUl.partialSdu != 0L) { SPutMsg(rbCb->m.am.amUl.partialSdu); } rbCb->m.am.amUl.partialSdu = 0L;};
   }
   ...
   if (amHdr->fi & 0x02)
   {
      ...
      if (rbCb->m.am.amUl.partialSdu == 0L)
      {
      ...
      {
         SCatMsg(pdu, rbCb->m.am.amUl.partialSdu, 1);
         { if (rbCb->m.am.amUl.partialSdu != 0L) { SPutMsg(rbCb->m.am.amUl.partialSdu); } rbCb->m.am.amUl.partialSdu = 0L;};
      }
      else
      {
         kwAmmGetSdu(&liCnt, amHdr, &pdu, &sdu);
         SCatMsg(sdu, rbCb->m.am.amUl.partialSdu, 1);
         { if (rbCb->m.am.amUl.partialSdu != 0L) { SPutMsg(rbCb->m.am.amUl.partialSdu); } rbCb->m.am.amUl.partialSdu = 0L;};
   ...
   if(1 == isPduProcessd)
   {
      if (amHdr->fi & 0x01)
      {
         ...
         rbCb->m.am.amUl.partialSdu = pdu;
         (*recBuf)->amHdr.numSduProcessed++;
      }
      else if (pdu != 0L)
      {
         rbCb->m.am.amUl.partialSdu = 0L;
...
# 5006 "../..//lterlcpdcp/kw_amm.c"
static Void kwAmmProcSeg
(
KwRbCb *rbCb,
KwAmHdr *amHdr,
Buffer *pdu,
...
# 5239 "../..//lterlcpdcp/kw_amm.c"
static S16 kwReassembleSdus
(
KwRbCb *rbCb,
KwAmRecBuf **recBuf,
U16 *numSdu
...

{
   ...
   if ((*recBuf)->amHdr.rf == 0)
   {
      ...
      if((*recBuf)->amHdr.numSduProcessed > (*recBuf)->amHdr.numLi)
      {
         rbCb->m.am.amUl.expSn = ((*recBuf)->amHdr.sn + 1) % 1024;
         rbCb->m.am.amUl.expSo = 0;
      }
   }
   else
   {
      ...
      { CmLList *tmpNode; ((((tmpNode) = ((&((*recBuf)->segLst))->crnt = (&((*recBuf)->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
      rbCb->m.am.amUl.expSn = (*recBuf)->amHdr.sn;
      while(seg && (*numSdu < 5))
      {
         kwAmmProcSeg(rbCb, &seg->amHdr, seg->seg, seg, numSdu);

         if(seg->amHdr.numSduProcessed > seg->amHdr.numLi)
         {

            rbCb->m.am.amUl.expSo = seg->soEnd + 1;
            cmLListDelFrm(&((*recBuf)->segLst),&(seg->lstEnt));
            { if (seg != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) seg, (Size) sizeof(KwSeg)); seg = 0L; } };
         }
         { CmLList *tmpNode; ((((tmpNode) = ((&((*recBuf)->segLst))->crnt = (&((*recBuf)->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; };
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5395); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmEstHdrSz(amDl, type)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5408); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmEstHdrSz: estHdrSz = %ld \n", amDl->estHdrSz); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 5434 "../..//lterlcpdcp/kw_amm.c"
static S16 kwAmmSndStaInd
(
KwRbCb *rbCb,
KwRetx *retx
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5459); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmSndStaInd(rbCb, retx)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&staInd, (Size) sizeof(KwuStaIndInfo)) == 0) { cmMemset((U8 *)(staInd), 0, sizeof(KwuStaIndInfo)); } else { (staInd) = 0L; } };
# 5478 "../..//lterlcpdcp/kw_amm.c"
   ...
   { cmMemset((U8 *)(&pjStaInd), 0, sizeof(PjDatCfm)); };

   { cmMemcpy((U8*)&pjStaInd, (U8 *)staInd, sizeof(KwuStaIndInfo)); };
   { if (staInd != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) staInd, (Size) sizeof(KwuStaIndInfo)); staInd = 0L; } };
...
# 5528 "../..//lterlcpdcp/kw_amm.c"
static S16 kwAmmSndDatCfm
(
KwRbCb *rbCb,
U32 sduId
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5552); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmSndDatCfm(rbCb, sduId)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 5584 "../..//lterlcpdcp/kw_amm.c"
   if(kwCb.init.trc == 1)
   {

      kwLmmSendTrc(0x55, 0L);
   }
   ...
   { cmMemcpy((U8*)&(pjDatCfm.rlcId), (U8 *)&rbCb->rlcId, sizeof(CmLteRlcId)); };
   pjDatCfm.numSdu = 1;
...
# 5633 "../..//lterlcpdcp/kw_amm.c"
static S16 kwGetNxtRetx
(
KwAmDl *amDl,
KwRetx **retx
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5651); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwGetNxtRetx(amDl, retx)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 5693 "../..//lterlcpdcp/kw_amm.c"
 S16 kwAmmReEstablish
(
CmLteRlcId rlcId,
KwRbCb *rbCb
)
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5714); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmReEstablish(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   if( (rbCb->rlcId.rbType == 0) && (rbCb->rlcId.rbId == 1) )
   {



      if(0 != kwDbmFetchUeCb(rbCb->rlcId.ueId,rbCb->rlcId.cellId, &ueCb))
      {
          return(1) ;
      }
...
# 5745 "../..//lterlcpdcp/kw_amm.c"
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5757); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmReEstablish:Count(%lu) in toBeReasmbldAmPduLst\n", rbCb->m.am.amUl.toBeReasmbldAmPduLst.count); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



   kwAmmChkReasmblyLstSz(rbCb);
   ...
   if (tmrRunning)
   {
      kwStopTmr((U32)rbCb, 3);
   }
   tmrRunning = kwChkTmr((U32)rbCb, 4);
   if (tmrRunning)
   {
      kwStopTmr((U32)rbCb, 4);
   }
   ...
   rbCb->m.am.amUl.vrH = 0;
   rbCb->m.am.amUl.vrX = 0;
   rbCb->m.am.amUl.vrMs = 0;
   rbCb->m.am.amUl.staTrg = 0;
   rbCb->m.am.amUl.cntrlBo = 0;
# 5795 "../..//lterlcpdcp/kw_amm.c"
   rbCb->m.am.amDl.vtMs = (rbCb->m.am.amDl.vtA + 512) % 1024;
   rbCb->m.am.amDl.pollSn = 0;
   rbCb->m.am.amDl.bo = 0;
   rbCb->m.am.amDl.retxBo = 0;
   rbCb->m.am.amDl.cntrlBo = 0;
   rbCb->m.am.amDl.estHdrSz = 0;
   rbCb->m.am.amDl.numSduPdu = 0;
   rbCb->m.am.amDl.numSeg = 0;
   rbCb->m.am.amDl.pduWoPoll = 0;
   rbCb->m.am.amDl.byteWoPoll = 0;
# 5817 "../..//lterlcpdcp/kw_amm.c"
   rbCb->m.am.amDl.nxtRetx = 0L;

   return(0);
}
# 5844 "../..//lterlcpdcp/kw_amm.c"
 S16 kwAmmDiscSdu
(
KwRbCb *rbCb,
U32 sduId
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5862); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmDiscSdu(rbCb, sduId)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   while (sdu != 0L)
   {
      if ( (sdu->mode.am.sduId == sduId) && (!sdu->mode.am.isSegmented) )
      {
         ...
         if (rbCb->m.am.amDl.nxtTx == sdu)
         {
            { CmLList *tmpNode = 0L; ((((tmpNode) = ((&(rbCb->m.am.amDl.sduQ))->crnt = ((&(rbCb->m.am.amDl.sduQ))->crnt ? (&(rbCb->m.am.amDl.sduQ))->crnt->next : (&(rbCb->m.am.amDl.sduQ))->first)))!= 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) tmpSdu = (KwSdu *)tmpNode->node; else tmpSdu = 0L; };
            rbCb->m.am.amDl.nxtTx = tmpSdu;
         }
# 5900 "../..//lterlcpdcp/kw_amm.c"
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 5953); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmReOrdTmrExp(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { mSn = ((sn - amUl->vrR) + 1024) % 1024; };
   { mVrMr = ((amUl->vrMr - amUl->vrR) + 1024) % 1024; };
   ...
   while (mSn < mVrMr)
   {
            ...
            (!amUl->recBuf[sn]->allRcvd)) )
      {
         ...
         if (amUl->cntrlBo)
         {
           ...
           rbCb->m.am.amDl.cntrlBo = rbCb->m.am.amUl.cntrlBo;

           { Bool winStall = 0; KwAmDl *tamDl = 0L; tamDl = &rbCb->m.am.amDl; if (rbCb->m.am.amDl.bo < 0) rbCb->m.am.amDl.bo = 0; if (rbCb->m.am.amDl.cntrlBo < 0) rbCb->m.am.amDl.cntrlBo = 0; if (rbCb->m.am.amDl.retxBo < 0) rbCb->m.am.amDl.retxBo = 0; { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; winStall = 0; { _vtA = ((tamDl->vtA - tamDl->vtA) + 1024) % 1024; }; { _mSn = ((tamDl->vtS - tamDl->vtA) + 1024) % 1024; }; { _vtMs = ((tamDl->vtMs - tamDl->vtA) + 1024) % 1024; }; if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { winStall = 1; } }; if (!winStall) { bo = rbCb->m.am.amDl.bo + rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } else { bo = rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } };


           staPduPrsnt = (rbCb->m.am.amDl.cntrlBo) ? 1 : 0;
           kwUtlSndDStaRsp(rbCb, bo, rbCb->m.am.amDl.estHdrSz, staPduPrsnt);
         }
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 6040); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmStaProTmrExp(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 6096); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmPollRetxTmrExp(rbCb)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 6106 "../..//lterlcpdcp/kw_amm.c"
   if (((amDl->nxtTx == 0L) || (amDl->vtS == amDl->vtMs)) &&
       (amDl->nxtRetx == 0L))
   {
      sn = (amDl->vtS - 1) & 0x3ff;
      if (amDl->txBuf[sn] != 0L)
      {
         ...
         else if (rbCb->m.am.amDl.nxtRetx == 0L)
         {
            rbCb->m.am.amDl.nxtRetx = retx;
         }
         do { U32 _bo; { Bool winStall = 0; KwAmDl *tamDl = 0L; tamDl = &rbCb->m.am.amDl; if (rbCb->m.am.amDl.bo < 0) rbCb->m.am.amDl.bo = 0; if (rbCb->m.am.amDl.cntrlBo < 0) rbCb->m.am.amDl.cntrlBo = 0; if (rbCb->m.am.amDl.retxBo < 0) rbCb->m.am.amDl.retxBo = 0; { KwSn _mSn = 0; KwSn _vtA = 0; KwSn _vtMs = 0; winStall = 0; { _vtA = ((tamDl->vtA - tamDl->vtA) + 1024) % 1024; }; { _mSn = ((tamDl->vtS - tamDl->vtA) + 1024) % 1024; }; { _vtMs = ((tamDl->vtMs - tamDl->vtA) + 1024) % 1024; }; if (! ((_vtA <= _mSn) && (_mSn < _vtMs)) ) { winStall = 1; } }; if (!winStall) { _bo = rbCb->m.am.amDl.bo + rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } else { _bo = rbCb->m.am.amDl.cntrlBo + rbCb->m.am.amDl.retxBo; } }; kwUtlSndDStaRsp(rbCb, _bo, rbCb->m.am.amDl.estHdrSz, rbCb->m.am.amDl.cntrlBo ? 1 : 0); } while(0);
...
# 6162 "../..//lterlcpdcp/kw_amm.c"
static Void kwUpdRemPduAck
(
KwRbCb *rbCb,
KwSn mAckSn,
CmLList *retxNode
...

{
   ...
   { mSn = ((rbCb->m.am.amDl.txSn - rbCb->m.am.amDl.vtA) + 1024) % 1024; };
   sn = rbCb->m.am.amDl.txSn;
   while(mSn < mAckSn)
   {
      if ((rbCb->m.am.amDl.txBuf[sn] != 0L) )
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 0) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 6207); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUpdRemPduAck: Handle ACK for PDU with sn =                    %d\n", sn); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 6232 "../..//lterlcpdcp/kw_amm.c"
static Void kwExtractElmnt
(
Buffer *pdu,
KwExtHdr *hdrInfo
)
...
# 6540 "../..//lterlcpdcp/kw_amm.c"
static Void kwFormCntrlBits
(
KwCntrlInfo *cntrlInfo,
U16 *staPdu,
KwDatReq *kwDatReq,
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 6681); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmUpdExpByteSeg(amUl, sn, so)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
# 6694 "../..//lterlcpdcp/kw_amm.c"
   { CmLList *tmpNode; ((((tmpNode) = ((&(amUl->recBuf[sn]->segLst))->crnt = (&(amUl->recBuf[sn]->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) tSeg = (KwSeg *)tmpNode->node; else tSeg = 0L; };
   ...
   while(tSeg)
   {
      if (tSeg->amHdr.so == seqSo)
      {
         ...
         { CmLList *tmpNode; (amUl->recBuf[sn]->segLst).crnt = &((tSeg)->lstEnt); ((((tmpNode) = ((&(amUl->recBuf[sn]->segLst))->crnt = ((&(amUl->recBuf[sn]->segLst))->crnt ? (&(amUl->recBuf[sn]->segLst))->crnt->next : (&(amUl->recBuf[sn]->segLst))->first)))!= 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) tSeg = (KwSeg *)tmpNode->node; else tSeg = 0L; };
      }
      else
      {
...

{
   ...
   { retxMSn = ((retx->amHdr.sn - amDl->vtA) + 1024) % 1024; };
   while(node != 0L)
   {
      tRetx = (KwRetx *)(node->node);
      { tMSn = ((tRetx->amHdr.sn - amDl->vtA) + 1024) % 1024; };
      if (tMSn > retxMSn)
      {
         node = node->prev;
      }
...
# 6813 "../..//lterlcpdcp/kw_amm.c"
static S16 kwUpdFrmTxtoRetx
(
KwAmDl *amDl,
KwRetx **retx,
KwSn sn
...

{
   ...
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 6831); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwUpdFrmTxtoRetx(amUl, sn, so)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   { if (SGetSBuf(kwCb.init.region, kwCb.init.pool, (Data **)&*retx, (Size) sizeof(KwRetx)) == 0) { cmMemset((U8 *)(*retx), 0, sizeof(KwRetx)); } else { (*retx) = 0L; } };
# 6844 "../..//lterlcpdcp/kw_amm.c"
   ...
   { cmMemcpy((U8*)&((*retx)->amHdr), (U8 *)&amDl->txBuf[sn]->amHdr, sizeof(KwAmHdr)); };
   (*retx)->amHdr.lsf = 1;
   kwAmmAddPduToRetxLst(amDl, (*retx));


   { if (amDl->txBuf[sn] != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) amDl->txBuf[sn], (Size) sizeof(KwTx)); amDl->txBuf[sn] = 0L; } };
...
# 6979 "../..//lterlcpdcp/kw_amm.c"
static Void kwAmmReasmbleOnReEst
(
KwRbCb *rbCb,
U16 *numSdus
)
...

{
   ...
   KwSn sn;
   ;;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7000); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmReasmbleOnReEst(rbCb, numSdus)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   inWhile = 0;
   seg = 0L;
   amUl = &(rbCb->m.am.amUl);
   pduList = &amUl->toBeReasmbldAmPduLst;

   while( (pduList->first) && (*numSdus < 5) )
   {
      inWhile = 1;
      pduRecBuf = (KwAmRecBuf*) pduList->first->node;

      if(1 == pduRecBuf->allRcvd)
      {
         { if (pduRecBuf->pdu != 0L) { SPutMsg(pduRecBuf->pdu); } pduRecBuf->pdu = 0L;};

         { CmLList *tmpNode; ((((tmpNode) = ((&(pduRecBuf->segLst))->crnt = (&(pduRecBuf->segLst))->first)) != 0L) ? (tmpNode)->node : 0L); if (tmpNode != 0L) seg = (KwSeg *)tmpNode->node; else seg = 0L; }
         ...
         { if (pduRecBuf != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) pduRecBuf, (Size) sizeof(KwAmRecBuf)); pduRecBuf = 0L; } };
         (*numSdus)++;
      }
   ...
   sn = rbCb->m.am.amUl.vrR;
   { mVrMr = ((rbCb->m.am.amUl.vrMr - rbCb->m.am.amUl.vrR) + 1024) % 1024; };
   { mSn = ((sn - rbCb->m.am.amUl.vrR) + 1024) % 1024; };
   while( (mSn < mVrMr) && (*numSdus < 5) )
   {
      if(amUl->recBuf[sn])
      {
...
# 7140 "../..//lterlcpdcp/kw_amm.c"
 Void kwAmmProcessSelfMsgUl
(
KwRbCb *rbCb,
U16 *numSdus
)
...

{
   ...
   ;;
   do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7164); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl(rbCb, numSdus)\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


   seg = 0L;
   amUl = &(rbCb->m.am.amUl);
   pduList = &amUl->toBeReasmbldAmPduLst;
   rbList = &kwCb.reasmblyRbList;



   if(rbCb->rbOp & 0x08)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7177); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:Deletion of UL PDUs               to be done in toBeReasmbldAmPduLst\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   { if (pduRecBuf != 0L) { (Void) SPutSBuf(kwCb.init.region, kwCb.init.pool, (Data *) pduRecBuf, (Size) sizeof(KwAmRecBuf)); pduRecBuf = 0L; } };
      ...
      if(0L == pduList->first)
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7211); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:PDU list is empty,so                  RB is deleted from Rb List\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);


         ;
         rbList->first->node = 0L;
         cmLListDelFrm(rbList, rbList->first);
         ;

         rbCb->rbOp &= 0xf7;


         ret = kwUtlRbDeletion(rbCb);
         if(0 == ret)
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7224); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:Freeing of RbCb is done\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

         }
         else
         {
            do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 3)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7230); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:Freeing of RbCb is not done                     since it is not yet completed at DL side\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   else if(rbCb->rbOp & 0x02)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7241); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:Reestablishment flag is ON.              So, reassembly of complete PDUs and deletion of segmented PDUs               to be done in toBeReasmbldAmPduLst\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);



      kwAmmReasmbleOnReEst(rbCb, numSdus);




      if( (0L == pduList->first) && (0 == (rbCb->rbOp & 0x02)) )
      {
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7251); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:PDU list is empty,so                  RB is deleted from Rb List\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
   ...
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7267); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:Reassembly of UL PDUs               to be done in toBeReasmbldAmPduLst\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
      ...
      while( (pduList->first) && (*numSdus < 5) )
      {
         ...
         if(0 == pduRecBuf->amHdr.rf)
         {


            if(pduRecBuf->amHdr.numSduProcessed > pduRecBuf->amHdr.numLi)
            {
               ;
               cmLListDelFrm(pduList, pduList->first);
               if(0L == pduList->first)
         ...
         else if (1 == pduRecBuf->amHdr.rf)
         {


            if(0 == pduRecBuf->segLst.count)
            {
               ;
               cmLListDelFrm(pduList, pduList->first);
               if(0L == pduList->first)
   ...
   if(0L != pduList->first)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7320); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:PDU list is not empty\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);

      if( (rbList->count > 1) && (0 == (rbCb->rbOp & 0x08)) && (0 == (rbCb->rbOp & 0x02)) )
      {
         ;
         cmLListDelFrm(rbList, rbList->first);
         cmLListAdd2Tail(rbList, &rbCb->rlsReasmblyRbLnk);
         ;
         rbCb->rlsReasmblyRbLnk.node = (U32)rbCb;
         do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7330); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmProcessSelfMsgUl:RB is deleted from front and                  added at the end of RB List\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
...
# 7356 "../..//lterlcpdcp/kw_amm.c"
 Void kwAmmChkReasmblyLstSz
(
KwRbCb *rbCb
)
...

{
   ...
   if(rbCb->m.am.amUl.toBeReasmbldAmPduLst.count > 500)
   {
      do { if (!((kwCb.init.dbgMask & (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4))) ^ (((0x00000002 << 4) << 2) | (0x00000002 << 1) | ((0x00000002 << 4) << 4)))) { do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); { sprintf(kwCb.init.prntBuf, "[RLC_LAYER: %s:%d]::", "../..//lterlcpdcp/kw_amm.c", 7372); SPrint(kwCb.init.prntBuf); { S8 _buf[60]; DateTime dt; cmMemset((U8 *)(&dt), 0, sizeof(DateTime)); SGetDateTime(&dt); sprintf(_buf, "\n\ndate: %02d/%02d/%04d time: %02d:%02d:%02d\n", (int)dt.month,(int)dt.day,(int)dt.year + 1900, (int)dt.hour,(int)dt.min,(int)dt.sec); { sprintf (kwCb.init.prntBuf, "[%s]", _buf); SPrint(kwCb.init.prntBuf); }; }; sprintf(kwCb.init.prntBuf, ("\nDebug Log:\n")); SPrint(kwCb.init.prntBuf); }; { sprintf (kwCb.init.prntBuf, "kwAmmChkReasmblyLstSz:Alarm is raised\n"); SPrint(kwCb.init.prntBuf); }; do { { sprintf (kwCb.init.prntBuf, "\n==========================\n"); SPrint(kwCb.init.prntBuf); }; }while(0); } }while(0);
